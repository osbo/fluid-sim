...
# Outputs:
# - Full train logs:
#     results/lsp_scale_train_logs/multiphase_v2_<scale>.log
# - Per-task CSV summary row:
#     results/lsp_scale_train_task_<task>.csv
#
...
#SBATCH --mem=32G
#SBATCH -t 2:00:00
#SBATCH -o /home/osbo/ondemand/fluid-sim/slurm_logs/lsp_train_scale_%A_%a.out
#SBATCH -e /home/osbo/ondemand/fluid-sim/slurm_logs/lsp_train_scale_%A_%a.err
...
SRC_DATA_DIR="${FLUID_SIM_ROOT}/data/${EXP_NAME}"
