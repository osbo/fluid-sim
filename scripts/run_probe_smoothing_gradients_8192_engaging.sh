...
#
# Outputs:
#   logs:     results/probe_smoothing_8192/*.log
#   weights:  weights/*smooth*.bytes
#   profiles: weights/*smooth*_training_profile.csv
#   plot/csv: results/probe_smoothing_8192/gradient_balance_8192.*
#
# Submit:
...
#SBATCH --mem=32G
#SBATCH -t 2:00:00
#SBATCH -o /home/osbo/ondemand/fluid-sim/slurm_logs/lo_probe_grad_8192_%j.out
#SBATCH -e /home/osbo/ondemand/fluid-sim/slurm_logs/lo_probe_grad_8192_%j.err

set -euo pipefail

ROOT="/home/osbo/ondemand/fluid-sim"
...
python3 -u "${ROOT}/python/plot_probe_smoothing_grad_balance.py" \
