...
# Outputs:
#   - per-task CSV:
#       results/generalization_neural_spai_split_sweep_task_<task>.csv
#   - merged CSV (run merge snippet below):
#       results/generalization_neural_spai_split_sweep.csv
#
# Merge:
#   python3 - <<'PY'
...
#SBATCH --mem=32G
#SBATCH -t 6:00:00
#SBATCH -o /home/osbo/ondemand/fluid-sim/slurm_logs/lsp_eval_gen_split_%j.out
#SBATCH -e /home/osbo/ondemand/fluid-sim/slurm_logs/lsp_eval_gen_split_%j.err
