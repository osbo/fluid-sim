...
# Outputs:
# - Full infer logs:
#     results/lsp_scale_infer_logs/multiphase_v2_<scale>.log
# - Raw infer.py CSVs:
#     results/lsp_scale_infer_raw/infer_sweep_multiphase_v2_<scale>_*.csv
#     results/lsp_scale_infer_raw/all_infer_sweep_multiphase_v2_<scale>_*.csv
# - Per-task normalized CSV:
#     results/lsp_scale_infer_task_<task>.csv
#
# Merge task CSVs:
#   python3 /home/osbo/ondemand/fluid-sim/merge_lsp_scale_infer_csvs.py
#
...
#SBATCH --mem=32G
#SBATCH -t 2:00:00
#SBATCH -o /home/osbo/ondemand/fluid-sim/slurm_logs/lsp_infer_scale_%A_%a.out
#SBATCH -e /home/osbo/ondemand/fluid-sim/slurm_logs/lsp_infer_scale_%A_%a.err
