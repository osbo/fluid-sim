...
\begin{teaserfigure}
  ...
  \end{minipage}\hfill
  \begin{minipage}[t]{0.245\linewidth}\centering
    \figplaceholder{\linewidth}{1.65in}{3D multiphase pressure-Poisson: volumetric density,
      buoyancy-driven plume, interface sharpening. Shown as a forward visualisation;
      quantitative 3D evaluation is future work.}\\[1pt]
...
Poisson family is reported in Supplementary \S\ref{SX-supp:generalization}.
...
\clearpage
% ---------------------------------------------------------------------------
% Figures-only page 2: training + probe alignment
% ---------------------------------------------------------------------------
