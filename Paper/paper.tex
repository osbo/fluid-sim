...
% TODO: confirm GPU/CPU model + CUDA/PyTorch versions before submission.
All experiments run on a single [GPU MODEL] (CUDA [VERSION], PyTorch [VERSION]) and a
single-socket [CPU MODEL]; CPU baselines use Eigen, SciPy, and PyAMG. PCG scalar
accumulators use float64; preconditioner weights and apply use float32. GPU timings are
...
$\mathcal{H}$-matrix-style preconditioner (full generation script in Appendix~\ref{app:dataset}):
\begin{itemize}
...
Best per scale in \textbf{bold}. Iteration counts in Appendix~\ref{app:full_perf_table}.}
\label{tab:main:perf}
...
% --- TABLE: ablation sweep (compact placeholder; will be filled with real numbers) ---
\begin{table}[t]
\centering
\caption{Architecture and loss ablations at $N\!=\!4\,096$ ($\mathrm{rtol}\!=\!10^{-8}$,
$20$ frames). \emph{Total} = inference $+$ PCG (ms). Numbers to be filled with the final
sweep; expected signs reported in the body text.}
\label{tab:ablation}
\footnotesize\setlength{\tabcolsep}{4pt}
\begin{tabular}{@{}lccc@{}}
\toprule
Configuration & Total & Iters & $\Delta$ vs.\ best \\
\midrule
\textbf{Best ($d{=}128, n_l{=}3$, all on)} & \textbf{TODO} & \textbf{TODO} & --- \\
\midrule
\multicolumn{4}{l}{\emph{Capacity:}}\\
$d{=}64, n_l{=}2$              & TODO & TODO & TODO \\
$d{=}128, n_l{=}2$             & TODO & TODO & TODO \\
$d{=}256, n_l{=}2$             & TODO & TODO & TODO \\
\multicolumn{4}{l}{\emph{Components (best $-$ component):}}\\
$-$ highways                    & TODO & TODO & TODO \\
$-$ off-diag stack              & TODO & TODO & TODO \\
$-$ GCN ($n_{\mathrm{gcn}}{=}0$)& TODO & TODO & TODO \\
$-$ Jacobi residual gate        & TODO & TODO & TODO \\
$-$ probe smoothing             & TODO & TODO & TODO \\
\multicolumn{4}{l}{\emph{Loss objective (best arch.):}}\\
$\mathcal{L}_{\ell_2}$ Hutchinson & TODO & TODO & TODO \\
SAI~\cite{Yang2025sparse}      & TODO & TODO & TODO \\
$\mathcal{L}_{\cos}$ (ours)    & TODO & TODO & --- \\
\bottomrule
\end{tabular}
\end{table}
...
supplementary material in the interest of space:
