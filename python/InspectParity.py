...
_DEFAULT_WEIGHTS_PATH = _script_dir.parent / "Assets" / "StreamingAssets" / "leaf_only_weights_sim_8192.bytes"
...
def main() -> None:
    ...
    if data_folder is None:
        data_folder = _script_dir.parent / "Assets" / "StreamingAssets" / "TestData"
