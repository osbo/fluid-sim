...
def train_hgt_ol():
    ...
    parser.add_argument('--leaf-size', type=int, default=_DEFAULT_LEAF_SIZE)
    parser.add_argument('--frame', type=int, default=600)
    parser.add_argument('--rank-scale', type=float, default=2.0)
    parser.add_argument('--max-rank', type=int, default=128)
    parser.add_argument('--d-model', type=int, default=128)
    parser.add_argument('--viz-limit', type=int, default=32)
    parser.add_argument('--seed', type=int, default=42, help='Random seed for init; use same as LeafOnly for comparable runs')
    parser.add_argument('--save-attention', action='store_true', default=True, help='Save leaf attention weights every diagnostic step to debug_attention.pt (load in InspectModel if supported)')
