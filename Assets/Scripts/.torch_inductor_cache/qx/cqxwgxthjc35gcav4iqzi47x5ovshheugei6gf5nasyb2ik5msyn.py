...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ty/ctywolethscwekki6d5qddmtg6cvzjima6txc345d7hce5hglon6.py
...
def call(args):
    ...
    assert_size_stride(arg30_1, (1, 48, 32, 33), (50688, 1056, 33, 1))
    assert_size_stride(arg31_1, (1, 48, 32, 33, 4), (202752, 4224, 132, 4, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_24.run(arg31_1, buf71, buf125, 202752, grid=grid(202752), stream=stream0)
        del arg31_1
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        ...
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_28.run(arg30_1, buf70, buf73, buf71, buf76, 12288, 33, grid=grid(12288), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(buf80, buf77, arg30_1, buf79, arg57_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg57_1
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_28.run(arg30_1, buf124, buf127, buf125, buf130, 12288, 33, grid=grid(12288), stream=stream0)
        ...
        triton_poi_fused_clone_31.run(buf134, buf131, arg30_1, buf133, arg65_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg30_1
        del arg65_1
        del buf131
        del buf133
        ...
        # Topologically Sorted Source Nodes: [j_gate], Original ATen: [aten.mul]
        triton_poi_fused_mul_37.run(buf144, arg73_1, 512, grid=grid(512), stream=stream0)
        del arg73_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg30_1 = rand_strided((1, 48, 32, 33), (50688, 1056, 33, 1), device='cuda:0', dtype=torch.float32)
    arg31_1 = rand_strided((1, 48, 32, 33, 4), (202752, 4224, 132, 4, 1), device='cuda:0', dtype=torch.float32)
