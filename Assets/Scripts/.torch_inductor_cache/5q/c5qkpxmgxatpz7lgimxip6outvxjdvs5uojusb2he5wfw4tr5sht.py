...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg52_1
        buf161 = reinterpret_tensor(buf86, (1, 512, 128), (65536, 128, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf60, buf87, arg53_1, arg54_1, arg55_1, buf161, 512, 128, grid=grid(512), stream=stream0)
        del arg54_1
        del arg55_1
        ...
        del arg64_1
        del buf25
        buf98 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        buf103 = reinterpret_tensor(buf70, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf70  # reuse
        buf101 = reinterpret_tensor(buf103, (48, 1, 32, 128), (4224, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_5, kv_2], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_23.run(buf91, arg65_1, buf93, arg66_1, arg67_1, buf98, buf101, 1536, 128, grid=grid(1536), stream=stream0)
        del arg66_1
        del arg67_1
        buf99 = empty_strided_cuda((1536, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (1536, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 384), (1, 128), 0), out=buf99)
        buf102 = reinterpret_tensor(buf103, (48, 1, 1, 128), (4224, 1, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf98, buf102, 6144, 32, grid=grid(6144), stream=stream0)
        del buf101
        del buf102
        buf104 = empty_strided_cuda((1584, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (1584, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 384), (1, 128), 0), out=buf104)
        del arg68_1
        buf105 = reinterpret_tensor(buf98, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf99, arg69_1, buf105, 196608, grid=grid(196608), stream=stream0)
        buf106 = empty_strided_cuda((384, 16, 36), (576, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_26.run(buf104, arg69_1, buf106, 221184, grid=grid(221184), stream=stream0)
        buf107 = empty_strided_cuda((384, 32, 36), (1152, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(reinterpret_tensor(buf105, (384, 32, 16), (512, 16, 1), 0), buf106, out=buf107)
        buf108 = reinterpret_tensor(buf103, (48, 1, 32, 33, 4), (4224, 202752, 132, 4, 1), 0); del buf103  # reuse
        buf143 = empty_strided_cuda((48, 1, 32, 33, 4), (4224, 202752, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_27.run(arg30_1, buf108, buf143, 202752, grid=grid(202752), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf108, 6144, grid=grid(6144), stream=stream0)
        buf110 = empty_strided_cuda((48, 1, 32, 33), (1056, 1056, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf108, buf110, 50688, grid=grid(50688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf110, 1536, grid=grid(1536), stream=stream0)
        buf113 = empty_strided_cuda((48, 1, 32, 33, 8), (8448, 405504, 33, 1, 1056), torch.float32)
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg31_1, buf107, buf110, buf108, buf113, 12288, 33, grid=grid(12288), stream=stream0)
        buf114 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_per_fused__softmax_32.run(buf113, buf114, 12288, 33, grid=grid(12288), stream=stream0)
        buf115 = empty_strided_cuda((48, 1, 32, 33, 4), (4224, 1, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf110, buf108, buf115, 202752, grid=grid(202752), stream=stream0)
        del buf108
        buf116 = empty_strided_cuda((50688, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (50688, 4), (4, 1), 0), reinterpret_tensor(arg70_1, (4, 8), (1, 4), 0), out=buf116)
        del arg70_1
        buf117 = reinterpret_tensor(buf113, (48, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf117, buf114, arg31_1, buf116, arg71_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg71_1
        buf118 = reinterpret_tensor(buf115, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf104, arg69_1, buf118, 202752, grid=grid(202752), stream=stream0)
        del arg69_1
        buf119 = reinterpret_tensor(buf105, (384, 32, 16), (512, 16, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf117, (384, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf118, (384, 33, 16), (528, 16, 1), 0), out=buf119)
        buf120 = empty_strided_cuda((48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf119, buf120, 196608, grid=grid(196608), stream=stream0)
        buf121 = reinterpret_tensor(buf119, (1536, 128), (128, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (1536, 128), (128, 1), 0), reinterpret_tensor(arg72_1, (128, 128), (1, 128), 0), out=buf121)
        del arg72_1
        buf122 = reinterpret_tensor(buf121, (48, 32, 128), (4096, 128, 1), 0); del buf121  # reuse
        buf126 = reinterpret_tensor(buf120, (48, 32, 128), (4096, 128, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf122, buf91, arg65_1, buf93, arg73_1, arg74_1, arg75_1, buf126, 1536, 128, grid=grid(1536), stream=stream0)
        del arg65_1
        del arg73_1
        del arg74_1
        del arg75_1
        buf127 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (1536, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 512), (1, 128), 0), out=buf127)
        del arg76_1
        buf128 = reinterpret_tensor(buf127, (48, 32, 512), (16384, 512, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf128, arg77_1, 786432, grid=grid(786432), stream=stream0)
        del arg77_1
        buf129 = reinterpret_tensor(buf126, (1536, 128), (128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (1536, 512), (512, 1), 0), reinterpret_tensor(arg78_1, (512, 128), (1, 512), 0), out=buf129)
        del arg78_1
        buf133 = reinterpret_tensor(buf93, (48, 32, 128), (4096, 128, 1), 0); del buf93  # reuse
        buf138 = reinterpret_tensor(buf118, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf118  # reuse
        buf136 = reinterpret_tensor(buf138, (48, 1, 32, 128), (4224, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_5, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_39.run(buf122, buf129, arg79_1, arg80_1, arg81_1, buf133, buf136, 1536, 128, grid=grid(1536), stream=stream0)
        del arg80_1
        del arg81_1
        buf134 = buf99; del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf133, (1536, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 384), (1, 128), 0), out=buf134)
        buf137 = reinterpret_tensor(buf138, (48, 1, 1, 128), (4224, 1, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf133, buf137, 6144, 32, grid=grid(6144), stream=stream0)
        del buf136
        del buf137
        buf139 = buf104; del buf104  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf138, (1584, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 384), (1, 128), 0), out=buf139)
        del arg82_1
        buf140 = reinterpret_tensor(buf133, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf134, arg83_1, buf140, 196608, grid=grid(196608), stream=stream0)
        del buf134
        buf141 = buf106; del buf106  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_26.run(buf139, arg83_1, buf141, 221184, grid=grid(221184), stream=stream0)
        buf142 = buf107; del buf107  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(reinterpret_tensor(buf140, (384, 32, 16), (512, 16, 1), 0), buf141, out=buf142)
        del buf141
        ...
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf143, 6144, grid=grid(6144), stream=stream0)
        buf145 = buf110; del buf110  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf143, buf145, 50688, grid=grid(50688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf145, 1536, grid=grid(1536), stream=stream0)
        buf148 = reinterpret_tensor(buf117, (48, 1, 32, 33, 8), (8448, 405504, 33, 1, 1056), 0); del buf117  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg31_1, buf142, buf145, buf143, buf148, 12288, 33, grid=grid(12288), stream=stream0)
        del buf142
        buf149 = buf114; del buf114  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_32.run(buf148, buf149, 12288, 33, grid=grid(12288), stream=stream0)
        buf150 = reinterpret_tensor(buf138, (48, 1, 32, 33, 4), (4224, 1, 132, 4, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf145, buf143, buf150, 202752, grid=grid(202752), stream=stream0)
        del buf143
        del buf145
        buf151 = buf116; del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf150, (50688, 4), (4, 1), 0), reinterpret_tensor(arg84_1, (4, 8), (1, 4), 0), out=buf151)
        del arg84_1
        buf152 = reinterpret_tensor(buf148, (48, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf152, buf149, arg31_1, buf151, arg85_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg31_1
        del arg85_1
        del buf149
        del buf151
        buf153 = reinterpret_tensor(buf150, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf139, arg83_1, buf153, 202752, grid=grid(202752), stream=stream0)
        del arg83_1
        del buf139
        buf154 = reinterpret_tensor(buf140, (384, 32, 16), (512, 16, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf152, (384, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf153, (384, 33, 16), (528, 16, 1), 0), out=buf154)
        del buf152
        del buf153
        buf155 = reinterpret_tensor(buf91, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf154, buf155, 196608, grid=grid(196608), stream=stream0)
        buf156 = reinterpret_tensor(buf154, (1536, 128), (128, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf155, (1536, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 128), (1, 128), 0), out=buf156)
        del arg86_1
        buf157 = reinterpret_tensor(buf156, (48, 32, 128), (4096, 128, 1), 0); del buf156  # reuse
        buf168 = reinterpret_tensor(buf155, (48, 32, 128), (4096, 128, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [x_5, x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf157, buf122, buf129, arg79_1, arg87_1, arg88_1, arg89_1, buf168, 1536, 128, grid=grid(1536), stream=stream0)
        del arg79_1
        del arg87_1
        del arg88_1
        del arg89_1
        del buf122
        del buf129
        buf162 = reinterpret_tensor(buf58, (512, 512), (512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (512, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 512), (1, 128), 0), out=buf162)
        del arg56_1
        buf163 = reinterpret_tensor(buf162, (1, 512, 512), (262144, 512, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf163, arg57_1, 262144, grid=grid(262144), stream=stream0)
        del arg57_1
        buf164 = reinterpret_tensor(buf161, (512, 128), (128, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (512, 512), (512, 1), 0), reinterpret_tensor(arg58_1, (512, 128), (1, 512), 0), out=buf164)
        del arg58_1
        del buf163
        buf165 = reinterpret_tensor(buf164, (1, 512, 128), (65536, 128, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_41.run(buf165, buf60, buf87, arg53_1, arg59_1, 65536, grid=grid(65536), stream=stream0)
        del arg53_1
        del arg59_1
        del buf60
        del buf87
        buf166 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg61_1, reinterpret_tensor(buf165, (512, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf166)
        del arg60_1
        del arg61_1
        ...
        buf169 = reinterpret_tensor(buf128, (1536, 512), (512, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (1536, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 512), (1, 128), 0), out=buf169)
        del arg90_1
        buf170 = reinterpret_tensor(buf169, (48, 32, 512), (16384, 512, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf170, arg91_1, 786432, grid=grid(786432), stream=stream0)
        del arg91_1
        buf171 = reinterpret_tensor(buf168, (1536, 128), (128, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (1536, 512), (512, 1), 0), reinterpret_tensor(arg92_1, (512, 128), (1, 512), 0), out=buf171)
        del arg92_1
        del buf170
        buf172 = reinterpret_tensor(buf171, (48, 32, 128), (4096, 128, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [x_7], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf172, buf157, arg93_1, 196608, grid=grid(196608), stream=stream0)
        del arg93_1
        del buf157
        buf173 = empty_strided_cuda((1536, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf172, (1536, 128), (128, 1), 0), reinterpret_tensor(arg94_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf173)
        del arg94_1
        del arg95_1
        buf174 = empty_strided_cuda((1536, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg97_1, reinterpret_tensor(buf172, (1536, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf174)
        del arg96_1
        del arg97_1
        del buf172
        buf175 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf173, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf174, (48, 32, 32), (1024, 1, 32), 0), out=buf175)
        del buf173
        del buf174
        buf176 = buf166; del buf166  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf165, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf176)
        del arg100_1
        del arg101_1
        buf177 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf165, (512, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf177)
        del arg102_1
        del arg103_1
        buf178 = empty_strided_cuda((512, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (512, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 1), (1, 128), 0), out=buf178)
        del arg98_1
        del buf165
        buf179 = reinterpret_tensor(buf178, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_43.run(buf179, arg99_1, 512, grid=grid(512), stream=stream0)
        del arg99_1
        buf180 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf167, buf175, buf176, buf177, buf179, buf180, 98816, grid=grid(98816), stream=stream0)
        del buf167
        del buf175
        del buf176
        del buf177
