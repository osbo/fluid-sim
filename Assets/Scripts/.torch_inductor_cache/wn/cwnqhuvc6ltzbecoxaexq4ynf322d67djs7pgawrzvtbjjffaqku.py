...
#   %sub : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=4] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg4_1, %mul_2), kwargs = {})
#   %mul_3 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %sub), kwargs = {})
...
#   %mul_4 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg1_1, %div_1), kwargs = {})
#   %add_1 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_4, %sub), kwargs = {})
...
#   %copy__4 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg5_1, %sub), kwargs = {})
...
def partition_0(args):
    ...
    del arg0_1
    buf5 = empty_strided((4736, 1), (1, 4736), device='mps', dtype=torch.float32)
