...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/cv/ccved35ud6eqipbzf4qgtxxzn2n2gqf64tizmcibcbd34sxdbvbc.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf5, arg7_1, buf6, 869760, grid=grid(869760), stream=stream0)
        del buf4
        del buf6
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf14, arg7_1, buf15, 869760, grid=grid(869760), stream=stream0)
        del arg6_1
        del arg7_1
        del buf13
        del buf15
