...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7u/c7ud3t54jxmsegr4lv234zwia2aazjofrsbnpuwvlzmkvzwv2bsi.py
# Topologically Sorted Source Nodes: [mask_base_1, sum_1], Original ATen: [aten.clone, aten.sum]
# Source node to ATen node mapping:
#   mask_base_1 => clone_1
#   sum_1 => sum_1
# Graph fragment:
#   %clone_1 : [num_users=5] = call_function[target=torch.ops.aten.clone.default](args = (%unsqueeze_13,), kwargs = {})
...
def triton_(in_ptr0, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    r1 = rindex
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + (r1 + (129*x0)), None)
    tmp1 = tl.broadcast_to(tmp0, [XBLOCK, RBLOCK])
    tmp3 = tl.sum(tmp1, 1)[:, None]
    tl.store(out_ptr1 + (r1 + (128*x0)), tmp0, None)
    tl.store(out_ptr0 + (x0), tmp3, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/h2/ch2sbnhkamzncmfc5ewgba633kqyumdyrmiqgwbforjhuxbhnlow.py
...
def triton_(in_out_ptr0, in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x1 = (xindex // 128)
    x2 = xindex
    tmp0 = tl.load(in_ptr0 + ((130*x0) + (16512*x1)), None, eviction_policy='evict_last')
    tmp1 = tl.load(in_out_ptr0 + (x2), None)
    tmp2 = 1.0
    tmp3 = tmp1 < tmp2
    tmp4 = tmp3.to(tl.float32)
    tmp5 = triton_helpers.maximum(tmp0, tmp4)
    tl.store(out_ptr0 + ((129*x0) + (16384*x1)), tmp5, None)
''', device_str='cuda')
...
#   %index_put_5 : [num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_7, [None, None, %iota, %iota], %full_default_5), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/er/cermyox3vaeykksoyiwfxtwqsbpokwmqhspg4tgld7ckzt5ibef4.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/tb/ctbyygcmag6i7dbhsng7lniaw4gbx4lvzs5bhiuhob5kk3xtsyb7.py
# Topologically Sorted Source Nodes: [q_f, k_f, v_f, eq_1, logit_bias_1, logit_bias, x_soft], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   eq_1 => eq_1
#   k_f => clone_3
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/zl/czlek7robqprpabrznx4t6knpyyg3khmzd3udzdrnkn2yne6uqdf.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wd/cwdaypg27s3hhjfsntmq3o377vesfzarti2rhbm6mikxm2b423qn.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/72/c7273qea6drxosz3zpdjduhlaidd7m6q46zjsxadepo5w4tr63ze.py
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp7 = tl.load(in_ptr3 + (128 + x6 + (192*x3)), None, eviction_policy='evict_last')
    tmp8 = tl.load(in_ptr4 + (128 + x6), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tmp5 = tmp3 + tmp4
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wh/cwhggtjaubhmomxmbhbfucm5onzqrc2yb3cu4y5iets47cykxazl.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wj/cwjkw6bcwnv6mi4s6kci7355uynyeseaj7iyyjfnvsmnecmw57vu.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/eq/ceqlbmyo26owo35iwipfmfqqlcghanko2sj42sysugyojdhvez3u.py
# Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
# Source node to ATen node mapping:
#   row_sum_1 => full_default_8
# Graph fragment:
#   %full_default_8 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/g4/cg4uiyhvmd2tdpruwroouhnk654edm5h7sjkw6r6ampjzvvaqfc2.py
...
#   %full_default_9 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_2 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_3 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, out_ptr2, out_ptr3, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp19 = tl.load(in_ptr4 + (x0 + (8192*tmp10)), None)
    tmp20 = tl.load(in_ptr4 + (x0 + (8192*tmp16)), None)
    tl.atomic_add(out_ptr0 + (x0 + (8192*tmp4)), tmp12, None, sem='relaxed')
    tl.atomic_add(out_ptr1 + (x0 + (8192*tmp4)), tmp18, None, sem='relaxed')
    tl.atomic_add(out_ptr2 + (x0 + (8192*tmp4)), tmp19, None, sem='relaxed')
    tl.atomic_add(out_ptr3 + (x0 + (8192*tmp4)), tmp20, None, sem='relaxed')
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/c6/cc6ax4vi3vehb257teioh73gldp3u75qbtuhqravqve2ovpo4cfl.py
# Topologically Sorted Source Nodes: [h_off_3, layer_norm_3, off_prep_block], Original ATen: [aten.mean, aten.native_layer_norm]
# Source node to ATen node mapping:
#   h_off_3 => mean_7
...
# Graph fragment:
#   %full_default_10 : [num_users=5] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 64, 64], 1.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %index_put_9 : [num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_12, [None, None, %iota_1, %iota_1], %full_default_12), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/yh/cyho7h36nidbl7zavr5c6hlrptidcxgnfnxq5moszazjrkg2537u.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/az/cazoldwz6rjiwwfqqaj3xwhfxhkkt4gddbd7ezertjqptdjggebk.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   eq_3 => eq_3
#   k_f_1 => clone_11
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/cp/ccptizaatsguqgw34zny7qkj3u5pv2dxcgdlfn25vdfpcugv4lva.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/zl/czl5rozb3zbqlitmvugaslxbz4rqc6auezpmua43gwgc2r4jwfl7.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_mul_39', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sh/cshqhof4f7q5py3qejrho2nrykzxr6b7wyxzkhpsqz47kokg2mrs.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/i3/ci3lsqeh2s4bxyr74unmevrhogkpi7laxjast3jemeotoyefoyak.py
...
# Graph fragment:
#   %full_default_19 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_20 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
triton_poi_fused_index_index_add_zeros_42 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sq/csqdxrus4kvppq4yedwjsuun4r7vg5diwllfs25qdvpnq2wn67xv.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5n/c5nkkt7e3667xgerk3t5225d24gvb7rdk3mvjjyu6bwcuzdrkmxh.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/62/c62jvajs6fjbhwsi4l6whimciah3fkmqhgj3jlnvxalakzacasgn.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/c7/cc7apk5opnjeawkroueew6636zkc7yjawdtmdjhzt5nk3nhttcoe.py
...
def call(args):
    ...
    assert_size_stride(arg38_1, (192, 64), (64, 1))
    ...
    assert_size_stride(arg44_1, (8, 64), (64, 1))
    ...
    assert_size_stride(arg56_1, (192, 64), (64, 1))
    ...
    assert_size_stride(arg62_1, (8, 64), (64, 1))
    ...
    assert_size_stride(arg74_1, (192, 64), (64, 1))
    ...
    assert_size_stride(arg80_1, (8, 64), (64, 1))
    ...
    assert_size_stride(arg92_1, (192, 64), (64, 1))
    ...
    assert_size_stride(arg98_1, (8, 64), (64, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [layer_norm_1], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_6.run(buf25, arg36_1, arg37_1, buf29, 4096, 64, grid=grid(4096), stream=stream0)
        del arg36_1
        del arg37_1
        buf30 = empty_strided_cuda((4096, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf29, (4096, 64), (64, 1), 0), reinterpret_tensor(arg38_1, (64, 192), (1, 64), 0), out=buf30)
        buf31 = empty_strided_cuda((1, 32, 128), (4096, 128, 1), torch.float32)
        buf32 = reinterpret_tensor(buf17, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf17  # reuse
        # Topologically Sorted Source Nodes: [mask_base_1, sum_1], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_7.run(arg29_1, buf31, buf32, 4096, 128, grid=grid(4096), stream=stream0)
        buf33 = buf31; del buf31  # reuse
        # Topologically Sorted Source Nodes: [lt, _need_diag, maximum, copy_], Original ATen: [aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_poi_fused__to_copy_copy_lt_maximum_8.run(buf33, arg29_1, buf32, 4096, grid=grid(4096), stream=stream0)
        buf35 = empty_strided_cuda((1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [bias_physics], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(arg28_1, buf35, 2097152, grid=grid(2097152), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics, setitem], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_10.run(buf35, 16384, grid=grid(16384), stream=stream0)
        buf37 = empty_strided_cuda((1, 32, 128, 128), (524288, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_1], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(buf35, buf37, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_1], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf37, 4096, grid=grid(4096), stream=stream0)
        buf39 = reinterpret_tensor(buf12, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf12  # reuse
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, eq_1, logit_bias_1, logit_bias, x_soft], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_13.run(buf30, arg39_1, buf39, 262144, grid=grid(262144), stream=stream0)
        buf40 = empty_strided_cuda((32, 8, 128, 8), (8192, 1024, 8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, eq_1, logit_bias_1, logit_bias, x_soft], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_14.run(buf30, arg39_1, buf40, 262144, grid=grid(262144), stream=stream0)
        buf41 = empty_strided_cuda((32, 8, 128, 8), (8192, 1024, 8, 1), torch.float32)
        buf53 = empty_strided_cuda((32, 8, 128, 1, 8, 1), (8192, 1024, 8, 8, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, eq_1, logit_bias_1, logit_bias, x_soft, einsum], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_15.run(buf30, arg39_1, buf41, buf53, 262144, grid=grid(262144), stream=stream0)
        buf48 = empty_strided_cuda((1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf37, buf35, buf48, 2097152, grid=grid(2097152), stream=stream0)
        buf49 = empty_strided_cuda((524288, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf48, (524288, 4), (4, 1), 0), reinterpret_tensor(arg40_1, (4, 16), (1, 4), 0), out=buf49)
        del arg40_1
        buf50 = reinterpret_tensor(buf49, (1, 32, 128, 128, 16), (8388608, 262144, 2048, 16, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_17.run(buf50, arg41_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg41_1
        buf51 = empty_strided_cuda((524288, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf50, (524288, 16), (16, 1), 0), reinterpret_tensor(arg42_1, (16, 8), (1, 16), 0), out=buf51)
        del arg42_1
        buf42 = empty_strided_cuda((32, 8, 128, 128), (131072, 16384, 128, 1), torch.float32)
        buf52 = empty_strided_cuda((32, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, eq_1, logit_bias_1, logit_bias, x_soft, einsum], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_18.run(buf32, buf37, buf35, buf51, arg43_1, buf42, buf52, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg43_1
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, eq_1, logit_bias_1, logit_bias, x_soft], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        ...
        buf44 = buf43[0]
        del buf43
        buf54 = reinterpret_tensor(buf41, (256, 128, 8), (1024, 8, 1), 0); del buf41  # reuse
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf52, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf53, (256, 128, 8), (1024, 8, 1), 0), out=buf54)
        buf55 = empty_strided_cuda((4096, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf29, (4096, 64), (64, 1), 0), reinterpret_tensor(arg44_1, (64, 8), (1, 64), 0), out=buf55)
        del arg44_1
        buf56 = empty_strided_cuda((1, 32, 1, 64), (2048, 64, 2048, 1), torch.float32)
        buf57 = reinterpret_tensor(buf56, (1, 32, 1, 64), (2048, 64, 64, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [diag_prep_block], Original ATen: [aten.mean]
        triton_red_fused_mean_19.run(buf57, buf25, 2048, 128, grid=grid(2048), stream=stream0)
        buf58 = empty_strided_cuda((32, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (32, 64), (64, 1), 0), reinterpret_tensor(arg38_1, (64, 192), (1, 64), 0), out=buf58)
        del arg38_1
        buf59 = reinterpret_tensor(buf44, (1, 32, 128, 8, 8), (262144, 8192, 64, 8, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [x_mid, mul_2, x_mid_1], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_20.run(buf59, buf54, buf55, arg45_1, buf58, arg39_1, 262144, grid=grid(262144), stream=stream0)
        del arg39_1
        del arg45_1
        buf60 = reinterpret_tensor(buf54, (4096, 64), (64, 1), 0); del buf54  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (4096, 64), (64, 1), 0), reinterpret_tensor(arg46_1, (64, 64), (1, 64), 0), out=buf60)
        del arg46_1
        buf65 = reinterpret_tensor(buf59, (1, 4096, 64), (262144, 64, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf60, arg47_1, arg48_1, arg49_1, buf65, 4096, 64, grid=grid(4096), stream=stream0)
        del arg48_1
        del arg49_1
        buf64 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf64.copy_(arg34_1)
        del arg34_1
        buf66 = empty_strided_cuda((4096, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf65, (4096, 64), (64, 1), 0), reinterpret_tensor(arg50_1, (64, 256), (1, 64), 0), out=buf66)
        del arg50_1
        buf67 = reinterpret_tensor(buf66, (1, 4096, 256), (1048576, 256, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf67, arg51_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg51_1
        buf68 = reinterpret_tensor(buf65, (4096, 64), (64, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (4096, 256), (256, 1), 0), reinterpret_tensor(arg52_1, (256, 64), (1, 256), 0), out=buf68)
        del arg52_1
        buf69 = reinterpret_tensor(buf68, (1, 4096, 64), (262144, 64, 1), 0); del buf68  # reuse
        buf122 = buf29; del buf29  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_22.run(buf69, buf25, buf60, arg47_1, arg53_1, arg72_1, arg73_1, buf122, 4096, 64, grid=grid(4096), stream=stream0)
        del arg47_1
        del arg53_1
        del arg72_1
        del arg73_1
        buf70 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf70.copy_(arg32_1)
        del arg32_1
        buf71 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf71, 892928, grid=grid(892928), stream=stream0)
        buf107 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf107, 892928, grid=grid(892928), stream=stream0)
        buf109 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf109, 892928, grid=grid(892928), stream=stream0)
        buf73 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf73.copy_(arg33_1)
        del arg33_1
        buf74 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf74, 892928, grid=grid(892928), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_21, index_add__4, col_sum_1, getitem_22, index_add__5, row_sum, getitem_12, index_add__2, col_sum, getitem_13, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_24.run(buf64, buf70, buf69, buf73, buf25, buf71, buf74, buf107, buf109, 1458176, grid=grid(1458176), stream=stream0)
        buf76 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        buf80 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        buf111 = empty_strided_cuda((109, 1, 1, 64), (64, 6976, 6976, 1), torch.float32)
        buf112 = reinterpret_tensor(buf111, (109, 1, 1, 64), (64, 1, 6976, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3, off_prep_block], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_25.run(buf112, buf71, arg35_1, buf74, arg54_1, arg55_1, buf107, buf109, buf76, buf80, 6976, 64, grid=grid(6976), stream=stream0)
        del arg54_1
        del arg55_1
        del buf107
        del buf109
        buf81 = empty_strided_cuda((6976, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf80, (6976, 64), (64, 1), 0), reinterpret_tensor(arg56_1, (64, 192), (1, 64), 0), out=buf81)
        buf83 = empty_strided_cuda((109, 1, 64, 64), (4096, 4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mask_base_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf83, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2, lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.clone, aten.sum, aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_27.run(buf83, 6976, 64, grid=grid(6976), stream=stream0)
        buf85 = empty_strided_cuda((109, 64, 65, 4), (16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_28.run(arg30_1, buf85, 1813760, grid=grid(1813760), stream=stream0)
        del arg30_1
        buf86 = empty_strided_cuda((109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf85, buf86, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_30.run(buf86, 27904, grid=grid(27904), stream=stream0)
        buf88 = empty_strided_cuda((109, 1, 64, 64), (4096, 4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf86, buf88, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf88, 6976, grid=grid(6976), stream=stream0)
        buf90 = empty_strided_cuda((109, 8, 64, 8), (4096, 512, 8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf81, arg57_1, buf90, 446464, grid=grid(446464), stream=stream0)
        buf91 = empty_strided_cuda((109, 8, 64, 8), (4096, 512, 8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf81, arg57_1, buf91, 446464, grid=grid(446464), stream=stream0)
        buf92 = empty_strided_cuda((109, 8, 64, 8), (4096, 512, 8, 1), torch.float32)
        buf104 = empty_strided_cuda((109, 8, 64, 1, 8, 1), (4096, 512, 8, 8, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_35.run(buf81, arg57_1, buf92, buf104, 446464, grid=grid(446464), stream=stream0)
        buf99 = empty_strided_cuda((109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf88, buf86, buf99, 1785856, grid=grid(1785856), stream=stream0)
        buf100 = empty_strided_cuda((446464, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (446464, 4), (4, 1), 0), reinterpret_tensor(arg58_1, (4, 16), (1, 4), 0), out=buf100)
        del arg58_1
        buf101 = reinterpret_tensor(buf100, (109, 1, 64, 64, 16), (65536, 1, 1024, 16, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf101, arg59_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg59_1
        buf102 = empty_strided_cuda((446464, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (446464, 16), (16, 1), 0), reinterpret_tensor(arg60_1, (16, 8), (1, 16), 0), out=buf102)
        del arg60_1
        buf93 = empty_strided_cuda((109, 8, 64, 64), (32768, 4096, 64, 1), torch.float32)
        buf103 = empty_strided_cuda((109, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_38.run(buf83, buf88, buf86, buf102, arg61_1, buf93, buf103, 872, 4096, grid=grid(872, 4096), stream=stream0)
        del arg61_1
        del buf83
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        buf94 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf90, buf91, buf92, buf93, False)
        buf95 = buf94[0]
        del buf94
        buf105 = reinterpret_tensor(buf92, (872, 64, 8), (512, 8, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf103, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf104, (872, 64, 8), (512, 8, 1), 0), out=buf105)
        buf106 = empty_strided_cuda((6976, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf80, (6976, 64), (64, 1), 0), reinterpret_tensor(arg62_1, (64, 8), (1, 64), 0), out=buf106)
        del arg62_1
        buf113 = empty_strided_cuda((109, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (109, 64), (64, 1), 0), reinterpret_tensor(arg56_1, (64, 192), (1, 64), 0), out=buf113)
        del arg56_1
        buf114 = reinterpret_tensor(buf95, (109, 1, 64, 8, 8), (4096, 1, 64, 8, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2, mul_3, x_mid_3], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_39.run(buf114, buf105, buf106, arg63_1, buf113, arg57_1, 446464, grid=grid(446464), stream=stream0)
        del arg57_1
        del arg63_1
        buf115 = reinterpret_tensor(buf105, (6976, 64), (64, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (6976, 64), (64, 1), 0), reinterpret_tensor(arg64_1, (64, 64), (1, 64), 0), out=buf115)
        del arg64_1
        buf164 = reinterpret_tensor(buf114, (109, 64, 64), (4096, 64, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf76, buf115, arg65_1, arg66_1, arg67_1, buf164, 6976, 64, grid=grid(6976), stream=stream0)
        del arg66_1
        del arg67_1
        buf123 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (4096, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 192), (1, 64), 0), out=buf123)
        buf124 = buf33; del buf33  # reuse
        buf125 = buf37; del buf37  # reuse
        # Topologically Sorted Source Nodes: [mask_base_4, sum_3], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_7.run(arg29_1, buf124, buf125, 4096, 128, grid=grid(4096), stream=stream0)
        ...
        triton_poi_fused__to_copy_copy_lt_maximum_8.run(buf126, arg29_1, buf125, 4096, grid=grid(4096), stream=stream0)
        del arg29_1
        buf128 = buf35; del buf35  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(arg28_1, buf128, 2097152, grid=grid(2097152), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_2, setitem_4], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_10.run(buf128, 16384, grid=grid(16384), stream=stream0)
        buf130 = buf32; del buf32  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(buf128, buf130, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf130, 4096, grid=grid(4096), stream=stream0)
        buf132 = reinterpret_tensor(buf25, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf25  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_13.run(buf123, arg75_1, buf132, 262144, grid=grid(262144), stream=stream0)
        buf133 = reinterpret_tensor(buf60, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_14.run(buf123, arg75_1, buf133, 262144, grid=grid(262144), stream=stream0)
        buf134 = reinterpret_tensor(buf53, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf53  # reuse
        buf146 = reinterpret_tensor(buf40, (32, 8, 128, 1, 8, 1), (8192, 1024, 8, 8, 1, 1), 0); del buf40  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_15.run(buf123, arg75_1, buf134, buf146, 262144, grid=grid(262144), stream=stream0)
        del buf123
        buf141 = buf48; del buf48  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf130, buf128, buf141, 2097152, grid=grid(2097152), stream=stream0)
        buf142 = reinterpret_tensor(buf50, (524288, 16), (16, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (524288, 4), (4, 1), 0), reinterpret_tensor(arg76_1, (4, 16), (1, 4), 0), out=buf142)
        del arg76_1
        del buf141
        buf143 = reinterpret_tensor(buf142, (1, 32, 128, 128, 16), (8388608, 262144, 2048, 16, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_17.run(buf143, arg77_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg77_1
        buf144 = reinterpret_tensor(buf52, (524288, 8), (8, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf143, (524288, 16), (16, 1), 0), reinterpret_tensor(arg78_1, (16, 8), (1, 16), 0), out=buf144)
        del arg78_1
        del buf143
        buf135 = buf42; del buf42  # reuse
        buf145 = reinterpret_tensor(buf51, (32, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4, einsum_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_18.run(buf125, buf130, buf128, buf144, arg79_1, buf135, buf145, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg79_1
        del buf128
        del buf144
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        buf136 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf132, buf133, buf134, buf135, False)
        del buf132
        del buf133
        del buf135
        buf137 = buf136[0]
        del buf136
        buf147 = reinterpret_tensor(buf134, (256, 128, 8), (1024, 8, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf145, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf146, (256, 128, 8), (1024, 8, 1), 0), out=buf147)
        del buf145
        del buf146
        buf148 = buf55; del buf55  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (4096, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 8), (1, 64), 0), out=buf148)
        del arg80_1
        del buf122
        buf149 = buf58; del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (32, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 192), (1, 64), 0), out=buf149)
        del arg74_1
        del buf57
        buf150 = reinterpret_tensor(buf137, (1, 32, 128, 8, 8), (262144, 8192, 64, 8, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4, mul_4, x_mid_5], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_20.run(buf150, buf147, buf148, arg81_1, buf149, arg75_1, 262144, grid=grid(262144), stream=stream0)
        del arg75_1
        del arg81_1
        del buf148
        del buf149
        buf151 = reinterpret_tensor(buf147, (4096, 64), (64, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf150, (4096, 64), (64, 1), 0), reinterpret_tensor(arg82_1, (64, 64), (1, 64), 0), out=buf151)
        del arg82_1
        buf155 = reinterpret_tensor(buf150, (1, 4096, 64), (262144, 64, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf69, buf151, arg83_1, arg84_1, arg85_1, buf155, 4096, 64, grid=grid(4096), stream=stream0)
        del arg84_1
        del arg85_1
        buf156 = reinterpret_tensor(buf67, (4096, 256), (256, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf155, (4096, 64), (64, 1), 0), reinterpret_tensor(arg86_1, (64, 256), (1, 64), 0), out=buf156)
        del arg86_1
        buf157 = reinterpret_tensor(buf156, (1, 4096, 256), (1048576, 256, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf157, arg87_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg87_1
        buf158 = reinterpret_tensor(buf155, (4096, 64), (64, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf157, (4096, 256), (256, 1), 0), reinterpret_tensor(arg88_1, (256, 64), (1, 256), 0), out=buf158)
        del arg88_1
        del buf157
        buf159 = reinterpret_tensor(buf158, (1, 4096, 64), (262144, 64, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_41.run(buf159, buf69, buf151, arg83_1, arg89_1, 262144, grid=grid(262144), stream=stream0)
        del arg83_1
        del arg89_1
        buf160 = buf74; del buf74  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf160, 892928, grid=grid(892928), stream=stream0)
        buf162 = buf71; del buf71  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf162, 892928, grid=grid(892928), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_37, index_add__6, col_sum_2, getitem_38, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_42.run(buf64, buf70, buf159, buf73, buf160, buf162, 1458176, grid=grid(1458176), stream=stream0)
        buf165 = reinterpret_tensor(buf86, (6976, 256), (256, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf164, (6976, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 256), (1, 64), 0), out=buf165)
        del arg68_1
        buf166 = reinterpret_tensor(buf165, (109, 64, 256), (16384, 256, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_43.run(buf166, arg69_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg69_1
        buf167 = reinterpret_tensor(buf164, (6976, 64), (64, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf166, (6976, 256), (256, 1), 0), reinterpret_tensor(arg70_1, (256, 64), (1, 256), 0), out=buf167)
        del arg70_1
        buf168 = reinterpret_tensor(buf167, (109, 64, 64), (4096, 64, 1), 0); del buf167  # reuse
        buf172 = buf80; del buf80  # reuse
        # Topologically Sorted Source Nodes: [x_2, h_off_5, x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_44.run(buf168, buf160, arg35_1, buf162, buf76, buf115, arg65_1, arg71_1, arg90_1, arg91_1, buf172, 6976, 64, grid=grid(6976), stream=stream0)
        del arg35_1
        del arg65_1
        del arg71_1
        del arg90_1
        ...
        del buf160
        del buf162
        buf173 = buf81; del buf81  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (6976, 64), (64, 1), 0), reinterpret_tensor(arg92_1, (64, 192), (1, 64), 0), out=buf173)
        buf175 = reinterpret_tensor(buf76, (109, 1, 64, 64), (4096, 4096, 64, 1), 0); del buf76  # reuse
        # Topologically Sorted Source Nodes: [mask_base_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf175, 446464, grid=grid(446464), stream=stream0)
        ...
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_27.run(buf175, 6976, 64, grid=grid(6976), stream=stream0)
        buf177 = reinterpret_tensor(buf166, (109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf85, buf177, 1785856, grid=grid(1785856), stream=stream0)
        del buf85
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_30.run(buf177, 27904, grid=grid(27904), stream=stream0)
        buf179 = reinterpret_tensor(buf115, (109, 1, 64, 64), (4096, 4096, 64, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf177, buf179, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf179, 6976, grid=grid(6976), stream=stream0)
        buf181 = reinterpret_tensor(buf104, (109, 8, 64, 8), (4096, 512, 8, 1), 0); del buf104  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf173, arg93_1, buf181, 446464, grid=grid(446464), stream=stream0)
        buf182 = buf91; del buf91  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf173, arg93_1, buf182, 446464, grid=grid(446464), stream=stream0)
        buf183 = buf90; del buf90  # reuse
        buf195 = reinterpret_tensor(buf88, (109, 8, 64, 1, 8, 1), (4096, 512, 8, 8, 1, 1), 0); del buf88  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_35.run(buf173, arg93_1, buf183, buf195, 446464, grid=grid(446464), stream=stream0)
        del buf173
        buf190 = buf99; del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf179, buf177, buf190, 1785856, grid=grid(1785856), stream=stream0)
        buf191 = reinterpret_tensor(buf101, (446464, 16), (16, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf190, (446464, 4), (4, 1), 0), reinterpret_tensor(arg94_1, (4, 16), (1, 4), 0), out=buf191)
        del arg94_1
        del buf190
        buf192 = reinterpret_tensor(buf191, (109, 1, 64, 64, 16), (65536, 1, 1024, 16, 1), 0); del buf191  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf192, arg95_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg95_1
        buf193 = reinterpret_tensor(buf103, (446464, 8), (8, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf192, (446464, 16), (16, 1), 0), reinterpret_tensor(arg96_1, (16, 8), (1, 16), 0), out=buf193)
        del arg96_1
        del buf192
        buf184 = buf93; del buf93  # reuse
        buf194 = reinterpret_tensor(buf102, (109, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6, einsum_3], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_38.run(buf175, buf179, buf177, buf193, arg97_1, buf184, buf194, 872, 4096, grid=grid(872, 4096), stream=stream0)
        del arg97_1
        del buf175
        del buf179
        del buf193
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        buf185 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf181, buf182, buf183, buf184, False)
        del buf181
        del buf182
        del buf184
        buf186 = buf185[0]
        del buf185
        buf196 = reinterpret_tensor(buf183, (872, 64, 8), (512, 8, 1), 0); del buf183  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf194, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf195, (872, 64, 8), (512, 8, 1), 0), out=buf196)
        del buf194
        del buf195
        buf197 = buf106; del buf106  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (6976, 64), (64, 1), 0), reinterpret_tensor(arg98_1, (64, 8), (1, 64), 0), out=buf197)
        del arg98_1
        del buf172
        buf198 = buf113; del buf113  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (109, 64), (64, 1), 0), reinterpret_tensor(arg92_1, (64, 192), (1, 64), 0), out=buf198)
        del arg92_1
        del buf112
        buf199 = reinterpret_tensor(buf186, (109, 1, 64, 8, 8), (4096, 1, 64, 8, 1), 0); del buf186  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6, mul_5, x_mid_7], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_39.run(buf199, buf196, buf197, arg99_1, buf198, arg93_1, 446464, grid=grid(446464), stream=stream0)
        del arg93_1
        del arg99_1
        del buf197
        del buf198
        buf200 = reinterpret_tensor(buf196, (6976, 64), (64, 1), 0); del buf196  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf199, (6976, 64), (64, 1), 0), reinterpret_tensor(arg100_1, (64, 64), (1, 64), 0), out=buf200)
        del arg100_1
        buf206 = reinterpret_tensor(buf199, (109, 64, 64), (4096, 64, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf168, buf200, arg101_1, arg102_1, arg103_1, buf206, 6976, 64, grid=grid(6976), stream=stream0)
        del arg102_1
        del arg103_1
        buf204 = reinterpret_tensor(buf130, (4096, 128), (128, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf159, (4096, 64), (64, 1), 0), reinterpret_tensor(arg108_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf204)
        del arg108_1
        del arg109_1
        buf205 = reinterpret_tensor(buf125, (32, 128, 128), (16384, 128, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf204, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf204, (32, 128, 128), (16384, 1, 128), 0), out=buf205)
        del buf204
        buf207 = reinterpret_tensor(buf177, (6976, 256), (256, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf206, (6976, 64), (64, 1), 0), reinterpret_tensor(arg104_1, (64, 256), (1, 64), 0), out=buf207)
        del arg104_1
        buf208 = reinterpret_tensor(buf207, (109, 64, 256), (16384, 256, 1), 0); del buf207  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_43.run(buf208, arg105_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg105_1
        buf209 = reinterpret_tensor(buf206, (6976, 64), (64, 1), 0); del buf206  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf208, (6976, 256), (256, 1), 0), reinterpret_tensor(arg106_1, (256, 64), (1, 256), 0), out=buf209)
        del arg106_1
        del buf208
        buf210 = reinterpret_tensor(buf209, (109, 64, 64), (4096, 64, 1), 0); del buf209  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_45.run(buf210, buf168, buf200, arg101_1, arg107_1, 446464, grid=grid(446464), stream=stream0)
        del arg101_1
        del arg107_1
        buf211 = buf200; del buf200  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf210, (6976, 64), (64, 1), 0), reinterpret_tensor(arg110_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf211)
        del arg110_1
        del arg111_1
        buf212 = reinterpret_tensor(buf168, (6976, 64), (64, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg113_1, reinterpret_tensor(buf210, (6976, 64), (64, 1), 0), reinterpret_tensor(arg112_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf212)
        del arg112_1
        del arg113_1
        buf213 = buf210; del buf210  # reuse
        # Topologically Sorted Source Nodes: [out_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf211, (109, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf212, (109, 64, 64), (4096, 1, 64), 0), out=buf213)
        del buf211
        del buf212
        buf214 = reinterpret_tensor(buf69, (4096, 64), (64, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf159, (4096, 64), (64, 1), 0), reinterpret_tensor(arg116_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf214)
        del arg116_1
        del arg117_1
        buf215 = buf151; del buf151  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf159, (4096, 64), (64, 1), 0), reinterpret_tensor(arg118_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf215)
        del arg118_1
        del arg119_1
        buf216 = reinterpret_tensor(buf126, (4096, 1), (1, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (4096, 64), (64, 1), 0), reinterpret_tensor(arg114_1, (64, 1), (1, 64), 0), out=buf216)
        del arg114_1
        del buf159
        buf217 = reinterpret_tensor(buf216, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf216  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_46.run(buf217, arg115_1, 4096, grid=grid(4096), stream=stream0)
        del arg115_1
        buf218 = empty_strided_cuda((1, 1499136), (1499136, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_47.run(buf205, buf213, buf214, buf215, buf217, buf218, 1499136, grid=grid(1499136), stream=stream0)
        del buf205
        del buf213
        del buf214
        del buf215
    return (buf218, reinterpret_tensor(buf217, (1, 32, 128), (4096, 128, 1), 0), buf70, buf73, buf64, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg32_1 = rand_strided((178, ), (1, ), device='cpu', dtype=torch.int64)
    arg33_1 = rand_strided((178, ), (1, ), device='cpu', dtype=torch.int64)
    arg34_1 = rand_strided((178, ), (1, ), device='cpu', dtype=torch.int64)
    ...
    arg38_1 = rand_strided((192, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg44_1 = rand_strided((8, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg56_1 = rand_strided((192, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg62_1 = rand_strided((8, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg74_1 = rand_strided((192, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg80_1 = rand_strided((8, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg92_1 = rand_strided((192, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg98_1 = rand_strided((8, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg110_1 = rand_strided((64, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg114_1 = rand_strided((1, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    arg115_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg116_1 = rand_strided((64, 64), (64, 1), device='cuda:0', dtype=torch.float32)
