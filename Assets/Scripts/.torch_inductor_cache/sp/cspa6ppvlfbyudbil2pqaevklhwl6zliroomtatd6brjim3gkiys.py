...
#   %index_4 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_59, [%device_put]), kwargs = {})
#   %index_put_10 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_16, [%device_put_2], %index_4, True), kwargs = {})
...
#   %index_5 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_59, [%device_put_1]), kwargs = {})
#   %index_put_11 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_17, [%device_put_2], %index_5, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf106 = empty_strided_cuda((1, 16, 33, 33, 4), (70144, 4384, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem, setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(arg28_1, buf38, buf106, 69696, grid=grid(69696), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        buf101 = empty_strided_cuda((1, 528, 128), (67584, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_23.run(buf61, buf29, buf52, arg39_1, arg45_1, arg64_1, arg65_1, buf101, 528, 128, grid=grid(528), stream=stream0)
        del arg39_1
        del arg45_1
        del arg64_1
        del arg65_1
        ...
        buf102 = buf34; del buf34  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (528, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf102)
        del arg66_1
        buf103 = reinterpret_tensor(buf101, (16, 8, 33, 16, 1, 1), (4224, 528, 16, 1, 1, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf102, arg67_1, buf103, 67584, grid=grid(67584), stream=stream0)
        buf104 = reinterpret_tensor(buf52, (16, 8, 16, 1, 33, 1), (4224, 528, 33, 33, 1, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf102, arg67_1, buf104, 2048, 33, grid=grid(2048, 33), stream=stream0)
        buf105 = reinterpret_tensor(buf47, (128, 33, 33), (1089, 33, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf103, (128, 33, 16), (528, 16, 1), 0), reinterpret_tensor(buf104, (128, 16, 33), (528, 33, 1), 0), out=buf105)
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf106, 2112, grid=grid(2112), stream=stream0)
        buf108 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf106, buf108, 17424, grid=grid(17424), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf108, 528, grid=grid(528), stream=stream0)
        buf111 = reinterpret_tensor(buf48, (1, 16, 33, 33, 8), (143360, 8960, 33, 1, 1120), 0); del buf48  # reuse
        buf112 = buf44; del buf44  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_15.run(arg29_1, buf105, buf108, buf106, buf111, buf112, 4224, 33, grid=grid(4224), stream=stream0)
        buf113 = buf45; del buf45  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf108, buf106, buf113, 69696, grid=grid(69696), stream=stream0)
        del buf106
        del buf108
        buf114 = buf46; del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf113, buf114, 69696, grid=grid(69696), stream=stream0)
        del buf113
        buf115 = reinterpret_tensor(buf105, (17424, 8), (8, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf114, reinterpret_tensor(arg68_1, (4, 8), (1, 4), 0), out=buf115)
        del arg68_1
        del buf114
        buf116 = reinterpret_tensor(buf111, (16, 8, 33, 33, 1, 1), (8960, 1120, 33, 1, 1, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf116, buf112, arg29_1, buf115, arg69_1, 128, 1089, grid=grid(128, 1089), stream=stream0)
        del arg29_1
        del arg69_1
        del buf112
        del buf115
        buf117 = reinterpret_tensor(buf104, (16, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf102, arg67_1, buf117, 67584, grid=grid(67584), stream=stream0)
        del arg67_1
        buf118 = reinterpret_tensor(buf103, (128, 33, 16), (528, 16, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf116, (128, 33, 33), (1120, 33, 1), 0), reinterpret_tensor(buf117, (128, 33, 16), (528, 16, 1), 0), out=buf118)
        del buf116
        buf119 = reinterpret_tensor(buf117, (1, 16, 33, 8, 16), (67584, 4224, 128, 16, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_20.run(buf118, buf119, 67584, grid=grid(67584), stream=stream0)
        buf120 = reinterpret_tensor(buf118, (528, 128), (128, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (528, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 128), (1, 128), 0), out=buf120)
        del arg70_1
        buf124 = reinterpret_tensor(buf119, (1, 528, 128), (67584, 128, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_21.run(buf61, buf120, arg71_1, arg72_1, arg73_1, buf124, 528, 128, grid=grid(528), stream=stream0)
        del arg72_1
        del arg73_1
        buf125 = reinterpret_tensor(buf59, (528, 512), (512, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (528, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 512), (1, 128), 0), out=buf125)
        del arg74_1
        buf126 = reinterpret_tensor(buf125, (1, 528, 512), (270336, 512, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf126, arg75_1, 270336, grid=grid(270336), stream=stream0)
        del arg75_1
        buf127 = reinterpret_tensor(buf124, (528, 128), (128, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (528, 512), (512, 1), 0), reinterpret_tensor(arg76_1, (512, 128), (1, 512), 0), out=buf127)
        del arg76_1
        del buf126
        buf128 = reinterpret_tensor(buf127, (1, 528, 128), (67584, 128, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_25.run(buf128, buf61, buf120, arg71_1, arg77_1, 67584, grid=grid(67584), stream=stream0)
        del arg71_1
        del arg77_1
        del buf120
        buf129 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf129, 196608, grid=grid(196608), stream=stream0)
        buf131 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf131, 196608, grid=grid(196608), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [row_sum, getitem_14, index_add__2, col_sum, getitem_15, index_add__3, row_sum_1, getitem_27, index_add__4, col_sum_1, getitem_28, index_add__5], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_26.run(buf56, buf62, buf61, buf65, buf128, buf63, buf66, buf129, buf131, 270336, grid=grid(270336), stream=stream0)
        del buf61
        buf133 = empty_strided_cuda((48, 1, 1, 128), (128, 6144, 6144, 1), torch.float32)
        buf71 = reinterpret_tensor(buf102, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf102  # reuse
        ...
        # Topologically Sorted Source Nodes: [mean_1, cat_4, mean_2], Original ATen: [aten.mean, aten.cat]
        triton_per_fused_cat_mean_27.run(buf63, arg49_1, buf66, buf129, buf131, buf133, buf70, buf69, 6144, 32, grid=grid(6144), stream=stream0)
        del buf63
        del buf66
        buf75 = empty_strided_cuda((48, 33, 128), (4224, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_28.run(buf71, arg50_1, arg51_1, buf75, 1584, 128, grid=grid(1584), stream=stream0)
        del arg50_1
        del arg51_1
        del buf69
        del buf70
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_29.run(buf76, arg53_1, buf77, 221184, grid=grid(221184), stream=stream0)
        buf78 = empty_strided_cuda((384, 16, 36), (576, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_30.run(buf76, arg53_1, buf78, 221184, grid=grid(221184), stream=stream0)
        ...
        buf147 = empty_strided_cuda((48, 1, 33, 33, 4), (4384, 210432, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_2, setitem_6], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(arg30_1, buf80, buf147, 209088, grid=grid(209088), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf80, 6336, grid=grid(6336), stream=stream0)
        buf82 = empty_strided_cuda((48, 1, 33, 33), (1120, 53760, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf80, buf82, 52272, grid=grid(52272), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf82, 1584, grid=grid(1584), stream=stream0)
        buf85 = empty_strided_cuda((48, 1, 33, 33, 8), (8960, 430080, 33, 1, 1120), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(arg31_1, buf79, buf82, buf80, buf85, 12672, 33, grid=grid(12672), stream=stream0)
        buf86 = empty_strided_cuda((48, 1, 33, 1, 8), (264, 12672, 8, 12672, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf85, buf86, 12672, 33, grid=grid(12672), stream=stream0)
        buf87 = empty_strided_cuda((48, 1, 33, 33, 4), (4384, 4, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf82, buf80, buf87, 209088, grid=grid(209088), stream=stream0)
        del buf80
        buf88 = empty_strided_cuda((52272, 4), (4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_38.run(buf87, buf88, 209088, grid=grid(209088), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf90, buf86, arg31_1, buf89, arg55_1, 384, 1089, grid=grid(384, 1089), stream=stream0)
        del arg55_1
        buf91 = reinterpret_tensor(buf75, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf76, arg53_1, buf91, 202752, grid=grid(202752), stream=stream0)
        del arg53_1
        ...
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_41.run(buf92, buf93, 202752, grid=grid(202752), stream=stream0)
        ...
        del arg56_1
        buf134 = reinterpret_tensor(buf93, (48, 33, 128), (4224, 128, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf71, buf94, arg57_1, arg58_1, arg59_1, buf134, 1584, 128, grid=grid(1584), stream=stream0)
        del arg58_1
        del arg59_1
        buf135 = empty_strided_cuda((1584, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (1584, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf135)
        del arg60_1
        buf136 = reinterpret_tensor(buf135, (48, 33, 512), (16896, 512, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_43.run(buf136, arg61_1, 811008, grid=grid(811008), stream=stream0)
        del arg61_1
        buf137 = reinterpret_tensor(buf134, (1584, 128), (128, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (1584, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf137)
        del arg62_1
        buf138 = reinterpret_tensor(buf137, (48, 33, 128), (4224, 128, 1), 0); del buf137  # reuse
        buf142 = empty_strided_cuda((48, 33, 128), (4224, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_2, x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_44.run(buf138, buf129, arg49_1, buf131, buf133, buf71, buf94, arg57_1, arg63_1, arg78_1, arg79_1, buf142, 1584, 128, grid=grid(1584), stream=stream0)
        del arg49_1
        del arg57_1
        del arg63_1
        del arg78_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (1584, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf143)
        del arg80_1
        buf144 = reinterpret_tensor(buf78, (384, 36, 16), (576, 16, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_29.run(buf143, arg81_1, buf144, 221184, grid=grid(221184), stream=stream0)
        buf145 = reinterpret_tensor(buf77, (384, 16, 36), (576, 36, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_30.run(buf143, arg81_1, buf145, 221184, grid=grid(221184), stream=stream0)
        ...
        triton_poi_fused_index_put_lift_fresh_32.run(buf147, 6336, grid=grid(6336), stream=stream0)
        buf149 = buf82; del buf82  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf147, buf149, 52272, grid=grid(52272), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf149, 1584, grid=grid(1584), stream=stream0)
        buf152 = reinterpret_tensor(buf90, (48, 1, 33, 33, 8), (8960, 430080, 33, 1, 1120), 0); del buf90  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(arg31_1, buf146, buf149, buf147, buf152, 12672, 33, grid=grid(12672), stream=stream0)
        del buf146
        buf153 = buf86; del buf86  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf152, buf153, 12672, 33, grid=grid(12672), stream=stream0)
        buf154 = buf87; del buf87  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf149, buf147, buf154, 209088, grid=grid(209088), stream=stream0)
        del buf147
        del buf149
        buf155 = buf88; del buf88  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_38.run(buf154, buf155, 209088, grid=grid(209088), stream=stream0)
        del buf154
        buf156 = buf89; del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf155, reinterpret_tensor(arg82_1, (4, 8), (1, 4), 0), out=buf156)
        del arg82_1
        del buf155
        buf157 = reinterpret_tensor(buf152, (48, 8, 33, 33, 1, 1), (8960, 1120, 33, 1, 1, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf157, buf153, arg31_1, buf156, arg83_1, 384, 1089, grid=grid(384, 1089), stream=stream0)
        del arg31_1
        del arg83_1
        del buf153
        del buf156
        buf158 = reinterpret_tensor(buf142, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf143, arg81_1, buf158, 202752, grid=grid(202752), stream=stream0)
        del arg81_1
        del buf143
        buf159 = reinterpret_tensor(buf94, (384, 33, 16), (528, 16, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf157, (384, 33, 33), (1120, 33, 1), 0), reinterpret_tensor(buf158, (384, 33, 16), (528, 16, 1), 0), out=buf159)
        del buf157
        buf160 = reinterpret_tensor(buf158, (48, 1, 33, 8, 16), (4224, 1, 128, 16, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_41.run(buf159, buf160, 202752, grid=grid(202752), stream=stream0)
        buf161 = reinterpret_tensor(buf159, (1584, 128), (128, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf160, (1584, 128), (128, 1), 0), reinterpret_tensor(arg84_1, (128, 128), (1, 128), 0), out=buf161)
        del arg84_1
        buf168 = reinterpret_tensor(buf160, (48, 33, 128), (4224, 128, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf138, buf161, arg85_1, arg86_1, arg87_1, buf168, 1584, 128, grid=grid(1584), stream=stream0)
        del arg86_1
        del arg87_1
        buf165 = empty_strided_cuda((16, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf128, (16, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg92_1, (16, 128, 32), (0, 1, 128), 0), out=buf165)
        del arg92_1
        buf166 = reinterpret_tensor(buf165, (1, 16, 32, 32), (16384, 1024, 32, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.add]
        triton_poi_fused_add_45.run(buf166, arg93_1, 16384, grid=grid(16384), stream=stream0)
        del arg93_1
        buf167 = empty_strided_cuda((16, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf166, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf166, (16, 32, 32), (1024, 1, 32), 0), out=buf167)
        buf169 = reinterpret_tensor(buf136, (1584, 512), (512, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (1584, 128), (128, 1), 0), reinterpret_tensor(arg88_1, (128, 512), (1, 128), 0), out=buf169)
        del arg88_1
        buf170 = reinterpret_tensor(buf169, (48, 33, 512), (16896, 512, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_43.run(buf170, arg89_1, 811008, grid=grid(811008), stream=stream0)
        del arg89_1
        buf171 = reinterpret_tensor(buf168, (1584, 128), (128, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (1584, 512), (512, 1), 0), reinterpret_tensor(arg90_1, (512, 128), (1, 512), 0), out=buf171)
        del arg90_1
        del buf170
        buf172 = reinterpret_tensor(buf171, (48, 33, 128), (4224, 128, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_46.run(buf172, buf138, buf161, arg85_1, arg91_1, 202752, grid=grid(202752), stream=stream0)
        del arg85_1
        del arg91_1
        del buf138
        del buf161
        buf173 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf172, (48, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg94_1, (48, 128, 32), (0, 1, 128), 0), out=buf173)
        del arg94_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf172, (48, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg96_1, (48, 128, 32), (0, 1, 128), 0), out=buf174)
        del arg96_1
        del buf172
        buf175 = reinterpret_tensor(buf173, (48, 1, 32, 32), (1024, 1, 32, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.add]
        triton_poi_fused_add_47.run(buf175, arg95_1, 49152, grid=grid(49152), stream=stream0)
        del arg95_1
        buf176 = reinterpret_tensor(buf174, (48, 1, 32, 32), (1024, 1, 32, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.add]
        triton_poi_fused_add_47.run(buf176, arg97_1, 49152, grid=grid(49152), stream=stream0)
        del arg97_1
        ...
        del buf175
        del buf176
        buf178 = reinterpret_tensor(buf25, (1, 16, 32, 128), (65536, 4096, 128, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [h_phys_flat], Original ATen: [aten.clone]
        triton_poi_fused_clone_48.run(buf128, buf178, 65536, grid=grid(65536), stream=stream0)
        buf179 = reinterpret_tensor(buf166, (512, 32), (32, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf178, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf179)
        del arg100_1
        del arg101_1
        buf180 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf178, (512, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf180)
        del arg102_1
        del arg103_1
        del buf178
        buf181 = empty_strided_cuda((16, 32, 1), (32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [linear_34], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf128, (16, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg98_1, (16, 128, 1), (0, 1, 0), 0), out=buf181)
        del arg98_1
        del buf128
        buf182 = reinterpret_tensor(buf181, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf181  # reuse
        # Topologically Sorted Source Nodes: [linear_34, sigmoid], Original ATen: [aten.add, aten.sigmoid]
        triton_poi_fused_add_sigmoid_49.run(buf182, arg99_1, 512, grid=grid(512), stream=stream0)
        del arg99_1
        buf183 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_50.run(buf167, buf177, buf179, buf180, buf182, buf183, 98816, grid=grid(98816), stream=stream0)
        del buf167
        del buf177
        del buf179
        del buf180
    return (buf183, reinterpret_tensor(buf182, (1, 16, 32), (512, 32, 1), 0), buf62, buf65, buf56, )
