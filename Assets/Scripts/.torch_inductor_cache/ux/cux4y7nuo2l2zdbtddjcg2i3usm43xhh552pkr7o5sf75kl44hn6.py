...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6t/c6tkauefucv24njx2cxxw7tl7b4h5n7nmayxwzcg7xyacvgqnpuw.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_35', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vt/cvtkdyytczpb6v2f45xqbjbx7pkx6vibtbciljmdqoewsec6nfgg.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_36', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/tb/ctbpnflipejw5tfz54bh7soyx2k63kaulgcmgkxit7dorppvnwvb.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_38', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp9 = tmp0 >= tmp5
    tmp10 = tl.full([1], 27648, tl.int64)
    tmp11 = tmp0 < tmp10
    tmp12 = tmp9 & tmp11
    tmp13 = tmp12 & tmp4
    tmp14 = tl.load(in_ptr1 + ((-8192) + x0), tmp13 & xmask, eviction_policy='evict_last', other=0.0)
    tmp15 = tmp0 >= tmp10
    tmp16 = tl.full([1], 35840, tl.int64)
    tmp17 = tmp0 < tmp16
    tmp18 = tmp15 & tmp17
    tmp19 = tmp18 & tmp4
    tmp20 = tl.load(in_ptr2 + ((-27648) + x0), tmp19 & xmask, eviction_policy='evict_last', other=0.0)
    tmp21 = tmp0 >= tmp16
    tmp22 = tmp21 & tmp4
    tmp23 = tl.load(in_ptr3 + ((-35840) + x0), tmp22 & xmask, eviction_policy='evict_last', other=0.0)
    ...
    tmp29 = tmp0 >= tmp3
    tmp30 = tl.full([1], 44288, tl.int64)
    tmp31 = tmp0 < tmp30
    tmp32 = tl.load(in_ptr4 + ((-44032) + x0), tmp29 & xmask, eviction_policy='evict_last', other=0.0)
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.add]
        triton_poi_fused_add_35.run(buf114, buf25, buf52, arg39_1, arg47_1, 131072, grid=grid(131072), stream=stream0)
        del arg39_1
        del arg47_1
        del buf25
        del buf52
        ...
        del arg62_1
        del buf122
        buf124 = reinterpret_tensor(buf117, (19, 8, 32, 64, 1, 1), (16384, 2048, 64, 1, 1, 1), 0); del buf117  # reuse
        ...
        del buf138
        del buf139
        buf141 = empty_strided_cuda((19, 1, 32, 8, 64), (16384, 1, 512, 64, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf143, buf56, buf57, buf86, arg59_1, arg67_1, 311296, grid=grid(311296), stream=stream0)
        del arg59_1
        del arg67_1
        del buf56
        del buf57
        del buf86
        buf144 = empty_strided_cuda((608, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf143, (608, 512), (512, 1), 0), reinterpret_tensor(arg68_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf144)
        del arg68_1
        del arg69_1
        buf145 = empty_strided_cuda((608, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf143, (608, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf145)
        del arg70_1
        del arg71_1
        del buf143
        buf146 = empty_strided_cuda((19, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf144, (19, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf145, (19, 32, 32), (1024, 1, 32), 0), out=buf146)
        del buf144
        del buf145
        buf147 = buf115; del buf115  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf114, (256, 512), (512, 1), 0), reinterpret_tensor(arg74_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf147)
        del arg74_1
        del arg75_1
        buf148 = empty_strided_cuda((256, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg77_1, reinterpret_tensor(buf114, (256, 512), (512, 1), 0), reinterpret_tensor(arg76_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf148)
        del arg76_1
        del arg77_1
        buf149 = empty_strided_cuda((256, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (256, 512), (512, 1), 0), reinterpret_tensor(arg72_1, (512, 1), (1, 512), 0), out=buf149)
        del arg72_1
        del buf114
        buf150 = reinterpret_tensor(buf149, (1, 8, 32, 1), (256, 32, 1, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_37.run(buf150, arg73_1, 256, grid=grid(256), stream=stream0)
        del arg73_1
        buf151 = empty_strided_cuda((1, 44288), (44288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_38.run(buf116, buf146, buf147, buf148, buf150, buf151, 44288, grid=grid(44288), stream=stream0)
        del buf116
        del buf146
        del buf147
        del buf148
