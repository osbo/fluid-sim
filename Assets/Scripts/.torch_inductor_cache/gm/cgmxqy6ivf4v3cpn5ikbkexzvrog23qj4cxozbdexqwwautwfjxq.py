...
#   node_feats_1 => cat
# Graph fragment:
#   %cat : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%slice_3, %expand], -1), kwargs = {})
...
# Graph fragment:
#   %full_default : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([4096, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%addmm_2, [%select_2]), kwargs = {})
#   %mul_3 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%index, %unsqueeze_1), kwargs = {})
#   %index_put : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default, [%select_1], %mul_3, True), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7a/c7ajtw7h5hlkdu3ncvupds7b3pvfc2bsbmw6i7o5kbrvzefkhem6.py
...
def call(args):
    ...
    args.clear()
    assert_size_stride(arg0_1, (1, 12), (12, 1))
    assert_size_stride(arg1_1, (1, 4096, 9), (36864, 9, 1))
    ...
    assert_size_stride(arg28_1, (109, 128, 128, 4), (65536, 512, 4, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((1, 4096, 18), (73728, 18, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_feats_1], Original ATen: [aten.cat]
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_0.run(arg1_1, arg0_1, buf0, 73728, grid=grid(73728), stream=stream0)
        del arg0_1
        ...
        del arg27_1
        del buf24
        buf26 = empty_strided_cuda((109, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        buf27 = buf26; del buf26  # reuse
        # Topologically Sorted Source Nodes: [sub], Original ATen: [aten.mean]
        triton_per_fused_mean_6.run(buf27, arg28_1, 446464, 16, grid=grid(446464), stream=stream0)
        del arg28_1
    return (reinterpret_tensor(buf25, (1, 4096, 128), (524288, 128, 1), 0), reinterpret_tensor(buf25, (1, 4096, 128), (524288, 128, 1), 0), reinterpret_tensor(arg1_1, (4096, 3), (9, 1), 0), reinterpret_tensor(buf27, (109, 1, 32, 32, 4), (4096, 4096, 128, 4, 1), 0), )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    arg0_1 = rand_strided((1, 12), (12, 1), device='cuda:0', dtype=torch.float32)
    arg1_1 = rand_strided((1, 4096, 9), (36864, 9, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg28_1 = rand_strided((109, 128, 128, 4), (65536, 512, 4, 1), device='cuda:0', dtype=torch.float32)
