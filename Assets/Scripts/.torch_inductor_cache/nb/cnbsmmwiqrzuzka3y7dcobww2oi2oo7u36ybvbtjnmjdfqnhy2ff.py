...
#   out => add_2
# Graph fragment:
#   %add_tensor_31 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_31, %arg15_1), kwargs = {})
#   %add_2 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%squeeze, %add_tensor_31), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/35/c35rvyrawts2lklx2zkuccsehjjsc5vjedhc73cqb563a35uftbg.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ej/cejsi3u2zli3lgbgk4vf22xbrr727jdbipi7j7rmcoghisaaham2.py
# Topologically Sorted Source Nodes: [x_mid], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_mid => clone_6
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vn/cvnp4kipzbwohpdniescdny5u7iwpqtgn6kgmo22ipnxgqsgwmom.py
...
triton_per_fused_mean_20 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_mean_20', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/b2/cb2j2zsq6r6zpudsif4jexgfdrtvg3ej4szaezl55qxgeam3rm3t.py
...
#   x_out => clone_7
# Graph fragment:
#   %mul_16 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_18, %view_32), kwargs = {})
#   %add_12 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_29, %mul_16), kwargs = {})
#   %clone_7 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%add_12,), kwargs = {memory_format: torch.contiguous_format})
triton_poi_fused_add_clone_mul_21 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_clone_mul_21', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5y/c5yc5fybyg57v2bwa3xr7mgs6sipes4t3a45by4cf6bnosmi3pf2.py
# Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_11 => add_16, erf_3, mul_19, mul_20, mul_21
# Graph fragment:
#   %mul_19 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_40, 0.5), kwargs = {})
#   %mul_20 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_40, 0.7071067811865476), kwargs = {})
#   %erf_3 : [num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_20,), kwargs = {})
#   %add_16 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf_3, 1), kwargs = {})
#   %mul_21 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_19, %add_16), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fr/cfrpjjqxhcavnoazpi27ycdiwpqvz3ewekrly2u4xra7vqs5ugtw.py
# Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   layer_norm_5 => add_29, add_30, mul_31, mul_32, rsqrt_5, sub_7, var_mean_5
#   x => add_13
#   x_1 => add_17
# Graph fragment:
#   %add_13 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_5, %view_38), kwargs = {})
#   %add_17 : [num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_13, %view_42), kwargs = {})
...
#   %sub_7 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_17, %getitem_11), kwargs = {})
#   %add_29 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_10, 1e-05), kwargs = {})
#   %rsqrt_5 : [num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_29,), kwargs = {})
#   %mul_31 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_7, %rsqrt_5), kwargs = {})
#   %mul_32 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_31, %arg68_1), kwargs = {})
#   %add_30 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_32, %arg69_1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4j/c4jdcdbrzchnywk2krbavv4kpqmqefyltd54vr7uq7ynjc74aw3y.py
...
# Graph fragment:
#   %full_default_8 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([48, 1, 32, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_4 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_31, [%device_put]), kwargs = {})
...
#   %index_5 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_31, [%device_put_1]), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_index_add_zeros_25', 'mutated_arg_names': ['out_ptr0', 'out_ptr1', 'out_ptr2', 'out_ptr3'], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/bi/cbi3wa5tkhgfgtcu3or7wgysbnngnqr7tnapvveipzieuonnbwm4.py
# Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
# Source node to ATen node mapping:
#   layer_norm_3 => add_19, add_20, mul_22, mul_23, rsqrt_3, sub_4, var_mean_3
# Graph fragment:
#   %var_mean_3 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_45, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_4 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_45, %getitem_7), kwargs = {})
#   %add_19 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_6, 1e-05), kwargs = {})
#   %rsqrt_3 : [num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_19,), kwargs = {})
#   %mul_22 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_4, %rsqrt_3), kwargs = {})
#   %mul_23 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_22, %arg52_1), kwargs = {})
#   %add_20 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_23, %arg53_1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fl/cfl3gaj2naxjylkdcuulpm4jrffxndzffsx2444wouvth25ttprv.py
# Topologically Sorted Source Nodes: [mask_base_2, sum_2], Original ATen: [aten.clone, aten.sum]
# Source node to ATen node mapping:
#   mask_base_2 => clone_9
#   sum_2 => sum_3
# Graph fragment:
#   %clone_9 : [num_users=4] = call_function[target=torch.ops.aten.clone.default](args = (%slice_27,), kwargs = {})
#   %sum_3 : [num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%clone_9, [-1]), kwargs = {})
triton_per_fused_clone_sum_27 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_clone_sum_27', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, out_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 1536
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/qu/cqu6lmegeicesmkezrsulmdvhkewd4djhfi6w2wpwvw5by4k4br2.py
# Topologically Sorted Source Nodes: [lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.lt, aten._to_copy, aten.maximum, aten.copy]
# Source node to ATen node mapping:
...
triton_poi_fused__to_copy_copy_lt_maximum_28 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__to_copy_copy_lt_maximum_28', 'mutated_arg_names': ['in_out_ptr0', 'out_ptr0'], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ww/cwwf2d6etxuaaqi65mxmarnbea2rjscom6ebjdkii7dptvhbvdhj.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wr/cwrazmw5gsopv7wo7xtkzxmfg3f3hh7c24kh33ilpih65fjcacri.py
# Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum_2 => clone_11
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/as/casczvsnejqmyl3cgomaj6jgl4dsgs7nqtqqduhjr3ardsnn2gtj.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_31', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3g/c3gtooyzaxx6lyo3l6dfpmisvwibakl6nrwpjhfkekn5tr24pl75.py
# Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   bias_physics_1 => clone_8
#   setitem_2 => full_default_10, index_put_8
# Graph fragment:
#   %clone_8 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_26,), kwargs = {})
...
#   %index_put_8 : [num_users=2] = call_function[target=torch.ops.aten.index_put_.default](args = (%clone_8, [None, None, %iota_1, %iota_1], %full_default_10), kwargs = {})
triton_poi_fused_clone_index_put_lift_fresh_32 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5r/c5r5zesmyoc4i3c2k33dglbbtnp6yv7ssdpypzygt22y3kqmiiok.py
# Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_3 => full_default_11, index_put_9
# Graph fragment:
...
#   %index_put_9 : [num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_8, [None, None, %iota_1, %iota_1], %full_default_11), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/y4/cy45tjgm7ry35im23voi7ur3jqcvnvy2lekqhleguhitw7jfehko.py
# Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_3 => full_default_11, index_put_9
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3a/c3alqjldwesmk5rvwm6urvpn5ap76f36vu7ptqb5uvplblcjquxw.py
...
#   scores_3 => mul_24
#   scores_4 => add_21
#   scores_5 => clone_12, full_default_12, where_2
# Graph fragment:
#   %eq_2 : [num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%unsqueeze_22, 0), kwargs = {})
#   %full_default_12 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], -inf), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %mul_24 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_55, 0.25), kwargs = {})
#   %add_21 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_24, %slice_48), kwargs = {})
#   %where_2 : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%eq_2, %full_default_12, %add_21), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/lv/clvskti7jhuxjqpv5nbonpaykbyf46ndfgjk2zdftmkgdxxdmvx7.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xy/cxylaxb7gycdgbp7lruqsufc4qfjf3pou3bqzziotfs3sbycn3up.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3x/c3xmepfjqm3hi6duk27i67a2shke725tbsnp4ghcv2temx4kdt62.py
# Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_mid_2 => clone_13
# Graph fragment:
#   %clone_13 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_43,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/2p/c2ptxmrcd3b2tpoxy7gc3vxskkv466nyekps5h4nxezfmtktrlrx.py
# Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_mid_2 => clone_14
# Graph fragment:
#   %clone_14 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_44,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ha/chasyimdkgliuhr4rrdvmbztbcop6arbrhbzj5bzj2sp4ypvjnbm.py
...
triton_per_fused_mean_40 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_mean_40', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ix/cixbkhocmw3k5355fevhdasvi5gvw4cy2nk4eraodbupcq77sicj.py
...
#   x_out_3 => clone_15
# Graph fragment:
#   %mul_25 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_25, %view_65), kwargs = {})
#   %add_23 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_62, %mul_25), kwargs = {})
#   %clone_15 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%add_23,), kwargs = {memory_format: torch.contiguous_format})
triton_poi_fused_add_clone_mul_41 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_clone_mul_41', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ru/cruanwqoaeqzdog7bqxf5gzp2fbt2evbqepcyfj6a7zr4kovqnyn.py
# Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   layer_norm_4 => add_25, add_26, mul_26, mul_27, rsqrt_4, sub_6, var_mean_4
#   x_2 => add_24
# Graph fragment:
#   %add_24 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_45, %view_71), kwargs = {})
...
#   %sub_6 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_24, %getitem_9), kwargs = {})
...
#   %mul_26 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_6, %rsqrt_4), kwargs = {})
#   %mul_27 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_26, %arg62_1), kwargs = {})
#   %add_26 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_27, %arg63_1), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_42', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 7, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 1536
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wb/cwbrzcxsn6bzzidts7ueziqt5lhxwkl46jus7jjrup7qhk5wesak.py
# Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   x_4 => add_34
#   x_5 => add_38
# Graph fragment:
#   %add_34 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_17, %view_101), kwargs = {})
#   %add_38 : [num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_34, %view_105), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7l/c7ln5zcjvhwiiconqrhjynxomb5wigzifqznes2sokque5lvpxek.py
...
# Source node to ATen node mapping:
#   col_sum_2 => full_default_19
#   getitem_33 => index_6
#   getitem_34 => index_7
#   index_add__6 => index_put_12
#   index_add__7 => index_put_13
#   row_sum_2 => full_default_18
# Graph fragment:
#   %full_default_18 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([48, 1, 32, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_6 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_68, [%device_put]), kwargs = {})
#   %index_put_12 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_18, [%device_put_2], %index_6, True), kwargs = {})
...
#   %index_7 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_68, [%device_put_1]), kwargs = {})
#   %index_put_13 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_19, [%device_put_2], %index_7, True), kwargs = {})
triton_poi_fused_index_index_add_zeros_44 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xm/cxm6zidgrihykdomu46dmjyfiy4mjjgqph2ru24gaicwk2f42cwp.py
# Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_14 => add_27, erf_4, mul_28, mul_29, mul_30
# Graph fragment:
#   %mul_28 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_73, 0.5), kwargs = {})
#   %mul_29 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_73, 0.7071067811865476), kwargs = {})
#   %erf_4 : [num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_29,), kwargs = {})
#   %add_27 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf_4, 1), kwargs = {})
#   %mul_30 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %add_27), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vy/cvyv23upgdw5p6rmd6uo6wvsr6qlcg4j7pv6lpujjtwyxidcatjm.py
# Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   layer_norm_7 => add_41, add_42, mul_40, mul_41, rsqrt_7, sub_10, var_mean_7
#   off_in => add_40
#   x_3 => add_28
# Graph fragment:
#   %add_28 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_24, %view_75), kwargs = {})
#   %add_40 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_108, %add_28), kwargs = {})
...
#   %sub_10 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_40, %getitem_15), kwargs = {})
...
#   %mul_40 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_10, %rsqrt_7), kwargs = {})
#   %mul_41 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_40, %arg84_1), kwargs = {})
#   %add_42 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_41, %arg85_1), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_46', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 8, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/dx/cdxmvpd43hegrupiqw4lj7aark7clm2yuvnl2rxwpa33cs7bzmvg.py
# Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   layer_norm_8 => add_47, add_48, mul_44, mul_45, rsqrt_8, sub_12, var_mean_8
#   x_6 => add_46
# Graph fragment:
#   %add_46 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_40, %view_134), kwargs = {})
...
#   %sub_12 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_46, %getitem_17), kwargs = {})
#   %add_47 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_16, 1e-05), kwargs = {})
#   %rsqrt_8 : [num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_47,), kwargs = {})
#   %mul_44 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_12, %rsqrt_8), kwargs = {})
#   %mul_45 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_44, %arg94_1), kwargs = {})
#   %add_48 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_45, %arg95_1), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_47', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 1536
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/li/clilw42recdu3lhjhfz22ljl5744ji6dsn7w6lg63s3qcipkr666.py
...
# Graph fragment:
#   %add_46 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_40, %view_134), kwargs = {})
#   %add_50 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_46, %view_138), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/23/c23zhzvrqfuygs6pmb6mvb2hfwlpya7m5ee6ze4rppqwqj2fxqq7.py
# Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
# Source node to ATen node mapping:
#   sigmoid_4 => sigmoid_4
# Graph fragment:
#   %sigmoid_4 : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_158,), kwargs = {})
triton_poi_fused_sigmoid_49 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_sigmoid_49', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
...
#   packed_1 => cat_4
# Graph fragment:
#   %cat_4 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_3, %view_159], 1), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg42_1, (8, 128), (128, 1))
    ...
    assert_size_stride(arg58_1, (8, 128), (128, 1))
    ...
    assert_size_stride(arg72_1, (8, 4), (4, 1))
    assert_size_stride(arg73_1, (8, ), (1, ))
    assert_size_stride(arg74_1, (8, 128), (128, 1))
    ...
    assert_size_stride(arg80_1, (512, 128), (128, 1))
    ...
    assert_size_stride(arg88_1, (8, 4), (4, 1))
    assert_size_stride(arg89_1, (8, ), (1, ))
    assert_size_stride(arg90_1, (8, 128), (128, 1))
    ...
    assert_size_stride(arg96_1, (512, 128), (128, 1))
    ...
    assert_size_stride(arg104_1, (32, 128), (128, 1))
    assert_size_stride(arg105_1, (32, ), (1, ))
    assert_size_stride(arg106_1, (1, 128), (128, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf46 = reinterpret_tensor(buf37, (16384, 8), (8, 1), 0); del buf37  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf45, (16384, 4), (4, 1), 0), reinterpret_tensor(arg40_1, (4, 8), (1, 4), 0), out=buf46)
        del arg40_1
        buf47 = reinterpret_tensor(buf43, (16, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf43  # reuse
        # Topologically Sorted Source Nodes: [x_mid], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf47, buf44, buf30, buf46, arg41_1, 128, 1024, grid=grid(128, 1024), stream=stream0)
        del arg41_1
        buf48 = reinterpret_tensor(buf45, (16, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf45  # reuse
        # Topologically Sorted Source Nodes: [x_mid], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf34, arg39_1, buf48, 65536, grid=grid(65536), stream=stream0)
        buf49 = reinterpret_tensor(buf38, (128, 32, 16), (512, 16, 1), 0); del buf38  # reuse
        # Topologically Sorted Source Nodes: [x_mid], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf47, (128, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf48, (128, 32, 16), (512, 16, 1), 0), out=buf49)
        buf50 = reinterpret_tensor(buf44, (512, 8), (8, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf33, (512, 128), (128, 1), 0), reinterpret_tensor(arg42_1, (128, 8), (1, 128), 0), out=buf50)
        del arg42_1
        buf51 = empty_strided_cuda((1, 16, 1, 128), (2048, 128, 2048, 1), torch.float32)
        buf52 = reinterpret_tensor(buf51, (1, 16, 1, 128), (2048, 128, 128, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [diag_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_20.run(buf52, buf25, 2048, 32, grid=grid(2048), stream=stream0)
        buf53 = empty_strided_cuda((16, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf52, (16, 128), (128, 1), 0), reinterpret_tensor(arg38_1, (128, 384), (1, 128), 0), out=buf53)
        del arg38_1
        buf54 = reinterpret_tensor(buf33, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [mul_3, x_mid_1, x_out], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_21.run(buf49, buf50, arg43_1, buf53, arg39_1, buf54, 65536, grid=grid(65536), stream=stream0)
        del arg39_1
        del arg43_1
        buf55 = reinterpret_tensor(buf49, (512, 128), (128, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf54, (512, 128), (128, 1), 0), reinterpret_tensor(arg44_1, (128, 128), (1, 128), 0), out=buf55)
        del arg44_1
        buf60 = reinterpret_tensor(buf54, (1, 512, 128), (65536, 128, 1), 0); del buf54  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf55, arg45_1, arg46_1, arg47_1, buf60, 512, 128, grid=grid(512), stream=stream0)
        del arg46_1
        del arg47_1
        buf59 = empty_strided_cuda((66, ), (1, ), torch.int64)
        buf59.copy_(arg34_1)
        del arg34_1
        buf61 = empty_strided_cuda((512, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (512, 128), (128, 1), 0), reinterpret_tensor(arg48_1, (128, 512), (1, 128), 0), out=buf61)
        del arg48_1
        buf62 = reinterpret_tensor(buf61, (1, 512, 512), (262144, 512, 1), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf62, arg49_1, 262144, grid=grid(262144), stream=stream0)
        del arg49_1
        buf63 = reinterpret_tensor(buf60, (512, 128), (128, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf62, (512, 512), (512, 1), 0), reinterpret_tensor(arg50_1, (512, 128), (1, 512), 0), out=buf63)
        del arg50_1
        buf64 = reinterpret_tensor(buf63, (1, 512, 128), (65536, 128, 1), 0); del buf63  # reuse
        buf116 = reinterpret_tensor(buf48, (1, 512, 128), (65536, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_23.run(buf64, buf25, buf55, arg45_1, arg51_1, arg68_1, arg69_1, buf116, 512, 128, grid=grid(512), stream=stream0)
        del arg45_1
        del arg51_1
        del arg68_1
        del arg69_1
        ...
        buf65.copy_(arg32_1)
        del arg32_1
        buf66 = reinterpret_tensor(buf34, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf66, 196608, grid=grid(196608), stream=stream0)
        buf68 = empty_strided_cuda((66, ), (1, ), torch.int64)
        buf68.copy_(arg33_1)
        del arg33_1
        buf69 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf69, 196608, grid=grid(196608), stream=stream0)
        ...
        triton_poi_fused_zeros_24.run(buf96, 196608, grid=grid(196608), stream=stream0)
        buf98 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf98, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_17, index_add__4, col_sum_1, getitem_18, index_add__5, row_sum, getitem_8, index_add__2, col_sum, getitem_9, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_25.run(buf59, buf65, buf64, buf68, buf25, buf66, buf69, buf96, buf98, 270336, grid=grid(270336), stream=stream0)
        buf78 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_26.run(buf66, arg35_1, buf69, arg52_1, arg53_1, buf78, 1536, 128, grid=grid(1536), stream=stream0)
        del arg52_1
        del arg53_1
        buf74 = empty_strided_cuda((48, 1, 32), (32, 1536, 1), torch.float32)
        buf75 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_27.run(arg31_1, buf74, buf75, 1536, 32, grid=grid(1536), stream=stream0)
        buf76 = buf74; del buf74  # reuse
        # Topologically Sorted Source Nodes: [lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_poi_fused__to_copy_copy_lt_maximum_28.run(buf76, arg31_1, buf75, 1536, grid=grid(1536), stream=stream0)
        buf79 = empty_strided_cuda((1536, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (1536, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf79)
        buf80 = empty_strided_cuda((48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf79, arg55_1, buf80, 196608, grid=grid(196608), stream=stream0)
        buf81 = empty_strided_cuda((48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf79, arg55_1, buf81, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf82 = empty_strided_cuda((384, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf80, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf81, (384, 16, 32), (512, 32, 1), 0), out=buf82)
        buf83 = reinterpret_tensor(buf81, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(arg30_1, buf83, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_32.run(buf83, 6144, grid=grid(6144), stream=stream0)
        buf85 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf83, buf85, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf85, 1536, grid=grid(1536), stream=stream0)
        buf88 = empty_strided_cuda((48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(buf75, buf82, buf85, buf83, buf88, 12288, 32, grid=grid(12288), stream=stream0)
        buf89 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf88, buf89, 12288, 32, grid=grid(12288), stream=stream0)
        buf90 = reinterpret_tensor(buf80, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf85, buf83, buf90, 196608, grid=grid(196608), stream=stream0)
        buf91 = reinterpret_tensor(buf82, (49152, 8), (8, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf90, (49152, 4), (4, 1), 0), reinterpret_tensor(arg56_1, (4, 8), (1, 4), 0), out=buf91)
        del arg56_1
        buf92 = reinterpret_tensor(buf88, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf92, buf89, buf75, buf91, arg57_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg57_1
        buf93 = reinterpret_tensor(buf90, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf79, arg55_1, buf93, 196608, grid=grid(196608), stream=stream0)
        buf94 = reinterpret_tensor(buf83, (384, 32, 16), (512, 16, 1), 0); del buf83  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf92, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf93, (384, 32, 16), (512, 16, 1), 0), out=buf94)
        del buf93
        buf95 = reinterpret_tensor(buf89, (1536, 8), (8, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (1536, 128), (128, 1), 0), reinterpret_tensor(arg58_1, (128, 8), (1, 128), 0), out=buf95)
        del arg58_1
        del buf78
        buf100 = reinterpret_tensor(buf53, (48, 1, 1, 128), (128, 6144, 6144, 1), 0); del buf53  # reuse
        buf101 = reinterpret_tensor(buf100, (48, 1, 1, 128), (128, 1, 6144, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_40.run(buf101, buf96, arg35_1, buf98, 6144, 32, grid=grid(6144), stream=stream0)
        buf102 = empty_strided_cuda((48, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (48, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf102)
        del arg54_1
        buf103 = reinterpret_tensor(buf98, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [mul_5, x_mid_3, x_out_3], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_41.run(buf94, buf95, arg59_1, buf102, arg55_1, buf103, 196608, grid=grid(196608), stream=stream0)
        del arg55_1
        del arg59_1
        buf104 = reinterpret_tensor(buf94, (1536, 128), (128, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (1536, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 128), (1, 128), 0), out=buf104)
        del arg60_1
        buf105 = reinterpret_tensor(buf104, (48, 32, 128), (4096, 128, 1), 0); del buf104  # reuse
        buf149 = reinterpret_tensor(buf103, (48, 32, 128), (4096, 128, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf105, buf66, arg35_1, buf69, arg61_1, arg62_1, arg63_1, buf149, 1536, 128, grid=grid(1536), stream=stream0)
        del arg61_1
        del arg62_1
        del arg63_1
        buf112 = buf31; del buf31  # reuse
        buf113 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [mask_base_4, sum_3], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_7.run(arg29_1, buf112, buf113, 512, 32, grid=grid(512), stream=stream0)
        ...
        triton_poi_fused__to_copy_copy_lt_maximum_8.run(buf114, arg29_1, buf113, 512, grid=grid(512), stream=stream0)
        del arg29_1
        buf117 = reinterpret_tensor(buf69, (512, 384), (384, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (512, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 384), (1, 128), 0), out=buf117)
        buf118 = reinterpret_tensor(buf25, (16, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf117, arg71_1, buf118, 65536, grid=grid(65536), stream=stream0)
        buf119 = reinterpret_tensor(buf55, (16, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf55  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf117, arg71_1, buf119, 2048, 32, grid=grid(2048, 32), stream=stream0)
        buf120 = reinterpret_tensor(buf47, (128, 32, 32), (1024, 32, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf118, (128, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf119, (128, 16, 32), (512, 32, 1), 0), out=buf120)
        buf121 = reinterpret_tensor(buf119, (1, 16, 32, 32, 4), (65536, 4096, 128, 4, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_11.run(arg28_1, buf121, 65536, grid=grid(65536), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_2, setitem_4], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_12.run(buf121, 2048, grid=grid(2048), stream=stream0)
        buf123 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf121, buf123, 16384, grid=grid(16384), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf123, 512, grid=grid(512), stream=stream0)
        buf126 = reinterpret_tensor(buf46, (1, 16, 32, 32, 8), (131072, 8192, 32, 1, 1024), 0); del buf46  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_15.run(buf113, buf120, buf123, buf121, buf126, 4096, 32, grid=grid(4096), stream=stream0)
        buf127 = reinterpret_tensor(buf50, (1, 16, 32, 1, 8), (4096, 256, 8, 4096, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_per_fused__softmax_16.run(buf126, buf127, 4096, 32, grid=grid(4096), stream=stream0)
        buf128 = reinterpret_tensor(buf118, (1, 16, 32, 32, 4), (65536, 4096, 128, 4, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf123, buf121, buf128, 65536, grid=grid(65536), stream=stream0)
        buf129 = reinterpret_tensor(buf120, (16384, 8), (8, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (16384, 4), (4, 1), 0), reinterpret_tensor(arg72_1, (4, 8), (1, 4), 0), out=buf129)
        del arg72_1
        buf130 = reinterpret_tensor(buf126, (16, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf130, buf127, buf113, buf129, arg73_1, 128, 1024, grid=grid(128, 1024), stream=stream0)
        del arg73_1
        del buf129
        buf131 = reinterpret_tensor(buf128, (16, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf117, arg71_1, buf131, 65536, grid=grid(65536), stream=stream0)
        buf132 = reinterpret_tensor(buf121, (128, 32, 16), (512, 16, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf130, (128, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf131, (128, 32, 16), (512, 16, 1), 0), out=buf132)
        del buf130
        del buf131
        buf133 = reinterpret_tensor(buf127, (512, 8), (8, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 8), (1, 128), 0), out=buf133)
        del arg74_1
        buf134 = empty_strided_cuda((16, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf52, (16, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 384), (1, 128), 0), out=buf134)
        del arg70_1
        del buf52
        buf135 = reinterpret_tensor(buf116, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [mul_7, x_mid_5, x_out_6], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_21.run(buf132, buf133, arg75_1, buf134, arg71_1, buf135, 65536, grid=grid(65536), stream=stream0)
        del arg71_1
        del arg75_1
        del buf133
        del buf134
        buf136 = reinterpret_tensor(buf132, (512, 128), (128, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf135, (512, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 128), (1, 128), 0), out=buf136)
        del arg76_1
        buf140 = reinterpret_tensor(buf135, (1, 512, 128), (65536, 128, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf64, buf136, arg77_1, arg78_1, arg79_1, buf140, 512, 128, grid=grid(512), stream=stream0)
        del arg78_1
        del arg79_1
        buf141 = reinterpret_tensor(buf62, (512, 512), (512, 1), 0); del buf62  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf140, (512, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 512), (1, 128), 0), out=buf141)
        del arg80_1
        buf142 = reinterpret_tensor(buf141, (1, 512, 512), (262144, 512, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf142, arg81_1, 262144, grid=grid(262144), stream=stream0)
        del arg81_1
        buf143 = reinterpret_tensor(buf140, (512, 128), (128, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (512, 512), (512, 1), 0), reinterpret_tensor(arg82_1, (512, 128), (1, 512), 0), out=buf143)
        del arg82_1
        del buf142
        buf144 = reinterpret_tensor(buf143, (1, 512, 128), (65536, 128, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf144, buf64, buf136, arg77_1, arg83_1, 65536, grid=grid(65536), stream=stream0)
        del arg77_1
        del arg83_1
        del buf136
        del buf64
        buf145 = reinterpret_tensor(buf117, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf145, 196608, grid=grid(196608), stream=stream0)
        buf147 = buf66; del buf66  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf147, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_33, index_add__6, col_sum_2, getitem_34, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_44.run(buf59, buf65, buf144, buf68, buf145, buf147, 270336, grid=grid(270336), stream=stream0)
        buf150 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf149, (1536, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 512), (1, 128), 0), out=buf150)
        del arg64_1
        buf151 = reinterpret_tensor(buf150, (48, 32, 512), (16384, 512, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf151, arg65_1, 786432, grid=grid(786432), stream=stream0)
        del arg65_1
        buf152 = reinterpret_tensor(buf149, (1536, 128), (128, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf151, (1536, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 128), (1, 512), 0), out=buf152)
        del arg66_1
        buf153 = reinterpret_tensor(buf152, (48, 32, 128), (4096, 128, 1), 0); del buf152  # reuse
        buf161 = reinterpret_tensor(buf96, (48, 32, 128), (4096, 128, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_46.run(buf153, buf145, arg35_1, buf147, buf105, arg67_1, arg84_1, arg85_1, buf161, 1536, 128, grid=grid(1536), stream=stream0)
        del arg35_1
        del arg67_1
        del arg84_1
        del arg85_1
        del buf105
        buf157 = buf76; del buf76  # reuse
        buf158 = buf75; del buf75  # reuse
        # Topologically Sorted Source Nodes: [mask_base_5, sum_4], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_27.run(arg31_1, buf157, buf158, 1536, 32, grid=grid(1536), stream=stream0)
        buf159 = buf157; del buf157  # reuse
        # Topologically Sorted Source Nodes: [lt_3, _need_diag_3, maximum_3, copy__3], Original ATen: [aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_poi_fused__to_copy_copy_lt_maximum_28.run(buf159, arg31_1, buf158, 1536, grid=grid(1536), stream=stream0)
        del arg31_1
        del buf159
        buf162 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (1536, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf162)
        buf163 = reinterpret_tensor(buf147, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf162, arg87_1, buf163, 196608, grid=grid(196608), stream=stream0)
        buf164 = reinterpret_tensor(buf145, (48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf162, arg87_1, buf164, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf165 = reinterpret_tensor(buf92, (384, 32, 32), (1024, 32, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf163, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf164, (384, 16, 32), (512, 32, 1), 0), out=buf165)
        buf166 = reinterpret_tensor(buf164, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(arg30_1, buf166, 196608, grid=grid(196608), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_32.run(buf166, 6144, grid=grid(6144), stream=stream0)
        buf168 = buf85; del buf85  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf166, buf168, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf168, 1536, grid=grid(1536), stream=stream0)
        buf171 = reinterpret_tensor(buf91, (48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), 0); del buf91  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(buf158, buf165, buf168, buf166, buf171, 12288, 32, grid=grid(12288), stream=stream0)
        buf172 = reinterpret_tensor(buf95, (48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf171, buf172, 12288, 32, grid=grid(12288), stream=stream0)
        buf173 = reinterpret_tensor(buf163, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf168, buf166, buf173, 196608, grid=grid(196608), stream=stream0)
        buf174 = reinterpret_tensor(buf165, (49152, 8), (8, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf173, (49152, 4), (4, 1), 0), reinterpret_tensor(arg88_1, (4, 8), (1, 4), 0), out=buf174)
        del arg88_1
        buf175 = reinterpret_tensor(buf171, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf175, buf172, buf158, buf174, arg89_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg89_1
        del buf174
        buf176 = reinterpret_tensor(buf173, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf162, arg87_1, buf176, 196608, grid=grid(196608), stream=stream0)
        del buf162
        buf177 = reinterpret_tensor(buf166, (384, 32, 16), (512, 16, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf175, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf176, (384, 32, 16), (512, 16, 1), 0), out=buf177)
        del buf175
        del buf176
        buf178 = reinterpret_tensor(buf172, (1536, 8), (8, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (1536, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 8), (1, 128), 0), out=buf178)
        del arg90_1
        buf179 = buf102; del buf102  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (48, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf179)
        del arg86_1
        del buf101
        buf180 = reinterpret_tensor(buf161, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [mul_9, x_mid_7, x_out_9], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_41.run(buf177, buf178, arg91_1, buf179, arg87_1, buf180, 196608, grid=grid(196608), stream=stream0)
        del arg87_1
        del arg91_1
        del buf178
        del buf179
        buf181 = reinterpret_tensor(buf177, (1536, 128), (128, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf180, (1536, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 128), (1, 128), 0), out=buf181)
        del arg92_1
        buf187 = reinterpret_tensor(buf180, (48, 32, 128), (4096, 128, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_47.run(buf153, buf181, arg93_1, arg94_1, arg95_1, buf187, 1536, 128, grid=grid(1536), stream=stream0)
        del arg94_1
        del arg95_1
        buf185 = reinterpret_tensor(buf113, (512, 32), (32, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf144, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf185)
        del arg100_1
        del arg101_1
        buf186 = reinterpret_tensor(buf123, (16, 32, 32), (1024, 32, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf185, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf185, (16, 32, 32), (1024, 1, 32), 0), out=buf186)
        buf188 = reinterpret_tensor(buf151, (1536, 512), (512, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf187, (1536, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 512), (1, 128), 0), out=buf188)
        del arg96_1
        buf189 = reinterpret_tensor(buf188, (48, 32, 512), (16384, 512, 1), 0); del buf188  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf189, arg97_1, 786432, grid=grid(786432), stream=stream0)
        del arg97_1
        buf190 = reinterpret_tensor(buf187, (1536, 128), (128, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf189, (1536, 512), (512, 1), 0), reinterpret_tensor(arg98_1, (512, 128), (1, 512), 0), out=buf190)
        del arg98_1
        del buf189
        buf191 = reinterpret_tensor(buf190, (48, 32, 128), (4096, 128, 1), 0); del buf190  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf191, buf153, buf181, arg93_1, arg99_1, 196608, grid=grid(196608), stream=stream0)
        del arg93_1
        del arg99_1
        del buf153
        del buf181
        buf192 = reinterpret_tensor(buf158, (1536, 32), (32, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf191, (1536, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf192)
        del arg102_1
        del arg103_1
        buf193 = reinterpret_tensor(buf168, (1536, 32), (32, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg105_1, reinterpret_tensor(buf191, (1536, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf193)
        del arg104_1
        del arg105_1
        del buf191
        buf194 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf192, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf193, (48, 32, 32), (1024, 1, 32), 0), out=buf194)
        del buf192
        del buf193
        buf195 = buf185; del buf185  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf144, (512, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf195)
        del arg108_1
        del arg109_1
        buf196 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf144, (512, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf196)
        del arg110_1
        del arg111_1
        buf197 = reinterpret_tensor(buf114, (512, 1), (1, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf144, (512, 128), (128, 1), 0), reinterpret_tensor(arg106_1, (128, 1), (1, 128), 0), out=buf197)
        del arg106_1
        del buf144
        buf198 = reinterpret_tensor(buf197, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_49.run(buf198, arg107_1, 512, grid=grid(512), stream=stream0)
        del arg107_1
        buf199 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_50.run(buf186, buf194, buf195, buf196, buf198, buf199, 98816, grid=grid(98816), stream=stream0)
        del buf186
        del buf194
        del buf195
        del buf196
    return (buf199, reinterpret_tensor(buf198, (1, 16, 32), (512, 32, 1), 0), buf65, buf68, buf59, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg42_1 = rand_strided((8, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg58_1 = rand_strided((8, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg72_1 = rand_strided((8, 4), (4, 1), device='cuda:0', dtype=torch.float32)
    arg73_1 = rand_strided((8, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg74_1 = rand_strided((8, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg80_1 = rand_strided((512, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg88_1 = rand_strided((8, 4), (4, 1), device='cuda:0', dtype=torch.float32)
    arg89_1 = rand_strided((8, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg90_1 = rand_strided((8, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg96_1 = rand_strided((512, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg104_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg105_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg106_1 = rand_strided((1, 128), (128, 1), device='cuda:0', dtype=torch.float32)
