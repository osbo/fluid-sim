...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_22.run(buf68, buf25, buf60, arg47_1, arg53_1, arg72_1, arg73_1, buf119, 4096, 128, grid=grid(4096), stream=stream0)
        del arg47_1
        del arg53_1
        del arg72_1
        del arg73_1
        ...
        buf106 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf106, 1785856, grid=grid(1785856), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_21, index_add__4, col_sum_1, getitem_22, index_add__5, row_sum, getitem_12, index_add__2, col_sum, getitem_13, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_24.run(arg34_1, arg32_1, buf68, arg33_1, buf25, buf69, buf71, buf104, buf106, 2916352, grid=grid(2916352), stream=stream0)
        buf73 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        buf77 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_25.run(buf69, arg35_1, buf71, arg54_1, arg55_1, buf73, buf77, 6976, 128, grid=grid(6976), stream=stream0)
        del arg54_1
        del arg55_1
        buf78 = empty_strided_cuda((6976, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf77, (6976, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf78)
        ...
        del arg30_1
        buf83 = reinterpret_tensor(buf71, (109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf78, arg57_1, buf87, 892928, grid=grid(892928), stream=stream0)
        buf88 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf78, arg57_1, buf88, 892928, grid=grid(892928), stream=stream0)
        buf89 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        buf101 = empty_strided_cuda((109, 8, 64, 1, 16, 1), (8192, 1024, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_35.run(buf78, arg57_1, buf89, buf101, 892928, grid=grid(892928), stream=stream0)
        buf96 = reinterpret_tensor(buf69, (109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        buf92 = buf91[0]
        del buf91
        buf102 = reinterpret_tensor(buf89, (872, 64, 16), (1024, 16, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf100, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf101, (872, 64, 16), (1024, 16, 1), 0), out=buf102)
        buf103 = empty_strided_cuda((6976, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf77, (6976, 128), (128, 1), 0), reinterpret_tensor(arg62_1, (128, 8), (1, 128), 0), out=buf103)
        del arg62_1
        buf108 = empty_strided_cuda((109, 1, 1, 128), (128, 13952, 13952, 1), torch.float32)
        buf109 = reinterpret_tensor(buf108, (109, 1, 1, 128), (128, 1, 13952, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_39.run(buf109, buf104, arg35_1, buf106, 13952, 64, grid=grid(13952), stream=stream0)
        buf110 = empty_strided_cuda((109, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf109, (109, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf110)
        del arg56_1
        buf111 = reinterpret_tensor(buf92, (109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2, mul_3, x_mid_3], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_40.run(buf111, buf102, buf103, arg63_1, buf110, arg57_1, 892928, grid=grid(892928), stream=stream0)
        del arg57_1
        del arg63_1
        buf112 = reinterpret_tensor(buf102, (6976, 128), (128, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf111, (6976, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf112)
        del arg64_1
        buf161 = reinterpret_tensor(buf111, (109, 64, 128), (8192, 128, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf73, buf112, arg65_1, arg66_1, arg67_1, buf161, 6976, 128, grid=grid(6976), stream=stream0)
        del arg66_1
        del arg67_1
        buf120 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (4096, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf120)
        buf121 = empty_strided_cuda((1, 32, 128), (4096, 128, 1), torch.float32)
        buf122 = reinterpret_tensor(buf25, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf25  # reuse
        ...
        del arg29_1
        del buf123
        buf125 = reinterpret_tensor(buf66, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf66  # reuse
        ...
        buf127 = reinterpret_tensor(buf60, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf60  # reuse
        ...
        buf129 = reinterpret_tensor(buf53, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf53  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_13.run(buf120, arg75_1, buf129, 524288, grid=grid(524288), stream=stream0)
        buf130 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_14.run(buf120, arg75_1, buf130, 524288, grid=grid(524288), stream=stream0)
        buf131 = buf39; del buf39  # reuse
        buf143 = reinterpret_tensor(buf37, (32, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf37  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_15.run(buf120, arg75_1, buf131, buf143, 524288, grid=grid(524288), stream=stream0)
        del buf120
        ...
        buf134 = buf133[0]
        del buf133
        buf144 = reinterpret_tensor(buf131, (256, 128, 16), (2048, 16, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf142, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf143, (256, 128, 16), (2048, 16, 1), 0), out=buf144)
        del buf142
        del buf143
        buf145 = buf55; del buf55  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (4096, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 8), (1, 128), 0), out=buf145)
        del arg80_1
        del buf119
        buf146 = buf58; del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (32, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf146)
        del arg74_1
        buf147 = reinterpret_tensor(buf134, (1, 32, 128, 8, 16), (524288, 16384, 128, 16, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4, mul_4, x_mid_5], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_20.run(buf147, buf144, buf145, arg81_1, buf146, arg75_1, 524288, grid=grid(524288), stream=stream0)
        del arg75_1
        del arg81_1
        del buf145
        del buf146
        buf148 = reinterpret_tensor(buf144, (4096, 128), (128, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf147, (4096, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 128), (1, 128), 0), out=buf148)
        del arg82_1
        buf152 = reinterpret_tensor(buf147, (1, 4096, 128), (524288, 128, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf68, buf148, arg83_1, arg84_1, arg85_1, buf152, 4096, 128, grid=grid(4096), stream=stream0)
        del arg84_1
        del arg85_1
        buf153 = reinterpret_tensor(buf125, (4096, 512), (512, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf152, (4096, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 512), (1, 128), 0), out=buf153)
        del arg86_1
        buf154 = reinterpret_tensor(buf153, (1, 4096, 512), (2097152, 512, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf154, arg87_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg87_1
        buf155 = reinterpret_tensor(buf152, (4096, 128), (128, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf154, (4096, 512), (512, 1), 0), reinterpret_tensor(arg88_1, (512, 128), (1, 512), 0), out=buf155)
        del arg88_1
        del buf154
        buf156 = reinterpret_tensor(buf155, (1, 4096, 128), (524288, 128, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf156, buf68, buf148, arg83_1, arg89_1, 524288, grid=grid(524288), stream=stream0)
        del arg83_1
        del arg89_1
        buf157 = buf106; del buf106  # reuse
        ...
        buf159 = buf104; del buf104  # reuse
        ...
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_37, index_add__6, col_sum_2, getitem_38, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_43.run(arg34_1, arg32_1, buf156, arg33_1, buf157, buf159, 2916352, grid=grid(2916352), stream=stream0)
        del arg32_1
        del arg33_1
        del arg34_1
        buf162 = reinterpret_tensor(buf100, (6976, 512), (512, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (6976, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 512), (1, 128), 0), out=buf162)
        del arg68_1
        buf163 = reinterpret_tensor(buf162, (109, 64, 512), (32768, 512, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_44.run(buf163, arg69_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg69_1
        buf164 = reinterpret_tensor(buf161, (6976, 128), (128, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (6976, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 128), (1, 512), 0), out=buf164)
        del arg70_1
        buf165 = reinterpret_tensor(buf164, (109, 64, 128), (8192, 128, 1), 0); del buf164  # reuse
        buf169 = buf77; del buf77  # reuse
        # Topologically Sorted Source Nodes: [x_2, h_off_5, x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_45.run(buf165, buf157, arg35_1, buf159, buf73, buf112, arg65_1, arg71_1, arg90_1, arg91_1, buf169, 6976, 128, grid=grid(6976), stream=stream0)
        del arg35_1
        del arg65_1
        del arg71_1
        del arg90_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf169, (6976, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf170)
        buf172 = buf85; del buf85  # reuse
        ...
        buf174 = reinterpret_tensor(buf159, (109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), 0); del buf159  # reuse
        ...
        buf178 = reinterpret_tensor(buf73, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf73  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf170, arg93_1, buf178, 892928, grid=grid(892928), stream=stream0)
        buf179 = reinterpret_tensor(buf112, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf170, arg93_1, buf179, 892928, grid=grid(892928), stream=stream0)
        buf180 = reinterpret_tensor(buf101, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf101  # reuse
        buf192 = reinterpret_tensor(buf88, (109, 8, 64, 1, 16, 1), (8192, 1024, 16, 16, 1, 1), 0); del buf88  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_35.run(buf170, arg93_1, buf180, buf192, 892928, grid=grid(892928), stream=stream0)
        del buf170
        buf187 = reinterpret_tensor(buf157, (109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg95_1
        buf190 = reinterpret_tensor(buf163, (446464, 8), (8, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        buf183 = buf182[0]
        del buf182
        buf193 = reinterpret_tensor(buf180, (872, 64, 16), (1024, 16, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf191, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf192, (872, 64, 16), (1024, 16, 1), 0), out=buf193)
        del buf192
        buf194 = buf103; del buf103  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf169, (6976, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 8), (1, 128), 0), out=buf194)
        del arg98_1
        del buf169
        buf195 = buf110; del buf110  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf109, (109, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf195)
        del arg92_1
        del buf109
        buf196 = reinterpret_tensor(buf183, (109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), 0); del buf183  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6, mul_5, x_mid_7], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_40.run(buf196, buf193, buf194, arg99_1, buf195, arg93_1, 892928, grid=grid(892928), stream=stream0)
        del arg93_1
        del arg99_1
        del buf194
        del buf195
        buf197 = reinterpret_tensor(buf193, (6976, 128), (128, 1), 0); del buf193  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf196, (6976, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 128), (1, 128), 0), out=buf197)
        del arg100_1
        buf203 = reinterpret_tensor(buf196, (109, 64, 128), (8192, 128, 1), 0); del buf196  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf165, buf197, arg101_1, arg102_1, arg103_1, buf203, 6976, 128, grid=grid(6976), stream=stream0)
        del arg102_1
        del arg103_1
        buf201 = reinterpret_tensor(buf68, (4096, 128), (128, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf156, (4096, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf201)
        del arg108_1
        del arg109_1
        buf202 = reinterpret_tensor(buf148, (32, 128, 128), (16384, 128, 1), 0); del buf148  # reuse
        ...
        del buf201
        buf204 = reinterpret_tensor(buf191, (6976, 512), (512, 1), 0); del buf191  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf203, (6976, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 512), (1, 128), 0), out=buf204)
        del arg104_1
        buf205 = reinterpret_tensor(buf204, (109, 64, 512), (32768, 512, 1), 0); del buf204  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_44.run(buf205, arg105_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg105_1
        buf206 = reinterpret_tensor(buf203, (6976, 128), (128, 1), 0); del buf203  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf205, (6976, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 128), (1, 512), 0), out=buf206)
        del arg106_1
        del buf205
        buf207 = reinterpret_tensor(buf206, (109, 64, 128), (8192, 128, 1), 0); del buf206  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_46.run(buf207, buf165, buf197, arg101_1, arg107_1, 892928, grid=grid(892928), stream=stream0)
        del arg101_1
        del arg107_1
        del buf165
        del buf197
        buf208 = reinterpret_tensor(buf176, (6976, 64), (64, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf207, (6976, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf208)
        del arg110_1
        del arg111_1
        buf209 = reinterpret_tensor(buf172, (6976, 64), (64, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg113_1, reinterpret_tensor(buf207, (6976, 128), (128, 1), 0), reinterpret_tensor(arg112_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf209)
        del arg112_1
        del arg113_1
        del buf207
        buf210 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        ...
        del buf208
        del buf209
        buf211 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf156, (4096, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf211)
        del arg116_1
        del arg117_1
        buf212 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf156, (4096, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf212)
        del arg118_1
        del arg119_1
        buf213 = reinterpret_tensor(buf57, (4096, 1), (1, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (4096, 128), (128, 1), 0), reinterpret_tensor(arg114_1, (128, 1), (1, 128), 0), out=buf213)
        del arg114_1
        del buf156
        buf214 = reinterpret_tensor(buf213, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf213  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_47.run(buf214, arg115_1, 4096, grid=grid(4096), stream=stream0)
        del arg115_1
        buf215 = empty_strided_cuda((1, 1499136), (1499136, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_48.run(buf202, buf210, buf211, buf212, buf214, buf215, 1499136, grid=grid(1499136), stream=stream0)
        del buf202
        del buf210
        del buf211
        del buf212
