...
# Graph fragment:
#   %cat_default : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view, %full_default_6], 1), kwargs = {})
...
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default_1 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%permute, %full_default_7],), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/st/cst3czmcbwsex45b6cpwsvekpq3lgdzeapmvt74ex6jrpivitneh.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_21', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vi/cvirdctamnuvlco6z3rnfgqy7bxxvkmzvchrueqjxhahmehad77v.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/qw/cqwjxqmhr5tdzlnmnjvik5cnwiqikvmn5veogzzptsz2zuhyob6c.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/dj/cdjwjtk5kzanheklm2jpgc5wzqsdxmt3klqjmtqis5osuonobvek.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1], Original ATen: [aten.add]
        triton_poi_fused_add_21.run(buf61, buf26, buf53, arg41_1, arg47_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg41_1
        del arg47_1
        del buf26
        ...
        del arg56_1
        buf100 = reinterpret_tensor(buf91, (234, 32, 256), (8192, 256, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, z_1], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf64, buf92, arg57_1, arg58_1, arg59_1, buf100, 7488, 256, grid=grid(7488), stream=stream0)
        del arg58_1
        del arg59_1
        buf96 = buf53; del buf53  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf61, (8192, 256), (256, 1), 0), reinterpret_tensor(arg64_1, (256, 256), (1, 256), 0), out=buf96)
        del arg64_1
        buf97 = reinterpret_tensor(buf96, (1, 64, 128, 256), (2097152, 32768, 256, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_2.run(buf97, arg65_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg65_1
        buf98 = reinterpret_tensor(buf34, (8192, 128), (128, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf97, (8192, 256), (256, 1), 0), reinterpret_tensor(arg66_1, (256, 128), (1, 256), 0), alpha=1, beta=1, out=buf98)
        del arg66_1
        del arg67_1
        del buf97
        buf99 = empty_strided_cuda((64, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf98, (64, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf98, (64, 128, 128), (16384, 1, 128), 0), out=buf99)
        del buf98
        buf101 = reinterpret_tensor(buf63, (7488, 1024), (1024, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (7488, 256), (256, 1), 0), reinterpret_tensor(arg60_1, (256, 1024), (1, 256), 0), out=buf101)
        del arg60_1
        buf102 = reinterpret_tensor(buf101, (234, 32, 1024), (32768, 1024, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf102, arg61_1, 7667712, grid=grid(7667712), stream=stream0)
        del arg61_1
        buf103 = reinterpret_tensor(buf100, (7488, 256), (256, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf102, (7488, 1024), (1024, 1), 0), reinterpret_tensor(arg62_1, (1024, 256), (1, 1024), 0), out=buf103)
        del arg62_1
        del buf102
        buf104 = reinterpret_tensor(buf103, (234, 32, 256), (8192, 256, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_37.run(buf104, buf64, buf92, arg57_1, arg63_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg57_1
        del arg63_1
        del buf64
        buf105 = buf92; del buf92  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf104, (7488, 256), (256, 1), 0), reinterpret_tensor(arg68_1, (256, 256), (1, 256), 0), out=buf105)
        del arg68_1
        buf106 = reinterpret_tensor(buf105, (234, 1, 32, 256), (8192, 1, 256, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf106, arg69_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg69_1
        ...
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf106, (7488, 256), (256, 1), 0), reinterpret_tensor(arg70_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf107)
        del arg70_1
        del arg71_1
        buf108 = reinterpret_tensor(buf106, (7488, 256), (256, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf104, (7488, 256), (256, 1), 0), reinterpret_tensor(arg72_1, (256, 256), (1, 256), 0), out=buf108)
        del arg72_1
        del buf104
        buf109 = reinterpret_tensor(buf108, (234, 1, 32, 256), (8192, 1, 256, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf109, arg73_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg73_1
        buf110 = empty_strided_cuda((7488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf109, (7488, 256), (256, 1), 0), reinterpret_tensor(arg74_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf110)
        del arg74_1
        del arg75_1
        del buf109
        ...
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf61, (8192, 256), (256, 1), 0), reinterpret_tensor(arg78_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf112)
        del arg78_1
        del arg79_1
        buf113 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg81_1, reinterpret_tensor(buf61, (8192, 256), (256, 1), 0), reinterpret_tensor(arg80_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf113)
        del arg80_1
        del arg81_1
        buf114 = empty_strided_cuda((8192, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf61, (8192, 256), (256, 1), 0), reinterpret_tensor(arg76_1, (256, 1), (1, 256), 0), out=buf114)
        del arg76_1
        del buf61
        buf115 = reinterpret_tensor(buf114, (1, 64, 128, 1), (8192, 128, 1, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_39.run(buf115, arg77_1, 8192, grid=grid(8192), stream=stream0)
        del arg77_1
        buf116 = empty_strided_cuda((1, 1820672), (1820672, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_40.run(buf99, buf111, buf112, buf113, buf115, buf116, 1820672, grid=grid(1820672), stream=stream0)
        del buf111
        del buf112
        del buf113
        del buf99
    return (buf116, reinterpret_tensor(buf115, (1, 64, 128), (8192, 128, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg66_1 = rand_strided((128, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg70_1 = rand_strided((32, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg74_1 = rand_strided((32, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg75_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg76_1 = rand_strided((1, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg77_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg78_1 = rand_strided((32, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg79_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg80_1 = rand_strided((32, 256), (256, 1), device='cuda:0', dtype=torch.float32)
