...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vz/cvzdsom3wz4uosowly7lz76b3mwrftafxbtexpecm3meiptqeqdo.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/pc/cpccbo7g6idp6fido62rqugonfmvjgsvlhba45zcvhxoa4xdnthp.py
# Topologically Sorted Source Nodes: [aggr], Original ATen: [aten.zeros_like]
# Source node to ATen node mapping:
#   aggr => full_default
# Graph fragment:
#   %full_default : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([4096, 32], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/yg/cyg7g5eaqatf7mhoood2erowieui6vcl3k4gaav4hz6lokvtmnwb.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp11 = tl.load(in_ptr1 + (x0 + (32*tmp9)), xmask)
    tmp13 = tmp11 * tmp12
    tl.atomic_add(out_ptr0 + (x0 + (64*tmp4)), tmp13, xmask, sem='relaxed')
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gm/cgmytcvfchiamyhy4oe7zeg7bi45mukw4jp4iec2nsznghtdz3mg.py
# Topologically Sorted Source Nodes: [out], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   out => add_2
# Graph fragment:
#   %add_tensor_18 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_18, %arg15_1), kwargs = {})
#   %add_2 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%squeeze, %add_tensor_18), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xl/cxl7czz5yqt3tnokfaltcmg5ruqefp5wv3znxxxtnpwlibpxjety.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    r1 = rindex
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + (r1 + (32*x0)), None)
    tmp1 = tl.load(in_ptr1 + (r1 + (32*x0)), None)
    ...
    tmp26 = tmp24 * tmp25
    tmp28 = tmp26 + tmp27
    tl.store(out_ptr2 + (r1 + (32*x0)), tmp28, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ka/ckao53ccx4gqccpak62rylvbnq5tkabkfklc2kyao55l7k2edt6f.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.full([XBLOCK, 1], 32, tl.int32)
    ...
    tmp22 = tmp20 * tmp21
    tmp24 = tmp22 + tmp23
    tl.store(out_ptr2 + (r1 + (32*x0)), tmp24, None)
''', device_str='cuda')
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ar/carfl3k67fj45ac6xperypem6eybssuqhebvg7i2dxutumf3ydoz.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 4096)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (4*x2) + (96*x1) + (12288*x3)), None)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xl/cxlaj6a2aeecmoei4unqki2dprfen3hhgqgw2bw7mkszzewpsix4.py
# Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f => clone_2
#   logit_bias => clone_4
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 4096)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (32 + x0 + (4*x2) + (96*x1) + (12288*x3)), None)
    tmp1 = tl.load(in_ptr1 + (32 + x0 + (4*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/li/clid4lotg4vfw733vgrq4go3ec3h2k2gqsir5nellbw72prodcol.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 4096)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (64 + x0 + (4*x2) + (96*x1) + (12288*x3)), None)
    tmp1 = tl.load(in_ptr1 + (64 + x0 + (4*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, None)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/n6/cn6g23rpk7wbptglcctpuqdytrbyxz5yh2ksxtgkpvlsp2mbuuun.py
...
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x0 + (4*x2) + (512*x1) + (4096*x3)), None)
    tmp2 = tmp0 + tmp1
...
# Graph fragment:
#   %full_default_4 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 32], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/dn/cdnbovtjzdwmj5wgvav66vpu4gbype6hixvdzzgslgtf2u4zj6w2.py
...
#   %full_default_5 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 32], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, out_ptr4, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp32 = tmp30 * tmp31
    tmp34 = tmp32 + tmp33
    tl.atomic_add(out_ptr2 + (r1 + (32*x2) + (4096*tmp22)), tmp4, None, sem='relaxed')
    tl.atomic_add(out_ptr3 + (r1 + (32*x2) + (4096*tmp22)), tmp4, None, sem='relaxed')
    tl.store(out_ptr4 + (r1 + (128*x0)), tmp34, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/k2/ck2lhhbnz47ite2gkhd2hajuetvb2aw4pt6ioxlbmt6mo3vl3fcl.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/tz/ctzfsrichdps2ungwp4nzdmrazhbd6y6nh333xcuupt4nd4ousbs.py
# Topologically Sorted Source Nodes: [x_mid_d, g], Original ATen: [aten.add, aten.mean]
# Source node to ATen node mapping:
#   g => mean_4
#   x_mid_d => add_12
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hc/chclrtogoskfo4jqwvv4nuethkng5srhwhqcgotezsl23armza77.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wr/cwrgypgljelrwbd6moif6otzfsdja7idb6wcgbeckkv7eft5sslx.py
# Topologically Sorted Source Nodes: [z_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   z_1 => cat_3
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/42/c42yjph2be63rgg4cscr3mj3gyhidft53rdf3kp5k6uh3rgkdbzj.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/pn/cpnbs53nxz75rkxr7jx3cektbocrnoypeh3m4zdmvaecbds2zrkb.py
# Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9, row_highway_2, index_add__8], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
# Source node to ATen node mapping:
#   col_highway_1 => full_default_9
#   col_highway_2 => full_default_11
#   h_diag_1 => add_16
#   index_add__4 => index_put_8
#   index_add__5 => index_put_9
#   index_add__8 => index_put_12
#   index_add__9 => index_put_13
#   row_highway_1 => full_default_8
#   row_highway_2 => full_default_10
#   x_mid_d => add_12
# Graph fragment:
#   %add_12 : [num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_9, %view_46), kwargs = {})
#   %add_16 : [num_users=7] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_12, %view_63), kwargs = {})
#   %full_default_8 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 32], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_9 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 32], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_11 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 32], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_13 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_11, [None, %slice_31], %view_131, True), kwargs = {})
#   %full_default_10 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 32], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_12 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_10, [None, %slice_31], %view_131, True), kwargs = {})
triton_poi_fused_add_index_add_new_zeros_26 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_index_add_new_zeros_26', 'mutated_arg_names': ['in_out_ptr0', 'out_ptr0', 'out_ptr1', 'out_ptr2', 'out_ptr3'], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, out_ptr1, out_ptr2, out_ptr3, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.atomic_add(out_ptr0 + (x2 + (4096*tmp13)), tmp8, None, sem='relaxed')
    tl.atomic_add(out_ptr1 + (x2 + (4096*tmp13)), tmp8, None, sem='relaxed')
    tl.atomic_add(out_ptr2 + (x2 + (4096*tmp13)), tmp8, None, sem='relaxed')
    tl.atomic_add(out_ptr3 + (x2 + (4096*tmp13)), tmp8, None, sem='relaxed')
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/la/clam6perruekhk7infewg5t2xebzazw3iexepjnfum4saghl4ozq.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr0 + (32 + r1 + (128*x0)), xmask, other=0.0)
    tmp4 = tl.load(in_ptr1 + (32 + r1 + (128*x0)), xmask, other=0.0)
    tmp7 = tl.load(in_ptr0 + (64 + r1 + (128*x0)), xmask, other=0.0)
    tmp8 = tl.load(in_ptr1 + (64 + r1 + (128*x0)), xmask, other=0.0)
    tmp11 = tl.load(in_ptr0 + (96 + r1 + (128*x0)), xmask, other=0.0)
    tmp12 = tl.load(in_ptr1 + (96 + r1 + (128*x0)), xmask, other=0.0)
    ...
    tmp24 = tl.full([XBLOCK, 1], 32, tl.int32)
    ...
    tmp41 = tmp39 * tmp40
    tmp43 = tmp41 + tmp42
    tl.store(out_ptr0 + (r1 + (32*x0)), tmp16, xmask)
    tl.store(out_ptr3 + (r1 + (32*x0)), tmp43, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xp/cxpxnfbwthev2fguhq7eviqrtqlc3nf7xmof4bw2b73rmrygdaz7.py
...
triton_per_fused_mean_28 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
#   %index_put_6 : [num_users=2] = call_function[target=torch.ops.aten.index_put_.default](args = (%view_7, [None, None, %iota_1, %iota_1], %full_default_6), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/dz/cdz7kgoyncqafe64fyqdbh5uculeuzgbwcssb3hrumqjkp73f7rm.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 1024)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (4*x2) + (96*x1) + (3072*x3)), xmask)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/bf/cbf2wemxjnm45geshzippkhth6wecov26ygqaoaqm7szzdedhpk6.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f_1 => clone_9
#   logit_bias_1 => clone_11
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 1024)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (32 + x0 + (4*x2) + (96*x1) + (3072*x3)), xmask)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3z/c3zzvaibo3gwaqbdzouu7pm3oauepyaisgulies7nutg7ejqkep5.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 1024)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (64 + x0 + (4*x2) + (96*x1) + (3072*x3)), xmask)
    tmp1 = tl.load(in_ptr1 + (64 + x0 + (4*x2)), xmask, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, xmask)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7m/c7mdcd56kpvj6z5irlyqrvh3h6ufemimvsk4sllbc3kv6tt2wczh.py
...
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x0 + (4*x2) + (128*x1) + (1024*x3)), xmask)
    tmp2 = tmp0 + tmp1
    tl.store(in_out_ptr0 + (x4), tmp2, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/no/cnoyb6kdg7pqxihkfcpwxr53c2ul6yasqchpjmnlw3g6s2zxr4kf.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kn/cknhf5bejslz2m2ws7hmznkb46jjf5yx37x4vmojonsvjx3oln6s.py
...
triton_poi_fused_index_add_index_select_41 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp12 = tl.load(in_ptr2 + (x0 + (32*(x1 // 4)) + (1024*tmp10)), None)
    tmp13 = tl.load(in_ptr3 + (x0 + (32*(x1 // 4)) + (1024*tmp10)), None)
    tmp15 = tmp13 + tmp14
    tmp16 = tmp12 + tmp15
    tmp18 = tmp17 + tmp1
    tmp19 = tmp17 < 0
    ...
    tl.atomic_add(out_ptr0 + (x3 + (4096*tmp4)), tmp16, None, sem='relaxed')
    tl.atomic_add(out_ptr1 + (x3 + (4096*tmp20)), tmp16, None, sem='relaxed')
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/eg/ceglaznho3oh2olnp4gz3bqozdoby5xa364red37xhmg3jnqghgf.py
...
triton_per_fused_add_mean_42 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_mean_42', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (x0 + (32*r2) + (1024*x1)), xmask, other=0.0)
    tmp2 = tl.load(in_ptr2 + (x0), xmask, eviction_policy='evict_last')
    tmp3 = tmp1 + tmp2
    tmp4 = tmp0 + tmp3
    tmp5 = tl.broadcast_to(tmp4, [XBLOCK, RBLOCK])
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/tm/ctm6d6sucqwmkwwhxwkxvfzjz443mynaexlxjsfilf7eugp36x2m.py
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (32 + x0 + (128*x1)), xmask)
    tmp3 = tl.load(in_ptr0 + (64 + x0 + (128*x1)), xmask)
    tmp5 = tl.load(in_ptr0 + (96 + x0 + (128*x1)), xmask)
    tmp2 = tmp0 + tmp1
    tmp4 = tmp2 + tmp3
    tmp6 = tmp4 + tmp5
    tmp7 = 4.0
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/jj/cjjdcdg245764omgqlk5tai34jemwh62ey445dmasyyhjtbdlp6d.py
# Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   z_3 => cat_4
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_44', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = 32.0
    tmp2 = tmp0 / tmp1
    tl.store(out_ptr0 + (x0 + (128*x3)), tmp2, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hl/chlgxknziomyzsuunwf2efhyusdfbsvjm2rpddaznqaqsayq4i5n.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hh/chh7kp6jxo5wu377og4i732scrfpgjrxgjxoitgthctc6hjp3ijf.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/2b/c2bemmvg6f5ngjfpp3z3n63fhcofiz2t6ylqx3xbyzyqb2gwkfec.py
# Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_26 => add_28, erf_8, mul_36, mul_37, mul_38
# Graph fragment:
#   %mul_36 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_148, 0.5), kwargs = {})
#   %mul_37 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_148, 0.7071067811865476), kwargs = {})
#   %erf_8 : [num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_37,), kwargs = {})
#   %add_28 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf_8, 1), kwargs = {})
#   %mul_38 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_36, %add_28), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hx/chxweeokitf37nkd44mvxpvsty7b3d7ys6b6cgfdt7adbaqhbl7o.py
# Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
# Source node to ATen node mapping:
#   sigmoid => sigmoid
# Graph fragment:
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_161,), kwargs = {})
triton_poi_fused_sigmoid_48 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_sigmoid_48', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/lc/clcjh56mb6fmnks3wi4d73cxudzicy7oyfc3kz75cfzmdg7lu445.py
# Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   packed_1 => cat_6
# Graph fragment:
#   %cat_6 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_5, %view_162], 1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/iv/civvnmxkcbnnmal7unak4czvvfonythgqsmeqs4pl5aanbt7wmah.py
# Topologically Sorted Source Nodes: [toks_3, index_add__11, index_add__10], Original ATen: [aten.index_select, aten.index_add]
# Source node to ATen node mapping:
#   index_add__10 => index_put_14
#   index_add__11 => index_put_15
#   toks_3 => index_3
# Graph fragment:
#   %index_3 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_133, [None, %device_put_2]), kwargs = {})
#   %index_put_15 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_13, [None, %device_put_1], %index_3, True), kwargs = {})
#   %index_put_14 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_12, [None, %device_put], %index_3, True), kwargs = {})
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.atomic_add(out_ptr0 + (x3 + (4096*tmp4)), tmp12, None, sem='relaxed')
    tl.atomic_add(out_ptr1 + (x3 + (4096*tmp16)), tmp12, None, sem='relaxed')
''', device_str='cuda')
...
def call(args):
    ...
    assert_size_stride(arg2_1, (32, 18), (18, 1))
    ...
    assert_size_stride(arg14_1, (32, 32), (32, 1))
    ...
    assert_size_stride(arg34_1, (96, 32), (32, 1))
    ...
    assert_size_stride(arg40_1, (32, 32), (32, 1))
    ...
    assert_size_stride(arg60_1, (32, 32), (32, 1))
    ...
    assert_size_stride(arg66_1, (32, 128), (128, 1))
    assert_size_stride(arg67_1, (32, ), (1, ))
    assert_size_stride(arg68_1, (32, 32), (32, 1))
    assert_size_stride(arg69_1, (32, ), (1, ))
    assert_size_stride(arg70_1, (128, 32), (32, 1))
    assert_size_stride(arg71_1, (128, ), (1, ))
    assert_size_stride(arg72_1, (32, 32), (32, 1))
    assert_size_stride(arg73_1, (32, ), (1, ))
    assert_size_stride(arg74_1, (32, 32), (32, 1))
    assert_size_stride(arg75_1, (32, ), (1, ))
    assert_size_stride(arg76_1, (32, 32), (32, 1))
    assert_size_stride(arg77_1, (32, ), (1, ))
    assert_size_stride(arg78_1, (32, 32), (32, 1))
    assert_size_stride(arg79_1, (32, ), (1, ))
    assert_size_stride(arg80_1, (1, 32), (32, 1))
    assert_size_stride(arg81_1, (1, ), (1, ))
    assert_size_stride(arg82_1, (32, 32), (32, 1))
    assert_size_stride(arg83_1, (32, ), (1, ))
    assert_size_stride(arg84_1, (32, 32), (32, 1))
    assert_size_stride(arg85_1, (32, ), (1, ))
    with torch.cuda._DeviceGuard(0):
        ...
        del arg0_1
        del arg1_1
        buf1 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf0, (4096, 18), (18, 1), 0), reinterpret_tensor(arg2_1, (18, 32), (1, 18), 0), out=buf1)
        del arg2_1
        del buf0
        buf2 = reinterpret_tensor(buf1, (1, 4096, 32), (131072, 32, 1), 0); del buf1  # reuse
        # Topologically Sorted Source Nodes: [input_2], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf2, arg3_1, 131072, grid=grid(131072), stream=stream0)
        del arg3_1
        buf3 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_3], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg5_1, reinterpret_tensor(buf2, (4096, 32), (32, 1), 0), reinterpret_tensor(arg4_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf3)
        del arg4_1
        del arg5_1
        buf8 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        buf4 = reinterpret_tensor(buf8, (4096, 32), (64, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [self_features], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg11_1, buf3, reinterpret_tensor(arg10_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf4)
        del arg10_1
        del arg11_1
        buf5 = reinterpret_tensor(buf2, (4096, 32), (32, 1), 0); del buf2  # reuse
        # Topologically Sorted Source Nodes: [neighbor_features], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg9_1, buf3, reinterpret_tensor(arg8_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf5)
        del arg8_1
        del arg9_1
        buf6 = reinterpret_tensor(buf8, (4096, 32), (64, 1), 32)  # alias
        # Topologically Sorted Source Nodes: [aggr], Original ATen: [aten.zeros_like]
        triton_poi_fused_zeros_like_2.run(buf6, 131072, grid=grid(131072), stream=stream0)
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf5, arg7_1, buf6, 873152, grid=grid(873152), stream=stream0)
        del buf4
        del buf6
        buf9 = buf5; del buf5  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf8, reinterpret_tensor(arg12_1, (64, 32), (1, 64), 0), out=buf9)
        del arg12_1
        ...
        # Topologically Sorted Source Nodes: [input_5], Original ATen: [aten.gelu]
        extern_kernels.mm(buf10, reinterpret_tensor(arg14_1, (32, 32), (1, 32), 0), out=buf11)
        del arg14_1
        ...
        buf13 = reinterpret_tensor(buf17, (4096, 32), (64, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [self_features_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg19_1, buf12, reinterpret_tensor(arg18_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf13)
        del arg18_1
        del arg19_1
        buf14 = buf3; del buf3  # reuse
        # Topologically Sorted Source Nodes: [neighbor_features_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg17_1, buf12, reinterpret_tensor(arg16_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf14)
        del arg16_1
        del arg17_1
        buf15 = reinterpret_tensor(buf17, (4096, 32), (64, 1), 32)  # alias
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf14, arg7_1, buf15, 873152, grid=grid(873152), stream=stream0)
        del arg6_1
        del arg7_1
        del buf13
        del buf15
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf17, reinterpret_tensor(arg20_1, (64, 32), (1, 64), 0), out=buf18)
        del arg20_1
        del buf17
        ...
        # Topologically Sorted Source Nodes: [input_8], Original ATen: [aten.gelu]
        extern_kernels.mm(buf19, reinterpret_tensor(arg22_1, (32, 32), (1, 32), 0), out=buf20)
        del arg22_1
        buf24 = reinterpret_tensor(buf19, (1, 4096, 32), (131072, 32, 1), 0); del buf19  # reuse
        # Topologically Sorted Source Nodes: [h_2], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf12, buf20, arg23_1, arg24_1, arg25_1, buf24, 4096, 32, grid=grid(4096), stream=stream0)
        del arg23_1
        del arg24_1
        del arg25_1
        buf25 = buf20; del buf20  # reuse
        # Topologically Sorted Source Nodes: [h_3], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg27_1, reinterpret_tensor(buf24, (4096, 32), (32, 1), 0), reinterpret_tensor(arg26_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf25)
        del arg26_1
        del arg27_1
        buf29 = buf24; del buf24  # reuse
        # Topologically Sorted Source Nodes: [layer_norm_1], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_6.run(buf25, arg32_1, arg33_1, buf29, 4096, 32, grid=grid(4096), stream=stream0)
        del arg32_1
        del arg33_1
        buf30 = empty_strided_cuda((4096, 96), (96, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf29, (4096, 32), (32, 1), 0), reinterpret_tensor(arg34_1, (32, 96), (1, 32), 0), out=buf30)
        del arg34_1
        ...
        buf33 = empty_strided_cuda((1, 32, 128, 128), (524288, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_1], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        buf35 = reinterpret_tensor(buf29, (32, 8, 128, 4), (4096, 512, 4, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf36 = reinterpret_tensor(buf12, (32, 8, 128, 4), (4096, 512, 4, 1), 0); del buf12  # reuse
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf37 = empty_strided_cuda((32, 8, 128, 4), (4096, 512, 4, 1), torch.float32)
        buf49 = empty_strided_cuda((32, 8, 128, 1, 4, 1), (4096, 512, 4, 4, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft, einsum_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        del arg39_1
        del buf47
        buf50 = reinterpret_tensor(buf37, (256, 128, 4), (512, 4, 1), 0); del buf37  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf48, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf49, (256, 128, 4), (512, 4, 1), 0), out=buf50)
        del buf48
        buf51 = reinterpret_tensor(buf40, (1, 32, 128, 8, 4), (131072, 4096, 32, 4, 1), 0); del buf40  # reuse
        # Topologically Sorted Source Nodes: [x_mid], Original ATen: [aten.add]
        triton_poi_fused_add_18.run(buf51, buf50, 131072, grid=grid(131072), stream=stream0)
        buf52 = reinterpret_tensor(buf50, (4096, 32), (32, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf51, (4096, 32), (32, 1), 0), reinterpret_tensor(arg40_1, (32, 32), (1, 32), 0), out=buf52)
        del arg40_1
        buf56 = reinterpret_tensor(buf51, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [row_highway], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf56, 131072, grid=grid(131072), stream=stream0)
        buf58 = reinterpret_tensor(buf49, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf49  # reuse
        ...
        buf66 = reinterpret_tensor(buf33, (1, 4096, 128), (524288, 128, 1), 0); del buf33  # reuse
        buf62 = reinterpret_tensor(buf66, (1, 4096, 32), (524288, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_d, z, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_20.run(buf25, buf52, arg41_1, arg42_1, arg46_1, arg47_1, buf56, buf58, buf62, 4096, 32, grid=grid(4096), stream=stream0)
        del arg46_1
        del arg47_1
        buf60 = empty_strided_cuda((1, 1, 32, 32), (1024, 1024, 1, 32), torch.float32)
        # Topologically Sorted Source Nodes: [x_mid_d, g], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_21.run(buf25, buf52, arg41_1, buf60, 1024, 128, grid=grid(1024), stream=stream0)
        buf61 = empty_strided_cuda((1, 1, 32), (32, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_mid_d, g], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_22.run(buf60, buf61, 32, 32, grid=grid(32), stream=stream0)
        del buf60
        buf63 = reinterpret_tensor(buf66, (1, 4096, 32), (524288, 128, 1), 32)  # alias
        # Topologically Sorted Source Nodes: [z_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_23.run(buf56, buf63, 131072, grid=grid(131072), stream=stream0)
        buf64 = reinterpret_tensor(buf66, (1, 4096, 32), (524288, 128, 1), 64)  # alias
        # Topologically Sorted Source Nodes: [z_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_23.run(buf58, buf64, 131072, grid=grid(131072), stream=stream0)
        buf65 = reinterpret_tensor(buf66, (1, 4096, 32), (524288, 128, 1), 96)  # alias
        # Topologically Sorted Source Nodes: [z_1], Original ATen: [aten.cat]
        ...
        del buf64
        del buf65
        buf67 = empty_strided_cuda((4096, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf66, (4096, 128), (128, 1), 0), reinterpret_tensor(arg48_1, (128, 128), (1, 128), 0), out=buf67)
        del arg48_1
        buf68 = reinterpret_tensor(buf67, (1, 4096, 128), (524288, 128, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_25.run(buf68, arg49_1, 524288, grid=grid(524288), stream=stream0)
        del arg49_1
        buf69 = reinterpret_tensor(buf58, (4096, 32), (32, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf68, (4096, 128), (128, 1), 0), reinterpret_tensor(arg50_1, (128, 32), (1, 128), 0), out=buf69)
        del arg50_1
        buf109 = buf56; del buf56  # reuse
        # Topologically Sorted Source Nodes: [row_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf109, 131072, grid=grid(131072), stream=stream0)
        buf115 = reinterpret_tensor(buf36, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [col_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf115, 131072, grid=grid(131072), stream=stream0)
        buf142 = reinterpret_tensor(buf35, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf35  # reuse
        # Topologically Sorted Source Nodes: [col_highway_2], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf142, 131072, grid=grid(131072), stream=stream0)
        buf145 = empty_strided_cuda((1, 32, 128, 32), (131072, 4096, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_highway_2], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf145, 131072, grid=grid(131072), stream=stream0)
        buf70 = reinterpret_tensor(buf69, (1, 4096, 32), (131072, 32, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9, row_highway_2, index_add__8], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_26.run(buf70, buf25, buf52, arg41_1, arg51_1, arg42_1, buf109, buf115, buf142, buf145, 131072, grid=grid(131072), stream=stream0)
        del arg41_1
        del arg51_1
        del buf25
        buf71 = empty_strided_cuda((1, 109, 4096), (446464, 4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_p_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf70, (1, 32, 4096), (131072, 4096, 1), 0), out=buf71)
        buf72 = empty_strided_cuda((1, 109, 4096), (446464, 4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_p_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf70, (1, 32, 4096), (131072, 4096, 1), 0), out=buf72)
        buf73 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        buf77 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_27.run(buf71, buf72, arg52_1, arg53_1, buf73, buf77, 3488, 32, grid=grid(3488), stream=stream0)
        del arg52_1
        del arg53_1
        buf78 = empty_strided_cuda((3488, 96), (96, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf77, (3488, 32), (32, 1), 0), reinterpret_tensor(arg54_1, (32, 96), (1, 32), 0), out=buf78)
        del arg54_1
        buf79 = reinterpret_tensor(buf72, (109, 32, 32, 4), (4096, 128, 4, 1), 0); del buf72  # reuse
        buf80 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [sub], Original ATen: [aten.mean]
        triton_per_fused_mean_28.run(buf80, arg29_1, 446464, 16, grid=grid(446464), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf80, 13952, grid=grid(13952), stream=stream0)
        buf82 = reinterpret_tensor(buf77, (109, 1, 32, 32), (1024, 1024, 32, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        buf84 = empty_strided_cuda((109, 8, 32, 4), (1024, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf78, arg55_1, buf84, 111616, grid=grid(111616), stream=stream0)
        buf85 = empty_strided_cuda((109, 8, 32, 4), (1024, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf78, arg55_1, buf85, 111616, grid=grid(111616), stream=stream0)
        buf86 = empty_strided_cuda((109, 8, 32, 4), (1024, 128, 4, 1), torch.float32)
        buf98 = empty_strided_cuda((109, 8, 32, 1, 4, 1), (1024, 128, 4, 4, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf78, arg55_1, buf86, buf98, 111616, grid=grid(111616), stream=stream0)
        del arg55_1
        del buf78
        ...
        buf89 = buf88[0]
        del buf88
        buf93 = reinterpret_tensor(buf71, (109, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf82, buf80, buf93, 446464, grid=grid(446464), stream=stream0)
        buf94 = empty_strided_cuda((111616, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg59_1
        del buf96
        buf99 = reinterpret_tensor(buf82, (872, 32, 4), (128, 4, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf97, (872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf98, (872, 32, 4), (128, 4, 1), 0), out=buf99)
        del buf97
        buf100 = reinterpret_tensor(buf89, (109, 1, 32, 8, 4), (1024, 1, 32, 4, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        triton_poi_fused_add_39.run(buf100, buf99, 111616, grid=grid(111616), stream=stream0)
        buf101 = reinterpret_tensor(buf99, (3488, 32), (32, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (3488, 32), (32, 1), 0), reinterpret_tensor(arg60_1, (32, 32), (1, 32), 0), out=buf101)
        del arg60_1
        buf125 = reinterpret_tensor(buf93, (109, 32, 128), (4096, 128, 1), 0); del buf93  # reuse
        buf121 = reinterpret_tensor(buf125, (109, 32, 32), (4096, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf73, buf101, arg61_1, arg62_1, arg63_1, buf121, 3488, 32, grid=grid(3488), stream=stream0)
        del arg62_1
        del arg63_1
        buf105 = buf52; del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf70, (4096, 32), (32, 1), 0), reinterpret_tensor(arg68_1, (32, 32), (1, 32), 0), out=buf105)
        del arg68_1
        buf106 = reinterpret_tensor(buf105, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf106, arg69_1, 131072, grid=grid(131072), stream=stream0)
        del arg69_1
        buf107 = reinterpret_tensor(buf68, (4096, 128), (128, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf106, (4096, 32), (32, 1), 0), reinterpret_tensor(arg70_1, (32, 128), (1, 32), 0), alpha=1, beta=1, out=buf107)
        del arg70_1
        del arg71_1
        del buf106
        buf108 = reinterpret_tensor(buf66, (32, 128, 128), (16384, 128, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf107, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf107, (32, 128, 128), (16384, 1, 128), 0), out=buf108)
        del buf107
        buf111 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf111.copy_(arg43_1)
        del arg43_1
        buf112 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf112.copy_(arg45_1)
        del arg45_1
        buf117 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf117.copy_(arg44_1)
        del arg44_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_41.run(buf111, buf112, buf73, buf101, arg61_1, buf117, buf109, buf115, 729088, grid=grid(729088), stream=stream0)
        buf114 = reinterpret_tensor(buf80, (1, 109, 4096), (446464, 4096, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf109, (1, 32, 4096), (131072, 4096, 1), 0), out=buf114)
        del arg30_1
        buf119 = empty_strided_cuda((1, 109, 4096), (446464, 4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf115, (1, 32, 4096), (131072, 4096, 1), 0), out=buf119)
        del arg31_1
        buf120 = empty_strided_cuda((109, 1, 32), (32, 3488, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_mid_o, g_1], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_42.run(buf73, buf101, arg61_1, buf120, 3488, 32, grid=grid(3488), stream=stream0)
        buf122 = reinterpret_tensor(buf125, (109, 32, 32), (4096, 128, 1), 32)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf114, buf122, 111616, grid=grid(111616), stream=stream0)
        del buf114
        buf123 = reinterpret_tensor(buf125, (109, 32, 32), (4096, 128, 1), 64)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf119, buf123, 111616, grid=grid(111616), stream=stream0)
        buf124 = reinterpret_tensor(buf125, (109, 32, 32), (4096, 128, 1), 96)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf120, buf124, 111616, grid=grid(111616), stream=stream0)
        del buf120
        del buf121
        del buf122
        del buf123
        del buf124
        buf126 = reinterpret_tensor(buf119, (3488, 128), (128, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf125, (3488, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf126)
        del arg64_1
        del buf125
        buf127 = reinterpret_tensor(buf126, (109, 32, 128), (4096, 128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf127, arg65_1, 446464, grid=grid(446464), stream=stream0)
        del arg65_1
        buf128 = reinterpret_tensor(buf100, (3488, 32), (32, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf127, (3488, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 32), (1, 128), 0), out=buf128)
        del arg66_1
        del buf127
        buf129 = reinterpret_tensor(buf128, (109, 32, 32), (1024, 32, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_46.run(buf129, buf73, buf101, arg61_1, arg67_1, 111616, grid=grid(111616), stream=stream0)
        del arg61_1
        del arg67_1
        buf130 = reinterpret_tensor(buf73, (3488, 32), (32, 1), 0); del buf73  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf129, (3488, 32), (32, 1), 0), reinterpret_tensor(arg72_1, (32, 32), (1, 32), 0), out=buf130)
        del arg72_1
        buf131 = reinterpret_tensor(buf130, (109, 1, 32, 32), (1024, 1, 32, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf131, arg73_1, 111616, grid=grid(111616), stream=stream0)
        del arg73_1
        buf132 = buf101; del buf101  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf131, (3488, 32), (32, 1), 0), reinterpret_tensor(arg74_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf132)
        del arg74_1
        del arg75_1
        buf133 = reinterpret_tensor(buf131, (3488, 32), (32, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf129, (3488, 32), (32, 1), 0), reinterpret_tensor(arg76_1, (32, 32), (1, 32), 0), out=buf133)
        del arg76_1
        buf134 = reinterpret_tensor(buf133, (109, 1, 32, 32), (1024, 1, 32, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf134, arg77_1, 111616, grid=grid(111616), stream=stream0)
        del arg77_1
        buf135 = reinterpret_tensor(buf98, (3488, 32), (32, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf134, (3488, 32), (32, 1), 0), reinterpret_tensor(arg78_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf135)
        del arg78_1
        del arg79_1
        buf136 = reinterpret_tensor(buf134, (109, 32, 32), (1024, 32, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf132, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf135, (109, 32, 32), (1024, 1, 32), 0), out=buf136)
        del buf132
        del buf135
        buf137 = reinterpret_tensor(buf115, (4096, 32), (32, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf70, (4096, 32), (32, 1), 0), reinterpret_tensor(arg82_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf137)
        del arg82_1
        del arg83_1
        buf138 = reinterpret_tensor(buf109, (4096, 32), (32, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf70, (4096, 32), (32, 1), 0), reinterpret_tensor(arg84_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf138)
        del arg84_1
        del arg85_1
        buf139 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf70, (4096, 32), (32, 1), 0), reinterpret_tensor(arg80_1, (32, 1), (1, 32), 0), out=buf139)
        del arg80_1
        del buf70
        buf140 = reinterpret_tensor(buf139, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_48.run(buf140, arg81_1, 4096, grid=grid(4096), stream=stream0)
        del arg81_1
        buf141 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_49.run(buf108, buf136, buf137, buf138, buf140, buf141, 902144, grid=grid(902144), stream=stream0)
        del buf108
        del buf136
        del buf137
        del buf138
        # Topologically Sorted Source Nodes: [toks_3, index_add__11, index_add__10], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_50.run(buf117, buf112, buf129, buf111, buf142, buf145, 729088, grid=grid(729088), stream=stream0)
        del buf129
    return (buf141, reinterpret_tensor(buf140, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf142, (1, 4096, 32), (131072, 32, 1), 0), reinterpret_tensor(buf145, (1, 4096, 32), (131072, 32, 1), 0), arg42_1, buf111, buf117, buf112, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((32, 18), (18, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg14_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg22_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg26_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg34_1 = rand_strided((96, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg40_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg50_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg54_1 = rand_strided((96, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg60_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg66_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg67_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg68_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg69_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg70_1 = rand_strided((128, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg71_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg72_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg73_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg74_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg75_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg76_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg77_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg78_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg79_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg80_1 = rand_strided((1, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg81_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg82_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg83_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg84_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg85_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
