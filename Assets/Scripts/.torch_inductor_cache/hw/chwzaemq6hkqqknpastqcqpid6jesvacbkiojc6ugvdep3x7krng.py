...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg52_1
        buf163 = reinterpret_tensor(buf86, (1, 512, 128), (65536, 128, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf60, buf87, arg53_1, arg54_1, arg55_1, buf163, 512, 128, grid=grid(512), stream=stream0)
        del arg54_1
        del arg55_1
        buf91 = reinterpret_tensor(buf65, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf91, 196608, grid=grid(196608), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [row_sum, getitem_22, index_add__2, col_sum, getitem_23, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_22.run(arg64_1, arg62_1, buf25, arg63_1, buf91, buf93, 270336, grid=grid(270336), stream=stream0)
        del arg62_1
        del arg63_1
        del arg64_1
        del buf25
        buf95 = empty_strided_cuda((48, 16, 128), (2048, 128, 1), torch.float32)
        buf101 = empty_strided_cuda((48, 16, 128), (2048, 128, 1), torch.float32)
        buf106 = empty_strided_cuda((48, 1, 17, 128), (2176, 1, 128, 1), torch.float32)
        buf104 = reinterpret_tensor(buf106, (48, 1, 16, 128), (2176, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [h_off_1, layer_norm_5, kv_2], Original ATen: [aten.mean, aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_mean_native_layer_norm_23.run(buf91, arg65_1, buf93, arg66_1, arg67_1, buf95, buf101, buf104, 768, 128, grid=grid(768), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        del buf91
        del buf93
        buf99 = empty_strided_cuda((48, 16, 17, 4), (1088, 68, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(arg30_1, buf99, 52224, grid=grid(52224), stream=stream0)
        del arg30_1
        buf100 = empty_strided_cuda((48, 16, 17), (272, 17, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.cat]
        triton_poi_fused_cat_25.run(arg31_1, buf100, 13056, grid=grid(13056), stream=stream0)
        del arg31_1
        buf102 = empty_strided_cuda((768, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (768, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 384), (1, 128), 0), out=buf102)
        buf105 = reinterpret_tensor(buf106, (48, 1, 1, 128), (2176, 1, 128, 1), 2048)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_26.run(buf101, buf105, 6144, 16, grid=grid(6144), stream=stream0)
        del buf104
        del buf105
        buf107 = empty_strided_cuda((816, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf106, (816, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 384), (1, 128), 0), out=buf107)
        del arg68_1
        buf108 = reinterpret_tensor(buf101, (48, 8, 16, 16, 1, 1), (2048, 256, 16, 1, 1, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf102, arg69_1, buf108, 98304, grid=grid(98304), stream=stream0)
        buf109 = reinterpret_tensor(buf106, (48, 8, 16, 1, 17, 1), (2176, 272, 17, 17, 1, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf107, arg69_1, buf109, 6144, 17, grid=grid(6144, 17), stream=stream0)
        buf110 = empty_strided_cuda((384, 16, 17), (272, 17, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf108, (384, 16, 16), (256, 16, 1), 0), reinterpret_tensor(buf109, (384, 16, 17), (272, 17, 1), 0), out=buf110)
        buf111 = empty_strided_cuda((48, 1, 16, 17, 4), (1088, 52224, 68, 4, 1), torch.float32)
        buf146 = empty_strided_cuda((48, 1, 16, 17, 4), (1088, 52224, 68, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_29.run(buf99, buf111, buf146, 52224, grid=grid(52224), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_30.run(buf111, 3072, grid=grid(3072), stream=stream0)
        buf113 = empty_strided_cuda((48, 1, 16, 17), (272, 272, 17, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf111, buf113, 13056, grid=grid(13056), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf113, 768, grid=grid(768), stream=stream0)
        buf116 = reinterpret_tensor(buf109, (48, 1, 16, 17, 8), (2176, 104448, 17, 1, 272), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_33.run(buf100, buf110, buf113, buf111, buf116, 6144, 17, grid=grid(6144), stream=stream0)
        buf117 = empty_strided_cuda((48, 1, 16, 1, 8), (128, 6144, 8, 6144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_per_fused__softmax_34.run(buf116, buf117, 6144, 17, grid=grid(6144), stream=stream0)
        buf118 = reinterpret_tensor(buf99, (48, 1, 16, 17, 4), (1088, 1, 68, 4, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_35.run(buf113, buf111, buf118, 52224, grid=grid(52224), stream=stream0)
        del buf111
        buf119 = reinterpret_tensor(buf110, (13056, 8), (8, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf118, (13056, 4), (4, 1), 0), reinterpret_tensor(arg70_1, (4, 8), (1, 4), 0), out=buf119)
        del arg70_1
        buf120 = reinterpret_tensor(buf116, (48, 8, 16, 17, 1, 1), (2176, 272, 17, 1, 1, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf120, buf117, buf100, buf119, arg71_1, 384, 272, grid=grid(384, 272), stream=stream0)
        del arg71_1
        buf121 = reinterpret_tensor(buf119, (48, 8, 17, 1, 16, 1), (2176, 272, 16, 16, 1, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_37.run(buf107, arg69_1, buf121, 104448, grid=grid(104448), stream=stream0)
        del arg69_1
        buf122 = reinterpret_tensor(buf108, (384, 16, 16), (256, 16, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf120, (384, 16, 17), (272, 17, 1), 0), reinterpret_tensor(buf121, (384, 17, 16), (272, 16, 1), 0), out=buf122)
        buf123 = empty_strided_cuda((48, 1, 16, 8, 16), (2048, 1, 128, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf122, buf123, 98304, grid=grid(98304), stream=stream0)
        buf124 = reinterpret_tensor(buf122, (768, 128), (128, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf123, (768, 128), (128, 1), 0), reinterpret_tensor(arg72_1, (128, 128), (1, 128), 0), out=buf124)
        del arg72_1
        buf128 = reinterpret_tensor(buf123, (48, 16, 128), (2048, 128, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_39.run(buf95, buf124, arg73_1, arg74_1, arg75_1, buf128, 768, 128, grid=grid(768), stream=stream0)
        del arg74_1
        del arg75_1
        buf129 = empty_strided_cuda((768, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (768, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 512), (1, 128), 0), out=buf129)
        del arg76_1
        buf130 = reinterpret_tensor(buf129, (48, 16, 512), (8192, 512, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_40.run(buf130, arg77_1, 393216, grid=grid(393216), stream=stream0)
        del arg77_1
        buf131 = reinterpret_tensor(buf128, (768, 128), (128, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf130, (768, 512), (512, 1), 0), reinterpret_tensor(arg78_1, (512, 128), (1, 512), 0), out=buf131)
        del arg78_1
        buf132 = reinterpret_tensor(buf131, (48, 16, 128), (2048, 128, 1), 0); del buf131  # reuse
        buf136 = empty_strided_cuda((48, 16, 128), (2048, 128, 1), torch.float32)
        buf141 = reinterpret_tensor(buf121, (48, 1, 17, 128), (2176, 1, 128, 1), 0); del buf121  # reuse
        buf139 = reinterpret_tensor(buf141, (48, 1, 16, 128), (2176, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_4, x_5, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_41.run(buf132, buf95, buf124, arg73_1, arg79_1, arg80_1, arg81_1, buf136, buf139, 768, 128, grid=grid(768), stream=stream0)
        del arg73_1
        del arg79_1
        del arg80_1
        del arg81_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (768, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 384), (1, 128), 0), out=buf137)
        buf140 = reinterpret_tensor(buf141, (48, 1, 1, 128), (2176, 1, 128, 1), 2048)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_26.run(buf136, buf140, 6144, 16, grid=grid(6144), stream=stream0)
        del buf139
        del buf140
        buf142 = buf107; del buf107  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (816, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 384), (1, 128), 0), out=buf142)
        del arg82_1
        buf143 = reinterpret_tensor(buf136, (48, 8, 16, 16, 1, 1), (2048, 256, 16, 1, 1, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf137, arg83_1, buf143, 98304, grid=grid(98304), stream=stream0)
        del buf137
        buf144 = reinterpret_tensor(buf141, (48, 8, 16, 1, 17, 1), (2176, 272, 17, 17, 1, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf142, arg83_1, buf144, 6144, 17, grid=grid(6144, 17), stream=stream0)
        buf145 = reinterpret_tensor(buf120, (384, 16, 17), (272, 17, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf143, (384, 16, 16), (256, 16, 1), 0), reinterpret_tensor(buf144, (384, 16, 17), (272, 17, 1), 0), out=buf145)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_30.run(buf146, 3072, grid=grid(3072), stream=stream0)
        buf148 = buf113; del buf113  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf146, buf148, 13056, grid=grid(13056), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf148, 768, grid=grid(768), stream=stream0)
        buf151 = reinterpret_tensor(buf144, (48, 1, 16, 17, 8), (2176, 104448, 17, 1, 272), 0); del buf144  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_33.run(buf100, buf145, buf148, buf146, buf151, 6144, 17, grid=grid(6144), stream=stream0)
        buf152 = buf117; del buf117  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_34.run(buf151, buf152, 6144, 17, grid=grid(6144), stream=stream0)
        buf153 = buf118; del buf118  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_35.run(buf148, buf146, buf153, 52224, grid=grid(52224), stream=stream0)
        del buf146
        del buf148
        buf154 = reinterpret_tensor(buf145, (13056, 8), (8, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (13056, 4), (4, 1), 0), reinterpret_tensor(arg84_1, (4, 8), (1, 4), 0), out=buf154)
        del arg84_1
        del buf153
        buf155 = reinterpret_tensor(buf151, (48, 8, 16, 17, 1, 1), (2176, 272, 17, 1, 1, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf155, buf152, buf100, buf154, arg85_1, 384, 272, grid=grid(384, 272), stream=stream0)
        del arg85_1
        del buf100
        del buf152
        buf156 = reinterpret_tensor(buf154, (48, 8, 17, 1, 16, 1), (2176, 272, 16, 16, 1, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_37.run(buf142, arg83_1, buf156, 104448, grid=grid(104448), stream=stream0)
        del arg83_1
        del buf142
        buf157 = reinterpret_tensor(buf143, (384, 16, 16), (256, 16, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf155, (384, 16, 17), (272, 17, 1), 0), reinterpret_tensor(buf156, (384, 17, 16), (272, 16, 1), 0), out=buf157)
        del buf155
        del buf156
        buf158 = reinterpret_tensor(buf95, (48, 1, 16, 8, 16), (2048, 1, 128, 16, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf157, buf158, 98304, grid=grid(98304), stream=stream0)
        buf159 = reinterpret_tensor(buf157, (768, 128), (128, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (768, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 128), (1, 128), 0), out=buf159)
        del arg86_1
        buf170 = reinterpret_tensor(buf158, (48, 16, 128), (2048, 128, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_39.run(buf132, buf159, arg87_1, arg88_1, arg89_1, buf170, 768, 128, grid=grid(768), stream=stream0)
        del arg88_1
        del arg89_1
        buf164 = reinterpret_tensor(buf58, (512, 512), (512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (512, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 512), (1, 128), 0), out=buf164)
        del arg56_1
        buf165 = reinterpret_tensor(buf164, (1, 512, 512), (262144, 512, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf165, arg57_1, 262144, grid=grid(262144), stream=stream0)
        del arg57_1
        buf166 = reinterpret_tensor(buf163, (512, 128), (128, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (512, 512), (512, 1), 0), reinterpret_tensor(arg58_1, (512, 128), (1, 512), 0), out=buf166)
        del arg58_1
        del buf165
        buf167 = reinterpret_tensor(buf166, (1, 512, 128), (65536, 128, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf167, buf60, buf87, arg53_1, arg59_1, 65536, grid=grid(65536), stream=stream0)
        del arg53_1
        del arg59_1
        del buf60
        del buf87
        ...
        extern_kernels.addmm(arg61_1, reinterpret_tensor(buf167, (512, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf168)
        del arg60_1
        del arg61_1
        ...
        del buf168
        buf171 = reinterpret_tensor(buf130, (768, 512), (512, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (768, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 512), (1, 128), 0), out=buf171)
        del arg90_1
        buf172 = reinterpret_tensor(buf171, (48, 16, 512), (8192, 512, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_40.run(buf172, arg91_1, 393216, grid=grid(393216), stream=stream0)
        del arg91_1
        buf173 = reinterpret_tensor(buf170, (768, 128), (128, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (768, 512), (512, 1), 0), reinterpret_tensor(arg92_1, (512, 128), (1, 512), 0), out=buf173)
        del arg92_1
        del buf172
        buf174 = reinterpret_tensor(buf173, (48, 16, 128), (2048, 128, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf174, buf132, buf159, arg87_1, arg93_1, 98304, grid=grid(98304), stream=stream0)
        del arg87_1
        del arg93_1
        del buf132
        del buf159
        buf175 = empty_strided_cuda((768, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf174, (768, 128), (128, 1), 0), reinterpret_tensor(arg94_1, (128, 16), (1, 128), 0), alpha=1, beta=1, out=buf175)
        del arg94_1
        del arg95_1
        buf176 = empty_strided_cuda((768, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg97_1, reinterpret_tensor(buf174, (768, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 16), (1, 128), 0), alpha=1, beta=1, out=buf176)
        del arg96_1
        del arg97_1
        del buf174
        buf177 = empty_strided_cuda((48, 16, 16), (256, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf175, (48, 16, 16), (256, 16, 1), 0), reinterpret_tensor(buf176, (48, 16, 16), (256, 1, 16), 0), out=buf177)
        del buf175
        del buf176
        buf178 = empty_strided_cuda((512, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf167, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 16), (1, 128), 0), alpha=1, beta=1, out=buf178)
        del arg100_1
        del arg101_1
        buf179 = empty_strided_cuda((512, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf167, (512, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 16), (1, 128), 0), alpha=1, beta=1, out=buf179)
        del arg102_1
        del arg103_1
        buf180 = empty_strided_cuda((512, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf167, (512, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 1), (1, 128), 0), out=buf180)
        del arg98_1
        del buf167
        buf181 = reinterpret_tensor(buf180, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_44.run(buf181, arg99_1, 512, grid=grid(512), stream=stream0)
        del arg99_1
        buf182 = empty_strided_cuda((1, 45568), (45568, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf169, buf177, buf178, buf179, buf181, buf182, 45568, grid=grid(45568), stream=stream0)
        del buf169
        del buf177
        del buf178
        del buf179
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg62_1 = rand_strided((66, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg63_1 = rand_strided((66, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg64_1 = rand_strided((66, ), (1, ), device='cuda:0', dtype=torch.int64)
