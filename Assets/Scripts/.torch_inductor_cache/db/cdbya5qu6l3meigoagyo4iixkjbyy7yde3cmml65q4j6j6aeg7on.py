...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5i/c5il2h4ec2f2r2aarlcjfm35oktwbsu7tg43yn2th6rrowy56yvs.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr0 + (115758 + x1), xmask, eviction_policy='evict_last')
    tmp12 = tl.load(in_ptr2 + (x1), xmask, eviction_policy='evict_last')
    tmp1 = tl.full([XBLOCK], 16384, tl.int32)
    tmp2 = tmp0 + tmp1
    tmp3 = tmp0 < 0
    tmp4 = tl.where(tmp3, tmp2, tmp0)
    tl.device_assert(((0 <= tmp4) & (tmp4 < 16384)) | ~(xmask), "index out of bounds: 0 <= tmp4 < 16384")
    tmp7 = tmp6 + tmp1
    tmp8 = tmp6 < 0
    tmp9 = tl.where(tmp8, tmp7, tmp6)
    tl.device_assert(((0 <= tmp9) & (tmp9 < 16384)) | ~(xmask), "index out of bounds: 0 <= tmp9 < 16384")
...
def call(args):
    ...
    assert_size_stride(arg6_1, (2, 115758), (115758, 1))
    assert_size_stride(arg7_1, (115758, ), (1, ))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_4.run(arg6_1, buf6, arg7_1, buf7, 14817024, grid=grid(14817024), stream=stream0)
        del buf5
        del buf7
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_4.run(arg6_1, buf15, arg7_1, buf16, 14817024, grid=grid(14817024), stream=stream0)
        del arg6_1
        del arg7_1
        del buf14
        del buf16
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, z, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_21.run(buf26, buf53, arg41_1, arg42_1, arg43_1, arg44_1, buf57, buf59, buf63, 16384, 128, grid=grid(16384), stream=stream0)
        del arg43_1
        del arg44_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (16384, 512), (512, 1), 0), reinterpret_tensor(arg45_1, (512, 512), (1, 512), 0), out=buf68)
        del arg45_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf69, (16384, 512), (512, 1), 0), reinterpret_tensor(arg47_1, (512, 128), (1, 512), 0), out=buf70)
        del arg47_1
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_27.run(buf71, buf26, buf53, arg41_1, arg48_1, arg68_1, arg69_1, buf109, 16384, 128, grid=grid(16384), stream=stream0)
        del arg41_1
        del arg48_1
        del arg68_1
        del arg69_1
        ...
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_28.run(buf72, buf73, arg49_1, arg50_1, buf74, buf78, 15584, 128, grid=grid(15584), stream=stream0)
        del arg49_1
        del arg50_1
        buf79 = empty_strided_cuda((15584, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (15584, 128), (128, 1), 0), reinterpret_tensor(arg51_1, (128, 384), (1, 128), 0), out=buf79)
        del arg51_1
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf79, arg52_1, buf85, 1994752, grid=grid(1994752), stream=stream0)
        buf86 = empty_strided_cuda((487, 8, 32, 16), (4096, 512, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf79, arg52_1, buf86, 1994752, grid=grid(1994752), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf79, arg52_1, buf87, buf99, 1994752, grid=grid(1994752), stream=stream0)
        del arg52_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (15584, 128), (128, 1), 0), reinterpret_tensor(arg57_1, (128, 128), (1, 128), 0), out=buf102)
        del arg57_1
        buf151 = reinterpret_tensor(buf96, (487, 32, 512), (16384, 512, 1), 0); del buf96  # reuse
        buf147 = reinterpret_tensor(buf151, (487, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf74, buf102, arg58_1, arg62_1, arg63_1, buf147, 15584, 128, grid=grid(15584), stream=stream0)
        del arg62_1
        del arg63_1
        ...
        buf142 = reinterpret_tensor(buf117, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf117  # reuse
        ...
        buf157 = reinterpret_tensor(buf116, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf116  # reuse
        ...
        buf166 = reinterpret_tensor(buf124, (1, 16384, 512), (8388608, 512, 1), 0); del buf124  # reuse
        buf162 = reinterpret_tensor(buf166, (1, 16384, 128), (8388608, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_d_1, z_4, row_highway_2, index_add__8, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_42.run(buf71, buf132, arg77_1, arg42_1, arg78_1, arg79_1, buf136, buf157, buf162, buf138, buf142, 16384, 128, grid=grid(16384), stream=stream0)
        del arg78_1
        del arg79_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_43.run(arg60_1, arg59_1, buf74, buf102, arg58_1, arg61_1, buf138, buf142, 17858560, grid=grid(17858560), stream=stream0)
        buf141 = buf72; del buf72  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf138, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf141)
        buf145 = empty_strided_cuda((1, 487, 16384), (7979008, 16384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf142, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf145)
        buf146 = empty_strided_cuda((487, 1, 128), (128, 62336, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_mid_o, g_1], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf74, buf102, arg58_1, buf146, 62336, 32, grid=grid(62336), stream=stream0)
        buf148 = reinterpret_tensor(buf151, (487, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf141, buf148, 1994752, grid=grid(1994752), stream=stream0)
        buf149 = reinterpret_tensor(buf151, (487, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf145, buf149, 1994752, grid=grid(1994752), stream=stream0)
        buf150 = reinterpret_tensor(buf151, (487, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf146, buf150, 1994752, grid=grid(1994752), stream=stream0)
        del buf147
        del buf148
        del buf149
        del buf150
        buf152 = reinterpret_tensor(buf145, (15584, 512), (512, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf151, (15584, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 512), (1, 512), 0), out=buf152)
        del arg64_1
        buf153 = reinterpret_tensor(buf152, (487, 32, 512), (16384, 512, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf153, arg65_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg65_1
        buf154 = reinterpret_tensor(buf101, (15584, 128), (128, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (15584, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 128), (1, 512), 0), out=buf154)
        del arg66_1
        buf155 = reinterpret_tensor(buf154, (487, 32, 128), (4096, 128, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf155, buf74, buf102, arg58_1, arg67_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg58_1
        del arg67_1
        # Topologically Sorted Source Nodes: [toks_3, index_add__10, index_add__11], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_49.run(arg60_1, arg59_1, buf155, arg61_1, buf136, buf157, 17858560, grid=grid(17858560), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x_mid_d_1, g_2], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_23.run(buf160, buf161, 128, 128, grid=grid(128), stream=stream0)
        buf163 = reinterpret_tensor(buf166, (1, 16384, 128), (8388608, 512, 1), 128)  # alias
        ...
        buf164 = reinterpret_tensor(buf166, (1, 16384, 128), (8388608, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_5], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf157, buf164, 2097152, grid=grid(2097152), stream=stream0)
        buf165 = reinterpret_tensor(buf166, (1, 16384, 128), (8388608, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_5], Original ATen: [aten.cat]
        ...
        del buf164
        del buf165
        buf167 = reinterpret_tensor(buf111, (16384, 512), (512, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf166, (16384, 512), (512, 1), 0), reinterpret_tensor(arg80_1, (512, 512), (1, 512), 0), out=buf167)
        del arg80_1
        buf168 = reinterpret_tensor(buf167, (1, 16384, 512), (8388608, 512, 1), 0); del buf167  # reuse
        ...
        del arg81_1
        buf169 = reinterpret_tensor(buf157, (16384, 128), (128, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (16384, 512), (512, 1), 0), reinterpret_tensor(arg82_1, (512, 128), (1, 512), 0), out=buf169)
        del arg82_1
        buf170 = reinterpret_tensor(buf169, (1, 16384, 128), (2097152, 128, 1), 0); del buf169  # reuse
        buf207 = reinterpret_tensor(buf136, (1, 16384, 128), (2097152, 128, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, h_diag_2, layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_27.run(buf170, buf71, buf132, arg77_1, arg83_1, arg100_1, arg101_1, buf207, 16384, 128, grid=grid(16384), stream=stream0)
        del arg100_1
        del arg101_1
        del arg77_1
        del arg83_1
        buf171 = reinterpret_tensor(buf153, (1, 487, 16384), (7979008, 16384, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [row_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf170, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf171)
        buf172 = reinterpret_tensor(buf151, (1, 487, 16384), (7979008, 16384, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [col_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf170, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf172)
        buf173 = buf155; del buf155  # reuse
        buf177 = buf74; del buf74  # reuse
        # Topologically Sorted Source Nodes: [h_off_5, off_in, layer_norm_7], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_50.run(buf173, buf171, buf172, arg84_1, arg85_1, buf177, 15584, 128, grid=grid(15584), stream=stream0)
        del arg84_1
        del arg85_1
        buf178 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf177, (15584, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf178)
        del arg86_1
        ...
        buf183 = reinterpret_tensor(buf177, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf177  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf178, arg87_1, buf183, 1994752, grid=grid(1994752), stream=stream0)
        buf184 = reinterpret_tensor(buf102, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf178, arg87_1, buf184, 1994752, grid=grid(1994752), stream=stream0)
        buf185 = reinterpret_tensor(buf99, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf99  # reuse
        buf197 = reinterpret_tensor(buf81, (487, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf81  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf178, arg87_1, buf185, buf197, 1994752, grid=grid(1994752), stream=stream0)
        del arg87_1
        buf186 = reinterpret_tensor(buf98, (487, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf188 = buf187[0]
        del buf187
        buf192 = reinterpret_tensor(buf185, (487, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf181, buf179, buf192, 1994752, grid=grid(1994752), stream=stream0)
        buf193 = reinterpret_tensor(buf172, (498688, 16), (16, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg90_1
        buf196 = reinterpret_tensor(buf97, (487, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf97  # reuse
        ...
        del arg91_1
        buf198 = reinterpret_tensor(buf192, (3896, 32, 16), (512, 16, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [einsum_11], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf196, (3896, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf197, (3896, 32, 16), (512, 16, 1), 0), out=buf198)
        buf199 = reinterpret_tensor(buf188, (487, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf188  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf199, buf198, 1994752, grid=grid(1994752), stream=stream0)
        buf200 = reinterpret_tensor(buf198, (15584, 128), (128, 1), 0); del buf198  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf199, (15584, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 128), (1, 128), 0), out=buf200)
        del arg92_1
        buf249 = reinterpret_tensor(buf194, (487, 32, 512), (16384, 512, 1), 0); del buf194  # reuse
        buf245 = reinterpret_tensor(buf249, (487, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_1, z_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf173, buf200, arg93_1, arg94_1, arg95_1, buf245, 15584, 128, grid=grid(15584), stream=stream0)
        del arg94_1
        del arg95_1
        buf208 = buf110; del buf110  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf207, (16384, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 384), (1, 128), 0), out=buf208)
        del arg102_1
        buf209 = reinterpret_tensor(buf168, (1, 128, 128, 128, 4), (8388608, 65536, 512, 4, 1), 0); del buf168  # reuse
        ...
        buf211 = reinterpret_tensor(buf207, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf207  # reuse
        ...
        buf213 = reinterpret_tensor(buf71, (128, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf71  # reuse
        ...
        buf214 = reinterpret_tensor(buf132, (128, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf215 = reinterpret_tensor(buf142, (128, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf142  # reuse
        buf227 = reinterpret_tensor(buf138, (128, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf138  # reuse
        ...
        del arg103_1
        del buf208
        buf216 = reinterpret_tensor(buf128, (128, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf218 = buf217[0]
        del buf217
        buf222 = reinterpret_tensor(buf166, (1, 128, 128, 128, 4), (8388608, 65536, 512, 4, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg106_1
        del buf224
        buf226 = reinterpret_tensor(buf127, (128, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf127  # reuse
        ...
        del arg107_1
        del buf225
        buf228 = reinterpret_tensor(buf211, (1024, 128, 16), (2048, 16, 1), 0); del buf211  # reuse
        # Topologically Sorted Source Nodes: [einsum_14], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf226, (1024, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf227, (1024, 128, 16), (2048, 16, 1), 0), out=buf228)
        del buf226
        buf229 = reinterpret_tensor(buf218, (1, 128, 128, 8, 16), (2097152, 16384, 128, 16, 1), 0); del buf218  # reuse
        ...
        buf230 = reinterpret_tensor(buf228, (16384, 128), (128, 1), 0); del buf228  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf229, (16384, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), out=buf230)
        del arg108_1
        buf234 = reinterpret_tensor(buf229, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf229  # reuse
        ...
        buf236 = reinterpret_tensor(buf227, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf227  # reuse
        ...
        buf240 = reinterpret_tensor(buf215, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf215  # reuse
        ...
        buf255 = reinterpret_tensor(buf214, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf214  # reuse
        ...
        buf264 = reinterpret_tensor(buf222, (1, 16384, 512), (8388608, 512, 1), 0); del buf222  # reuse
        buf260 = reinterpret_tensor(buf264, (1, 16384, 128), (8388608, 512, 1), 0)  # alias
        ...
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_42.run(buf170, buf230, arg109_1, arg42_1, arg110_1, arg111_1, buf234, buf255, buf260, buf236, buf240, 16384, 128, grid=grid(16384), stream=stream0)
        del arg110_1
        del arg111_1
        # Topologically Sorted Source Nodes: [toks_5, index_add__14, index_add__15], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_43.run(arg60_1, arg59_1, buf173, buf200, arg93_1, arg61_1, buf236, buf240, 17858560, grid=grid(17858560), stream=stream0)
        buf239 = buf171; del buf171  # reuse
        # Topologically Sorted Source Nodes: [row_t_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf236, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf239)
        buf243 = buf141; del buf141  # reuse
        # Topologically Sorted Source Nodes: [col_t_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf240, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf243)
        buf244 = buf146; del buf146  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, g_3], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf173, buf200, arg93_1, buf244, 62336, 32, grid=grid(62336), stream=stream0)
        buf246 = reinterpret_tensor(buf249, (487, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf239, buf246, 1994752, grid=grid(1994752), stream=stream0)
        buf247 = reinterpret_tensor(buf249, (487, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf243, buf247, 1994752, grid=grid(1994752), stream=stream0)
        buf248 = reinterpret_tensor(buf249, (487, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf244, buf248, 1994752, grid=grid(1994752), stream=stream0)
        del buf245
        del buf246
        del buf247
        del buf248
        buf250 = reinterpret_tensor(buf243, (15584, 512), (512, 1), 0); del buf243  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf249, (15584, 512), (512, 1), 0), reinterpret_tensor(arg96_1, (512, 512), (1, 512), 0), out=buf250)
        del arg96_1
        buf251 = reinterpret_tensor(buf250, (487, 32, 512), (16384, 512, 1), 0); del buf250  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf251, arg97_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg97_1
        buf252 = reinterpret_tensor(buf199, (15584, 128), (128, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf251, (15584, 512), (512, 1), 0), reinterpret_tensor(arg98_1, (512, 128), (1, 512), 0), out=buf252)
        del arg98_1
        buf253 = reinterpret_tensor(buf252, (487, 32, 128), (4096, 128, 1), 0); del buf252  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, off_stream_1], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf253, buf173, buf200, arg93_1, arg99_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg93_1
        del arg99_1
        # Topologically Sorted Source Nodes: [toks_7, index_add__18, index_add__19], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_49.run(arg60_1, arg59_1, buf253, arg61_1, buf234, buf255, 17858560, grid=grid(17858560), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x_mid_d_2, g_4], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_23.run(buf258, buf259, 128, 128, grid=grid(128), stream=stream0)
        buf261 = reinterpret_tensor(buf264, (1, 16384, 128), (8388608, 512, 1), 128)  # alias
        ...
        buf262 = reinterpret_tensor(buf264, (1, 16384, 128), (8388608, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf255, buf262, 2097152, grid=grid(2097152), stream=stream0)
        buf263 = reinterpret_tensor(buf264, (1, 16384, 128), (8388608, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        ...
        del buf262
        del buf263
        buf265 = reinterpret_tensor(buf209, (16384, 512), (512, 1), 0); del buf209  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf264, (16384, 512), (512, 1), 0), reinterpret_tensor(arg112_1, (512, 512), (1, 512), 0), out=buf265)
        del arg112_1
        del buf264
        buf266 = reinterpret_tensor(buf265, (1, 16384, 512), (8388608, 512, 1), 0); del buf265  # reuse
        ...
        del arg113_1
        buf267 = reinterpret_tensor(buf255, (16384, 128), (128, 1), 0); del buf255  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf266, (16384, 512), (512, 1), 0), reinterpret_tensor(arg114_1, (512, 128), (1, 512), 0), out=buf267)
        del arg114_1
        del buf266
        buf306 = buf234; del buf234  # reuse
        # Topologically Sorted Source Nodes: [row_highway_5], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf306, 2097152, grid=grid(2097152), stream=stream0)
        buf310 = buf240; del buf240  # reuse
        # Topologically Sorted Source Nodes: [col_highway_5], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf310, 2097152, grid=grid(2097152), stream=stream0)
        buf336 = buf236; del buf236  # reuse
        # Topologically Sorted Source Nodes: [col_highway_6], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf336, 2097152, grid=grid(2097152), stream=stream0)
        buf339 = reinterpret_tensor(buf213, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf213  # reuse
        ...
        buf268 = reinterpret_tensor(buf267, (1, 16384, 128), (2097152, 128, 1), 0); del buf267  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, h_diag_3, row_highway_5, index_add__20, col_highway_5, index_add__21, col_highway_6, index_add__25, row_highway_6, index_add__24], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_51.run(buf268, buf170, buf230, arg109_1, arg115_1, arg42_1, buf306, buf310, buf336, buf339, 2097152, grid=grid(2097152), stream=stream0)
        del arg109_1
        del arg115_1
        del arg42_1
        buf269 = reinterpret_tensor(buf251, (1, 487, 16384), (7979008, 16384, 1), 0); del buf251  # reuse
        # Topologically Sorted Source Nodes: [row_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf268, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf269)
        buf270 = reinterpret_tensor(buf249, (1, 487, 16384), (7979008, 16384, 1), 0); del buf249  # reuse
        # Topologically Sorted Source Nodes: [col_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf268, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf270)
        buf271 = buf253; del buf253  # reuse
        buf275 = reinterpret_tensor(buf200, (487, 32, 128), (4096, 128, 1), 0); del buf200  # reuse
        # Topologically Sorted Source Nodes: [h_off_7, off_in_1, layer_norm_11], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_50.run(buf271, buf269, buf270, arg116_1, arg117_1, buf275, 15584, 128, grid=grid(15584), stream=stream0)
        del arg116_1
        del arg117_1
        buf276 = buf178; del buf178  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf275, (15584, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 384), (1, 128), 0), out=buf276)
        del arg118_1
        ...
        buf281 = reinterpret_tensor(buf275, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf275  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf276, arg119_1, buf281, 1994752, grid=grid(1994752), stream=stream0)
        buf282 = reinterpret_tensor(buf173, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf276, arg119_1, buf282, 1994752, grid=grid(1994752), stream=stream0)
        buf283 = reinterpret_tensor(buf197, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf197  # reuse
        buf295 = reinterpret_tensor(buf179, (487, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf179  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf276, arg119_1, buf283, buf295, 1994752, grid=grid(1994752), stream=stream0)
        del arg119_1
        del buf276
        buf284 = reinterpret_tensor(buf196, (487, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf196  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf286 = buf285[0]
        del buf285
        buf290 = reinterpret_tensor(buf283, (487, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf283  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf279, buf277, buf290, 1994752, grid=grid(1994752), stream=stream0)
        del buf277
        buf291 = reinterpret_tensor(buf270, (498688, 16), (16, 1), 0); del buf270  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg122_1
        buf294 = reinterpret_tensor(buf195, (487, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf195  # reuse
        ...
        del arg123_1
        del buf293
        buf296 = reinterpret_tensor(buf290, (3896, 32, 16), (512, 16, 1), 0); del buf290  # reuse
        # Topologically Sorted Source Nodes: [einsum_17], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf294, (3896, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf295, (3896, 32, 16), (512, 16, 1), 0), out=buf296)
        del buf294
        del buf295
        buf297 = reinterpret_tensor(buf286, (487, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf286  # reuse
        # Topologically Sorted Source Nodes: [x_mid_5], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf297, buf296, 1994752, grid=grid(1994752), stream=stream0)
        buf298 = reinterpret_tensor(buf296, (15584, 128), (128, 1), 0); del buf296  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf297, (15584, 128), (128, 1), 0), reinterpret_tensor(arg124_1, (128, 128), (1, 128), 0), out=buf298)
        del arg124_1
        buf319 = reinterpret_tensor(buf292, (487, 32, 512), (16384, 512, 1), 0); del buf292  # reuse
        buf315 = reinterpret_tensor(buf319, (487, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf271, buf298, arg125_1, arg126_1, arg127_1, buf315, 15584, 128, grid=grid(15584), stream=stream0)
        del arg126_1
        del arg127_1
        buf302 = buf230; del buf230  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf268, (16384, 128), (128, 1), 0), reinterpret_tensor(arg132_1, (128, 128), (1, 128), 0), out=buf302)
        del arg132_1
        buf303 = reinterpret_tensor(buf302, (1, 128, 128, 128), (2097152, 16384, 128, 1), 0); del buf302  # reuse
        # Topologically Sorted Source Nodes: [input_47], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_2.run(buf303, arg133_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg133_1
        buf304 = reinterpret_tensor(buf170, (16384, 128), (128, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [input_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg135_1, reinterpret_tensor(buf303, (16384, 128), (128, 1), 0), reinterpret_tensor(arg134_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf304)
        del arg134_1
        del arg135_1
        buf305 = reinterpret_tensor(buf303, (128, 128, 128), (16384, 128, 1), 0); del buf303  # reuse
        ...
        triton_poi_fused_index_add_index_select_43.run(arg60_1, arg59_1, buf271, buf298, arg125_1, arg61_1, buf306, buf310, 17858560, grid=grid(17858560), stream=stream0)
        buf309 = buf269; del buf269  # reuse
        # Topologically Sorted Source Nodes: [row_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf306, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf309)
        del arg30_1
        del buf306
        buf313 = buf239; del buf239  # reuse
        # Topologically Sorted Source Nodes: [col_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf310, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf313)
        del arg31_1
        del buf310
        buf314 = buf244; del buf244  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, g_5], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf271, buf298, arg125_1, buf314, 62336, 32, grid=grid(62336), stream=stream0)
        buf316 = reinterpret_tensor(buf319, (487, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf309, buf316, 1994752, grid=grid(1994752), stream=stream0)
        del buf309
        buf317 = reinterpret_tensor(buf319, (487, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf313, buf317, 1994752, grid=grid(1994752), stream=stream0)
        buf318 = reinterpret_tensor(buf319, (487, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf314, buf318, 1994752, grid=grid(1994752), stream=stream0)
        del buf314
        del buf315
        del buf316
        del buf317
        del buf318
        buf320 = reinterpret_tensor(buf313, (15584, 512), (512, 1), 0); del buf313  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf319, (15584, 512), (512, 1), 0), reinterpret_tensor(arg128_1, (512, 512), (1, 512), 0), out=buf320)
        del arg128_1
        del buf319
        buf321 = reinterpret_tensor(buf320, (487, 32, 512), (16384, 512, 1), 0); del buf320  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf321, arg129_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg129_1
        buf322 = reinterpret_tensor(buf297, (15584, 128), (128, 1), 0); del buf297  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf321, (15584, 512), (512, 1), 0), reinterpret_tensor(arg130_1, (512, 128), (1, 512), 0), out=buf322)
        del arg130_1
        del buf321
        buf323 = reinterpret_tensor(buf322, (487, 32, 128), (4096, 128, 1), 0); del buf322  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf323, buf271, buf298, arg125_1, arg131_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg125_1
        del arg131_1
        del buf271
        buf324 = buf298; del buf298  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf323, (15584, 128), (128, 1), 0), reinterpret_tensor(arg136_1, (128, 128), (1, 128), 0), out=buf324)
        del arg136_1
        buf325 = reinterpret_tensor(buf324, (487, 1, 32, 128), (4096, 1, 128, 1), 0); del buf324  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_52.run(buf325, arg137_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg137_1
        ...
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf325, (15584, 128), (128, 1), 0), reinterpret_tensor(arg138_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf326)
        del arg138_1
        del arg139_1
        buf327 = reinterpret_tensor(buf325, (15584, 128), (128, 1), 0); del buf325  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf323, (15584, 128), (128, 1), 0), reinterpret_tensor(arg140_1, (128, 128), (1, 128), 0), out=buf327)
        del arg140_1
        ...
        triton_poi_fused_gelu_52.run(buf328, arg141_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg141_1
        buf329 = empty_strided_cuda((15584, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg143_1, reinterpret_tensor(buf328, (15584, 128), (128, 1), 0), reinterpret_tensor(arg142_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf329)
        del arg142_1
        del arg143_1
        del buf328
        ...
        extern_kernels.addmm(arg147_1, reinterpret_tensor(buf268, (16384, 128), (128, 1), 0), reinterpret_tensor(arg146_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf331)
        del arg146_1
        del arg147_1
        buf332 = empty_strided_cuda((16384, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg149_1, reinterpret_tensor(buf268, (16384, 128), (128, 1), 0), reinterpret_tensor(arg148_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf332)
        del arg148_1
        del arg149_1
        buf333 = reinterpret_tensor(buf258, (16384, 1), (1, 1), 0); del buf258  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf268, (16384, 128), (128, 1), 0), reinterpret_tensor(arg144_1, (128, 1), (1, 128), 0), out=buf333)
        del arg144_1
        del buf268
        ...
        triton_poi_fused_index_add_index_select_49.run(arg61_1, arg59_1, buf323, arg60_1, buf336, buf339, 17858560, grid=grid(17858560), stream=stream0)
        del arg59_1
        del arg60_1
        del arg61_1
        del buf323
    return (buf335, reinterpret_tensor(buf334, (1, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf336, (1, 16384, 128), (2097152, 128, 1), 0), reinterpret_tensor(buf339, (1, 16384, 128), (2097152, 128, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg6_1 = rand_strided((2, 115758), (115758, 1), device='cuda:0', dtype=torch.int64)
    arg7_1 = rand_strided((115758, ), (1, ), device='cuda:0', dtype=torch.float32)
