...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/pt/cpthgoai6tajip7oljlqree42zgfdh3sbcgapdtiv335yocfffmv.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/zd/czd7g3e27lyjrddwkcvp6mrh4pjvoxzixhacrgsjuis3axgcuhja.py
# Topologically Sorted Source Nodes: [aggr], Original ATen: [aten.zeros_like]
# Source node to ATen node mapping:
#   aggr => full_default
# Graph fragment:
#   %full_default : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([4096, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/p3/cp34zp6gtf53w2bsdst7so3yyu64z7oasmwe2g7fsamxq2mxfbl5.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/z3/cz3qrzb5ztb6yplwtv4n3ms2j4hsrpbewvi5t7l7eukxaj4stiyf.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kk/ckkzjysfuec6yxtvoe7pfiqvrakzns5uym4ej5dvpj5dsrhcemjm.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/su/csuqiwcqpngxbjdj5igyvzo5u6wnpczi3nz2zbqjbl7dkky6hr77.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tl.store(out_ptr3 + (r1 + (256*x2) + (33024*x3)), tmp24, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7q/c7qc5dvre72zr2gbycfhyyvbeuvrqfwh43lpn46ooyloqpbuhjbr.py
...
def triton_(in_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    tmp4 = 128.0
    tmp5 = tmp2 / tmp4
    tl.store(out_ptr1 + (x0 + (33024*x1)), tmp5, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kt/cktkuox2pgqjeht2jytkygbufz3ok37sionck76slhia4cd5bncw.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/mk/cmkjwcioe7q2j4oypfjql47tagscdhqkxpekownniaxain5y27ii.py
# Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum => clone_1
# Graph fragment:
...
def triton_(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y1 = (yindex // 256)
    y3 = yindex
    tmp0 = tl.load(in_ptr0 + (256 + y0 + (768*x2) + (99072*y1)), xmask, eviction_policy='evict_last')
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5n/c5nb6wbqj3r5n34ugvq3mrtwlf72lliy2azzza3oep5qsbur2ddi.py
...
#   %mul_15 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_23, 0.1767766952966369), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sy/csyxd5a6be35w3zkq3faoekizqjsad4ippzryqjbz2a5cpnv4xuq.py
# Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out => clone_5
# Graph fragment:
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 33024)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (512 + x0 + (32*x2) + (768*x1) + (99072*x3)), None)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/lh/clhjnokhkhvrbmpkvge6wjipbqtkkenst3g43pq2jcqwsyalt4fp.py
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 32768)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (32*x2) + (4096*x1) + (32768*x3)), None)
    tl.store(out_ptr0 + (x4), tmp0, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/q4/cq4ahkl2aswwtb3qdlrywlr5ng7ab7slxy5nwccpzgu364unrqow.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/o3/co3c4xh3m4xqwrnlsd7xgkl2sap6bswy63vm3us44mbxoysftfiv.py
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tl.store(out_ptr3 + (r1 + (256*x2) + (33024*x3)), tmp32, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/qm/cqm5aji7c52foaciuazsnqclgnnwyl6muozcsfpgvaj7ka4pg444.py
# Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
# Source node to ATen node mapping:
#   row_sum => full_default_14
# Graph fragment:
#   %full_default_14 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/yd/cydnvpspyrqgcbx5ci4xpi4whkq6qumjzmnxcm4s7xjvaou5phxe.py
...
# Graph fragment:
#   %full_default_14 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_2 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_45, [%arg62_1]), kwargs = {})
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_14, [%arg64_1], %index_2, True), kwargs = {})
#   %full_default_15 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_3 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_45, [%arg63_1]), kwargs = {})
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_15, [%arg64_1], %index_3, True), kwargs = {})
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp12 = tl.load(in_ptr2 + (x0 + (32768*tmp10)), None)
    tmp14 = tmp13 + tmp7
    tmp15 = tmp13 < 0
    tmp16 = tl.where(tmp15, tmp14, tmp13)
    tl.device_assert((0 <= tmp16) & (tmp16 < 32), "index out of bounds: 0 <= tmp16 < 32")
    tmp18 = tl.load(in_ptr2 + (x0 + (32768*tmp16)), None)
    tl.atomic_add(out_ptr0 + (x0 + (32768*tmp4)), tmp12, None, sem='relaxed')
    tl.atomic_add(out_ptr1 + (x0 + (32768*tmp4)), tmp18, None, sem='relaxed')
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vx/cvxbgjdpd4gihvq524xqymfuams447w43m7zsk6um7s377wkh6vc.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kl/ckltzlm367nd45hvsrcuppfhs36yhbw3gy5ucphmbuih4z4u2tej.py
...
def triton_(in_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = 64.0
    tmp6 = tmp4 / tmp5
    tl.store(out_ptr1 + (x0 + (16640*x1)), tmp6, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/cn/ccnc5gmws3ghjut7ek6gk5gee2pezb4ltchkix2ysqwazrbj4jrj.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 16384)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (32*x2) + (768*x1) + (49152*x3)), None)
    tmp1 = tl.load(in_ptr1 + (x0 + (32*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, None)
''', device_str='cuda')
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/oa/coaaaszgqe2n5sxozmcrofq6ybclxd3iuzrxka4uede76t3v5xjo.py
# Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum_4 => clone_15
# Graph fragment:
...
def triton_(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y1 = (yindex // 256)
    y3 = yindex
    tmp0 = tl.load(in_ptr0 + (256 + y0 + (768*x2) + (49920*y1)), xmask & ymask, eviction_policy='evict_last')
    tmp1 = tl.load(in_ptr1 + (256 + y0), ymask, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/zc/czcznykl66emrkq4w2n6qdkphstp4wihhtcv7alqg4d4f5wih5e6.py
...
#   %mul_31 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_87, 0.1767766952966369), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fg/cfgqpi6zmzywcikkgifp74z6mqhwwnjptvc2sn7uuwioi7jtnjl3.py
# Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_8 => clone_19
# Graph fragment:
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 16640)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (512 + x0 + (32*x2) + (768*x1) + (49920*x3)), xmask)
    tmp1 = tl.load(in_ptr1 + (512 + x0 + (32*x2)), xmask, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/23/c23423ugb2drsklkt6xlaxtbmdwyyeiorhzrmt7koscjrezpl47x.py
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 16384)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (32*x2) + (2048*x1) + (16384*x3)), None)
    tl.store(out_ptr0 + (x4), tmp0, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/43/c43qjlvxlrnta2ehkqih2jh4nd26nnhccsxgs4uwrfz2tk2neivm.py
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_40', 'mutated_arg_names': [], 'no_x_dim': True, 'num_load': 5, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel):
    xnumel = 6976
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/if/cify6vq5bd6b5frsvbkvkh4m7x7ojv2q67x2hqckthkcznxmfqu4.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xk/cxk6ssr5goompsncbfhhnlb74k2au4fczsgworumwahseqrzawf5.py
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tl.store(in_out_ptr0 + (r1 + (256*x0)), tmp8, None)
    tl.store(out_ptr2 + (r1 + (256*x0)), tmp32, None)
    tl.store(out_ptr3 + (r1 + (256*x2) + (16640*x3)), tmp32, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xw/cxw4q6cokzfe3il4p4go5jet3xt2qh72ssqrbincdqaivaptt2c4.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/va/cvalcjeqmkxhekiidwqqv433fugh6o6hrrrdq6m2w6y45xe4b22w.py
...
def call(args):
    ...
    assert_size_stride(arg42_1, (1024, 256), (256, 1))
    ...
    assert_size_stride(arg56_1, (1024, 256), (256, 1))
    ...
    assert_size_stride(arg68_1, (768, 256), (256, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg0_1
        del arg1_1
        buf1 = empty_strided_cuda((4096, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf0, (4096, 18), (18, 1), 0), reinterpret_tensor(arg2_1, (18, 256), (1, 18), 0), out=buf1)
        del arg2_1
        del buf0
        buf2 = reinterpret_tensor(buf1, (1, 4096, 256), (1048576, 256, 1), 0); del buf1  # reuse
        # Topologically Sorted Source Nodes: [input_2], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf2, arg3_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg3_1
        buf3 = empty_strided_cuda((4096, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_3], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg5_1, reinterpret_tensor(buf2, (4096, 256), (256, 1), 0), reinterpret_tensor(arg4_1, (256, 256), (1, 256), 0), alpha=1, beta=1, out=buf3)
        del arg4_1
        del arg5_1
        buf8 = empty_strided_cuda((4096, 512), (512, 1), torch.float32)
        buf4 = reinterpret_tensor(buf8, (4096, 256), (512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [self_features], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg11_1, buf3, reinterpret_tensor(arg10_1, (256, 256), (1, 256), 0), alpha=1, beta=1, out=buf4)
        del arg10_1
        del arg11_1
        buf5 = reinterpret_tensor(buf2, (4096, 256), (256, 1), 0); del buf2  # reuse
        # Topologically Sorted Source Nodes: [neighbor_features], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg9_1, buf3, reinterpret_tensor(arg8_1, (256, 256), (1, 256), 0), alpha=1, beta=1, out=buf5)
        del arg8_1
        del arg9_1
        buf6 = reinterpret_tensor(buf8, (4096, 256), (512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [aggr], Original ATen: [aten.zeros_like]
        triton_poi_fused_zeros_like_2.run(buf6, 1048576, grid=grid(1048576), stream=stream0)
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf5, arg7_1, buf6, 6985216, grid=grid(6985216), stream=stream0)
        del buf4
        del buf6
        buf9 = buf5; del buf5  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf8, reinterpret_tensor(arg12_1, (512, 256), (1, 512), 0), out=buf9)
        del arg12_1
        buf10 = buf9; del buf9  # reuse
        # Topologically Sorted Source Nodes: [input_5], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf10, arg13_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg13_1
        buf11 = empty_strided_cuda((4096, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_5], Original ATen: [aten.gelu]
        extern_kernels.mm(buf10, reinterpret_tensor(arg14_1, (256, 256), (1, 256), 0), out=buf11)
        del arg14_1
        buf12 = buf11; del buf11  # reuse
        # Topologically Sorted Source Nodes: [out], Original ATen: [aten.add]
        triton_poi_fused_add_4.run(buf12, buf3, arg15_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg15_1
        buf17 = buf8; del buf8  # reuse
        buf13 = reinterpret_tensor(buf17, (4096, 256), (512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [self_features_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg19_1, buf12, reinterpret_tensor(arg18_1, (256, 256), (1, 256), 0), alpha=1, beta=1, out=buf13)
        del arg18_1
        del arg19_1
        buf14 = buf3; del buf3  # reuse
        # Topologically Sorted Source Nodes: [neighbor_features_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg17_1, buf12, reinterpret_tensor(arg16_1, (256, 256), (1, 256), 0), alpha=1, beta=1, out=buf14)
        del arg16_1
        del arg17_1
        buf15 = reinterpret_tensor(buf17, (4096, 256), (512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [aggr_1], Original ATen: [aten.zeros_like]
        triton_poi_fused_zeros_like_2.run(buf15, 1048576, grid=grid(1048576), stream=stream0)
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf14, arg7_1, buf15, 6985216, grid=grid(6985216), stream=stream0)
        del arg6_1
        del arg7_1
        del buf13
        del buf15
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf17, reinterpret_tensor(arg20_1, (512, 256), (1, 512), 0), out=buf18)
        del arg20_1
        del buf17
        buf19 = buf18; del buf18  # reuse
        # Topologically Sorted Source Nodes: [input_8], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf19, arg21_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg21_1
        buf20 = buf10; del buf10  # reuse
        # Topologically Sorted Source Nodes: [input_8], Original ATen: [aten.gelu]
        extern_kernels.mm(buf19, reinterpret_tensor(arg22_1, (256, 256), (1, 256), 0), out=buf20)
        del arg22_1
        buf24 = reinterpret_tensor(buf19, (1, 4096, 256), (1048576, 256, 1), 0); del buf19  # reuse
        # Topologically Sorted Source Nodes: [h_2], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf12, buf20, arg23_1, arg24_1, arg25_1, buf24, 4096, 256, grid=grid(4096), stream=stream0)
        del arg23_1
        del arg24_1
        del arg25_1
        buf25 = buf20; del buf20  # reuse
        # Topologically Sorted Source Nodes: [h_3], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg27_1, reinterpret_tensor(buf24, (4096, 256), (256, 1), 0), reinterpret_tensor(arg26_1, (256, 256), (1, 256), 0), alpha=1, beta=1, out=buf25)
        del arg26_1
        del arg27_1
        buf29 = buf24; del buf24  # reuse
        buf34 = empty_strided_cuda((1, 32, 129, 256), (1056768, 33024, 256, 1), torch.float32)
        buf32 = reinterpret_tensor(buf34, (1, 32, 128, 256), (1056768, 33024, 256, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_1, kv], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_6.run(buf25, arg32_1, arg33_1, buf29, buf32, 4096, 256, grid=grid(4096), stream=stream0)
        del arg32_1
        del arg33_1
        buf30 = empty_strided_cuda((4096, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf29, (4096, 256), (256, 1), 0), reinterpret_tensor(arg34_1, (256, 768), (1, 256), 0), out=buf30)
        buf33 = reinterpret_tensor(buf34, (1, 32, 1, 256), (1056768, 33024, 256, 1), 32768)  # alias
        # Topologically Sorted Source Nodes: [block_node], Original ATen: [aten.mean]
        triton_red_fused_mean_7.run(buf29, buf33, 8192, 128, grid=grid(8192), stream=stream0)
        del buf32
        del buf33
        buf35 = empty_strided_cuda((4128, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf34, (4128, 256), (256, 1), 0), reinterpret_tensor(arg34_1, (256, 768), (1, 256), 0), out=buf35)
        del arg34_1
        buf36 = reinterpret_tensor(buf29, (32, 8, 128, 32, 1, 1), (32768, 4096, 32, 1, 1, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf30, arg35_1, buf36, 1048576, grid=grid(1048576), stream=stream0)
        buf37 = reinterpret_tensor(buf34, (32, 8, 32, 1, 129, 1), (33024, 4128, 129, 129, 1, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf35, arg35_1, buf37, 8192, 129, grid=grid(8192, 129), stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf36, (256, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf37, (256, 32, 129), (4128, 129, 1), 0), out=buf38)
        ...
        del arg37_1
        buf49 = reinterpret_tensor(buf37, (32, 8, 129, 1, 32, 1), (33024, 4128, 32, 32, 1, 1), 0); del buf37  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf35, arg35_1, buf49, 1056768, grid=grid(1056768), stream=stream0)
        del arg35_1
        buf50 = reinterpret_tensor(buf36, (256, 128, 32), (4096, 32, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf48, (256, 128, 129), (16512, 129, 1), 0), reinterpret_tensor(buf49, (256, 129, 32), (4128, 32, 1), 0), out=buf50)
        buf51 = reinterpret_tensor(buf12, (1, 32, 128, 8, 32), (1048576, 32768, 256, 32, 1), 0); del buf12  # reuse
        # Topologically Sorted Source Nodes: [x_out_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf50, buf51, 1048576, grid=grid(1048576), stream=stream0)
        buf52 = reinterpret_tensor(buf50, (4096, 256), (256, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf51, (4096, 256), (256, 1), 0), reinterpret_tensor(arg38_1, (256, 256), (1, 256), 0), out=buf52)
        del arg38_1
        buf56 = reinterpret_tensor(buf51, (1, 4096, 256), (1048576, 256, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf52, arg39_1, arg40_1, arg41_1, buf56, 4096, 256, grid=grid(4096), stream=stream0)
        del arg40_1
        del arg41_1
        buf57 = empty_strided_cuda((4096, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf56, (4096, 256), (256, 1), 0), reinterpret_tensor(arg42_1, (256, 1024), (1, 256), 0), out=buf57)
        del arg42_1
        buf58 = reinterpret_tensor(buf57, (1, 4096, 1024), (4194304, 1024, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf58, arg43_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg43_1
        buf59 = reinterpret_tensor(buf56, (4096, 256), (256, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf58, (4096, 1024), (1024, 1), 0), reinterpret_tensor(arg44_1, (1024, 256), (1, 1024), 0), out=buf59)
        del arg44_1
        buf60 = reinterpret_tensor(buf59, (1, 4096, 256), (1048576, 256, 1), 0); del buf59  # reuse
        buf64 = empty_strided_cuda((1, 4096, 256), (1048576, 256, 1), torch.float32)
        buf69 = reinterpret_tensor(buf49, (1, 32, 129, 256), (1056768, 33024, 256, 1), 0); del buf49  # reuse
        buf67 = reinterpret_tensor(buf69, (1, 32, 128, 256), (1056768, 33024, 256, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_3, kv_1], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_21.run(buf60, buf25, buf52, arg39_1, arg45_1, arg46_1, arg47_1, buf64, buf67, 4096, 256, grid=grid(4096), stream=stream0)
        del arg39_1
        del arg45_1
        del arg46_1
        del arg47_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf64, (4096, 256), (256, 1), 0), reinterpret_tensor(arg48_1, (256, 768), (1, 256), 0), out=buf65)
        buf68 = reinterpret_tensor(buf69, (1, 32, 1, 256), (1056768, 33024, 256, 1), 32768)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_red_fused_mean_7.run(buf64, buf68, 8192, 128, grid=grid(8192), stream=stream0)
        del buf67
        del buf68
        buf70 = buf35; del buf35  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf69, (4128, 256), (256, 1), 0), reinterpret_tensor(arg48_1, (256, 768), (1, 256), 0), out=buf70)
        del arg48_1
        buf71 = reinterpret_tensor(buf64, (32, 8, 128, 32, 1, 1), (32768, 4096, 32, 1, 1, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf65, arg49_1, buf71, 1048576, grid=grid(1048576), stream=stream0)
        del buf65
        buf72 = reinterpret_tensor(buf69, (32, 8, 32, 1, 129, 1), (33024, 4128, 129, 129, 1, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf70, arg49_1, buf72, 8192, 129, grid=grid(8192, 129), stream=stream0)
        buf73 = reinterpret_tensor(buf48, (256, 128, 129), (16512, 129, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf71, (256, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf72, (256, 32, 129), (4128, 129, 1), 0), out=buf73)
        ...
        buf79 = reinterpret_tensor(buf47, (1, 32, 128, 129, 8), (4227072, 132096, 129, 1, 16512), 0); del buf47  # reuse
        ...
        del buf74
        del buf76
        buf82 = reinterpret_tensor(buf73, (528384, 8), (8, 1), 0); del buf73  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del buf80
        del buf82
        buf84 = reinterpret_tensor(buf72, (32, 8, 129, 1, 32, 1), (33024, 4128, 32, 32, 1, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf70, arg49_1, buf84, 1056768, grid=grid(1056768), stream=stream0)
        del arg49_1
        del buf70
        buf85 = reinterpret_tensor(buf71, (256, 128, 32), (4096, 32, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf83, (256, 128, 129), (16512, 129, 1), 0), reinterpret_tensor(buf84, (256, 129, 32), (4128, 32, 1), 0), out=buf85)
        del buf83
        del buf84
        buf86 = reinterpret_tensor(buf52, (1, 32, 128, 8, 32), (1048576, 32768, 256, 32, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf85, buf86, 1048576, grid=grid(1048576), stream=stream0)
        buf87 = reinterpret_tensor(buf85, (4096, 256), (256, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf86, (4096, 256), (256, 1), 0), reinterpret_tensor(arg52_1, (256, 256), (1, 256), 0), out=buf87)
        del arg52_1
        buf163 = reinterpret_tensor(buf86, (1, 4096, 256), (1048576, 256, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf60, buf87, arg53_1, arg54_1, arg55_1, buf163, 4096, 256, grid=grid(4096), stream=stream0)
        del arg54_1
        del arg55_1
        buf91 = empty_strided_cuda((109, 1, 128, 256), (32768, 32768, 256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_22.run(buf91, 3571712, grid=grid(3571712), stream=stream0)
        buf93 = empty_strided_cuda((109, 1, 128, 256), (32768, 32768, 256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_22.run(buf93, 3571712, grid=grid(3571712), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum, getitem_22, index_add__2, col_sum, getitem_23, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_23.run(arg64_1, arg62_1, buf25, arg63_1, buf91, buf93, 5832704, grid=grid(5832704), stream=stream0)
        del arg62_1
        del arg63_1
        del arg64_1
        del buf25
        buf95 = empty_strided_cuda((109, 64, 256), (16384, 256, 1), torch.float32)
        buf101 = empty_strided_cuda((109, 64, 256), (16384, 256, 1), torch.float32)
        buf106 = empty_strided_cuda((109, 1, 65, 256), (16640, 1, 256, 1), torch.float32)
        buf104 = reinterpret_tensor(buf106, (109, 1, 64, 256), (16640, 1, 256, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [h_off_1, layer_norm_5, kv_2], Original ATen: [aten.mean, aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_mean_native_layer_norm_24.run(buf91, arg65_1, buf93, arg66_1, arg67_1, buf95, buf101, buf104, 6976, 256, grid=grid(6976), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        del buf91
        del buf93
        buf99 = empty_strided_cuda((109, 64, 65, 4), (16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_25.run(arg30_1, buf99, 1813760, grid=grid(1813760), stream=stream0)
        del arg30_1
        buf100 = empty_strided_cuda((109, 64, 65), (4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.cat]
        triton_poi_fused_cat_26.run(arg31_1, buf100, 453440, grid=grid(453440), stream=stream0)
        del arg31_1
        buf102 = empty_strided_cuda((6976, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (6976, 256), (256, 1), 0), reinterpret_tensor(arg68_1, (256, 768), (1, 256), 0), out=buf102)
        buf105 = reinterpret_tensor(buf106, (109, 1, 1, 256), (16640, 1, 256, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_27.run(buf101, buf105, 27904, 64, grid=grid(27904), stream=stream0)
        del buf104
        del buf105
        buf107 = empty_strided_cuda((7085, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf106, (7085, 256), (256, 1), 0), reinterpret_tensor(arg68_1, (256, 768), (1, 256), 0), out=buf107)
        del arg68_1
        buf108 = reinterpret_tensor(buf101, (109, 8, 64, 32, 1, 1), (16384, 2048, 32, 1, 1, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf102, arg69_1, buf108, 1785856, grid=grid(1785856), stream=stream0)
        buf109 = reinterpret_tensor(buf106, (109, 8, 32, 1, 65, 1), (16640, 2080, 65, 65, 1, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf107, arg69_1, buf109, 27904, 65, grid=grid(27904, 65), stream=stream0)
        buf110 = empty_strided_cuda((872, 64, 65), (4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf108, (872, 64, 32), (2048, 32, 1), 0), reinterpret_tensor(buf109, (872, 32, 65), (2080, 65, 1), 0), out=buf110)
        buf111 = reinterpret_tensor(buf109, (109, 1, 64, 65, 4), (16640, 1813760, 260, 4, 1), 0); del buf109  # reuse
        buf146 = empty_strided_cuda((109, 1, 64, 65, 4), (16640, 1813760, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_30.run(buf99, buf111, buf146, 1813760, grid=grid(1813760), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_31.run(buf111, 27904, grid=grid(27904), stream=stream0)
        buf113 = empty_strided_cuda((109, 1, 64, 65), (4160, 4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf111, buf113, 453440, grid=grid(453440), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf113, 6976, grid=grid(6976), stream=stream0)
        buf116 = empty_strided_cuda((109, 1, 64, 65, 8), (33280, 3627520, 65, 1, 4160), torch.float32)
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_red_fused__softmax_add_eq_masked_fill_mul_34.run(buf100, buf110, buf113, buf111, buf116, 55808, 65, grid=grid(55808), stream=stream0)
        buf117 = empty_strided_cuda((109, 1, 64, 1, 8), (512, 55808, 8, 55808, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_red_fused__softmax_35.run(buf116, buf117, 55808, 65, grid=grid(55808), stream=stream0)
        buf118 = reinterpret_tensor(buf99, (109, 1, 64, 65, 4), (16640, 1, 260, 4, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf113, buf111, buf118, 1813760, grid=grid(1813760), stream=stream0)
        del buf111
        buf119 = reinterpret_tensor(buf110, (453440, 8), (8, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf118, (453440, 4), (4, 1), 0), reinterpret_tensor(arg70_1, (4, 8), (1, 4), 0), out=buf119)
        del arg70_1
        buf120 = reinterpret_tensor(buf116, (109, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_37.run(buf120, buf117, buf100, buf119, arg71_1, 872, 4160, grid=grid(872, 4160), stream=stream0)
        del arg71_1
        buf121 = reinterpret_tensor(buf118, (109, 8, 65, 1, 32, 1), (16640, 2080, 32, 32, 1, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf107, arg69_1, buf121, 1813760, grid=grid(1813760), stream=stream0)
        del arg69_1
        buf122 = reinterpret_tensor(buf108, (872, 64, 32), (2048, 32, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf120, (872, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf121, (872, 65, 32), (2080, 32, 1), 0), out=buf122)
        buf123 = empty_strided_cuda((109, 1, 64, 8, 32), (16384, 1, 256, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf122, buf123, 1785856, grid=grid(1785856), stream=stream0)
        buf124 = reinterpret_tensor(buf122, (6976, 256), (256, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf123, (6976, 256), (256, 1), 0), reinterpret_tensor(arg72_1, (256, 256), (1, 256), 0), out=buf124)
        del arg72_1
        buf128 = reinterpret_tensor(buf123, (109, 64, 256), (16384, 256, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf95, buf124, arg73_1, arg74_1, arg75_1, buf128, 6976, 256, grid=grid(6976), stream=stream0)
        del arg74_1
        del arg75_1
        buf129 = empty_strided_cuda((6976, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (6976, 256), (256, 1), 0), reinterpret_tensor(arg76_1, (256, 1024), (1, 256), 0), out=buf129)
        del arg76_1
        buf130 = reinterpret_tensor(buf129, (109, 64, 1024), (65536, 1024, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf130, arg77_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg77_1
        buf131 = reinterpret_tensor(buf128, (6976, 256), (256, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf130, (6976, 1024), (1024, 1), 0), reinterpret_tensor(arg78_1, (1024, 256), (1, 1024), 0), out=buf131)
        del arg78_1
        buf132 = reinterpret_tensor(buf131, (109, 64, 256), (16384, 256, 1), 0); del buf131  # reuse
        buf136 = empty_strided_cuda((109, 64, 256), (16384, 256, 1), torch.float32)
        buf141 = reinterpret_tensor(buf121, (109, 1, 65, 256), (16640, 1, 256, 1), 0); del buf121  # reuse
        buf139 = reinterpret_tensor(buf141, (109, 1, 64, 256), (16640, 1, 256, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_4, x_5, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_42.run(buf132, buf95, buf124, arg73_1, arg79_1, arg80_1, arg81_1, buf136, buf139, 6976, 256, grid=grid(6976), stream=stream0)
        del arg73_1
        del arg79_1
        del arg80_1
        del arg81_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (6976, 256), (256, 1), 0), reinterpret_tensor(arg82_1, (256, 768), (1, 256), 0), out=buf137)
        buf140 = reinterpret_tensor(buf141, (109, 1, 1, 256), (16640, 1, 256, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_27.run(buf136, buf140, 27904, 64, grid=grid(27904), stream=stream0)
        del buf139
        del buf140
        buf142 = buf107; del buf107  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (7085, 256), (256, 1), 0), reinterpret_tensor(arg82_1, (256, 768), (1, 256), 0), out=buf142)
        del arg82_1
        buf143 = reinterpret_tensor(buf136, (109, 8, 64, 32, 1, 1), (16384, 2048, 32, 1, 1, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf137, arg83_1, buf143, 1785856, grid=grid(1785856), stream=stream0)
        del buf137
        buf144 = reinterpret_tensor(buf141, (109, 8, 32, 1, 65, 1), (16640, 2080, 65, 65, 1, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf142, arg83_1, buf144, 27904, 65, grid=grid(27904, 65), stream=stream0)
        buf145 = reinterpret_tensor(buf120, (872, 64, 65), (4160, 65, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf143, (872, 64, 32), (2048, 32, 1), 0), reinterpret_tensor(buf144, (872, 32, 65), (2080, 65, 1), 0), out=buf145)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_31.run(buf146, 27904, grid=grid(27904), stream=stream0)
        buf148 = buf113; del buf113  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf146, buf148, 453440, grid=grid(453440), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf148, 6976, grid=grid(6976), stream=stream0)
        buf151 = reinterpret_tensor(buf119, (109, 1, 64, 65, 8), (33280, 3627520, 65, 1, 4160), 0); del buf119  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_34.run(buf100, buf145, buf148, buf146, buf151, 55808, 65, grid=grid(55808), stream=stream0)
        buf152 = buf117; del buf117  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_red_fused__softmax_35.run(buf151, buf152, 55808, 65, grid=grid(55808), stream=stream0)
        buf153 = reinterpret_tensor(buf144, (109, 1, 64, 65, 4), (16640, 1, 260, 4, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf148, buf146, buf153, 1813760, grid=grid(1813760), stream=stream0)
        del buf146
        del buf148
        buf154 = reinterpret_tensor(buf145, (453440, 8), (8, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (453440, 4), (4, 1), 0), reinterpret_tensor(arg84_1, (4, 8), (1, 4), 0), out=buf154)
        del arg84_1
        buf155 = reinterpret_tensor(buf151, (109, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_37.run(buf155, buf152, buf100, buf154, arg85_1, 872, 4160, grid=grid(872, 4160), stream=stream0)
        del arg85_1
        del buf100
        del buf152
        del buf154
        buf156 = reinterpret_tensor(buf153, (109, 8, 65, 1, 32, 1), (16640, 2080, 32, 32, 1, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf142, arg83_1, buf156, 1813760, grid=grid(1813760), stream=stream0)
        del arg83_1
        del buf142
        buf157 = reinterpret_tensor(buf143, (872, 64, 32), (2048, 32, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf155, (872, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf156, (872, 65, 32), (2080, 32, 1), 0), out=buf157)
        del buf155
        del buf156
        buf158 = reinterpret_tensor(buf95, (109, 1, 64, 8, 32), (16384, 1, 256, 32, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf157, buf158, 1785856, grid=grid(1785856), stream=stream0)
        buf159 = reinterpret_tensor(buf157, (6976, 256), (256, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (6976, 256), (256, 1), 0), reinterpret_tensor(arg86_1, (256, 256), (1, 256), 0), out=buf159)
        del arg86_1
        buf170 = reinterpret_tensor(buf158, (109, 64, 256), (16384, 256, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf132, buf159, arg87_1, arg88_1, arg89_1, buf170, 6976, 256, grid=grid(6976), stream=stream0)
        del arg88_1
        del arg89_1
        buf164 = reinterpret_tensor(buf58, (4096, 1024), (1024, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (4096, 256), (256, 1), 0), reinterpret_tensor(arg56_1, (256, 1024), (1, 256), 0), out=buf164)
        del arg56_1
        buf165 = reinterpret_tensor(buf164, (1, 4096, 1024), (4194304, 1024, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf165, arg57_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg57_1
        buf166 = reinterpret_tensor(buf163, (4096, 256), (256, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (4096, 1024), (1024, 1), 0), reinterpret_tensor(arg58_1, (1024, 256), (1, 1024), 0), out=buf166)
        del arg58_1
        del buf165
        buf167 = reinterpret_tensor(buf166, (1, 4096, 256), (1048576, 256, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf167, buf60, buf87, arg53_1, arg59_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg53_1
        del arg59_1
        del buf60
        del buf87
        buf168 = empty_strided_cuda((4096, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg61_1, reinterpret_tensor(buf167, (4096, 256), (256, 1), 0), reinterpret_tensor(arg60_1, (256, 128), (1, 256), 0), alpha=1, beta=1, out=buf168)
        del arg60_1
        del arg61_1
        buf169 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf168, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf168, (32, 128, 128), (16384, 1, 128), 0), out=buf169)
        del buf168
        buf171 = reinterpret_tensor(buf130, (6976, 1024), (1024, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (6976, 256), (256, 1), 0), reinterpret_tensor(arg90_1, (256, 1024), (1, 256), 0), out=buf171)
        del arg90_1
        buf172 = reinterpret_tensor(buf171, (109, 64, 1024), (65536, 1024, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf172, arg91_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg91_1
        buf173 = reinterpret_tensor(buf170, (6976, 256), (256, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (6976, 1024), (1024, 1), 0), reinterpret_tensor(arg92_1, (1024, 256), (1, 1024), 0), out=buf173)
        del arg92_1
        del buf172
        buf174 = reinterpret_tensor(buf173, (109, 64, 256), (16384, 256, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_44.run(buf174, buf132, buf159, arg87_1, arg93_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg87_1
        del arg93_1
        del buf132
        del buf159
        buf175 = empty_strided_cuda((6976, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf174, (6976, 256), (256, 1), 0), reinterpret_tensor(arg94_1, (256, 64), (1, 256), 0), alpha=1, beta=1, out=buf175)
        del arg94_1
        del arg95_1
        buf176 = empty_strided_cuda((6976, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg97_1, reinterpret_tensor(buf174, (6976, 256), (256, 1), 0), reinterpret_tensor(arg96_1, (256, 64), (1, 256), 0), alpha=1, beta=1, out=buf176)
        del arg96_1
        del arg97_1
        del buf174
        buf177 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf175, (109, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf176, (109, 64, 64), (4096, 1, 64), 0), out=buf177)
        del buf175
        del buf176
        buf178 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf167, (4096, 256), (256, 1), 0), reinterpret_tensor(arg100_1, (256, 64), (1, 256), 0), alpha=1, beta=1, out=buf178)
        del arg100_1
        del arg101_1
        buf179 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf167, (4096, 256), (256, 1), 0), reinterpret_tensor(arg102_1, (256, 64), (1, 256), 0), alpha=1, beta=1, out=buf179)
        del arg102_1
        del arg103_1
        buf180 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf167, (4096, 256), (256, 1), 0), reinterpret_tensor(arg98_1, (256, 1), (1, 256), 0), out=buf180)
        del arg98_1
        del buf167
        buf181 = reinterpret_tensor(buf180, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_45.run(buf181, arg99_1, 4096, grid=grid(4096), stream=stream0)
        del arg99_1
        buf182 = empty_strided_cuda((1, 1499136), (1499136, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf169, buf177, buf178, buf179, buf181, buf182, 1499136, grid=grid(1499136), stream=stream0)
        del buf169
        del buf177
        del buf178
        del buf179
    return (buf182, reinterpret_tensor(buf181, (1, 32, 128), (4096, 128, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg42_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg43_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg44_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg56_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg57_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg58_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg62_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg63_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg64_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
    ...
    arg68_1 = rand_strided((768, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg90_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg91_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg92_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg96_1 = rand_strided((64, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg97_1 = rand_strided((64, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg98_1 = rand_strided((1, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg102_1 = rand_strided((64, 256), (256, 1), device='cuda:0', dtype=torch.float32)
