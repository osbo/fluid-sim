...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf102 = empty_strided_cuda((1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem, setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_7.run(arg28_1, buf31, buf102, 2097152, grid=grid(2097152), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        triton_per_fused_native_layer_norm_5.run(buf25, buf52, arg43_1, arg44_1, arg45_1, buf56, 4096, 64, grid=grid(4096), stream=stream0)
        del arg44_1
        del arg45_1
        buf57 = empty_strided_cuda((4096, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf56, (4096, 64), (64, 1), 0), reinterpret_tensor(arg46_1, (64, 256), (1, 64), 0), out=buf57)
        del arg46_1
        buf58 = reinterpret_tensor(buf57, (1, 4096, 256), (1048576, 256, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf58, arg47_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg47_1
        buf59 = reinterpret_tensor(buf56, (4096, 64), (64, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf58, (4096, 256), (256, 1), 0), reinterpret_tensor(arg48_1, (256, 64), (1, 256), 0), out=buf59)
        del arg48_1
        buf60 = reinterpret_tensor(buf59, (1, 4096, 64), (262144, 64, 1), 0); del buf59  # reuse
        buf100 = reinterpret_tensor(buf49, (1, 4096, 64), (262144, 64, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_20.run(buf60, buf25, buf52, arg43_1, arg49_1, arg66_1, arg67_1, buf100, 4096, 64, grid=grid(4096), stream=stream0)
        del arg43_1
        del arg49_1
        del arg66_1
        del arg67_1
        buf61 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf61, 892928, grid=grid(892928), stream=stream0)
        buf101 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (4096, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 192), (1, 64), 0), out=buf101)
        del arg68_1
        buf106 = reinterpret_tensor(buf100, (32, 4, 128, 16), (8192, 2048, 16, 1), 0); del buf100  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_11.run(buf101, arg69_1, buf106, 262144, grid=grid(262144), stream=stream0)
        buf107 = reinterpret_tensor(buf52, (32, 4, 128, 16), (8192, 2048, 16, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf101, arg69_1, buf107, 262144, grid=grid(262144), stream=stream0)
        buf108 = reinterpret_tensor(buf25, (32, 4, 128, 16), (8192, 2048, 16, 1), 0); del buf25  # reuse
        buf120 = reinterpret_tensor(buf36, (32, 4, 128, 1, 16, 1), (8192, 2048, 16, 16, 1, 1), 0); del buf36  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf101, arg69_1, buf108, buf120, 262144, grid=grid(262144), stream=stream0)
        del arg69_1
        del buf101
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_8.run(buf102, 16384, grid=grid(16384), stream=stream0)
        buf104 = buf33; del buf33  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_9.run(buf102, buf104, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_10.run(buf104, 4096, grid=grid(4096), stream=stream0)
        buf109 = reinterpret_tensor(buf48, (32, 4, 128, 128), (65536, 16384, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf104, buf102, buf109, 2097152, grid=grid(2097152), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf110 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf106, buf107, buf108, buf109, False)
        del buf106
        del buf107
        buf111 = buf110[0]
        del buf110
        buf115 = reinterpret_tensor(buf109, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf104, buf102, buf115, 2097152, grid=grid(2097152), stream=stream0)
        buf116 = reinterpret_tensor(buf46, (524288, 16), (16, 1), 0); del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (524288, 4), (4, 1), 0), reinterpret_tensor(arg70_1, (4, 16), (1, 4), 0), out=buf116)
        del arg70_1
        buf117 = reinterpret_tensor(buf116, (1, 32, 128, 128, 16), (8388608, 262144, 2048, 16, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_16.run(buf117, arg71_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg71_1
        buf118 = reinterpret_tensor(buf115, (524288, 4), (4, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf117, (524288, 16), (16, 1), 0), reinterpret_tensor(arg72_1, (16, 4), (1, 16), 0), out=buf118)
        del arg72_1
        del buf117
        buf119 = reinterpret_tensor(buf102, (32, 4, 128, 128, 1, 1), (65536, 16384, 128, 1, 1, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf118, arg73_1, buf119, 128, 16384, grid=grid(128, 16384), stream=stream0)
        del arg73_1
        del buf118
        buf121 = reinterpret_tensor(buf108, (128, 128, 16), (2048, 16, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf119, (128, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf120, (128, 128, 16), (2048, 16, 1), 0), out=buf121)
        del buf119
        del buf120
        buf122 = reinterpret_tensor(buf111, (1, 32, 128, 4, 16), (262144, 8192, 64, 16, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.add]
        triton_poi_fused_add_18.run(buf122, buf121, 262144, grid=grid(262144), stream=stream0)
        buf123 = reinterpret_tensor(buf121, (4096, 64), (64, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (4096, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 64), (1, 64), 0), out=buf123)
        del arg74_1
        buf127 = reinterpret_tensor(buf122, (1, 4096, 64), (262144, 64, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf60, buf123, arg75_1, arg76_1, arg77_1, buf127, 4096, 64, grid=grid(4096), stream=stream0)
        del arg76_1
        del arg77_1
        buf128 = reinterpret_tensor(buf58, (4096, 256), (256, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf127, (4096, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 256), (1, 64), 0), out=buf128)
        del arg78_1
        buf129 = reinterpret_tensor(buf128, (1, 4096, 256), (1048576, 256, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf129, arg79_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg79_1
        buf130 = reinterpret_tensor(buf127, (4096, 64), (64, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf129, (4096, 256), (256, 1), 0), reinterpret_tensor(arg80_1, (256, 64), (1, 256), 0), out=buf130)
        del arg80_1
        del buf129
        buf131 = reinterpret_tensor(buf130, (1, 4096, 64), (262144, 64, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_22.run(buf131, buf60, buf123, arg75_1, arg81_1, 262144, grid=grid(262144), stream=stream0)
        del arg75_1
        del arg81_1
        del buf123
        buf132 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf132, 892928, grid=grid(892928), stream=stream0)
        buf134 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf134, 892928, grid=grid(892928), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_16, index_add__4, col_sum_1, getitem_17, index_add__5, row_sum_2, getitem_28, index_add__6, col_sum_2, getitem_29, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_23.run(arg32_1, arg30_1, buf60, arg31_1, buf131, buf61, buf63, buf132, buf134, 1458176, grid=grid(1458176), stream=stream0)
        del arg30_1
        del arg31_1
        del arg32_1
        del buf60
        buf65 = empty_strided_cuda((109, 32, 64), (2048, 64, 1), torch.float32)
        buf69 = empty_strided_cuda((109, 32, 64), (2048, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_24.run(buf61, arg33_1, buf63, arg50_1, arg51_1, buf65, buf69, 3488, 64, grid=grid(3488), stream=stream0)
        del arg50_1
        del arg51_1
        del buf61
        buf70 = empty_strided_cuda((3488, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf69, (3488, 64), (64, 1), 0), reinterpret_tensor(arg52_1, (64, 192), (1, 64), 0), out=buf70)
        del arg52_1
        buf72 = empty_strided_cuda((109, 1, 32, 32, 4), (4096, 446464, 128, 4, 1), torch.float32)
        buf147 = empty_strided_cuda((109, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [sub, setitem_2], Original ATen: [aten.mean, aten.lift_fresh, aten.index_put]
        triton_per_fused_index_put_lift_fresh_mean_25.run(arg29_1, buf72, buf147, 446464, 16, grid=grid(446464), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf72, 13952, grid=grid(13952), stream=stream0)
        buf74 = empty_strided_cuda((109, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf72, buf74, 111616, grid=grid(111616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf74, 3488, grid=grid(3488), stream=stream0)
        buf76 = reinterpret_tensor(buf69, (109, 4, 32, 16), (2048, 512, 16, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf70, arg53_1, buf76, 223232, grid=grid(223232), stream=stream0)
        buf77 = empty_strided_cuda((109, 4, 32, 16), (2048, 512, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf70, arg53_1, buf77, 223232, grid=grid(223232), stream=stream0)
        buf78 = empty_strided_cuda((109, 4, 32, 16), (2048, 512, 16, 1), torch.float32)
        buf90 = empty_strided_cuda((109, 4, 32, 1, 16, 1), (2048, 512, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_1], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf70, arg53_1, buf78, buf90, 223232, grid=grid(223232), stream=stream0)
        del arg53_1
        buf79 = empty_strided_cuda((109, 4, 32, 32), (4096, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf74, buf72, buf79, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf80 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf76, buf77, buf78, buf79, False)
        del buf76
        buf81 = buf80[0]
        del buf80
        buf85 = reinterpret_tensor(buf79, (109, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf74, buf72, buf85, 446464, grid=grid(446464), stream=stream0)
        buf86 = empty_strided_cuda((111616, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf85, (111616, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 16), (1, 4), 0), out=buf86)
        del arg54_1
        buf87 = reinterpret_tensor(buf86, (109, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_34.run(buf87, arg55_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg55_1
        buf88 = reinterpret_tensor(buf85, (111616, 4), (4, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf87, (111616, 16), (16, 1), 0), reinterpret_tensor(arg56_1, (16, 4), (1, 16), 0), out=buf88)
        del arg56_1
        buf89 = reinterpret_tensor(buf72, (109, 4, 32, 32, 1, 1), (4096, 1024, 32, 1, 1, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf88, arg57_1, buf89, 436, 1024, grid=grid(436, 1024), stream=stream0)
        del arg57_1
        del buf88
        buf91 = reinterpret_tensor(buf78, (436, 32, 16), (512, 16, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf89, (436, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf90, (436, 32, 16), (512, 16, 1), 0), out=buf91)
        buf92 = reinterpret_tensor(buf81, (109, 1, 32, 4, 16), (2048, 1, 64, 16, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf92, buf91, 223232, grid=grid(223232), stream=stream0)
        buf93 = reinterpret_tensor(buf91, (3488, 64), (64, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf92, (3488, 64), (64, 1), 0), reinterpret_tensor(arg58_1, (64, 64), (1, 64), 0), out=buf93)
        del arg58_1
        buf137 = reinterpret_tensor(buf92, (109, 32, 64), (2048, 64, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf65, buf93, arg59_1, arg60_1, arg61_1, buf137, 3488, 64, grid=grid(3488), stream=stream0)
        del arg60_1
        del arg61_1
        buf138 = reinterpret_tensor(buf63, (3488, 256), (256, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf137, (3488, 64), (64, 1), 0), reinterpret_tensor(arg62_1, (64, 256), (1, 64), 0), out=buf138)
        del arg62_1
        buf139 = reinterpret_tensor(buf138, (109, 32, 256), (8192, 256, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf139, arg63_1, 892928, grid=grid(892928), stream=stream0)
        del arg63_1
        buf140 = reinterpret_tensor(buf137, (3488, 64), (64, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (3488, 256), (256, 1), 0), reinterpret_tensor(arg64_1, (256, 64), (1, 256), 0), out=buf140)
        del arg64_1
        del buf139
        buf136 = reinterpret_tensor(buf90, (109, 32, 64), (2048, 64, 1), 0); del buf90  # reuse
        buf141 = buf136; del buf136  # reuse
        buf145 = reinterpret_tensor(buf77, (109, 32, 64), (2048, 64, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [x_2, h_off_5, x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_39.run(buf141, buf132, arg33_1, buf134, buf65, buf93, arg59_1, buf140, arg65_1, arg82_1, arg83_1, buf145, 3488, 64, grid=grid(3488), stream=stream0)
        del arg33_1
        del arg59_1
        del arg65_1
        del arg82_1
        del arg83_1
        del buf132
        buf146 = buf70; del buf70  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf145, (3488, 64), (64, 1), 0), reinterpret_tensor(arg84_1, (64, 192), (1, 64), 0), out=buf146)
        del arg84_1
        # Topologically Sorted Source Nodes: [setitem_6], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf147, 13952, grid=grid(13952), stream=stream0)
        buf149 = buf74; del buf74  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf147, buf149, 111616, grid=grid(111616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf149, 3488, grid=grid(3488), stream=stream0)
        buf151 = reinterpret_tensor(buf145, (109, 4, 32, 16), (2048, 512, 16, 1), 0); del buf145  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf146, arg85_1, buf151, 223232, grid=grid(223232), stream=stream0)
        buf152 = reinterpret_tensor(buf93, (109, 4, 32, 16), (2048, 512, 16, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf146, arg85_1, buf152, 223232, grid=grid(223232), stream=stream0)
        buf153 = reinterpret_tensor(buf65, (109, 4, 32, 16), (2048, 512, 16, 1), 0); del buf65  # reuse
        buf165 = reinterpret_tensor(buf140, (109, 4, 32, 1, 16, 1), (2048, 512, 16, 16, 1, 1), 0); del buf140  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf146, arg85_1, buf153, buf165, 223232, grid=grid(223232), stream=stream0)
        del arg85_1
        del buf146
        buf154 = reinterpret_tensor(buf89, (109, 4, 32, 32), (4096, 1024, 32, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf149, buf147, buf154, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf155 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf151, buf152, buf153, buf154, False)
        del buf151
        del buf152
        buf156 = buf155[0]
        del buf155
        buf160 = reinterpret_tensor(buf154, (109, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf149, buf147, buf160, 446464, grid=grid(446464), stream=stream0)
        buf161 = reinterpret_tensor(buf87, (111616, 16), (16, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf160, (111616, 4), (4, 1), 0), reinterpret_tensor(arg86_1, (4, 16), (1, 4), 0), out=buf161)
        del arg86_1
        buf162 = reinterpret_tensor(buf161, (109, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_34.run(buf162, arg87_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg87_1
        buf163 = reinterpret_tensor(buf160, (111616, 4), (4, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf162, (111616, 16), (16, 1), 0), reinterpret_tensor(arg88_1, (16, 4), (1, 16), 0), out=buf163)
        del arg88_1
        del buf162
        buf164 = reinterpret_tensor(buf147, (109, 4, 32, 32, 1, 1), (4096, 1024, 32, 1, 1, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf163, arg89_1, buf164, 436, 1024, grid=grid(436, 1024), stream=stream0)
        del arg89_1
        del buf163
        buf166 = reinterpret_tensor(buf153, (436, 32, 16), (512, 16, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf164, (436, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf165, (436, 32, 16), (512, 16, 1), 0), out=buf166)
        del buf164
        del buf165
        buf167 = reinterpret_tensor(buf156, (109, 1, 32, 4, 16), (2048, 1, 64, 16, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf167, buf166, 223232, grid=grid(223232), stream=stream0)
        buf168 = reinterpret_tensor(buf166, (3488, 64), (64, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf167, (3488, 64), (64, 1), 0), reinterpret_tensor(arg90_1, (64, 64), (1, 64), 0), out=buf168)
        del arg90_1
        buf174 = reinterpret_tensor(buf167, (109, 32, 64), (2048, 64, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf141, buf168, arg91_1, arg92_1, arg93_1, buf174, 3488, 64, grid=grid(3488), stream=stream0)
        del arg92_1
        del arg93_1
        buf172 = reinterpret_tensor(buf104, (4096, 128), (128, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg99_1, reinterpret_tensor(buf131, (4096, 64), (64, 1), 0), reinterpret_tensor(arg98_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf172)
        del arg98_1
        del arg99_1
        buf173 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf172, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf172, (32, 128, 128), (16384, 1, 128), 0), out=buf173)
        del buf172
        buf175 = reinterpret_tensor(buf134, (3488, 256), (256, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf174, (3488, 64), (64, 1), 0), reinterpret_tensor(arg94_1, (64, 256), (1, 64), 0), out=buf175)
        del arg94_1
        buf176 = reinterpret_tensor(buf175, (109, 32, 256), (8192, 256, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf176, arg95_1, 892928, grid=grid(892928), stream=stream0)
        del arg95_1
        buf177 = reinterpret_tensor(buf174, (3488, 64), (64, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf176, (3488, 256), (256, 1), 0), reinterpret_tensor(arg96_1, (256, 64), (1, 256), 0), out=buf177)
        del arg96_1
        del buf176
        buf178 = reinterpret_tensor(buf177, (109, 32, 64), (2048, 64, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf178, buf141, buf168, arg91_1, arg97_1, 223232, grid=grid(223232), stream=stream0)
        del arg91_1
        del arg97_1
        del buf141
        del buf168
        buf179 = reinterpret_tensor(buf149, (3488, 32), (32, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf178, (3488, 64), (64, 1), 0), reinterpret_tensor(arg100_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf179)
        del arg100_1
        del arg101_1
        buf180 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf178, (3488, 64), (64, 1), 0), reinterpret_tensor(arg102_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf180)
        del arg102_1
        del arg103_1
        del buf178
        buf181 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf179, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf180, (109, 32, 32), (1024, 1, 32), 0), out=buf181)
        del buf179
        del buf180
        buf182 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg107_1, reinterpret_tensor(buf131, (4096, 64), (64, 1), 0), reinterpret_tensor(arg106_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf182)
        del arg106_1
        del arg107_1
        buf183 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf131, (4096, 64), (64, 1), 0), reinterpret_tensor(arg108_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf183)
        del arg108_1
        del arg109_1
        buf184 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf131, (4096, 64), (64, 1), 0), reinterpret_tensor(arg104_1, (64, 1), (1, 64), 0), out=buf184)
        del arg104_1
        del buf131
        buf185 = reinterpret_tensor(buf184, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf184  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_41.run(buf185, arg105_1, 4096, grid=grid(4096), stream=stream0)
        del arg105_1
        buf186 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_42.run(buf173, buf181, buf182, buf183, buf185, buf186, 902144, grid=grid(902144), stream=stream0)
        del buf173
        del buf181
        del buf182
        del buf183
    return (buf186, reinterpret_tensor(buf185, (1, 32, 128), (4096, 128, 1), 0), )
