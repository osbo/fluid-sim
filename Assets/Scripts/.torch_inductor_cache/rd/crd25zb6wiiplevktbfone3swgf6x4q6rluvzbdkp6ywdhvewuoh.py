...
# Graph fragment:
#   %cat_default : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view, %full_default_14], 1), kwargs = {})
...
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default_1 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%permute, %full_default_15],), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/nh/cnhsyfq4wh42axcczmwz32jja2lb5ubmq4twgkjeqklj6zihncrt.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/mj/cmj74qe6dpaw4ftqqatzd7snmv2a4gpaszurkqssydnkolbtt27j.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5c/c5ckxwqf3abwanqjh6rhb6co5bffsa2eupfzycplcsvyojf6uxjq.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vo/cvo537xbcblglpfnacpnogwmc4xfkgwh7my7y2ereiiqb2u5yfq4.py
...
triton_per_fused_mean_native_layer_norm_22 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_mean_native_layer_norm_22', 'mutated_arg_names': [], 'no_x_dim': True, 'num_load': 10, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ae/caedmhxwvlsy4evhr5iaahlixnbujsr2gdonjwcg2ejfvremssnk.py
...
triton_per_fused_index_put_lift_fresh_mean_23 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32', 5: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_index_put_lift_fresh_mean_23', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/js/cjsa7v7k4ymaau3qio46xph57mahogm32ptp6wqyhdbwqu4jafwl.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ll/cllnovuunqnkxm5fbq7kueldbg3sdxmtsaautstfpgbumbasoryd.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/b4/cb4qul3mgblrrvjy2t33hcw4xsxoc4hqgo4c4oky6vxbd7sypfgw.py
# Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_3 => full_default_5, index_put_5
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gz/cgzguc2d7d3eufgddkjuesct3slht5i2iijroravje3hcnhu252f.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/dw/cdw2mwmijesu7l2nbadbv5pj6gnrmcpin4lldjtr4be57embq42u.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f_1 => clone_9
#   logit_bias_1 => clone_11
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/dj/cdjfi54dmx6qfw3zqu5nuaqcpjdxh5l6egq4433fg3dhf3mxy5os.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6e/c6ejsji7275qt6gk6ip33voexw6sitgwfuknsujmfibgu5xk3bzi.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f_1 => clone_9
#   logit_bias_1 => clone_11
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/r5/cr5izigqbmokv4rokr5ejlbet2av4pzbxzfrr2u5gzckqacg32qz.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
triton_poi_fused_31 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_31', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ti/ctiz2hl34rb5rdxlrvqp55c7htxt2xipbpeyun6kbzva3u72mxls.py
...
triton_poi_fused_gelu_32 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/m2/cm2ze5nihkaweyeidbnhehbdb5r3a22xtglmj3gnm5m5zjr7tagd.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/m7/cm7sx5dnotdjycuk75buaer5v57foxkr2m7yqffo5ipbkmpgpnx3.py
...
triton_poi_fused_add_34 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_34', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7m/c7mpf56w22iohwy4fi43tltndivhgnuowd26uqyom3r65duppbxh.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/l3/cl33sagnbbvlit5iskbuypiqbr6yqpc6l2di3pa2fhemg3n6illl.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ig/cigs2msgf3drcxh3vjfhm32cy23r2wmfn3rlgk73rgrw4ujfkf4l.py
...
triton_per_fused_add_mean_native_layer_norm_37 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/lg/clgb427tx26kxgvdg66nq26hwvot3iiksddjfkcx5agbjdmtzzs7.py
...
triton_poi_fused_index_put_lift_fresh_38 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_put_lift_fresh_38', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ap/capyj4hn5rdezikkbqhacbkjks7s3uohcy73czpypfvyw43eqz7n.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ci/ccipb73d4wrctoqsokut3zrqevkiwvc5qkb4xcreiwbamsziaj5l.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gb/cgb46s55gvnfvkr6t7pcmbse6t56hah7qibacs5qhs55z2agz3gm.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5c/c5c6qrzepiorto2ukgniydze35jxifbqesmzcxr6hb2hryzax2tw.py
...
triton_poi_fused_sigmoid_42 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_sigmoid_42', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5q/c5qxbsg3sawjxaiyb422ktjmb5voelv6cf2dzyjpgu3xujrspljs.py
...
def call(args):
    ...
    assert_size_stride(arg44_1, (1024, 256), (256, 1))
    ...
    assert_size_stride(arg50_1, (768, 256), (256, 1))
    ...
    assert_size_stride(arg60_1, (1024, 256), (256, 1))
    ...
    assert_size_stride(arg66_1, (768, 256), (256, 1))
    ...
    assert_size_stride(arg92_1, (1024, 256), (256, 1))
    ...
    assert_size_stride(arg98_1, (768, 256), (256, 1))
    ...
    assert_size_stride(arg124_1, (1024, 256), (256, 1))
    assert_size_stride(arg125_1, (1024, ), (1, ))
    assert_size_stride(arg126_1, (256, 1024), (1024, 1))
    ...
    assert_size_stride(arg134_1, (32, 256), (256, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf101 = empty_strided_cuda((1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem, setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_8.run(arg28_1, buf32, buf101, 4194304, grid=grid(4194304), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        del arg40_1
        buf57 = reinterpret_tensor(buf52, (1, 8192, 256), (2097152, 256, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d, z], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_6.run(buf26, buf53, arg41_1, arg42_1, arg43_1, buf57, 8192, 256, grid=grid(8192), stream=stream0)
        del arg42_1
        del arg43_1
        buf58 = reinterpret_tensor(buf49, (8192, 1024), (1024, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (8192, 256), (256, 1), 0), reinterpret_tensor(arg44_1, (256, 1024), (1, 256), 0), out=buf58)
        del arg44_1
        buf59 = reinterpret_tensor(buf58, (1, 8192, 1024), (8388608, 1024, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf59, arg45_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg45_1
        buf60 = reinterpret_tensor(buf57, (8192, 256), (256, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (8192, 1024), (1024, 1), 0), reinterpret_tensor(arg46_1, (1024, 256), (1, 1024), 0), out=buf60)
        del arg46_1
        buf61 = reinterpret_tensor(buf60, (1, 8192, 256), (2097152, 256, 1), 0); del buf60  # reuse
        buf99 = reinterpret_tensor(buf50, (1, 8192, 256), (2097152, 256, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_21.run(buf61, buf26, buf53, arg41_1, arg47_1, arg64_1, arg65_1, buf99, 8192, 256, grid=grid(8192), stream=stream0)
        del arg41_1
        del arg47_1
        del arg64_1
        del arg65_1
        buf62 = empty_strided_cuda((1, 234, 32768), (7667712, 32768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_p_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf61, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf62)
        buf63 = empty_strided_cuda((1, 234, 32768), (7667712, 32768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_p_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf61, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf63)
        buf64 = empty_strided_cuda((234, 32, 256), (8192, 256, 1), torch.float32)
        buf68 = empty_strided_cuda((234, 32, 256), (8192, 256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_22.run(buf62, buf63, arg48_1, arg49_1, buf64, buf68, 7488, 256, grid=grid(7488), stream=stream0)
        del arg48_1
        del arg49_1
        buf69 = empty_strided_cuda((7488, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf68, (7488, 256), (256, 1), 0), reinterpret_tensor(arg50_1, (256, 768), (1, 256), 0), out=buf69)
        del arg50_1
        buf71 = empty_strided_cuda((234, 1, 32, 32, 4), (4096, 958464, 128, 4, 1), torch.float32)
        buf143 = empty_strided_cuda((234, 1, 32, 32, 4), (4096, 958464, 128, 4, 1), torch.float32)
        buf215 = empty_strided_cuda((234, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [sub, setitem_2, setitem_6], Original ATen: [aten.mean, aten.lift_fresh, aten.index_put]
        triton_per_fused_index_put_lift_fresh_mean_23.run(arg29_1, buf71, buf143, buf215, 958464, 16, grid=grid(958464), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_24.run(buf71, 29952, grid=grid(29952), stream=stream0)
        buf73 = empty_strided_cuda((234, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_25.run(buf71, buf73, 239616, grid=grid(239616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf73, 7488, grid=grid(7488), stream=stream0)
        buf75 = reinterpret_tensor(buf68, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_27.run(buf69, arg51_1, buf75, 1916928, grid=grid(1916928), stream=stream0)
        buf76 = empty_strided_cuda((234, 8, 32, 32), (8192, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_28.run(buf69, arg51_1, buf76, 1916928, grid=grid(1916928), stream=stream0)
        buf77 = empty_strided_cuda((234, 8, 32, 32), (8192, 1024, 32, 1), torch.float32)
        buf89 = empty_strided_cuda((234, 8, 32, 1, 32, 1), (8192, 1024, 32, 32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf69, arg51_1, buf77, buf89, 1916928, grid=grid(1916928), stream=stream0)
        del arg51_1
        buf78 = empty_strided_cuda((234, 8, 32, 32), (8192, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf73, buf71, buf78, 1916928, grid=grid(1916928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf79 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf75, buf76, buf77, buf78, False)
        del buf75
        buf80 = buf79[0]
        del buf79
        buf84 = empty_strided_cuda((234, 1, 32, 32, 4), (4096, 1, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_31.run(buf73, buf71, buf84, 958464, grid=grid(958464), stream=stream0)
        del buf71
        buf85 = empty_strided_cuda((239616, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf84, (239616, 4), (4, 1), 0), reinterpret_tensor(arg52_1, (4, 16), (1, 4), 0), out=buf85)
        del arg52_1
        buf86 = reinterpret_tensor(buf85, (234, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_32.run(buf86, arg53_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg53_1
        buf87 = reinterpret_tensor(buf78, (239616, 8), (8, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf86, (239616, 16), (16, 1), 0), reinterpret_tensor(arg54_1, (16, 8), (1, 16), 0), out=buf87)
        del arg54_1
        buf88 = reinterpret_tensor(buf77, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf87, arg55_1, buf88, 1872, 1024, grid=grid(1872, 1024), stream=stream0)
        del arg55_1
        buf90 = reinterpret_tensor(buf87, (1872, 32, 32), (1024, 32, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf88, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf89, (1872, 32, 32), (1024, 32, 1), 0), out=buf90)
        buf91 = reinterpret_tensor(buf80, (234, 1, 32, 8, 32), (8192, 1, 256, 32, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        triton_poi_fused_add_34.run(buf91, buf90, 1916928, grid=grid(1916928), stream=stream0)
        buf92 = reinterpret_tensor(buf90, (7488, 256), (256, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf91, (7488, 256), (256, 1), 0), reinterpret_tensor(arg56_1, (256, 256), (1, 256), 0), out=buf92)
        del arg56_1
        buf133 = reinterpret_tensor(buf91, (234, 32, 256), (8192, 256, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, z_1], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf64, buf92, arg57_1, arg58_1, arg59_1, buf133, 7488, 256, grid=grid(7488), stream=stream0)
        del arg58_1
        del arg59_1
        buf100 = buf31; del buf31  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (8192, 256), (256, 1), 0), reinterpret_tensor(arg66_1, (256, 768), (1, 256), 0), out=buf100)
        del arg66_1
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_9.run(buf101, 32768, grid=grid(32768), stream=stream0)
        buf103 = buf34; del buf34  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_10.run(buf101, buf103, 1048576, grid=grid(1048576), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(buf103, 8192, grid=grid(8192), stream=stream0)
        buf105 = reinterpret_tensor(buf99, (64, 8, 128, 32), (32768, 4096, 32, 1), 0); del buf99  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf100, arg67_1, buf105, 2097152, grid=grid(2097152), stream=stream0)
        buf106 = reinterpret_tensor(buf53, (64, 8, 128, 32), (32768, 4096, 32, 1), 0); del buf53  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf100, arg67_1, buf106, 2097152, grid=grid(2097152), stream=stream0)
        buf107 = reinterpret_tensor(buf26, (64, 8, 128, 32), (32768, 4096, 32, 1), 0); del buf26  # reuse
        buf119 = reinterpret_tensor(buf37, (64, 8, 128, 1, 32, 1), (32768, 4096, 32, 32, 1, 1), 0); del buf37  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf100, arg67_1, buf107, buf119, 2097152, grid=grid(2097152), stream=stream0)
        del arg67_1
        buf108 = reinterpret_tensor(buf59, (64, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_15.run(buf103, buf101, buf108, 8388608, grid=grid(8388608), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf109 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf105, buf106, buf107, buf108, False)
        del buf105
        buf110 = buf109[0]
        del buf109
        buf114 = buf45; del buf45  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf103, buf101, buf114, 4194304, grid=grid(4194304), stream=stream0)
        buf115 = reinterpret_tensor(buf47, (1048576, 16), (16, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (1048576, 4), (4, 1), 0), reinterpret_tensor(arg68_1, (4, 16), (1, 4), 0), out=buf115)
        del arg68_1
        buf116 = reinterpret_tensor(buf115, (1, 64, 128, 128, 16), (16777216, 262144, 2048, 16, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_17.run(buf116, arg69_1, 16777216, grid=grid(16777216), stream=stream0)
        del arg69_1
        buf117 = reinterpret_tensor(buf108, (1048576, 8), (8, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (1048576, 16), (16, 1), 0), reinterpret_tensor(arg70_1, (16, 8), (1, 16), 0), out=buf117)
        del arg70_1
        buf118 = reinterpret_tensor(buf48, (64, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf117, arg71_1, buf118, 512, 16384, grid=grid(512, 16384), stream=stream0)
        del arg71_1
        buf120 = reinterpret_tensor(buf107, (512, 128, 32), (4096, 32, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf118, (512, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf119, (512, 128, 32), (4096, 32, 1), 0), out=buf120)
        buf121 = reinterpret_tensor(buf110, (1, 64, 128, 8, 32), (2097152, 32768, 256, 32, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.add]
        triton_poi_fused_add_19.run(buf121, buf120, 2097152, grid=grid(2097152), stream=stream0)
        buf122 = reinterpret_tensor(buf120, (8192, 256), (256, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (8192, 256), (256, 1), 0), reinterpret_tensor(arg72_1, (256, 256), (1, 256), 0), out=buf122)
        del arg72_1
        buf126 = reinterpret_tensor(buf121, (1, 8192, 256), (2097152, 256, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_6.run(buf61, buf122, arg73_1, arg74_1, arg75_1, buf126, 8192, 256, grid=grid(8192), stream=stream0)
        del arg74_1
        del arg75_1
        buf127 = reinterpret_tensor(buf118, (8192, 1024), (1024, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (8192, 256), (256, 1), 0), reinterpret_tensor(arg76_1, (256, 1024), (1, 256), 0), out=buf127)
        del arg76_1
        buf128 = reinterpret_tensor(buf127, (1, 8192, 1024), (8388608, 1024, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf128, arg77_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg77_1
        buf129 = reinterpret_tensor(buf126, (8192, 256), (256, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (8192, 1024), (1024, 1), 0), reinterpret_tensor(arg78_1, (1024, 256), (1, 1024), 0), out=buf129)
        del arg78_1
        buf130 = reinterpret_tensor(buf129, (1, 8192, 256), (2097152, 256, 1), 0); del buf129  # reuse
        buf171 = reinterpret_tensor(buf119, (1, 8192, 256), (2097152, 256, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, h_diag_2, layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_21.run(buf130, buf61, buf122, arg73_1, arg79_1, arg96_1, arg97_1, buf171, 8192, 256, grid=grid(8192), stream=stream0)
        del arg73_1
        del arg79_1
        del arg96_1
        del arg97_1
        buf131 = buf63; del buf63  # reuse
        # Topologically Sorted Source Nodes: [row_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf130, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf131)
        buf132 = buf62; del buf62  # reuse
        # Topologically Sorted Source Nodes: [col_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf130, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf132)
        buf134 = empty_strided_cuda((7488, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf133, (7488, 256), (256, 1), 0), reinterpret_tensor(arg60_1, (256, 1024), (1, 256), 0), out=buf134)
        del arg60_1
        buf135 = reinterpret_tensor(buf134, (234, 32, 1024), (32768, 1024, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf135, arg61_1, 7667712, grid=grid(7667712), stream=stream0)
        del arg61_1
        buf136 = reinterpret_tensor(buf133, (7488, 256), (256, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf135, (7488, 1024), (1024, 1), 0), reinterpret_tensor(arg62_1, (1024, 256), (1, 1024), 0), out=buf136)
        del arg62_1
        buf137 = reinterpret_tensor(buf136, (234, 32, 256), (8192, 256, 1), 0); del buf136  # reuse
        buf141 = reinterpret_tensor(buf89, (234, 32, 256), (8192, 256, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, h_off_5, off_stream, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_37.run(buf137, buf131, buf132, buf64, buf92, arg57_1, arg63_1, arg80_1, arg81_1, buf141, 7488, 256, grid=grid(7488), stream=stream0)
        del arg57_1
        del arg63_1
        del arg80_1
        del arg81_1
        buf142 = buf69; del buf69  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (7488, 256), (256, 1), 0), reinterpret_tensor(arg82_1, (256, 768), (1, 256), 0), out=buf142)
        del arg82_1
        # Topologically Sorted Source Nodes: [setitem_6], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_24.run(buf143, 29952, grid=grid(29952), stream=stream0)
        buf145 = buf73; del buf73  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_25.run(buf143, buf145, 239616, grid=grid(239616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf145, 7488, grid=grid(7488), stream=stream0)
        buf147 = reinterpret_tensor(buf141, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf141  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_27.run(buf142, arg83_1, buf147, 1916928, grid=grid(1916928), stream=stream0)
        buf148 = reinterpret_tensor(buf92, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_28.run(buf142, arg83_1, buf148, 1916928, grid=grid(1916928), stream=stream0)
        buf149 = reinterpret_tensor(buf64, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf64  # reuse
        buf161 = reinterpret_tensor(buf88, (234, 8, 32, 1, 32, 1), (8192, 1024, 32, 32, 1, 1), 0); del buf88  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf142, arg83_1, buf149, buf161, 1916928, grid=grid(1916928), stream=stream0)
        del arg83_1
        buf150 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf145, buf143, buf150, 1916928, grid=grid(1916928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf151 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf147, buf148, buf149, buf150, False)
        del buf147
        buf152 = buf151[0]
        del buf151
        buf156 = buf84; del buf84  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_31.run(buf145, buf143, buf156, 958464, grid=grid(958464), stream=stream0)
        del buf143
        buf157 = reinterpret_tensor(buf86, (239616, 16), (16, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (239616, 4), (4, 1), 0), reinterpret_tensor(arg84_1, (4, 16), (1, 4), 0), out=buf157)
        del arg84_1
        buf158 = reinterpret_tensor(buf157, (234, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_32.run(buf158, arg85_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg85_1
        buf159 = reinterpret_tensor(buf150, (239616, 8), (8, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (239616, 16), (16, 1), 0), reinterpret_tensor(arg86_1, (16, 8), (1, 16), 0), out=buf159)
        del arg86_1
        buf160 = reinterpret_tensor(buf149, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [einsum_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf159, arg87_1, buf160, 1872, 1024, grid=grid(1872, 1024), stream=stream0)
        del arg87_1
        buf162 = reinterpret_tensor(buf159, (1872, 32, 32), (1024, 32, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [einsum_9], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf160, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf161, (1872, 32, 32), (1024, 32, 1), 0), out=buf162)
        buf163 = reinterpret_tensor(buf152, (234, 1, 32, 8, 32), (8192, 1, 256, 32, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_34.run(buf163, buf162, 1916928, grid=grid(1916928), stream=stream0)
        buf164 = reinterpret_tensor(buf162, (7488, 256), (256, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (7488, 256), (256, 1), 0), reinterpret_tensor(arg88_1, (256, 256), (1, 256), 0), out=buf164)
        del arg88_1
        buf205 = reinterpret_tensor(buf163, (234, 32, 256), (8192, 256, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, z_3], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf137, buf164, arg89_1, arg90_1, arg91_1, buf205, 7488, 256, grid=grid(7488), stream=stream0)
        del arg90_1
        del arg91_1
        buf172 = buf100; del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (8192, 256), (256, 1), 0), reinterpret_tensor(arg98_1, (256, 768), (1, 256), 0), out=buf172)
        del arg98_1
        buf173 = buf114; del buf114  # reuse
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_38.run(arg28_1, buf173, 4194304, grid=grid(4194304), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_9.run(buf173, 32768, grid=grid(32768), stream=stream0)
        buf175 = buf103; del buf103  # reuse
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_10.run(buf173, buf175, 1048576, grid=grid(1048576), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(buf175, 8192, grid=grid(8192), stream=stream0)
        buf177 = reinterpret_tensor(buf171, (64, 8, 128, 32), (32768, 4096, 32, 1), 0); del buf171  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf172, arg99_1, buf177, 2097152, grid=grid(2097152), stream=stream0)
        buf178 = reinterpret_tensor(buf61, (64, 8, 128, 32), (32768, 4096, 32, 1), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf172, arg99_1, buf178, 2097152, grid=grid(2097152), stream=stream0)
        buf179 = reinterpret_tensor(buf122, (64, 8, 128, 32), (32768, 4096, 32, 1), 0); del buf122  # reuse
        buf191 = reinterpret_tensor(buf106, (64, 8, 128, 1, 32, 1), (32768, 4096, 32, 32, 1, 1), 0); del buf106  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf172, arg99_1, buf179, buf191, 2097152, grid=grid(2097152), stream=stream0)
        del arg99_1
        del buf172
        buf180 = reinterpret_tensor(buf128, (64, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_15.run(buf175, buf173, buf180, 8388608, grid=grid(8388608), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf182 = buf181[0]
        del buf181
        buf186 = buf101; del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf175, buf173, buf186, 4194304, grid=grid(4194304), stream=stream0)
        del buf173
        buf187 = reinterpret_tensor(buf116, (1048576, 16), (16, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf186, (1048576, 4), (4, 1), 0), reinterpret_tensor(arg100_1, (4, 16), (1, 4), 0), out=buf187)
        del arg100_1
        del buf186
        buf188 = reinterpret_tensor(buf187, (1, 64, 128, 128, 16), (16777216, 262144, 2048, 16, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [input_35], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_17.run(buf188, arg101_1, 16777216, grid=grid(16777216), stream=stream0)
        del arg101_1
        buf189 = reinterpret_tensor(buf180, (1048576, 8), (8, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf188, (1048576, 16), (16, 1), 0), reinterpret_tensor(arg102_1, (16, 8), (1, 16), 0), out=buf189)
        del arg102_1
        del buf188
        buf190 = reinterpret_tensor(buf117, (64, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [einsum_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf189, arg103_1, buf190, 512, 16384, grid=grid(512, 16384), stream=stream0)
        del arg103_1
        del buf189
        buf192 = reinterpret_tensor(buf179, (512, 128, 32), (4096, 32, 1), 0); del buf179  # reuse
        # Topologically Sorted Source Nodes: [einsum_10], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf190, (512, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf191, (512, 128, 32), (4096, 32, 1), 0), out=buf192)
        del buf191
        buf193 = reinterpret_tensor(buf182, (1, 64, 128, 8, 32), (2097152, 32768, 256, 32, 1), 0); del buf182  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.add]
        triton_poi_fused_add_19.run(buf193, buf192, 2097152, grid=grid(2097152), stream=stream0)
        buf194 = reinterpret_tensor(buf192, (8192, 256), (256, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf193, (8192, 256), (256, 1), 0), reinterpret_tensor(arg104_1, (256, 256), (1, 256), 0), out=buf194)
        del arg104_1
        buf198 = reinterpret_tensor(buf193, (1, 8192, 256), (2097152, 256, 1), 0); del buf193  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, z_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_6.run(buf130, buf194, arg105_1, arg106_1, arg107_1, buf198, 8192, 256, grid=grid(8192), stream=stream0)
        del arg106_1
        del arg107_1
        buf199 = reinterpret_tensor(buf190, (8192, 1024), (1024, 1), 0); del buf190  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf198, (8192, 256), (256, 1), 0), reinterpret_tensor(arg108_1, (256, 1024), (1, 256), 0), out=buf199)
        del arg108_1
        buf200 = reinterpret_tensor(buf199, (1, 8192, 1024), (8388608, 1024, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [input_38], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf200, arg109_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg109_1
        buf201 = reinterpret_tensor(buf198, (8192, 256), (256, 1), 0); del buf198  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf200, (8192, 1024), (1024, 1), 0), reinterpret_tensor(arg110_1, (1024, 256), (1, 1024), 0), out=buf201)
        del arg110_1
        del buf200
        buf202 = reinterpret_tensor(buf201, (1, 8192, 256), (2097152, 256, 1), 0); del buf201  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, h_diag_3], Original ATen: [aten.add]
        triton_poi_fused_add_39.run(buf202, buf130, buf194, arg105_1, arg111_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg105_1
        del arg111_1
        del buf130
        buf203 = buf132; del buf132  # reuse
        # Topologically Sorted Source Nodes: [row_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf202, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf203)
        del arg30_1
        buf204 = buf131; del buf131  # reuse
        # Topologically Sorted Source Nodes: [col_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf202, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf204)
        del arg31_1
        buf206 = reinterpret_tensor(buf135, (7488, 1024), (1024, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf205, (7488, 256), (256, 1), 0), reinterpret_tensor(arg92_1, (256, 1024), (1, 256), 0), out=buf206)
        del arg92_1
        buf207 = reinterpret_tensor(buf206, (234, 32, 1024), (32768, 1024, 1), 0); del buf206  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf207, arg93_1, 7667712, grid=grid(7667712), stream=stream0)
        del arg93_1
        buf208 = reinterpret_tensor(buf205, (7488, 256), (256, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf207, (7488, 1024), (1024, 1), 0), reinterpret_tensor(arg94_1, (1024, 256), (1, 1024), 0), out=buf208)
        del arg94_1
        del buf207
        buf209 = reinterpret_tensor(buf208, (234, 32, 256), (8192, 256, 1), 0); del buf208  # reuse
        buf213 = reinterpret_tensor(buf161, (234, 32, 256), (8192, 256, 1), 0); del buf161  # reuse
        ...
        triton_per_fused_add_mean_native_layer_norm_37.run(buf209, buf203, buf204, buf137, buf164, arg89_1, arg95_1, arg112_1, arg113_1, buf213, 7488, 256, grid=grid(7488), stream=stream0)
        del arg112_1
        del arg113_1
        del arg89_1
        del arg95_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf213, (7488, 256), (256, 1), 0), reinterpret_tensor(arg114_1, (256, 768), (1, 256), 0), out=buf214)
        del arg114_1
        # Topologically Sorted Source Nodes: [setitem_10], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_24.run(buf215, 29952, grid=grid(29952), stream=stream0)
        buf217 = buf145; del buf145  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_25.run(buf215, buf217, 239616, grid=grid(239616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf217, 7488, grid=grid(7488), stream=stream0)
        buf219 = reinterpret_tensor(buf213, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf213  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_27.run(buf214, arg115_1, buf219, 1916928, grid=grid(1916928), stream=stream0)
        buf220 = reinterpret_tensor(buf164, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_28.run(buf214, arg115_1, buf220, 1916928, grid=grid(1916928), stream=stream0)
        buf221 = reinterpret_tensor(buf137, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf137  # reuse
        buf233 = reinterpret_tensor(buf160, (234, 8, 32, 1, 32, 1), (8192, 1024, 32, 32, 1, 1), 0); del buf160  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf214, arg115_1, buf221, buf233, 1916928, grid=grid(1916928), stream=stream0)
        del arg115_1
        del buf214
        buf222 = buf148; del buf148  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf217, buf215, buf222, 1916928, grid=grid(1916928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf223 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf219, buf220, buf221, buf222, False)
        del buf219
        del buf220
        buf224 = buf223[0]
        del buf223
        buf228 = buf156; del buf156  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_31.run(buf217, buf215, buf228, 958464, grid=grid(958464), stream=stream0)
        del buf215
        buf229 = reinterpret_tensor(buf158, (239616, 16), (16, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf228, (239616, 4), (4, 1), 0), reinterpret_tensor(arg116_1, (4, 16), (1, 4), 0), out=buf229)
        del arg116_1
        del buf228
        buf230 = reinterpret_tensor(buf229, (234, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf229  # reuse
        # Topologically Sorted Source Nodes: [input_41], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_32.run(buf230, arg117_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg117_1
        buf231 = reinterpret_tensor(buf222, (239616, 8), (8, 1), 0); del buf222  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf230, (239616, 16), (16, 1), 0), reinterpret_tensor(arg118_1, (16, 8), (1, 16), 0), out=buf231)
        del arg118_1
        del buf230
        buf232 = reinterpret_tensor(buf221, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf221  # reuse
        # Topologically Sorted Source Nodes: [einsum_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf231, arg119_1, buf232, 1872, 1024, grid=grid(1872, 1024), stream=stream0)
        del arg119_1
        buf234 = reinterpret_tensor(buf231, (1872, 32, 32), (1024, 32, 1), 0); del buf231  # reuse
        # Topologically Sorted Source Nodes: [einsum_13], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf232, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf233, (1872, 32, 32), (1024, 32, 1), 0), out=buf234)
        del buf232
        del buf233
        buf235 = reinterpret_tensor(buf224, (234, 1, 32, 8, 32), (8192, 1, 256, 32, 1), 0); del buf224  # reuse
        # Topologically Sorted Source Nodes: [x_mid_5], Original ATen: [aten.add]
        triton_poi_fused_add_34.run(buf235, buf234, 1916928, grid=grid(1916928), stream=stream0)
        buf236 = reinterpret_tensor(buf234, (7488, 256), (256, 1), 0); del buf234  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf235, (7488, 256), (256, 1), 0), reinterpret_tensor(arg120_1, (256, 256), (1, 256), 0), out=buf236)
        del arg120_1
        buf244 = reinterpret_tensor(buf235, (234, 32, 256), (8192, 256, 1), 0); del buf235  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf209, buf236, arg121_1, arg122_1, arg123_1, buf244, 7488, 256, grid=grid(7488), stream=stream0)
        del arg122_1
        del arg123_1
        buf240 = buf194; del buf194  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf202, (8192, 256), (256, 1), 0), reinterpret_tensor(arg128_1, (256, 256), (1, 256), 0), out=buf240)
        del arg128_1
        buf241 = reinterpret_tensor(buf240, (1, 64, 128, 256), (2097152, 32768, 256, 1), 0); del buf240  # reuse
        # Topologically Sorted Source Nodes: [input_47], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_2.run(buf241, arg129_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg129_1
        buf242 = reinterpret_tensor(buf175, (8192, 128), (128, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [input_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg131_1, reinterpret_tensor(buf241, (8192, 256), (256, 1), 0), reinterpret_tensor(arg130_1, (256, 128), (1, 256), 0), alpha=1, beta=1, out=buf242)
        del arg130_1
        del arg131_1
        del buf241
        buf243 = empty_strided_cuda((64, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf242, (64, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf242, (64, 128, 128), (16384, 1, 128), 0), out=buf243)
        del buf242
        buf245 = reinterpret_tensor(buf204, (7488, 1024), (1024, 1), 0); del buf204  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf244, (7488, 256), (256, 1), 0), reinterpret_tensor(arg124_1, (256, 1024), (1, 256), 0), out=buf245)
        del arg124_1
        buf246 = reinterpret_tensor(buf245, (234, 32, 1024), (32768, 1024, 1), 0); del buf245  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf246, arg125_1, 7667712, grid=grid(7667712), stream=stream0)
        del arg125_1
        buf247 = reinterpret_tensor(buf244, (7488, 256), (256, 1), 0); del buf244  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf246, (7488, 1024), (1024, 1), 0), reinterpret_tensor(arg126_1, (1024, 256), (1, 1024), 0), out=buf247)
        del arg126_1
        del buf246
        buf248 = reinterpret_tensor(buf247, (234, 32, 256), (8192, 256, 1), 0); del buf247  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf248, buf209, buf236, arg121_1, arg127_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg121_1
        del arg127_1
        del buf209
        buf249 = buf236; del buf236  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf248, (7488, 256), (256, 1), 0), reinterpret_tensor(arg132_1, (256, 256), (1, 256), 0), out=buf249)
        del arg132_1
        buf250 = reinterpret_tensor(buf249, (234, 1, 32, 256), (8192, 1, 256, 1), 0); del buf249  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf250, arg133_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg133_1
        buf251 = reinterpret_tensor(buf217, (7488, 32), (32, 1), 0); del buf217  # reuse
        # Topologically Sorted Source Nodes: [input_51], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg135_1, reinterpret_tensor(buf250, (7488, 256), (256, 1), 0), reinterpret_tensor(arg134_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf251)
        del arg134_1
        del arg135_1
        buf252 = reinterpret_tensor(buf250, (7488, 256), (256, 1), 0); del buf250  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf248, (7488, 256), (256, 1), 0), reinterpret_tensor(arg136_1, (256, 256), (1, 256), 0), out=buf252)
        del arg136_1
        del buf248
        buf253 = reinterpret_tensor(buf252, (234, 1, 32, 256), (8192, 1, 256, 1), 0); del buf252  # reuse
        # Topologically Sorted Source Nodes: [input_53], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf253, arg137_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg137_1
        buf254 = empty_strided_cuda((7488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf253, (7488, 256), (256, 1), 0), reinterpret_tensor(arg138_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf254)
        del arg138_1
        del arg139_1
        del buf253
        buf255 = empty_strided_cuda((234, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf251, (234, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf254, (234, 32, 32), (1024, 1, 32), 0), out=buf255)
        del buf251
        del buf254
        buf256 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg143_1, reinterpret_tensor(buf202, (8192, 256), (256, 1), 0), reinterpret_tensor(arg142_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf256)
        del arg142_1
        del arg143_1
        buf257 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg145_1, reinterpret_tensor(buf202, (8192, 256), (256, 1), 0), reinterpret_tensor(arg144_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf257)
        del arg144_1
        del arg145_1
        buf258 = empty_strided_cuda((8192, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf202, (8192, 256), (256, 1), 0), reinterpret_tensor(arg140_1, (256, 1), (1, 256), 0), out=buf258)
        del arg140_1
        del buf202
        buf259 = reinterpret_tensor(buf258, (1, 64, 128, 1), (8192, 128, 1, 1), 0); del buf258  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_42.run(buf259, arg141_1, 8192, grid=grid(8192), stream=stream0)
        del arg141_1
        buf260 = empty_strided_cuda((1, 1820672), (1820672, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf243, buf255, buf256, buf257, buf259, buf260, 1820672, grid=grid(1820672), stream=stream0)
        del buf243
        del buf255
        del buf256
        del buf257
    return (buf260, reinterpret_tensor(buf259, (1, 64, 128), (8192, 128, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg44_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg45_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg46_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg50_1 = rand_strided((768, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg60_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg61_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg62_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg66_1 = rand_strided((768, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg76_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg77_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg78_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg82_1 = rand_strided((768, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg92_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg93_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg94_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg98_1 = rand_strided((768, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg108_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg109_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg110_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg114_1 = rand_strided((768, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg124_1 = rand_strided((1024, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    arg125_1 = rand_strided((1024, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg126_1 = rand_strided((256, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg134_1 = rand_strided((32, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg140_1 = rand_strided((1, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg144_1 = rand_strided((32, 256), (256, 1), device='cuda:0', dtype=torch.float32)
