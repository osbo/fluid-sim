...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/73/c73drl2h574h2lvyhategq6mblolamekkj63ywg6zpjnksosmt5n.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf145
        del buf146
        buf148 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf117, (4096, 512), (512, 1), 0), reinterpret_tensor(arg72_1, (512, 1), (1, 512), 0), out=buf148)
        del arg72_1
        del buf117
        buf149 = reinterpret_tensor(buf148, (1, 128, 32, 1), (4096, 32, 1, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_40.run(buf149, arg73_1, 4096, grid=grid(4096), stream=stream0)
        del arg73_1
        buf150 = empty_strided_cuda((1, 633856), (633856, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_41.run(buf119, buf147, buf149, buf150, 633856, grid=grid(633856), stream=stream0)
        del buf119
        del buf147
    return (buf150, reinterpret_tensor(buf149, (1, 128, 32), (4096, 32, 1), 0), )
