...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_22.run(buf69, buf25, buf60, arg47_1, arg53_1, arg72_1, arg73_1, buf122, 4096, 128, grid=grid(4096), stream=stream0)
        del arg47_1
        del arg53_1
        del arg72_1
        del arg73_1
        ...
        buf109 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf109, 1785856, grid=grid(1785856), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_21, index_add__4, col_sum_1, getitem_22, index_add__5, row_sum, getitem_12, index_add__2, col_sum, getitem_13, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_24.run(buf64, buf70, buf69, buf73, buf25, buf71, buf74, buf107, buf109, 2916352, grid=grid(2916352), stream=stream0)
        buf76 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        buf80 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_25.run(buf71, arg35_1, buf74, arg54_1, arg55_1, buf76, buf80, 6976, 128, grid=grid(6976), stream=stream0)
        del arg54_1
        del arg55_1
        buf81 = empty_strided_cuda((6976, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf80, (6976, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf81)
        ...
        del arg30_1
        buf86 = reinterpret_tensor(buf74, (109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        ...
        buf90 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf81, arg57_1, buf90, 892928, grid=grid(892928), stream=stream0)
        buf91 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf81, arg57_1, buf91, 892928, grid=grid(892928), stream=stream0)
        buf92 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        buf104 = empty_strided_cuda((109, 8, 64, 1, 16, 1), (8192, 1024, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_35.run(buf81, arg57_1, buf92, buf104, 892928, grid=grid(892928), stream=stream0)
        buf99 = reinterpret_tensor(buf71, (109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        buf95 = buf94[0]
        del buf94
        buf105 = reinterpret_tensor(buf92, (872, 64, 16), (1024, 16, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf103, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf104, (872, 64, 16), (1024, 16, 1), 0), out=buf105)
        buf106 = empty_strided_cuda((6976, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf80, (6976, 128), (128, 1), 0), reinterpret_tensor(arg62_1, (128, 8), (1, 128), 0), out=buf106)
        del arg62_1
        buf111 = empty_strided_cuda((109, 1, 1, 128), (128, 13952, 13952, 1), torch.float32)
        buf112 = reinterpret_tensor(buf111, (109, 1, 1, 128), (128, 1, 13952, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_39.run(buf112, buf107, arg35_1, buf109, 13952, 64, grid=grid(13952), stream=stream0)
        buf113 = empty_strided_cuda((109, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (109, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf113)
        del arg56_1
        buf114 = reinterpret_tensor(buf95, (109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2, mul_3, x_mid_3], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_40.run(buf114, buf105, buf106, arg63_1, buf113, arg57_1, 892928, grid=grid(892928), stream=stream0)
        del arg57_1
        del arg63_1
        buf115 = reinterpret_tensor(buf105, (6976, 128), (128, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (6976, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf115)
        del arg64_1
        buf164 = reinterpret_tensor(buf114, (109, 64, 128), (8192, 128, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf76, buf115, arg65_1, arg66_1, arg67_1, buf164, 6976, 128, grid=grid(6976), stream=stream0)
        del arg66_1
        del arg67_1
        buf123 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (4096, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf123)
        buf124 = empty_strided_cuda((1, 32, 128), (4096, 128, 1), torch.float32)
        buf125 = reinterpret_tensor(buf25, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf25  # reuse
        ...
        del arg29_1
        del buf126
        buf128 = reinterpret_tensor(buf67, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf67  # reuse
        ...
        buf130 = reinterpret_tensor(buf60, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf60  # reuse
        ...
        buf132 = reinterpret_tensor(buf53, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf53  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_13.run(buf123, arg75_1, buf132, 524288, grid=grid(524288), stream=stream0)
        buf133 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_14.run(buf123, arg75_1, buf133, 524288, grid=grid(524288), stream=stream0)
        buf134 = buf39; del buf39  # reuse
        buf146 = reinterpret_tensor(buf37, (32, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf37  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_15.run(buf123, arg75_1, buf134, buf146, 524288, grid=grid(524288), stream=stream0)
        del buf123
        ...
        buf137 = buf136[0]
        del buf136
        buf147 = reinterpret_tensor(buf134, (256, 128, 16), (2048, 16, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf145, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf146, (256, 128, 16), (2048, 16, 1), 0), out=buf147)
        del buf145
        del buf146
        buf148 = buf55; del buf55  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (4096, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 8), (1, 128), 0), out=buf148)
        del arg80_1
        del buf122
        buf149 = buf58; del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (32, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf149)
        del arg74_1
        buf150 = reinterpret_tensor(buf137, (1, 32, 128, 8, 16), (524288, 16384, 128, 16, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4, mul_4, x_mid_5], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_20.run(buf150, buf147, buf148, arg81_1, buf149, arg75_1, 524288, grid=grid(524288), stream=stream0)
        del arg75_1
        del arg81_1
        del buf148
        del buf149
        buf151 = reinterpret_tensor(buf147, (4096, 128), (128, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf150, (4096, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 128), (1, 128), 0), out=buf151)
        del arg82_1
        buf155 = reinterpret_tensor(buf150, (1, 4096, 128), (524288, 128, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf69, buf151, arg83_1, arg84_1, arg85_1, buf155, 4096, 128, grid=grid(4096), stream=stream0)
        del arg84_1
        del arg85_1
        buf156 = reinterpret_tensor(buf128, (4096, 512), (512, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf155, (4096, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 512), (1, 128), 0), out=buf156)
        del arg86_1
        buf157 = reinterpret_tensor(buf156, (1, 4096, 512), (2097152, 512, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf157, arg87_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg87_1
        buf158 = reinterpret_tensor(buf155, (4096, 128), (128, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf157, (4096, 512), (512, 1), 0), reinterpret_tensor(arg88_1, (512, 128), (1, 512), 0), out=buf158)
        del arg88_1
        del buf157
        buf159 = reinterpret_tensor(buf158, (1, 4096, 128), (524288, 128, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf159, buf69, buf151, arg83_1, arg89_1, 524288, grid=grid(524288), stream=stream0)
        del arg83_1
        del arg89_1
        buf160 = buf109; del buf109  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf160, 1785856, grid=grid(1785856), stream=stream0)
        buf162 = buf107; del buf107  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf162, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_37, index_add__6, col_sum_2, getitem_38, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_43.run(buf64, buf70, buf159, buf73, buf160, buf162, 2916352, grid=grid(2916352), stream=stream0)
        buf165 = reinterpret_tensor(buf103, (6976, 512), (512, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf164, (6976, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 512), (1, 128), 0), out=buf165)
        del arg68_1
        buf166 = reinterpret_tensor(buf165, (109, 64, 512), (32768, 512, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_44.run(buf166, arg69_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg69_1
        buf167 = reinterpret_tensor(buf164, (6976, 128), (128, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf166, (6976, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 128), (1, 512), 0), out=buf167)
        del arg70_1
        buf168 = reinterpret_tensor(buf167, (109, 64, 128), (8192, 128, 1), 0); del buf167  # reuse
        buf172 = buf80; del buf80  # reuse
        # Topologically Sorted Source Nodes: [x_2, h_off_5, x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_45.run(buf168, buf160, arg35_1, buf162, buf76, buf115, arg65_1, arg71_1, arg90_1, arg91_1, buf172, 6976, 128, grid=grid(6976), stream=stream0)
        del arg35_1
        del arg65_1
        del arg71_1
        del arg90_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (6976, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf173)
        buf175 = buf88; del buf88  # reuse
        ...
        buf177 = reinterpret_tensor(buf162, (109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), 0); del buf162  # reuse
        ...
        buf181 = reinterpret_tensor(buf76, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf76  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf173, arg93_1, buf181, 892928, grid=grid(892928), stream=stream0)
        buf182 = reinterpret_tensor(buf115, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf173, arg93_1, buf182, 892928, grid=grid(892928), stream=stream0)
        buf183 = reinterpret_tensor(buf104, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf104  # reuse
        buf195 = reinterpret_tensor(buf91, (109, 8, 64, 1, 16, 1), (8192, 1024, 16, 16, 1, 1), 0); del buf91  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_35.run(buf173, arg93_1, buf183, buf195, 892928, grid=grid(892928), stream=stream0)
        del buf173
        buf190 = reinterpret_tensor(buf160, (109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg95_1
        buf193 = reinterpret_tensor(buf166, (446464, 8), (8, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        buf186 = buf185[0]
        del buf185
        buf196 = reinterpret_tensor(buf183, (872, 64, 16), (1024, 16, 1), 0); del buf183  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf194, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf195, (872, 64, 16), (1024, 16, 1), 0), out=buf196)
        del buf195
        buf197 = buf106; del buf106  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (6976, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 8), (1, 128), 0), out=buf197)
        del arg98_1
        del buf172
        buf198 = buf113; del buf113  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (109, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf198)
        del arg92_1
        del buf112
        buf199 = reinterpret_tensor(buf186, (109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), 0); del buf186  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6, mul_5, x_mid_7], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_40.run(buf199, buf196, buf197, arg99_1, buf198, arg93_1, 892928, grid=grid(892928), stream=stream0)
        del arg93_1
        del arg99_1
        del buf197
        del buf198
        buf200 = reinterpret_tensor(buf196, (6976, 128), (128, 1), 0); del buf196  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf199, (6976, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 128), (1, 128), 0), out=buf200)
        del arg100_1
        buf206 = reinterpret_tensor(buf199, (109, 64, 128), (8192, 128, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf168, buf200, arg101_1, arg102_1, arg103_1, buf206, 6976, 128, grid=grid(6976), stream=stream0)
        del arg102_1
        del arg103_1
        buf204 = reinterpret_tensor(buf69, (4096, 128), (128, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf159, (4096, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf204)
        del arg108_1
        del arg109_1
        buf205 = reinterpret_tensor(buf151, (32, 128, 128), (16384, 128, 1), 0); del buf151  # reuse
        ...
        del buf204
        buf207 = reinterpret_tensor(buf194, (6976, 512), (512, 1), 0); del buf194  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf206, (6976, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 512), (1, 128), 0), out=buf207)
        del arg104_1
        buf208 = reinterpret_tensor(buf207, (109, 64, 512), (32768, 512, 1), 0); del buf207  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_44.run(buf208, arg105_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg105_1
        buf209 = reinterpret_tensor(buf206, (6976, 128), (128, 1), 0); del buf206  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf208, (6976, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 128), (1, 512), 0), out=buf209)
        del arg106_1
        del buf208
        buf210 = reinterpret_tensor(buf209, (109, 64, 128), (8192, 128, 1), 0); del buf209  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_46.run(buf210, buf168, buf200, arg101_1, arg107_1, 892928, grid=grid(892928), stream=stream0)
        del arg101_1
        del arg107_1
        del buf168
        del buf200
        buf211 = reinterpret_tensor(buf179, (6976, 64), (64, 1), 0); del buf179  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf210, (6976, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf211)
        del arg110_1
        del arg111_1
        buf212 = reinterpret_tensor(buf175, (6976, 64), (64, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg113_1, reinterpret_tensor(buf210, (6976, 128), (128, 1), 0), reinterpret_tensor(arg112_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf212)
        del arg112_1
        del arg113_1
        del buf210
        buf213 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        ...
        del buf211
        del buf212
        buf214 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf159, (4096, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf214)
        del arg116_1
        del arg117_1
        buf215 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf159, (4096, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf215)
        del arg118_1
        del arg119_1
        buf216 = reinterpret_tensor(buf57, (4096, 1), (1, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (4096, 128), (128, 1), 0), reinterpret_tensor(arg114_1, (128, 1), (1, 128), 0), out=buf216)
        del arg114_1
        del buf159
        buf217 = reinterpret_tensor(buf216, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf216  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_47.run(buf217, arg115_1, 4096, grid=grid(4096), stream=stream0)
        del arg115_1
        buf218 = empty_strided_cuda((1, 1499136), (1499136, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_48.run(buf205, buf213, buf214, buf215, buf217, buf218, 1499136, grid=grid(1499136), stream=stream0)
        del buf205
        del buf213
        del buf214
        del buf215
