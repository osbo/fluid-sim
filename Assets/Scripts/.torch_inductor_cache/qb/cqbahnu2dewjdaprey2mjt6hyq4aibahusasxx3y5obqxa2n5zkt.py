...
# Graph fragment:
#   %index : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_17, [None, %arg6_1]), kwargs = {})
#   %index_put : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%view_4, [None, %arg4_1], %index, True), kwargs = {})
#   %index_1 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_18, [None, %arg6_1]), kwargs = {})
#   %index_put_1 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%view_20, [None, %arg5_1], %index_1, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf2 = empty_strided_cuda((996, 256), (256, 1), torch.float32)
        buf2.copy_(arg3_1)
        del arg3_1
        buf3 = empty_strided_cuda((1, 996, 32), (31872, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_col_strips], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf2, (1, 996, 256), (254976, 256, 1), 0), reinterpret_tensor(buf0, (1, 256, 32), (0, 32, 1), 0), out=buf3)
        buf4 = empty_strided_cuda((996, 32, 1), (32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [y_r], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg1_1, (996, 32, 32), (1024, 32, 1), 262144), reinterpret_tensor(buf3, (996, 32, 1), (32, 1, 1), 0), out=buf4)
        buf6 = buf2; del buf2  # reuse
        buf6.copy_(arg2_1)
        del arg2_1
        buf7 = buf3; del buf3  # reuse
        # Topologically Sorted Source Nodes: [x_row_strips], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf6, (1, 996, 256), (254976, 256, 1), 0), reinterpret_tensor(buf0, (1, 256, 32), (0, 32, 1), 0), out=buf7)
        del buf6
        buf8 = empty_strided_cuda((996, 32, 1), (32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [y_c], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg1_1, (996, 32, 32), (1024, 1, 32), 262144), reinterpret_tensor(buf7, (996, 32, 1), (32, 1, 1), 0), out=buf8)
        del buf7
        # Topologically Sorted Source Nodes: [getitem_2, index_add_, getitem_3, index_add__1], Original ATen: [aten.index, aten.index_add]
        triton_poi_fused_index_index_add_1.run(arg4_1, arg6_1, buf4, arg5_1, buf8, buf1, 81984, grid=grid(81984), stream=stream0)
        del arg4_1
        del arg5_1
        del arg6_1
        del buf4
        ...
        # Topologically Sorted Source Nodes: [mul_1, y_1], Original ATen: [aten.mul, aten.add]
        triton_poi_fused_add_mul_2.run(buf10, buf1, arg1_1, arg7_1, 8192, grid=grid(8192), stream=stream0)
        del arg1_1
        del arg7_1
        del buf1
    return (reinterpret_tensor(buf10, (7520, 1), (1, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg4_1 = rand_strided((2562, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg5_1 = rand_strided((2562, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg6_1 = rand_strided((2562, ), (1, ), device='cuda:0', dtype=torch.int64)
