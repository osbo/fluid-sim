...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/cp/ccpp25vq72etqqll6oigz3z6hrnaa2ir6wg26g5x6kbwsm6v5xj7.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_25.run(arg30_1, buf71, buf125, 2057088, grid=grid(2057088), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        ...
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_29.run(arg31_1, buf70, buf73, buf71, buf76, 124672, 33, grid=grid(124672), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf80, buf77, arg31_1, buf79, arg57_1, 3896, 1056, grid=grid(3896, 1056), stream=stream0)
        del arg57_1
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_29.run(arg31_1, buf124, buf127, buf125, buf130, 124672, 33, grid=grid(124672), stream=stream0)
        ...
        triton_poi_fused_clone_32.run(buf134, buf131, arg31_1, buf133, arg65_1, 3896, 1056, grid=grid(3896, 1056), stream=stream0)
        del arg31_1
        del arg65_1
        del buf131
        del buf133
        ...
        del arg72_1
        del buf112
        buf144 = reinterpret_tensor(buf143, (1, 128, 32, 1), (4096, 32, 1, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_38.run(buf144, arg73_1, 4096, grid=grid(4096), stream=stream0)
        del arg73_1
        ...
        del buf114
        del buf142
    return (buf145, reinterpret_tensor(buf144, (1, 128, 32), (4096, 32, 1), 0), )
