...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6n/c6nhvlxcty3mgd3cotzuslyeoj44bzlckconwvdwocyrf7jarmv6.py
# Topologically Sorted Source Nodes: [diag_summary, off_summary, off_gathered, index_add__2], Original ATen: [aten.mean, aten.index, aten.index_add]
# Source node to ATen node mapping:
#   diag_summary => mean_5
...
#   %index_put_6 : [num_users=2] = call_function[target=torch.ops.aten.index_put.default](args = (%mean_5, [None, %device_put], %index_2, True), kwargs = {})
triton_red_fused_index_index_add_mean_35 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32', 4: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused_index_index_add_mean_35', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6s/c6sx5lhad5fb75drc2n3orcrnnjrlzfqbplfhtxbh5sp367kdubk.py
# Topologically Sorted Source Nodes: [off_summary], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   off_summary => mean_6
# Graph fragment:
#   %mean_6 : [num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%view_92, [2]), kwargs = {})
triton_per_fused_mean_38 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_mean_38', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xs/cxspeei3ys4fr2clwrjnddkthmj6iuzpdewqpvrjtectxaawpycl.py
# Topologically Sorted Source Nodes: [diag_summary, off_summary, off_gathered, index_add__2, index_add__3], Original ATen: [aten.mean, aten.index, aten.index_add]
# Source node to ATen node mapping:
#   diag_summary => mean_5
#   index_add__2 => index_put_6
...
#   %index_2 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%mean_6, [None, %device_put_2]), kwargs = {})
#   %index_put_6 : [num_users=2] = call_function[target=torch.ops.aten.index_put.default](args = (%mean_5, [None, %device_put], %index_2, True), kwargs = {})
#   %index_put_7 : [num_users=2] = call_function[target=torch.ops.aten.index_put_.default](args = (%mean_5, [None, %device_put_1], %index_2, True), kwargs = {})
triton_poi_fused_index_index_add_mean_39 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_index_add_mean_39', 'mutated_arg_names': ['out_ptr0', 'out_ptr1'], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7t/c7txo7gh6xy323tee3mloagqsfzsuzoddkdbanhqtnknnk7qfyjf.py
# Topologically Sorted Source Nodes: [h_d_out], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   h_d_out => add_28
# Graph fragment:
#   %add_28 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_91, %unsqueeze_38), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_40', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kf/ckfzr4n2ft5mbuaktdfxf4le36xe62ogkwmfxing4jbygd6iwale.py
# Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
# Source node to ATen node mapping:
#   u_leaf => addmm_23
# Graph fragment:
#   %addmm_23 : [num_users=1] = call_function[target=torch.ops.aten.addmm.default](args = (%arg68_1, %view_106, %permute_75), kwargs = {})
#   %mm_default : [num_users=1] = call_function[target=torch.ops.aten.mm.default](args = (%view_123, %permute_80), kwargs = {})
triton_poi_fused_addmm_41 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/34/c34mpgdyfbartulbx74yrka4sfx4yfjh3xwbnoylriz4c3kjwelu.py
# Topologically Sorted Source Nodes: [h_o_out], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   h_o_out => add_30
# Graph fragment:
#   %add_30 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_92, %unsqueeze_39), kwargs = {})
...
#   sigmoid => sigmoid
# Graph fragment:
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_124,), kwargs = {})
...
#   packed_1 => cat_4
# Graph fragment:
#   %cat_4 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_3, %view_125], 1), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_34.run(buf63, buf91, arg57_1, arg58_1, arg59_1, buf97, 3488, 64, grid=grid(3488), stream=stream0)
        del arg58_1
        del arg59_1
        buf104 = empty_strided_cuda((1, 32, 64), (2048, 64, 1), torch.float32)
        buf107 = empty_strided_cuda((1, 32, 64), (2048, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [diag_summary, off_summary, off_gathered, index_add__2], Original ATen: [aten.mean, aten.index, aten.index_add]
        triton_red_fused_index_index_add_mean_35.run(buf60, buf104, buf107, 2048, 128, grid=grid(2048), stream=stream0)
        buf96 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf96.copy_(arg64_1)
        del arg64_1
        ...
        del buf63
        del buf91
        buf102 = empty_strided_cuda((1, 109, 64), (6976, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [off_summary], Original ATen: [aten.mean]
        triton_per_fused_mean_38.run(buf101, buf102, 6976, 32, grid=grid(6976), stream=stream0)
        buf103 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf103.copy_(arg66_1)
        del arg66_1
        buf106 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf106.copy_(arg65_1)
        del arg65_1
        # Topologically Sorted Source Nodes: [diag_summary, off_summary, off_gathered, index_add__2, index_add__3], Original ATen: [aten.mean, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_mean_39.run(buf96, buf103, buf102, buf106, buf104, buf107, 11392, grid=grid(11392), stream=stream0)
        buf109 = reinterpret_tensor(buf60, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [h_d_out], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf109, buf104, buf107, 262144, grid=grid(262144), stream=stream0)
        buf110 = buf52; del buf52  # reuse
        buf121 = buf25; del buf25  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        triton_poi_fused_addmm_41.run(buf109, buf110, buf121, 262144, grid=grid(262144), stream=stream0)
        buf111 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg68_1, buf110, reinterpret_tensor(arg67_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf111)
        del arg67_1
        del arg68_1
        del buf110
        ...
        # Topologically Sorted Source Nodes: [off_row_update], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), buf104, out=buf113)
        del arg30_1
        del buf104
        buf114 = empty_strided_cuda((1, 109, 64), (6976, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [off_col_update], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), buf107, out=buf114)
        del arg31_1
        del buf107
        buf115 = reinterpret_tensor(buf101, (1, 109, 32, 64), (223232, 2048, 64, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [h_o_out], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf115, buf113, buf114, 223232, grid=grid(223232), stream=stream0)
        del buf113
        del buf114
        ...
        extern_kernels.addmm(arg70_1, reinterpret_tensor(buf115, (3488, 64), (64, 1), 0), reinterpret_tensor(arg69_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf116)
        del arg69_1
        del arg70_1
        buf117 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg72_1, reinterpret_tensor(buf115, (3488, 64), (64, 1), 0), reinterpret_tensor(arg71_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf117)
        del arg71_1
        del arg72_1
        del buf115
        buf118 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf116, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf117, (109, 32, 32), (1024, 1, 32), 0), out=buf118)
        del buf116
        del buf117
        buf119 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg76_1, reinterpret_tensor(buf109, (4096, 64), (64, 1), 0), reinterpret_tensor(arg75_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf119)
        del arg75_1
        del arg76_1
        buf120 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg78_1, reinterpret_tensor(buf109, (4096, 64), (64, 1), 0), reinterpret_tensor(arg77_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf120)
        del arg77_1
        del arg78_1
        del buf109
        buf122 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf121, reinterpret_tensor(arg73_1, (64, 1), (1, 64), 0), out=buf122)
        del arg73_1
        del buf121
        buf123 = reinterpret_tensor(buf122, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_43.run(buf123, arg74_1, 4096, grid=grid(4096), stream=stream0)
        del arg74_1
        buf124 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf112, buf118, buf119, buf120, buf123, buf124, 902144, grid=grid(902144), stream=stream0)
        del buf112
        del buf118
        del buf119
        del buf120
    return (buf124, reinterpret_tensor(buf123, (1, 32, 128), (4096, 128, 1), 0), buf96, buf106, buf103, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg69_1 = rand_strided((32, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    arg70_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg71_1 = rand_strided((32, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg75_1 = rand_strided((32, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    arg76_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg77_1 = rand_strided((32, 64), (64, 1), device='cuda:0', dtype=torch.float32)
