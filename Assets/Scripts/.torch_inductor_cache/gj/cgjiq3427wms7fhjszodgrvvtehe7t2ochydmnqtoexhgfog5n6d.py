...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gq/cgqc3bkbjadroibaz3fh7kvdutw4vii2yj26waw3vifyodbyt3ce.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tl.store(out_ptr3 + (r1 + (512*x2) + (33280*x3)), tmp37, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6h/c6h2uhp6tutd4nqnxtcjdeasu64wwyvcu7s334yvpmy6z6oyo7m7.py
...
def triton_(in_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp5 = 64.0
    tmp6 = tmp4 / tmp5
    tl.store(out_ptr1 + (x0 + (33280*x1)), tmp6, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/yd/cydwwazxhv6yop3qvl4n6rdo3nzz7wdzkngy7urwilocwuvvnhnq.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7i/c7iqozgug2omgto5i2b7fx5dtdze4prijqfhrhnwn77tbra2qgkg.py
# Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum_4 => clone_17
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/77/c77b4yx2ucnxrf3wabankktqatfdk5gu75n2kvapz77ht3i5tc6d.py
...
#   %select_scatter_default_4 : [num_users=4] = call_function[target=torch.ops.aten.select_scatter.default](args = (%expand_5, %copy_4, 3, 64), kwargs = {})
...
#   %select_scatter_default_6 : [num_users=1] = call_function[target=torch.ops.aten.select_scatter.default](args = (%select_scatter_default_4, %select_scatter_default_5, 3, 64), kwargs = {})
...
#   %select_scatter_default_12 : [num_users=4] = call_function[target=torch.ops.aten.select_scatter.default](args = (%expand_6, %copy_6, 3, 64), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gt/cgtjdujyzwbulbnkk3xlxgdzt33zwi6y4mnl5itffbaa6inywhqc.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/oc/cocz6fz7yu6vfvmz5o6ib4yw7vuobkwe3jnoc26svdh4g6p3ucje.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/as/casz5edwanoheqf2mnimf66wdewn72bknevvrpgti4v7xnpjp6mg.py
# Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_11 => full_default_17, index_put_7
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/uz/cuzac2ha7fgotpq3poteamrqtuctmah5lpdhcyauncmj2dk6brjc.py
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_add_eq_masked_fill_mul_29', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 8, 'num_reduction': 2, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 3072
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ql/cqlvzj63czzc6367jyledhjnjkkp2vvoz2t6wo6ysdlrmilwpzr6.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hu/chuin24mt7rm5vblvsrqk2uorlwp5aupdnfkywy3ybtk74qzjyjc.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/bc/cbcu2jwkjx3kfgzdonjdvs2rxyl7k67bwkqwhjlkas7vonj57zej.py
# Topologically Sorted Source Nodes: [x_out_6], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_6 => clone_21
# Graph fragment:
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 33280)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (1024 + x0 + (64*x2) + (1536*x1) + (99840*x3)), xmask)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ip/cipfxizdpfikkgbbtxqy2gaqkenmrydelnzvb3o3rd2ptabdcrvk.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/lp/clpfw5h3i3rqfxnnmn5tcdaf2ou3xj2rktmrpxq2l2xe6wktnnpw.py
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tl.store(out_ptr3 + (r1 + (512*x2) + (33280*x3)), tmp41, None)
''', device_str='cuda')
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hv/chv4teyf3jencqilpmkcnl6kjhmkvlgad4vwkrs4khrped5w6mjm.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/v5/cv53y2ycxy3bimbrnpfipbsdhszre54nykifj6lensrlasztk2iy.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp15 = tmp0 >= tmp3
    tmp16 = tl.full([1], 41216, tl.int64)
    tmp17 = tmp0 < tmp16
    tmp18 = tl.load(in_ptr2 + ((-40960) + x0), tmp15 & xmask, eviction_policy='evict_last', other=0.0)
...
def call(args):
    ...
    assert_size_stride(arg66_1, (64, 512), (512, 1))
    assert_size_stride(arg67_1, (64, ), (1, ))
    assert_size_stride(arg68_1, (64, 512), (512, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf98 = empty_strided_cuda((1, 4, 64, 65, 4), (66560, 16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem, setitem_1, setitem_4, setitem_5], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_10.run(arg29_1, buf39, buf98, 66560, grid=grid(66560), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem, setitem_1, setitem_2], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        ...
        buf93 = reinterpret_tensor(buf49, (1, 4, 65, 512), (133120, 33280, 512, 1), 0); del buf49  # reuse
        buf91 = reinterpret_tensor(buf93, (1, 4, 64, 512), (133120, 33280, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x, layer_norm_2, kv_1], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        ...
        buf60 = empty_strided_cuda((1, 384, 512), (196608, 512, 1), torch.float32)
        buf65 = empty_strided_cuda((1, 6, 65, 512), (199680, 33280, 512, 1), torch.float32)
        buf63 = reinterpret_tensor(buf65, (1, 6, 64, 512), (199680, 33280, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_3, kv_2], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_21.run(buf56, buf25, arg50_1, arg51_1, buf60, buf63, 384, 512, grid=grid(384), stream=stream0)
        del arg50_1
        del arg51_1
        buf61 = empty_strided_cuda((384, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (384, 512), (512, 1), 0), reinterpret_tensor(arg52_1, (512, 1536), (1, 512), 0), out=buf61)
        buf64 = reinterpret_tensor(buf65, (1, 6, 1, 512), (199680, 33280, 512, 1), 32768)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_22.run(buf60, buf64, 3072, 64, grid=grid(3072), stream=stream0)
        del buf63
        del buf64
        buf66 = empty_strided_cuda((390, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf65, (390, 512), (512, 1), 0), reinterpret_tensor(arg52_1, (512, 1536), (1, 512), 0), out=buf66)
        del arg52_1
        buf67 = reinterpret_tensor(buf60, (6, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_23.run(buf61, arg53_1, buf67, 196608, grid=grid(196608), stream=stream0)
        buf68 = reinterpret_tensor(buf65, (6, 8, 64, 1, 65, 1), (33280, 4160, 65, 65, 1, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_24.run(buf66, arg53_1, buf68, 3072, 65, grid=grid(3072, 65), stream=stream0)
        buf69 = empty_strided_cuda((48, 64, 65), (4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf67, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf68, (48, 64, 65), (4160, 65, 1), 0), out=buf69)
        buf70 = empty_strided_cuda((1, 6, 64, 65, 4), (99840, 16640, 260, 4, 1), torch.float32)
        buf125 = empty_strided_cuda((1, 6, 64, 65, 4), (99840, 16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_25.run(arg31_1, buf70, buf125, 99840, grid=grid(99840), stream=stream0)
        del arg31_1
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_26.run(buf70, 1536, grid=grid(1536), stream=stream0)
        buf72 = empty_strided_cuda((1, 6, 64, 65), (24960, 4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf70, buf72, 24960, grid=grid(24960), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf72, 384, grid=grid(384), stream=stream0)
        buf75 = reinterpret_tensor(buf68, (1, 6, 64, 65, 8), (199680, 33280, 65, 1, 4160), 0); del buf68  # reuse
        buf76 = empty_strided_cuda((1, 6, 64, 1, 8), (3072, 512, 1, 3072, 64), torch.float32)
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_red_fused__softmax_add_eq_masked_fill_mul_29.run(arg30_1, buf69, buf72, buf70, buf75, buf76, 3072, 65, grid=grid(3072), stream=stream0)
        buf77 = empty_strided_cuda((1, 6, 64, 65, 4), (99840, 16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_30.run(buf72, buf70, buf77, 99840, grid=grid(99840), stream=stream0)
        del buf70
        buf78 = reinterpret_tensor(buf69, (24960, 8), (8, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf77, (24960, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 8), (1, 4), 0), out=buf78)
        del arg54_1
        buf79 = reinterpret_tensor(buf75, (6, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [x_out_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(buf79, buf76, arg30_1, buf78, arg55_1, 48, 4160, grid=grid(48, 4160), stream=stream0)
        del arg55_1
        buf80 = reinterpret_tensor(buf78, (6, 8, 65, 1, 64, 1), (33280, 4160, 64, 64, 1, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [x_out_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf66, arg53_1, buf80, 199680, grid=grid(199680), stream=stream0)
        del arg53_1
        buf81 = reinterpret_tensor(buf67, (48, 64, 64), (4096, 64, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [x_out_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf79, (48, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf80, (48, 65, 64), (4160, 64, 1), 0), out=buf81)
        buf82 = empty_strided_cuda((1, 6, 64, 8, 64), (196608, 32768, 512, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_7], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf81, buf82, 196608, grid=grid(196608), stream=stream0)
        buf83 = reinterpret_tensor(buf81, (384, 512), (512, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf82, (384, 512), (512, 1), 0), reinterpret_tensor(arg56_1, (512, 512), (1, 512), 0), out=buf83)
        del arg56_1
        buf84 = reinterpret_tensor(buf83, (1, 384, 512), (196608, 512, 1), 0); del buf83  # reuse
        buf115 = reinterpret_tensor(buf82, (1, 384, 512), (196608, 512, 1), 0); del buf82  # reuse
        buf120 = reinterpret_tensor(buf80, (1, 6, 65, 512), (199680, 33280, 512, 1), 0); del buf80  # reuse
        buf118 = reinterpret_tensor(buf120, (1, 6, 64, 512), (199680, 33280, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_34.run(buf84, buf56, buf25, arg57_1, arg58_1, arg59_1, buf115, buf118, 384, 512, grid=grid(384), stream=stream0)
        del arg57_1
        del arg58_1
        del arg59_1
        del buf56
        ...
        buf92 = reinterpret_tensor(buf93, (1, 4, 1, 512), (133120, 33280, 512, 1), 32768)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_per_fused_mean_7.run(buf88, buf92, 2048, 64, grid=grid(2048), stream=stream0)
        del buf91
        del buf92
        buf94 = buf35; del buf35  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf93, (260, 512), (512, 1), 0), reinterpret_tensor(arg42_1, (512, 1536), (1, 512), 0), out=buf94)
        del arg42_1
        buf95 = reinterpret_tensor(buf88, (4, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), 0); del buf88  # reuse
        ...
        del buf89
        buf96 = reinterpret_tensor(buf93, (4, 8, 64, 1, 65, 1), (33280, 4160, 65, 65, 1, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf94, arg43_1, buf96, 2048, 65, grid=grid(2048, 65), stream=stream0)
        buf97 = reinterpret_tensor(buf48, (32, 64, 65), (4160, 65, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf95, (32, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf96, (32, 64, 65), (4160, 65, 1), 0), out=buf97)
        ...
        triton_poi_fused_index_put_lift_fresh_12.run(buf98, buf100, 16640, grid=grid(16640), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf100, 256, grid=grid(256), stream=stream0)
        buf103 = reinterpret_tensor(buf96, (1, 4, 64, 65, 8), (133120, 33280, 65, 1, 4160), 0); del buf96  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_14.run(arg28_1, buf97, buf100, buf98, buf103, buf104, 2048, 65, grid=grid(2048), stream=stream0)
        buf105 = buf46; del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf100, buf98, buf105, 66560, grid=grid(66560), stream=stream0)
        del buf100
        del buf98
        buf106 = reinterpret_tensor(buf97, (16640, 8), (8, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf105, (16640, 4), (4, 1), 0), reinterpret_tensor(arg44_1, (4, 8), (1, 4), 0), out=buf106)
        del arg44_1
        del buf105
        buf107 = reinterpret_tensor(buf103, (4, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [x_out_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_16.run(buf107, buf104, arg28_1, buf106, arg45_1, 32, 4160, grid=grid(32, 4160), stream=stream0)
        del arg28_1
        del arg45_1
        del buf104
        buf108 = reinterpret_tensor(buf106, (4, 8, 65, 1, 64, 1), (33280, 4160, 64, 64, 1, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [x_out_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf94, arg43_1, buf108, 133120, grid=grid(133120), stream=stream0)
        del arg43_1
        del buf94
        buf109 = reinterpret_tensor(buf95, (32, 64, 64), (4096, 64, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf107, (32, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf108, (32, 65, 64), (4160, 64, 1), 0), out=buf109)
        del buf107
        del buf108
        buf110 = empty_strided_cuda((1, 4, 64, 8, 64), (131072, 32768, 512, 64, 1), torch.float32)
        ...
        del buf25
        del buf52
        buf113 = empty_strided_cuda((256, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg49_1, reinterpret_tensor(buf112, (256, 512), (512, 1), 0), reinterpret_tensor(arg48_1, (512, 64), (1, 512), 0), alpha=1, beta=1, out=buf113)
        del arg48_1
        del arg49_1
        buf114 = empty_strided_cuda((4, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [diag_blocks], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf113, (4, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf113, (4, 64, 64), (4096, 1, 64), 0), out=buf114)
        del buf113
        buf116 = buf61; del buf61  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (384, 512), (512, 1), 0), reinterpret_tensor(arg60_1, (512, 1536), (1, 512), 0), out=buf116)
        buf119 = reinterpret_tensor(buf120, (1, 6, 1, 512), (199680, 33280, 512, 1), 32768)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_22.run(buf115, buf119, 3072, 64, grid=grid(3072), stream=stream0)
        del buf118
        del buf119
        buf121 = buf66; del buf66  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (390, 512), (512, 1), 0), reinterpret_tensor(arg60_1, (512, 1536), (1, 512), 0), out=buf121)
        del arg60_1
        buf122 = reinterpret_tensor(buf115, (6, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_23.run(buf116, arg61_1, buf122, 196608, grid=grid(196608), stream=stream0)
        del buf116
        buf123 = reinterpret_tensor(buf120, (6, 8, 64, 1, 65, 1), (33280, 4160, 65, 65, 1, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_24.run(buf121, arg61_1, buf123, 3072, 65, grid=grid(3072, 65), stream=stream0)
        buf124 = reinterpret_tensor(buf79, (48, 64, 65), (4160, 65, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf122, (48, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf123, (48, 64, 65), (4160, 65, 1), 0), out=buf124)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_26.run(buf125, 1536, grid=grid(1536), stream=stream0)
        buf127 = buf72; del buf72  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf125, buf127, 24960, grid=grid(24960), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf127, 384, grid=grid(384), stream=stream0)
        buf130 = reinterpret_tensor(buf123, (1, 6, 64, 65, 8), (199680, 33280, 65, 1, 4160), 0); del buf123  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_29.run(arg30_1, buf124, buf127, buf125, buf130, buf131, 3072, 65, grid=grid(3072), stream=stream0)
        buf132 = buf77; del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_30.run(buf127, buf125, buf132, 99840, grid=grid(99840), stream=stream0)
        del buf125
        del buf127
        buf133 = reinterpret_tensor(buf124, (24960, 8), (8, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf132, (24960, 4), (4, 1), 0), reinterpret_tensor(arg62_1, (4, 8), (1, 4), 0), out=buf133)
        del arg62_1
        del buf132
        buf134 = reinterpret_tensor(buf130, (6, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(buf134, buf131, arg30_1, buf133, arg63_1, 48, 4160, grid=grid(48, 4160), stream=stream0)
        del arg30_1
        del arg63_1
        del buf131
        buf135 = reinterpret_tensor(buf133, (6, 8, 65, 1, 64, 1), (33280, 4160, 64, 64, 1, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf121, arg61_1, buf135, 199680, grid=grid(199680), stream=stream0)
        del arg61_1
        del buf121
        buf136 = reinterpret_tensor(buf122, (48, 64, 64), (4096, 64, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf134, (48, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf135, (48, 65, 64), (4160, 64, 1), 0), out=buf136)
        del buf134
        del buf135
        buf137 = empty_strided_cuda((1, 6, 64, 8, 64), (196608, 32768, 512, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf136, buf137, 196608, grid=grid(196608), stream=stream0)
        buf138 = reinterpret_tensor(buf136, (384, 512), (512, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf137, (384, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 512), (1, 512), 0), out=buf138)
        del arg64_1
        del buf137
        buf139 = reinterpret_tensor(buf138, (1, 384, 512), (196608, 512, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [x_3], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf139, buf84, arg65_1, 196608, grid=grid(196608), stream=stream0)
        del arg65_1
        del buf84
        buf140 = empty_strided_cuda((384, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf139, (384, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 64), (1, 512), 0), alpha=1, beta=1, out=buf140)
        del arg66_1
        del arg67_1
        buf141 = empty_strided_cuda((384, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf139, (384, 512), (512, 1), 0), reinterpret_tensor(arg68_1, (512, 64), (1, 512), 0), alpha=1, beta=1, out=buf141)
        del arg68_1
        del arg69_1
        del buf139
        buf142 = empty_strided_cuda((6, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [off_diag_blocks], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf140, (6, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf141, (6, 64, 64), (4096, 1, 64), 0), out=buf142)
        del buf140
        del buf141
        ...
        del arg70_1
        del buf112
        buf144 = reinterpret_tensor(buf143, (1, 4, 64), (256, 64, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [j_gate], Original ATen: [aten.mul]
        triton_poi_fused_mul_37.run(buf144, arg71_1, 256, grid=grid(256), stream=stream0)
        del arg71_1
        buf145 = empty_strided_cuda((1, 41216), (41216, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_38.run(buf114, buf142, buf144, buf145, 41216, grid=grid(41216), stream=stream0)
        del buf114
        del buf142
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg66_1 = rand_strided((64, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    arg67_1 = rand_strided((64, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg68_1 = rand_strided((64, 512), (512, 1), device='cuda:0', dtype=torch.float32)
