...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg42_1
        buf101 = reinterpret_tensor(buf52, (1, 528, 128), (67584, 128, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_21.run(buf29, buf53, arg43_1, arg44_1, arg45_1, buf101, 528, 128, grid=grid(528), stream=stream0)
        del arg44_1
        del arg45_1
        buf57 = empty_strided_cuda((66, ), (1, ), torch.int64)
        buf57.copy_(arg34_1)
        del arg34_1
        buf58 = empty_strided_cuda((66, ), (1, ), torch.int64)
        buf58.copy_(arg32_1)
        del arg32_1
        ...
        buf61.copy_(arg33_1)
        del arg33_1
        buf62 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_22.run(buf62, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum, getitem_12, index_add__2, col_sum, getitem_13, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_23.run(buf57, buf58, buf25, buf61, buf59, buf62, 270336, grid=grid(270336), stream=stream0)
        buf64 = empty_strided_cuda((48, 16, 128), (2048, 128, 1), torch.float32)
        buf68 = empty_strided_cuda((1, 48, 17, 128), (104448, 2176, 128, 1), torch.float32)
        buf66 = reinterpret_tensor(buf68, (1, 48, 16, 128), (104448, 2176, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [h_off_base_1, cat_6], Original ATen: [aten.mean, aten.cat]
        triton_poi_fused_cat_mean_24.run(buf59, arg35_1, buf62, buf64, buf66, 98304, grid=grid(98304), stream=stream0)
        del arg35_1
        buf67 = reinterpret_tensor(buf68, (1, 48, 1, 128), (104448, 2176, 128, 1), 2048)  # alias
        # Topologically Sorted Source Nodes: [bn_off], Original ATen: [aten.mean]
        triton_per_fused_mean_25.run(buf64, buf67, 6144, 16, grid=grid(6144), stream=stream0)
        del buf64
        buf69 = empty_strided_cuda((48, 17, 1), (17, 1, 816), torch.float32)
        buf70 = empty_strided_cuda((48, 17, 1), (17, 1, 816), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_26.run(buf68, buf69, buf70, 816, 128, grid=grid(816), stream=stream0)
        del buf66
        del buf67
        buf72 = empty_strided_cuda((48, 16, 17, 4), (1088, 68, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_27.run(arg30_1, buf72, 52224, grid=grid(52224), stream=stream0)
        del arg30_1
        buf73 = empty_strided_cuda((48, 16, 17), (272, 17, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.cat]
        triton_poi_fused_cat_28.run(arg31_1, buf73, 13056, grid=grid(13056), stream=stream0)
        del arg31_1
        buf74 = reinterpret_tensor(buf62, (48, 32, 128), (4096, 128, 1), 0); del buf62  # reuse
        buf79 = empty_strided_cuda((48, 2, 17, 128), (4352, 2176, 128, 1), torch.float32)
        buf77 = reinterpret_tensor(buf79, (48, 2, 16, 128), (4352, 2176, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_3, x_2, kv_1], Original ATen: [aten.native_layer_norm, aten.constant_pad_nd, aten.cat]
        triton_poi_fused_cat_constant_pad_nd_native_layer_norm_29.run(buf68, buf69, buf70, arg50_1, arg51_1, buf74, buf77, 196608, grid=grid(196608), stream=stream0)
        del arg50_1
        del arg51_1
        buf75 = empty_strided_cuda((1536, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf74, (1536, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf75)
        buf78 = reinterpret_tensor(buf79, (48, 2, 1, 128), (4352, 2176, 128, 1), 2048)  # alias
        # Topologically Sorted Source Nodes: [block_node], Original ATen: [aten.mean]
        triton_per_fused_mean_30.run(buf74, buf78, 12288, 16, grid=grid(12288), stream=stream0)
        del buf77
        del buf78
        buf80 = empty_strided_cuda((1632, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf79, (1632, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf80)
        del arg52_1
        buf81 = reinterpret_tensor(buf74, (48, 2, 8, 16, 16, 1), (4096, 2048, 256, 16, 1, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(buf75, arg53_1, buf81, 196608, grid=grid(196608), stream=stream0)
        buf82 = reinterpret_tensor(buf79, (48, 2, 8, 16, 17, 1), (4352, 2176, 272, 17, 1, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf80, arg53_1, buf82, 12288, 17, grid=grid(12288, 17), stream=stream0)
        buf83 = empty_strided_cuda((768, 16, 17), (272, 17, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf81, (768, 16, 16), (256, 16, 1), 0), reinterpret_tensor(buf82, (768, 16, 17), (272, 17, 1), 0), out=buf83)
        buf84 = empty_strided_cuda((48, 1, 16, 17, 4), (1088, 52224, 68, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_2, setitem_3], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_33.run(buf72, buf84, 52224, grid=grid(52224), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_2, setitem_3, setitem_4], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_34.run(buf84, 3072, grid=grid(3072), stream=stream0)
        buf86 = empty_strided_cuda((48, 1, 16, 17), (272, 272, 17, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_35.run(buf84, buf86, 13056, grid=grid(13056), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_36.run(buf86, 768, grid=grid(768), stream=stream0)
        buf89 = reinterpret_tensor(buf82, (48, 2, 16, 17, 8), (4352, 2176, 17, 1, 272), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_37.run(buf73, buf83, buf86, buf84, buf89, 12288, 17, grid=grid(12288), stream=stream0)
        buf90 = empty_strided_cuda((48, 2, 16, 1, 8), (256, 128, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_38.run(buf89, buf90, 12288, 17, grid=grid(12288), stream=stream0)
        buf91 = empty_strided_cuda((48, 1, 16, 17, 4), (1088, 1, 68, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_39.run(buf86, buf84, buf91, 52224, grid=grid(52224), stream=stream0)
        del buf84
        buf92 = empty_strided_cuda((13056, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf91, (13056, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 8), (1, 4), 0), out=buf92)
        del arg54_1
        buf93 = reinterpret_tensor(buf89, (48, 2, 8, 16, 17, 1), (4352, 2176, 272, 17, 1, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf93, buf90, buf73, buf92, arg55_1, 768, 272, grid=grid(768, 272), stream=stream0)
        del arg55_1
        buf94 = reinterpret_tensor(buf83, (48, 2, 8, 17, 16, 1), (4352, 2176, 272, 16, 1, 1), 0); del buf83  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_41.run(buf80, arg53_1, buf94, 208896, grid=grid(208896), stream=stream0)
        del arg53_1
        buf95 = reinterpret_tensor(buf81, (768, 16, 16), (256, 16, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf93, (768, 16, 17), (272, 17, 1), 0), reinterpret_tensor(buf94, (768, 17, 16), (272, 16, 1), 0), out=buf95)
        buf96 = reinterpret_tensor(buf59, (48, 2, 16, 8, 16), (4096, 2048, 128, 16, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_42.run(buf95, buf96, 196608, grid=grid(196608), stream=stream0)
        buf97 = reinterpret_tensor(buf95, (1536, 128), (128, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (1536, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 128), (1, 128), 0), out=buf97)
        del arg56_1
        buf106 = reinterpret_tensor(buf92, (48, 17, 128), (2176, 128, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [x_3, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_43.run(buf68, buf97, arg57_1, arg58_1, arg59_1, buf106, 816, 128, grid=grid(816), stream=stream0)
        del arg58_1
        del arg59_1
        buf102 = empty_strided_cuda((528, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (528, 128), (128, 1), 0), reinterpret_tensor(arg46_1, (128, 512), (1, 128), 0), out=buf102)
        del arg46_1
        buf103 = reinterpret_tensor(buf102, (1, 528, 512), (270336, 512, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_44.run(buf103, arg47_1, 270336, grid=grid(270336), stream=stream0)
        del arg47_1
        buf104 = reinterpret_tensor(buf101, (528, 128), (128, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (528, 512), (512, 1), 0), reinterpret_tensor(arg48_1, (512, 128), (1, 512), 0), out=buf104)
        del arg48_1
        buf105 = reinterpret_tensor(buf104, (1, 528, 128), (67584, 128, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.add]
        triton_poi_fused_add_45.run(buf105, buf29, buf53, arg43_1, arg49_1, 67584, grid=grid(67584), stream=stream0)
        del arg43_1
        del arg49_1
        buf107 = empty_strided_cuda((816, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf106, (816, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf107)
        del arg60_1
        buf108 = reinterpret_tensor(buf107, (48, 17, 512), (8704, 512, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_46.run(buf108, arg61_1, 417792, grid=grid(417792), stream=stream0)
        del arg61_1
        buf109 = reinterpret_tensor(buf106, (816, 128), (128, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf108, (816, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf109)
        del arg62_1
        buf110 = reinterpret_tensor(buf109, (48, 17, 128), (2176, 128, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [x_3, x_4], Original ATen: [aten.add]
        triton_poi_fused_add_47.run(buf110, buf68, buf97, arg57_1, arg63_1, 104448, grid=grid(104448), stream=stream0)
        del arg57_1
        del arg63_1
        buf113 = empty_strided_cuda((1, 64, 128), (8192, 128, 1), torch.float32)
        buf111 = reinterpret_tensor(buf113, (1, 16, 128), (8192, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [V], Original ATen: [aten.cat]
        triton_poi_fused_cat_48.run(buf105, buf111, 2048, grid=grid(2048), stream=stream0)
        buf112 = reinterpret_tensor(buf113, (1, 48, 128), (8192, 128, 1), 2048)  # alias
        # Topologically Sorted Source Nodes: [V], Original ATen: [aten.cat]
        triton_poi_fused_cat_49.run(buf110, buf112, 6144, grid=grid(6144), stream=stream0)
        del buf111
        del buf112
        buf114 = empty_strided_cuda((1, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [msg], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 64, 64), (0, 64, 1), 0), buf113, out=buf114)
        buf115 = empty_strided_cuda((64, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (64, 128), (128, 1), 0), reinterpret_tensor(arg65_1, (128, 128), (1, 128), 0), out=buf115)
        del arg65_1
        buf116 = reinterpret_tensor(buf115, (1, 64, 128), (8192, 128, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_50.run(buf116, arg66_1, 8192, grid=grid(8192), stream=stream0)
        del arg66_1
        buf117 = reinterpret_tensor(buf114, (64, 128), (128, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (64, 128), (128, 1), 0), reinterpret_tensor(arg67_1, (128, 128), (1, 128), 0), out=buf117)
        del arg67_1
        buf118 = reinterpret_tensor(buf117, (1, 64, 128), (8192, 128, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [V_1], Original ATen: [aten.add]
        triton_poi_fused_add_51.run(buf118, buf113, arg68_1, 8192, grid=grid(8192), stream=stream0)
        del arg68_1
        buf119 = buf113; del buf113  # reuse
        # Topologically Sorted Source Nodes: [V_1, msg_1], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 64, 64), (0, 64, 1), 0), buf118, out=buf119)
        buf120 = reinterpret_tensor(buf116, (64, 128), (128, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (64, 128), (128, 1), 0), reinterpret_tensor(arg69_1, (128, 128), (1, 128), 0), out=buf120)
        del arg69_1
        buf121 = reinterpret_tensor(buf120, (1, 64, 128), (8192, 128, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_50.run(buf121, arg70_1, 8192, grid=grid(8192), stream=stream0)
        del arg70_1
        buf122 = reinterpret_tensor(buf119, (64, 128), (128, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (64, 128), (128, 1), 0), reinterpret_tensor(arg71_1, (128, 128), (1, 128), 0), out=buf122)
        del arg71_1
        buf123 = buf118; del buf118  # reuse
        # Topologically Sorted Source Nodes: [V_2], Original ATen: [aten.add]
        triton_poi_fused_add_52.run(buf123, buf122, arg72_1, 8192, grid=grid(8192), stream=stream0)
        del arg72_1
        buf124 = reinterpret_tensor(buf122, (1, 64, 128), (8192, 128, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [V_2, msg_2], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 64, 64), (0, 64, 1), 0), buf123, out=buf124)
        buf125 = reinterpret_tensor(buf121, (64, 128), (128, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (64, 128), (128, 1), 0), reinterpret_tensor(arg73_1, (128, 128), (1, 128), 0), out=buf125)
        del arg73_1
        buf126 = reinterpret_tensor(buf125, (1, 64, 128), (8192, 128, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_50.run(buf126, arg74_1, 8192, grid=grid(8192), stream=stream0)
        del arg74_1
        buf127 = reinterpret_tensor(buf124, (64, 128), (128, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (64, 128), (128, 1), 0), reinterpret_tensor(arg75_1, (128, 128), (1, 128), 0), out=buf127)
        del arg75_1
        buf128 = buf123; del buf123  # reuse
        # Topologically Sorted Source Nodes: [V_3], Original ATen: [aten.add]
        triton_poi_fused_add_52.run(buf128, buf127, arg76_1, 8192, grid=grid(8192), stream=stream0)
        del arg76_1
        buf129 = reinterpret_tensor(buf127, (1, 64, 128), (8192, 128, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [V_3, msg_3], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 64, 64), (0, 64, 1), 0), buf128, out=buf129)
        buf130 = reinterpret_tensor(buf126, (64, 128), (128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf129, (64, 128), (128, 1), 0), reinterpret_tensor(arg77_1, (128, 128), (1, 128), 0), out=buf130)
        del arg77_1
        buf131 = reinterpret_tensor(buf130, (1, 64, 128), (8192, 128, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_50.run(buf131, arg78_1, 8192, grid=grid(8192), stream=stream0)
        del arg78_1
        buf132 = reinterpret_tensor(buf129, (64, 128), (128, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf131, (64, 128), (128, 1), 0), reinterpret_tensor(arg79_1, (128, 128), (1, 128), 0), out=buf132)
        del arg79_1
        buf133 = buf128; del buf128  # reuse
        # Topologically Sorted Source Nodes: [V_4], Original ATen: [aten.add]
        triton_poi_fused_add_52.run(buf133, buf132, arg80_1, 8192, grid=grid(8192), stream=stream0)
        del arg80_1
        buf134 = reinterpret_tensor(buf132, (1, 64, 128), (8192, 128, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [V_4, msg_4], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 64, 64), (0, 64, 1), 0), buf133, out=buf134)
        buf135 = reinterpret_tensor(buf131, (64, 128), (128, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (64, 128), (128, 1), 0), reinterpret_tensor(arg81_1, (128, 128), (1, 128), 0), out=buf135)
        del arg81_1
        buf136 = reinterpret_tensor(buf135, (1, 64, 128), (8192, 128, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_50.run(buf136, arg82_1, 8192, grid=grid(8192), stream=stream0)
        del arg82_1
        buf137 = reinterpret_tensor(buf134, (64, 128), (128, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (64, 128), (128, 1), 0), reinterpret_tensor(arg83_1, (128, 128), (1, 128), 0), out=buf137)
        del arg83_1
        buf138 = buf133; del buf133  # reuse
        # Topologically Sorted Source Nodes: [V_5], Original ATen: [aten.add]
        triton_poi_fused_add_52.run(buf138, buf137, arg84_1, 8192, grid=grid(8192), stream=stream0)
        del arg84_1
        buf139 = reinterpret_tensor(buf137, (1, 64, 128), (8192, 128, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [V_5, msg_5], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 64, 64), (0, 64, 1), 0), buf138, out=buf139)
        buf140 = reinterpret_tensor(buf136, (64, 128), (128, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (64, 128), (128, 1), 0), reinterpret_tensor(arg85_1, (128, 128), (1, 128), 0), out=buf140)
        del arg85_1
        buf141 = reinterpret_tensor(buf140, (1, 64, 128), (8192, 128, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_50.run(buf141, arg86_1, 8192, grid=grid(8192), stream=stream0)
        del arg86_1
        buf142 = reinterpret_tensor(buf139, (64, 128), (128, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (64, 128), (128, 1), 0), reinterpret_tensor(arg87_1, (128, 128), (1, 128), 0), out=buf142)
        del arg87_1
        buf143 = buf138; del buf138  # reuse
        # Topologically Sorted Source Nodes: [V_6], Original ATen: [aten.add]
        triton_poi_fused_add_52.run(buf143, buf142, arg88_1, 8192, grid=grid(8192), stream=stream0)
        del arg88_1
        buf144 = reinterpret_tensor(buf142, (1, 64, 128), (8192, 128, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [V_6, msg_6], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 64, 64), (0, 64, 1), 0), buf143, out=buf144)
        buf145 = reinterpret_tensor(buf141, (64, 128), (128, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf144, (64, 128), (128, 1), 0), reinterpret_tensor(arg89_1, (128, 128), (1, 128), 0), out=buf145)
        del arg89_1
        buf146 = reinterpret_tensor(buf145, (1, 64, 128), (8192, 128, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [input_35], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_50.run(buf146, arg90_1, 8192, grid=grid(8192), stream=stream0)
        del arg90_1
        buf147 = reinterpret_tensor(buf144, (64, 128), (128, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf146, (64, 128), (128, 1), 0), reinterpret_tensor(arg91_1, (128, 128), (1, 128), 0), out=buf147)
        del arg91_1
        buf148 = buf143; del buf143  # reuse
        # Topologically Sorted Source Nodes: [V_7], Original ATen: [aten.add]
        triton_poi_fused_add_52.run(buf148, buf147, arg92_1, 8192, grid=grid(8192), stream=stream0)
        del arg92_1
        buf149 = reinterpret_tensor(buf147, (1, 64, 128), (8192, 128, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [V_7, msg_7], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 64, 64), (0, 64, 1), 0), buf148, out=buf149)
        del arg64_1
        buf150 = reinterpret_tensor(buf146, (64, 128), (128, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf149, (64, 128), (128, 1), 0), reinterpret_tensor(arg93_1, (128, 128), (1, 128), 0), out=buf150)
        del arg93_1
        buf151 = reinterpret_tensor(buf150, (1, 64, 128), (8192, 128, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [input_38], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_50.run(buf151, arg94_1, 8192, grid=grid(8192), stream=stream0)
        del arg94_1
        buf152 = reinterpret_tensor(buf149, (64, 128), (128, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf151, (64, 128), (128, 1), 0), reinterpret_tensor(arg95_1, (128, 128), (1, 128), 0), out=buf152)
        del arg95_1
        buf156 = buf151; del buf151  # reuse
        # Topologically Sorted Source Nodes: [V_8, V_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_53.run(buf148, buf152, arg96_1, arg97_1, arg98_1, buf156, 64, 128, grid=grid(64), stream=stream0)
        del arg96_1
        del arg97_1
        del arg98_1
        del buf148
        buf160 = reinterpret_tensor(buf53, (1, 528, 128), (67584, 128, 1), 0); del buf53  # reuse
        # Topologically Sorted Source Nodes: [layer_norm_6], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_54.run(buf156, buf105, arg99_1, arg100_1, buf160, 528, 128, grid=grid(528), stream=stream0)
        del arg100_1
        del arg99_1
        buf161 = buf35; del buf35  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf160, (528, 128), (128, 1), 0), reinterpret_tensor(arg101_1, (128, 384), (1, 128), 0), out=buf161)
        buf162 = buf34; del buf34  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf160, (528, 128), (128, 1), 0), reinterpret_tensor(arg101_1, (128, 384), (1, 128), 0), out=buf162)
        del arg101_1
        buf163 = reinterpret_tensor(buf160, (16, 8, 33, 16, 1, 1), (4224, 528, 16, 1, 1, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf161, arg102_1, buf163, 67584, grid=grid(67584), stream=stream0)
        del buf161
        buf164 = reinterpret_tensor(buf29, (16, 8, 16, 1, 33, 1), (4224, 528, 33, 33, 1, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf162, arg102_1, buf164, 2048, 33, grid=grid(2048, 33), stream=stream0)
        buf165 = reinterpret_tensor(buf48, (128, 33, 33), (1089, 33, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf163, (128, 33, 16), (528, 16, 1), 0), reinterpret_tensor(buf164, (128, 16, 33), (528, 33, 1), 0), out=buf165)
        buf166 = buf46; del buf46  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_4], Original ATen: [aten.cat]
        triton_poi_fused_cat_11.run(arg28_1, buf166, 69696, grid=grid(69696), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_4, setitem_8], Original ATen: [aten.cat, aten.lift_fresh, aten.index_put]
        triton_poi_fused_cat_index_put_lift_fresh_12.run(buf166, 2048, grid=grid(2048), stream=stream0)
        buf168 = buf41; del buf41  # reuse
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf166, buf168, 17424, grid=grid(17424), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf168, 512, grid=grid(512), stream=stream0)
        buf171 = reinterpret_tensor(buf49, (1, 16, 33, 33, 8), (143360, 8960, 33, 1, 1120), 0); del buf49  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_15.run(arg29_1, buf165, buf168, buf166, buf171, buf172, 4224, 33, grid=grid(4224), stream=stream0)
        buf173 = buf39; del buf39  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf168, buf166, buf173, 69696, grid=grid(69696), stream=stream0)
        del buf166
        del buf168
        buf174 = buf47; del buf47  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf173, buf174, 69696, grid=grid(69696), stream=stream0)
        del buf173
        buf175 = reinterpret_tensor(buf165, (17424, 8), (8, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf174, reinterpret_tensor(arg103_1, (4, 8), (1, 4), 0), out=buf175)
        del arg103_1
        del buf174
        buf176 = reinterpret_tensor(buf171, (16, 8, 33, 33, 1, 1), (8960, 1120, 33, 1, 1, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf176, buf172, arg29_1, buf175, arg104_1, 128, 1089, grid=grid(128, 1089), stream=stream0)
        del arg104_1
        del arg29_1
        del buf172
        del buf175
        buf177 = reinterpret_tensor(buf164, (16, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf162, arg102_1, buf177, 67584, grid=grid(67584), stream=stream0)
        del arg102_1
        del buf162
        buf178 = reinterpret_tensor(buf163, (128, 33, 16), (528, 16, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf176, (128, 33, 33), (1120, 33, 1), 0), reinterpret_tensor(buf177, (128, 33, 16), (528, 16, 1), 0), out=buf178)
        del buf176
        buf179 = reinterpret_tensor(buf177, (1, 16, 33, 8, 16), (67584, 4224, 128, 16, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [x_out_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_20.run(buf178, buf179, 67584, grid=grid(67584), stream=stream0)
        buf180 = reinterpret_tensor(buf178, (528, 128), (128, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf179, (528, 128), (128, 1), 0), reinterpret_tensor(arg105_1, (128, 128), (1, 128), 0), out=buf180)
        del arg105_1
        buf214 = reinterpret_tensor(buf179, (1, 528, 128), (67584, 128, 1), 0); del buf179  # reuse
        # Topologically Sorted Source Nodes: [x_5, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_55.run(buf156, buf105, buf180, arg106_1, arg107_1, arg108_1, buf214, 528, 128, grid=grid(528), stream=stream0)
        del arg107_1
        del arg108_1
        buf184 = buf70; del buf70  # reuse
        buf185 = buf69; del buf69  # reuse
        # Topologically Sorted Source Nodes: [layer_norm_8], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_56.run(buf156, buf110, buf184, buf185, 816, 128, grid=grid(816), stream=stream0)
        buf187 = reinterpret_tensor(buf97, (48, 32, 128), (4096, 128, 1), 0); del buf97  # reuse
        buf192 = reinterpret_tensor(buf94, (48, 2, 17, 128), (4352, 2176, 128, 1), 0); del buf94  # reuse
        buf190 = reinterpret_tensor(buf192, (48, 2, 16, 128), (4352, 2176, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_8, x_7, kv_3], Original ATen: [aten.native_layer_norm, aten.constant_pad_nd, aten.cat]
        triton_poi_fused_cat_constant_pad_nd_native_layer_norm_57.run(buf156, buf110, buf184, buf185, arg113_1, arg114_1, buf187, buf190, 196608, grid=grid(196608), stream=stream0)
        del arg113_1
        del arg114_1
        del buf184
        del buf185
        buf188 = buf75; del buf75  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf187, (1536, 128), (128, 1), 0), reinterpret_tensor(arg115_1, (128, 384), (1, 128), 0), out=buf188)
        buf191 = reinterpret_tensor(buf192, (48, 2, 1, 128), (4352, 2176, 128, 1), 2048)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_per_fused_mean_30.run(buf187, buf191, 12288, 16, grid=grid(12288), stream=stream0)
        del buf190
        del buf191
        buf193 = buf80; del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf192, (1632, 128), (128, 1), 0), reinterpret_tensor(arg115_1, (128, 384), (1, 128), 0), out=buf193)
        del arg115_1
        buf194 = reinterpret_tensor(buf187, (48, 2, 8, 16, 16, 1), (4096, 2048, 256, 16, 1, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(buf188, arg116_1, buf194, 196608, grid=grid(196608), stream=stream0)
        del buf188
        buf195 = reinterpret_tensor(buf192, (48, 2, 8, 16, 17, 1), (4352, 2176, 272, 17, 1, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf193, arg116_1, buf195, 12288, 17, grid=grid(12288, 17), stream=stream0)
        buf196 = reinterpret_tensor(buf93, (768, 16, 17), (272, 17, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf194, (768, 16, 16), (256, 16, 1), 0), reinterpret_tensor(buf195, (768, 16, 17), (272, 17, 1), 0), out=buf196)
        buf197 = reinterpret_tensor(buf91, (48, 1, 16, 17, 4), (1088, 52224, 68, 4, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [setitem_10, setitem_11], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_33.run(buf72, buf197, 52224, grid=grid(52224), stream=stream0)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_34.run(buf197, 3072, grid=grid(3072), stream=stream0)
        buf199 = buf86; del buf86  # reuse
        # Topologically Sorted Source Nodes: [setitem_13], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_35.run(buf197, buf199, 13056, grid=grid(13056), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_13], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_36.run(buf199, 768, grid=grid(768), stream=stream0)
        buf202 = reinterpret_tensor(buf195, (48, 2, 16, 17, 8), (4352, 2176, 17, 1, 272), 0); del buf195  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_37.run(buf73, buf196, buf199, buf197, buf202, 12288, 17, grid=grid(12288), stream=stream0)
        buf203 = buf90; del buf90  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_38.run(buf202, buf203, 12288, 17, grid=grid(12288), stream=stream0)
        buf204 = reinterpret_tensor(buf72, (48, 1, 16, 17, 4), (1088, 1, 68, 4, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_39.run(buf199, buf197, buf204, 52224, grid=grid(52224), stream=stream0)
        del buf197
        del buf199
        buf205 = reinterpret_tensor(buf68, (13056, 8), (8, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf204, (13056, 4), (4, 1), 0), reinterpret_tensor(arg117_1, (4, 8), (1, 4), 0), out=buf205)
        del arg117_1
        del buf204
        buf206 = reinterpret_tensor(buf202, (48, 2, 8, 16, 17, 1), (4352, 2176, 272, 17, 1, 1), 0); del buf202  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf206, buf203, buf73, buf205, arg118_1, 768, 272, grid=grid(768, 272), stream=stream0)
        del arg118_1
        del buf73
        buf207 = reinterpret_tensor(buf196, (48, 2, 8, 17, 16, 1), (4352, 2176, 272, 16, 1, 1), 0); del buf196  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_41.run(buf193, arg116_1, buf207, 208896, grid=grid(208896), stream=stream0)
        del arg116_1
        del buf193
        buf208 = reinterpret_tensor(buf194, (768, 16, 16), (256, 16, 1), 0); del buf194  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf206, (768, 16, 17), (272, 17, 1), 0), reinterpret_tensor(buf207, (768, 17, 16), (272, 16, 1), 0), out=buf208)
        del buf206
        del buf207
        buf209 = buf96; del buf96  # reuse
        # Topologically Sorted Source Nodes: [x_out_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_42.run(buf208, buf209, 196608, grid=grid(196608), stream=stream0)
        buf210 = reinterpret_tensor(buf208, (1536, 128), (128, 1), 0); del buf208  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf209, (1536, 128), (128, 1), 0), reinterpret_tensor(arg119_1, (128, 128), (1, 128), 0), out=buf210)
        del arg119_1
        del buf209
        buf222 = reinterpret_tensor(buf205, (48, 17, 128), (2176, 128, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [x_8, layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_58.run(buf156, buf110, buf210, arg120_1, arg121_1, arg122_1, buf222, 816, 128, grid=grid(816), stream=stream0)
        del arg121_1
        del arg122_1
        buf215 = reinterpret_tensor(buf103, (528, 512), (512, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf214, (528, 128), (128, 1), 0), reinterpret_tensor(arg109_1, (128, 512), (1, 128), 0), out=buf215)
        del arg109_1
        buf216 = reinterpret_tensor(buf215, (1, 528, 512), (270336, 512, 1), 0); del buf215  # reuse
        # Topologically Sorted Source Nodes: [input_41], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_44.run(buf216, arg110_1, 270336, grid=grid(270336), stream=stream0)
        del arg110_1
        buf217 = reinterpret_tensor(buf214, (528, 128), (128, 1), 0); del buf214  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf216, (528, 512), (512, 1), 0), reinterpret_tensor(arg111_1, (512, 128), (1, 512), 0), out=buf217)
        del arg111_1
        del buf216
        buf218 = reinterpret_tensor(buf25, (1, 16, 32, 128), (65536, 4096, 128, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [h_diag], Original ATen: [aten.clone]
        triton_poi_fused_clone_59.run(buf156, buf105, buf180, arg106_1, buf217, arg112_1, buf218, 65536, grid=grid(65536), stream=stream0)
        del arg106_1
        del arg112_1
        del buf105
        del buf180
        del buf217
        buf219 = reinterpret_tensor(buf24, (512, 128), (128, 1), 0); del buf24  # reuse
        buf234 = buf12; del buf12  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        triton_poi_fused_addmm_60.run(buf218, buf219, buf234, 65536, grid=grid(65536), stream=stream0)
        buf220 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg128_1, buf219, reinterpret_tensor(arg127_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf220)
        del arg127_1
        del arg128_1
        del buf219
        buf221 = empty_strided_cuda((16, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf220, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf220, (16, 32, 32), (1024, 1, 32), 0), out=buf221)
        del buf220
        buf223 = reinterpret_tensor(buf108, (816, 512), (512, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf222, (816, 128), (128, 1), 0), reinterpret_tensor(arg123_1, (128, 512), (1, 128), 0), out=buf223)
        del arg123_1
        buf224 = reinterpret_tensor(buf223, (48, 17, 512), (8704, 512, 1), 0); del buf223  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_46.run(buf224, arg124_1, 417792, grid=grid(417792), stream=stream0)
        del arg124_1
        buf225 = reinterpret_tensor(buf222, (816, 128), (128, 1), 0); del buf222  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf224, (816, 512), (512, 1), 0), reinterpret_tensor(arg125_1, (512, 128), (1, 512), 0), out=buf225)
        del arg125_1
        del buf224
        buf226 = reinterpret_tensor(buf225, (48, 17, 128), (2176, 128, 1), 0); del buf225  # reuse
        # Topologically Sorted Source Nodes: [x_8, x_9], Original ATen: [aten.add]
        triton_poi_fused_add_61.run(buf226, buf156, buf110, buf210, arg120_1, arg126_1, 104448, grid=grid(104448), stream=stream0)
        del arg120_1
        del arg126_1
        del buf110
        del buf210
        buf227 = reinterpret_tensor(buf203, (48, 16, 16), (256, 16, 1), 0); del buf203  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf226, (48, 16, 128), (2176, 128, 1), 0), reinterpret_tensor(arg129_1, (48, 128, 16), (0, 1, 128), 0), out=buf227)
        del arg129_1
        buf228 = empty_strided_cuda((48, 16, 16), (256, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf226, (48, 16, 128), (2176, 128, 1), 0), reinterpret_tensor(arg131_1, (48, 128, 16), (0, 1, 128), 0), out=buf228)
        del arg131_1
        del buf226
        buf229 = reinterpret_tensor(buf227, (48, 1, 16, 16), (256, 1, 16, 1), 0); del buf227  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.add]
        triton_poi_fused_add_62.run(buf229, arg130_1, 12288, grid=grid(12288), stream=stream0)
        del arg130_1
        buf230 = reinterpret_tensor(buf228, (48, 1, 16, 16), (256, 1, 16, 1), 0); del buf228  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.add]
        triton_poi_fused_add_62.run(buf230, arg132_1, 12288, grid=grid(12288), stream=stream0)
        del arg132_1
        buf231 = empty_strided_cuda((48, 16, 16), (256, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf229, (48, 16, 16), (256, 16, 1), 0), reinterpret_tensor(buf230, (48, 16, 16), (256, 1, 16), 0), out=buf231)
        del buf229
        del buf230
        buf232 = reinterpret_tensor(buf156, (512, 16), (16, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg136_1, reinterpret_tensor(buf218, (512, 128), (128, 1), 0), reinterpret_tensor(arg135_1, (128, 16), (1, 128), 0), alpha=1, beta=1, out=buf232)
        del arg135_1
        del arg136_1
        buf233 = reinterpret_tensor(buf152, (512, 16), (16, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg138_1, reinterpret_tensor(buf218, (512, 128), (128, 1), 0), reinterpret_tensor(arg137_1, (128, 16), (1, 128), 0), alpha=1, beta=1, out=buf233)
        del arg137_1
        del arg138_1
        del buf218
        buf235 = empty_strided_cuda((512, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf234, reinterpret_tensor(arg133_1, (128, 1), (1, 128), 0), out=buf235)
        del arg133_1
        del buf234
        buf236 = reinterpret_tensor(buf235, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf235  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_63.run(buf236, arg134_1, 512, grid=grid(512), stream=stream0)
        del arg134_1
        buf237 = empty_strided_cuda((1, 45568), (45568, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_64.run(buf221, buf231, buf232, buf233, buf236, buf237, 45568, grid=grid(45568), stream=stream0)
        del buf221
        del buf231
        del buf232
        del buf233
    return (buf237, reinterpret_tensor(buf236, (1, 16, 32), (512, 32, 1), 0), buf58, buf61, buf57, )
