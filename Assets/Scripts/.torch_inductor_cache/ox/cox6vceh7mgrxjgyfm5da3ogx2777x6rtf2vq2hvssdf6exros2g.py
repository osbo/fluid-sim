...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/2q/c2qfldlohgkra4erihwilc75mqlvpxo3q55h6ziqqdh4xnwmdx6s.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_38', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp15 = tmp0 >= tmp3
    tmp16 = tl.full([1], 27904, tl.int64)
    tmp17 = tmp0 < tmp16
    tmp18 = tl.load(in_ptr2 + ((-27648) + x0), tmp15 & xmask, eviction_policy='evict_last', other=0.0)
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf144
        del buf145
        buf147 = empty_strided_cuda((256, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (256, 512), (512, 1), 0), reinterpret_tensor(arg72_1, (512, 1), (1, 512), 0), out=buf147)
        del arg72_1
        del buf114
        buf148 = reinterpret_tensor(buf147, (1, 8, 32, 1), (256, 32, 1, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_37.run(buf148, arg73_1, 256, grid=grid(256), stream=stream0)
        del arg73_1
        buf149 = empty_strided_cuda((1, 27904), (27904, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_38.run(buf116, buf146, buf148, buf149, 27904, grid=grid(27904), stream=stream0)
        del buf116
        del buf146
    return (buf149, reinterpret_tensor(buf148, (1, 8, 32), (256, 32, 1), 0), )
