...
#   %cat_6 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%mean_4, %mean_5], 2), kwargs = {})
...
#   x_out_11 => clone_24
# Graph fragment:
#   %clone_24 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%view_84,), kwargs = {memory_format: torch.contiguous_format})
...
#   %cat_7 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%mean_6, %mean_7], 2), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/eh/cehbrz4dfvih6cm33rq6dectqbf5sy7mxyvmv7vtll75q7nvv4k7.py
# Topologically Sorted Source Nodes: [x_3], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   x_3 => add_30
# Graph fragment:
#   %add_30 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_25, %view_114), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/u2/cu257qwepr2z55uexedn4mj53xzumvtxt7xcu322d44giye53i3h.py
# Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   packed_1 => cat_9
# Graph fragment:
#   %cat_9 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_8, %view_126], 1), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf125 = empty_strided_cuda((1, 6, 32, 33, 4), (25344, 4224, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_27.run(arg31_1, buf70, buf125, 25344, grid=grid(25344), stream=stream0)
        del arg31_1
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        ...
        del buf113
        buf115 = reinterpret_tensor(buf83, (1, 6, 32, 512), (98304, 16384, 512, 1), 0); del buf83  # reuse
        buf120 = reinterpret_tensor(buf80, (1, 6, 33, 512), (101376, 16896, 512, 1), 0); del buf80  # reuse
        buf118 = reinterpret_tensor(buf120, (1, 6, 32, 512), (101376, 16896, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_attn_3, kv_3], Original ATen: [aten.mean, aten.cat]
        triton_poi_fused_cat_mean_39.run(buf84, buf85, buf86, arg58_1, arg59_1, buf115, buf118, 98304, grid=grid(98304), stream=stream0)
        del arg58_1
        del arg59_1
        del buf85
        del buf86
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (192, 512), (512, 1), 0), reinterpret_tensor(arg60_1, (512, 1536), (1, 512), 0), out=buf116)
        buf119 = reinterpret_tensor(buf120, (1, 6, 1, 512), (101376, 16896, 512, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf115, buf119, 3072, 32, grid=grid(3072), stream=stream0)
        del buf118
        del buf119
        buf121 = buf66; del buf66  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (198, 512), (512, 1), 0), reinterpret_tensor(arg60_1, (512, 1536), (1, 512), 0), out=buf121)
        del arg60_1
        buf122 = reinterpret_tensor(buf115, (6, 8, 32, 64, 1, 1), (16384, 2048, 64, 1, 1, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf116, arg61_1, buf122, 98304, grid=grid(98304), stream=stream0)
        del buf116
        buf123 = reinterpret_tensor(buf120, (6, 8, 64, 1, 33, 1), (16896, 2112, 33, 33, 1, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf121, arg61_1, buf123, 3072, 33, grid=grid(3072, 33), stream=stream0)
        buf124 = reinterpret_tensor(buf79, (48, 32, 33), (1056, 33, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf122, (48, 32, 64), (2048, 64, 1), 0), reinterpret_tensor(buf123, (48, 64, 33), (2112, 33, 1), 0), out=buf124)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf125, 768, grid=grid(768), stream=stream0)
        buf127 = buf72; del buf72  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf125, buf127, 6336, grid=grid(6336), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf127, 192, grid=grid(192), stream=stream0)
        buf130 = reinterpret_tensor(buf78, (1, 6, 32, 33, 8), (50688, 8448, 33, 1, 1056), 0); del buf78  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg30_1, buf124, buf127, buf125, buf130, buf131, 1536, 33, grid=grid(1536), stream=stream0)
        buf132 = buf77; del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_32.run(buf127, buf125, buf132, 25344, grid=grid(25344), stream=stream0)
        del buf125
        del buf127
        buf133 = reinterpret_tensor(buf124, (6336, 8), (8, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf132, (6336, 4), (4, 1), 0), reinterpret_tensor(arg62_1, (4, 8), (1, 4), 0), out=buf133)
        del arg62_1
        del buf132
        buf134 = reinterpret_tensor(buf130, (6, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [x_out_15], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf134, buf131, arg30_1, buf133, arg63_1, 48, 1056, grid=grid(48, 1056), stream=stream0)
        del arg30_1
        del arg63_1
        del buf131
        del buf133
        buf135 = reinterpret_tensor(buf123, (6, 8, 33, 1, 64, 1), (16896, 2112, 64, 64, 1, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [x_out_15], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf121, arg61_1, buf135, 101376, grid=grid(101376), stream=stream0)
        del arg61_1
        del buf121
        buf136 = reinterpret_tensor(buf122, (48, 32, 64), (2048, 64, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [x_out_15], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf134, (48, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf135, (48, 33, 64), (2112, 64, 1), 0), out=buf136)
        del buf134
        del buf135
        buf137 = buf82; del buf82  # reuse
        # Topologically Sorted Source Nodes: [x_out_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf136, buf137, 98304, grid=grid(98304), stream=stream0)
        buf138 = reinterpret_tensor(buf136, (192, 512), (512, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf137, (192, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 512), (1, 512), 0), out=buf138)
        del arg64_1
        del buf137
        buf139 = reinterpret_tensor(buf89, (1, 384, 512), (196608, 512, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [x_3], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf84, buf138, arg65_1, buf139, 196608, grid=grid(196608), stream=stream0)
        del arg65_1
        del buf138
        del buf84
        ...
        del buf140
        del buf141
        buf143 = reinterpret_tensor(buf54, (256, 1), (1, 1), 0); del buf54  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        # Topologically Sorted Source Nodes: [j_gate], Original ATen: [aten.mul]
        triton_poi_fused_mul_41.run(buf144, arg71_1, 256, grid=grid(256), stream=stream0)
        del arg71_1
        buf145 = empty_strided_cuda((1, 41216), (41216, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_42.run(buf114, buf142, buf144, buf145, 41216, grid=grid(41216), stream=stream0)
        del buf114
        del buf142
