...
# Topologically Sorted Source Nodes: [x, x_1, layer_norm_5, kv_2], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
# Source node to ATen node mapping:
#   kv_2 => cat_5
...
#   %cat_5 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_65, %mean_2], 2), kwargs = {})
...
# Topologically Sorted Source Nodes: [row_sum, getitem_13, index_add__2, col_sum, getitem_14, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
# Source node to ATen node mapping:
#   col_sum => full_default_9
#   getitem_13 => index_2
#   getitem_14 => index_3
...
# Graph fragment:
#   %full_default_8 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([48, 1, 32, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_2 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_27, [%device_put]), kwargs = {})
#   %index_put_4 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_8, [%device_put_2], %index_2, True), kwargs = {})
...
#   %index_3 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_27, [%device_put_1]), kwargs = {})
#   %index_put_5 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_9, [%device_put_2], %index_3, True), kwargs = {})
...
# Graph fragment:
#   %var_mean_3 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_37, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_4 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_37, %getitem_7), kwargs = {})
...
#   %cat_4 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_38, %mean_1], 2), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ha/chai2rdr6m56whepwqubqbyvogqnltmjttblkxtxlgb2xlawpnn2.py
# Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   block_node_1 => mean_1
# Graph fragment:
#   %mean_1 : [num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%view_38, [2], True), kwargs = {})
...
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default_1 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_47, %full_default_31], 2), kwargs = {})
...
# Source node to ATen node mapping:
#   setitem_4 => copy_2, full_default_10
#   setitem_5 => copy_3, full_default_11
# Graph fragment:
...
#   %copy_2 : [num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%select_17, %full_default_10), kwargs = {})
...
#   %copy_3 : [num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%select_23, %full_default_11), kwargs = {})
...
#   setitem_4 => copy_2, full_default_10
#   setitem_5 => copy_3, full_default_11
#   setitem_6 => full_default_12, index_put_6
# Graph fragment:
#   %full_default_10 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %copy_2 : [num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%select_17, %full_default_10), kwargs = {})
#   %select_scatter_default_4 : [num_users=4] = call_function[target=torch.ops.aten.select_scatter.default](args = (%view_7, %copy_2, 3, 32), kwargs = {})
...
#   %index_put_6 : [num_users=2] = call_function[target=torch.ops.aten.index_put_.default](args = (%select_scatter_default_6, [None, None, %iota_1, %iota_1], %full_default_12), kwargs = {})
...
# Source node to ATen node mapping:
#   setitem_7 => full_default_13, index_put_7
# Graph fragment:
...
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_28, [None, None, %iota_1, %iota_1], %full_default_13), kwargs = {})
...
#   scores_3 => mul_23
#   scores_4 => add_19
#   scores_5 => clone_10, full_default_14, where_2
# Graph fragment:
...
#   %mul_23 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_49, 0.25), kwargs = {})
#   %add_19 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_23, %slice_95), kwargs = {})
...
#   x_out_4 => clone_11
# Graph fragment:
#   %clone_11 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_40,), kwargs = {memory_format: torch.contiguous_format})
...
#   x_out_5 => clone_13
# Graph fragment:
#   %clone_13 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%view_56,), kwargs = {memory_format: torch.contiguous_format})
...
#   x_2 => add_21
# Graph fragment:
#   %add_21 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_37, %view_60), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/qd/cqdcnmcg4zouncjl6lvlqbg7set2uskvktd5ztzkxnjeo54qxg2o.py
# Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   x_4 => add_30
#   x_5 => add_34
# Graph fragment:
#   %add_30 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_15, %view_87), kwargs = {})
#   %add_34 : [num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_30, %view_91), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/b2/cb2yv3strje25jemlvjebblqjojgdxidxr2qvfj5b7vp53owkqej.py
# Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_14 => add_24, erf_4, mul_26, mul_27, mul_28
# Graph fragment:
#   %mul_26 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_62, 0.5), kwargs = {})
#   %mul_27 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_62, 0.7071067811865476), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/n2/cn2sipffff4p6kux5a2y7atarjptensgtohu2mcjc3v2asw7kwux.py
# Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
# Source node to ATen node mapping:
#   kv_3 => cat_6
...
#   x_3 => add_25
# Graph fragment:
#   %add_25 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_21, %view_64), kwargs = {})
#   %add_36 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_94, %add_25), kwargs = {})
...
#   %cat_6 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_95, %mean_3], 2), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_cat_native_layer_norm_40', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 8, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr3 + (r2 + (128*x0) + (4224*x1)), tmp39, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/nt/cntby67pt36dzn56bcy2imhjjroizyqvokvdeg3by4qtgjr3b6k5.py
# Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   layer_norm_8 => add_42, add_43, mul_40, mul_41, rsqrt_8, sub_12, var_mean_8
#   x_6 => add_41
# Graph fragment:
#   %add_41 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_36, %view_117), kwargs = {})
#   %var_mean_8 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%add_41, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_12 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_41, %getitem_17), kwargs = {})
#   %add_42 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_16, 1e-05), kwargs = {})
#   %rsqrt_8 : [num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_42,), kwargs = {})
...
#   %add_43 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_41, %arg87_1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/iw/ciwdzygqnj444b5zrusyjybilhqvtiq6hsnwnfdeljkpc5fsvfg4.py
...
#   sigmoid => sigmoid
# Graph fragment:
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_141,), kwargs = {})
...
#   packed_1 => cat_8
# Graph fragment:
#   %cat_8 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_7, %view_142], 1), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg38_1
        buf57 = reinterpret_tensor(buf51, (1, 512, 128), (65536, 128, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf52, arg39_1, arg40_1, arg41_1, buf57, 512, 128, grid=grid(512), stream=stream0)
        del arg40_1
        del arg41_1
        buf56 = empty_strided_cuda((66, ), (1, ), torch.int64)
        buf56.copy_(arg48_1)
        del arg48_1
        buf58 = empty_strided_cuda((512, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (512, 128), (128, 1), 0), reinterpret_tensor(arg42_1, (128, 512), (1, 128), 0), out=buf58)
        del arg42_1
        buf59 = reinterpret_tensor(buf58, (1, 512, 512), (262144, 512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf59, arg43_1, 262144, grid=grid(262144), stream=stream0)
        del arg43_1
        buf60 = reinterpret_tensor(buf57, (512, 128), (128, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (512, 512), (512, 1), 0), reinterpret_tensor(arg44_1, (512, 128), (1, 512), 0), out=buf60)
        del arg44_1
        buf61 = reinterpret_tensor(buf60, (1, 512, 128), (65536, 128, 1), 0); del buf60  # reuse
        buf102 = empty_strided_cuda((1, 512, 128), (65536, 128, 1), torch.float32)
        buf107 = reinterpret_tensor(buf49, (1, 16, 33, 128), (67584, 4224, 128, 1), 0); del buf49  # reuse
        buf105 = reinterpret_tensor(buf107, (1, 16, 32, 128), (67584, 4224, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5, kv_2], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_20.run(buf61, buf25, buf52, arg39_1, arg45_1, arg64_1, arg65_1, buf102, buf105, 512, 128, grid=grid(512), stream=stream0)
        del arg39_1
        del arg45_1
        del arg64_1
        del arg65_1
        ...
        buf62.copy_(arg46_1)
        del arg46_1
        buf63 = reinterpret_tensor(buf30, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf30  # reuse
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        ...
        triton_poi_fused_zeros_21.run(buf66, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum, getitem_13, index_add__2, col_sum, getitem_14, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_22.run(buf56, buf62, buf61, buf65, buf63, buf66, 270336, grid=grid(270336), stream=stream0)
        buf71 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        buf76 = reinterpret_tensor(buf35, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf35  # reuse
        buf74 = reinterpret_tensor(buf76, (48, 1, 32, 128), (4224, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_3, kv_1], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_23.run(buf63, arg49_1, buf66, arg50_1, arg51_1, buf71, buf74, 1536, 128, grid=grid(1536), stream=stream0)
        del arg50_1
        del arg51_1
        ...
        buf75 = reinterpret_tensor(buf76, (48, 1, 1, 128), (4224, 1, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf71, buf75, 6144, 32, grid=grid(6144), stream=stream0)
        del buf74
        del buf75
        buf77 = empty_strided_cuda((1584, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (1584, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf77)
        del arg52_1
        buf78 = reinterpret_tensor(buf71, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf72, arg53_1, buf78, 196608, grid=grid(196608), stream=stream0)
        buf79 = empty_strided_cuda((384, 16, 36), (576, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_26.run(buf77, arg53_1, buf79, 221184, grid=grid(221184), stream=stream0)
        buf80 = empty_strided_cuda((384, 32, 36), (1152, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(reinterpret_tensor(buf78, (384, 32, 16), (512, 16, 1), 0), buf79, out=buf80)
        buf81 = reinterpret_tensor(buf76, (48, 1, 32, 33, 4), (4224, 202752, 132, 4, 1), 0); del buf76  # reuse
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_27.run(arg30_1, buf81, 202752, grid=grid(202752), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5, setitem_6], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf81, 6144, grid=grid(6144), stream=stream0)
        buf83 = empty_strided_cuda((48, 1, 32, 33), (1056, 1056, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf81, buf83, 50688, grid=grid(50688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf83, 1536, grid=grid(1536), stream=stream0)
        buf86 = empty_strided_cuda((48, 1, 32, 33, 8), (8448, 405504, 33, 1, 1056), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg31_1, buf80, buf83, buf81, buf86, 12288, 33, grid=grid(12288), stream=stream0)
        buf87 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_32.run(buf86, buf87, 12288, 33, grid=grid(12288), stream=stream0)
        buf88 = empty_strided_cuda((48, 1, 32, 33, 4), (4224, 1, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf83, buf81, buf88, 202752, grid=grid(202752), stream=stream0)
        buf89 = empty_strided_cuda((50688, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf88, (50688, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 8), (1, 4), 0), out=buf89)
        del arg54_1
        buf90 = reinterpret_tensor(buf86, (48, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf90, buf87, arg31_1, buf89, arg55_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg55_1
        buf91 = reinterpret_tensor(buf88, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf77, arg53_1, buf91, 202752, grid=grid(202752), stream=stream0)
        del arg53_1
        buf92 = reinterpret_tensor(buf78, (384, 32, 16), (512, 16, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf90, (384, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf91, (384, 33, 16), (528, 16, 1), 0), out=buf92)
        buf93 = empty_strided_cuda((48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf92, buf93, 196608, grid=grid(196608), stream=stream0)
        ...
        del arg56_1
        buf95 = reinterpret_tensor(buf94, (48, 32, 128), (4096, 128, 1), 0); del buf94  # reuse
        buf138 = reinterpret_tensor(buf93, (48, 32, 128), (4096, 128, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf95, buf63, arg49_1, buf66, arg57_1, arg58_1, arg59_1, buf138, 1536, 128, grid=grid(1536), stream=stream0)
        del arg57_1
        del arg58_1
        del arg59_1
        buf103 = reinterpret_tensor(buf66, (512, 384), (384, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf102, (512, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf103)
        buf106 = reinterpret_tensor(buf107, (1, 16, 1, 128), (67584, 4224, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_7.run(buf102, buf106, 2048, 32, grid=grid(2048), stream=stream0)
        del buf105
        del buf106
        buf108 = reinterpret_tensor(buf91, (528, 384), (384, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf107, (528, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf108)
        del arg66_1
        buf109 = reinterpret_tensor(buf102, (16, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf103, arg67_1, buf109, 65536, grid=grid(65536), stream=stream0)
        buf110 = reinterpret_tensor(buf107, (16, 8, 16, 1, 33, 1), (4224, 528, 33, 33, 1, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf108, arg67_1, buf110, 2048, 33, grid=grid(2048, 33), stream=stream0)
        buf111 = reinterpret_tensor(buf48, (128, 32, 33), (1056, 33, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf109, (128, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf110, (128, 16, 33), (528, 33, 1), 0), out=buf111)
        buf112 = reinterpret_tensor(buf110, (1, 16, 32, 33, 4), (67584, 4224, 132, 4, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_10.run(arg28_1, buf112, 67584, grid=grid(67584), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_11.run(buf112, 2048, grid=grid(2048), stream=stream0)
        buf114 = buf41; del buf41  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf112, buf114, 16896, grid=grid(16896), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf114, 512, grid=grid(512), stream=stream0)
        buf117 = reinterpret_tensor(buf47, (1, 16, 32, 33, 8), (135168, 8448, 33, 1, 1056), 0); del buf47  # reuse
        buf118 = buf45; del buf45  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_14.run(arg29_1, buf111, buf114, buf112, buf117, buf118, 4096, 33, grid=grid(4096), stream=stream0)
        buf119 = buf39; del buf39  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf114, buf112, buf119, 67584, grid=grid(67584), stream=stream0)
        del buf112
        del buf114
        buf120 = reinterpret_tensor(buf111, (16896, 8), (8, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (16896, 4), (4, 1), 0), reinterpret_tensor(arg68_1, (4, 8), (1, 4), 0), out=buf120)
        del arg68_1
        buf121 = reinterpret_tensor(buf117, (16, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_16.run(buf121, buf118, arg29_1, buf120, arg69_1, 128, 1056, grid=grid(128, 1056), stream=stream0)
        del arg29_1
        del arg69_1
        del buf118
        del buf120
        buf122 = reinterpret_tensor(buf119, (16, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf108, arg67_1, buf122, 67584, grid=grid(67584), stream=stream0)
        del arg67_1
        buf123 = reinterpret_tensor(buf109, (128, 32, 16), (512, 16, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf121, (128, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf122, (128, 33, 16), (528, 16, 1), 0), out=buf123)
        del buf121
        del buf122
        buf124 = reinterpret_tensor(buf52, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf123, buf124, 65536, grid=grid(65536), stream=stream0)
        buf125 = reinterpret_tensor(buf123, (512, 128), (128, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (512, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 128), (1, 128), 0), out=buf125)
        del arg70_1
        buf129 = reinterpret_tensor(buf124, (1, 512, 128), (65536, 128, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf61, buf125, arg71_1, arg72_1, arg73_1, buf129, 512, 128, grid=grid(512), stream=stream0)
        del arg72_1
        del arg73_1
        buf130 = reinterpret_tensor(buf59, (512, 512), (512, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf129, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 512), (1, 128), 0), out=buf130)
        del arg74_1
        buf131 = reinterpret_tensor(buf130, (1, 512, 512), (262144, 512, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf131, arg75_1, 262144, grid=grid(262144), stream=stream0)
        del arg75_1
        buf132 = reinterpret_tensor(buf129, (512, 128), (128, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf131, (512, 512), (512, 1), 0), reinterpret_tensor(arg76_1, (512, 128), (1, 512), 0), out=buf132)
        del arg76_1
        del buf131
        buf133 = reinterpret_tensor(buf132, (1, 512, 128), (65536, 128, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_38.run(buf133, buf61, buf125, arg71_1, arg77_1, 65536, grid=grid(65536), stream=stream0)
        del arg71_1
        del arg77_1
        del buf125
        del buf61
        buf134 = reinterpret_tensor(buf103, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf103  # reuse
        ...
        buf136 = buf63; del buf63  # reuse
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf136, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_25, index_add__4, col_sum_1, getitem_26, index_add__5], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_22.run(buf56, buf62, buf133, buf65, buf134, buf136, 270336, grid=grid(270336), stream=stream0)
        buf139 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf138, (1536, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf139)
        del arg60_1
        buf140 = reinterpret_tensor(buf139, (48, 32, 512), (16384, 512, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf140, arg61_1, 786432, grid=grid(786432), stream=stream0)
        del arg61_1
        buf141 = reinterpret_tensor(buf138, (1536, 128), (128, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf140, (1536, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf141)
        del arg62_1
        buf142 = reinterpret_tensor(buf141, (48, 32, 128), (4096, 128, 1), 0); del buf141  # reuse
        buf146 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        buf151 = reinterpret_tensor(buf108, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf108  # reuse
        buf149 = reinterpret_tensor(buf151, (48, 1, 32, 128), (4224, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_40.run(buf142, buf134, arg49_1, buf136, buf95, arg63_1, arg78_1, arg79_1, buf146, buf149, 1536, 128, grid=grid(1536), stream=stream0)
        del arg49_1
        del arg63_1
        del arg78_1
        del arg79_1
        del buf134
        del buf136
        buf147 = buf72; del buf72  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf146, (1536, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf147)
        buf150 = reinterpret_tensor(buf151, (48, 1, 1, 128), (4224, 1, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf146, buf150, 6144, 32, grid=grid(6144), stream=stream0)
        del buf149
        del buf150
        buf152 = buf77; del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf151, (1584, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf152)
        del arg80_1
        buf153 = reinterpret_tensor(buf146, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf147, arg81_1, buf153, 196608, grid=grid(196608), stream=stream0)
        del buf147
        buf154 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_26.run(buf152, arg81_1, buf154, 221184, grid=grid(221184), stream=stream0)
        buf155 = buf80; del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(reinterpret_tensor(buf153, (384, 32, 16), (512, 16, 1), 0), buf154, out=buf155)
        del buf154
        buf156 = reinterpret_tensor(buf151, (48, 1, 32, 33, 4), (4224, 202752, 132, 4, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_27.run(arg30_1, buf156, 202752, grid=grid(202752), stream=stream0)
        del arg30_1
        ...
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf156, 6144, grid=grid(6144), stream=stream0)
        buf158 = buf83; del buf83  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf156, buf158, 50688, grid=grid(50688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf158, 1536, grid=grid(1536), stream=stream0)
        buf161 = reinterpret_tensor(buf90, (48, 1, 32, 33, 8), (8448, 405504, 33, 1, 1056), 0); del buf90  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg31_1, buf155, buf158, buf156, buf161, 12288, 33, grid=grid(12288), stream=stream0)
        del buf155
        buf162 = buf87; del buf87  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_32.run(buf161, buf162, 12288, 33, grid=grid(12288), stream=stream0)
        buf163 = reinterpret_tensor(buf81, (48, 1, 32, 33, 4), (4224, 1, 132, 4, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf158, buf156, buf163, 202752, grid=grid(202752), stream=stream0)
        del buf156
        del buf158
        buf164 = buf89; del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (50688, 4), (4, 1), 0), reinterpret_tensor(arg82_1, (4, 8), (1, 4), 0), out=buf164)
        del arg82_1
        buf165 = reinterpret_tensor(buf161, (48, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf165, buf162, arg31_1, buf164, arg83_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg31_1
        del arg83_1
        del buf162
        del buf164
        buf166 = reinterpret_tensor(buf163, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf152, arg81_1, buf166, 202752, grid=grid(202752), stream=stream0)
        del arg81_1
        del buf152
        buf167 = reinterpret_tensor(buf153, (384, 32, 16), (512, 16, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf165, (384, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf166, (384, 33, 16), (528, 16, 1), 0), out=buf167)
        del buf165
        del buf166
        buf168 = reinterpret_tensor(buf95, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf167, buf168, 196608, grid=grid(196608), stream=stream0)
        buf169 = reinterpret_tensor(buf167, (1536, 128), (128, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (1536, 128), (128, 1), 0), reinterpret_tensor(arg84_1, (128, 128), (1, 128), 0), out=buf169)
        del arg84_1
        buf175 = reinterpret_tensor(buf168, (48, 32, 128), (4096, 128, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf142, buf169, arg85_1, arg86_1, arg87_1, buf175, 1536, 128, grid=grid(1536), stream=stream0)
        del arg86_1
        del arg87_1
        buf173 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg93_1, reinterpret_tensor(buf133, (512, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf173)
        del arg92_1
        del arg93_1
        buf174 = empty_strided_cuda((16, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf173, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf173, (16, 32, 32), (1024, 1, 32), 0), out=buf174)
        buf176 = reinterpret_tensor(buf140, (1536, 512), (512, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf175, (1536, 128), (128, 1), 0), reinterpret_tensor(arg88_1, (128, 512), (1, 128), 0), out=buf176)
        del arg88_1
        ...
        triton_poi_fused_gelu_39.run(buf177, arg89_1, 786432, grid=grid(786432), stream=stream0)
        del arg89_1
        buf178 = reinterpret_tensor(buf175, (1536, 128), (128, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf177, (1536, 512), (512, 1), 0), reinterpret_tensor(arg90_1, (512, 128), (1, 512), 0), out=buf178)
        del arg90_1
        del buf177
        buf179 = reinterpret_tensor(buf178, (48, 32, 128), (4096, 128, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf179, buf142, buf169, arg85_1, arg91_1, 196608, grid=grid(196608), stream=stream0)
        del arg85_1
        del arg91_1
        del buf142
        del buf169
        buf180 = empty_strided_cuda((1536, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf179, (1536, 128), (128, 1), 0), reinterpret_tensor(arg94_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf180)
        del arg94_1
        del arg95_1
        buf181 = empty_strided_cuda((1536, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg97_1, reinterpret_tensor(buf179, (1536, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf181)
        del arg96_1
        del arg97_1
        del buf179
        buf182 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf180, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf181, (48, 32, 32), (1024, 1, 32), 0), out=buf182)
        del buf180
        del buf181
        buf183 = buf173; del buf173  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf133, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf183)
        del arg100_1
        del arg101_1
        buf184 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf133, (512, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf184)
        del arg102_1
        del arg103_1
        buf185 = empty_strided_cuda((512, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf133, (512, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 1), (1, 128), 0), out=buf185)
        del arg98_1
        del buf133
        buf186 = reinterpret_tensor(buf185, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_43.run(buf186, arg99_1, 512, grid=grid(512), stream=stream0)
        del arg99_1
        buf187 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf174, buf182, buf183, buf184, buf186, buf187, 98816, grid=grid(98816), stream=stream0)
        del buf174
        del buf182
        del buf183
        del buf184
    return (buf187, reinterpret_tensor(buf186, (1, 16, 32), (512, 32, 1), 0), buf62, buf65, buf56, )
