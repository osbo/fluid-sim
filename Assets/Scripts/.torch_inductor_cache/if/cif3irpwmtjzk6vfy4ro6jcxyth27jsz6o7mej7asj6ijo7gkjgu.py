...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, out_ptr4, xnumel, rnumel):
    ...
    tmp26 = tmp24 * tmp25
    tmp28 = tmp26 + tmp27
    tl.store(out_ptr2 + (r1 + (512*x0)), tmp4, None)
    tl.store(out_ptr3 + (r1 + (512*x0)), tmp28, None)
    tl.store(out_ptr4 + (r1 + (512*x2) + (16896*x3)), tmp28, None)
