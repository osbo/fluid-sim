...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7i/c7ip64xtu4csk77bmfeco4uxqx7jo2bdr5zcuerim62xqkwgjnmf.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 8192)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (16*x2) + (192*x1) + (24576*x3)), None)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4z/c4zx425cftojerzpidmnvigyyryxpt7e4yebchpwapmmdhyayy6v.py
# Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f => clone_2
#   logit_bias => clone_4
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 8192)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (64 + x0 + (16*x2) + (192*x1) + (24576*x3)), None)
    tmp1 = tl.load(in_ptr1 + (64 + x0 + (16*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/y4/cy4clrrgwea6tywhyfqj6q2lqmu6idhftmtrkkkko3vv6jflo6ol.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 8192)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (128 + x0 + (16*x2) + (192*x1) + (24576*x3)), None)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/cf/ccfb7jcyaidjv2wmv6rbu7335diwptk227nqe5kjja3dmfrch2p7.py
# Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f => clone_2
#   logit_bias => clone_4
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/mb/cmbjfvj5grys5hoy2jx6afm7q7nfenuegmcpthgkvyqhwun5jriy.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/bq/cbq4s4p57zccesordwgfo7xz4zfociekic4oug4jewtab2fb5den.py
...
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x0 + (16*x2) + (2048*x1) + (8192*x3)), None)
    tmp2 = tmp0 + tmp1
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fc/cfceapgbscdguv7wdog6kzpikcmvyw2eqt5h6td24lkn2l6wytrt.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/io/ciosuvyaxiahx2frogzchuylrh2wkjh62s3l7x3nz3pgxdi6kbwi.py
# Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
# Source node to ATen node mapping:
#   row_sum_1 => full_default_4
# Graph fragment:
#   %full_default_4 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ay/caycdjvrdmsdap4dc742hw7whdi5adr5e3swekbhixdi3ir6oxe5.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/f3/cf3xbivbrjof6rer7bnfkjtijomcrnsmavqssnbe3hnox22kzgze.py
...
# Graph fragment:
#   %full_default_4 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_4 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_29, [%device_put]), kwargs = {})
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_4, [%device_put_2], %index_4, True), kwargs = {})
#   %full_default_5 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_5 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_29, [%device_put_1]), kwargs = {})
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_5, [%device_put_2], %index_5, True), kwargs = {})
#   %full_default_10 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_6 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_62, [%device_put]), kwargs = {})
#   %index_put_12 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_10, [%device_put_2], %index_6, True), kwargs = {})
#   %full_default_11 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([109, 1, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_7 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_62, [%device_put_1]), kwargs = {})
#   %index_put_13 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_11, [%device_put_2], %index_7, True), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5d/c5djfw4rd5ubwj3g2o5xhntr4jbzdttlg4psk4zswf7vvjaysacm.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/22/c22wbfohbtkmvcejqph35f7punvube6z7vsionmcrm3xnckqcfmn.py
...
@triton.jit
def triton_(in_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 446464
    rnumel = 16
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/q4/cq4siooqiiwmpl2mqavr4jp3s4vrt7on636ducxrxzl6s7274qtu.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 2048)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (16*x2) + (192*x1) + (6144*x3)), None)
    tmp1 = tl.load(in_ptr1 + (x0 + (16*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, None)
''', device_str='cuda')
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3w/c3w6drpdg4vkm7dugbuytrxlkfepbd7btxaek2in7n4rinhyp2he.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f_1 => clone_9
#   logit_bias_1 => clone_11
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 2048)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (64 + x0 + (16*x2) + (192*x1) + (6144*x3)), None)
    tmp1 = tl.load(in_ptr1 + (64 + x0 + (16*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, None)
''', device_str='cuda')
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3c/c3cbwqv6rfpkjj33grr4jy6p3qsrugnxvr6yuqv4kyvutoimfrzd.py
...
def triton_(in_ptr0, in_ptr1, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 2048)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (128 + x0 + (16*x2) + (192*x1) + (6144*x3)), None)
    tmp1 = tl.load(in_ptr1 + (128 + x0 + (16*x2)), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x4), tmp2, None)
    tl.store(out_ptr1 + (x4), tmp2, None)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/zf/czf7pqqkqknamg5gzd5mw2tyr6lachq655jn5nnub5as3stlvu7h.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f_1 => clone_9
#   logit_bias_1 => clone_11
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/p6/cp66scuvwgijrixfkqv2ddfy2lmdikpd6lrueazlyh56iuvymbyz.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/z6/cz6eid3oorkrnpweydpj3xoecamwbk4y27gviqdf6nxzcoxnmzd6.py
...
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 2048)
    tmp0 = tl.load(in_out_ptr0 + (x4), None)
    tmp1 = tl.load(in_ptr0 + (x0 + (16*x2) + (512*x1) + (2048*x3)), None)
    tmp2 = tmp0 + tmp1
    tl.store(in_out_ptr0 + (x4), tmp2, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5t/c5tedy5ohyelrkusd4nf27mvhev6it5tokxwhqymacm43um6zbd7.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/24/c24n7m3fpiuogoazzx3zukawo4alz5def5qwiw7spfzl2leof6s2.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/mc/cmc2dun32kgvk5vb7mepyhllnlj4ypgselo7arkqtuikrhdpws2o.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ye/cyejdii7qnmny5tpqs7rvbequp3dspx3gsk23ixgkgbunvjfib4j.py
...
def call(args):
    ...
    assert_size_stride(arg56_1, (4, 16), (16, 1))
    ...
    assert_size_stride(arg72_1, (4, 16), (16, 1))
    assert_size_stride(arg73_1, (4, ), (1, ))
    assert_size_stride(arg74_1, (64, 64), (64, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [layer_norm_1], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_6.run(buf25, arg34_1, arg35_1, buf29, 4096, 64, grid=grid(4096), stream=stream0)
        del arg34_1
        del arg35_1
        buf30 = empty_strided_cuda((4096, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf29, (4096, 64), (64, 1), 0), reinterpret_tensor(arg36_1, (64, 192), (1, 64), 0), out=buf30)
        del arg36_1
        buf31 = empty_strided_cuda((1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), torch.float32)
        buf105 = empty_strided_cuda((1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem, setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_7.run(arg28_1, buf31, buf105, 2097152, grid=grid(2097152), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        buf35 = reinterpret_tensor(buf29, (32, 4, 128, 16), (8192, 2048, 16, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_11.run(buf30, arg37_1, buf35, 262144, grid=grid(262144), stream=stream0)
        buf36 = reinterpret_tensor(buf12, (32, 4, 128, 16), (8192, 2048, 16, 1), 0); del buf12  # reuse
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf30, arg37_1, buf36, 262144, grid=grid(262144), stream=stream0)
        buf37 = empty_strided_cuda((32, 4, 128, 16), (8192, 2048, 16, 1), torch.float32)
        buf49 = empty_strided_cuda((32, 4, 128, 1, 16, 1), (8192, 2048, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft, einsum], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf30, arg37_1, buf37, buf49, 262144, grid=grid(262144), stream=stream0)
        del arg37_1
        buf38 = empty_strided_cuda((32, 4, 128, 128), (65536, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f, k_f, v_f, logit_bias, x_soft], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf40 = buf39[0]
        del buf39
        buf44 = reinterpret_tensor(buf38, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf38  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg39_1
        buf47 = reinterpret_tensor(buf44, (524288, 4), (4, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf46, (524288, 16), (16, 1), 0), reinterpret_tensor(arg40_1, (16, 4), (1, 16), 0), out=buf47)
        del arg40_1
        buf48 = reinterpret_tensor(buf31, (32, 4, 128, 128, 1, 1), (65536, 16384, 128, 1, 1, 1), 0); del buf31  # reuse
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf47, arg41_1, buf48, 128, 16384, grid=grid(128, 16384), stream=stream0)
        del arg41_1
        del buf47
        buf50 = reinterpret_tensor(buf37, (128, 128, 16), (2048, 16, 1), 0); del buf37  # reuse
        ...
        buf51 = reinterpret_tensor(buf40, (1, 32, 128, 4, 16), (262144, 8192, 64, 16, 1), 0); del buf40  # reuse
        # Topologically Sorted Source Nodes: [x_mid], Original ATen: [aten.add]
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf51, (4096, 64), (64, 1), 0), reinterpret_tensor(arg42_1, (64, 64), (1, 64), 0), out=buf52)
        del arg42_1
        buf57 = reinterpret_tensor(buf51, (1, 4096, 64), (262144, 64, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf52, arg43_1, arg44_1, arg45_1, buf57, 4096, 64, grid=grid(4096), stream=stream0)
        del arg44_1
        del arg45_1
        buf56 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf56.copy_(arg32_1)
        del arg32_1
        buf58 = empty_strided_cuda((4096, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (4096, 64), (64, 1), 0), reinterpret_tensor(arg46_1, (64, 256), (1, 64), 0), out=buf58)
        del arg46_1
        buf59 = reinterpret_tensor(buf58, (1, 4096, 256), (1048576, 256, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf59, arg47_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg47_1
        buf60 = reinterpret_tensor(buf57, (4096, 64), (64, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (4096, 256), (256, 1), 0), reinterpret_tensor(arg48_1, (256, 64), (1, 256), 0), out=buf60)
        del arg48_1
        buf61 = reinterpret_tensor(buf60, (1, 4096, 64), (262144, 64, 1), 0); del buf60  # reuse
        buf103 = reinterpret_tensor(buf49, (1, 4096, 64), (262144, 64, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_20.run(buf61, buf25, buf52, arg43_1, arg49_1, arg66_1, arg67_1, buf103, 4096, 64, grid=grid(4096), stream=stream0)
        del arg43_1
        del arg49_1
        del arg66_1
        del arg67_1
        buf62 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf62.copy_(arg30_1)
        del arg30_1
        buf63 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf63, 892928, grid=grid(892928), stream=stream0)
        buf104 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (4096, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 192), (1, 64), 0), out=buf104)
        del arg68_1
        buf109 = reinterpret_tensor(buf103, (32, 4, 128, 16), (8192, 2048, 16, 1), 0); del buf103  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_11.run(buf104, arg69_1, buf109, 262144, grid=grid(262144), stream=stream0)
        buf110 = reinterpret_tensor(buf52, (32, 4, 128, 16), (8192, 2048, 16, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf104, arg69_1, buf110, 262144, grid=grid(262144), stream=stream0)
        buf111 = reinterpret_tensor(buf25, (32, 4, 128, 16), (8192, 2048, 16, 1), 0); del buf25  # reuse
        buf123 = reinterpret_tensor(buf36, (32, 4, 128, 1, 16, 1), (8192, 2048, 16, 16, 1, 1), 0); del buf36  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf104, arg69_1, buf111, buf123, 262144, grid=grid(262144), stream=stream0)
        del arg69_1
        del buf104
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_8.run(buf105, 16384, grid=grid(16384), stream=stream0)
        buf107 = buf33; del buf33  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_9.run(buf105, buf107, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_10.run(buf107, 4096, grid=grid(4096), stream=stream0)
        buf112 = reinterpret_tensor(buf48, (32, 4, 128, 128), (65536, 16384, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf107, buf105, buf112, 2097152, grid=grid(2097152), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf113 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf109, buf110, buf111, buf112, False)
        del buf109
        del buf110
        buf114 = buf113[0]
        del buf113
        buf118 = reinterpret_tensor(buf112, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf107, buf105, buf118, 2097152, grid=grid(2097152), stream=stream0)
        buf119 = reinterpret_tensor(buf46, (524288, 16), (16, 1), 0); del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf118, (524288, 4), (4, 1), 0), reinterpret_tensor(arg70_1, (4, 16), (1, 4), 0), out=buf119)
        del arg70_1
        buf120 = reinterpret_tensor(buf119, (1, 32, 128, 128, 16), (8388608, 262144, 2048, 16, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_16.run(buf120, arg71_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg71_1
        buf121 = reinterpret_tensor(buf118, (524288, 4), (4, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (524288, 16), (16, 1), 0), reinterpret_tensor(arg72_1, (16, 4), (1, 16), 0), out=buf121)
        del arg72_1
        del buf120
        buf122 = reinterpret_tensor(buf105, (32, 4, 128, 128, 1, 1), (65536, 16384, 128, 1, 1, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf121, arg73_1, buf122, 128, 16384, grid=grid(128, 16384), stream=stream0)
        del arg73_1
        del buf121
        buf124 = reinterpret_tensor(buf111, (128, 128, 16), (2048, 16, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf122, (128, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf123, (128, 128, 16), (2048, 16, 1), 0), out=buf124)
        del buf122
        del buf123
        buf125 = reinterpret_tensor(buf114, (1, 32, 128, 4, 16), (262144, 8192, 64, 16, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.add]
        triton_poi_fused_add_18.run(buf125, buf124, 262144, grid=grid(262144), stream=stream0)
        buf126 = reinterpret_tensor(buf124, (4096, 64), (64, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf125, (4096, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 64), (1, 64), 0), out=buf126)
        del arg74_1
        buf130 = reinterpret_tensor(buf125, (1, 4096, 64), (262144, 64, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf61, buf126, arg75_1, arg76_1, arg77_1, buf130, 4096, 64, grid=grid(4096), stream=stream0)
        del arg76_1
        del arg77_1
        buf131 = reinterpret_tensor(buf59, (4096, 256), (256, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf130, (4096, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 256), (1, 64), 0), out=buf131)
        del arg78_1
        buf132 = reinterpret_tensor(buf131, (1, 4096, 256), (1048576, 256, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf132, arg79_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg79_1
        buf133 = reinterpret_tensor(buf130, (4096, 64), (64, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf132, (4096, 256), (256, 1), 0), reinterpret_tensor(arg80_1, (256, 64), (1, 256), 0), out=buf133)
        del arg80_1
        del buf132
        buf134 = reinterpret_tensor(buf133, (1, 4096, 64), (262144, 64, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_22.run(buf134, buf61, buf126, arg75_1, arg81_1, 262144, grid=grid(262144), stream=stream0)
        del arg75_1
        del arg81_1
        del buf126
        buf135 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf135, 892928, grid=grid(892928), stream=stream0)
        buf137 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf137, 892928, grid=grid(892928), stream=stream0)
        buf65 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf65.copy_(arg31_1)
        del arg31_1
        buf66 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf66, 892928, grid=grid(892928), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_16, index_add__4, col_sum_1, getitem_17, index_add__5, row_sum_2, getitem_28, index_add__6, col_sum_2, getitem_29, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_23.run(buf56, buf62, buf61, buf65, buf134, buf63, buf66, buf135, buf137, 1458176, grid=grid(1458176), stream=stream0)
        del buf61
        buf68 = empty_strided_cuda((109, 32, 64), (2048, 64, 1), torch.float32)
        buf72 = empty_strided_cuda((109, 32, 64), (2048, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_24.run(buf63, arg33_1, buf66, arg50_1, arg51_1, buf68, buf72, 3488, 64, grid=grid(3488), stream=stream0)
        del arg50_1
        del arg51_1
        del buf63
        buf73 = empty_strided_cuda((3488, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf72, (3488, 64), (64, 1), 0), reinterpret_tensor(arg52_1, (64, 192), (1, 64), 0), out=buf73)
        del arg52_1
        buf75 = empty_strided_cuda((109, 1, 32, 32, 4), (4096, 446464, 128, 4, 1), torch.float32)
        buf150 = empty_strided_cuda((109, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [sub, setitem_2], Original ATen: [aten.mean, aten.lift_fresh, aten.index_put]
        triton_per_fused_index_put_lift_fresh_mean_25.run(arg29_1, buf75, buf150, 446464, 16, grid=grid(446464), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf75, 13952, grid=grid(13952), stream=stream0)
        buf77 = empty_strided_cuda((109, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf75, buf77, 111616, grid=grid(111616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf77, 3488, grid=grid(3488), stream=stream0)
        buf79 = reinterpret_tensor(buf72, (109, 4, 32, 16), (2048, 512, 16, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf73, arg53_1, buf79, 223232, grid=grid(223232), stream=stream0)
        buf80 = empty_strided_cuda((109, 4, 32, 16), (2048, 512, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf73, arg53_1, buf80, 223232, grid=grid(223232), stream=stream0)
        buf81 = empty_strided_cuda((109, 4, 32, 16), (2048, 512, 16, 1), torch.float32)
        buf93 = empty_strided_cuda((109, 4, 32, 1, 16, 1), (2048, 512, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_1], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf73, arg53_1, buf81, buf93, 223232, grid=grid(223232), stream=stream0)
        del arg53_1
        buf82 = empty_strided_cuda((109, 4, 32, 32), (4096, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf77, buf75, buf82, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf83 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf79, buf80, buf81, buf82, False)
        del buf79
        buf84 = buf83[0]
        del buf83
        buf88 = reinterpret_tensor(buf82, (109, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf77, buf75, buf88, 446464, grid=grid(446464), stream=stream0)
        buf89 = empty_strided_cuda((111616, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf88, (111616, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 16), (1, 4), 0), out=buf89)
        del arg54_1
        buf90 = reinterpret_tensor(buf89, (109, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_34.run(buf90, arg55_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg55_1
        buf91 = reinterpret_tensor(buf88, (111616, 4), (4, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf90, (111616, 16), (16, 1), 0), reinterpret_tensor(arg56_1, (16, 4), (1, 16), 0), out=buf91)
        del arg56_1
        buf92 = reinterpret_tensor(buf75, (109, 4, 32, 32, 1, 1), (4096, 1024, 32, 1, 1, 1), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf91, arg57_1, buf92, 436, 1024, grid=grid(436, 1024), stream=stream0)
        del arg57_1
        del buf91
        buf94 = reinterpret_tensor(buf81, (436, 32, 16), (512, 16, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf92, (436, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf93, (436, 32, 16), (512, 16, 1), 0), out=buf94)
        buf95 = reinterpret_tensor(buf84, (109, 1, 32, 4, 16), (2048, 1, 64, 16, 1), 0); del buf84  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf95, buf94, 223232, grid=grid(223232), stream=stream0)
        buf96 = reinterpret_tensor(buf94, (3488, 64), (64, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf95, (3488, 64), (64, 1), 0), reinterpret_tensor(arg58_1, (64, 64), (1, 64), 0), out=buf96)
        del arg58_1
        buf140 = reinterpret_tensor(buf95, (109, 32, 64), (2048, 64, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf68, buf96, arg59_1, arg60_1, arg61_1, buf140, 3488, 64, grid=grid(3488), stream=stream0)
        del arg60_1
        del arg61_1
        buf141 = reinterpret_tensor(buf66, (3488, 256), (256, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf140, (3488, 64), (64, 1), 0), reinterpret_tensor(arg62_1, (64, 256), (1, 64), 0), out=buf141)
        del arg62_1
        buf142 = reinterpret_tensor(buf141, (109, 32, 256), (8192, 256, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf142, arg63_1, 892928, grid=grid(892928), stream=stream0)
        del arg63_1
        buf143 = reinterpret_tensor(buf140, (3488, 64), (64, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (3488, 256), (256, 1), 0), reinterpret_tensor(arg64_1, (256, 64), (1, 256), 0), out=buf143)
        del arg64_1
        del buf142
        buf139 = reinterpret_tensor(buf93, (109, 32, 64), (2048, 64, 1), 0); del buf93  # reuse
        buf144 = buf139; del buf139  # reuse
        buf148 = reinterpret_tensor(buf80, (109, 32, 64), (2048, 64, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [x_2, h_off_5, x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_39.run(buf144, buf135, arg33_1, buf137, buf68, buf96, arg59_1, buf143, arg65_1, arg82_1, arg83_1, buf148, 3488, 64, grid=grid(3488), stream=stream0)
        del arg33_1
        del arg59_1
        del arg65_1
        del arg82_1
        del arg83_1
        del buf135
        buf149 = buf73; del buf73  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf148, (3488, 64), (64, 1), 0), reinterpret_tensor(arg84_1, (64, 192), (1, 64), 0), out=buf149)
        del arg84_1
        # Topologically Sorted Source Nodes: [setitem_6], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf150, 13952, grid=grid(13952), stream=stream0)
        buf152 = buf77; del buf77  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf150, buf152, 111616, grid=grid(111616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf152, 3488, grid=grid(3488), stream=stream0)
        buf154 = reinterpret_tensor(buf148, (109, 4, 32, 16), (2048, 512, 16, 1), 0); del buf148  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf149, arg85_1, buf154, 223232, grid=grid(223232), stream=stream0)
        buf155 = reinterpret_tensor(buf96, (109, 4, 32, 16), (2048, 512, 16, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf149, arg85_1, buf155, 223232, grid=grid(223232), stream=stream0)
        buf156 = reinterpret_tensor(buf68, (109, 4, 32, 16), (2048, 512, 16, 1), 0); del buf68  # reuse
        buf168 = reinterpret_tensor(buf143, (109, 4, 32, 1, 16, 1), (2048, 512, 16, 16, 1, 1), 0); del buf143  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf149, arg85_1, buf156, buf168, 223232, grid=grid(223232), stream=stream0)
        del arg85_1
        del buf149
        buf157 = reinterpret_tensor(buf92, (109, 4, 32, 32), (4096, 1024, 32, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf152, buf150, buf157, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf158 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf154, buf155, buf156, buf157, False)
        del buf154
        del buf155
        buf159 = buf158[0]
        del buf158
        buf163 = reinterpret_tensor(buf157, (109, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf152, buf150, buf163, 446464, grid=grid(446464), stream=stream0)
        buf164 = reinterpret_tensor(buf90, (111616, 16), (16, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (111616, 4), (4, 1), 0), reinterpret_tensor(arg86_1, (4, 16), (1, 4), 0), out=buf164)
        del arg86_1
        buf165 = reinterpret_tensor(buf164, (109, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_34.run(buf165, arg87_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg87_1
        buf166 = reinterpret_tensor(buf163, (111616, 4), (4, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (111616, 16), (16, 1), 0), reinterpret_tensor(arg88_1, (16, 4), (1, 16), 0), out=buf166)
        del arg88_1
        del buf165
        buf167 = reinterpret_tensor(buf150, (109, 4, 32, 32, 1, 1), (4096, 1024, 32, 1, 1, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf166, arg89_1, buf167, 436, 1024, grid=grid(436, 1024), stream=stream0)
        del arg89_1
        del buf166
        buf169 = reinterpret_tensor(buf156, (436, 32, 16), (512, 16, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf167, (436, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf168, (436, 32, 16), (512, 16, 1), 0), out=buf169)
        del buf167
        del buf168
        buf170 = reinterpret_tensor(buf159, (109, 1, 32, 4, 16), (2048, 1, 64, 16, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf170, buf169, 223232, grid=grid(223232), stream=stream0)
        buf171 = reinterpret_tensor(buf169, (3488, 64), (64, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (3488, 64), (64, 1), 0), reinterpret_tensor(arg90_1, (64, 64), (1, 64), 0), out=buf171)
        del arg90_1
        buf177 = reinterpret_tensor(buf170, (109, 32, 64), (2048, 64, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf144, buf171, arg91_1, arg92_1, arg93_1, buf177, 3488, 64, grid=grid(3488), stream=stream0)
        del arg92_1
        del arg93_1
        buf175 = reinterpret_tensor(buf107, (4096, 128), (128, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg99_1, reinterpret_tensor(buf134, (4096, 64), (64, 1), 0), reinterpret_tensor(arg98_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf175)
        del arg98_1
        del arg99_1
        buf176 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf175, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf175, (32, 128, 128), (16384, 1, 128), 0), out=buf176)
        del buf175
        buf178 = reinterpret_tensor(buf137, (3488, 256), (256, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf177, (3488, 64), (64, 1), 0), reinterpret_tensor(arg94_1, (64, 256), (1, 64), 0), out=buf178)
        del arg94_1
        buf179 = reinterpret_tensor(buf178, (109, 32, 256), (8192, 256, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf179, arg95_1, 892928, grid=grid(892928), stream=stream0)
        del arg95_1
        buf180 = reinterpret_tensor(buf177, (3488, 64), (64, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf179, (3488, 256), (256, 1), 0), reinterpret_tensor(arg96_1, (256, 64), (1, 256), 0), out=buf180)
        del arg96_1
        del buf179
        buf181 = reinterpret_tensor(buf180, (109, 32, 64), (2048, 64, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf181, buf144, buf171, arg91_1, arg97_1, 223232, grid=grid(223232), stream=stream0)
        del arg91_1
        del arg97_1
        del buf144
        del buf171
        buf182 = reinterpret_tensor(buf152, (3488, 32), (32, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf181, (3488, 64), (64, 1), 0), reinterpret_tensor(arg100_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf182)
        del arg100_1
        del arg101_1
        buf183 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf181, (3488, 64), (64, 1), 0), reinterpret_tensor(arg102_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf183)
        del arg102_1
        del arg103_1
        del buf181
        buf184 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf182, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf183, (109, 32, 32), (1024, 1, 32), 0), out=buf184)
        del buf182
        del buf183
        buf185 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg107_1, reinterpret_tensor(buf134, (4096, 64), (64, 1), 0), reinterpret_tensor(arg106_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf185)
        del arg106_1
        del arg107_1
        buf186 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf134, (4096, 64), (64, 1), 0), reinterpret_tensor(arg108_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf186)
        del arg108_1
        del arg109_1
        buf187 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (4096, 64), (64, 1), 0), reinterpret_tensor(arg104_1, (64, 1), (1, 64), 0), out=buf187)
        del arg104_1
        del buf134
        buf188 = reinterpret_tensor(buf187, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_41.run(buf188, arg105_1, 4096, grid=grid(4096), stream=stream0)
        del arg105_1
        buf189 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_42.run(buf176, buf184, buf185, buf186, buf188, buf189, 902144, grid=grid(902144), stream=stream0)
        del buf176
        del buf184
        del buf185
        del buf186
    return (buf189, reinterpret_tensor(buf188, (1, 32, 128), (4096, 128, 1), 0), buf62, buf65, buf56, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg30_1 = rand_strided((178, ), (1, ), device='cpu', dtype=torch.int64)
    arg31_1 = rand_strided((178, ), (1, ), device='cpu', dtype=torch.int64)
    ...
    arg36_1 = rand_strided((192, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg40_1 = rand_strided((4, 16), (16, 1), device='cuda:0', dtype=torch.float32)
    arg41_1 = rand_strided((4, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg42_1 = rand_strided((64, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg46_1 = rand_strided((256, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    arg47_1 = rand_strided((256, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg48_1 = rand_strided((64, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg56_1 = rand_strided((4, 16), (16, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg72_1 = rand_strided((4, 16), (16, 1), device='cuda:0', dtype=torch.float32)
    arg73_1 = rand_strided((4, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg74_1 = rand_strided((64, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg80_1 = rand_strided((64, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg84_1 = rand_strided((192, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg88_1 = rand_strided((4, 16), (16, 1), device='cuda:0', dtype=torch.float32)
    arg89_1 = rand_strided((4, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg90_1 = rand_strided((64, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg94_1 = rand_strided((256, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg98_1 = rand_strided((128, 64), (64, 1), device='cuda:0', dtype=torch.float32)
