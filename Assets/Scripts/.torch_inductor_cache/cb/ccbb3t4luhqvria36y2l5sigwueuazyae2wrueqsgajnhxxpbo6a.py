...
def call(args):
    ...
    assert_size_stride(arg45_1, (128, 96), (96, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, z, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_20.run(buf25, buf52, arg41_1, arg42_1, arg43_1, arg44_1, buf56, buf58, buf60, 4096, 32, grid=grid(4096), stream=stream0)
        del arg43_1
        del arg44_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf63, (4096, 96), (96, 1), 0), reinterpret_tensor(arg45_1, (96, 128), (1, 96), 0), out=buf64)
        del arg45_1
        del buf63
        buf65 = reinterpret_tensor(buf64, (1, 4096, 128), (524288, 128, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf65, arg46_1, 524288, grid=grid(524288), stream=stream0)
        del arg46_1
        buf66 = reinterpret_tensor(buf58, (4096, 32), (32, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf65, (4096, 128), (128, 1), 0), reinterpret_tensor(arg47_1, (128, 32), (1, 128), 0), out=buf66)
        del arg47_1
        ...
        buf110 = reinterpret_tensor(buf36, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [col_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf110, 131072, grid=grid(131072), stream=stream0)
        buf134 = reinterpret_tensor(buf35, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf35  # reuse
        # Topologically Sorted Source Nodes: [col_highway_2], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf134, 131072, grid=grid(131072), stream=stream0)
        buf137 = empty_strided_cuda((1, 32, 128, 32), (131072, 4096, 32, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9, row_highway_2, index_add__8], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_23.run(buf67, buf25, buf52, arg41_1, arg48_1, arg42_1, buf106, buf110, buf134, buf137, 131072, grid=grid(131072), stream=stream0)
        del arg41_1
        del arg42_1
        del arg48_1
        del buf25
        ...
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_24.run(buf68, buf69, arg49_1, arg50_1, buf70, buf74, 3488, 32, grid=grid(3488), stream=stream0)
        del arg49_1
        del arg50_1
        buf75 = empty_strided_cuda((3488, 96), (96, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf74, (3488, 32), (32, 1), 0), reinterpret_tensor(arg51_1, (32, 96), (1, 32), 0), out=buf75)
        del arg51_1
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf75, arg52_1, buf81, 111616, grid=grid(111616), stream=stream0)
        buf82 = empty_strided_cuda((109, 8, 32, 4), (1024, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf75, arg52_1, buf82, 111616, grid=grid(111616), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf75, arg52_1, buf83, buf95, 111616, grid=grid(111616), stream=stream0)
        del arg52_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (3488, 32), (32, 1), 0), reinterpret_tensor(arg57_1, (32, 32), (1, 32), 0), out=buf98)
        del arg57_1
        buf117 = reinterpret_tensor(buf75, (109, 32, 96), (3072, 96, 1), 0); del buf75  # reuse
        buf114 = reinterpret_tensor(buf117, (109, 32, 32), (3072, 96, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf70, buf98, arg58_1, arg62_1, arg63_1, buf114, 3488, 32, grid=grid(3488), stream=stream0)
        del arg62_1
        del arg63_1
        ...
        del buf104
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_38.run(arg60_1, arg59_1, buf70, buf98, arg58_1, arg61_1, buf106, buf110, 729088, grid=grid(729088), stream=stream0)
        buf109 = reinterpret_tensor(buf90, (1, 109, 4096), (446464, 4096, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf106, (1, 32, 4096), (131072, 4096, 1), 0), out=buf109)
        del arg30_1
        buf113 = reinterpret_tensor(buf77, (1, 109, 4096), (446464, 4096, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf110, (1, 32, 4096), (131072, 4096, 1), 0), out=buf113)
        del arg31_1
        buf115 = reinterpret_tensor(buf117, (109, 32, 32), (3072, 96, 1), 32)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf109, buf115, 111616, grid=grid(111616), stream=stream0)
        del buf109
        buf116 = reinterpret_tensor(buf117, (109, 32, 32), (3072, 96, 1), 64)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf113, buf116, 111616, grid=grid(111616), stream=stream0)
        del buf114
        del buf115
        del buf116
        buf118 = reinterpret_tensor(buf113, (3488, 128), (128, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf117, (3488, 96), (96, 1), 0), reinterpret_tensor(arg64_1, (96, 128), (1, 96), 0), out=buf118)
        del arg64_1
        del buf117
        buf119 = reinterpret_tensor(buf118, (109, 32, 128), (4096, 128, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_40.run(buf119, arg65_1, 446464, grid=grid(446464), stream=stream0)
        del arg65_1
        buf120 = reinterpret_tensor(buf97, (3488, 32), (32, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (3488, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 32), (1, 128), 0), out=buf120)
        del arg66_1
        del buf119
        buf121 = reinterpret_tensor(buf120, (109, 32, 32), (1024, 32, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_41.run(buf121, buf70, buf98, arg58_1, arg67_1, 111616, grid=grid(111616), stream=stream0)
        del arg58_1
        del arg67_1
        buf122 = buf98; del buf98  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (3488, 32), (32, 1), 0), reinterpret_tensor(arg72_1, (32, 32), (1, 32), 0), out=buf122)
        del arg72_1
        buf123 = reinterpret_tensor(buf122, (109, 1, 32, 32), (1024, 1, 32, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf123, arg73_1, 111616, grid=grid(111616), stream=stream0)
        del arg73_1
        buf124 = reinterpret_tensor(buf70, (3488, 32), (32, 1), 0); del buf70  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf123, (3488, 32), (32, 1), 0), reinterpret_tensor(arg74_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf124)
        del arg74_1
        del arg75_1
        buf125 = reinterpret_tensor(buf123, (3488, 32), (32, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (3488, 32), (32, 1), 0), reinterpret_tensor(arg76_1, (32, 32), (1, 32), 0), out=buf125)
        del arg76_1
        ...
        triton_poi_fused_gelu_42.run(buf126, arg77_1, 111616, grid=grid(111616), stream=stream0)
        del arg77_1
        buf127 = reinterpret_tensor(buf95, (3488, 32), (32, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf126, (3488, 32), (32, 1), 0), reinterpret_tensor(arg78_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf127)
        del arg78_1
        del arg79_1
        buf128 = reinterpret_tensor(buf126, (109, 32, 32), (1024, 32, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf124, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf127, (109, 32, 32), (1024, 1, 32), 0), out=buf128)
        del buf124
        del buf127
        buf129 = reinterpret_tensor(buf110, (4096, 32), (32, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf67, (4096, 32), (32, 1), 0), reinterpret_tensor(arg82_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf129)
        del arg82_1
        del arg83_1
        buf130 = reinterpret_tensor(buf106, (4096, 32), (32, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf67, (4096, 32), (32, 1), 0), reinterpret_tensor(arg84_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf130)
        del arg84_1
        del arg85_1
        buf131 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (4096, 32), (32, 1), 0), reinterpret_tensor(arg80_1, (32, 1), (1, 32), 0), out=buf131)
        del arg80_1
        del buf67
        buf132 = reinterpret_tensor(buf131, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_43.run(buf132, arg81_1, 4096, grid=grid(4096), stream=stream0)
        del arg81_1
        buf133 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf105, buf128, buf129, buf130, buf132, buf133, 902144, grid=grid(902144), stream=stream0)
        del buf105
        del buf128
        del buf129
        del buf130
        # Topologically Sorted Source Nodes: [toks_3, index_add__11, index_add__10], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_45.run(arg61_1, arg59_1, buf121, arg60_1, buf134, buf137, 729088, grid=grid(729088), stream=stream0)
        del arg59_1
        del arg60_1
        del arg61_1
        del buf121
    return (buf133, reinterpret_tensor(buf132, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf134, (1, 4096, 32), (131072, 32, 1), 0), reinterpret_tensor(buf137, (1, 4096, 32), (131072, 32, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg45_1 = rand_strided((128, 96), (96, 1), device='cuda:0', dtype=torch.float32)
