...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/u7/cu7pjmwljs7xucrhe2wq632mfuaqqbgtudnppijjhpocrx5fcwmd.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf5, arg7_1, buf6, 3194240, grid=grid(3194240), stream=stream0)
        del buf4
        del buf6
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf14, arg7_1, buf15, 3194240, grid=grid(3194240), stream=stream0)
        del arg6_1
        del arg7_1
        del buf13
        del buf15
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1, 7424, 9), (67860, 9, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg6_1 = rand_strided((2, 49910), (49910, 1), device='cuda:0', dtype=torch.int64)
    arg7_1 = rand_strided((49910, ), (1, ), device='cuda:0', dtype=torch.float32)
