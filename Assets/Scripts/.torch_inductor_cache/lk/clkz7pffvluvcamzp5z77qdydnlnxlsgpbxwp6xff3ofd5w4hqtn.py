...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf3 = empty_strided_cuda((1, 32, 128, 128), (524288, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_highway], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_0.run(buf3, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [row_highway, index_add_, col_highway, index_add__1], Original ATen: [aten.new_zeros, aten.index_add]
        triton_poi_fused_index_add_new_zeros_1.run(arg2_1, arg1_1, buf0, buf3, 524288, grid=grid(524288), stream=stream0)
        del arg1_1
        del arg2_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__2, index_add__3], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_2.run(arg4_1, arg3_1, arg0_1, arg5_1, buf0, buf3, 2916352, grid=grid(2916352), stream=stream0)
        del arg0_1
        del arg3_1
        del arg4_1
        del arg5_1
    return (reinterpret_tensor(buf0, (1, 4096, 128), (524288, 128, 1), 0), reinterpret_tensor(buf3, (1, 4096, 128), (524288, 128, 1), 0), )
