...
#   out => add_2
# Graph fragment:
#   %add_tensor_26 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_26, %arg15_1), kwargs = {})
#   %add_2 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%squeeze, %add_tensor_26), kwargs = {})
...
# Topologically Sorted Source Nodes: [x_work], Original ATen: [aten.native_layer_norm]
# Source node to ATen node mapping:
#   x_work => add_7, add_8, mul_13, mul_14, rsqrt_1, sub_1, var_mean_1
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/na/cnaeqpxm7efcedaucyt6g66ep45fehvilo3hs2gvii3ueymf5c47.py
...
# Source node to ATen node mapping:
# Graph fragment:
#   %mm_default_22 : [num_users=1] = call_function[target=torch.ops.aten.mm.default](args = (%view_21, %permute_17), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vx/cvxcwxuvltz7hqzuhq6wjlbtvfysyqcnui3mlmuh3klzcexw2xia.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_23', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/dq/cdqwnfzpkesogbgtm427sobuwl5aiyw3tdlovrmecqck7j4wunvx.py
# Topologically Sorted Source Nodes: [row_sum, getitem_14, index_add__2, col_sum, getitem_15, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
# Source node to ATen node mapping:
...
# Graph fragment:
#   %full_default_6 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([48, 1, 32, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_2 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_26, [%device_put]), kwargs = {})
#   %index_put_4 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_6, [%device_put_2], %index_2, True), kwargs = {})
...
#   %index_3 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_26, [%device_put_1]), kwargs = {})
#   %index_put_5 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_7, [%device_put_2], %index_3, True), kwargs = {})
triton_poi_fused_index_index_add_zeros_25 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_index_add_zeros_25', 'mutated_arg_names': ['out_ptr0', 'out_ptr1'], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/bg/cbgu5lr4iujgozoq4z25oyvakpfezit4r7b36bxi2anpq4sjflzd.py
# Topologically Sorted Source Nodes: [mean_1, cat_4], Original ATen: [aten.mean, aten.cat]
# Source node to ATen node mapping:
#   cat_4 => cat_4
#   mean_1 => mean_1
# Graph fragment:
...
triton_per_fused_cat_mean_26 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.DEFAULT,
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*i64', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_cat_mean_26', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 6144
    rnumel = 32
    RBLOCK: tl.constexpr = 32
    xoffset = tl.program_id(0) * XBLOCK
    ...
    tmp12 = tl.load(in_ptr0 + (r2 + (32*x3)), None)
    tmp14 = tl.load(in_ptr2 + (r2 + (32*x3)), None)
    ...
    tl.store(out_ptr2 + (r2 + (32*x0) + (4224*x1)), tmp16, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5g/c5gcpzisnioxos25m3v2zm3mh45ygyulabcljrhvcpbqmz56hg72.py
# Topologically Sorted Source Nodes: [x_work_1], Original ATen: [aten.native_layer_norm]
# Source node to ATen node mapping:
#   x_work_1 => add_17, add_18, mul_21, mul_22, rsqrt_3, sub_4, var_mean_3
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/im/cimntone6lb3ntji3hcnj2xyal6ecsb7ux2znyal6ku4gidzhcwz.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default_2 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_47, %full_default_28], 1), kwargs = {})
triton_poi_fused_28 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_28', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3y/c3y4umhmb2qfe5xrj4wdp3ojygx5vjudureqxr4kewcr6dvbn6fk.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default_3 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_48, %full_default_29], 2), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/s3/cs3dlxx5wkdtmgvn4bv4lzmza2unw6lpnhxsyfpdmx4txla62dkl.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/pv/cpveflcsz3q3kzghyqk5fs2xaj4dbf3sjlama5rbco5awkkuhpms.py
# Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_2 => full_default_8, index_put_6
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/rv/crvej233p74whdmdxxj4phpve5hke3rbdtyjz2fjxi32b57z3dnu.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/oc/coct447h2c2pkrasod53qwzse4vjxo3kb7okrwa34jzzkhyftel3.py
# Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_3 => full_default_9, index_put_7
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sq/csqmnruxztcx3l2tgwc6vaqtijfvirmzsaxuowqn5cm5if7upeiy.py
...
triton_per_fused__softmax_add_eq_masked_fill_mul_34 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_eq_masked_fill_mul_34', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6n/c6nqohx6weqv7siy2z5r2zjs7zqltqpsfrmo35svr32bhwmj4wyv.py
...
triton_per_fused__softmax_35 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wp/cwpmayamt6gepqnaek4lknmljdc52oxtmm7druc5nqtelwpt7fgr.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/db/cdbalst3p3f44hexc475xuv3eg235io2hvust3e7bejujnjgh5el.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %mm_default_17 : [num_users=1] = call_function[target=torch.ops.aten.mm.default](args = (%view_52, %permute_35), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5l/c5la3zwsvemvcbarw3v4g624yqcvyu2u2enrorezzzgaiygexqxp.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_38', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/o3/co36zhrs3ajwyhbhhszjgall3uj4es6qkb2jmdsymidxwaueejck.py
# Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_4 => clone_13
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/s7/cs7lregwythcndizbzrxvxix57j7tx7wcwyo5xahq6yo7swbectq.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_40', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/l3/cl3uj4rwob6m2ynojnpjy7ub7zndzlybisipesbug4zsuyqia7yj.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/u6/cu6sxk52pmusfuizjuyag6pnpnv47dbvnrxel5mmw5ykehh6jojv.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sq/csqcndayw2cpwpcf3flnyuinwmbsjxtwvmc4hk2yty2u6pkxpg37.py
...
# Graph fragment:
#   %add_21 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_40, %view_61), kwargs = {})
#   %add_25 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_21, %view_65), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/li/cli4hfl2yfqhyjoh7jbmnvbky2ffkquuceeds4dkaplpamzenkrc.py
# Topologically Sorted Source Nodes: [ex, x_work_2], Original ATen: [aten.cat, aten.native_layer_norm]
# Source node to ATen node mapping:
#   ex => cat_5
#   x_work_2 => add_26, add_27, mul_29, mul_30, rsqrt_5, sub_7, var_mean_5
# Graph fragment:
#   %cat_5 : [num_users=3] = call_function[target=torch.ops.aten.cat.default](args = ([%view_67, %view_69], 1), kwargs = {})
#   %var_mean_5 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%cat_5, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_7 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%cat_5, %getitem_11), kwargs = {})
...
triton_per_fused_cat_native_layer_norm_44 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_cat_native_layer_norm_44', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp4 = tmp0 < tmp3
    tmp5 = tl.load(in_ptr0 + (4096 + r1 + (4224*x0)), tmp4 & xmask, other=0.0)
    tmp6 = tmp0 >= tmp3
    tmp7 = tl.full([1, 1], 64, tl.int64)
    tmp8 = tmp0 < tmp7
    tmp9 = tl.load(in_ptr1 + (4096 + r1 + (4224*((-16) + x0))), tmp6 & xmask, other=0.0)
    tmp10 = tl.where(tmp4, tmp5, tmp9)
    ...
    tmp35 = tmp33 * tmp34
    tmp37 = tmp35 + tmp36
    tl.store(out_ptr2 + (r1 + (128*x0)), tmp37, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ih/cihmfxknmwv6bbk3flxczvnltmrqsxr2ph5ncbtq5pkmc6lpao45.py
...
#   %index_put_8 : [num_users=2] = call_function[target=torch.ops.aten.index_put.default](args = (%arg65_1, [None, None, %iota_2, %iota_2], %full_default_12), kwargs = {})
triton_poi_fused_index_put_lift_fresh_45 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/b3/cb3ddtzpjl3gxsmuzltotrhwutxt4kbh6ovesm3fw3surnaf2rgn.py
# Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_4 => full_default_12, index_put_8
# Graph fragment:
#   %full_default_12 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_8 : [num_users=2] = call_function[target=torch.ops.aten.index_put.default](args = (%arg65_1, [None, None, %iota_2, %iota_2], %full_default_12), kwargs = {})
triton_poi_fused_index_put_lift_fresh_46 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/qp/cqpymgjhf2427qs3uzghl3hyvma23wp6lsgkl2pukmbsr2kbl2qj.py
# Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_5 => full_default_13, index_put_9
# Graph fragment:
...
#   %index_put_9 : [num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_11, [None, None, %iota_2, %iota_2], %full_default_13), kwargs = {})
triton_poi_fused_index_put_lift_fresh_47 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_put_lift_fresh_47', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/jp/cjppvishejuhc4aozou5f26j7m55sw4rcp4pyvgwffuxtcbbri5s.py
# Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_5 => full_default_13, index_put_9
# Graph fragment:
#   %full_default_13 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 1.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_9 : [num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_11, [None, None, %iota_2, %iota_2], %full_default_13), kwargs = {})
triton_poi_fused_index_put_lift_fresh_48 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_put_lift_fresh_48', 'mutated_arg_names': ['out_ptr0'], 'no_x_dim': False, 'num_load': 0, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/rr/crrbvc3zxvlhba7mwq33gk2shccjo62xjtyx4jn4565ozgkx6axj.py
...
# Source node to ATen node mapping:
#   attn_probs_2 => amax_2, exp_2, sub_8, sum_3
#   eq_4 => eq_4
#   scores_6 => mul_31
#   scores_7 => add_28
#   scores_8 => clone_16, full_default_14, where_4
# Graph fragment:
#   %eq_4 : [num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%unsqueeze_21, 0), kwargs = {})
...
#   %mul_31 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_79, 0.25), kwargs = {})
#   %add_28 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_31, %slice_76), kwargs = {})
#   %where_4 : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%eq_4, %full_default_14, %add_28), kwargs = {})
#   %clone_16 : [num_users=2] = call_function[target=torch.ops.aten.clone.default](args = (%where_4,), kwargs = {memory_format: torch.contiguous_format})
#   %amax_2 : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%clone_16, [3], True), kwargs = {})
#   %sub_8 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%clone_16, %amax_2), kwargs = {})
...
triton_per_fused__softmax_add_eq_masked_fill_mul_49 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr1 + (r2 + (64*x3)), xmask, other=0.0)
    tmp8 = tl.load(in_ptr2 + (r2 + (64*x0)), xmask, eviction_policy='evict_last', other=0.0)
    tmp9 = tl.load(in_ptr3 + (3 + (4*r2) + (256*x0)), xmask, eviction_policy='evict_last', other=0.0)
    tmp1 = 0.0
    tmp2 = tmp0 == tmp1
    tmp4 = 0.25
    tmp5 = tmp3 * tmp4
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ll/cllbubrhbhvyqiurrtemgnqxneetf4kps6fg65pmsgpojhewdj57.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %select_scatter_default_2 : [num_users=2] = call_function[target=torch.ops.aten.select_scatter.default](args = (%index_put_8, %index_put_9, 4, 3), kwargs = {})
triton_poi_fused_50 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_50', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3k/c3koubdajxshkcfs7aprcnjexgk4k2b2tq7o6jo2gpm7x5jcj4pe.py
# Topologically Sorted Source Nodes: [attn_probs_2, eq_5, linear_edge_weights_5, combined_weights_2], Original ATen: [aten._softmax, aten.eq, aten.masked_fill, aten.add]
# Source node to ATen node mapping:
#   attn_probs_2 => div_4
#   combined_weights_2 => add_29
#   eq_5 => eq_5
#   linear_edge_weights_5 => full_default_15, where_5
# Graph fragment:
#   %div_4 : [num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%exp_2, %sum_3), kwargs = {})
#   %eq_5 : [num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%unsqueeze_21, 0), kwargs = {})
...
#   %where_5 : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%eq_5, %full_default_15, %view_82), kwargs = {})
#   %add_29 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%div_4, %where_5), kwargs = {})
triton_poi_fused__softmax_add_eq_masked_fill_51 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused__softmax_add_eq_masked_fill_51', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y3 = yindex
    y1 = (yindex // 64)
    tmp0 = tl.load(in_ptr0 + (y3 + (4096*x2)), xmask, eviction_policy='evict_last')
    tmp1 = tl.load(in_ptr1 + (y1 + (64*x2)), xmask, eviction_policy='evict_last')
    tmp3 = tl.load(in_ptr2 + (y3), None, eviction_policy='evict_last')
    tmp6 = tl.load(in_out_ptr0 + (x2 + (8*y3)), xmask, eviction_policy='evict_last')
    ...
    tmp10 = tmp2 + tmp9
    tl.debug_barrier()
    tl.store(in_out_ptr0 + (x2 + (8*y3)), tmp10, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/tg/ctg63tlyg3lpxyvjqvbyhdqm7mmjyxoznaakinamp5jw7ifpyzg7.py
# Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_9 => clone_17
# Graph fragment:
#   %clone_17 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%view_86,), kwargs = {memory_format: torch.contiguous_format})
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x2 = (xindex // 128)
    x3 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (16*x2) + (1024*x1)), None)
    tl.store(out_ptr0 + (x3), tmp0, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vd/cvdvvupkh22sir2wvbb7fqzerealk4zpwnmstukr4vw6ufl4gyzp.py
# Topologically Sorted Source Nodes: [ex, x_4, layer_norm_6], Original ATen: [aten.cat, aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   ex => cat_5
...
# Graph fragment:
#   %cat_5 : [num_users=3] = call_function[target=torch.ops.aten.cat.default](args = ([%view_67, %view_69], 1), kwargs = {})
#   %add_30 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%cat_5, %view_90), kwargs = {})
...
triton_per_fused_add_cat_native_layer_norm_53 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_cat_native_layer_norm_53', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    x0 = xindex
    r1 = rindex
    tmp11 = tl.load(in_ptr2 + (r1 + (128*x0)), xmask, other=0.0)
    tmp12 = tl.load(in_ptr3 + (r1), None, eviction_policy='evict_last')
    tmp38 = tl.load(in_ptr4 + (r1), None, eviction_policy='evict_last')
    tmp40 = tl.load(in_ptr5 + (r1), None, eviction_policy='evict_last')
    tmp0 = x0
    tmp1 = tl.full([1, 1], 0, tl.int64)
    tmp2 = tmp0 >= tmp1
    tmp3 = tl.full([1, 1], 16, tl.int64)
    ...
    tmp39 = tmp37 * tmp38
    tmp41 = tmp39 + tmp40
    tl.store(in_out_ptr0 + (r1 + (128*x0)), tmp41, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gk/cgk57rs2t5dkvamaa6koydqcgpmnbztahirvidmmuqv2k5xiefqh.py
# Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_17 => add_33, erf_5, mul_34, mul_35, mul_36
# Graph fragment:
#   %mul_34 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_92, 0.5), kwargs = {})
#   %mul_35 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_92, 0.7071067811865476), kwargs = {})
...
triton_poi_fused_gelu_54 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/lb/clb2sfwzcfqcr523gi7adddtaivytcurkca3cymtxzk6zuoc63xf.py
# Topologically Sorted Source Nodes: [ex, x_4, x_5], Original ATen: [aten.cat, aten.add]
# Source node to ATen node mapping:
#   ex => cat_5
#   x_4 => add_30
#   x_5 => add_34
...
#   %cat_5 : [num_users=3] = call_function[target=torch.ops.aten.cat.default](args = ([%view_67, %view_69], 1), kwargs = {})
#   %add_30 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%cat_5, %view_90), kwargs = {})
#   %add_34 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_30, %view_94), kwargs = {})
triton_poi_fused_add_cat_55 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/he/chewaoo3nz2co6ykjvao2wasig26warfrevottrdxalvpwub2xzd.py
# Topologically Sorted Source Nodes: [x_work_3], Original ATen: [aten.native_layer_norm]
# Source node to ATen node mapping:
#   x_work_3 => add_35, add_36, mul_37, mul_38, rsqrt_7, sub_10, var_mean_7
# Graph fragment:
#   %var_mean_7 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_108, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_10 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_108, %getitem_15), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_56', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    xnumel = 528
    ...
    x0 = xindex
    r1 = rindex
    tmp4 = tl.load(in_ptr1 + (r1 + (128*x0) + (4224*((x0 % 33) // 33))), xmask, other=0.0)
    ...
    tmp2 = tmp0 >= tmp1
    tmp3 = tl.load(in_ptr0 + (r1 + (128*(x0 // 33)) + (128*((x0 % 33) // 33))), tmp2 & xmask, other=0.0)
    tmp5 = tl.where(tmp2, tmp3, tmp4)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wg/cwg6jwwj7ejg5ozh35zuejq3dlp7vd5nkehz3lrm2zwr2czbdh76.py
...
#   x_6 => add_39
# Graph fragment:
#   %add_39 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_108, %view_129), kwargs = {})
...
#   %mul_41 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_40, %arg88_1), kwargs = {})
#   %add_41 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_41, %arg89_1), kwargs = {})
triton_per_fused_add_native_layer_norm_57 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/a7/ca76rwqax7vpgwnb3536djv4yyys6q2ym2stvpqdc2tjphfvafsx.py
...
# Graph fragment:
#   %add_39 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_108, %view_129), kwargs = {})
#   %add_43 : [num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_39, %view_133), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_58', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, xnumel, XBLOCK : tl.constexpr):
    ...
    x0 = xindex % 128
    x1 = (xindex // 128)
    tmp4 = tl.load(in_ptr1 + (x0 + (128*x1) + (4224*((x1 % 33) // 33))), None)
    ...
    tmp2 = tmp0 >= tmp1
    tmp3 = tl.load(in_ptr0 + (x0 + (128*(x1 // 33)) + (128*((x1 % 33) // 33))), tmp2, other=0.0)
    tmp5 = tl.where(tmp2, tmp3, tmp4)
    tmp8 = tmp6 + tmp7
    tmp9 = tmp5 + tmp8
    tmp12 = tmp10 + tmp11
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/zr/czryfhaf5xwdel6tvle6vcr7mhrtrb7s3drkrt5f52fd4apczmh5.py
# Topologically Sorted Source Nodes: [mean_2], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   mean_2 => mean_2
# Graph fragment:
#   %mean_2 : [num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%view_138, [2], True), kwargs = {})
triton_per_fused_mean_59 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/y7/cy7sbk35qdgzjx75b7hqfhwweif3vwurqvujcwrqcfdwu2vctwsy.py
# Topologically Sorted Source Nodes: [off_in, x_work_4], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   off_in => add_45
#   x_work_4 => add_46, add_47, mul_45, mul_46, rsqrt_9, sub_13, var_mean_9
# Graph fragment:
#   %add_45 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_139, %view_141), kwargs = {})
#   %var_mean_9 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%add_45, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_13 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_45, %getitem_19), kwargs = {})
#   %add_46 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_18, 1e-05), kwargs = {})
#   %rsqrt_9 : [num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_46,), kwargs = {})
#   %mul_45 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_13, %rsqrt_9), kwargs = {})
#   %mul_46 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_45, %arg94_1), kwargs = {})
#   %add_47 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_46, %arg95_1), kwargs = {})
triton_per_fused_add_native_layer_norm_60 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/o6/co6dhy237nw42s6ojohhbzadpobuuwhd5s5xajuorkhfi76qzqxg.py
# Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   u_leaf => add_55
# Graph fragment:
#   %add_55 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_170, %arg109_1), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_61', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/rm/crmk6uz5rphtoll2agode6d2b3dqugdms74vcnu42imlclxikxss.py
# Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   u_leaf_1 => add_56
# Graph fragment:
#   %add_56 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_179, %arg111_1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/76/c76b3ajt64qpbh7gyrjcujijhj46xn375lj2z6q57nsoewg3lnen.py
# Topologically Sorted Source Nodes: [h_phys_flat], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   h_phys_flat => clone_33
# Graph fragment:
#   %clone_33 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_165,), kwargs = {memory_format: torch.contiguous_format})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_63', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/px/cpxwdsbs7ythn7rhubw6u4tgzeysuiphka6emkxl4ydnsjm3irxc.py
# Topologically Sorted Source Nodes: [linear_39, sigmoid], Original ATen: [aten.add, aten.sigmoid]
# Source node to ATen node mapping:
#   linear_39 => add_58
#   sigmoid => sigmoid
# Graph fragment:
#   %add_58 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_190, %arg115_1), kwargs = {})
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%add_58,), kwargs = {})
triton_poi_fused_add_sigmoid_64 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/qx/cqxx4exjgczhgcyk27tao7ydhawecbubldceo64ysmd4glv4a2hb.py
# Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   packed_1 => cat_8
# Graph fragment:
#   %cat_8 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_7, %view_191], 1), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg64_1, (1, 1, 64, 64), (4096, 4096, 64, 1))
    assert_size_stride(arg65_1, (1, 1, 64, 64, 4), (16384, 16384, 256, 4, 1))
    ...
    assert_size_stride(arg96_1, (384, 128), (128, 1))
    assert_size_stride(arg97_1, (384, ), (1, ))
    assert_size_stride(arg98_1, (8, 4), (4, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [setitem], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(arg28_1, buf38, 69696, grid=grid(69696), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        del arg38_1
        buf57 = reinterpret_tensor(buf51, (1, 528, 128), (67584, 128, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_21.run(buf29, buf52, arg39_1, arg40_1, arg41_1, buf57, 528, 128, grid=grid(528), stream=stream0)
        del arg40_1
        del arg41_1
        buf56 = empty_strided_cuda((66, ), (1, ), torch.int64)
        buf56.copy_(arg48_1)
        del arg48_1
        buf58 = empty_strided_cuda((528, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (528, 128), (128, 1), 0), reinterpret_tensor(arg42_1, (128, 512), (1, 128), 0), out=buf58)
        del arg42_1
        buf59 = reinterpret_tensor(buf58, (1, 528, 512), (270336, 512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf59, arg43_1, 270336, grid=grid(270336), stream=stream0)
        del arg43_1
        buf60 = reinterpret_tensor(buf57, (528, 128), (128, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (528, 512), (512, 1), 0), reinterpret_tensor(arg44_1, (512, 128), (1, 512), 0), out=buf60)
        del arg44_1
        buf61 = reinterpret_tensor(buf60, (1, 528, 128), (67584, 128, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.add]
        triton_poi_fused_add_23.run(buf61, buf29, buf52, arg39_1, arg45_1, 67584, grid=grid(67584), stream=stream0)
        del arg39_1
        del arg45_1
        buf62 = empty_strided_cuda((66, ), (1, ), torch.int64)
        buf62.copy_(arg46_1)
        del arg46_1
        ...
        buf65 = empty_strided_cuda((66, ), (1, ), torch.int64)
        buf65.copy_(arg47_1)
        del arg47_1
        buf66 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf66, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum, getitem_14, index_add__2, col_sum, getitem_15, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_25.run(buf56, buf62, buf61, buf65, buf63, buf66, 270336, grid=grid(270336), stream=stream0)
        buf71 = reinterpret_tensor(buf34, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf34  # reuse
        buf70 = reinterpret_tensor(buf71, (48, 1, 1, 128), (4224, 1, 128, 1), 4096)  # alias
        buf69 = reinterpret_tensor(buf71, (48, 1, 32, 128), (4224, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [mean_1, cat_4], Original ATen: [aten.mean, aten.cat]
        triton_per_fused_cat_mean_26.run(buf63, arg49_1, buf66, buf70, buf69, 6144, 32, grid=grid(6144), stream=stream0)
        buf75 = empty_strided_cuda((48, 33, 128), (4224, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_work_1], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_27.run(buf71, arg50_1, arg51_1, buf75, 1584, 128, grid=grid(1584), stream=stream0)
        del arg50_1
        del arg51_1
        del buf69
        del buf70
        buf76 = empty_strided_cuda((1584, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf75, (1584, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf76)
        del arg52_1
        buf77 = empty_strided_cuda((384, 36, 16), (576, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_28.run(buf76, arg53_1, buf77, 221184, grid=grid(221184), stream=stream0)
        buf78 = empty_strided_cuda((384, 16, 36), (576, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_29.run(buf76, arg53_1, buf78, 221184, grid=grid(221184), stream=stream0)
        buf79 = empty_strided_cuda((384, 36, 36), (1296, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(buf77, buf78, out=buf79)
        buf80 = empty_strided_cuda((48, 1, 33, 33, 4), (4384, 210432, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(arg30_1, buf80, 209088, grid=grid(209088), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf80, 6336, grid=grid(6336), stream=stream0)
        buf82 = empty_strided_cuda((48, 1, 33, 33), (1120, 53760, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf80, buf82, 52272, grid=grid(52272), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf82, 1584, grid=grid(1584), stream=stream0)
        buf85 = empty_strided_cuda((48, 1, 33, 33, 8), (8960, 430080, 33, 1, 1120), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_34.run(arg31_1, buf79, buf82, buf80, buf85, 12672, 33, grid=grid(12672), stream=stream0)
        buf86 = empty_strided_cuda((48, 1, 33, 1, 8), (264, 12672, 8, 12672, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_35.run(buf85, buf86, 12672, 33, grid=grid(12672), stream=stream0)
        buf87 = empty_strided_cuda((48, 1, 33, 33, 4), (4384, 4, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf82, buf80, buf87, 209088, grid=grid(209088), stream=stream0)
        buf88 = empty_strided_cuda((52272, 4), (4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf87, buf88, 209088, grid=grid(209088), stream=stream0)
        buf89 = empty_strided_cuda((52272, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf88, reinterpret_tensor(arg54_1, (4, 8), (1, 4), 0), out=buf89)
        del arg54_1
        buf90 = reinterpret_tensor(buf85, (48, 8, 33, 33, 1, 1), (8960, 1120, 33, 1, 1, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf90, buf86, arg31_1, buf89, arg55_1, 384, 1089, grid=grid(384, 1089), stream=stream0)
        del arg55_1
        buf91 = reinterpret_tensor(buf75, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf76, arg53_1, buf91, 202752, grid=grid(202752), stream=stream0)
        del arg53_1
        buf92 = empty_strided_cuda((384, 33, 16), (528, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf90, (384, 33, 33), (1120, 33, 1), 0), reinterpret_tensor(buf91, (384, 33, 16), (528, 16, 1), 0), out=buf92)
        buf93 = reinterpret_tensor(buf91, (48, 1, 33, 8, 16), (4224, 1, 128, 16, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf92, buf93, 202752, grid=grid(202752), stream=stream0)
        buf94 = reinterpret_tensor(buf92, (1584, 128), (128, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf93, (1584, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 128), (1, 128), 0), out=buf94)
        del arg56_1
        buf98 = reinterpret_tensor(buf93, (48, 33, 128), (4224, 128, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf71, buf94, arg57_1, arg58_1, arg59_1, buf98, 1584, 128, grid=grid(1584), stream=stream0)
        del arg58_1
        del arg59_1
        buf99 = empty_strided_cuda((1584, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (1584, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf99)
        del arg60_1
        buf100 = reinterpret_tensor(buf99, (48, 33, 512), (16896, 512, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf100, arg61_1, 811008, grid=grid(811008), stream=stream0)
        del arg61_1
        buf101 = reinterpret_tensor(buf98, (1584, 128), (128, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (1584, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf101)
        del arg62_1
        buf102 = reinterpret_tensor(buf101, (48, 33, 128), (4224, 128, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf102, buf71, buf94, arg57_1, arg63_1, 202752, grid=grid(202752), stream=stream0)
        del arg57_1
        del arg63_1
        buf106 = empty_strided_cuda((1, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [ex, x_work_2], Original ATen: [aten.cat, aten.native_layer_norm]
        triton_per_fused_cat_native_layer_norm_44.run(buf61, buf102, arg66_1, arg67_1, buf106, 64, 128, grid=grid(64), stream=stream0)
        del arg66_1
        del arg67_1
        buf107 = empty_strided_cuda((64, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [qkv_2], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf106, (64, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 384), (1, 128), 0), alpha=1, beta=1, out=buf107)
        del arg68_1
        del arg69_1
        buf108 = empty_strided_cuda((8, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf107, (8, 64, 16), (16, 384, 1), 0), reinterpret_tensor(buf107, (8, 16, 64), (16, 1, 384), 128), out=buf108)
        buf109 = empty_strided_cuda((1, 1, 64, 64, 4), (16384, 16384, 256, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_45.run(arg65_1, buf109, 16384, grid=grid(16384), stream=stream0)
        del arg65_1
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_46.run(buf109, 256, grid=grid(256), stream=stream0)
        buf111 = empty_strided_cuda((1, 1, 64, 64), (4096, 4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_47.run(buf109, buf111, 4096, grid=grid(4096), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_48.run(buf111, 64, grid=grid(64), stream=stream0)
        buf114 = empty_strided_cuda((1, 1, 64, 64, 8), (32768, 32768, 64, 1, 4096), torch.float32)
        buf115 = empty_strided_cuda((1, 1, 64, 1, 8), (512, 512, 1, 512, 64), torch.float32)
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_49.run(arg64_1, buf108, buf111, buf109, buf114, buf115, 512, 64, grid=grid(512), stream=stream0)
        buf116 = empty_strided_cuda((1, 1, 64, 64, 4), (16384, 1, 256, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_50.run(buf111, buf109, buf116, 16384, grid=grid(16384), stream=stream0)
        del buf111
        buf117 = reinterpret_tensor(buf108, (4096, 8), (8, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (4096, 4), (4, 1), 0), reinterpret_tensor(arg70_1, (4, 8), (1, 4), 0), out=buf117)
        del arg70_1
        buf118 = reinterpret_tensor(buf117, (1, 1, 64, 64, 8), (32768, 1, 512, 8, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_2, eq_5, linear_edge_weights_5, combined_weights_2], Original ATen: [aten._softmax, aten.eq, aten.masked_fill, aten.add]
        triton_poi_fused__softmax_add_eq_masked_fill_51.run(buf118, buf114, buf115, arg64_1, arg71_1, 4096, 8, grid=grid(4096, 8), stream=stream0)
        del arg64_1
        del arg71_1
        del buf114
        buf119 = reinterpret_tensor(buf106, (8, 64, 16), (1024, 16, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf118, (8, 64, 64), (1, 512, 8), 0), reinterpret_tensor(buf107, (8, 64, 16), (16, 384, 1), 256), out=buf119)
        del buf107
        buf120 = empty_strided_cuda((1, 1, 64, 8, 16), (8192, 1, 128, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_52.run(buf119, buf120, 8192, grid=grid(8192), stream=stream0)
        buf121 = reinterpret_tensor(buf119, (64, 128), (128, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (64, 128), (128, 1), 0), reinterpret_tensor(arg72_1, (128, 128), (1, 128), 0), out=buf121)
        del arg72_1
        buf125 = reinterpret_tensor(buf120, (1, 64, 128), (8192, 128, 1), 0); del buf120  # reuse
        buf126 = buf125; del buf125  # reuse
        # Topologically Sorted Source Nodes: [ex, x_4, layer_norm_6], Original ATen: [aten.cat, aten.add, aten.native_layer_norm]
        triton_per_fused_add_cat_native_layer_norm_53.run(buf126, buf61, buf102, buf121, arg73_1, arg74_1, arg75_1, 64, 128, grid=grid(64), stream=stream0)
        del arg74_1
        del arg75_1
        buf127 = reinterpret_tensor(buf118, (64, 512), (512, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (64, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 512), (1, 128), 0), out=buf127)
        del arg76_1
        buf128 = reinterpret_tensor(buf127, (1, 64, 512), (32768, 512, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_54.run(buf128, arg77_1, 32768, grid=grid(32768), stream=stream0)
        del arg77_1
        buf129 = reinterpret_tensor(buf126, (64, 128), (128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (64, 512), (512, 1), 0), reinterpret_tensor(arg78_1, (512, 128), (1, 512), 0), out=buf129)
        del arg78_1
        del buf128
        buf130 = reinterpret_tensor(buf129, (1, 64, 128), (8192, 128, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [ex, x_4, x_5], Original ATen: [aten.cat, aten.add]
        triton_poi_fused_add_cat_55.run(buf130, buf61, buf102, buf121, arg73_1, arg79_1, 8192, grid=grid(8192), stream=stream0)
        del arg73_1
        del arg79_1
        del buf121
        buf134 = reinterpret_tensor(buf52, (1, 528, 128), (67584, 128, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x_work_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_56.run(buf130, buf61, arg80_1, arg81_1, buf134, 528, 128, grid=grid(528), stream=stream0)
        del arg80_1
        del arg81_1
        buf135 = reinterpret_tensor(buf94, (528, 384), (384, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (528, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 384), (1, 128), 0), out=buf135)
        del arg82_1
        buf136 = reinterpret_tensor(buf134, (16, 8, 33, 16, 1, 1), (4224, 528, 16, 1, 1, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf135, arg83_1, buf136, 67584, grid=grid(67584), stream=stream0)
        buf137 = reinterpret_tensor(buf29, (16, 8, 16, 1, 33, 1), (4224, 528, 33, 33, 1, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf135, arg83_1, buf137, 2048, 33, grid=grid(2048, 33), stream=stream0)
        buf138 = reinterpret_tensor(buf47, (128, 33, 33), (1089, 33, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf136, (128, 33, 16), (528, 16, 1), 0), reinterpret_tensor(buf137, (128, 16, 33), (528, 33, 1), 0), out=buf138)
        buf139 = buf45; del buf45  # reuse
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(arg28_1, buf139, 69696, grid=grid(69696), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf139, 2112, grid=grid(2112), stream=stream0)
        buf141 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf139, buf141, 17424, grid=grid(17424), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf141, 528, grid=grid(528), stream=stream0)
        buf144 = reinterpret_tensor(buf48, (1, 16, 33, 33, 8), (143360, 8960, 33, 1, 1120), 0); del buf48  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_15.run(arg29_1, buf138, buf141, buf139, buf144, buf145, 4224, 33, grid=grid(4224), stream=stream0)
        buf146 = buf38; del buf38  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf141, buf139, buf146, 69696, grid=grid(69696), stream=stream0)
        del buf139
        del buf141
        buf147 = buf46; del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf146, buf147, 69696, grid=grid(69696), stream=stream0)
        del buf146
        buf148 = reinterpret_tensor(buf138, (17424, 8), (8, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf147, reinterpret_tensor(arg84_1, (4, 8), (1, 4), 0), out=buf148)
        del arg84_1
        del buf147
        buf149 = reinterpret_tensor(buf144, (16, 8, 33, 33, 1, 1), (8960, 1120, 33, 1, 1, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf149, buf145, arg29_1, buf148, arg85_1, 128, 1089, grid=grid(128, 1089), stream=stream0)
        del arg29_1
        del arg85_1
        del buf145
        del buf148
        buf150 = reinterpret_tensor(buf137, (16, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf135, arg83_1, buf150, 67584, grid=grid(67584), stream=stream0)
        del arg83_1
        buf151 = reinterpret_tensor(buf136, (128, 33, 16), (528, 16, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf149, (128, 33, 33), (1120, 33, 1), 0), reinterpret_tensor(buf150, (128, 33, 16), (528, 16, 1), 0), out=buf151)
        del buf149
        buf152 = reinterpret_tensor(buf150, (1, 16, 33, 8, 16), (67584, 4224, 128, 16, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_20.run(buf151, buf152, 67584, grid=grid(67584), stream=stream0)
        buf153 = reinterpret_tensor(buf151, (528, 128), (128, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf152, (528, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 128), (1, 128), 0), out=buf153)
        del arg86_1
        buf157 = reinterpret_tensor(buf152, (1, 528, 128), (67584, 128, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_57.run(buf130, buf61, buf153, arg87_1, arg88_1, arg89_1, buf157, 528, 128, grid=grid(528), stream=stream0)
        del arg88_1
        del arg89_1
        buf158 = reinterpret_tensor(buf59, (528, 512), (512, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf157, (528, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 512), (1, 128), 0), out=buf158)
        del arg90_1
        buf159 = reinterpret_tensor(buf158, (1, 528, 512), (270336, 512, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf159, arg91_1, 270336, grid=grid(270336), stream=stream0)
        del arg91_1
        buf160 = reinterpret_tensor(buf157, (528, 128), (128, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (528, 512), (512, 1), 0), reinterpret_tensor(arg92_1, (512, 128), (1, 512), 0), out=buf160)
        del arg92_1
        del buf159
        buf161 = reinterpret_tensor(buf160, (1, 528, 128), (67584, 128, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_58.run(buf161, buf130, buf61, buf153, arg87_1, arg93_1, 67584, grid=grid(67584), stream=stream0)
        del arg87_1
        del arg93_1
        del buf153
        del buf61
        buf162 = buf66; del buf66  # reuse
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf162, 196608, grid=grid(196608), stream=stream0)
        buf164 = buf63; del buf63  # reuse
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf164, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_36, index_add__4, col_sum_1, getitem_37, index_add__5], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_25.run(buf56, buf62, buf161, buf65, buf162, buf164, 270336, grid=grid(270336), stream=stream0)
        buf166 = empty_strided_cuda((48, 1, 1, 128), (128, 6144, 6144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mean_2], Original ATen: [aten.mean]
        triton_per_fused_mean_59.run(buf162, arg49_1, buf164, buf166, 6144, 32, grid=grid(6144), stream=stream0)
        buf167 = reinterpret_tensor(buf135, (48, 33, 128), (4224, 128, 1), 0); del buf135  # reuse
        buf171 = reinterpret_tensor(buf71, (48, 33, 128), (4224, 128, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [off_in, x_work_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_60.run(buf162, arg49_1, buf164, buf166, buf130, buf102, arg94_1, arg95_1, buf167, buf171, 1584, 128, grid=grid(1584), stream=stream0)
        del arg49_1
        del arg94_1
        del arg95_1
        del buf130
        ...
        del buf164
        del buf166
        buf172 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (1584, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 384), (1, 128), 0), out=buf172)
        del arg96_1
        buf173 = reinterpret_tensor(buf78, (384, 36, 16), (576, 16, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_28.run(buf172, arg97_1, buf173, 221184, grid=grid(221184), stream=stream0)
        buf174 = reinterpret_tensor(buf77, (384, 16, 36), (576, 36, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_29.run(buf172, arg97_1, buf174, 221184, grid=grid(221184), stream=stream0)
        buf175 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(buf173, buf174, out=buf175)
        del buf173
        del buf174
        buf176 = reinterpret_tensor(buf87, (48, 1, 33, 33, 4), (4384, 210432, 132, 4, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [setitem_10], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(arg30_1, buf176, 209088, grid=grid(209088), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [setitem_10], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf176, 6336, grid=grid(6336), stream=stream0)
        buf178 = buf82; del buf82  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf176, buf178, 52272, grid=grid(52272), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf178, 1584, grid=grid(1584), stream=stream0)
        buf181 = reinterpret_tensor(buf90, (48, 1, 33, 33, 8), (8960, 430080, 33, 1, 1120), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [eq_8, scores_14, scores_12, scores_13, attn_probs_4], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_34.run(arg31_1, buf175, buf178, buf176, buf181, 12672, 33, grid=grid(12672), stream=stream0)
        del buf175
        buf182 = buf86; del buf86  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_4], Original ATen: [aten._softmax]
        triton_per_fused__softmax_35.run(buf181, buf182, 12672, 33, grid=grid(12672), stream=stream0)
        buf183 = reinterpret_tensor(buf80, (48, 1, 33, 33, 4), (4384, 4, 132, 4, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf178, buf176, buf183, 209088, grid=grid(209088), stream=stream0)
        del buf176
        del buf178
        buf184 = buf88; del buf88  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf183, buf184, 209088, grid=grid(209088), stream=stream0)
        del buf183
        buf185 = buf89; del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf184, reinterpret_tensor(arg98_1, (4, 8), (1, 4), 0), out=buf185)
        del arg98_1
        del buf184
        buf186 = reinterpret_tensor(buf181, (48, 8, 33, 33, 1, 1), (8960, 1120, 33, 1, 1, 1), 0); del buf181  # reuse
        # Topologically Sorted Source Nodes: [x_out_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf186, buf182, arg31_1, buf185, arg99_1, 384, 1089, grid=grid(384, 1089), stream=stream0)
        del arg31_1
        del arg99_1
        del buf182
        del buf185
        buf187 = reinterpret_tensor(buf171, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [x_out_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf172, arg97_1, buf187, 202752, grid=grid(202752), stream=stream0)
        del arg97_1
        del buf172
        buf188 = reinterpret_tensor(buf102, (384, 33, 16), (528, 16, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [x_out_16], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf186, (384, 33, 33), (1120, 33, 1), 0), reinterpret_tensor(buf187, (384, 33, 16), (528, 16, 1), 0), out=buf188)
        del buf186
        buf189 = reinterpret_tensor(buf187, (48, 1, 33, 8, 16), (4224, 1, 128, 16, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [x_out_17], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf188, buf189, 202752, grid=grid(202752), stream=stream0)
        buf190 = reinterpret_tensor(buf188, (1584, 128), (128, 1), 0); del buf188  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf189, (1584, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 128), (1, 128), 0), out=buf190)
        del arg100_1
        buf197 = reinterpret_tensor(buf189, (48, 33, 128), (4224, 128, 1), 0); del buf189  # reuse
        # Topologically Sorted Source Nodes: [x_8, layer_norm_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf167, buf190, arg101_1, arg102_1, arg103_1, buf197, 1584, 128, grid=grid(1584), stream=stream0)
        del arg102_1
        del arg103_1
        buf194 = reinterpret_tensor(buf116, (16, 32, 32), (1024, 32, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf161, (16, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg108_1, (16, 128, 32), (0, 1, 128), 0), out=buf194)
        del arg108_1
        buf195 = reinterpret_tensor(buf194, (1, 16, 32, 32), (16384, 1024, 32, 1), 0); del buf194  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.add]
        triton_poi_fused_add_61.run(buf195, arg109_1, 16384, grid=grid(16384), stream=stream0)
        del arg109_1
        buf196 = reinterpret_tensor(buf109, (16, 32, 32), (1024, 32, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf195, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf195, (16, 32, 32), (1024, 1, 32), 0), out=buf196)
        buf198 = reinterpret_tensor(buf100, (1584, 512), (512, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf197, (1584, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 512), (1, 128), 0), out=buf198)
        del arg104_1
        buf199 = reinterpret_tensor(buf198, (48, 33, 512), (16896, 512, 1), 0); del buf198  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf199, arg105_1, 811008, grid=grid(811008), stream=stream0)
        del arg105_1
        buf200 = reinterpret_tensor(buf197, (1584, 128), (128, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf199, (1584, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 128), (1, 512), 0), out=buf200)
        del arg106_1
        del buf199
        buf201 = reinterpret_tensor(buf200, (48, 33, 128), (4224, 128, 1), 0); del buf200  # reuse
        # Topologically Sorted Source Nodes: [x_8, x_9], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf201, buf167, buf190, arg101_1, arg107_1, 202752, grid=grid(202752), stream=stream0)
        del arg101_1
        del arg107_1
        del buf167
        del buf190
        buf202 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf201, (48, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg110_1, (48, 128, 32), (0, 1, 128), 0), out=buf202)
        del arg110_1
        buf203 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf201, (48, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg112_1, (48, 128, 32), (0, 1, 128), 0), out=buf203)
        del arg112_1
        del buf201
        buf204 = reinterpret_tensor(buf202, (48, 1, 32, 32), (1024, 1, 32, 1), 0); del buf202  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.add]
        triton_poi_fused_add_62.run(buf204, arg111_1, 49152, grid=grid(49152), stream=stream0)
        del arg111_1
        buf205 = reinterpret_tensor(buf203, (48, 1, 32, 32), (1024, 1, 32, 1), 0); del buf203  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.add]
        triton_poi_fused_add_62.run(buf205, arg113_1, 49152, grid=grid(49152), stream=stream0)
        del arg113_1
        buf206 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf204, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf205, (48, 32, 32), (1024, 1, 32), 0), out=buf206)
        del buf204
        del buf205
        buf207 = reinterpret_tensor(buf25, (1, 16, 32, 128), (65536, 4096, 128, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [h_phys_flat], Original ATen: [aten.clone]
        triton_poi_fused_clone_63.run(buf161, buf207, 65536, grid=grid(65536), stream=stream0)
        buf208 = reinterpret_tensor(buf195, (512, 32), (32, 1), 0); del buf195  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf207, (512, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf208)
        del arg116_1
        del arg117_1
        buf209 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf207, (512, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf209)
        del arg118_1
        del arg119_1
        del buf207
        buf210 = reinterpret_tensor(buf115, (16, 32, 1), (32, 1, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [linear_39], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf161, (16, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg114_1, (16, 128, 1), (0, 1, 0), 0), out=buf210)
        del arg114_1
        del buf161
        buf211 = reinterpret_tensor(buf210, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf210  # reuse
        # Topologically Sorted Source Nodes: [linear_39, sigmoid], Original ATen: [aten.add, aten.sigmoid]
        triton_poi_fused_add_sigmoid_64.run(buf211, arg115_1, 512, grid=grid(512), stream=stream0)
        del arg115_1
        buf212 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_65.run(buf196, buf206, buf208, buf209, buf211, buf212, 98816, grid=grid(98816), stream=stream0)
        del buf196
        del buf206
        del buf208
        del buf209
    return (buf212, reinterpret_tensor(buf211, (1, 16, 32), (512, 32, 1), 0), buf62, buf65, buf56, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg46_1 = rand_strided((66, ), (1, ), device='cpu', dtype=torch.int64)
    arg47_1 = rand_strided((66, ), (1, ), device='cpu', dtype=torch.int64)
    arg48_1 = rand_strided((66, ), (1, ), device='cpu', dtype=torch.int64)
    ...
    arg64_1 = rand_strided((1, 1, 64, 64), (4096, 4096, 64, 1), device='cuda:0', dtype=torch.float32)
    arg65_1 = rand_strided((1, 1, 64, 64, 4), (16384, 16384, 256, 4, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg96_1 = rand_strided((384, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg97_1 = rand_strided((384, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg98_1 = rand_strided((8, 4), (4, 1), device='cuda:0', dtype=torch.float32)
