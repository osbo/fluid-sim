...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf112 = reinterpret_tensor(buf48, (1, 512, 128), (65536, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_23.run(buf63, buf25, buf55, arg45_1, arg51_1, arg68_1, arg69_1, buf112, 512, 128, grid=grid(512), stream=stream0)
        del arg45_1
        del arg51_1
        del arg68_1
        del arg69_1
        ...
        buf92 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf92, 196608, grid=grid(196608), stream=stream0)
        buf94 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf94, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_17, index_add__4, col_sum_1, getitem_18, index_add__5, row_sum, getitem_8, index_add__2, col_sum, getitem_9, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_25.run(arg34_1, arg32_1, buf63, arg33_1, buf25, buf64, buf66, buf92, buf94, 270336, grid=grid(270336), stream=stream0)
        buf74 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_26.run(buf64, arg35_1, buf66, arg52_1, arg53_1, buf74, 1536, 128, grid=grid(1536), stream=stream0)
        del arg52_1
        del arg53_1
        buf72 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mask_base_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf72, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2, lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.clone, aten.sum, aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_28.run(buf72, 1536, 32, grid=grid(1536), stream=stream0)
        buf75 = empty_strided_cuda((1536, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf74, (1536, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf75)
        buf76 = empty_strided_cuda((48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf75, arg55_1, buf76, 196608, grid=grid(196608), stream=stream0)
        buf77 = empty_strided_cuda((48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf75, arg55_1, buf77, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf78 = empty_strided_cuda((384, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf76, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf77, (384, 16, 32), (512, 32, 1), 0), out=buf78)
        buf79 = reinterpret_tensor(buf77, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(arg30_1, buf79, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_32.run(buf79, 6144, grid=grid(6144), stream=stream0)
        buf81 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf79, buf81, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf81, 1536, grid=grid(1536), stream=stream0)
        buf84 = empty_strided_cuda((48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(buf72, buf78, buf81, buf79, buf84, 12288, 32, grid=grid(12288), stream=stream0)
        buf85 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf84, buf85, 12288, 32, grid=grid(12288), stream=stream0)
        buf86 = reinterpret_tensor(buf76, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf76  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf81, buf79, buf86, 196608, grid=grid(196608), stream=stream0)
        buf87 = reinterpret_tensor(buf78, (49152, 8), (8, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf86, (49152, 4), (4, 1), 0), reinterpret_tensor(arg56_1, (4, 8), (1, 4), 0), out=buf87)
        del arg56_1
        buf88 = reinterpret_tensor(buf84, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf84  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf88, buf85, buf72, buf87, arg57_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg57_1
        buf89 = reinterpret_tensor(buf86, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf75, arg55_1, buf89, 196608, grid=grid(196608), stream=stream0)
        buf90 = reinterpret_tensor(buf79, (384, 32, 16), (512, 16, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf88, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf89, (384, 32, 16), (512, 16, 1), 0), out=buf90)
        del buf89
        buf91 = reinterpret_tensor(buf85, (1536, 8), (8, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf74, (1536, 128), (128, 1), 0), reinterpret_tensor(arg58_1, (128, 8), (1, 128), 0), out=buf91)
        del arg58_1
        del buf74
        buf96 = reinterpret_tensor(buf53, (48, 1, 1, 128), (128, 6144, 6144, 1), 0); del buf53  # reuse
        buf97 = reinterpret_tensor(buf96, (48, 1, 1, 128), (128, 1, 6144, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_40.run(buf97, buf92, arg35_1, buf94, 6144, 32, grid=grid(6144), stream=stream0)
        buf98 = empty_strided_cuda((48, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (48, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf98)
        del arg54_1
        buf99 = reinterpret_tensor(buf94, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [mul_5, x_mid_3, x_out_3], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_41.run(buf90, buf91, arg59_1, buf98, arg55_1, buf99, 196608, grid=grid(196608), stream=stream0)
        del arg55_1
        del arg59_1
        buf100 = reinterpret_tensor(buf90, (1536, 128), (128, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (1536, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 128), (1, 128), 0), out=buf100)
        del arg60_1
        buf101 = reinterpret_tensor(buf100, (48, 32, 128), (4096, 128, 1), 0); del buf100  # reuse
        buf145 = reinterpret_tensor(buf99, (48, 32, 128), (4096, 128, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf101, buf64, arg35_1, buf66, arg61_1, arg62_1, arg63_1, buf145, 1536, 128, grid=grid(1536), stream=stream0)
        del arg61_1
        del arg62_1
        del arg63_1
        buf108 = buf31; del buf31  # reuse
        buf109 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [mask_base_4, sum_3], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_7.run(arg29_1, buf108, buf109, 512, 32, grid=grid(512), stream=stream0)
        ...
        triton_poi_fused__to_copy_copy_lt_maximum_8.run(buf110, arg29_1, buf109, 512, grid=grid(512), stream=stream0)
        del arg29_1
        buf113 = reinterpret_tensor(buf66, (512, 384), (384, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (512, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 384), (1, 128), 0), out=buf113)
        buf114 = reinterpret_tensor(buf25, (16, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf113, arg71_1, buf114, 65536, grid=grid(65536), stream=stream0)
        buf115 = reinterpret_tensor(buf55, (16, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf55  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf113, arg71_1, buf115, 2048, 32, grid=grid(2048, 32), stream=stream0)
        buf116 = reinterpret_tensor(buf47, (128, 32, 32), (1024, 32, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf114, (128, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf115, (128, 16, 32), (512, 32, 1), 0), out=buf116)
        buf117 = reinterpret_tensor(buf115, (1, 16, 32, 32, 4), (65536, 4096, 128, 4, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_11.run(arg28_1, buf117, 65536, grid=grid(65536), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_2, setitem_4], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_12.run(buf117, 2048, grid=grid(2048), stream=stream0)
        buf119 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf117, buf119, 16384, grid=grid(16384), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf119, 512, grid=grid(512), stream=stream0)
        buf122 = reinterpret_tensor(buf46, (1, 16, 32, 32, 8), (131072, 8192, 32, 1, 1024), 0); del buf46  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_15.run(buf109, buf116, buf119, buf117, buf122, 4096, 32, grid=grid(4096), stream=stream0)
        buf123 = reinterpret_tensor(buf50, (1, 16, 32, 1, 8), (4096, 256, 8, 4096, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_per_fused__softmax_16.run(buf122, buf123, 4096, 32, grid=grid(4096), stream=stream0)
        buf124 = reinterpret_tensor(buf114, (1, 16, 32, 32, 4), (65536, 4096, 128, 4, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf119, buf117, buf124, 65536, grid=grid(65536), stream=stream0)
        buf125 = reinterpret_tensor(buf116, (16384, 8), (8, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (16384, 4), (4, 1), 0), reinterpret_tensor(arg72_1, (4, 8), (1, 4), 0), out=buf125)
        del arg72_1
        buf126 = reinterpret_tensor(buf122, (16, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf126, buf123, buf109, buf125, arg73_1, 128, 1024, grid=grid(128, 1024), stream=stream0)
        del arg73_1
        del buf125
        buf127 = reinterpret_tensor(buf124, (16, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf113, arg71_1, buf127, 65536, grid=grid(65536), stream=stream0)
        buf128 = reinterpret_tensor(buf117, (128, 32, 16), (512, 16, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf126, (128, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf127, (128, 32, 16), (512, 16, 1), 0), out=buf128)
        del buf126
        del buf127
        buf129 = reinterpret_tensor(buf123, (512, 8), (8, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 8), (1, 128), 0), out=buf129)
        del arg74_1
        buf130 = empty_strided_cuda((16, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf52, (16, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 384), (1, 128), 0), out=buf130)
        del arg70_1
        del buf52
        buf131 = reinterpret_tensor(buf112, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [mul_7, x_mid_5, x_out_6], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_21.run(buf128, buf129, arg75_1, buf130, arg71_1, buf131, 65536, grid=grid(65536), stream=stream0)
        del arg71_1
        del arg75_1
        del buf129
        del buf130
        buf132 = reinterpret_tensor(buf128, (512, 128), (128, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf131, (512, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 128), (1, 128), 0), out=buf132)
        del arg76_1
        buf136 = reinterpret_tensor(buf131, (1, 512, 128), (65536, 128, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf63, buf132, arg77_1, arg78_1, arg79_1, buf136, 512, 128, grid=grid(512), stream=stream0)
        del arg78_1
        del arg79_1
        buf137 = reinterpret_tensor(buf61, (512, 512), (512, 1), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (512, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 512), (1, 128), 0), out=buf137)
        del arg80_1
        buf138 = reinterpret_tensor(buf137, (1, 512, 512), (262144, 512, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf138, arg81_1, 262144, grid=grid(262144), stream=stream0)
        del arg81_1
        buf139 = reinterpret_tensor(buf136, (512, 128), (128, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf138, (512, 512), (512, 1), 0), reinterpret_tensor(arg82_1, (512, 128), (1, 512), 0), out=buf139)
        del arg82_1
        del buf138
        buf140 = reinterpret_tensor(buf139, (1, 512, 128), (65536, 128, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf140, buf63, buf132, arg77_1, arg83_1, 65536, grid=grid(65536), stream=stream0)
        del arg77_1
        del arg83_1
        del buf132
        del buf63
        buf141 = reinterpret_tensor(buf113, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf141, 196608, grid=grid(196608), stream=stream0)
        buf143 = buf64; del buf64  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf143, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_33, index_add__6, col_sum_2, getitem_34, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_44.run(arg34_1, arg32_1, buf140, arg33_1, buf141, buf143, 270336, grid=grid(270336), stream=stream0)
        del arg32_1
        del arg33_1
        del arg34_1
        buf146 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf145, (1536, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 512), (1, 128), 0), out=buf146)
        del arg64_1
        buf147 = reinterpret_tensor(buf146, (48, 32, 512), (16384, 512, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf147, arg65_1, 786432, grid=grid(786432), stream=stream0)
        del arg65_1
        buf148 = reinterpret_tensor(buf145, (1536, 128), (128, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf147, (1536, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 128), (1, 512), 0), out=buf148)
        del arg66_1
        buf149 = reinterpret_tensor(buf148, (48, 32, 128), (4096, 128, 1), 0); del buf148  # reuse
        buf156 = reinterpret_tensor(buf92, (48, 32, 128), (4096, 128, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_46.run(buf149, buf141, arg35_1, buf143, buf101, arg67_1, arg84_1, arg85_1, buf156, 1536, 128, grid=grid(1536), stream=stream0)
        del arg35_1
        del arg67_1
        del arg84_1
        del arg85_1
        del buf101
        buf154 = buf72; del buf72  # reuse
        # Topologically Sorted Source Nodes: [mask_base_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf154, 49152, grid=grid(49152), stream=stream0)
        ...
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_28.run(buf154, 1536, 32, grid=grid(1536), stream=stream0)
        buf157 = buf75; del buf75  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (1536, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf157)
        buf158 = reinterpret_tensor(buf143, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf157, arg87_1, buf158, 196608, grid=grid(196608), stream=stream0)
        buf159 = reinterpret_tensor(buf141, (48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf157, arg87_1, buf159, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf160 = reinterpret_tensor(buf88, (384, 32, 32), (1024, 32, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf158, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf159, (384, 16, 32), (512, 32, 1), 0), out=buf160)
        buf161 = reinterpret_tensor(buf159, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(arg30_1, buf161, 196608, grid=grid(196608), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_32.run(buf161, 6144, grid=grid(6144), stream=stream0)
        buf163 = buf81; del buf81  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf161, buf163, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf163, 1536, grid=grid(1536), stream=stream0)
        buf166 = reinterpret_tensor(buf87, (48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), 0); del buf87  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(buf154, buf160, buf163, buf161, buf166, 12288, 32, grid=grid(12288), stream=stream0)
        buf167 = reinterpret_tensor(buf91, (48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf166, buf167, 12288, 32, grid=grid(12288), stream=stream0)
        buf168 = reinterpret_tensor(buf158, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf163, buf161, buf168, 196608, grid=grid(196608), stream=stream0)
        buf169 = reinterpret_tensor(buf160, (49152, 8), (8, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (49152, 4), (4, 1), 0), reinterpret_tensor(arg88_1, (4, 8), (1, 4), 0), out=buf169)
        del arg88_1
        buf170 = reinterpret_tensor(buf166, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf170, buf167, buf154, buf169, arg89_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg89_1
        del buf169
        buf171 = reinterpret_tensor(buf168, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf157, arg87_1, buf171, 196608, grid=grid(196608), stream=stream0)
        del buf157
        buf172 = reinterpret_tensor(buf161, (384, 32, 16), (512, 16, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf170, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf171, (384, 32, 16), (512, 16, 1), 0), out=buf172)
        del buf170
        del buf171
        buf173 = reinterpret_tensor(buf167, (1536, 8), (8, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (1536, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 8), (1, 128), 0), out=buf173)
        del arg90_1
        buf174 = buf98; del buf98  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (48, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf174)
        del arg86_1
        del buf97
        buf175 = reinterpret_tensor(buf156, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [mul_9, x_mid_7, x_out_9], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_41.run(buf172, buf173, arg91_1, buf174, arg87_1, buf175, 196608, grid=grid(196608), stream=stream0)
        del arg87_1
        del arg91_1
        del buf173
        del buf174
        buf176 = reinterpret_tensor(buf172, (1536, 128), (128, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf175, (1536, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 128), (1, 128), 0), out=buf176)
        del arg92_1
        buf182 = reinterpret_tensor(buf175, (48, 32, 128), (4096, 128, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_47.run(buf149, buf176, arg93_1, arg94_1, arg95_1, buf182, 1536, 128, grid=grid(1536), stream=stream0)
        del arg94_1
        del arg95_1
        buf180 = reinterpret_tensor(buf109, (512, 32), (32, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf140, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf180)
        del arg100_1
        del arg101_1
        buf181 = reinterpret_tensor(buf119, (16, 32, 32), (1024, 32, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf180, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf180, (16, 32, 32), (1024, 1, 32), 0), out=buf181)
        buf183 = reinterpret_tensor(buf147, (1536, 512), (512, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf182, (1536, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 512), (1, 128), 0), out=buf183)
        del arg96_1
        buf184 = reinterpret_tensor(buf183, (48, 32, 512), (16384, 512, 1), 0); del buf183  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf184, arg97_1, 786432, grid=grid(786432), stream=stream0)
        del arg97_1
        buf185 = reinterpret_tensor(buf182, (1536, 128), (128, 1), 0); del buf182  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf184, (1536, 512), (512, 1), 0), reinterpret_tensor(arg98_1, (512, 128), (1, 512), 0), out=buf185)
        del arg98_1
        del buf184
        buf186 = reinterpret_tensor(buf185, (48, 32, 128), (4096, 128, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf186, buf149, buf176, arg93_1, arg99_1, 196608, grid=grid(196608), stream=stream0)
        del arg93_1
        del arg99_1
        del buf149
        del buf176
        buf187 = reinterpret_tensor(buf154, (1536, 32), (32, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf186, (1536, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf187)
        del arg102_1
        del arg103_1
        buf188 = reinterpret_tensor(buf163, (1536, 32), (32, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg105_1, reinterpret_tensor(buf186, (1536, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf188)
        del arg104_1
        del arg105_1
        del buf186
        buf189 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf187, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf188, (48, 32, 32), (1024, 1, 32), 0), out=buf189)
        del buf187
        del buf188
        buf190 = buf180; del buf180  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf140, (512, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf190)
        del arg108_1
        del arg109_1
        buf191 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf140, (512, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf191)
        del arg110_1
        del arg111_1
        buf192 = reinterpret_tensor(buf110, (512, 1), (1, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf140, (512, 128), (128, 1), 0), reinterpret_tensor(arg106_1, (128, 1), (1, 128), 0), out=buf192)
        del arg106_1
        del buf140
        buf193 = reinterpret_tensor(buf192, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_49.run(buf193, arg107_1, 512, grid=grid(512), stream=stream0)
        del arg107_1
        buf194 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_50.run(buf181, buf189, buf190, buf191, buf193, buf194, 98816, grid=grid(98816), stream=stream0)
        del buf181
        del buf189
        del buf190
        del buf191
    return (buf194, reinterpret_tensor(buf193, (1, 16, 32), (512, 32, 1), 0), )
