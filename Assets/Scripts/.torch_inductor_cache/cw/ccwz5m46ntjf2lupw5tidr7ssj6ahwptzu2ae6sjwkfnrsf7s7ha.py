...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/as/casdsovmustmnzivahosn23gmrpcdp7apj5nnoxo77lgedgxkwb2.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr0 + (58346 + x1), xmask, eviction_policy='evict_last')
...
def call(args):
    ...
    assert_size_stride(arg6_1, (2, 58346), (58346, 1))
    assert_size_stride(arg7_1, (58346, ), (1, ))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_4.run(arg6_1, buf6, arg7_1, buf7, 7468288, grid=grid(7468288), stream=stream0)
        del buf5
        del buf7
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_4.run(arg6_1, buf15, arg7_1, buf16, 7468288, grid=grid(7468288), stream=stream0)
        del arg6_1
        del arg7_1
        del buf14
        del buf16
        ...
        buf280 = empty_strided_cuda((234, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [sub, setitem_2, setitem_6], Original ATen: [aten.mean, aten.lift_fresh, aten.index_put]
        triton_per_fused_index_put_lift_fresh_mean_29.run(arg29_1, buf81, buf182, buf280, 958464, 16, grid=grid(958464), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        triton_poi_fused_new_zeros_20.run(buf309, 1048576, grid=grid(1048576), stream=stream0)
        ...
        buf342 = reinterpret_tensor(buf216, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf216  # reuse
        # Topologically Sorted Source Nodes: [row_highway_6], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf342, 1048576, grid=grid(1048576), stream=stream0)
        buf271 = reinterpret_tensor(buf270, (1, 8192, 128), (1048576, 128, 1), 0); del buf270  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, h_diag_3, row_highway_5, index_add__20, col_highway_5, index_add__21, col_highway_6, index_add__25, row_highway_6, index_add__24], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_51.run(buf271, buf173, buf233, arg109_1, arg115_1, arg42_1, buf309, buf313, buf339, buf342, 1048576, grid=grid(1048576), stream=stream0)
        del arg109_1
        del arg115_1
        ...
        del arg124_1
        buf322 = reinterpret_tensor(buf295, (234, 32, 512), (16384, 512, 1), 0); del buf295  # reuse
        buf318 = reinterpret_tensor(buf322, (234, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf274, buf301, arg125_1, arg126_1, arg127_1, buf318, 7488, 128, grid=grid(7488), stream=stream0)
        del arg126_1
        del arg127_1
        buf305 = buf233; del buf233  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf271, (8192, 128), (128, 1), 0), reinterpret_tensor(arg132_1, (128, 128), (1, 128), 0), out=buf305)
        del arg132_1
        buf306 = reinterpret_tensor(buf305, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf305  # reuse
        # Topologically Sorted Source Nodes: [input_47], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_2.run(buf306, arg133_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg133_1
        buf307 = reinterpret_tensor(buf173, (8192, 128), (128, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [input_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg135_1, reinterpret_tensor(buf306, (8192, 128), (128, 1), 0), reinterpret_tensor(arg134_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf307)
        del arg134_1
        del arg135_1
        buf308 = reinterpret_tensor(buf306, (64, 128, 128), (16384, 128, 1), 0); del buf306  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf307, (64, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf307, (64, 128, 128), (16384, 1, 128), 0), out=buf308)
        del buf307
        # Topologically Sorted Source Nodes: [toks_9, index_add__22, index_add__23], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_43.run(buf140, buf141, buf274, buf301, arg125_1, buf146, buf309, buf313, 7372800, grid=grid(7372800), stream=stream0)
        buf312 = buf272; del buf272  # reuse
        # Topologically Sorted Source Nodes: [row_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf309, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf312)
        del arg30_1
        del buf309
        buf316 = buf242; del buf242  # reuse
        # Topologically Sorted Source Nodes: [col_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf313, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf316)
        del arg31_1
        del buf313
        buf317 = buf247; del buf247  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, g_5], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf274, buf301, arg125_1, buf317, 29952, 32, grid=grid(29952), stream=stream0)
        buf319 = reinterpret_tensor(buf322, (234, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf312, buf319, 958464, grid=grid(958464), stream=stream0)
        del buf312
        buf320 = reinterpret_tensor(buf322, (234, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf316, buf320, 958464, grid=grid(958464), stream=stream0)
        buf321 = reinterpret_tensor(buf322, (234, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf317, buf321, 958464, grid=grid(958464), stream=stream0)
        del buf317
        del buf318
        del buf319
        del buf320
        del buf321
        buf323 = reinterpret_tensor(buf316, (7488, 512), (512, 1), 0); del buf316  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf322, (7488, 512), (512, 1), 0), reinterpret_tensor(arg128_1, (512, 512), (1, 512), 0), out=buf323)
        del arg128_1
        del buf322
        buf324 = reinterpret_tensor(buf323, (234, 32, 512), (16384, 512, 1), 0); del buf323  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf324, arg129_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg129_1
        buf325 = reinterpret_tensor(buf300, (7488, 128), (128, 1), 0); del buf300  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf324, (7488, 512), (512, 1), 0), reinterpret_tensor(arg130_1, (512, 128), (1, 512), 0), out=buf325)
        del arg130_1
        del buf324
        buf326 = reinterpret_tensor(buf325, (234, 32, 128), (4096, 128, 1), 0); del buf325  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf326, buf274, buf301, arg125_1, arg131_1, 958464, grid=grid(958464), stream=stream0)
        del arg125_1
        del arg131_1
        del buf274
        buf327 = buf301; del buf301  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf326, (7488, 128), (128, 1), 0), reinterpret_tensor(arg136_1, (128, 128), (1, 128), 0), out=buf327)
        del arg136_1
        buf328 = reinterpret_tensor(buf327, (234, 1, 32, 128), (4096, 1, 128, 1), 0); del buf327  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_52.run(buf328, arg137_1, 958464, grid=grid(958464), stream=stream0)
        del arg137_1
        buf329 = reinterpret_tensor(buf282, (7488, 32), (32, 1), 0); del buf282  # reuse
        # Topologically Sorted Source Nodes: [input_51], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf328, (7488, 128), (128, 1), 0), reinterpret_tensor(arg138_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf329)
        del arg138_1
        del arg139_1
        buf330 = reinterpret_tensor(buf328, (7488, 128), (128, 1), 0); del buf328  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf326, (7488, 128), (128, 1), 0), reinterpret_tensor(arg140_1, (128, 128), (1, 128), 0), out=buf330)
        del arg140_1
        buf331 = reinterpret_tensor(buf330, (234, 1, 32, 128), (4096, 1, 128, 1), 0); del buf330  # reuse
        # Topologically Sorted Source Nodes: [input_53], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_52.run(buf331, arg141_1, 958464, grid=grid(958464), stream=stream0)
        del arg141_1
        buf332 = empty_strided_cuda((7488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg143_1, reinterpret_tensor(buf331, (7488, 128), (128, 1), 0), reinterpret_tensor(arg142_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf332)
        del arg142_1
        del arg143_1
        del buf331
        buf333 = empty_strided_cuda((234, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf329, (234, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf332, (234, 32, 32), (1024, 1, 32), 0), out=buf333)
        del buf329
        del buf332
        buf334 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg147_1, reinterpret_tensor(buf271, (8192, 128), (128, 1), 0), reinterpret_tensor(arg146_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf334)
        del arg146_1
        del arg147_1
        buf335 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg149_1, reinterpret_tensor(buf271, (8192, 128), (128, 1), 0), reinterpret_tensor(arg148_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf335)
        del arg148_1
        del arg149_1
        buf336 = reinterpret_tensor(buf261, (8192, 1), (1, 1), 0); del buf261  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf271, (8192, 128), (128, 1), 0), reinterpret_tensor(arg144_1, (128, 1), (1, 128), 0), out=buf336)
        del arg144_1
        del buf271
        buf337 = reinterpret_tensor(buf336, (1, 64, 128, 1), (8192, 128, 1, 1), 0); del buf336  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_53.run(buf337, arg145_1, 8192, grid=grid(8192), stream=stream0)
        del arg145_1
        buf338 = empty_strided_cuda((1, 1820672), (1820672, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_54.run(buf308, buf333, buf334, buf335, buf337, buf338, 1820672, grid=grid(1820672), stream=stream0)
        del buf308
        del buf333
        del buf334
        del buf335
        # Topologically Sorted Source Nodes: [toks_11, index_add__27, index_add__26], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_49.run(buf146, buf141, buf326, buf140, buf339, buf342, 7372800, grid=grid(7372800), stream=stream0)
        del buf326
    return (buf338, reinterpret_tensor(buf337, (1, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf339, (1, 8192, 128), (1048576, 128, 1), 0), reinterpret_tensor(buf342, (1, 8192, 128), (1048576, 128, 1), 0), arg42_1, buf140, buf146, buf141, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg6_1 = rand_strided((2, 58346), (58346, 1), device='cuda:0', dtype=torch.int64)
    arg7_1 = rand_strided((58346, ), (1, ), device='cuda:0', dtype=torch.float32)
