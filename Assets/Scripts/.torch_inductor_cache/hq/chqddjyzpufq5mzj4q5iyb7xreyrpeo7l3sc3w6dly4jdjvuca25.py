...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/eg/cegg7nww5htllhzncpvnodrd4zlfjxbvyftyhd5f74w5plxkuhio.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/tj/ctjbpax7naicdkt7gf5iasdqf24ffqctiymg4xn4qa4dbt572eqm.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/62/c62ji625pqymrtv3ndxxxuesdqrqtvx2od22sllhixcvzgwfpdzl.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1], Original ATen: [aten.add]
        triton_poi_fused_add_21.run(buf61, buf26, buf53, arg41_1, arg47_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg41_1
        del arg47_1
        ...
        del arg50_1
        buf70 = reinterpret_tensor(buf68, (234, 32, 32, 4), (4096, 128, 4, 1), 0); del buf68  # reuse
        ...
        del arg56_1
        buf100 = reinterpret_tensor(buf91, (234, 32, 128), (4096, 128, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, z_1], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf64, buf92, arg57_1, arg58_1, arg59_1, buf100, 7488, 128, grid=grid(7488), stream=stream0)
        del arg58_1
        del arg59_1
        buf96 = buf53; del buf53  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf61, (8192, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf96)
        del arg64_1
        buf97 = reinterpret_tensor(buf96, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_2.run(buf97, arg65_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg65_1
        buf98 = buf26; del buf26  # reuse
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf97, (8192, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf98)
        del arg66_1
        del arg67_1
        buf99 = reinterpret_tensor(buf97, (64, 128, 128), (16384, 128, 1), 0); del buf97  # reuse
        ...
        del buf98
        buf101 = reinterpret_tensor(buf86, (7488, 512), (512, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (7488, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf101)
        del arg60_1
        buf102 = reinterpret_tensor(buf101, (234, 32, 512), (16384, 512, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf102, arg61_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg61_1
        buf103 = reinterpret_tensor(buf100, (7488, 128), (128, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf102, (7488, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf103)
        del arg62_1
        del buf102
        buf104 = reinterpret_tensor(buf103, (234, 32, 128), (4096, 128, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_37.run(buf104, buf64, buf92, arg57_1, arg63_1, 958464, grid=grid(958464), stream=stream0)
        del arg57_1
        del arg63_1
        del buf64
        buf105 = buf92; del buf92  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf104, (7488, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 128), (1, 128), 0), out=buf105)
        del arg68_1
        buf106 = reinterpret_tensor(buf105, (234, 1, 32, 128), (4096, 1, 128, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf106, arg69_1, 958464, grid=grid(958464), stream=stream0)
        del arg69_1
        ...
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf106, (7488, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf107)
        del arg70_1
        del arg71_1
        buf108 = reinterpret_tensor(buf106, (7488, 128), (128, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf104, (7488, 128), (128, 1), 0), reinterpret_tensor(arg72_1, (128, 128), (1, 128), 0), out=buf108)
        del arg72_1
        del buf104
        buf109 = reinterpret_tensor(buf108, (234, 1, 32, 128), (4096, 1, 128, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf109, arg73_1, 958464, grid=grid(958464), stream=stream0)
        del arg73_1
        buf110 = empty_strided_cuda((7488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf109, (7488, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf110)
        del arg74_1
        del arg75_1
        del buf109
        ...
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf61, (8192, 128), (128, 1), 0), reinterpret_tensor(arg78_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf112)
        del arg78_1
        del arg79_1
        buf113 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg81_1, reinterpret_tensor(buf61, (8192, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf113)
        del arg80_1
        del arg81_1
        buf114 = empty_strided_cuda((8192, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf61, (8192, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 1), (1, 128), 0), out=buf114)
        del arg76_1
        del buf61
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg70_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg74_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg75_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg76_1 = rand_strided((1, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg77_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg78_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg79_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg80_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
