...
#   %index_2 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%mean_6, [None, %arg66_1]), kwargs = {})
#   %index_put_6 : [num_users=2] = call_function[target=torch.ops.aten.index_put.default](args = (%mean_5, [None, %arg64_1], %index_2, True), kwargs = {})
...
#   %index_2 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%mean_6, [None, %arg66_1]), kwargs = {})
#   %index_put_6 : [num_users=2] = call_function[target=torch.ops.aten.index_put.default](args = (%mean_5, [None, %arg64_1], %index_2, True), kwargs = {})
#   %index_put_7 : [num_users=2] = call_function[target=torch.ops.aten.index_put_.default](args = (%mean_5, [None, %arg65_1], %index_2, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg58_1
        del arg59_1
        buf102 = empty_strided_cuda((1, 32, 64), (2048, 64, 1), torch.float32)
        buf104 = empty_strided_cuda((1, 32, 64), (2048, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [diag_summary, off_summary, off_gathered, index_add__2], Original ATen: [aten.mean, aten.index, aten.index_add]
        triton_red_fused_index_index_add_mean_35.run(buf60, buf102, buf104, 2048, 128, grid=grid(2048), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_37.run(buf100, buf63, buf91, arg57_1, arg63_1, 223232, grid=grid(223232), stream=stream0)
        del arg57_1
        del arg63_1
        del buf63
        del buf91
        ...
        # Topologically Sorted Source Nodes: [off_summary], Original ATen: [aten.mean]
        triton_per_fused_mean_38.run(buf100, buf101, 6976, 32, grid=grid(6976), stream=stream0)
        # Topologically Sorted Source Nodes: [diag_summary, off_summary, off_gathered, index_add__2, index_add__3], Original ATen: [aten.mean, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_mean_39.run(arg64_1, arg66_1, buf101, arg65_1, buf102, buf104, 11392, grid=grid(11392), stream=stream0)
        del arg64_1
        del arg65_1
        del arg66_1
        buf106 = reinterpret_tensor(buf60, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [h_d_out], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf106, buf102, buf104, 262144, grid=grid(262144), stream=stream0)
        buf107 = buf52; del buf52  # reuse
        buf118 = buf25; del buf25  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        triton_poi_fused_addmm_41.run(buf106, buf107, buf118, 262144, grid=grid(262144), stream=stream0)
        buf108 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg68_1, buf107, reinterpret_tensor(arg67_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf108)
        del arg67_1
        del arg68_1
        del buf107
        buf109 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf108, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf108, (32, 128, 128), (16384, 1, 128), 0), out=buf109)
        del buf108
        buf110 = buf101; del buf101  # reuse
        # Topologically Sorted Source Nodes: [off_row_update], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), buf102, out=buf110)
        del arg30_1
        del buf102
        buf111 = empty_strided_cuda((1, 109, 64), (6976, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [off_col_update], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), buf104, out=buf111)
        del arg31_1
        del buf104
        buf112 = reinterpret_tensor(buf100, (1, 109, 32, 64), (223232, 2048, 64, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [h_o_out], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf112, buf110, buf111, 223232, grid=grid(223232), stream=stream0)
        del buf110
        del buf111
        buf113 = reinterpret_tensor(buf72, (3488, 32), (32, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg70_1, reinterpret_tensor(buf112, (3488, 64), (64, 1), 0), reinterpret_tensor(arg69_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf113)
        del arg69_1
        del arg70_1
        buf114 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg72_1, reinterpret_tensor(buf112, (3488, 64), (64, 1), 0), reinterpret_tensor(arg71_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf114)
        del arg71_1
        del arg72_1
        del buf112
        ...
        extern_kernels.bmm(reinterpret_tensor(buf113, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf114, (109, 32, 32), (1024, 1, 32), 0), out=buf115)
        del buf113
        del buf114
        buf116 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg76_1, reinterpret_tensor(buf106, (4096, 64), (64, 1), 0), reinterpret_tensor(arg75_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf116)
        del arg75_1
        del arg76_1
        buf117 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg78_1, reinterpret_tensor(buf106, (4096, 64), (64, 1), 0), reinterpret_tensor(arg77_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf117)
        del arg77_1
        del arg78_1
        del buf106
        buf119 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf118, reinterpret_tensor(arg73_1, (64, 1), (1, 64), 0), out=buf119)
        del arg73_1
        del buf118
        buf120 = reinterpret_tensor(buf119, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_43.run(buf120, arg74_1, 4096, grid=grid(4096), stream=stream0)
        del arg74_1
        buf121 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf109, buf115, buf116, buf117, buf120, buf121, 902144, grid=grid(902144), stream=stream0)
        del buf109
        del buf115
        del buf116
        del buf117
    return (buf121, reinterpret_tensor(buf120, (1, 32, 128), (4096, 128, 1), 0), )
