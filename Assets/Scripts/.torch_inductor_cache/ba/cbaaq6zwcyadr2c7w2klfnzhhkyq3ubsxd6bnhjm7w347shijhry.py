...
# Graph fragment:
#   %add_16 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_5, %view_36), kwargs = {})
#   %var_mean_3 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_38, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_5 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_38, %getitem_7), kwargs = {})
...
# Graph fragment:
#   %add_26 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_16, %view_65), kwargs = {})
...
# Graph fragment:
#   %var_mean_6 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_83, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_10 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_83, %getitem_13), kwargs = {})
...
#   %cat_5 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_84, %mean_2], 2), kwargs = {})
...
#   block_node_2 => mean_2
# Graph fragment:
#   %mean_2 : [num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%view_84, [2], True), kwargs = {})
...
#   %mul_33 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_93, 0.125), kwargs = {})
...
#   %sub_11 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%clone_17, %amax_2), kwargs = {})
...
#   x_out_9 => clone_20
# Graph fragment:
#   %clone_20 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%view_100,), kwargs = {memory_format: torch.contiguous_format})
...
#   xp_7 => add_34
# Graph fragment:
#   %add_34 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_83, %view_104), kwargs = {})
...
# Graph fragment:
#   %mul_36 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_106, 0.5), kwargs = {})
#   %mul_37 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_106, 0.7071067811865476), kwargs = {})
...
# Graph fragment:
#   %add_39 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_81, %view_110), kwargs = {})
#   %var_mean_8 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_112, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_14 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_112, %getitem_17), kwargs = {})
...
#   %cat_6 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_113, %mean_3], 2), kwargs = {})
...
#   xp_10 => add_44
# Graph fragment:
#   %add_44 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_112, %view_133), kwargs = {})
...
#   h_off_2 => add_49
# Graph fragment:
#   %add_49 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_39, %view_139), kwargs = {})
...
#   sigmoid => sigmoid
# Graph fragment:
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_153,), kwargs = {})
...
#   packed_1 => cat_8
# Graph fragment:
#   %cat_8 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_7, %view_154], 1), kwargs = {})
