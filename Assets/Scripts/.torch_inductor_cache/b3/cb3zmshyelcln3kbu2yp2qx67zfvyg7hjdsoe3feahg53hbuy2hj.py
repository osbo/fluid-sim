...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wc/cwc7ufmptuyoc7bgcrpjwsannjiuwozz5w3icb4smaqvzuahqdpm.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ph/cphnxjxmreby24jk4y3nd6nnuhf6lgjx5g43shlnpul7d5l5lg76.py
...
triton_per_fused__to_copy_clone_copy_lt_maximum_sum_28 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused__to_copy_clone_copy_lt_maximum_sum_28', 'mutated_arg_names': ['out_ptr1'], 'no_x_dim': False, 'num_load': 0, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
#   %where_2 : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%eq_2, %full_default_13, %add_21), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf115 = reinterpret_tensor(buf48, (1, 512, 128), (65536, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_23.run(buf64, buf25, buf55, arg45_1, arg51_1, arg68_1, arg69_1, buf115, 512, 128, grid=grid(512), stream=stream0)
        del arg45_1
        del arg51_1
        del arg68_1
        del arg69_1
        ...
        buf97 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf97, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_17, index_add__4, col_sum_1, getitem_18, index_add__5, row_sum, getitem_8, index_add__2, col_sum, getitem_9, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_25.run(buf59, buf65, buf64, buf68, buf25, buf66, buf69, buf95, buf97, 270336, grid=grid(270336), stream=stream0)
        buf77 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_26.run(buf66, arg35_1, buf69, arg52_1, arg53_1, buf77, 1536, 128, grid=grid(1536), stream=stream0)
        del arg52_1
        del arg53_1
        buf75 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mask_base_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf75, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2, lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.clone, aten.sum, aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_28.run(buf75, 1536, 32, grid=grid(1536), stream=stream0)
        ...
        buf79 = empty_strided_cuda((48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf78, arg55_1, buf79, 196608, grid=grid(196608), stream=stream0)
        buf80 = empty_strided_cuda((48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf78, arg55_1, buf80, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf81 = empty_strided_cuda((384, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf79, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf80, (384, 16, 32), (512, 32, 1), 0), out=buf81)
        buf82 = reinterpret_tensor(buf80, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(arg30_1, buf82, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_32.run(buf82, 6144, grid=grid(6144), stream=stream0)
        buf84 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf82, buf84, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf84, 1536, grid=grid(1536), stream=stream0)
        buf87 = empty_strided_cuda((48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(buf75, buf81, buf84, buf82, buf87, 12288, 32, grid=grid(12288), stream=stream0)
        buf88 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf87, buf88, 12288, 32, grid=grid(12288), stream=stream0)
        buf89 = reinterpret_tensor(buf79, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf84, buf82, buf89, 196608, grid=grid(196608), stream=stream0)
        buf90 = reinterpret_tensor(buf81, (49152, 8), (8, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf89, (49152, 4), (4, 1), 0), reinterpret_tensor(arg56_1, (4, 8), (1, 4), 0), out=buf90)
        del arg56_1
        buf91 = reinterpret_tensor(buf87, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf91, buf88, buf75, buf90, arg57_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg57_1
        buf92 = reinterpret_tensor(buf89, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf78, arg55_1, buf92, 196608, grid=grid(196608), stream=stream0)
        buf93 = reinterpret_tensor(buf82, (384, 32, 16), (512, 16, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf91, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf92, (384, 32, 16), (512, 16, 1), 0), out=buf93)
        del buf92
        buf94 = reinterpret_tensor(buf88, (1536, 8), (8, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf77, (1536, 128), (128, 1), 0), reinterpret_tensor(arg58_1, (128, 8), (1, 128), 0), out=buf94)
        del arg58_1
        del buf77
        buf99 = reinterpret_tensor(buf53, (48, 1, 1, 128), (128, 6144, 6144, 1), 0); del buf53  # reuse
        buf100 = reinterpret_tensor(buf99, (48, 1, 1, 128), (128, 1, 6144, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_40.run(buf100, buf95, arg35_1, buf97, 6144, 32, grid=grid(6144), stream=stream0)
        buf101 = empty_strided_cuda((48, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (48, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf101)
        del arg54_1
        buf102 = reinterpret_tensor(buf97, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [mul_5, x_mid_3, x_out_3], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_41.run(buf93, buf94, arg59_1, buf101, arg55_1, buf102, 196608, grid=grid(196608), stream=stream0)
        del arg55_1
        del arg59_1
        buf103 = reinterpret_tensor(buf93, (1536, 128), (128, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf102, (1536, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 128), (1, 128), 0), out=buf103)
        del arg60_1
        buf104 = reinterpret_tensor(buf103, (48, 32, 128), (4096, 128, 1), 0); del buf103  # reuse
        buf148 = reinterpret_tensor(buf102, (48, 32, 128), (4096, 128, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf104, buf66, arg35_1, buf69, arg61_1, arg62_1, arg63_1, buf148, 1536, 128, grid=grid(1536), stream=stream0)
        del arg61_1
        del arg62_1
        del arg63_1
        buf111 = buf31; del buf31  # reuse
        buf112 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [mask_base_4, sum_3], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_7.run(arg29_1, buf111, buf112, 512, 32, grid=grid(512), stream=stream0)
        ...
        triton_poi_fused__to_copy_copy_lt_maximum_8.run(buf113, arg29_1, buf112, 512, grid=grid(512), stream=stream0)
        del arg29_1
        buf116 = reinterpret_tensor(buf69, (512, 384), (384, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (512, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 384), (1, 128), 0), out=buf116)
        buf117 = reinterpret_tensor(buf25, (16, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf116, arg71_1, buf117, 65536, grid=grid(65536), stream=stream0)
        buf118 = reinterpret_tensor(buf55, (16, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf55  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf116, arg71_1, buf118, 2048, 32, grid=grid(2048, 32), stream=stream0)
        buf119 = reinterpret_tensor(buf47, (128, 32, 32), (1024, 32, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf117, (128, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf118, (128, 16, 32), (512, 32, 1), 0), out=buf119)
        buf120 = reinterpret_tensor(buf118, (1, 16, 32, 32, 4), (65536, 4096, 128, 4, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_11.run(arg28_1, buf120, 65536, grid=grid(65536), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_2, setitem_4], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_12.run(buf120, 2048, grid=grid(2048), stream=stream0)
        buf122 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf120, buf122, 16384, grid=grid(16384), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf122, 512, grid=grid(512), stream=stream0)
        buf125 = reinterpret_tensor(buf46, (1, 16, 32, 32, 8), (131072, 8192, 32, 1, 1024), 0); del buf46  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_15.run(buf112, buf119, buf122, buf120, buf125, 4096, 32, grid=grid(4096), stream=stream0)
        buf126 = reinterpret_tensor(buf50, (1, 16, 32, 1, 8), (4096, 256, 8, 4096, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_per_fused__softmax_16.run(buf125, buf126, 4096, 32, grid=grid(4096), stream=stream0)
        buf127 = reinterpret_tensor(buf117, (1, 16, 32, 32, 4), (65536, 4096, 128, 4, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf122, buf120, buf127, 65536, grid=grid(65536), stream=stream0)
        buf128 = reinterpret_tensor(buf119, (16384, 8), (8, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf127, (16384, 4), (4, 1), 0), reinterpret_tensor(arg72_1, (4, 8), (1, 4), 0), out=buf128)
        del arg72_1
        buf129 = reinterpret_tensor(buf125, (16, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf129, buf126, buf112, buf128, arg73_1, 128, 1024, grid=grid(128, 1024), stream=stream0)
        del arg73_1
        del buf128
        buf130 = reinterpret_tensor(buf127, (16, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf116, arg71_1, buf130, 65536, grid=grid(65536), stream=stream0)
        buf131 = reinterpret_tensor(buf120, (128, 32, 16), (512, 16, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf129, (128, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf130, (128, 32, 16), (512, 16, 1), 0), out=buf131)
        del buf129
        del buf130
        buf132 = reinterpret_tensor(buf126, (512, 8), (8, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 8), (1, 128), 0), out=buf132)
        del arg74_1
        buf133 = empty_strided_cuda((16, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf52, (16, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 384), (1, 128), 0), out=buf133)
        del arg70_1
        del buf52
        buf134 = reinterpret_tensor(buf115, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [mul_7, x_mid_5, x_out_6], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_21.run(buf131, buf132, arg75_1, buf133, arg71_1, buf134, 65536, grid=grid(65536), stream=stream0)
        del arg71_1
        del arg75_1
        del buf132
        del buf133
        buf135 = reinterpret_tensor(buf131, (512, 128), (128, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (512, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 128), (1, 128), 0), out=buf135)
        del arg76_1
        buf139 = reinterpret_tensor(buf134, (1, 512, 128), (65536, 128, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf64, buf135, arg77_1, arg78_1, arg79_1, buf139, 512, 128, grid=grid(512), stream=stream0)
        del arg78_1
        del arg79_1
        buf140 = reinterpret_tensor(buf62, (512, 512), (512, 1), 0); del buf62  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (512, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 512), (1, 128), 0), out=buf140)
        del arg80_1
        buf141 = reinterpret_tensor(buf140, (1, 512, 512), (262144, 512, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf141, arg81_1, 262144, grid=grid(262144), stream=stream0)
        del arg81_1
        buf142 = reinterpret_tensor(buf139, (512, 128), (128, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (512, 512), (512, 1), 0), reinterpret_tensor(arg82_1, (512, 128), (1, 512), 0), out=buf142)
        del arg82_1
        del buf141
        buf143 = reinterpret_tensor(buf142, (1, 512, 128), (65536, 128, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf143, buf64, buf135, arg77_1, arg83_1, 65536, grid=grid(65536), stream=stream0)
        del arg77_1
        del arg83_1
        del buf135
        del buf64
        buf144 = reinterpret_tensor(buf116, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf116  # reuse
        ...
        buf146 = buf66; del buf66  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf146, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_33, index_add__6, col_sum_2, getitem_34, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_44.run(buf59, buf65, buf143, buf68, buf144, buf146, 270336, grid=grid(270336), stream=stream0)
        buf149 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf148, (1536, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 512), (1, 128), 0), out=buf149)
        del arg64_1
        buf150 = reinterpret_tensor(buf149, (48, 32, 512), (16384, 512, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf150, arg65_1, 786432, grid=grid(786432), stream=stream0)
        del arg65_1
        buf151 = reinterpret_tensor(buf148, (1536, 128), (128, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf150, (1536, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 128), (1, 512), 0), out=buf151)
        del arg66_1
        buf152 = reinterpret_tensor(buf151, (48, 32, 128), (4096, 128, 1), 0); del buf151  # reuse
        buf159 = reinterpret_tensor(buf95, (48, 32, 128), (4096, 128, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_46.run(buf152, buf144, arg35_1, buf146, buf104, arg67_1, arg84_1, arg85_1, buf159, 1536, 128, grid=grid(1536), stream=stream0)
        del arg35_1
        del arg67_1
        del arg84_1
        del arg85_1
        del buf104
        buf157 = buf75; del buf75  # reuse
        # Topologically Sorted Source Nodes: [mask_base_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf157, 49152, grid=grid(49152), stream=stream0)
        ...
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_28.run(buf157, 1536, 32, grid=grid(1536), stream=stream0)
        buf160 = buf78; del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (1536, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf160)
        buf161 = reinterpret_tensor(buf146, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf160, arg87_1, buf161, 196608, grid=grid(196608), stream=stream0)
        buf162 = reinterpret_tensor(buf144, (48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf160, arg87_1, buf162, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf163 = reinterpret_tensor(buf91, (384, 32, 32), (1024, 32, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf161, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf162, (384, 16, 32), (512, 32, 1), 0), out=buf163)
        buf164 = reinterpret_tensor(buf162, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(arg30_1, buf164, 196608, grid=grid(196608), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_32.run(buf164, 6144, grid=grid(6144), stream=stream0)
        buf166 = buf84; del buf84  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf164, buf166, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf166, 1536, grid=grid(1536), stream=stream0)
        buf169 = reinterpret_tensor(buf90, (48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), 0); del buf90  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(buf157, buf163, buf166, buf164, buf169, 12288, 32, grid=grid(12288), stream=stream0)
        buf170 = reinterpret_tensor(buf94, (48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf169, buf170, 12288, 32, grid=grid(12288), stream=stream0)
        buf171 = reinterpret_tensor(buf161, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf166, buf164, buf171, 196608, grid=grid(196608), stream=stream0)
        buf172 = reinterpret_tensor(buf163, (49152, 8), (8, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (49152, 4), (4, 1), 0), reinterpret_tensor(arg88_1, (4, 8), (1, 4), 0), out=buf172)
        del arg88_1
        buf173 = reinterpret_tensor(buf169, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf173, buf170, buf157, buf172, arg89_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg89_1
        del buf172
        buf174 = reinterpret_tensor(buf171, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf160, arg87_1, buf174, 196608, grid=grid(196608), stream=stream0)
        del buf160
        buf175 = reinterpret_tensor(buf164, (384, 32, 16), (512, 16, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf173, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf174, (384, 32, 16), (512, 16, 1), 0), out=buf175)
        del buf173
        del buf174
        buf176 = reinterpret_tensor(buf170, (1536, 8), (8, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (1536, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 8), (1, 128), 0), out=buf176)
        del arg90_1
        buf177 = buf101; del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (48, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf177)
        del arg86_1
        del buf100
        buf178 = reinterpret_tensor(buf159, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [mul_9, x_mid_7, x_out_9], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_41.run(buf175, buf176, arg91_1, buf177, arg87_1, buf178, 196608, grid=grid(196608), stream=stream0)
        del arg87_1
        del arg91_1
        del buf176
        del buf177
        buf179 = reinterpret_tensor(buf175, (1536, 128), (128, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf178, (1536, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 128), (1, 128), 0), out=buf179)
        del arg92_1
        buf185 = reinterpret_tensor(buf178, (48, 32, 128), (4096, 128, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_47.run(buf152, buf179, arg93_1, arg94_1, arg95_1, buf185, 1536, 128, grid=grid(1536), stream=stream0)
        del arg94_1
        del arg95_1
        buf183 = reinterpret_tensor(buf112, (512, 32), (32, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf143, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf183)
        del arg100_1
        del arg101_1
        buf184 = reinterpret_tensor(buf122, (16, 32, 32), (1024, 32, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf183, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf183, (16, 32, 32), (1024, 1, 32), 0), out=buf184)
        buf186 = reinterpret_tensor(buf150, (1536, 512), (512, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf185, (1536, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 512), (1, 128), 0), out=buf186)
        del arg96_1
        buf187 = reinterpret_tensor(buf186, (48, 32, 512), (16384, 512, 1), 0); del buf186  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf187, arg97_1, 786432, grid=grid(786432), stream=stream0)
        del arg97_1
        buf188 = reinterpret_tensor(buf185, (1536, 128), (128, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf187, (1536, 512), (512, 1), 0), reinterpret_tensor(arg98_1, (512, 128), (1, 512), 0), out=buf188)
        del arg98_1
        del buf187
        buf189 = reinterpret_tensor(buf188, (48, 32, 128), (4096, 128, 1), 0); del buf188  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf189, buf152, buf179, arg93_1, arg99_1, 196608, grid=grid(196608), stream=stream0)
        del arg93_1
        del arg99_1
        del buf152
        del buf179
        buf190 = reinterpret_tensor(buf157, (1536, 32), (32, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf189, (1536, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf190)
        del arg102_1
        del arg103_1
        buf191 = reinterpret_tensor(buf166, (1536, 32), (32, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg105_1, reinterpret_tensor(buf189, (1536, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf191)
        del arg104_1
        del arg105_1
        del buf189
        buf192 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf190, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf191, (48, 32, 32), (1024, 1, 32), 0), out=buf192)
        del buf190
        del buf191
        buf193 = buf183; del buf183  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf143, (512, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf193)
        del arg108_1
        del arg109_1
        buf194 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf143, (512, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf194)
        del arg110_1
        del arg111_1
        buf195 = reinterpret_tensor(buf113, (512, 1), (1, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf143, (512, 128), (128, 1), 0), reinterpret_tensor(arg106_1, (128, 1), (1, 128), 0), out=buf195)
        del arg106_1
        del buf143
        buf196 = reinterpret_tensor(buf195, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf195  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_49.run(buf196, arg107_1, 512, grid=grid(512), stream=stream0)
        del arg107_1
        buf197 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_50.run(buf184, buf192, buf193, buf194, buf196, buf197, 98816, grid=grid(98816), stream=stream0)
        del buf184
        del buf192
        del buf193
        del buf194
    return (buf197, reinterpret_tensor(buf196, (1, 16, 32), (512, 32, 1), 0), buf65, buf68, buf59, )
