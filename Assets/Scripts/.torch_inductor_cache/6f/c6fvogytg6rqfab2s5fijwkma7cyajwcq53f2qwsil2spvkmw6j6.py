...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf110 = reinterpret_tensor(buf36, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [col_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf110, 262144, grid=grid(262144), stream=stream0)
        buf134 = reinterpret_tensor(buf35, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf35  # reuse
        ...
        buf137 = empty_strided_cuda((1, 32, 128, 64), (262144, 8192, 64, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9, row_highway_2, index_add__8], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_23.run(buf67, buf25, buf52, arg41_1, arg48_1, arg42_1, buf106, buf110, buf134, buf137, 262144, grid=grid(262144), stream=stream0)
        del arg41_1
        del arg42_1
        del arg48_1
        del buf25
        ...
        del arg57_1
        buf117 = reinterpret_tensor(buf75, (109, 32, 192), (6144, 192, 1), 0); del buf75  # reuse
        buf114 = reinterpret_tensor(buf117, (109, 32, 64), (6144, 192, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf70, buf98, arg58_1, arg62_1, arg63_1, buf114, 3488, 64, grid=grid(3488), stream=stream0)
        del arg62_1
        del arg63_1
        ...
        del buf104
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_38.run(arg60_1, arg59_1, buf70, buf98, arg58_1, arg61_1, buf106, buf110, 1458176, grid=grid(1458176), stream=stream0)
        buf109 = reinterpret_tensor(buf94, (1, 109, 8192), (892928, 8192, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf106, (1, 32, 8192), (262144, 8192, 1), 0), out=buf109)
        del arg30_1
        del buf106
        buf113 = reinterpret_tensor(buf93, (1, 109, 8192), (892928, 8192, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf110, (1, 32, 8192), (262144, 8192, 1), 0), out=buf113)
        del arg31_1
        del buf110
        buf115 = reinterpret_tensor(buf117, (109, 32, 64), (6144, 192, 1), 64)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf109, buf115, 223232, grid=grid(223232), stream=stream0)
        del buf109
        buf116 = reinterpret_tensor(buf117, (109, 32, 64), (6144, 192, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf113, buf116, 223232, grid=grid(223232), stream=stream0)
        del buf114
        del buf115
        del buf116
        buf118 = reinterpret_tensor(buf113, (3488, 256), (256, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf117, (3488, 192), (192, 1), 0), reinterpret_tensor(arg64_1, (192, 256), (1, 192), 0), out=buf118)
        del arg64_1
        del buf117
        buf119 = reinterpret_tensor(buf118, (109, 32, 256), (8192, 256, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_40.run(buf119, arg65_1, 892928, grid=grid(892928), stream=stream0)
        del arg65_1
        buf120 = reinterpret_tensor(buf97, (3488, 64), (64, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (3488, 256), (256, 1), 0), reinterpret_tensor(arg66_1, (256, 64), (1, 256), 0), out=buf120)
        del arg66_1
        del buf119
        buf121 = reinterpret_tensor(buf120, (109, 32, 64), (2048, 64, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_41.run(buf121, buf70, buf98, arg58_1, arg67_1, 223232, grid=grid(223232), stream=stream0)
        del arg58_1
        del arg67_1
        del buf70
        buf122 = buf98; del buf98  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (3488, 64), (64, 1), 0), reinterpret_tensor(arg72_1, (64, 64), (1, 64), 0), out=buf122)
        del arg72_1
        buf123 = reinterpret_tensor(buf122, (109, 1, 32, 64), (2048, 1, 64, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf123, arg73_1, 223232, grid=grid(223232), stream=stream0)
        del arg73_1
        buf124 = reinterpret_tensor(buf79, (3488, 32), (32, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf123, (3488, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf124)
        del arg74_1
        del arg75_1
        buf125 = reinterpret_tensor(buf123, (3488, 64), (64, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (3488, 64), (64, 1), 0), reinterpret_tensor(arg76_1, (64, 64), (1, 64), 0), out=buf125)
        del arg76_1
        ...
        triton_poi_fused_gelu_42.run(buf126, arg77_1, 223232, grid=grid(223232), stream=stream0)
        del arg77_1
        buf127 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf126, (3488, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf127)
        del arg78_1
        del arg79_1
        del buf126
        buf128 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        ...
        del buf124
        del buf127
        buf129 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf67, (4096, 64), (64, 1), 0), reinterpret_tensor(arg82_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf129)
        del arg82_1
        del arg83_1
        buf130 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf67, (4096, 64), (64, 1), 0), reinterpret_tensor(arg84_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf130)
        del arg84_1
        del arg85_1
        buf131 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (4096, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 1), (1, 64), 0), out=buf131)
        del arg80_1
        del buf67
        ...
        del buf130
        # Topologically Sorted Source Nodes: [toks_3, index_add__11, index_add__10], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_45.run(arg61_1, arg59_1, buf121, arg60_1, buf134, buf137, 1458176, grid=grid(1458176), stream=stream0)
        del arg59_1
        del arg60_1
        del arg61_1
        del buf121
    return (buf133, reinterpret_tensor(buf132, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf134, (1, 4096, 64), (262144, 64, 1), 0), reinterpret_tensor(buf137, (1, 4096, 64), (262144, 64, 1), 0), )
