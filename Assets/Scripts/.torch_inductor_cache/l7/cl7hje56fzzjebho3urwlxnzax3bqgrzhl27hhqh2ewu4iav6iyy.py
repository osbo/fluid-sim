...
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_6, [None, %arg64_1], %view_88, True), kwargs = {})
#   %full_default_7 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_7, [None, %arg64_1], %view_88, True), kwargs = {})
...
#   toks => index_2
# Graph fragment:
#   %index_2 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_89, [None, %arg65_1]), kwargs = {})
#   %index_put_8 : [num_users=3] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_6, [None, %arg66_1], %index_2, True), kwargs = {})
#   %index_put_9 : [num_users=3] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_7, [None, %arg67_1], %index_2, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg46_1
        del buf58
        buf101 = reinterpret_tensor(buf49, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [col_highway], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf101, 262144, grid=grid(262144), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x, x_1, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_21.run(buf60, buf25, buf52, arg41_1, arg47_1, arg64_1, buf93, buf101, 262144, grid=grid(262144), stream=stream0)
        del arg41_1
        del arg47_1
        del arg64_1
        del buf25
        ...
        del arg56_1
        buf95 = reinterpret_tensor(buf88, (109, 128, 64), (8192, 64, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf61, buf62, buf89, arg57_1, arg58_1, arg59_1, buf95, 13952, 64, grid=grid(13952), stream=stream0)
        del arg58_1
        del arg59_1
        buf96 = empty_strided_cuda((13952, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf95, (13952, 64), (64, 1), 0), reinterpret_tensor(arg60_1, (64, 256), (1, 64), 0), out=buf96)
        del arg60_1
        buf97 = reinterpret_tensor(buf96, (109, 128, 256), (32768, 256, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf97, arg61_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg61_1
        buf98 = reinterpret_tensor(buf95, (13952, 64), (64, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (13952, 256), (256, 1), 0), reinterpret_tensor(arg62_1, (256, 64), (1, 256), 0), out=buf98)
        del arg62_1
        del buf97
        buf99 = reinterpret_tensor(buf98, (109, 128, 64), (8192, 64, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_37.run(buf99, buf61, buf62, buf89, arg57_1, arg63_1, 892928, grid=grid(892928), stream=stream0)
        del arg57_1
        del arg63_1
        del buf61
        # Topologically Sorted Source Nodes: [toks, index_add__4, index_add__5], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_38.run(arg66_1, arg65_1, buf99, arg67_1, buf93, buf101, 1458176, grid=grid(1458176), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        buf104 = reinterpret_tensor(buf30, (1, 32, 128, 192), (786432, 24576, 192, 1), 0); del buf30  # reuse
        # Topologically Sorted Source Nodes: [h_in], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf60, buf93, buf101, buf104, 786432, grid=grid(786432), stream=stream0)
        buf105 = buf52; del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf104, (4096, 192), (192, 1), 0), reinterpret_tensor(arg68_1, (192, 64), (1, 192), 0), out=buf105)
        del arg68_1
        del buf104
        buf106 = reinterpret_tensor(buf105, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf106, arg69_1, 262144, grid=grid(262144), stream=stream0)
        del arg69_1
        buf107 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf106, (4096, 64), (64, 1), 0), reinterpret_tensor(arg70_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf107)
        del arg70_1
        del arg71_1
        del buf106
        buf108 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        ...
        buf109 = reinterpret_tensor(buf89, (1, 109, 8192), (892928, 8192, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf93, (1, 32, 8192), (262144, 8192, 1), 0), out=buf109)
        del arg30_1
        buf110 = buf62; del buf62  # reuse
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf101, (1, 32, 8192), (262144, 8192, 1), 0), out=buf110)
        del arg31_1
        buf111 = reinterpret_tensor(buf67, (109, 1, 128, 192), (24576, 1, 192, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [h_in_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_40.run(buf99, buf109, buf110, buf111, 2678784, grid=grid(2678784), stream=stream0)
        del buf109
        del buf110
        buf112 = reinterpret_tensor(buf99, (13952, 64), (64, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf111, (13952, 192), (192, 1), 0), reinterpret_tensor(arg72_1, (192, 64), (1, 192), 0), out=buf112)
        del arg72_1
        buf113 = reinterpret_tensor(buf112, (109, 1, 128, 64), (8192, 1, 64, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf113, arg73_1, 892928, grid=grid(892928), stream=stream0)
        del arg73_1
        buf114 = reinterpret_tensor(buf70, (13952, 128), (128, 1), 0); del buf70  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf113, (13952, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf114)
        del arg74_1
        del arg75_1
        buf115 = reinterpret_tensor(buf113, (13952, 64), (64, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf111, (13952, 192), (192, 1), 0), reinterpret_tensor(arg76_1, (192, 64), (1, 192), 0), out=buf115)
        del arg76_1
        del buf111
        ...
        triton_poi_fused_gelu_41.run(buf116, arg77_1, 892928, grid=grid(892928), stream=stream0)
        del arg77_1
        buf117 = empty_strided_cuda((13952, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf116, (13952, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf117)
        del arg78_1
        del arg79_1
        del buf116
        buf118 = empty_strided_cuda((109, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf114, (109, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf117, (109, 128, 128), (16384, 1, 128), 0), out=buf118)
        del buf114
        del buf117
        buf119 = buf107; del buf107  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg82_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf119)
        del arg82_1
        del arg83_1
        buf120 = empty_strided_cuda((4096, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg84_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf120)
        del arg84_1
        del arg85_1
        buf121 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 1), (1, 64), 0), out=buf121)
        del arg80_1
        del buf60
        buf122 = reinterpret_tensor(buf121, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_42.run(buf122, arg81_1, 4096, grid=grid(4096), stream=stream0)
        del arg81_1
        buf123 = empty_strided_cuda((1, 3362816), (3362816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf108, buf118, buf119, buf120, buf122, buf123, 3362816, grid=grid(3362816), stream=stream0)
        del buf108
        del buf118
        del buf119
        del buf120
    return (buf123, reinterpret_tensor(buf122, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf101, (1, 4096, 64), (262144, 64, 1), 0), reinterpret_tensor(buf93, (1, 4096, 64), (262144, 64, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg65_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg66_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg67_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
