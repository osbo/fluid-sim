...
def call(args):
    ...
    assert_size_stride(arg59_1, (22, ), (1, ))
    assert_size_stride(arg60_1, (22, ), (1, ))
    assert_size_stride(arg61_1, (22, ), (1, ))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, z, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_20.run(buf25, buf52, arg41_1, arg42_1, arg43_1, arg44_1, buf56, buf58, buf62, 1024, 128, grid=grid(1024), stream=stream0)
        del arg43_1
        del arg44_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf66, (1024, 512), (512, 1), 0), reinterpret_tensor(arg45_1, (512, 512), (1, 512), 0), out=buf67)
        del arg45_1
        buf68 = reinterpret_tensor(buf67, (1, 1024, 512), (524288, 512, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_25.run(buf68, arg46_1, 524288, grid=grid(524288), stream=stream0)
        del arg46_1
        buf69 = reinterpret_tensor(buf58, (1024, 128), (128, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf68, (1024, 512), (512, 1), 0), reinterpret_tensor(arg47_1, (512, 128), (1, 512), 0), out=buf69)
        del arg47_1
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_26.run(buf70, buf25, buf52, arg41_1, arg48_1, arg68_1, arg69_1, buf108, 1024, 128, grid=grid(1024), stream=stream0)
        del arg41_1
        del arg48_1
        del arg68_1
        del arg69_1
        ...
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_27.run(buf71, buf72, arg49_1, arg50_1, buf73, buf77, 608, 128, grid=grid(608), stream=stream0)
        del arg49_1
        del arg50_1
        buf78 = empty_strided_cuda((608, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf77, (608, 128), (128, 1), 0), reinterpret_tensor(arg51_1, (128, 384), (1, 128), 0), out=buf78)
        del arg51_1
        buf80 = reinterpret_tensor(buf77, (19, 1, 32, 32, 4), (4096, 77824, 128, 4, 1), 0); del buf77  # reuse
        buf178 = empty_strided_cuda((19, 1, 32, 32, 4), (4096, 77824, 128, 4, 1), torch.float32)
        buf276 = empty_strided_cuda((19, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [sub, setitem_2, setitem_6], Original ATen: [aten.mean, aten.lift_fresh, aten.index_put]
        triton_per_fused_index_put_lift_fresh_mean_28.run(arg29_1, buf80, buf178, buf276, 77824, 16, grid=grid(77824), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf78, arg52_1, buf84, 77824, grid=grid(77824), stream=stream0)
        buf85 = empty_strided_cuda((19, 8, 32, 16), (4096, 512, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf78, arg52_1, buf85, 77824, grid=grid(77824), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf78, arg52_1, buf86, buf98, 77824, grid=grid(77824), stream=stream0)
        del arg52_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf93, (19456, 4), (4, 1), 0), reinterpret_tensor(arg53_1, (4, 16), (1, 4), 0), out=buf94)
        del arg53_1
        buf95 = reinterpret_tensor(buf94, (19, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf95, arg54_1, 311296, grid=grid(311296), stream=stream0)
        del arg54_1
        buf96 = reinterpret_tensor(buf87, (19456, 8), (8, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf95, (19456, 16), (16, 1), 0), reinterpret_tensor(arg55_1, (16, 8), (1, 16), 0), out=buf96)
        del arg55_1
        buf97 = empty_strided_cuda((19, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf96, arg56_1, buf97, 152, 1024, grid=grid(152, 1024), stream=stream0)
        del arg56_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (608, 128), (128, 1), 0), reinterpret_tensor(arg57_1, (128, 128), (1, 128), 0), out=buf101)
        del arg57_1
        buf150 = reinterpret_tensor(buf95, (19, 32, 512), (16384, 512, 1), 0); del buf95  # reuse
        buf146 = reinterpret_tensor(buf150, (19, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf73, buf101, arg58_1, arg62_1, arg63_1, buf146, 608, 128, grid=grid(608), stream=stream0)
        del arg62_1
        del arg63_1
        ...
        buf141 = reinterpret_tensor(buf116, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [col_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf141, 131072, grid=grid(131072), stream=stream0)
        buf156 = reinterpret_tensor(buf115, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [col_highway_2], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf156, 131072, grid=grid(131072), stream=stream0)
        buf165 = reinterpret_tensor(buf123, (1, 1024, 512), (524288, 512, 1), 0); del buf123  # reuse
        buf161 = reinterpret_tensor(buf165, (1, 1024, 128), (524288, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_d_1, z_4, row_highway_2, index_add__8, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_41.run(buf70, buf131, arg77_1, arg42_1, arg78_1, arg79_1, buf135, buf156, buf161, buf137, buf141, 1024, 128, grid=grid(1024), stream=stream0)
        del arg78_1
        del arg79_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_42.run(arg60_1, arg59_1, buf73, buf101, arg58_1, arg61_1, buf137, buf141, 360448, grid=grid(360448), stream=stream0)
        buf140 = buf71; del buf71  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf137, (1, 8, 16384), (131072, 16384, 1), 0), out=buf140)
        buf144 = empty_strided_cuda((1, 19, 16384), (311296, 16384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf141, (1, 8, 16384), (131072, 16384, 1), 0), out=buf144)
        buf145 = empty_strided_cuda((19, 1, 128), (128, 2432, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_mid_o, g_1], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_43.run(buf73, buf101, arg58_1, buf145, 2432, 32, grid=grid(2432), stream=stream0)
        buf147 = reinterpret_tensor(buf150, (19, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf140, buf147, 77824, grid=grid(77824), stream=stream0)
        buf148 = reinterpret_tensor(buf150, (19, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf144, buf148, 77824, grid=grid(77824), stream=stream0)
        buf149 = reinterpret_tensor(buf150, (19, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf145, buf149, 77824, grid=grid(77824), stream=stream0)
        del buf146
        del buf147
        del buf148
        del buf149
        buf151 = reinterpret_tensor(buf144, (608, 512), (512, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf150, (608, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 512), (1, 512), 0), out=buf151)
        del arg64_1
        buf152 = reinterpret_tensor(buf151, (19, 32, 512), (16384, 512, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_46.run(buf152, arg65_1, 311296, grid=grid(311296), stream=stream0)
        del arg65_1
        buf153 = reinterpret_tensor(buf100, (608, 128), (128, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf152, (608, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 128), (1, 512), 0), out=buf153)
        del arg66_1
        buf154 = reinterpret_tensor(buf153, (19, 32, 128), (4096, 128, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_47.run(buf154, buf73, buf101, arg58_1, arg67_1, 77824, grid=grid(77824), stream=stream0)
        del arg58_1
        del arg67_1
        # Topologically Sorted Source Nodes: [toks_3, index_add__10, index_add__11], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_48.run(arg60_1, arg59_1, buf154, arg61_1, buf135, buf156, 360448, grid=grid(360448), stream=stream0)
        buf159 = buf60; del buf60  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, g_2], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_21.run(buf70, buf131, arg77_1, buf159, 1024, 128, grid=grid(1024), stream=stream0)
        buf160 = buf61; del buf61  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, g_2], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_22.run(buf159, buf160, 128, 8, grid=grid(128), stream=stream0)
        buf162 = reinterpret_tensor(buf165, (1, 1024, 128), (524288, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_5], Original ATen: [aten.cat]
        triton_poi_fused_cat_23.run(buf135, buf162, 131072, grid=grid(131072), stream=stream0)
        buf163 = reinterpret_tensor(buf165, (1, 1024, 128), (524288, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_5], Original ATen: [aten.cat]
        triton_poi_fused_cat_23.run(buf156, buf163, 131072, grid=grid(131072), stream=stream0)
        buf164 = reinterpret_tensor(buf165, (1, 1024, 128), (524288, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_5], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf160, buf164, 131072, grid=grid(131072), stream=stream0)
        del buf161
        del buf162
        del buf163
        del buf164
        buf166 = reinterpret_tensor(buf110, (1024, 512), (512, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (1024, 512), (512, 1), 0), reinterpret_tensor(arg80_1, (512, 512), (1, 512), 0), out=buf166)
        del arg80_1
        buf167 = reinterpret_tensor(buf166, (1, 1024, 512), (524288, 512, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_25.run(buf167, arg81_1, 524288, grid=grid(524288), stream=stream0)
        del arg81_1
        buf168 = reinterpret_tensor(buf156, (1024, 128), (128, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf167, (1024, 512), (512, 1), 0), reinterpret_tensor(arg82_1, (512, 128), (1, 512), 0), out=buf168)
        del arg82_1
        buf169 = reinterpret_tensor(buf168, (1, 1024, 128), (131072, 128, 1), 0); del buf168  # reuse
        buf206 = reinterpret_tensor(buf135, (1, 1024, 128), (131072, 128, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, h_diag_2, layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_26.run(buf169, buf70, buf131, arg77_1, arg83_1, arg100_1, arg101_1, buf206, 1024, 128, grid=grid(1024), stream=stream0)
        del arg100_1
        del arg101_1
        del arg77_1
        del arg83_1
        buf170 = reinterpret_tensor(buf152, (1, 19, 16384), (311296, 16384, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [row_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf169, (1, 8, 16384), (131072, 16384, 1), 0), out=buf170)
        buf171 = reinterpret_tensor(buf150, (1, 19, 16384), (311296, 16384, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [col_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf169, (1, 8, 16384), (131072, 16384, 1), 0), out=buf171)
        buf172 = buf154; del buf154  # reuse
        buf176 = buf73; del buf73  # reuse
        # Topologically Sorted Source Nodes: [h_off_5, off_in, layer_norm_7], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_49.run(buf172, buf170, buf171, arg84_1, arg85_1, buf176, 608, 128, grid=grid(608), stream=stream0)
        del arg84_1
        del arg85_1
        buf177 = buf78; del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf176, (608, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf177)
        del arg86_1
        # Topologically Sorted Source Nodes: [setitem_6], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf178, 2432, grid=grid(2432), stream=stream0)
        buf180 = buf82; del buf82  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf178, buf180, 19456, grid=grid(19456), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf180, 608, grid=grid(608), stream=stream0)
        buf182 = reinterpret_tensor(buf176, (19, 8, 32, 16), (4096, 512, 16, 1), 0); del buf176  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf177, arg87_1, buf182, 77824, grid=grid(77824), stream=stream0)
        buf183 = reinterpret_tensor(buf101, (19, 8, 32, 16), (4096, 512, 16, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf177, arg87_1, buf183, 77824, grid=grid(77824), stream=stream0)
        buf184 = reinterpret_tensor(buf98, (19, 8, 32, 16), (4096, 512, 16, 1), 0); del buf98  # reuse
        buf196 = reinterpret_tensor(buf80, (19, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf80  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf177, arg87_1, buf184, buf196, 77824, grid=grid(77824), stream=stream0)
        del arg87_1
        buf185 = reinterpret_tensor(buf97, (19, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf180, buf178, buf185, 155648, grid=grid(155648), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf187 = buf186[0]
        del buf186
        buf191 = reinterpret_tensor(buf184, (19, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf184  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf180, buf178, buf191, 77824, grid=grid(77824), stream=stream0)
        buf192 = reinterpret_tensor(buf171, (19456, 16), (16, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf191, (19456, 4), (4, 1), 0), reinterpret_tensor(arg88_1, (4, 16), (1, 4), 0), out=buf192)
        del arg88_1
        buf193 = reinterpret_tensor(buf192, (19, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf193, arg89_1, 311296, grid=grid(311296), stream=stream0)
        del arg89_1
        buf194 = reinterpret_tensor(buf185, (19456, 8), (8, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf193, (19456, 16), (16, 1), 0), reinterpret_tensor(arg90_1, (16, 8), (1, 16), 0), out=buf194)
        del arg90_1
        buf195 = reinterpret_tensor(buf96, (19, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [einsum_11], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf194, arg91_1, buf195, 152, 1024, grid=grid(152, 1024), stream=stream0)
        del arg91_1
        buf197 = reinterpret_tensor(buf191, (152, 32, 16), (512, 16, 1), 0); del buf191  # reuse
        # Topologically Sorted Source Nodes: [einsum_11], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf195, (152, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf196, (152, 32, 16), (512, 16, 1), 0), out=buf197)
        buf198 = reinterpret_tensor(buf187, (19, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_39.run(buf198, buf197, 77824, grid=grid(77824), stream=stream0)
        buf199 = reinterpret_tensor(buf197, (608, 128), (128, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf198, (608, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 128), (1, 128), 0), out=buf199)
        del arg92_1
        buf248 = reinterpret_tensor(buf193, (19, 32, 512), (16384, 512, 1), 0); del buf193  # reuse
        buf244 = reinterpret_tensor(buf248, (19, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_1, z_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf172, buf199, arg93_1, arg94_1, arg95_1, buf244, 608, 128, grid=grid(608), stream=stream0)
        del arg94_1
        del arg95_1
        buf207 = buf109; del buf109  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf206, (1024, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 384), (1, 128), 0), out=buf207)
        del arg102_1
        buf208 = reinterpret_tensor(buf167, (1, 8, 128, 128, 4), (524288, 65536, 512, 4, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_7.run(arg28_1, buf208, 524288, grid=grid(524288), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_8.run(buf208, 4096, grid=grid(4096), stream=stream0)
        buf210 = reinterpret_tensor(buf206, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf206  # reuse
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_9.run(buf208, buf210, 131072, grid=grid(131072), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_10.run(buf210, 1024, grid=grid(1024), stream=stream0)
        buf212 = reinterpret_tensor(buf70, (8, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf70  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_11.run(buf207, arg103_1, buf212, 131072, grid=grid(131072), stream=stream0)
        buf213 = reinterpret_tensor(buf131, (8, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf207, arg103_1, buf213, 131072, grid=grid(131072), stream=stream0)
        buf214 = reinterpret_tensor(buf141, (8, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf141  # reuse
        buf226 = reinterpret_tensor(buf137, (8, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf137  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf207, arg103_1, buf214, buf226, 131072, grid=grid(131072), stream=stream0)
        del arg103_1
        del buf207
        buf215 = reinterpret_tensor(buf127, (8, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf210, buf208, buf215, 1048576, grid=grid(1048576), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf216 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf212, buf213, buf214, buf215, False)
        buf217 = buf216[0]
        del buf216
        buf221 = reinterpret_tensor(buf165, (1, 8, 128, 128, 4), (524288, 65536, 512, 4, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf210, buf208, buf221, 524288, grid=grid(524288), stream=stream0)
        buf222 = reinterpret_tensor(buf125, (131072, 16), (16, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf221, (131072, 4), (4, 1), 0), reinterpret_tensor(arg104_1, (4, 16), (1, 4), 0), out=buf222)
        del arg104_1
        buf223 = reinterpret_tensor(buf222, (1, 8, 128, 128, 16), (2097152, 262144, 2048, 16, 1), 0); del buf222  # reuse
        # Topologically Sorted Source Nodes: [input_35], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_16.run(buf223, arg105_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg105_1
        buf224 = reinterpret_tensor(buf215, (131072, 8), (8, 1), 0); del buf215  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf223, (131072, 16), (16, 1), 0), reinterpret_tensor(arg106_1, (16, 8), (1, 16), 0), out=buf224)
        del arg106_1
        del buf223
        buf225 = reinterpret_tensor(buf126, (8, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [einsum_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf224, arg107_1, buf225, 64, 16384, grid=grid(64, 16384), stream=stream0)
        del arg107_1
        del buf224
        buf227 = reinterpret_tensor(buf210, (64, 128, 16), (2048, 16, 1), 0); del buf210  # reuse
        # Topologically Sorted Source Nodes: [einsum_14], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf225, (64, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf226, (64, 128, 16), (2048, 16, 1), 0), out=buf227)
        del buf225
        buf228 = reinterpret_tensor(buf217, (1, 8, 128, 8, 16), (131072, 16384, 128, 16, 1), 0); del buf217  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.add]
        triton_poi_fused_add_18.run(buf228, buf227, 131072, grid=grid(131072), stream=stream0)
        buf229 = reinterpret_tensor(buf227, (1024, 128), (128, 1), 0); del buf227  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf228, (1024, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), out=buf229)
        del arg108_1
        buf233 = reinterpret_tensor(buf228, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf228  # reuse
        # Topologically Sorted Source Nodes: [row_highway_4], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf233, 131072, grid=grid(131072), stream=stream0)
        buf235 = reinterpret_tensor(buf226, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf226  # reuse
        # Topologically Sorted Source Nodes: [row_highway_3], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf235, 131072, grid=grid(131072), stream=stream0)
        buf239 = reinterpret_tensor(buf214, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf214  # reuse
        # Topologically Sorted Source Nodes: [col_highway_3], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf239, 131072, grid=grid(131072), stream=stream0)
        buf254 = reinterpret_tensor(buf213, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf213  # reuse
        # Topologically Sorted Source Nodes: [col_highway_4], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf254, 131072, grid=grid(131072), stream=stream0)
        buf263 = reinterpret_tensor(buf221, (1, 1024, 512), (524288, 512, 1), 0); del buf221  # reuse
        buf259 = reinterpret_tensor(buf263, (1, 1024, 128), (524288, 512, 1), 0)  # alias
        ...
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_41.run(buf169, buf229, arg109_1, arg42_1, arg110_1, arg111_1, buf233, buf254, buf259, buf235, buf239, 1024, 128, grid=grid(1024), stream=stream0)
        del arg110_1
        del arg111_1
        # Topologically Sorted Source Nodes: [toks_5, index_add__14, index_add__15], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_42.run(arg60_1, arg59_1, buf172, buf199, arg93_1, arg61_1, buf235, buf239, 360448, grid=grid(360448), stream=stream0)
        buf238 = buf170; del buf170  # reuse
        # Topologically Sorted Source Nodes: [row_t_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf235, (1, 8, 16384), (131072, 16384, 1), 0), out=buf238)
        buf242 = buf140; del buf140  # reuse
        # Topologically Sorted Source Nodes: [col_t_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf239, (1, 8, 16384), (131072, 16384, 1), 0), out=buf242)
        buf243 = buf145; del buf145  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, g_3], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_43.run(buf172, buf199, arg93_1, buf243, 2432, 32, grid=grid(2432), stream=stream0)
        buf245 = reinterpret_tensor(buf248, (19, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf238, buf245, 77824, grid=grid(77824), stream=stream0)
        buf246 = reinterpret_tensor(buf248, (19, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf242, buf246, 77824, grid=grid(77824), stream=stream0)
        buf247 = reinterpret_tensor(buf248, (19, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf243, buf247, 77824, grid=grid(77824), stream=stream0)
        del buf244
        del buf245
        del buf246
        del buf247
        buf249 = reinterpret_tensor(buf242, (608, 512), (512, 1), 0); del buf242  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf248, (608, 512), (512, 1), 0), reinterpret_tensor(arg96_1, (512, 512), (1, 512), 0), out=buf249)
        del arg96_1
        buf250 = reinterpret_tensor(buf249, (19, 32, 512), (16384, 512, 1), 0); del buf249  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_46.run(buf250, arg97_1, 311296, grid=grid(311296), stream=stream0)
        del arg97_1
        buf251 = reinterpret_tensor(buf198, (608, 128), (128, 1), 0); del buf198  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf250, (608, 512), (512, 1), 0), reinterpret_tensor(arg98_1, (512, 128), (1, 512), 0), out=buf251)
        del arg98_1
        buf252 = reinterpret_tensor(buf251, (19, 32, 128), (4096, 128, 1), 0); del buf251  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, off_stream_1], Original ATen: [aten.add]
        triton_poi_fused_add_47.run(buf252, buf172, buf199, arg93_1, arg99_1, 77824, grid=grid(77824), stream=stream0)
        del arg93_1
        del arg99_1
        # Topologically Sorted Source Nodes: [toks_7, index_add__18, index_add__19], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_48.run(arg60_1, arg59_1, buf252, arg61_1, buf233, buf254, 360448, grid=grid(360448), stream=stream0)
        buf257 = buf159; del buf159  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, g_4], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_21.run(buf169, buf229, arg109_1, buf257, 1024, 128, grid=grid(1024), stream=stream0)
        buf258 = buf160; del buf160  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, g_4], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_22.run(buf257, buf258, 128, 8, grid=grid(128), stream=stream0)
        buf260 = reinterpret_tensor(buf263, (1, 1024, 128), (524288, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_23.run(buf233, buf260, 131072, grid=grid(131072), stream=stream0)
        buf261 = reinterpret_tensor(buf263, (1, 1024, 128), (524288, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_23.run(buf254, buf261, 131072, grid=grid(131072), stream=stream0)
        buf262 = reinterpret_tensor(buf263, (1, 1024, 128), (524288, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf258, buf262, 131072, grid=grid(131072), stream=stream0)
        del buf258
        del buf259
        del buf260
        del buf261
        del buf262
        buf264 = reinterpret_tensor(buf208, (1024, 512), (512, 1), 0); del buf208  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf263, (1024, 512), (512, 1), 0), reinterpret_tensor(arg112_1, (512, 512), (1, 512), 0), out=buf264)
        del arg112_1
        del buf263
        buf265 = reinterpret_tensor(buf264, (1, 1024, 512), (524288, 512, 1), 0); del buf264  # reuse
        # Topologically Sorted Source Nodes: [input_38], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_25.run(buf265, arg113_1, 524288, grid=grid(524288), stream=stream0)
        del arg113_1
        buf266 = reinterpret_tensor(buf254, (1024, 128), (128, 1), 0); del buf254  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf265, (1024, 512), (512, 1), 0), reinterpret_tensor(arg114_1, (512, 128), (1, 512), 0), out=buf266)
        del arg114_1
        del buf265
        buf305 = buf233; del buf233  # reuse
        # Topologically Sorted Source Nodes: [row_highway_5], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf305, 131072, grid=grid(131072), stream=stream0)
        buf309 = buf239; del buf239  # reuse
        # Topologically Sorted Source Nodes: [col_highway_5], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf309, 131072, grid=grid(131072), stream=stream0)
        buf335 = buf235; del buf235  # reuse
        # Topologically Sorted Source Nodes: [col_highway_6], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf335, 131072, grid=grid(131072), stream=stream0)
        buf338 = reinterpret_tensor(buf212, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf212  # reuse
        ...
        buf267 = reinterpret_tensor(buf266, (1, 1024, 128), (131072, 128, 1), 0); del buf266  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, h_diag_3, row_highway_5, index_add__20, col_highway_5, index_add__21, col_highway_6, index_add__25, row_highway_6, index_add__24], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_50.run(buf267, buf169, buf229, arg109_1, arg115_1, arg42_1, buf305, buf309, buf335, buf338, 131072, grid=grid(131072), stream=stream0)
        del arg109_1
        del arg115_1
        del arg42_1
        buf268 = reinterpret_tensor(buf250, (1, 19, 16384), (311296, 16384, 1), 0); del buf250  # reuse
        # Topologically Sorted Source Nodes: [row_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf267, (1, 8, 16384), (131072, 16384, 1), 0), out=buf268)
        buf269 = reinterpret_tensor(buf248, (1, 19, 16384), (311296, 16384, 1), 0); del buf248  # reuse
        # Topologically Sorted Source Nodes: [col_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf267, (1, 8, 16384), (131072, 16384, 1), 0), out=buf269)
        buf270 = buf252; del buf252  # reuse
        buf274 = reinterpret_tensor(buf199, (19, 32, 128), (4096, 128, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [h_off_7, off_in_1, layer_norm_11], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_49.run(buf270, buf268, buf269, arg116_1, arg117_1, buf274, 608, 128, grid=grid(608), stream=stream0)
        del arg116_1
        del arg117_1
        buf275 = buf177; del buf177  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf274, (608, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 384), (1, 128), 0), out=buf275)
        del arg118_1
        # Topologically Sorted Source Nodes: [setitem_10], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf276, 2432, grid=grid(2432), stream=stream0)
        buf278 = buf180; del buf180  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf276, buf278, 19456, grid=grid(19456), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf278, 608, grid=grid(608), stream=stream0)
        buf280 = reinterpret_tensor(buf274, (19, 8, 32, 16), (4096, 512, 16, 1), 0); del buf274  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf275, arg119_1, buf280, 77824, grid=grid(77824), stream=stream0)
        buf281 = reinterpret_tensor(buf172, (19, 8, 32, 16), (4096, 512, 16, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf275, arg119_1, buf281, 77824, grid=grid(77824), stream=stream0)
        buf282 = reinterpret_tensor(buf196, (19, 8, 32, 16), (4096, 512, 16, 1), 0); del buf196  # reuse
        buf294 = reinterpret_tensor(buf178, (19, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf178  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf275, arg119_1, buf282, buf294, 77824, grid=grid(77824), stream=stream0)
        del arg119_1
        del buf275
        buf283 = reinterpret_tensor(buf195, (19, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf195  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf278, buf276, buf283, 155648, grid=grid(155648), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf285 = buf284[0]
        del buf284
        buf289 = reinterpret_tensor(buf282, (19, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf282  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf278, buf276, buf289, 77824, grid=grid(77824), stream=stream0)
        del buf276
        buf290 = reinterpret_tensor(buf269, (19456, 16), (16, 1), 0); del buf269  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf289, (19456, 4), (4, 1), 0), reinterpret_tensor(arg120_1, (4, 16), (1, 4), 0), out=buf290)
        del arg120_1
        buf291 = reinterpret_tensor(buf290, (19, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf290  # reuse
        # Topologically Sorted Source Nodes: [input_41], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf291, arg121_1, 311296, grid=grid(311296), stream=stream0)
        del arg121_1
        buf292 = reinterpret_tensor(buf283, (19456, 8), (8, 1), 0); del buf283  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf291, (19456, 16), (16, 1), 0), reinterpret_tensor(arg122_1, (16, 8), (1, 16), 0), out=buf292)
        del arg122_1
        buf293 = reinterpret_tensor(buf194, (19, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf194  # reuse
        # Topologically Sorted Source Nodes: [einsum_17], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf292, arg123_1, buf293, 152, 1024, grid=grid(152, 1024), stream=stream0)
        del arg123_1
        del buf292
        buf295 = reinterpret_tensor(buf289, (152, 32, 16), (512, 16, 1), 0); del buf289  # reuse
        # Topologically Sorted Source Nodes: [einsum_17], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf293, (152, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf294, (152, 32, 16), (512, 16, 1), 0), out=buf295)
        del buf293
        del buf294
        buf296 = reinterpret_tensor(buf285, (19, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf285  # reuse
        # Topologically Sorted Source Nodes: [x_mid_5], Original ATen: [aten.add]
        triton_poi_fused_add_39.run(buf296, buf295, 77824, grid=grid(77824), stream=stream0)
        buf297 = reinterpret_tensor(buf295, (608, 128), (128, 1), 0); del buf295  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf296, (608, 128), (128, 1), 0), reinterpret_tensor(arg124_1, (128, 128), (1, 128), 0), out=buf297)
        del arg124_1
        buf318 = reinterpret_tensor(buf291, (19, 32, 512), (16384, 512, 1), 0); del buf291  # reuse
        buf314 = reinterpret_tensor(buf318, (19, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf270, buf297, arg125_1, arg126_1, arg127_1, buf314, 608, 128, grid=grid(608), stream=stream0)
        del arg126_1
        del arg127_1
        buf301 = buf229; del buf229  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf267, (1024, 128), (128, 1), 0), reinterpret_tensor(arg132_1, (128, 128), (1, 128), 0), out=buf301)
        del arg132_1
        buf302 = reinterpret_tensor(buf301, (1, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf301  # reuse
        # Topologically Sorted Source Nodes: [input_47], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf302, arg133_1, 131072, grid=grid(131072), stream=stream0)
        del arg133_1
        buf303 = reinterpret_tensor(buf169, (1024, 128), (128, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [input_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg135_1, reinterpret_tensor(buf302, (1024, 128), (128, 1), 0), reinterpret_tensor(arg134_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf303)
        del arg134_1
        del arg135_1
        buf304 = reinterpret_tensor(buf302, (8, 128, 128), (16384, 128, 1), 0); del buf302  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf303, (8, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf303, (8, 128, 128), (16384, 1, 128), 0), out=buf304)
        del buf303
        # Topologically Sorted Source Nodes: [toks_9, index_add__22, index_add__23], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_42.run(arg60_1, arg59_1, buf270, buf297, arg125_1, arg61_1, buf305, buf309, 360448, grid=grid(360448), stream=stream0)
        buf308 = buf268; del buf268  # reuse
        # Topologically Sorted Source Nodes: [row_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf305, (1, 8, 16384), (131072, 16384, 1), 0), out=buf308)
        del arg30_1
        del buf305
        buf312 = buf238; del buf238  # reuse
        # Topologically Sorted Source Nodes: [col_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 19, 8), (152, 8, 1), 0), reinterpret_tensor(buf309, (1, 8, 16384), (131072, 16384, 1), 0), out=buf312)
        del arg31_1
        del buf309
        buf313 = buf243; del buf243  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, g_5], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_43.run(buf270, buf297, arg125_1, buf313, 2432, 32, grid=grid(2432), stream=stream0)
        buf315 = reinterpret_tensor(buf318, (19, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf308, buf315, 77824, grid=grid(77824), stream=stream0)
        del buf308
        buf316 = reinterpret_tensor(buf318, (19, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf312, buf316, 77824, grid=grid(77824), stream=stream0)
        buf317 = reinterpret_tensor(buf318, (19, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf313, buf317, 77824, grid=grid(77824), stream=stream0)
        del buf313
        del buf314
        del buf315
        del buf316
        del buf317
        buf319 = reinterpret_tensor(buf312, (608, 512), (512, 1), 0); del buf312  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf318, (608, 512), (512, 1), 0), reinterpret_tensor(arg128_1, (512, 512), (1, 512), 0), out=buf319)
        del arg128_1
        del buf318
        buf320 = reinterpret_tensor(buf319, (19, 32, 512), (16384, 512, 1), 0); del buf319  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_46.run(buf320, arg129_1, 311296, grid=grid(311296), stream=stream0)
        del arg129_1
        buf321 = reinterpret_tensor(buf296, (608, 128), (128, 1), 0); del buf296  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf320, (608, 512), (512, 1), 0), reinterpret_tensor(arg130_1, (512, 128), (1, 512), 0), out=buf321)
        del arg130_1
        del buf320
        buf322 = reinterpret_tensor(buf321, (19, 32, 128), (4096, 128, 1), 0); del buf321  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_47.run(buf322, buf270, buf297, arg125_1, arg131_1, 77824, grid=grid(77824), stream=stream0)
        del arg125_1
        del arg131_1
        del buf270
        buf323 = buf297; del buf297  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf322, (608, 128), (128, 1), 0), reinterpret_tensor(arg136_1, (128, 128), (1, 128), 0), out=buf323)
        del arg136_1
        buf324 = reinterpret_tensor(buf323, (19, 1, 32, 128), (4096, 1, 128, 1), 0); del buf323  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf324, arg137_1, 77824, grid=grid(77824), stream=stream0)
        del arg137_1
        buf325 = reinterpret_tensor(buf278, (608, 32), (32, 1), 0); del buf278  # reuse
        # Topologically Sorted Source Nodes: [input_51], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf324, (608, 128), (128, 1), 0), reinterpret_tensor(arg138_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf325)
        del arg138_1
        del arg139_1
        buf326 = reinterpret_tensor(buf324, (608, 128), (128, 1), 0); del buf324  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf322, (608, 128), (128, 1), 0), reinterpret_tensor(arg140_1, (128, 128), (1, 128), 0), out=buf326)
        del arg140_1
        ...
        triton_poi_fused_gelu_51.run(buf327, arg141_1, 77824, grid=grid(77824), stream=stream0)
        del arg141_1
        buf328 = empty_strided_cuda((608, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg143_1, reinterpret_tensor(buf327, (608, 128), (128, 1), 0), reinterpret_tensor(arg142_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf328)
        del arg142_1
        del arg143_1
        del buf327
        buf329 = empty_strided_cuda((19, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf325, (19, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf328, (19, 32, 32), (1024, 1, 32), 0), out=buf329)
        del buf325
        del buf328
        buf330 = empty_strided_cuda((1024, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg147_1, reinterpret_tensor(buf267, (1024, 128), (128, 1), 0), reinterpret_tensor(arg146_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf330)
        del arg146_1
        del arg147_1
        buf331 = empty_strided_cuda((1024, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg149_1, reinterpret_tensor(buf267, (1024, 128), (128, 1), 0), reinterpret_tensor(arg148_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf331)
        del arg148_1
        del arg149_1
        buf332 = reinterpret_tensor(buf257, (1024, 1), (1, 1), 0); del buf257  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf267, (1024, 128), (128, 1), 0), reinterpret_tensor(arg144_1, (128, 1), (1, 128), 0), out=buf332)
        del arg144_1
        del buf267
        buf333 = reinterpret_tensor(buf332, (1, 8, 128, 1), (1024, 128, 1, 1), 0); del buf332  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_52.run(buf333, arg145_1, 1024, grid=grid(1024), stream=stream0)
        del arg145_1
        buf334 = empty_strided_cuda((1, 217088), (217088, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_53.run(buf304, buf329, buf330, buf331, buf333, buf334, 217088, grid=grid(217088), stream=stream0)
        del buf304
        del buf329
        del buf330
        del buf331
        # Topologically Sorted Source Nodes: [toks_11, index_add__27, index_add__26], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_48.run(arg61_1, arg59_1, buf322, arg60_1, buf335, buf338, 360448, grid=grid(360448), stream=stream0)
        del arg59_1
        del arg60_1
        del arg61_1
        del buf322
    return (buf334, reinterpret_tensor(buf333, (1, 8, 128), (1024, 128, 1), 0), reinterpret_tensor(buf335, (1, 1024, 128), (131072, 128, 1), 0), reinterpret_tensor(buf338, (1, 1024, 128), (131072, 128, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg59_1 = rand_strided((22, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg60_1 = rand_strided((22, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg61_1 = rand_strided((22, ), (1, ), device='cuda:0', dtype=torch.int64)
