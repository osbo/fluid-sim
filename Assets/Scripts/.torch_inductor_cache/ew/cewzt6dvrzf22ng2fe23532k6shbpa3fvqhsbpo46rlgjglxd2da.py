...
#   %full_default_24 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 64, 128, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_25 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 64, 128, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_27 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 64, 128, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_26 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 64, 128, 256], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg124_1
        buf322 = reinterpret_tensor(buf273, (234, 32, 1024), (32768, 1024, 1), 0); del buf273  # reuse
        buf318 = reinterpret_tensor(buf322, (234, 32, 256), (32768, 1024, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf274, buf301, arg125_1, arg126_1, arg127_1, buf318, 7488, 256, grid=grid(7488), stream=stream0)
        del arg126_1
        del arg127_1
        buf305 = buf233; del buf233  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf271, (8192, 256), (256, 1), 0), reinterpret_tensor(arg132_1, (256, 256), (1, 256), 0), out=buf305)
        del arg132_1
        buf306 = reinterpret_tensor(buf305, (1, 64, 128, 256), (2097152, 32768, 256, 1), 0); del buf305  # reuse
        ...
        del arg133_1
        buf307 = reinterpret_tensor(buf214, (8192, 128), (128, 1), 0); del buf214  # reuse
        # Topologically Sorted Source Nodes: [input_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg135_1, reinterpret_tensor(buf306, (8192, 256), (256, 1), 0), reinterpret_tensor(arg134_1, (256, 128), (1, 256), 0), alpha=1, beta=1, out=buf307)
        del arg134_1
        del arg135_1
        del buf306
        buf308 = empty_strided_cuda((64, 128, 128), (16384, 128, 1), torch.float32)
        ...
        triton_poi_fused_index_add_index_select_43.run(buf140, buf141, buf274, buf301, arg125_1, buf146, buf309, buf313, 14745600, grid=grid(14745600), stream=stream0)
        buf312 = buf272; del buf272  # reuse
        # Topologically Sorted Source Nodes: [row_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf309, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf312)
        del arg30_1
        del buf309
        buf316 = buf242; del buf242  # reuse
        # Topologically Sorted Source Nodes: [col_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf313, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf316)
        del arg31_1
        del buf313
        buf317 = buf247; del buf247  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, g_5], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf274, buf301, arg125_1, buf317, 59904, 32, grid=grid(59904), stream=stream0)
        buf319 = reinterpret_tensor(buf322, (234, 32, 256), (32768, 1024, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf312, buf319, 1916928, grid=grid(1916928), stream=stream0)
        del buf312
        buf320 = reinterpret_tensor(buf322, (234, 32, 256), (32768, 1024, 1), 512)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf316, buf320, 1916928, grid=grid(1916928), stream=stream0)
        buf321 = reinterpret_tensor(buf322, (234, 32, 256), (32768, 1024, 1), 768)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf317, buf321, 1916928, grid=grid(1916928), stream=stream0)
        del buf317
        del buf318
        del buf319
        del buf320
        del buf321
        buf323 = reinterpret_tensor(buf316, (7488, 1024), (1024, 1), 0); del buf316  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf322, (7488, 1024), (1024, 1), 0), reinterpret_tensor(arg128_1, (1024, 1024), (1, 1024), 0), out=buf323)
        del arg128_1
        del buf322
        buf324 = reinterpret_tensor(buf323, (234, 32, 1024), (32768, 1024, 1), 0); del buf323  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf324, arg129_1, 7667712, grid=grid(7667712), stream=stream0)
        del arg129_1
        buf325 = reinterpret_tensor(buf300, (7488, 256), (256, 1), 0); del buf300  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf324, (7488, 1024), (1024, 1), 0), reinterpret_tensor(arg130_1, (1024, 256), (1, 1024), 0), out=buf325)
        del arg130_1
        del buf324
        buf326 = reinterpret_tensor(buf325, (234, 32, 256), (8192, 256, 1), 0); del buf325  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf326, buf274, buf301, arg125_1, arg131_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg125_1
        del arg131_1
        del buf274
        buf327 = buf301; del buf301  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf326, (7488, 256), (256, 1), 0), reinterpret_tensor(arg136_1, (256, 256), (1, 256), 0), out=buf327)
        del arg136_1
        buf328 = reinterpret_tensor(buf327, (234, 1, 32, 256), (8192, 1, 256, 1), 0); del buf327  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_52.run(buf328, arg137_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg137_1
        ...
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf328, (7488, 256), (256, 1), 0), reinterpret_tensor(arg138_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf329)
        del arg138_1
        del arg139_1
        buf330 = reinterpret_tensor(buf328, (7488, 256), (256, 1), 0); del buf328  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf326, (7488, 256), (256, 1), 0), reinterpret_tensor(arg140_1, (256, 256), (1, 256), 0), out=buf330)
        del arg140_1
        buf331 = reinterpret_tensor(buf330, (234, 1, 32, 256), (8192, 1, 256, 1), 0); del buf330  # reuse
        # Topologically Sorted Source Nodes: [input_53], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_52.run(buf331, arg141_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg141_1
        buf332 = empty_strided_cuda((7488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg143_1, reinterpret_tensor(buf331, (7488, 256), (256, 1), 0), reinterpret_tensor(arg142_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf332)
        del arg142_1
        del arg143_1
        del buf331
        ...
        extern_kernels.addmm(arg147_1, reinterpret_tensor(buf271, (8192, 256), (256, 1), 0), reinterpret_tensor(arg146_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf334)
        del arg146_1
        del arg147_1
        buf335 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg149_1, reinterpret_tensor(buf271, (8192, 256), (256, 1), 0), reinterpret_tensor(arg148_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf335)
        del arg148_1
        del arg149_1
        buf336 = empty_strided_cuda((8192, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf271, (8192, 256), (256, 1), 0), reinterpret_tensor(arg144_1, (256, 1), (1, 256), 0), out=buf336)
        del arg144_1
        del buf271
        ...
        triton_poi_fused_index_add_index_select_49.run(buf146, buf141, buf326, buf140, buf339, buf342, 14745600, grid=grid(14745600), stream=stream0)
        del buf326
    return (buf338, reinterpret_tensor(buf337, (1, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf339, (1, 8192, 256), (2097152, 256, 1), 0), reinterpret_tensor(buf342, (1, 8192, 256), (2097152, 256, 1), 0), arg42_1, buf140, buf146, buf141, )
