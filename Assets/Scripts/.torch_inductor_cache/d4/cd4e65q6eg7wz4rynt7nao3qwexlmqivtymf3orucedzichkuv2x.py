...
# Graph fragment:
#   %full_default_8 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([48, 1, 32, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_2 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_27, [%arg46_1]), kwargs = {})
#   %index_put_4 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_8, [%arg48_1], %index_2, True), kwargs = {})
...
#   %index_3 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_27, [%arg47_1]), kwargs = {})
#   %index_put_5 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_9, [%arg48_1], %index_3, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf99 = empty_strided_cuda((1, 512, 128), (65536, 128, 1), torch.float32)
        buf104 = reinterpret_tensor(buf49, (1, 16, 33, 128), (67584, 4224, 128, 1), 0); del buf49  # reuse
        buf102 = reinterpret_tensor(buf104, (1, 16, 32, 128), (67584, 4224, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5, kv_2], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_20.run(buf60, buf25, buf52, arg39_1, arg45_1, arg64_1, arg65_1, buf99, buf102, 512, 128, grid=grid(512), stream=stream0)
        del arg39_1
        del arg45_1
        del arg64_1
        del arg65_1
        ...
        # Topologically Sorted Source Nodes: [row_sum, getitem_13, index_add__2, col_sum, getitem_14, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_22.run(arg48_1, arg46_1, buf60, arg47_1, buf61, buf63, 270336, grid=grid(270336), stream=stream0)
        buf68 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        buf73 = reinterpret_tensor(buf35, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf35  # reuse
        buf71 = reinterpret_tensor(buf73, (48, 1, 32, 128), (4224, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_3, kv_1], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_23.run(buf61, arg49_1, buf63, arg50_1, arg51_1, buf68, buf71, 1536, 128, grid=grid(1536), stream=stream0)
        del arg50_1
        del arg51_1
        ...
        buf72 = reinterpret_tensor(buf73, (48, 1, 1, 128), (4224, 1, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf68, buf72, 6144, 32, grid=grid(6144), stream=stream0)
        del buf71
        del buf72
        buf74 = empty_strided_cuda((1584, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf73, (1584, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf74)
        del arg52_1
        buf75 = reinterpret_tensor(buf68, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf69, arg53_1, buf75, 196608, grid=grid(196608), stream=stream0)
        buf76 = empty_strided_cuda((384, 16, 36), (576, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_26.run(buf74, arg53_1, buf76, 221184, grid=grid(221184), stream=stream0)
        buf77 = empty_strided_cuda((384, 32, 36), (1152, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(reinterpret_tensor(buf75, (384, 32, 16), (512, 16, 1), 0), buf76, out=buf77)
        buf78 = reinterpret_tensor(buf73, (48, 1, 32, 33, 4), (4224, 202752, 132, 4, 1), 0); del buf73  # reuse
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_27.run(arg30_1, buf78, 202752, grid=grid(202752), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5, setitem_6], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf78, 6144, grid=grid(6144), stream=stream0)
        buf80 = empty_strided_cuda((48, 1, 32, 33), (1056, 1056, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf78, buf80, 50688, grid=grid(50688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf80, 1536, grid=grid(1536), stream=stream0)
        buf83 = empty_strided_cuda((48, 1, 32, 33, 8), (8448, 405504, 33, 1, 1056), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg31_1, buf77, buf80, buf78, buf83, 12288, 33, grid=grid(12288), stream=stream0)
        buf84 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_32.run(buf83, buf84, 12288, 33, grid=grid(12288), stream=stream0)
        buf85 = empty_strided_cuda((48, 1, 32, 33, 4), (4224, 1, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf80, buf78, buf85, 202752, grid=grid(202752), stream=stream0)
        buf86 = empty_strided_cuda((50688, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf85, (50688, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 8), (1, 4), 0), out=buf86)
        del arg54_1
        buf87 = reinterpret_tensor(buf83, (48, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf83  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf87, buf84, arg31_1, buf86, arg55_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg55_1
        buf88 = reinterpret_tensor(buf85, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf74, arg53_1, buf88, 202752, grid=grid(202752), stream=stream0)
        del arg53_1
        buf89 = reinterpret_tensor(buf75, (384, 32, 16), (512, 16, 1), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf87, (384, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf88, (384, 33, 16), (528, 16, 1), 0), out=buf89)
        buf90 = empty_strided_cuda((48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf89, buf90, 196608, grid=grid(196608), stream=stream0)
        buf91 = reinterpret_tensor(buf89, (1536, 128), (128, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf90, (1536, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 128), (1, 128), 0), out=buf91)
        del arg56_1
        buf92 = reinterpret_tensor(buf91, (48, 32, 128), (4096, 128, 1), 0); del buf91  # reuse
        buf135 = reinterpret_tensor(buf90, (48, 32, 128), (4096, 128, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf92, buf61, arg49_1, buf63, arg57_1, arg58_1, arg59_1, buf135, 1536, 128, grid=grid(1536), stream=stream0)
        del arg57_1
        del arg58_1
        del arg59_1
        buf100 = reinterpret_tensor(buf63, (512, 384), (384, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (512, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf100)
        buf103 = reinterpret_tensor(buf104, (1, 16, 1, 128), (67584, 4224, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_7.run(buf99, buf103, 2048, 32, grid=grid(2048), stream=stream0)
        del buf102
        del buf103
        buf105 = reinterpret_tensor(buf88, (528, 384), (384, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf104, (528, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf105)
        del arg66_1
        buf106 = reinterpret_tensor(buf99, (16, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf100, arg67_1, buf106, 65536, grid=grid(65536), stream=stream0)
        buf107 = reinterpret_tensor(buf104, (16, 8, 16, 1, 33, 1), (4224, 528, 33, 33, 1, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf105, arg67_1, buf107, 2048, 33, grid=grid(2048, 33), stream=stream0)
        buf108 = reinterpret_tensor(buf48, (128, 32, 33), (1056, 33, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf106, (128, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf107, (128, 16, 33), (528, 33, 1), 0), out=buf108)
        buf109 = reinterpret_tensor(buf107, (1, 16, 32, 33, 4), (67584, 4224, 132, 4, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_10.run(arg28_1, buf109, 67584, grid=grid(67584), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_11.run(buf109, 2048, grid=grid(2048), stream=stream0)
        buf111 = buf41; del buf41  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf109, buf111, 16896, grid=grid(16896), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf111, 512, grid=grid(512), stream=stream0)
        buf114 = reinterpret_tensor(buf47, (1, 16, 32, 33, 8), (135168, 8448, 33, 1, 1056), 0); del buf47  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_14.run(arg29_1, buf108, buf111, buf109, buf114, buf115, 4096, 33, grid=grid(4096), stream=stream0)
        buf116 = buf39; del buf39  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf111, buf109, buf116, 67584, grid=grid(67584), stream=stream0)
        del buf109
        del buf111
        buf117 = reinterpret_tensor(buf108, (16896, 8), (8, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (16896, 4), (4, 1), 0), reinterpret_tensor(arg68_1, (4, 8), (1, 4), 0), out=buf117)
        del arg68_1
        buf118 = reinterpret_tensor(buf114, (16, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_16.run(buf118, buf115, arg29_1, buf117, arg69_1, 128, 1056, grid=grid(128, 1056), stream=stream0)
        del arg29_1
        del arg69_1
        del buf115
        del buf117
        buf119 = reinterpret_tensor(buf116, (16, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf105, arg67_1, buf119, 67584, grid=grid(67584), stream=stream0)
        del arg67_1
        buf120 = reinterpret_tensor(buf106, (128, 32, 16), (512, 16, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf118, (128, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf119, (128, 33, 16), (528, 16, 1), 0), out=buf120)
        del buf118
        del buf119
        buf121 = reinterpret_tensor(buf52, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf120, buf121, 65536, grid=grid(65536), stream=stream0)
        buf122 = reinterpret_tensor(buf120, (512, 128), (128, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (512, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 128), (1, 128), 0), out=buf122)
        del arg70_1
        buf126 = reinterpret_tensor(buf121, (1, 512, 128), (65536, 128, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf60, buf122, arg71_1, arg72_1, arg73_1, buf126, 512, 128, grid=grid(512), stream=stream0)
        del arg72_1
        del arg73_1
        buf127 = reinterpret_tensor(buf58, (512, 512), (512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 512), (1, 128), 0), out=buf127)
        del arg74_1
        buf128 = reinterpret_tensor(buf127, (1, 512, 512), (262144, 512, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf128, arg75_1, 262144, grid=grid(262144), stream=stream0)
        del arg75_1
        buf129 = reinterpret_tensor(buf126, (512, 128), (128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (512, 512), (512, 1), 0), reinterpret_tensor(arg76_1, (512, 128), (1, 512), 0), out=buf129)
        del arg76_1
        del buf128
        buf130 = reinterpret_tensor(buf129, (1, 512, 128), (65536, 128, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_38.run(buf130, buf60, buf122, arg71_1, arg77_1, 65536, grid=grid(65536), stream=stream0)
        del arg71_1
        del arg77_1
        del buf122
        del buf60
        buf131 = reinterpret_tensor(buf100, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf131, 196608, grid=grid(196608), stream=stream0)
        buf133 = buf61; del buf61  # reuse
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf133, 196608, grid=grid(196608), stream=stream0)
        ...
        triton_poi_fused_index_index_add_zeros_22.run(arg48_1, arg46_1, buf130, arg47_1, buf131, buf133, 270336, grid=grid(270336), stream=stream0)
        del arg46_1
        del arg47_1
        del arg48_1
        buf136 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf135, (1536, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf136)
        del arg60_1
        buf137 = reinterpret_tensor(buf136, (48, 32, 512), (16384, 512, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf137, arg61_1, 786432, grid=grid(786432), stream=stream0)
        del arg61_1
        buf138 = reinterpret_tensor(buf135, (1536, 128), (128, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf137, (1536, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf138)
        del arg62_1
        buf139 = reinterpret_tensor(buf138, (48, 32, 128), (4096, 128, 1), 0); del buf138  # reuse
        buf143 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        buf148 = reinterpret_tensor(buf105, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf105  # reuse
        buf146 = reinterpret_tensor(buf148, (48, 1, 32, 128), (4224, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_40.run(buf139, buf131, arg49_1, buf133, buf92, arg63_1, arg78_1, arg79_1, buf143, buf146, 1536, 128, grid=grid(1536), stream=stream0)
        del arg49_1
        del arg63_1
        del arg78_1
        del arg79_1
        del buf131
        del buf133
        buf144 = buf69; del buf69  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf143, (1536, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf144)
        buf147 = reinterpret_tensor(buf148, (48, 1, 1, 128), (4224, 1, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf143, buf147, 6144, 32, grid=grid(6144), stream=stream0)
        del buf146
        del buf147
        buf149 = buf74; del buf74  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf148, (1584, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf149)
        del arg80_1
        buf150 = reinterpret_tensor(buf143, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf144, arg81_1, buf150, 196608, grid=grid(196608), stream=stream0)
        del buf144
        buf151 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_26.run(buf149, arg81_1, buf151, 221184, grid=grid(221184), stream=stream0)
        buf152 = buf77; del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(reinterpret_tensor(buf150, (384, 32, 16), (512, 16, 1), 0), buf151, out=buf152)
        del buf151
        buf153 = reinterpret_tensor(buf148, (48, 1, 32, 33, 4), (4224, 202752, 132, 4, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_27.run(arg30_1, buf153, 202752, grid=grid(202752), stream=stream0)
        del arg30_1
        ...
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf153, 6144, grid=grid(6144), stream=stream0)
        buf155 = buf80; del buf80  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf153, buf155, 50688, grid=grid(50688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf155, 1536, grid=grid(1536), stream=stream0)
        buf158 = reinterpret_tensor(buf87, (48, 1, 32, 33, 8), (8448, 405504, 33, 1, 1056), 0); del buf87  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg31_1, buf152, buf155, buf153, buf158, 12288, 33, grid=grid(12288), stream=stream0)
        del buf152
        buf159 = buf84; del buf84  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_32.run(buf158, buf159, 12288, 33, grid=grid(12288), stream=stream0)
        buf160 = reinterpret_tensor(buf78, (48, 1, 32, 33, 4), (4224, 1, 132, 4, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf155, buf153, buf160, 202752, grid=grid(202752), stream=stream0)
        del buf153
        del buf155
        buf161 = buf86; del buf86  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf160, (50688, 4), (4, 1), 0), reinterpret_tensor(arg82_1, (4, 8), (1, 4), 0), out=buf161)
        del arg82_1
        buf162 = reinterpret_tensor(buf158, (48, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf162, buf159, arg31_1, buf161, arg83_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg31_1
        del arg83_1
        del buf159
        del buf161
        buf163 = reinterpret_tensor(buf160, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf149, arg81_1, buf163, 202752, grid=grid(202752), stream=stream0)
        del arg81_1
        del buf149
        buf164 = reinterpret_tensor(buf150, (384, 32, 16), (512, 16, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf162, (384, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf163, (384, 33, 16), (528, 16, 1), 0), out=buf164)
        del buf162
        del buf163
        buf165 = reinterpret_tensor(buf92, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf164, buf165, 196608, grid=grid(196608), stream=stream0)
        buf166 = reinterpret_tensor(buf164, (1536, 128), (128, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (1536, 128), (128, 1), 0), reinterpret_tensor(arg84_1, (128, 128), (1, 128), 0), out=buf166)
        del arg84_1
        buf172 = reinterpret_tensor(buf165, (48, 32, 128), (4096, 128, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf139, buf166, arg85_1, arg86_1, arg87_1, buf172, 1536, 128, grid=grid(1536), stream=stream0)
        del arg86_1
        del arg87_1
        buf170 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg93_1, reinterpret_tensor(buf130, (512, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf170)
        del arg92_1
        del arg93_1
        buf171 = empty_strided_cuda((16, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf170, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf170, (16, 32, 32), (1024, 1, 32), 0), out=buf171)
        buf173 = reinterpret_tensor(buf137, (1536, 512), (512, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (1536, 128), (128, 1), 0), reinterpret_tensor(arg88_1, (128, 512), (1, 128), 0), out=buf173)
        del arg88_1
        buf174 = reinterpret_tensor(buf173, (48, 32, 512), (16384, 512, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf174, arg89_1, 786432, grid=grid(786432), stream=stream0)
        del arg89_1
        buf175 = reinterpret_tensor(buf172, (1536, 128), (128, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf174, (1536, 512), (512, 1), 0), reinterpret_tensor(arg90_1, (512, 128), (1, 512), 0), out=buf175)
        del arg90_1
        del buf174
        buf176 = reinterpret_tensor(buf175, (48, 32, 128), (4096, 128, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf176, buf139, buf166, arg85_1, arg91_1, 196608, grid=grid(196608), stream=stream0)
        del arg85_1
        del arg91_1
        del buf139
        del buf166
        buf177 = empty_strided_cuda((1536, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf176, (1536, 128), (128, 1), 0), reinterpret_tensor(arg94_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf177)
        del arg94_1
        del arg95_1
        buf178 = empty_strided_cuda((1536, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg97_1, reinterpret_tensor(buf176, (1536, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf178)
        del arg96_1
        del arg97_1
        del buf176
        buf179 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf177, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf178, (48, 32, 32), (1024, 1, 32), 0), out=buf179)
        del buf177
        del buf178
        buf180 = buf170; del buf170  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf130, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf180)
        del arg100_1
        del arg101_1
        buf181 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf130, (512, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf181)
        del arg102_1
        del arg103_1
        buf182 = empty_strided_cuda((512, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf130, (512, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 1), (1, 128), 0), out=buf182)
        del arg98_1
        del buf130
        buf183 = reinterpret_tensor(buf182, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf182  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_43.run(buf183, arg99_1, 512, grid=grid(512), stream=stream0)
        del arg99_1
        buf184 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf171, buf179, buf180, buf181, buf183, buf184, 98816, grid=grid(98816), stream=stream0)
        del buf171
        del buf179
        del buf180
        del buf181
    return (buf184, reinterpret_tensor(buf183, (1, 16, 32), (512, 32, 1), 0), )
