...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4t/c4tywv3hbs4xilvlvyz4odb3rrdkodr657myfsstwii434abc7ei.py
...
# Graph fragment:
#   %add_11 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_5, %view_30), kwargs = {})
#   %add_16 : [num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_11, %view_53), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xd/cxdwvxxnhwvvzokid32w4cka2sjyoa36oov3qh7fvwqx42sqfue4.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5x/c5xo4nlzlmnwauxqmibxuzn5ycwg6zbnbnkj2frrltrgicip53ki.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.full([1], 0, tl.int64)
    tmp2 = tmp0 >= tmp1
    tmp3 = tl.full([1], 209920, tl.int64)
    tmp4 = tmp0 < tmp3
    ...
    tmp12 = tmp9 & tmp11
    tmp13 = tmp12 & tmp4
    tmp14 = tl.load(in_ptr1 + ((-32768) + x0), tmp13, eviction_policy='evict_last', other=0.0)
    tmp15 = tmp0 >= tmp10
    tmp16 = tl.full([1], 177152, tl.int64)
    tmp17 = tmp0 < tmp16
    tmp18 = tmp15 & tmp17
    tmp19 = tmp18 & tmp4
    tmp20 = tl.load(in_ptr2 + ((-144384) + x0), tmp19, eviction_policy='evict_last', other=0.0)
    tmp21 = tmp0 >= tmp16
    tmp22 = tmp21 & tmp4
    tmp23 = tl.load(in_ptr3 + ((-177152) + x0), tmp22, eviction_policy='evict_last', other=0.0)
    ...
    tmp29 = tmp0 >= tmp3
    tmp30 = tl.full([1], 210944, tl.int64)
    tmp31 = tmp0 < tmp30
    tmp32 = tl.load(in_ptr4 + ((-209920) + x0), tmp29, eviction_policy='evict_last', other=0.0)
...
def call(args):
    ...
    assert_size_stride(arg76_1, (32, 512), (512, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.add]
        triton_poi_fused_add_37.run(buf118, buf25, buf54, arg39_1, arg47_1, 524288, grid=grid(524288), stream=stream0)
        del arg39_1
        del arg47_1
        del buf25
        del buf54
        ...
        del arg62_1
        del buf126
        buf128 = reinterpret_tensor(buf121, (109, 8, 32, 64, 1, 1), (16384, 2048, 64, 1, 1, 1), 0); del buf121  # reuse
        ...
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_38.run(buf147, buf58, buf59, buf88, arg59_1, arg67_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg59_1
        del arg67_1
        del buf58
        del buf59
        del buf88
        buf148 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf147, (3488, 512), (512, 1), 0), reinterpret_tensor(arg68_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf148)
        del arg68_1
        del arg69_1
        buf149 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf147, (3488, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf149)
        del arg70_1
        del arg71_1
        del buf147
        buf150 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf148, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf149, (109, 32, 32), (1024, 1, 32), 0), out=buf150)
        del buf148
        del buf149
        buf151 = buf119; del buf119  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf118, (1024, 512), (512, 1), 0), reinterpret_tensor(arg74_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf151)
        del arg74_1
        del arg75_1
        buf152 = empty_strided_cuda((1024, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg77_1, reinterpret_tensor(buf118, (1024, 512), (512, 1), 0), reinterpret_tensor(arg76_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf152)
        del arg76_1
        del arg77_1
        buf153 = empty_strided_cuda((1024, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf118, (1024, 512), (512, 1), 0), reinterpret_tensor(arg72_1, (512, 1), (1, 512), 0), out=buf153)
        del arg72_1
        del buf118
        buf154 = reinterpret_tensor(buf153, (1, 32, 32, 1), (1024, 32, 1, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_39.run(buf154, arg73_1, 1024, grid=grid(1024), stream=stream0)
        del arg73_1
        buf155 = empty_strided_cuda((1, 210944), (210944, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_40.run(buf120, buf150, buf151, buf152, buf154, buf155, 210944, grid=grid(210944), stream=stream0)
        del buf120
        del buf150
        del buf151
        del buf152
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg76_1 = rand_strided((32, 512), (512, 1), device='cuda:0', dtype=torch.float32)
