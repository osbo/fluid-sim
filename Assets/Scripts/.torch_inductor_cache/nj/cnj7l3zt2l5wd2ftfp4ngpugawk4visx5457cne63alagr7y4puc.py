...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5h/c5hcyypp4wonr64s6x22j4fdsyj64w5jqekertudfnmcvovghger.py
# Topologically Sorted Source Nodes: [zero__1], Original ATen: [aten.zero]
# Source node to ATen node mapping:
#   zero__1 => full_default_7
# Graph fragment:
...
triton_poi_fused_zero_20 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ar/car5kr7frutqyt4xn4zka7xzysdnrkqijlyrg3jo22s4lq3m6qvb.py
# Topologically Sorted Source Nodes: [x, x_1, zero_, index_add__2, zero__1, index_add__3], Original ATen: [aten.add, aten.zero, aten.index_add]
# Source node to ATen node mapping:
#   index_add__2 => index_put_6
#   index_add__3 => index_put_7
#   x => add_12
#   x_1 => add_16
#   zero_ => full_default_6
#   zero__1 => full_default_7
# Graph fragment:
...
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_6, [None, %arg66_1], %view_91, True), kwargs = {})
#   %full_default_7 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_7, [None, %arg66_1], %view_91, True), kwargs = {})
triton_poi_fused_add_index_add_zero_21 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_index_add_zero_21', 'mutated_arg_names': ['in_out_ptr0', 'out_ptr0', 'out_ptr1'], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
#   toks_1 => index_2
# Graph fragment:
#   %index_2 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_93, [None, %arg67_1]), kwargs = {})
#   %index_put_8 : [num_users=2] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_6, [None, %arg68_1], %index_2, True), kwargs = {})
#   %index_put_9 : [num_users=2] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_7, [None, %arg69_1], %index_2, True), kwargs = {})
...
#   sigmoid => sigmoid
# Graph fragment:
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_115,), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/uz/cuzj6z2ey6uwl7vfpisquj4qyvnbjdya47dryuvxfzrg3bnyjh2o.py
# Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   packed_1 => cat_4
# Graph fragment:
#   %cat_4 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_3, %view_116], 1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kv/ckv4w4xqoc2fajkq4jglarnwnk5gvatnfrshceuvcvp6dnlmew7h.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %copy_ : [num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg64_1, %index_put_8), kwargs = {})
triton_poi_fused_41 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_41', 'mutated_arg_names': ['out_ptr0'], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
def call(args):
    ...
    assert_size_stride(arg64_1, (1, 32, 128, 64), (262144, 8192, 64, 1))
    assert_size_stride(arg65_1, (1, 32, 128, 64), (262144, 8192, 64, 1))
    assert_size_stride(arg66_1, (32, ), (1, ))
    assert_size_stride(arg67_1, (178, ), (1, ))
    assert_size_stride(arg68_1, (178, ), (1, ))
    assert_size_stride(arg69_1, (178, ), (1, ))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [zero__1], Original ATen: [aten.zero]
        triton_poi_fused_zero_20.run(buf103, 262144, grid=grid(262144), stream=stream0)
        ...
        triton_poi_fused_zero_20.run(buf95, 262144, grid=grid(262144), stream=stream0)
        buf60 = reinterpret_tensor(buf59, (1, 4096, 64), (262144, 64, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, zero_, index_add__2, zero__1, index_add__3], Original ATen: [aten.add, aten.zero, aten.index_add]
        triton_poi_fused_add_index_add_zero_21.run(buf60, buf25, buf52, arg41_1, arg47_1, arg66_1, buf95, buf103, 262144, grid=grid(262144), stream=stream0)
        del arg41_1
        del arg47_1
        del arg66_1
        del buf25
        ...
        del buf91
        # Topologically Sorted Source Nodes: [toks_1, index_add__4, index_add__5], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_38.run(arg68_1, arg67_1, buf101, arg69_1, buf95, buf103, 1458176, grid=grid(1458176), stream=stream0)
        del arg67_1
        del arg68_1
        del arg69_1
        buf106 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg70_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf106)
        del arg70_1
        del arg71_1
        buf107 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf106, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf106, (32, 128, 128), (16384, 1, 128), 0), out=buf107)
        del buf106
        buf108 = reinterpret_tensor(buf72, (3488, 32), (32, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg73_1, reinterpret_tensor(buf101, (3488, 64), (64, 1), 0), reinterpret_tensor(arg72_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf108)
        del arg72_1
        del arg73_1
        buf109 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf101, (3488, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf109)
        del arg74_1
        del arg75_1
        del buf101
        buf110 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf108, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf109, (109, 32, 32), (1024, 1, 32), 0), out=buf110)
        del buf108
        del buf109
        buf111 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf111)
        del arg78_1
        del arg79_1
        buf112 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg81_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf112)
        del arg80_1
        del arg81_1
        buf113 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg76_1, (64, 1), (1, 64), 0), out=buf113)
        del arg76_1
        del buf60
        buf114 = reinterpret_tensor(buf113, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_39.run(buf114, arg77_1, 4096, grid=grid(4096), stream=stream0)
        del arg77_1
        buf115 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_40.run(buf107, buf110, buf111, buf112, buf114, buf115, 902144, grid=grid(902144), stream=stream0)
        del buf107
        del buf110
        del buf111
        del buf112
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_41.run(buf95, arg64_1, 262144, grid=grid(262144), stream=stream0)
        del arg64_1
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_41.run(buf103, arg65_1, 262144, grid=grid(262144), stream=stream0)
        del arg65_1
    return (buf115, reinterpret_tensor(buf114, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf103, (1, 4096, 64), (262144, 64, 1), 0), reinterpret_tensor(buf95, (1, 4096, 64), (262144, 64, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg64_1 = rand_strided((1, 32, 128, 64), (262144, 8192, 64, 1), device='cuda:0', dtype=torch.float32)
    arg65_1 = rand_strided((1, 32, 128, 64), (262144, 8192, 64, 1), device='cuda:0', dtype=torch.float32)
    arg66_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg67_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg68_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg69_1 = rand_strided((178, ), (1, ), device='cuda:0', dtype=torch.int64)
