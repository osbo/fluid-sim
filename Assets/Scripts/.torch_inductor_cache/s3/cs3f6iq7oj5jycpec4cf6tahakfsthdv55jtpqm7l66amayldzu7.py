...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4c/c4cbzblsallr25ox3ezkdrsz3sgn7pnewg3qmrbq2fxiy4zs4c5p.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr0 + (58328 + x1), xmask, eviction_policy='evict_last')
...
def call(args):
    ...
    assert_size_stride(arg6_1, (2, 58328), (58328, 1))
    assert_size_stride(arg7_1, (58328, ), (1, ))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_4.run(arg6_1, buf6, arg7_1, buf7, 7465984, grid=grid(7465984), stream=stream0)
        del buf5
        del buf7
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_4.run(arg6_1, buf15, arg7_1, buf16, 7465984, grid=grid(7465984), stream=stream0)
        del arg6_1
        del arg7_1
        del buf14
        del buf16
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg6_1 = rand_strided((2, 58328), (58328, 1), device='cuda:0', dtype=torch.int64)
    arg7_1 = rand_strided((58328, ), (1, ), device='cuda:0', dtype=torch.float32)
