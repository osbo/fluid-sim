...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg68_1
        buf106 = reinterpret_tensor(buf100, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf100  # reuse
        ...
        buf107 = reinterpret_tensor(buf52, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf108 = reinterpret_tensor(buf25, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf25  # reuse
        buf120 = reinterpret_tensor(buf36, (32, 8, 128, 1, 8, 1), (8192, 1024, 8, 8, 1, 1), 0); del buf36  # reuse
        ...
        buf109 = reinterpret_tensor(buf48, (32, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf104, buf102, buf109, 4194304, grid=grid(4194304), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        del arg71_1
        buf118 = reinterpret_tensor(buf109, (524288, 8), (8, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf117, (524288, 16), (16, 1), 0), reinterpret_tensor(arg72_1, (16, 8), (1, 16), 0), out=buf118)
        del arg72_1
        del buf117
        buf119 = reinterpret_tensor(buf47, (32, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf118, arg73_1, buf119, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg73_1
        del buf118
        buf121 = reinterpret_tensor(buf108, (256, 128, 8), (1024, 8, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf119, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf120, (256, 128, 8), (1024, 8, 1), 0), out=buf121)
        del buf119
        del buf120
        buf122 = reinterpret_tensor(buf111, (1, 32, 128, 8, 8), (262144, 8192, 64, 8, 1), 0); del buf111  # reuse
        ...
        buf76 = reinterpret_tensor(buf69, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf78 = empty_strided_cuda((109, 8, 32, 8), (2048, 256, 8, 1), torch.float32)
        buf90 = empty_strided_cuda((109, 8, 32, 1, 8, 1), (2048, 256, 8, 8, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_1], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        del arg53_1
        buf79 = reinterpret_tensor(buf63, (109, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf74, buf72, buf79, 892928, grid=grid(892928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf80 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf76, buf77, buf78, buf79, False)
        del buf76
        buf81 = buf80[0]
        del buf80
        buf85 = empty_strided_cuda((109, 1, 32, 32, 4), (4096, 1, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg55_1
        buf88 = reinterpret_tensor(buf79, (111616, 8), (8, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf87, (111616, 16), (16, 1), 0), reinterpret_tensor(arg56_1, (16, 8), (1, 16), 0), out=buf88)
        del arg56_1
        buf89 = reinterpret_tensor(buf61, (109, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf88, arg57_1, buf89, 872, 1024, grid=grid(872, 1024), stream=stream0)
        del arg57_1
        del buf88
        buf91 = reinterpret_tensor(buf78, (872, 32, 8), (256, 8, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf89, (872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf90, (872, 32, 8), (256, 8, 1), 0), out=buf91)
        buf92 = reinterpret_tensor(buf81, (109, 1, 32, 8, 8), (2048, 1, 64, 8, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        ...
        del arg60_1
        del arg61_1
        buf138 = reinterpret_tensor(buf89, (3488, 256), (256, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        buf151 = reinterpret_tensor(buf145, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf145  # reuse
        ...
        buf152 = reinterpret_tensor(buf93, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf153 = reinterpret_tensor(buf65, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf65  # reuse
        buf165 = reinterpret_tensor(buf140, (109, 8, 32, 1, 8, 1), (2048, 256, 8, 8, 1, 1), 0); del buf140  # reuse
        ...
        del arg85_1
        del buf146
        buf154 = reinterpret_tensor(buf134, (109, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf149, buf147, buf154, 892928, grid=grid(892928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        del arg87_1
        buf163 = reinterpret_tensor(buf154, (111616, 8), (8, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf162, (111616, 16), (16, 1), 0), reinterpret_tensor(arg88_1, (16, 8), (1, 16), 0), out=buf163)
        del arg88_1
        del buf162
        buf164 = reinterpret_tensor(buf132, (109, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf163, arg89_1, buf164, 872, 1024, grid=grid(872, 1024), stream=stream0)
        del arg89_1
        del buf163
        buf166 = reinterpret_tensor(buf153, (872, 32, 8), (256, 8, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf164, (872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf165, (872, 32, 8), (256, 8, 1), 0), out=buf166)
        del buf165
        buf167 = reinterpret_tensor(buf156, (109, 1, 32, 8, 8), (2048, 1, 64, 8, 1), 0); del buf156  # reuse
        ...
        del buf172
        buf175 = reinterpret_tensor(buf164, (3488, 256), (256, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
