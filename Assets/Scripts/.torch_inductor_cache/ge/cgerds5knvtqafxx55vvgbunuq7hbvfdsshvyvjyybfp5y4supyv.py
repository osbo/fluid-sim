...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/a5/ca5nv2h7kkdb7ce7cv26h7psuaaqubdswblemcw3swgqujc6n6ii.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr3 + (r1 + (128*x2) + (16512*x3)), tmp24, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kp/ckpu54zk5la5kbxxgexjyzwjh2leskf7z44iz4puenharxz7e7c7.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/we/cwecr23rqcagjeb5aspp5ayn6vyxe5ghtjqc3ate4fnmbzxeh2bu.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/bp/cbp2fgexzr6pwgnbtsaymqrbyccgbadojkjrqxnvfq4e3oo6cml2.py
# Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum => clone_1
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ml/cmlvxygpybghg7gay5m76yitng27meplgk6t3zxbsdhzidrrmw2r.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/qt/cqtge3ifgrx6536csfhkhbyxl7bkult64odc2e23bzn6j7v3i73b.py
# Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out => clone_5
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/oj/coj3grdulteijkaf3enpr23va4pfxb6oj33g7d22y5s4loud7vbt.py
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 16384)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (16*x2) + (2048*x1) + (16384*x3)), None)
    tl.store(out_ptr0 + (x4), tmp0, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/x5/cx5gbrrjdenmlr6wzpu7fefdcmmvqvbhfa7zq7rxuuqesztqmhfs.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/yg/cygjsodximydwjfiqmlmlugk4frjteqbnnu2iwofpvtvdtf5zf7d.py
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr3 + (r1 + (128*x2) + (16512*x3)), tmp32, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4o/c4ovdhvqsd3f5nj3f2p2ktc3s7cmqb6vtfiq2gszrqzso4dciqme.py
...
# Graph fragment:
#   %mean_4 : [num_users=3] = call_function[target=torch.ops.aten.mean.dim](args = (%view_82, [2]), kwargs = {})
...
#   %cat_7 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_83, %mean_5], 2), kwargs = {})
triton_per_fused_cat_mean_native_layer_norm_22 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr3 + (r1 + (128*x2) + (8320*x3)), tmp35, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/uu/cuudrldvsxdnk6uaetxnykhmssyw5w5v5iyc5y3ottkqkl56gdmh.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_23', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/at/catdltdnvy67z5fjk4ambusfsx7ozbeozqpda4da7z4fehlhwjys.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5v/c5vaxxrlx7iqjjocqzwmxyrcpj4cd37rojkhvuiot3klxlr2kokt.py
# Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   block_node_2 => mean_5
# Graph fragment:
#   %mean_5 : [num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%view_83, [2], True), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/oq/coq5sft462xgzsazl2xebke4z6u6ty7fa64e2quwhuxcjfvugke7.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/l3/cl33noceugny5m64gbkhmyxoilnvjywlaajw6zfo4pt5mzcjllbn.py
# Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum_6 => clone_15
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/pl/cplwhgp5x63h7jg36zkzwlturzyolopo4h3shy7tyegspdjo5rjp.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ip/cipa4tyef57alqsn7yfkvqu4ekzugqvsbaa3yagbaifatl72wu4c.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wy/cwyauffyhg4hafzwpcvcrqgsiipb5l4tvrsvahmihew55eg2xlzd.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4h/c4hehvdhjjfhcftoqoz775acjbim6vlqfvnpvx3zpmj3hse4o2g4.py
# Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_11 => full_default_17, index_put_7
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6x/c6xnir652zcfsmfkzrvzohjuxqmcsi2ruzhxy4dnylgwdvvzh5kl.py
...
#   %mul_31 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_94, 0.25), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/o6/co6ukxtyuilmd6htsgpjat5dv4ngx7qcdokott4xb3agbqxrnkqu.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/jt/cjt2dxmfhdudbby37337nko64z5erzx2cz5hxs2oiswbimvokaim.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gw/cgwjzpj3gcgfnniqkq7fhr6vlhpjb2yk2kpudkatipy7mvev3x7c.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/nl/cnla5ofx2x72put3ycfpu4ysusksjrck6oxkzq3w2wnvstu53r3x.py
# Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_8 => clone_19
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/yg/cygcshxpw2ukdjb6ka5lv3zotmbzbp66wqsmer5wpowcu3mpgddn.py
# Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_9 => clone_20
# Graph fragment:
#   %clone_20 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%view_101,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6x/c6xhspvz2dr32w6qui73cvqcit2mzwof6tniglyoloqvtei2neru.py
# Topologically Sorted Source Nodes: [h_off_1, x_4, layer_norm_6], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   h_off_1 => mean_4
...
# Graph fragment:
#   %mean_4 : [num_users=3] = call_function[target=torch.ops.aten.mean.dim](args = (%view_82, [2]), kwargs = {})
#   %add_30 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mean_4, %view_105), kwargs = {})
...
triton_per_fused_add_mean_native_layer_norm_38 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_mean_native_layer_norm_38', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 8, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_ptr0 + (128 + r1 + (256*x0)), xmask, other=0.0)
    tmp4 = tl.load(in_ptr1 + (128 + r1 + (256*x0)), xmask, other=0.0)
    tmp9 = tl.load(in_out_ptr0 + (r1 + (128*x0)), xmask, other=0.0)
    ...
    tmp37 = tmp35 * tmp36
    tmp39 = tmp37 + tmp38
    tl.store(in_out_ptr0 + (r1 + (128*x0)), tmp12, xmask)
    tl.store(out_ptr2 + (r1 + (128*x0)), tmp39, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/yr/cyrtkmv2rdcip7ny2oyk4o45n6ayqq5un6pnjsk6yan3i24dmnwz.py
# Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_17 => add_33, erf_5, mul_34, mul_35, mul_36
# Graph fragment:
#   %mul_34 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_107, 0.5), kwargs = {})
#   %mul_35 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_107, 0.7071067811865476), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/p7/cp73lqb2qyrbiwypn5mn5pg2icinyjfpzqsri6qtt4ueoqbn45j2.py
# Topologically Sorted Source Nodes: [x_5, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
# Source node to ATen node mapping:
#   kv_3 => cat_8
#   layer_norm_7 => add_35, add_36, mul_37, mul_38, rsqrt_7, sub_10, var_mean_7
#   x_5 => add_34
# Graph fragment:
#   %add_34 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_30, %view_109), kwargs = {})
...
#   %cat_8 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_110, %mean_6], 2), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_cat_native_layer_norm_40', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr3 + (r1 + (128*x2) + (8320*x3)), tmp31, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gq/cgqq2s3trdfja7ij3ce4vjh6u3jk63v5zubyxlspga46ysmmquzj.py
# Topologically Sorted Source Nodes: [x_5, x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
...
# Graph fragment:
#   %add_34 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_30, %view_109), kwargs = {})
#   %add_39 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_34, %view_132), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_41', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 7, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ts/ctsjtn2slu5g6iggnojnmokst6bhhoyztiharnffzpgpgpzrj7za.py
# Topologically Sorted Source Nodes: [x_7], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   x_7 => add_43
# Graph fragment:
#   %add_43 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_39, %view_136), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_43', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, xnumel, XBLOCK : tl.constexpr):
...
#   sigmoid => sigmoid
# Graph fragment:
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_150,), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/lo/clodfqmjx47t27tmdlbqtg3mlzxwmgswdqpgz3prtuavatnm26pr.py
# Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   packed_1 => cat_10
# Graph fragment:
#   %cat_10 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_9, %view_151], 1), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg62_1, (109, 32), (32, 1))
    assert_size_stride(arg63_1, (109, 32), (32, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf34 = empty_strided_cuda((1, 32, 129, 128), (528384, 16512, 128, 1), torch.float32)
        buf32 = reinterpret_tensor(buf34, (1, 32, 128, 128), (528384, 16512, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_1, kv], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_6.run(buf25, arg32_1, arg33_1, buf29, buf32, 4096, 128, grid=grid(4096), stream=stream0)
        del arg32_1
        del arg33_1
        ...
        buf33 = reinterpret_tensor(buf34, (1, 32, 1, 128), (528384, 16512, 128, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node], Original ATen: [aten.mean]
        triton_red_fused_mean_7.run(buf29, buf33, 4096, 128, grid=grid(4096), stream=stream0)
        del buf32
        del buf33
        buf35 = empty_strided_cuda((4128, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf34, (4128, 128), (128, 1), 0), reinterpret_tensor(arg34_1, (128, 384), (1, 128), 0), out=buf35)
        del arg34_1
        buf36 = reinterpret_tensor(buf29, (32, 8, 128, 16, 1, 1), (16384, 2048, 16, 1, 1, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
        ...
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf35, arg35_1, buf37, 4096, 129, grid=grid(4096, 129), stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf36, (256, 128, 16), (2048, 16, 1), 0), reinterpret_tensor(buf37, (256, 16, 129), (2080, 129, 1), 0), out=buf38)
        ...
        buf41 = reinterpret_tensor(buf34, (1, 32, 128, 129), (528384, 16512, 129, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        del arg37_1
        buf49 = reinterpret_tensor(buf37, (32, 8, 129, 1, 16, 1), (16640, 2080, 16, 16, 1, 1), 0); del buf37  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf35, arg35_1, buf49, 528384, grid=grid(528384), stream=stream0)
        del arg35_1
        buf50 = reinterpret_tensor(buf36, (256, 128, 16), (2048, 16, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf48, (256, 128, 129), (16512, 129, 1), 0), reinterpret_tensor(buf49, (256, 129, 16), (2080, 16, 1), 0), out=buf50)
        buf51 = reinterpret_tensor(buf12, (1, 32, 128, 8, 16), (524288, 16384, 128, 16, 1), 0); del buf12  # reuse
        # Topologically Sorted Source Nodes: [x_out_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf50, buf51, 524288, grid=grid(524288), stream=stream0)
        buf52 = reinterpret_tensor(buf50, (4096, 128), (128, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf51, (4096, 128), (128, 1), 0), reinterpret_tensor(arg38_1, (128, 128), (1, 128), 0), out=buf52)
        del arg38_1
        ...
        triton_per_fused_native_layer_norm_5.run(buf25, buf52, arg39_1, arg40_1, arg41_1, buf56, 4096, 128, grid=grid(4096), stream=stream0)
        del arg40_1
        del arg41_1
        buf57 = empty_strided_cuda((4096, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf56, (4096, 128), (128, 1), 0), reinterpret_tensor(arg42_1, (128, 512), (1, 128), 0), out=buf57)
        del arg42_1
        buf58 = reinterpret_tensor(buf57, (1, 4096, 512), (2097152, 512, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf58, arg43_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg43_1
        buf59 = reinterpret_tensor(buf56, (4096, 128), (128, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf58, (4096, 512), (512, 1), 0), reinterpret_tensor(arg44_1, (512, 128), (1, 512), 0), out=buf59)
        del arg44_1
        buf60 = reinterpret_tensor(buf59, (1, 4096, 128), (524288, 128, 1), 0); del buf59  # reuse
        buf64 = empty_strided_cuda((1, 4096, 128), (524288, 128, 1), torch.float32)
        buf69 = reinterpret_tensor(buf41, (1, 32, 129, 128), (528384, 16512, 128, 1), 0); del buf41  # reuse
        buf67 = reinterpret_tensor(buf69, (1, 32, 128, 128), (528384, 16512, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_3, kv_1], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_21.run(buf60, buf25, buf52, arg39_1, arg45_1, arg46_1, arg47_1, buf64, buf67, 4096, 128, grid=grid(4096), stream=stream0)
        del arg39_1
        del arg45_1
        del arg46_1
        del arg47_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf64, (4096, 128), (128, 1), 0), reinterpret_tensor(arg48_1, (128, 384), (1, 128), 0), out=buf65)
        buf68 = reinterpret_tensor(buf69, (1, 32, 1, 128), (528384, 16512, 128, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_red_fused_mean_7.run(buf64, buf68, 4096, 128, grid=grid(4096), stream=stream0)
        del buf67
        del buf68
        buf70 = buf35; del buf35  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf69, (4128, 128), (128, 1), 0), reinterpret_tensor(arg48_1, (128, 384), (1, 128), 0), out=buf70)
        del arg48_1
        buf71 = reinterpret_tensor(buf64, (32, 8, 128, 16, 1, 1), (16384, 2048, 16, 1, 1, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf65, arg49_1, buf71, 524288, grid=grid(524288), stream=stream0)
        del buf65
        buf72 = reinterpret_tensor(buf49, (32, 8, 16, 1, 129, 1), (16640, 2080, 129, 129, 1, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf70, arg49_1, buf72, 4096, 129, grid=grid(4096, 129), stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf71, (256, 128, 16), (2048, 16, 1), 0), reinterpret_tensor(buf72, (256, 16, 129), (2080, 129, 1), 0), out=buf73)
        ...
        buf76 = reinterpret_tensor(buf69, (1, 32, 128, 129), (528384, 16512, 129, 1), 0); del buf69  # reuse
        ...
        del buf80
        del buf82
        buf84 = reinterpret_tensor(buf72, (32, 8, 129, 1, 16, 1), (16640, 2080, 16, 16, 1, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf70, arg49_1, buf84, 528384, grid=grid(528384), stream=stream0)
        del arg49_1
        del buf70
        buf85 = reinterpret_tensor(buf71, (256, 128, 16), (2048, 16, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf83, (256, 128, 129), (16512, 129, 1), 0), reinterpret_tensor(buf84, (256, 129, 16), (2080, 16, 1), 0), out=buf85)
        del buf83
        del buf84
        buf86 = reinterpret_tensor(buf52, (1, 32, 128, 8, 16), (524288, 16384, 128, 16, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf85, buf86, 524288, grid=grid(524288), stream=stream0)
        buf87 = reinterpret_tensor(buf85, (4096, 128), (128, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf86, (4096, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 128), (1, 128), 0), out=buf87)
        del arg52_1
        buf161 = reinterpret_tensor(buf86, (1, 4096, 128), (524288, 128, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf60, buf87, arg53_1, arg54_1, arg55_1, buf161, 4096, 128, grid=grid(4096), stream=stream0)
        del arg54_1
        del arg55_1
        buf91 = empty_strided_cuda((1, 109, 16384), (1785856, 16384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_p], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg62_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf25, (1, 32, 16384), (524288, 16384, 1), 0), out=buf91)
        del arg62_1
        buf92 = empty_strided_cuda((1, 109, 16384), (1785856, 16384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_p], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg63_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf25, (1, 32, 16384), (524288, 16384, 1), 0), out=buf92)
        del arg63_1
        del buf25
        buf98 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        buf103 = empty_strided_cuda((109, 1, 65, 128), (8320, 1, 128, 1), torch.float32)
        buf101 = reinterpret_tensor(buf103, (109, 1, 64, 128), (8320, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [h_off_1, layer_norm_5, kv_2], Original ATen: [aten.mean, aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_mean_native_layer_norm_22.run(buf91, buf92, arg64_1, arg65_1, buf98, buf101, 6976, 128, grid=grid(6976), stream=stream0)
        del arg64_1
        del arg65_1
        buf96 = empty_strided_cuda((109, 64, 65, 4), (16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_23.run(arg30_1, buf96, 1813760, grid=grid(1813760), stream=stream0)
        del arg30_1
        buf97 = empty_strided_cuda((109, 64, 65), (4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(arg31_1, buf97, 453440, grid=grid(453440), stream=stream0)
        del arg31_1
        buf99 = empty_strided_cuda((6976, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (6976, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf99)
        buf102 = reinterpret_tensor(buf103, (109, 1, 1, 128), (8320, 1, 128, 1), 8192)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_25.run(buf98, buf102, 13952, 64, grid=grid(13952), stream=stream0)
        del buf101
        del buf102
        buf104 = empty_strided_cuda((7085, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (7085, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf104)
        del arg66_1
        buf105 = reinterpret_tensor(buf98, (109, 8, 64, 16, 1, 1), (8192, 1024, 16, 1, 1, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf99, arg67_1, buf105, 892928, grid=grid(892928), stream=stream0)
        buf106 = empty_strided_cuda((109, 8, 16, 1, 65, 1), (8448, 1056, 65, 65, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf104, arg67_1, buf106, 13952, 65, grid=grid(13952, 65), stream=stream0)
        buf107 = empty_strided_cuda((872, 64, 65), (4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf105, (872, 64, 16), (1024, 16, 1), 0), reinterpret_tensor(buf106, (872, 16, 65), (1056, 65, 1), 0), out=buf107)
        buf108 = empty_strided_cuda((109, 1, 64, 65, 4), (16640, 1813760, 260, 4, 1), torch.float32)
        buf143 = empty_strided_cuda((109, 1, 64, 65, 4), (16640, 1813760, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_28.run(buf96, buf108, buf143, 1813760, grid=grid(1813760), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_29.run(buf108, 27904, grid=grid(27904), stream=stream0)
        buf110 = empty_strided_cuda((109, 1, 64, 65), (4160, 4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf108, buf110, 453440, grid=grid(453440), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf110, 6976, grid=grid(6976), stream=stream0)
        buf113 = empty_strided_cuda((109, 1, 64, 65, 8), (33280, 3627520, 65, 1, 4160), torch.float32)
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_red_fused__softmax_add_eq_masked_fill_mul_32.run(buf97, buf107, buf110, buf108, buf113, 55808, 65, grid=grid(55808), stream=stream0)
        buf114 = empty_strided_cuda((109, 1, 64, 1, 8), (512, 55808, 8, 55808, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_red_fused__softmax_33.run(buf113, buf114, 55808, 65, grid=grid(55808), stream=stream0)
        buf115 = reinterpret_tensor(buf96, (109, 1, 64, 65, 4), (16640, 1, 260, 4, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_34.run(buf110, buf108, buf115, 1813760, grid=grid(1813760), stream=stream0)
        del buf108
        buf116 = reinterpret_tensor(buf107, (453440, 8), (8, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (453440, 4), (4, 1), 0), reinterpret_tensor(arg68_1, (4, 8), (1, 4), 0), out=buf116)
        del arg68_1
        buf117 = reinterpret_tensor(buf113, (109, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf117, buf114, buf97, buf116, arg69_1, 872, 4160, grid=grid(872, 4160), stream=stream0)
        del arg69_1
        buf118 = reinterpret_tensor(buf106, (109, 8, 65, 1, 16, 1), (8448, 1056, 16, 16, 1, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf104, arg67_1, buf118, 906880, grid=grid(906880), stream=stream0)
        del arg67_1
        buf119 = reinterpret_tensor(buf105, (872, 64, 16), (1024, 16, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf117, (872, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf118, (872, 65, 16), (1056, 16, 1), 0), out=buf119)
        buf120 = empty_strided_cuda((109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_37.run(buf119, buf120, 892928, grid=grid(892928), stream=stream0)
        buf121 = reinterpret_tensor(buf119, (6976, 128), (128, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (6976, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 128), (1, 128), 0), out=buf121)
        del arg70_1
        buf122 = reinterpret_tensor(buf121, (109, 64, 128), (8192, 128, 1), 0); del buf121  # reuse
        buf126 = reinterpret_tensor(buf120, (109, 64, 128), (8192, 128, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [h_off_1, x_4, layer_norm_6], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_38.run(buf122, buf91, buf92, arg71_1, arg72_1, arg73_1, buf126, 6976, 128, grid=grid(6976), stream=stream0)
        del arg71_1
        del arg72_1
        del arg73_1
        del buf91
        del buf92
        buf127 = empty_strided_cuda((6976, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (6976, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 512), (1, 128), 0), out=buf127)
        del arg74_1
        buf128 = reinterpret_tensor(buf127, (109, 64, 512), (32768, 512, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf128, arg75_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg75_1
        buf129 = reinterpret_tensor(buf126, (6976, 128), (128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (6976, 512), (512, 1), 0), reinterpret_tensor(arg76_1, (512, 128), (1, 512), 0), out=buf129)
        del arg76_1
        buf133 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        buf138 = buf103; del buf103  # reuse
        buf136 = reinterpret_tensor(buf138, (109, 1, 64, 128), (8320, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_5, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_40.run(buf122, buf129, arg77_1, arg78_1, arg79_1, buf133, buf136, 6976, 128, grid=grid(6976), stream=stream0)
        del arg78_1
        del arg79_1
        buf134 = buf99; del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf133, (6976, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf134)
        buf137 = reinterpret_tensor(buf138, (109, 1, 1, 128), (8320, 1, 128, 1), 8192)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_25.run(buf133, buf137, 13952, 64, grid=grid(13952), stream=stream0)
        del buf136
        del buf137
        buf139 = buf104; del buf104  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf138, (7085, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf139)
        del arg80_1
        del buf138
        buf140 = reinterpret_tensor(buf133, (109, 8, 64, 16, 1, 1), (8192, 1024, 16, 1, 1, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [einsum_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf134, arg81_1, buf140, 892928, grid=grid(892928), stream=stream0)
        del buf134
        buf141 = reinterpret_tensor(buf118, (109, 8, 16, 1, 65, 1), (8448, 1056, 65, 65, 1, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [einsum_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf139, arg81_1, buf141, 13952, 65, grid=grid(13952, 65), stream=stream0)
        buf142 = reinterpret_tensor(buf117, (872, 64, 65), (4160, 65, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [einsum_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf140, (872, 64, 16), (1024, 16, 1), 0), reinterpret_tensor(buf141, (872, 16, 65), (1056, 65, 1), 0), out=buf142)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_29.run(buf143, 27904, grid=grid(27904), stream=stream0)
        buf145 = buf110; del buf110  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf143, buf145, 453440, grid=grid(453440), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf145, 6976, grid=grid(6976), stream=stream0)
        buf148 = reinterpret_tensor(buf116, (109, 1, 64, 65, 8), (33280, 3627520, 65, 1, 4160), 0); del buf116  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_32.run(buf97, buf142, buf145, buf143, buf148, 55808, 65, grid=grid(55808), stream=stream0)
        buf149 = buf114; del buf114  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_red_fused__softmax_33.run(buf148, buf149, 55808, 65, grid=grid(55808), stream=stream0)
        buf150 = buf115; del buf115  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_34.run(buf145, buf143, buf150, 1813760, grid=grid(1813760), stream=stream0)
        del buf143
        del buf145
        buf151 = reinterpret_tensor(buf142, (453440, 8), (8, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf150, (453440, 4), (4, 1), 0), reinterpret_tensor(arg82_1, (4, 8), (1, 4), 0), out=buf151)
        del arg82_1
        del buf150
        buf152 = reinterpret_tensor(buf148, (109, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf152, buf149, buf97, buf151, arg83_1, 872, 4160, grid=grid(872, 4160), stream=stream0)
        del arg83_1
        del buf149
        del buf151
        del buf97
        buf153 = reinterpret_tensor(buf141, (109, 8, 65, 1, 16, 1), (8448, 1056, 16, 16, 1, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf139, arg81_1, buf153, 906880, grid=grid(906880), stream=stream0)
        del arg81_1
        del buf139
        buf154 = reinterpret_tensor(buf140, (872, 64, 16), (1024, 16, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf152, (872, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf153, (872, 65, 16), (1056, 16, 1), 0), out=buf154)
        del buf152
        del buf153
        buf155 = empty_strided_cuda((109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_37.run(buf154, buf155, 892928, grid=grid(892928), stream=stream0)
        buf156 = reinterpret_tensor(buf154, (6976, 128), (128, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf155, (6976, 128), (128, 1), 0), reinterpret_tensor(arg84_1, (128, 128), (1, 128), 0), out=buf156)
        del arg84_1
        buf157 = reinterpret_tensor(buf156, (109, 64, 128), (8192, 128, 1), 0); del buf156  # reuse
        buf168 = reinterpret_tensor(buf155, (109, 64, 128), (8192, 128, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [x_5, x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf157, buf122, buf129, arg77_1, arg85_1, arg86_1, arg87_1, buf168, 6976, 128, grid=grid(6976), stream=stream0)
        del arg77_1
        del arg85_1
        del arg86_1
        del arg87_1
        del buf122
        del buf129
        buf162 = reinterpret_tensor(buf58, (4096, 512), (512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (4096, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 512), (1, 128), 0), out=buf162)
        del arg56_1
        buf163 = reinterpret_tensor(buf162, (1, 4096, 512), (2097152, 512, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf163, arg57_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg57_1
        buf164 = reinterpret_tensor(buf161, (4096, 128), (128, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (4096, 512), (512, 1), 0), reinterpret_tensor(arg58_1, (512, 128), (1, 512), 0), out=buf164)
        del arg58_1
        del buf163
        buf165 = reinterpret_tensor(buf164, (1, 4096, 128), (524288, 128, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf165, buf60, buf87, arg53_1, arg59_1, 524288, grid=grid(524288), stream=stream0)
        del arg53_1
        del arg59_1
        buf166 = buf87; del buf87  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg61_1, reinterpret_tensor(buf165, (4096, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf166)
        del arg60_1
        del arg61_1
        buf167 = reinterpret_tensor(buf60, (32, 128, 128), (16384, 128, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf166, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf166, (32, 128, 128), (16384, 1, 128), 0), out=buf167)
        del buf166
        buf169 = reinterpret_tensor(buf128, (6976, 512), (512, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (6976, 128), (128, 1), 0), reinterpret_tensor(arg88_1, (128, 512), (1, 128), 0), out=buf169)
        del arg88_1
        buf170 = reinterpret_tensor(buf169, (109, 64, 512), (32768, 512, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf170, arg89_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg89_1
        buf171 = reinterpret_tensor(buf168, (6976, 128), (128, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (6976, 512), (512, 1), 0), reinterpret_tensor(arg90_1, (512, 128), (1, 512), 0), out=buf171)
        del arg90_1
        del buf170
        buf172 = reinterpret_tensor(buf171, (109, 64, 128), (8192, 128, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [x_7], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf172, buf157, arg91_1, 892928, grid=grid(892928), stream=stream0)
        del arg91_1
        del buf157
        buf173 = empty_strided_cuda((6976, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg93_1, reinterpret_tensor(buf172, (6976, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf173)
        del arg92_1
        del arg93_1
        buf174 = empty_strided_cuda((6976, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf172, (6976, 128), (128, 1), 0), reinterpret_tensor(arg94_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf174)
        del arg94_1
        del arg95_1
        del buf172
        buf175 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf173, (109, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf174, (109, 64, 64), (4096, 1, 64), 0), out=buf175)
        del buf173
        del buf174
        buf176 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg99_1, reinterpret_tensor(buf165, (4096, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf176)
        del arg98_1
        del arg99_1
        buf177 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf165, (4096, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf177)
        del arg100_1
        del arg101_1
        buf178 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (4096, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 1), (1, 128), 0), out=buf178)
        del arg96_1
        del buf165
        buf179 = reinterpret_tensor(buf178, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_44.run(buf179, arg97_1, 4096, grid=grid(4096), stream=stream0)
        del arg97_1
        buf180 = empty_strided_cuda((1, 1499136), (1499136, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf167, buf175, buf176, buf177, buf179, buf180, 1499136, grid=grid(1499136), stream=stream0)
        del buf167
        del buf175
        del buf176
        del buf177
    return (buf180, reinterpret_tensor(buf179, (1, 32, 128), (4096, 128, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg62_1 = rand_strided((109, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    arg63_1 = rand_strided((109, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg92_1 = rand_strided((64, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg93_1 = rand_strided((64, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg94_1 = rand_strided((64, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg98_1 = rand_strided((64, 128), (128, 1), device='cuda:0', dtype=torch.float32)
