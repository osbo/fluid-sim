...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg52_1
        buf166 = reinterpret_tensor(buf86, (1, 4096, 256), (1048576, 256, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf60, buf87, arg53_1, arg54_1, arg55_1, buf166, 4096, 256, grid=grid(4096), stream=stream0)
        del arg54_1
        del arg55_1
        ...
        buf95.copy_(arg63_1)
        del arg63_1
        buf96 = empty_strided_cuda((109, 1, 128, 256), (32768, 32768, 256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_22.run(buf96, 3571712, grid=grid(3571712), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum, getitem_22, index_add__2, col_sum, getitem_23, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_23.run(buf91, buf92, buf25, buf95, buf93, buf96, 5832704, grid=grid(5832704), stream=stream0)
        del buf25
        buf98 = empty_strided_cuda((109, 64, 256), (16384, 256, 1), torch.float32)
        buf104 = empty_strided_cuda((109, 64, 256), (16384, 256, 1), torch.float32)
        buf109 = empty_strided_cuda((109, 1, 65, 256), (16640, 1, 256, 1), torch.float32)
        buf107 = reinterpret_tensor(buf109, (109, 1, 64, 256), (16640, 1, 256, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [h_off_1, layer_norm_5, kv_2], Original ATen: [aten.mean, aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_mean_native_layer_norm_24.run(buf93, arg65_1, buf96, arg66_1, arg67_1, buf98, buf104, buf107, 6976, 256, grid=grid(6976), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        del buf93
        ...
        del arg31_1
        buf105 = empty_strided_cuda((6976, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf104, (6976, 256), (256, 1), 0), reinterpret_tensor(arg68_1, (256, 768), (1, 256), 0), out=buf105)
        buf108 = reinterpret_tensor(buf109, (109, 1, 1, 256), (16640, 1, 256, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_27.run(buf104, buf108, 27904, 64, grid=grid(27904), stream=stream0)
        del buf107
        del buf108
        buf110 = empty_strided_cuda((7085, 768), (768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf109, (7085, 256), (256, 1), 0), reinterpret_tensor(arg68_1, (256, 768), (1, 256), 0), out=buf110)
        del arg68_1
        buf111 = reinterpret_tensor(buf104, (109, 8, 64, 32, 1, 1), (16384, 2048, 32, 1, 1, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf105, arg69_1, buf111, 1785856, grid=grid(1785856), stream=stream0)
        buf112 = reinterpret_tensor(buf109, (109, 8, 32, 1, 65, 1), (16640, 2080, 65, 65, 1, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf110, arg69_1, buf112, 27904, 65, grid=grid(27904, 65), stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf111, (872, 64, 32), (2048, 32, 1), 0), reinterpret_tensor(buf112, (872, 32, 65), (2080, 65, 1), 0), out=buf113)
        buf114 = reinterpret_tensor(buf112, (109, 1, 64, 65, 4), (16640, 1813760, 260, 4, 1), 0); del buf112  # reuse
        ...
        buf116 = empty_strided_cuda((109, 1, 64, 65), (4160, 4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        del arg71_1
        buf124 = reinterpret_tensor(buf121, (109, 8, 65, 1, 32, 1), (16640, 2080, 32, 32, 1, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf110, arg69_1, buf124, 1813760, grid=grid(1813760), stream=stream0)
        del arg69_1
        buf125 = reinterpret_tensor(buf111, (872, 64, 32), (2048, 32, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf123, (872, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf124, (872, 65, 32), (2080, 32, 1), 0), out=buf125)
        buf126 = empty_strided_cuda((109, 1, 64, 8, 32), (16384, 1, 256, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf125, buf126, 1785856, grid=grid(1785856), stream=stream0)
        buf127 = reinterpret_tensor(buf125, (6976, 256), (256, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (6976, 256), (256, 1), 0), reinterpret_tensor(arg72_1, (256, 256), (1, 256), 0), out=buf127)
        del arg72_1
        buf131 = reinterpret_tensor(buf126, (109, 64, 256), (16384, 256, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf98, buf127, arg73_1, arg74_1, arg75_1, buf131, 6976, 256, grid=grid(6976), stream=stream0)
        del arg74_1
        del arg75_1
        buf132 = empty_strided_cuda((6976, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf131, (6976, 256), (256, 1), 0), reinterpret_tensor(arg76_1, (256, 1024), (1, 256), 0), out=buf132)
        del arg76_1
        buf133 = reinterpret_tensor(buf132, (109, 64, 1024), (65536, 1024, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf133, arg77_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg77_1
        buf134 = reinterpret_tensor(buf131, (6976, 256), (256, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf133, (6976, 1024), (1024, 1), 0), reinterpret_tensor(arg78_1, (1024, 256), (1, 1024), 0), out=buf134)
        del arg78_1
        buf135 = reinterpret_tensor(buf134, (109, 64, 256), (16384, 256, 1), 0); del buf134  # reuse
        buf139 = empty_strided_cuda((109, 64, 256), (16384, 256, 1), torch.float32)
        buf144 = reinterpret_tensor(buf124, (109, 1, 65, 256), (16640, 1, 256, 1), 0); del buf124  # reuse
        buf142 = reinterpret_tensor(buf144, (109, 1, 64, 256), (16640, 1, 256, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_4, x_5, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_42.run(buf135, buf98, buf127, arg73_1, arg79_1, arg80_1, arg81_1, buf139, buf142, 6976, 256, grid=grid(6976), stream=stream0)
        del arg73_1
        del arg79_1
        del arg80_1
        del arg81_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (6976, 256), (256, 1), 0), reinterpret_tensor(arg82_1, (256, 768), (1, 256), 0), out=buf140)
        buf143 = reinterpret_tensor(buf144, (109, 1, 1, 256), (16640, 1, 256, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_27.run(buf139, buf143, 27904, 64, grid=grid(27904), stream=stream0)
        del buf142
        del buf143
        buf145 = buf110; del buf110  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf144, (7085, 256), (256, 1), 0), reinterpret_tensor(arg82_1, (256, 768), (1, 256), 0), out=buf145)
        del arg82_1
        buf146 = reinterpret_tensor(buf139, (109, 8, 64, 32, 1, 1), (16384, 2048, 32, 1, 1, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf140, arg83_1, buf146, 1785856, grid=grid(1785856), stream=stream0)
        del buf140
        buf147 = reinterpret_tensor(buf144, (109, 8, 32, 1, 65, 1), (16640, 2080, 65, 65, 1, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf145, arg83_1, buf147, 27904, 65, grid=grid(27904, 65), stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf146, (872, 64, 32), (2048, 32, 1), 0), reinterpret_tensor(buf147, (872, 32, 65), (2080, 65, 1), 0), out=buf148)
        ...
        buf156 = reinterpret_tensor(buf147, (109, 1, 64, 65, 4), (16640, 1, 260, 4, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del buf155
        del buf157
        buf159 = reinterpret_tensor(buf156, (109, 8, 65, 1, 32, 1), (16640, 2080, 32, 32, 1, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf145, arg83_1, buf159, 1813760, grid=grid(1813760), stream=stream0)
        del arg83_1
        del buf145
        buf160 = reinterpret_tensor(buf146, (872, 64, 32), (2048, 32, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf158, (872, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf159, (872, 65, 32), (2080, 32, 1), 0), out=buf160)
        del buf158
        del buf159
        buf161 = reinterpret_tensor(buf98, (109, 1, 64, 8, 32), (16384, 1, 256, 32, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf160, buf161, 1785856, grid=grid(1785856), stream=stream0)
        buf162 = reinterpret_tensor(buf160, (6976, 256), (256, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (6976, 256), (256, 1), 0), reinterpret_tensor(arg86_1, (256, 256), (1, 256), 0), out=buf162)
        del arg86_1
        buf173 = reinterpret_tensor(buf161, (109, 64, 256), (16384, 256, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf135, buf162, arg87_1, arg88_1, arg89_1, buf173, 6976, 256, grid=grid(6976), stream=stream0)
        del arg88_1
        del arg89_1
        buf167 = reinterpret_tensor(buf58, (4096, 1024), (1024, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf166, (4096, 256), (256, 1), 0), reinterpret_tensor(arg56_1, (256, 1024), (1, 256), 0), out=buf167)
        del arg56_1
        buf168 = reinterpret_tensor(buf167, (1, 4096, 1024), (4194304, 1024, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf168, arg57_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg57_1
        buf169 = reinterpret_tensor(buf166, (4096, 256), (256, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (4096, 1024), (1024, 1), 0), reinterpret_tensor(arg58_1, (1024, 256), (1, 1024), 0), out=buf169)
        del arg58_1
        del buf168
        buf170 = reinterpret_tensor(buf169, (1, 4096, 256), (1048576, 256, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf170, buf60, buf87, arg53_1, arg59_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg53_1
        del arg59_1
        del buf60
        del buf87
        buf171 = empty_strided_cuda((4096, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg61_1, reinterpret_tensor(buf170, (4096, 256), (256, 1), 0), reinterpret_tensor(arg60_1, (256, 128), (1, 256), 0), alpha=1, beta=1, out=buf171)
        del arg60_1
        del arg61_1
        ...
        del buf171
        buf174 = reinterpret_tensor(buf133, (6976, 1024), (1024, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf173, (6976, 256), (256, 1), 0), reinterpret_tensor(arg90_1, (256, 1024), (1, 256), 0), out=buf174)
        del arg90_1
        buf175 = reinterpret_tensor(buf174, (109, 64, 1024), (65536, 1024, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf175, arg91_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg91_1
        buf176 = reinterpret_tensor(buf173, (6976, 256), (256, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf175, (6976, 1024), (1024, 1), 0), reinterpret_tensor(arg92_1, (1024, 256), (1, 1024), 0), out=buf176)
        del arg92_1
        del buf175
        buf177 = reinterpret_tensor(buf176, (109, 64, 256), (16384, 256, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_44.run(buf177, buf135, buf162, arg87_1, arg93_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg87_1
        del arg93_1
        del buf135
        del buf162
        ...
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf177, (6976, 256), (256, 1), 0), reinterpret_tensor(arg94_1, (256, 64), (1, 256), 0), alpha=1, beta=1, out=buf178)
        del arg94_1
        del arg95_1
        buf179 = empty_strided_cuda((6976, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg97_1, reinterpret_tensor(buf177, (6976, 256), (256, 1), 0), reinterpret_tensor(arg96_1, (256, 64), (1, 256), 0), alpha=1, beta=1, out=buf179)
        del arg96_1
        del arg97_1
        del buf177
        buf180 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        ...
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf170, (4096, 256), (256, 1), 0), reinterpret_tensor(arg100_1, (256, 64), (1, 256), 0), alpha=1, beta=1, out=buf181)
        del arg100_1
        del arg101_1
        buf182 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf170, (4096, 256), (256, 1), 0), reinterpret_tensor(arg102_1, (256, 64), (1, 256), 0), alpha=1, beta=1, out=buf182)
        del arg102_1
        del arg103_1
        buf183 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (4096, 256), (256, 1), 0), reinterpret_tensor(arg98_1, (256, 1), (1, 256), 0), out=buf183)
        del arg98_1
        del buf170
