...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xi/cxi6ts7zbqdp46mvluqf5exyopcwwayngzoxflgd4ir5aeadpppa.py
...
#   %cat_5 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_10, %mean_2], 2), kwargs = {})
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tl.store(out_ptr3 + (r1 + (512*x2) + (33280*x3)), tmp24, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/jw/cjwtlgmv7r37ejh2fc4pc4vjpfo74mhkas2icrj466u26vh46nsf.py
# Topologically Sorted Source Nodes: [block_node], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   block_node => mean_2
# Graph fragment:
#   %mean_2 : [num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%view_10, [2], True), kwargs = {})
...
def triton_(in_ptr0, out_ptr1, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    x1 = (xindex // 512)
    x3 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (512*r2) + (32768*x1)), None)
    tmp1 = tl.broadcast_to(tmp0, [XBLOCK, RBLOCK])
    tmp3 = tl.sum(tmp1, 1)[:, None]
    tmp4 = 64.0
    tmp5 = tmp3 / tmp4
    tl.store(out_ptr1 + (x0 + (33280*x1)), tmp5, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hz/chzfqjrqjjydrtvxbsfkw4e64sjaea6cgessaegqlyrrz7qnoi76.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/w6/cw66fg3vc4dxvbhysjednqagulgpthwz4cgyhdpvgb6qzhfxh3n3.py
# Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum => clone_1
# Graph fragment:
...
def triton_(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    y1 = (yindex // 512)
    y3 = yindex
    tmp0 = tl.load(in_ptr0 + (512 + y0 + (1536*x2) + (99840*y1)), xmask, eviction_policy='evict_last')
    tmp1 = tl.load(in_ptr1 + (512 + y0), None, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tl.store(out_ptr0 + (x2 + (65*y3)), tmp2, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ic/cicz7gkkwuv2a74xvp2rzr22egc5tzki6ispebn65swo2rhrhv7e.py
...
#   %select_scatter_default : [num_users=4] = call_function[target=torch.ops.aten.select_scatter.default](args = (%expand_1, %copy, 3, 64), kwargs = {})
...
#   %select_scatter_default_2 : [num_users=1] = call_function[target=torch.ops.aten.select_scatter.default](args = (%select_scatter_default, %select_scatter_default_1, 3, 64), kwargs = {})
...
#   %select_scatter_default_8 : [num_users=4] = call_function[target=torch.ops.aten.select_scatter.default](args = (%expand_2, %copy_2, 3, 64), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vq/cvqyulvgesqdwibr4lb7z7ezenzorkc3sdew6tniz4smnvo2rdat.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ck/cck744koesc4ouklfv3ee2aon5bmzfpa6mkxmerqezjv33jrkq2m.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7n/c7nsao4wun4cgu2exyg32mdnn3ls75g4g7n5qpxoujflibiq76bh.py
# Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_3 => full_default_5, index_put_3
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/px/cpxmflcrh7berr4sr5xuwnzehc7qceb7wt6gixdgvyziwvglllwl.py
...
#   %mul_15 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_21, 0.125), kwargs = {})
...
@triton_heuristics.reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused__softmax_add_eq_masked_fill_mul_14', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 8, 'num_reduction': 2, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    xnumel = 2048
    rnumel = 65
    xoffset = tl.program_id(0) * XBLOCK
    xindex = xoffset + tl.arange(0, XBLOCK)[:, None]
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r3 = rindex
        tmp0 = tl.load(in_ptr0 + (r3 + (65*x0) + (4160*x2)), rmask, eviction_policy='evict_last', other=0.0)
        tmp3 = tl.load(in_ptr1 + (r3 + (65*x4)), rmask, eviction_policy='evict_last', other=0.0)
        tmp8 = tl.load(in_ptr2 + (r3 + (65*x0) + (4160*x2)), rmask, eviction_policy='evict_last', other=0.0)
        tmp9 = tl.load(in_ptr3 + (3 + (4*r3) + (260*x0) + (16640*x2)), rmask, eviction_policy='evict_last', other=0.0)
        tmp1 = 0.0
        tmp2 = tmp0 == tmp1
        tmp4 = 0.125
        tmp5 = tmp3 * tmp4
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r3 = rindex
        tmp17 = tl.load(in_ptr0 + (r3 + (65*x0) + (4160*x2)), rmask, eviction_policy='evict_last', other=0.0)
        tmp20 = tl.load(in_ptr1 + (r3 + (65*x4)), rmask, eviction_policy='evict_first', other=0.0)
        tmp25 = tl.load(in_ptr2 + (r3 + (65*x0) + (4160*x2)), rmask, eviction_policy='evict_last', other=0.0)
        tmp26 = tl.load(in_ptr3 + (3 + (4*r3) + (260*x0) + (16640*x2)), rmask, eviction_policy='evict_last', other=0.0)
        tmp18 = 0.0
        tmp19 = tmp17 == tmp18
        tmp21 = 0.125
        tmp22 = tmp20 * tmp21
        ...
        tl.store(out_ptr1 + (r3 + (65*x4)), tmp32, rmask)
    tmp34 = tl.sum(_tmp34, 1)[:, None]
    tl.store(out_ptr2 + (x4), tmp34, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xq/cxq7iyzcqi6qv6abohxq5ksgfsphxtarl4fkuouxrh5cmmahtalh.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wr/cwrulkypnihguvjjgol4v2lhekmdd2omm5v6o7ge6r6b5cfgh3i7.py
...
@triton_heuristics.pointwise(
    size_hints=[32, 8192], tile_hint=TileHint.DEFAULT,
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr0 + (x3 + (64*y4)), xmask & ymask, eviction_policy='evict_last')
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ni/cnikmnrfot3mse6tknldyenivp7whicaw5en3udmknr2scyite42.py
# Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out => clone_5
# Graph fragment:
...
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x3 = (xindex // 33280)
    x4 = xindex
    tmp0 = tl.load(in_ptr0 + (1024 + x0 + (64*x2) + (1536*x1) + (99840*x3)), None)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/j4/cj45umqevna23gh7an5fbm4jg4sranfqorblxqmtqdez4ueh2ece.py
# Topologically Sorted Source Nodes: [x_out_1], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_1 => clone_6
# Graph fragment:
#   %clone_6 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%view_28,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ix/cixnihf7whgwdc4s6nlucci3xqcfsupicmd5pjq26sefqblirzvl.py
...
#   x => add_11
# Graph fragment:
#   %add_11 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_5, %view_32), kwargs = {})
...
#   %cat_6 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_33, %mean_3], 2), kwargs = {})
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, out_ptr3, xnumel, rnumel):
    ...
    tmp28 = tmp26 + tmp27
    tl.store(out_ptr2 + (r1 + (512*x0)), tmp28, None)
    tl.store(out_ptr3 + (r1 + (512*x2) + (33280*x3)), tmp28, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gr/cgr375bi6n5udz767ikjls4u73u6grhlhin5g5jcujipmoavlhfg.py
# Topologically Sorted Source Nodes: [triu_indices], Original ATen: [aten.triu_indices]
# Source node to ATen node mapping:
#   triu_indices => cat_7
# Graph fragment:
#   %cat_7 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%add_18, %add_19],), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/se/cseiud4fri4yr74igctqhx7spqrsxo65jiyz2cju4buqjstuudqy.py
# Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
# Source node to ATen node mapping:
#   layer_norm_3 => var_mean_3
# Graph fragment:
#   %var_mean_3 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_64, [2]), kwargs = {correction: 0, keepdim: True})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_21', 'mutated_arg_names': [], 'no_x_dim': True, 'num_load': 2, 'num_reduction': 4, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7a/c7a26r7pf4rw37uhzprp3rszdicz3trgf5kg5mkwohzdqri3wxn5.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_22', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp4 = tmp0 < tmp3
    tmp5 = tl.load(in_ptr0 + (x0 + (8*x1) + (520*x2)), tmp4 & xmask, other=0.0)
    tmp6 = tl.load(in_ptr0 + (4 + x0 + (8*x1) + (520*x2)), tmp4 & xmask, other=0.0)
    tmp7 = tmp5 + tmp6
    tmp8 = tl.load(in_ptr0 + (260 + x0 + (8*x1) + (520*x2)), tmp4 & xmask, other=0.0)
    tmp9 = tmp7 + tmp8
    tmp10 = tl.load(in_ptr0 + (264 + x0 + (8*x1) + (520*x2)), tmp4 & xmask, other=0.0)
    tmp11 = tmp9 + tmp10
    tmp12 = 4.0
    tmp13 = tmp11 / tmp12
    ...
    tmp16 = tmp0 >= tmp3
    tmp17 = tl.full([1], 33, tl.int64)
    tmp18 = tmp0 < tmp17
    tmp19 = tl.load(in_ptr0 + (256 + x0 + (520*x2)), tmp16 & xmask, eviction_policy='evict_last', other=0.0)
    tmp20 = tl.load(in_ptr0 + (516 + x0 + (520*x2)), tmp16 & xmask, eviction_policy='evict_last', other=0.0)
    tmp21 = tmp19 + tmp20
    tmp22 = 2.0
    tmp23 = tmp21 / tmp22
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/o2/co2zogl23lhq7sjeqfae2xkjsqliftjsy3x7unezvrwicbhoct3p.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_23', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.full([1], 32, tl.int64)
    tmp4 = tmp0 < tmp3
    tmp5 = tl.load(in_ptr0 + ((2*x0) + (130*x1)), tmp4 & xmask, eviction_policy='evict_last', other=0.0)
    tmp6 = tl.load(in_ptr0 + (1 + (2*x0) + (130*x1)), tmp4 & xmask, eviction_policy='evict_last', other=0.0)
    tmp7 = triton_helpers.maximum(tmp5, tmp6)
    tmp8 = tl.load(in_ptr0 + (65 + (2*x0) + (130*x1)), tmp4 & xmask, eviction_policy='evict_last', other=0.0)
    tmp9 = triton_helpers.maximum(tmp7, tmp8)
    tmp10 = tl.load(in_ptr0 + (66 + (2*x0) + (130*x1)), tmp4 & xmask, eviction_policy='evict_last', other=0.0)
    tmp11 = triton_helpers.maximum(tmp9, tmp10)
    tmp12 = tl.full(tmp11.shape, 0.0, tmp11.dtype)
    tmp13 = tl.where(tmp4, tmp11, tmp12)
    tmp14 = tmp0 >= tmp3
    tmp15 = tl.full([1], 33, tl.int64)
    tmp16 = tmp0 < tmp15
    tmp17 = tl.load(in_ptr0 + (64 + (130*x1)), tmp14 & xmask, eviction_policy='evict_last', other=0.0)
    tmp18 = tl.load(in_ptr0 + (129 + (130*x1)), tmp14 & xmask, eviction_policy='evict_last', other=0.0)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/2o/c2orngouzzbmgmhfs2kbm2jlys5swqtoladoj7gc7pez5c2x4446.py
# Topologically Sorted Source Nodes: [x_attn, kv_2], Original ATen: [aten.mean, aten.cat]
# Source node to ATen node mapping:
#   kv_2 => cat_8
#   x_attn => mean_4
# Graph fragment:
#   %mean_4 : [num_users=3] = call_function[target=torch.ops.aten.mean.dim](args = (%view_66, [3]), kwargs = {})
#   %cat_8 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%mean_4, %mean_5], 2), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/o2/co22hyyui3loh3cas4rvqrm3lurndda47ovzlcumyov35klu52qa.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/nw/cnwcxnsgr5i77sfathqfky6ldoxl4kzrxpzwfrquj2za5m5ewrry.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/r5/cr5tvxepatecbpnz74er3cmavf7rhvkcpismuancf77sobwqdll3.py
# Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum_4 => clone_17
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xq/cxq5ewvl6gbnf5pq4zcoezbjcn6iwsew4pwv6e5etldyk6dgzcrk.py
...
#   %select_scatter_default_12 : [num_users=4] = call_function[target=torch.ops.aten.select_scatter.default](args = (%expand_7, %copy_6, 3, 32), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_fill_lift_fresh_28', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/op/coprqrk7xhpoqa5ygbldakn4jf3qgz54ryfjryx2mebit5hd5oib.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_fill_index_put_lift_fresh_29', 'mutated_arg_names': ['out_ptr0'], 'no_x_dim': False, 'num_load': 0, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xj/cxjvzqb3hpzwhjqm62n5tzoheeeykkxlbuo3cdnfjss4ah5xsjqo.py
...
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_45, [None, None, %iota_4, %iota_4], %full_default_17), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_put_lift_fresh_30', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/co/ccoqu4253gbtwg4yhvhqxd53df5hrtsjual7b6nrtptqnb67vgbn.py
# Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_11 => full_default_17, index_put_7
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_put_lift_fresh_31', 'mutated_arg_names': ['out_ptr0'], 'no_x_dim': False, 'num_load': 0, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/do/cdok2ipnx2llj2hbkuz7ln6oiofl2innsnygno2sfb2ad7oantsx.py
...
# Source node to ATen node mapping:
#   attn_probs_2 => amax_4, exp_2, sub_10, sum_3
#   eq_4 => eq_4
#   scores_6 => mul_25
#   scores_7 => add_23
...
#   %mul_25 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_77, 0.125), kwargs = {})
#   %add_23 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_25, %slice_152), kwargs = {})
...
#   %amax_4 : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%clone_19, [3], True), kwargs = {})
#   %sub_10 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%clone_19, %amax_4), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: 'i32', 7: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused__softmax_add_eq_masked_fill_mul_32', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 2, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7m/c7mq6p2uwjdcmflyqaghbyixljtghnfjwkxsb6vs6bsmaufd22az.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_33', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fn/cfnoqq6evs5lfrnuruefbacuei4pbsl6pu4umma4cajdobhp6rfv.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/iu/ciujbyofky44cfsuoamobtnb4qbuswhbsuvcav24bhoi5uepaibp.py
# Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_8 => clone_21
# Graph fragment:
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_35', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 2, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wv/cwvvqns3he4wwob32tho4akeyiia7zlb5utqjkayogg35p5nu6ti.py
# Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_9 => clone_22
# Graph fragment:
#   %clone_22 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%view_84,), kwargs = {memory_format: torch.contiguous_format})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_clone_36', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ma/cmanm3mnrtlwtovzjr26hifcnd2forkianwxbio5wvlli7akbr7z.py
# Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   layer_norm_4 => var_mean_4
#   x_2 => add_25
# Graph fragment:
#   %add_25 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_64, %view_89), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*i64', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: '*fp32', 6: '*fp32', 7: 'i32', 8: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6, 7, 8), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_37', 'mutated_arg_names': [], 'no_x_dim': True, 'num_load': 4, 'num_reduction': 4, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/l7/cl74a2odj76hcjr3bj6h4bb6dw6bpst6n7x3kzt32dka5mv2ljfp.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_38', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gc/cgcbgwo6xvybmhiukgexked4stgygpfbw57yczwtafofb5hkrjl2.py
# Topologically Sorted Source Nodes: [x_attn_1, kv_3], Original ATen: [aten.mean, aten.cat]
# Source node to ATen node mapping:
#   kv_3 => cat_9
#   x_attn_1 => mean_6
# Graph fragment:
#   %mean_6 : [num_users=3] = call_function[target=torch.ops.aten.mean.dim](args = (%view_91, [3]), kwargs = {})
#   %cat_9 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%mean_6, %mean_7], 2), kwargs = {})
triton_poi_fused_cat_mean_39 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_mean_39', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 8, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/es/cesuxlh72eccq3okdfrss52w4kvpwcyipharu47bhjfuxm3li5fl.py
# Topologically Sorted Source Nodes: [h_a], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   h_a => mean_8
# Graph fragment:
#   %mean_8 : [num_users=2] = call_function[target=torch.ops.aten.mean.dim](args = (%view_116, [3]), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_mean_40', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sa/csav7a4p6hvljf5uopkh2smxzygiblu6u5kk3ic56vdepgwxzybv.py
...
triton_poi_fused_mul_41 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ew/cewtmwzx3m7smccuycbwttugjjsd7w7mr3djoz7hiphkyn3br2ya.py
# Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   packed_1 => cat_11
# Graph fragment:
#   %cat_11 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_10, %view_127], 1), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=132), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_42', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'B098E03CDA7B8ADC90DAFFDF24A2956451D1B13F297756A5DCC209498AA53705', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp15 = tmp0 >= tmp3
    tmp16 = tl.full([1], 22784, tl.int64)
    tmp17 = tmp0 < tmp16
    tmp18 = tl.load(in_ptr2 + ((-22528) + x0), tmp15 & xmask, eviction_policy='evict_last', other=0.0)
...
def call(args):
    ...
    assert_size_stride(arg28_1, (4, 64, 65), (4160, 65, 1))
    assert_size_stride(arg29_1, (4, 64, 65, 4), (16640, 260, 4, 1))
    assert_size_stride(arg30_1, (6, 64, 65), (4160, 65, 1))
    assert_size_stride(arg31_1, (6, 64, 65, 4), (16640, 260, 4, 1))
    ...
    assert_size_stride(arg48_1, (64, 512), (512, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf34 = empty_strided_cuda((1, 4, 65, 512), (133120, 33280, 512, 1), torch.float32)
        buf32 = reinterpret_tensor(buf34, (1, 4, 64, 512), (133120, 33280, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_1, kv], Original ATen: [aten.native_layer_norm, aten.cat]
        ...
        buf33 = reinterpret_tensor(buf34, (1, 4, 1, 512), (133120, 33280, 512, 1), 32768)  # alias
        # Topologically Sorted Source Nodes: [block_node], Original ATen: [aten.mean]
        triton_per_fused_mean_7.run(buf29, buf33, 2048, 64, grid=grid(2048), stream=stream0)
        del buf32
        del buf33
        buf35 = empty_strided_cuda((260, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf34, (260, 512), (512, 1), 0), reinterpret_tensor(arg34_1, (512, 1536), (1, 512), 0), out=buf35)
        del arg34_1
        buf36 = reinterpret_tensor(buf29, (4, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf30, arg35_1, buf36, 131072, grid=grid(131072), stream=stream0)
        buf37 = reinterpret_tensor(buf34, (4, 8, 64, 1, 65, 1), (33280, 4160, 65, 65, 1, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf35, arg35_1, buf37, 2048, 65, grid=grid(2048, 65), stream=stream0)
        buf38 = empty_strided_cuda((32, 64, 65), (4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf36, (32, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf37, (32, 64, 65), (4160, 65, 1), 0), out=buf38)
        buf39 = empty_strided_cuda((1, 4, 64, 65, 4), (66560, 16640, 260, 4, 1), torch.float32)
        buf100 = empty_strided_cuda((1, 4, 64, 65, 4), (66560, 16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem, setitem_1, setitem_4, setitem_5], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_10.run(arg29_1, buf39, buf100, 66560, grid=grid(66560), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem, setitem_1, setitem_2], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_11.run(buf39, 1024, grid=grid(1024), stream=stream0)
        buf41 = empty_strided_cuda((1, 4, 64, 65), (16640, 4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf39, buf41, 16640, grid=grid(16640), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf41, 256, grid=grid(256), stream=stream0)
        buf44 = reinterpret_tensor(buf37, (1, 4, 64, 65, 8), (133120, 33280, 65, 1, 4160), 0); del buf37  # reuse
        buf45 = empty_strided_cuda((1, 4, 64, 1, 8), (2048, 512, 1, 2048, 64), torch.float32)
        # Topologically Sorted Source Nodes: [eq, scores_2, scores, scores_1, attn_probs], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_red_fused__softmax_add_eq_masked_fill_mul_14.run(arg28_1, buf38, buf41, buf39, buf44, buf45, 2048, 65, grid=grid(2048), stream=stream0)
        buf46 = empty_strided_cuda((1, 4, 64, 65, 4), (66560, 16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf41, buf39, buf46, 66560, grid=grid(66560), stream=stream0)
        del buf39
        buf47 = reinterpret_tensor(buf38, (16640, 8), (8, 1), 0); del buf38  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf46, (16640, 4), (4, 1), 0), reinterpret_tensor(arg36_1, (4, 8), (1, 4), 0), out=buf47)
        del arg36_1
        buf48 = reinterpret_tensor(buf44, (4, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
        triton_poi_fused_clone_16.run(buf48, buf45, arg28_1, buf47, arg37_1, 32, 4160, grid=grid(32, 4160), stream=stream0)
        del arg37_1
        buf49 = reinterpret_tensor(buf47, (4, 8, 65, 1, 64, 1), (33280, 4160, 64, 64, 1, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf35, arg35_1, buf49, 133120, grid=grid(133120), stream=stream0)
        del arg35_1
        buf50 = reinterpret_tensor(buf36, (32, 64, 64), (4096, 64, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf48, (32, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf49, (32, 65, 64), (4160, 64, 1), 0), out=buf50)
        buf51 = reinterpret_tensor(buf12, (1, 4, 64, 8, 64), (131072, 32768, 512, 64, 1), 0); del buf12  # reuse
        # Topologically Sorted Source Nodes: [x_out_1], Original ATen: [aten.clone]
        ...
        del arg38_1
        buf90 = reinterpret_tensor(buf51, (1, 256, 512), (131072, 512, 1), 0); del buf51  # reuse
        buf95 = reinterpret_tensor(buf49, (1, 4, 65, 512), (133120, 33280, 512, 1), 0); del buf49  # reuse
        buf93 = reinterpret_tensor(buf95, (1, 4, 64, 512), (133120, 33280, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x, layer_norm_2, kv_1], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_19.run(buf25, buf52, arg39_1, arg40_1, arg41_1, buf90, buf93, 256, 512, grid=grid(256), stream=stream0)
        del arg40_1
        del arg41_1
        buf56 = empty_strided_cuda((12, ), (1, ), torch.int64)
        # Topologically Sorted Source Nodes: [triu_indices], Original ATen: [aten.triu_indices]
        triton_poi_fused_triu_indices_20.run(buf56, 12, grid=grid(12), stream=stream0)
        buf57 = empty_strided_cuda((1, 384, 1), (384, 1, 384), torch.float32)
        buf58 = empty_strided_cuda((1, 384, 1), (384, 1, 384), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_21.run(buf56, buf25, buf57, buf58, 384, 512, grid=grid(384), stream=stream0)
        buf60 = empty_strided_cuda((6, 32, 33, 4), (4224, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_22.run(arg31_1, buf60, 25344, grid=grid(25344), stream=stream0)
        del arg31_1
        buf61 = empty_strided_cuda((6, 32, 33), (1056, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.cat]
        triton_poi_fused_cat_23.run(arg30_1, buf61, 6336, grid=grid(6336), stream=stream0)
        del arg30_1
        buf62 = empty_strided_cuda((1, 6, 32, 512), (98304, 16384, 512, 1), torch.float32)
        buf67 = empty_strided_cuda((1, 6, 33, 512), (101376, 16896, 512, 1), torch.float32)
        buf65 = reinterpret_tensor(buf67, (1, 6, 32, 512), (101376, 16896, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_attn, kv_2], Original ATen: [aten.mean, aten.cat]
        triton_poi_fused_cat_mean_24.run(buf56, buf25, buf57, buf58, arg50_1, arg51_1, buf62, buf65, 98304, grid=grid(98304), stream=stream0)
        del arg50_1
        del arg51_1
        buf63 = empty_strided_cuda((192, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf62, (192, 512), (512, 1), 0), reinterpret_tensor(arg52_1, (512, 1536), (1, 512), 0), out=buf63)
        buf66 = reinterpret_tensor(buf67, (1, 6, 1, 512), (101376, 16896, 512, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_25.run(buf62, buf66, 3072, 32, grid=grid(3072), stream=stream0)
        del buf65
        del buf66
        buf68 = empty_strided_cuda((198, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (198, 512), (512, 1), 0), reinterpret_tensor(arg52_1, (512, 1536), (1, 512), 0), out=buf68)
        del arg52_1
        buf69 = reinterpret_tensor(buf62, (6, 8, 32, 64, 1, 1), (16384, 2048, 64, 1, 1, 1), 0); del buf62  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf63, arg53_1, buf69, 98304, grid=grid(98304), stream=stream0)
        buf70 = reinterpret_tensor(buf67, (6, 8, 64, 1, 33, 1), (16896, 2112, 33, 33, 1, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf68, arg53_1, buf70, 3072, 33, grid=grid(3072, 33), stream=stream0)
        buf71 = empty_strided_cuda((48, 32, 33), (1056, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf69, (48, 32, 64), (2048, 64, 1), 0), reinterpret_tensor(buf70, (48, 64, 33), (2112, 33, 1), 0), out=buf71)
        buf72 = empty_strided_cuda((1, 6, 32, 33, 4), (25344, 4224, 132, 4, 1), torch.float32)
        buf127 = empty_strided_cuda((1, 6, 32, 33, 4), (25344, 4224, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_28.run(buf60, buf72, buf127, 25344, grid=grid(25344), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_29.run(buf72, 768, grid=grid(768), stream=stream0)
        buf74 = empty_strided_cuda((1, 6, 32, 33), (6336, 1056, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf72, buf74, 6336, grid=grid(6336), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf74, 192, grid=grid(192), stream=stream0)
        buf77 = empty_strided_cuda((1, 6, 32, 33, 8), (50688, 8448, 33, 1, 1056), torch.float32)
        buf78 = empty_strided_cuda((1, 6, 32, 1, 8), (1536, 256, 1, 1536, 32), torch.float32)
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_32.run(buf61, buf71, buf74, buf72, buf77, buf78, 1536, 33, grid=grid(1536), stream=stream0)
        buf79 = reinterpret_tensor(buf60, (1, 6, 32, 33, 4), (25344, 4224, 132, 4, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf74, buf72, buf79, 25344, grid=grid(25344), stream=stream0)
        del buf72
        buf80 = reinterpret_tensor(buf71, (6336, 8), (8, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf79, (6336, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 8), (1, 4), 0), out=buf80)
        del arg54_1
        buf81 = reinterpret_tensor(buf77, (6, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf81, buf78, buf61, buf80, arg55_1, 48, 1056, grid=grid(48, 1056), stream=stream0)
        del arg55_1
        buf82 = reinterpret_tensor(buf70, (6, 8, 33, 1, 64, 1), (16896, 2112, 64, 64, 1, 1), 0); del buf70  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf68, arg53_1, buf82, 101376, grid=grid(101376), stream=stream0)
        del arg53_1
        buf83 = reinterpret_tensor(buf69, (48, 32, 64), (2048, 64, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf81, (48, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf82, (48, 33, 64), (2112, 64, 1), 0), out=buf83)
        buf84 = empty_strided_cuda((1, 6, 32, 8, 64), (98304, 16384, 512, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf83, buf84, 98304, grid=grid(98304), stream=stream0)
        buf85 = reinterpret_tensor(buf83, (192, 512), (512, 1), 0); del buf83  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf84, (192, 512), (512, 1), 0), reinterpret_tensor(arg56_1, (512, 512), (1, 512), 0), out=buf85)
        del arg56_1
        buf86 = empty_strided_cuda((1, 384, 512), (196608, 512, 1), torch.float32)
        buf87 = buf58; del buf58  # reuse
        buf88 = buf57; del buf57  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf56, buf25, buf85, arg57_1, buf86, buf87, buf88, 384, 512, grid=grid(384), stream=stream0)
        del arg57_1
        del buf56
        buf91 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf90, (256, 512), (512, 1), 0), reinterpret_tensor(arg42_1, (512, 1536), (1, 512), 0), out=buf91)
        buf94 = reinterpret_tensor(buf95, (1, 4, 1, 512), (133120, 33280, 512, 1), 32768)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_per_fused_mean_7.run(buf90, buf94, 2048, 64, grid=grid(2048), stream=stream0)
        del buf93
        del buf94
        buf96 = buf35; del buf35  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf95, (260, 512), (512, 1), 0), reinterpret_tensor(arg42_1, (512, 1536), (1, 512), 0), out=buf96)
        del arg42_1
        buf97 = reinterpret_tensor(buf90, (4, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf91, arg43_1, buf97, 131072, grid=grid(131072), stream=stream0)
        del buf91
        buf98 = reinterpret_tensor(buf95, (4, 8, 64, 1, 65, 1), (33280, 4160, 65, 65, 1, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf96, arg43_1, buf98, 2048, 65, grid=grid(2048, 65), stream=stream0)
        buf99 = reinterpret_tensor(buf48, (32, 64, 65), (4160, 65, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf97, (32, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf98, (32, 64, 65), (4160, 65, 1), 0), out=buf99)
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5, setitem_6], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_11.run(buf100, 1024, grid=grid(1024), stream=stream0)
        buf102 = buf41; del buf41  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf100, buf102, 16640, grid=grid(16640), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf102, 256, grid=grid(256), stream=stream0)
        buf105 = reinterpret_tensor(buf98, (1, 4, 64, 65, 8), (133120, 33280, 65, 1, 4160), 0); del buf98  # reuse
        buf106 = buf45; del buf45  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_14.run(arg28_1, buf99, buf102, buf100, buf105, buf106, 2048, 65, grid=grid(2048), stream=stream0)
        buf107 = buf46; del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf102, buf100, buf107, 66560, grid=grid(66560), stream=stream0)
        del buf100
        del buf102
        buf108 = reinterpret_tensor(buf99, (16640, 8), (8, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf107, (16640, 4), (4, 1), 0), reinterpret_tensor(arg44_1, (4, 8), (1, 4), 0), out=buf108)
        del arg44_1
        del buf107
        buf109 = reinterpret_tensor(buf105, (4, 8, 64, 65, 1, 1), (33280, 4160, 65, 1, 1, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_16.run(buf109, buf106, arg28_1, buf108, arg45_1, 32, 4160, grid=grid(32, 4160), stream=stream0)
        del arg28_1
        del arg45_1
        del buf106
        buf110 = reinterpret_tensor(buf108, (4, 8, 65, 1, 64, 1), (33280, 4160, 64, 64, 1, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf96, arg43_1, buf110, 133120, grid=grid(133120), stream=stream0)
        del arg43_1
        del buf96
        buf111 = reinterpret_tensor(buf97, (32, 64, 64), (4096, 64, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf109, (32, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf110, (32, 65, 64), (4160, 64, 1), 0), out=buf111)
        del buf109
        del buf110
        buf112 = empty_strided_cuda((1, 4, 64, 8, 64), (131072, 32768, 512, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf111, buf112, 131072, grid=grid(131072), stream=stream0)
        buf113 = reinterpret_tensor(buf111, (256, 512), (512, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (256, 512), (512, 1), 0), reinterpret_tensor(arg46_1, (512, 512), (1, 512), 0), out=buf113)
        del arg46_1
        del buf112
        buf114 = reinterpret_tensor(buf113, (1, 256, 512), (131072, 512, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.add]
        triton_poi_fused_add_38.run(buf114, buf25, buf52, arg39_1, arg47_1, 131072, grid=grid(131072), stream=stream0)
        del arg39_1
        del arg47_1
        del buf25
        del buf52
        buf115 = empty_strided_cuda((256, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg49_1, reinterpret_tensor(buf114, (256, 512), (512, 1), 0), reinterpret_tensor(arg48_1, (512, 64), (1, 512), 0), alpha=1, beta=1, out=buf115)
        del arg48_1
        del arg49_1
        buf116 = empty_strided_cuda((4, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [diag_blocks], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf115, (4, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf115, (4, 64, 64), (4096, 1, 64), 0), out=buf116)
        del buf115
        buf117 = reinterpret_tensor(buf85, (1, 6, 32, 512), (98304, 16384, 512, 1), 0); del buf85  # reuse
        buf122 = reinterpret_tensor(buf82, (1, 6, 33, 512), (101376, 16896, 512, 1), 0); del buf82  # reuse
        buf120 = reinterpret_tensor(buf122, (1, 6, 32, 512), (101376, 16896, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_attn_1, kv_3], Original ATen: [aten.mean, aten.cat]
        triton_poi_fused_cat_mean_39.run(buf86, buf87, buf88, arg58_1, arg59_1, buf117, buf120, 98304, grid=grid(98304), stream=stream0)
        del arg58_1
        del arg59_1
        del buf87
        del buf88
        buf118 = buf63; del buf63  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf117, (192, 512), (512, 1), 0), reinterpret_tensor(arg60_1, (512, 1536), (1, 512), 0), out=buf118)
        buf121 = reinterpret_tensor(buf122, (1, 6, 1, 512), (101376, 16896, 512, 1), 16384)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_25.run(buf117, buf121, 3072, 32, grid=grid(3072), stream=stream0)
        del buf120
        del buf121
        buf123 = buf68; del buf68  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (198, 512), (512, 1), 0), reinterpret_tensor(arg60_1, (512, 1536), (1, 512), 0), out=buf123)
        del arg60_1
        buf124 = reinterpret_tensor(buf117, (6, 8, 32, 64, 1, 1), (16384, 2048, 64, 1, 1, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf118, arg61_1, buf124, 98304, grid=grid(98304), stream=stream0)
        del buf118
        buf125 = reinterpret_tensor(buf122, (6, 8, 64, 1, 33, 1), (16896, 2112, 33, 33, 1, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_27.run(buf123, arg61_1, buf125, 3072, 33, grid=grid(3072, 33), stream=stream0)
        buf126 = reinterpret_tensor(buf81, (48, 32, 33), (1056, 33, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf124, (48, 32, 64), (2048, 64, 1), 0), reinterpret_tensor(buf125, (48, 64, 33), (2112, 33, 1), 0), out=buf126)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_29.run(buf127, 768, grid=grid(768), stream=stream0)
        buf129 = buf74; del buf74  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf127, buf129, 6336, grid=grid(6336), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf129, 192, grid=grid(192), stream=stream0)
        buf132 = reinterpret_tensor(buf80, (1, 6, 32, 33, 8), (50688, 8448, 33, 1, 1056), 0); del buf80  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_32.run(buf61, buf126, buf129, buf127, buf132, buf133, 1536, 33, grid=grid(1536), stream=stream0)
        buf134 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf129, buf127, buf134, 25344, grid=grid(25344), stream=stream0)
        del buf127
        del buf129
        buf135 = reinterpret_tensor(buf126, (6336, 8), (8, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (6336, 4), (4, 1), 0), reinterpret_tensor(arg62_1, (4, 8), (1, 4), 0), out=buf135)
        del arg62_1
        del buf134
        buf136 = reinterpret_tensor(buf132, (6, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf136, buf133, buf61, buf135, arg63_1, 48, 1056, grid=grid(48, 1056), stream=stream0)
        del arg63_1
        del buf133
        del buf135
        del buf61
        buf137 = reinterpret_tensor(buf125, (6, 8, 33, 1, 64, 1), (16896, 2112, 64, 64, 1, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf123, arg61_1, buf137, 101376, grid=grid(101376), stream=stream0)
        del arg61_1
        del buf123
        buf138 = reinterpret_tensor(buf124, (48, 32, 64), (2048, 64, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf136, (48, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf137, (48, 33, 64), (2112, 64, 1), 0), out=buf138)
        del buf136
        del buf137
        buf139 = buf84; del buf84  # reuse
        # Topologically Sorted Source Nodes: [x_out_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf138, buf139, 98304, grid=grid(98304), stream=stream0)
        buf140 = reinterpret_tensor(buf138, (192, 512), (512, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (192, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 512), (1, 512), 0), out=buf140)
        del arg64_1
        buf141 = reinterpret_tensor(buf139, (1, 6, 32, 512), (98304, 16384, 512, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [h_a], Original ATen: [aten.mean]
        triton_poi_fused_mean_40.run(buf86, buf140, arg65_1, buf141, 98304, grid=grid(98304), stream=stream0)
        del arg65_1
        del buf140
        del buf86
        buf142 = empty_strided_cuda((192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf141, (192, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf142)
        del arg66_1
        del arg67_1
        buf143 = empty_strided_cuda((192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf141, (192, 512), (512, 1), 0), reinterpret_tensor(arg68_1, (512, 32), (1, 512), 0), alpha=1, beta=1, out=buf143)
        del arg68_1
        del arg69_1
        del buf141
        buf144 = empty_strided_cuda((6, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [off_diag_blocks], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf142, (6, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf143, (6, 32, 32), (1024, 1, 32), 0), out=buf144)
        del buf142
        del buf143
        buf145 = empty_strided_cuda((256, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (256, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 1), (1, 512), 0), out=buf145)
        del arg70_1
        del buf114
        buf146 = reinterpret_tensor(buf145, (1, 4, 64), (256, 64, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [j_gate], Original ATen: [aten.mul]
        triton_poi_fused_mul_41.run(buf146, arg71_1, 256, grid=grid(256), stream=stream0)
        del arg71_1
        buf147 = empty_strided_cuda((1, 22784), (22784, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_42.run(buf116, buf144, buf146, buf147, 22784, grid=grid(22784), stream=stream0)
        del buf116
        del buf144
    return (buf147, buf146, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg28_1 = rand_strided((4, 64, 65), (4160, 65, 1), device='cuda:0', dtype=torch.float32)
    arg29_1 = rand_strided((4, 64, 65, 4), (16640, 260, 4, 1), device='cuda:0', dtype=torch.float32)
    arg30_1 = rand_strided((6, 64, 65), (4160, 65, 1), device='cuda:0', dtype=torch.float32)
    arg31_1 = rand_strided((6, 64, 65, 4), (16640, 260, 4, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg48_1 = rand_strided((64, 512), (512, 1), device='cuda:0', dtype=torch.float32)
