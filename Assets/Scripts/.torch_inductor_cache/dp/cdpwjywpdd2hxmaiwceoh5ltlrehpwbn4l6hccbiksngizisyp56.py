...
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_9, [%device_put_2], %index_4, True), kwargs = {})
...
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_10, [%device_put_2], %index_5, True), kwargs = {})
...
#   %index_put_12 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_21, [%device_put_2], %index_6, True), kwargs = {})
...
#   %index_put_13 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_22, [%device_put_2], %index_7, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg46_1
        buf64 = reinterpret_tensor(buf58, (1, 4096, 128), (524288, 128, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf59, arg47_1, arg48_1, arg49_1, buf64, 4096, 128, grid=grid(4096), stream=stream0)
        del arg48_1
        del arg49_1
        buf63 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf63.copy_(arg34_1)
        del arg34_1
        buf65 = reinterpret_tensor(buf34, (4096, 512), (512, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_22.run(buf68, buf25, buf59, arg47_1, arg53_1, arg72_1, arg73_1, buf121, 4096, 128, grid=grid(4096), stream=stream0)
        del arg47_1
        del arg53_1
        del arg72_1
        del arg73_1
        buf69 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf69.copy_(arg32_1)
        del arg32_1
        ...
        buf108 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf108, 1785856, grid=grid(1785856), stream=stream0)
        buf72 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf72.copy_(arg33_1)
        del arg33_1
        buf73 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf73, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_21, index_add__4, col_sum_1, getitem_22, index_add__5, row_sum, getitem_12, index_add__2, col_sum, getitem_13, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_24.run(buf63, buf69, buf68, buf72, buf25, buf70, buf73, buf106, buf108, 2916352, grid=grid(2916352), stream=stream0)
        buf75 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        buf79 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_25.run(buf70, arg35_1, buf73, arg54_1, arg55_1, buf75, buf79, 6976, 128, grid=grid(6976), stream=stream0)
        del arg54_1
        del arg55_1
        buf80 = empty_strided_cuda((6976, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf79, (6976, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf80)
        buf82 = empty_strided_cuda((109, 1, 64, 64), (4096, 4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mask_base_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf82, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2, lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.clone, aten.sum, aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_27.run(buf82, 6976, 64, grid=grid(6976), stream=stream0)
        buf84 = empty_strided_cuda((109, 64, 65, 4), (16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_28.run(arg30_1, buf84, 1813760, grid=grid(1813760), stream=stream0)
        del arg30_1
        buf85 = reinterpret_tensor(buf73, (109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), 0); del buf73  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf84, buf85, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_30.run(buf85, 27904, grid=grid(27904), stream=stream0)
        buf87 = empty_strided_cuda((109, 1, 64, 64), (4096, 4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf85, buf87, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf87, 6976, grid=grid(6976), stream=stream0)
        buf89 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf80, arg57_1, buf89, 892928, grid=grid(892928), stream=stream0)
        buf90 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf80, arg57_1, buf90, 892928, grid=grid(892928), stream=stream0)
        buf91 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        buf103 = empty_strided_cuda((109, 8, 64, 1, 16, 1), (8192, 1024, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_35.run(buf80, arg57_1, buf91, buf103, 892928, grid=grid(892928), stream=stream0)
        buf98 = reinterpret_tensor(buf70, (109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), 0); del buf70  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf87, buf85, buf98, 1785856, grid=grid(1785856), stream=stream0)
        buf99 = empty_strided_cuda((446464, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (446464, 4), (4, 1), 0), reinterpret_tensor(arg58_1, (4, 16), (1, 4), 0), out=buf99)
        del arg58_1
        del buf98
        buf100 = reinterpret_tensor(buf99, (109, 1, 64, 64, 16), (65536, 1, 1024, 16, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf100, arg59_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg59_1
        buf101 = empty_strided_cuda((446464, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (446464, 16), (16, 1), 0), reinterpret_tensor(arg60_1, (16, 8), (1, 16), 0), out=buf101)
        del arg60_1
        buf92 = empty_strided_cuda((109, 8, 64, 64), (32768, 4096, 64, 1), torch.float32)
        buf102 = empty_strided_cuda((109, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_38.run(buf82, buf87, buf85, buf101, arg61_1, buf92, buf102, 872, 4096, grid=grid(872, 4096), stream=stream0)
        del arg61_1
        del buf85
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        buf93 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf89, buf90, buf91, buf92, False)
        del buf89
        buf94 = buf93[0]
        del buf93
        buf104 = reinterpret_tensor(buf91, (872, 64, 16), (1024, 16, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf102, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf103, (872, 64, 16), (1024, 16, 1), 0), out=buf104)
        buf105 = empty_strided_cuda((6976, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf79, (6976, 128), (128, 1), 0), reinterpret_tensor(arg62_1, (128, 8), (1, 128), 0), out=buf105)
        del arg62_1
        buf110 = empty_strided_cuda((109, 1, 1, 128), (128, 13952, 13952, 1), torch.float32)
        buf111 = reinterpret_tensor(buf110, (109, 1, 1, 128), (128, 1, 13952, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_39.run(buf111, buf106, arg35_1, buf108, 13952, 64, grid=grid(13952), stream=stream0)
        buf112 = empty_strided_cuda((109, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf111, (109, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf112)
        del arg56_1
        buf113 = reinterpret_tensor(buf94, (109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2, mul_3, x_mid_3], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_40.run(buf113, buf104, buf105, arg63_1, buf112, arg57_1, 892928, grid=grid(892928), stream=stream0)
        del arg57_1
        del arg63_1
        buf114 = reinterpret_tensor(buf104, (6976, 128), (128, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf113, (6976, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf114)
        del arg64_1
        buf162 = reinterpret_tensor(buf113, (109, 64, 128), (8192, 128, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf75, buf114, arg65_1, arg66_1, arg67_1, buf162, 6976, 128, grid=grid(6976), stream=stream0)
        del arg66_1
        del arg67_1
        ...
        triton_poi_fused_clone_7.run(buf124, 524288, grid=grid(524288), stream=stream0)
        ...
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_8.run(buf124, 4096, 128, grid=grid(4096), stream=stream0)
        buf126 = reinterpret_tensor(buf66, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(arg28_1, buf126, 2097152, grid=grid(2097152), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_2, setitem_4], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_10.run(buf126, 16384, grid=grid(16384), stream=stream0)
        buf128 = reinterpret_tensor(buf59, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(buf126, buf128, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf128, 4096, grid=grid(4096), stream=stream0)
        buf130 = reinterpret_tensor(buf52, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf52  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_13.run(buf122, arg75_1, buf130, 524288, grid=grid(524288), stream=stream0)
        buf131 = buf39; del buf39  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_14.run(buf122, arg75_1, buf131, 524288, grid=grid(524288), stream=stream0)
        buf132 = buf38; del buf38  # reuse
        buf144 = reinterpret_tensor(buf36, (32, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf36  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_15.run(buf122, arg75_1, buf132, buf144, 524288, grid=grid(524288), stream=stream0)
        del buf122
        buf139 = buf47; del buf47  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf128, buf126, buf139, 2097152, grid=grid(2097152), stream=stream0)
        buf140 = reinterpret_tensor(buf49, (524288, 16), (16, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (524288, 4), (4, 1), 0), reinterpret_tensor(arg76_1, (4, 16), (1, 4), 0), out=buf140)
        del arg76_1
        del buf139
        buf141 = reinterpret_tensor(buf140, (1, 32, 128, 128, 16), (8388608, 262144, 2048, 16, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_17.run(buf141, arg77_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg77_1
        buf142 = reinterpret_tensor(buf51, (524288, 8), (8, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (524288, 16), (16, 1), 0), reinterpret_tensor(arg78_1, (16, 8), (1, 16), 0), out=buf142)
        del arg78_1
        del buf141
        buf133 = buf41; del buf41  # reuse
        buf143 = reinterpret_tensor(buf50, (32, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4, einsum_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_18.run(buf124, buf128, buf126, buf142, arg79_1, buf133, buf143, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg79_1
        del buf124
        del buf128
        del buf142
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        buf134 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf130, buf131, buf132, buf133, False)
        del buf130
        del buf131
        del buf133
        buf135 = buf134[0]
        del buf134
        buf145 = reinterpret_tensor(buf132, (256, 128, 16), (2048, 16, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf143, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf144, (256, 128, 16), (2048, 16, 1), 0), out=buf145)
        del buf143
        del buf144
        buf146 = buf54; del buf54  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (4096, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 8), (1, 128), 0), out=buf146)
        del arg80_1
        del buf121
        buf147 = buf57; del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf56, (32, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf147)
        del arg74_1
        buf148 = reinterpret_tensor(buf135, (1, 32, 128, 8, 16), (524288, 16384, 128, 16, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4, mul_4, x_mid_5], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_20.run(buf148, buf145, buf146, arg81_1, buf147, arg75_1, 524288, grid=grid(524288), stream=stream0)
        del arg75_1
        del arg81_1
        del buf146
        del buf147
        buf149 = reinterpret_tensor(buf145, (4096, 128), (128, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf148, (4096, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 128), (1, 128), 0), out=buf149)
        del arg82_1
        buf153 = reinterpret_tensor(buf148, (1, 4096, 128), (524288, 128, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf68, buf149, arg83_1, arg84_1, arg85_1, buf153, 4096, 128, grid=grid(4096), stream=stream0)
        del arg84_1
        del arg85_1
        buf154 = reinterpret_tensor(buf126, (4096, 512), (512, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (4096, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 512), (1, 128), 0), out=buf154)
        del arg86_1
        buf155 = reinterpret_tensor(buf154, (1, 4096, 512), (2097152, 512, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf155, arg87_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg87_1
        buf156 = reinterpret_tensor(buf153, (4096, 128), (128, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf155, (4096, 512), (512, 1), 0), reinterpret_tensor(arg88_1, (512, 128), (1, 512), 0), out=buf156)
        del arg88_1
        del buf155
        buf157 = reinterpret_tensor(buf156, (1, 4096, 128), (524288, 128, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_42.run(buf157, buf68, buf149, arg83_1, arg89_1, 524288, grid=grid(524288), stream=stream0)
        del arg83_1
        del arg89_1
        buf158 = buf108; del buf108  # reuse
        ...
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_37, index_add__6, col_sum_2, getitem_38, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_43.run(buf63, buf69, buf157, buf72, buf158, buf160, 2916352, grid=grid(2916352), stream=stream0)
        buf163 = reinterpret_tensor(buf102, (6976, 512), (512, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf162, (6976, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 512), (1, 128), 0), out=buf163)
        del arg68_1
        buf164 = reinterpret_tensor(buf163, (109, 64, 512), (32768, 512, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_44.run(buf164, arg69_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg69_1
        buf165 = reinterpret_tensor(buf162, (6976, 128), (128, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf164, (6976, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 128), (1, 512), 0), out=buf165)
        del arg70_1
        buf166 = reinterpret_tensor(buf165, (109, 64, 128), (8192, 128, 1), 0); del buf165  # reuse
        buf170 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [x_2, h_off_5, x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_45.run(buf166, buf158, arg35_1, buf160, buf75, buf114, arg65_1, arg71_1, arg90_1, arg91_1, buf170, 6976, 128, grid=grid(6976), stream=stream0)
        del arg35_1
        del arg65_1
        del arg71_1
        del arg90_1
        del arg91_1
        buf171 = buf80; del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (6976, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf171)
        buf173 = buf87; del buf87  # reuse
        # Topologically Sorted Source Nodes: [mask_base_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf173, 446464, grid=grid(446464), stream=stream0)
        ...
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_27.run(buf173, 6976, 64, grid=grid(6976), stream=stream0)
        buf175 = reinterpret_tensor(buf160, (109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf84, buf175, 1785856, grid=grid(1785856), stream=stream0)
        del buf84
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_30.run(buf175, 27904, grid=grid(27904), stream=stream0)
        buf177 = buf82; del buf82  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf175, buf177, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf177, 6976, grid=grid(6976), stream=stream0)
        buf179 = reinterpret_tensor(buf75, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf75  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf171, arg93_1, buf179, 892928, grid=grid(892928), stream=stream0)
        buf180 = reinterpret_tensor(buf114, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf171, arg93_1, buf180, 892928, grid=grid(892928), stream=stream0)
        buf181 = reinterpret_tensor(buf103, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf103  # reuse
        buf193 = reinterpret_tensor(buf90, (109, 8, 64, 1, 16, 1), (8192, 1024, 16, 16, 1, 1), 0); del buf90  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_35.run(buf171, arg93_1, buf181, buf193, 892928, grid=grid(892928), stream=stream0)
        del buf171
        buf188 = reinterpret_tensor(buf158, (109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf177, buf175, buf188, 1785856, grid=grid(1785856), stream=stream0)
        buf189 = reinterpret_tensor(buf100, (446464, 16), (16, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf188, (446464, 4), (4, 1), 0), reinterpret_tensor(arg94_1, (4, 16), (1, 4), 0), out=buf189)
        del arg94_1
        del buf188
        buf190 = reinterpret_tensor(buf189, (109, 1, 64, 64, 16), (65536, 1, 1024, 16, 1), 0); del buf189  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf190, arg95_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg95_1
        buf191 = reinterpret_tensor(buf164, (446464, 8), (8, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf190, (446464, 16), (16, 1), 0), reinterpret_tensor(arg96_1, (16, 8), (1, 16), 0), out=buf191)
        del arg96_1
        del buf190
        buf182 = buf92; del buf92  # reuse
        buf192 = reinterpret_tensor(buf101, (109, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6, einsum_3], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_38.run(buf173, buf177, buf175, buf191, arg97_1, buf182, buf192, 872, 4096, grid=grid(872, 4096), stream=stream0)
        del arg97_1
        del buf175
        del buf191
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        buf183 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf179, buf180, buf181, buf182, False)
        del buf179
        del buf180
        del buf182
        buf184 = buf183[0]
        del buf183
        buf194 = reinterpret_tensor(buf181, (872, 64, 16), (1024, 16, 1), 0); del buf181  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf192, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf193, (872, 64, 16), (1024, 16, 1), 0), out=buf194)
        del buf193
        buf195 = buf105; del buf105  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (6976, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 8), (1, 128), 0), out=buf195)
        del arg98_1
        del buf170
        buf196 = buf112; del buf112  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf111, (109, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf196)
        del arg92_1
        del buf111
        buf197 = reinterpret_tensor(buf184, (109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), 0); del buf184  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6, mul_5, x_mid_7], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_40.run(buf197, buf194, buf195, arg99_1, buf196, arg93_1, 892928, grid=grid(892928), stream=stream0)
        del arg93_1
        del arg99_1
        del buf195
        del buf196
        buf198 = reinterpret_tensor(buf194, (6976, 128), (128, 1), 0); del buf194  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf197, (6976, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 128), (1, 128), 0), out=buf198)
        del arg100_1
        buf204 = reinterpret_tensor(buf197, (109, 64, 128), (8192, 128, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf166, buf198, arg101_1, arg102_1, arg103_1, buf204, 6976, 128, grid=grid(6976), stream=stream0)
        del arg102_1
        del arg103_1
        buf202 = reinterpret_tensor(buf68, (4096, 128), (128, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf157, (4096, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf202)
        del arg108_1
        del arg109_1
        buf203 = reinterpret_tensor(buf149, (32, 128, 128), (16384, 128, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf202, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf202, (32, 128, 128), (16384, 1, 128), 0), out=buf203)
        del buf202
        buf205 = reinterpret_tensor(buf192, (6976, 512), (512, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf204, (6976, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 512), (1, 128), 0), out=buf205)
        del arg104_1
        buf206 = reinterpret_tensor(buf205, (109, 64, 512), (32768, 512, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_44.run(buf206, arg105_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg105_1
        buf207 = reinterpret_tensor(buf204, (6976, 128), (128, 1), 0); del buf204  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf206, (6976, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 128), (1, 512), 0), out=buf207)
        del arg106_1
        del buf206
        buf208 = reinterpret_tensor(buf207, (109, 64, 128), (8192, 128, 1), 0); del buf207  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_46.run(buf208, buf166, buf198, arg101_1, arg107_1, 892928, grid=grid(892928), stream=stream0)
        del arg101_1
        del arg107_1
        del buf166
        del buf198
        buf209 = reinterpret_tensor(buf177, (6976, 64), (64, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf208, (6976, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf209)
        del arg110_1
        del arg111_1
        buf210 = reinterpret_tensor(buf173, (6976, 64), (64, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg113_1, reinterpret_tensor(buf208, (6976, 128), (128, 1), 0), reinterpret_tensor(arg112_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf210)
        del arg112_1
        del arg113_1
        del buf208
        buf211 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf209, (109, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf210, (109, 64, 64), (4096, 1, 64), 0), out=buf211)
        del buf209
        del buf210
        buf212 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf157, (4096, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf212)
        del arg116_1
        del arg117_1
        buf213 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf157, (4096, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf213)
        del arg118_1
        del arg119_1
        buf214 = reinterpret_tensor(buf56, (4096, 1), (1, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf157, (4096, 128), (128, 1), 0), reinterpret_tensor(arg114_1, (128, 1), (1, 128), 0), out=buf214)
        del arg114_1
        del buf157
        buf215 = reinterpret_tensor(buf214, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf214  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_47.run(buf215, arg115_1, 4096, grid=grid(4096), stream=stream0)
        del arg115_1
        buf216 = empty_strided_cuda((1, 1499136), (1499136, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_48.run(buf203, buf211, buf212, buf213, buf215, buf216, 1499136, grid=grid(1499136), stream=stream0)
        del buf203
        del buf211
        del buf212
        del buf213
    return (buf216, reinterpret_tensor(buf215, (1, 32, 128), (4096, 128, 1), 0), buf69, buf72, buf63, )
