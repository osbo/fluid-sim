...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg52_1
        buf163 = reinterpret_tensor(buf86, (1, 4096, 64), (262144, 64, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf60, buf87, arg53_1, arg54_1, arg55_1, buf163, 4096, 64, grid=grid(4096), stream=stream0)
        del arg54_1
        del arg55_1
        buf91 = empty_strided_cuda((109, 1, 128, 64), (8192, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_22.run(buf91, 892928, grid=grid(892928), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [row_sum, getitem_22, index_add__2, col_sum, getitem_23, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_23.run(arg64_1, arg62_1, buf25, arg63_1, buf91, buf93, 1458176, grid=grid(1458176), stream=stream0)
        del arg62_1
        del arg63_1
        del arg64_1
        del buf25
        buf95 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        buf101 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        buf106 = empty_strided_cuda((109, 1, 65, 64), (4160, 1, 64, 1), torch.float32)
        buf104 = reinterpret_tensor(buf106, (109, 1, 64, 64), (4160, 1, 64, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [h_off_1, layer_norm_5, kv_2], Original ATen: [aten.mean, aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_mean_native_layer_norm_24.run(buf91, arg65_1, buf93, arg66_1, arg67_1, buf95, buf101, buf104, 6976, 64, grid=grid(6976), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        del buf91
        ...
        del arg31_1
        buf102 = empty_strided_cuda((6976, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (6976, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 192), (1, 64), 0), out=buf102)
        buf105 = reinterpret_tensor(buf106, (109, 1, 1, 64), (4160, 1, 64, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_per_fused_mean_27.run(buf101, buf105, 6976, 64, grid=grid(6976), stream=stream0)
        del buf104
        del buf105
        buf107 = empty_strided_cuda((7085, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf106, (7085, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 192), (1, 64), 0), out=buf107)
        del arg68_1
        buf108 = reinterpret_tensor(buf101, (109, 8, 64, 8, 1, 1), (4096, 512, 8, 1, 1, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf102, arg69_1, buf108, 446464, grid=grid(446464), stream=stream0)
        buf109 = reinterpret_tensor(buf106, (109, 8, 8, 1, 65, 1), (4160, 520, 65, 65, 1, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf107, arg69_1, buf109, 6976, 65, grid=grid(6976, 65), stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf108, (872, 64, 8), (512, 8, 1), 0), reinterpret_tensor(buf109, (872, 8, 65), (520, 65, 1), 0), out=buf110)
        ...
        buf113 = reinterpret_tensor(buf109, (109, 1, 64, 65), (4160, 4160, 65, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        del arg71_1
        buf121 = reinterpret_tensor(buf113, (109, 8, 65, 1, 8, 1), (4160, 520, 8, 8, 1, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf107, arg69_1, buf121, 453440, grid=grid(453440), stream=stream0)
        del arg69_1
        buf122 = reinterpret_tensor(buf108, (872, 64, 8), (512, 8, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf120, (872, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf121, (872, 65, 8), (520, 8, 1), 0), out=buf122)
        buf123 = empty_strided_cuda((109, 1, 64, 8, 8), (4096, 1, 64, 8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf122, buf123, 446464, grid=grid(446464), stream=stream0)
        buf124 = reinterpret_tensor(buf122, (6976, 64), (64, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf123, (6976, 64), (64, 1), 0), reinterpret_tensor(arg72_1, (64, 64), (1, 64), 0), out=buf124)
        del arg72_1
        buf128 = reinterpret_tensor(buf123, (109, 64, 64), (4096, 64, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf95, buf124, arg73_1, arg74_1, arg75_1, buf128, 6976, 64, grid=grid(6976), stream=stream0)
        del arg74_1
        del arg75_1
        buf129 = empty_strided_cuda((6976, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (6976, 64), (64, 1), 0), reinterpret_tensor(arg76_1, (64, 256), (1, 64), 0), out=buf129)
        del arg76_1
        buf130 = reinterpret_tensor(buf129, (109, 64, 256), (16384, 256, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf130, arg77_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg77_1
        buf131 = reinterpret_tensor(buf128, (6976, 64), (64, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf130, (6976, 256), (256, 1), 0), reinterpret_tensor(arg78_1, (256, 64), (1, 256), 0), out=buf131)
        del arg78_1
        buf132 = reinterpret_tensor(buf131, (109, 64, 64), (4096, 64, 1), 0); del buf131  # reuse
        buf136 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        buf141 = reinterpret_tensor(buf121, (109, 1, 65, 64), (4160, 1, 64, 1), 0); del buf121  # reuse
        buf139 = reinterpret_tensor(buf141, (109, 1, 64, 64), (4160, 1, 64, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_4, x_5, layer_norm_7, kv_3], Original ATen: [aten.add, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_native_layer_norm_42.run(buf132, buf95, buf124, arg73_1, arg79_1, arg80_1, arg81_1, buf136, buf139, 6976, 64, grid=grid(6976), stream=stream0)
        del arg73_1
        del arg79_1
        del arg80_1
        del arg81_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (6976, 64), (64, 1), 0), reinterpret_tensor(arg82_1, (64, 192), (1, 64), 0), out=buf137)
        buf140 = reinterpret_tensor(buf141, (109, 1, 1, 64), (4160, 1, 64, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_per_fused_mean_27.run(buf136, buf140, 6976, 64, grid=grid(6976), stream=stream0)
        del buf139
        del buf140
        buf142 = buf107; del buf107  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (7085, 64), (64, 1), 0), reinterpret_tensor(arg82_1, (64, 192), (1, 64), 0), out=buf142)
        del arg82_1
        buf143 = reinterpret_tensor(buf136, (109, 8, 64, 8, 1, 1), (4096, 512, 8, 1, 1, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf137, arg83_1, buf143, 446464, grid=grid(446464), stream=stream0)
        del buf137
        buf144 = reinterpret_tensor(buf141, (109, 8, 8, 1, 65, 1), (4160, 520, 65, 65, 1, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf142, arg83_1, buf144, 6976, 65, grid=grid(6976, 65), stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf143, (872, 64, 8), (512, 8, 1), 0), reinterpret_tensor(buf144, (872, 8, 65), (520, 65, 1), 0), out=buf145)
        ...
        buf148 = reinterpret_tensor(buf144, (109, 1, 64, 65), (4160, 4160, 65, 1), 0); del buf144  # reuse
        ...
        del buf152
        del buf154
        buf156 = reinterpret_tensor(buf100, (109, 8, 65, 1, 8, 1), (4160, 520, 8, 8, 1, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf142, arg83_1, buf156, 453440, grid=grid(453440), stream=stream0)
        del arg83_1
        del buf142
        buf157 = reinterpret_tensor(buf143, (872, 64, 8), (512, 8, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf155, (872, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf156, (872, 65, 8), (520, 8, 1), 0), out=buf157)
        del buf155
        del buf156
        buf158 = reinterpret_tensor(buf95, (109, 1, 64, 8, 8), (4096, 1, 64, 8, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf157, buf158, 446464, grid=grid(446464), stream=stream0)
        buf159 = reinterpret_tensor(buf157, (6976, 64), (64, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (6976, 64), (64, 1), 0), reinterpret_tensor(arg86_1, (64, 64), (1, 64), 0), out=buf159)
        del arg86_1
        buf170 = reinterpret_tensor(buf158, (109, 64, 64), (4096, 64, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf132, buf159, arg87_1, arg88_1, arg89_1, buf170, 6976, 64, grid=grid(6976), stream=stream0)
        del arg88_1
        del arg89_1
        buf164 = reinterpret_tensor(buf58, (4096, 256), (256, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (4096, 64), (64, 1), 0), reinterpret_tensor(arg56_1, (64, 256), (1, 64), 0), out=buf164)
        del arg56_1
        buf165 = reinterpret_tensor(buf164, (1, 4096, 256), (1048576, 256, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_20.run(buf165, arg57_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg57_1
        buf166 = reinterpret_tensor(buf163, (4096, 64), (64, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (4096, 256), (256, 1), 0), reinterpret_tensor(arg58_1, (256, 64), (1, 256), 0), out=buf166)
        del arg58_1
        del buf165
        buf167 = reinterpret_tensor(buf166, (1, 4096, 64), (262144, 64, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf167, buf60, buf87, arg53_1, arg59_1, 262144, grid=grid(262144), stream=stream0)
        del arg53_1
        del arg59_1
        buf168 = buf17; del buf17  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg61_1, reinterpret_tensor(buf167, (4096, 64), (64, 1), 0), reinterpret_tensor(arg60_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf168)
        del arg60_1
        del arg61_1
        ...
        del buf168
        buf171 = reinterpret_tensor(buf130, (6976, 256), (256, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (6976, 64), (64, 1), 0), reinterpret_tensor(arg90_1, (64, 256), (1, 64), 0), out=buf171)
        del arg90_1
        buf172 = reinterpret_tensor(buf171, (109, 64, 256), (16384, 256, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf172, arg91_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg91_1
        buf173 = reinterpret_tensor(buf170, (6976, 64), (64, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (6976, 256), (256, 1), 0), reinterpret_tensor(arg92_1, (256, 64), (1, 256), 0), out=buf173)
        del arg92_1
        del buf172
        buf174 = reinterpret_tensor(buf173, (109, 64, 64), (4096, 64, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_44.run(buf174, buf132, buf159, arg87_1, arg93_1, 446464, grid=grid(446464), stream=stream0)
        del arg87_1
        del arg93_1
        buf175 = buf159; del buf159  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf174, (6976, 64), (64, 1), 0), reinterpret_tensor(arg94_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf175)
        del arg94_1
        del arg95_1
        buf176 = reinterpret_tensor(buf132, (6976, 64), (64, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg97_1, reinterpret_tensor(buf174, (6976, 64), (64, 1), 0), reinterpret_tensor(arg96_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf176)
        del arg96_1
        del arg97_1
        ...
        del buf175
        del buf176
        buf178 = buf87; del buf87  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf167, (4096, 64), (64, 1), 0), reinterpret_tensor(arg100_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf178)
        del arg100_1
        del arg101_1
        buf179 = reinterpret_tensor(buf60, (4096, 64), (64, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf167, (4096, 64), (64, 1), 0), reinterpret_tensor(arg102_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf179)
        del arg102_1
        del arg103_1
        buf180 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf167, (4096, 64), (64, 1), 0), reinterpret_tensor(arg98_1, (64, 1), (1, 64), 0), out=buf180)
        del arg98_1
        del buf167
