...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf104 = empty_strided_cuda((1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem, setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_7.run(arg28_1, buf31, buf104, 2097152, grid=grid(2097152), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        del arg42_1
        buf57 = reinterpret_tensor(buf51, (1, 4096, 128), (524288, 128, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf52, arg43_1, arg44_1, arg45_1, buf57, 4096, 128, grid=grid(4096), stream=stream0)
        del arg44_1
        del arg45_1
        buf56 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf56.copy_(arg32_1)
        del arg32_1
        buf58 = reinterpret_tensor(buf44, (4096, 512), (512, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (4096, 128), (128, 1), 0), reinterpret_tensor(arg46_1, (128, 512), (1, 128), 0), out=buf58)
        del arg46_1
        buf59 = reinterpret_tensor(buf58, (1, 4096, 512), (2097152, 512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf59, arg47_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg47_1
        buf60 = reinterpret_tensor(buf57, (4096, 128), (128, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (4096, 512), (512, 1), 0), reinterpret_tensor(arg48_1, (512, 128), (1, 512), 0), out=buf60)
        del arg48_1
        buf61 = reinterpret_tensor(buf60, (1, 4096, 128), (524288, 128, 1), 0); del buf60  # reuse
        buf102 = reinterpret_tensor(buf49, (1, 4096, 128), (524288, 128, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_20.run(buf61, buf25, buf52, arg43_1, arg49_1, arg66_1, arg67_1, buf102, 4096, 128, grid=grid(4096), stream=stream0)
        del arg43_1
        del arg49_1
        del arg66_1
        del arg67_1
        ...
        buf103 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf102, (4096, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 384), (1, 128), 0), out=buf103)
        del arg68_1
        buf108 = reinterpret_tensor(buf102, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf102  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_11.run(buf103, arg69_1, buf108, 524288, grid=grid(524288), stream=stream0)
        buf109 = reinterpret_tensor(buf52, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf103, arg69_1, buf109, 524288, grid=grid(524288), stream=stream0)
        buf110 = reinterpret_tensor(buf25, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf25  # reuse
        buf122 = reinterpret_tensor(buf37, (32, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf37  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf103, arg69_1, buf110, buf122, 524288, grid=grid(524288), stream=stream0)
        del arg69_1
        del buf103
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_8.run(buf104, 16384, grid=grid(16384), stream=stream0)
        buf106 = reinterpret_tensor(buf36, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_9.run(buf104, buf106, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_10.run(buf106, 4096, grid=grid(4096), stream=stream0)
        buf111 = reinterpret_tensor(buf48, (32, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf106, buf104, buf111, 4194304, grid=grid(4194304), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf112 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf108, buf109, buf110, buf111, False)
        del buf108
        del buf109
        del buf110
        buf113 = buf112[0]
        del buf112
        buf117 = reinterpret_tensor(buf59, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf106, buf104, buf117, 2097152, grid=grid(2097152), stream=stream0)
        del buf104
        buf118 = reinterpret_tensor(buf46, (524288, 16), (16, 1), 0); del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf117, (524288, 4), (4, 1), 0), reinterpret_tensor(arg70_1, (4, 16), (1, 4), 0), out=buf118)
        del arg70_1
        buf119 = reinterpret_tensor(buf118, (1, 32, 128, 128, 16), (8388608, 262144, 2048, 16, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_16.run(buf119, arg71_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg71_1
        buf120 = reinterpret_tensor(buf111, (524288, 8), (8, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (524288, 16), (16, 1), 0), reinterpret_tensor(arg72_1, (16, 8), (1, 16), 0), out=buf120)
        del arg72_1
        del buf119
        buf121 = reinterpret_tensor(buf47, (32, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf120, arg73_1, buf121, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg73_1
        del buf120
        buf123 = reinterpret_tensor(buf106, (256, 128, 16), (2048, 16, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf121, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf122, (256, 128, 16), (2048, 16, 1), 0), out=buf123)
        del buf121
        del buf122
        buf124 = reinterpret_tensor(buf113, (1, 32, 128, 8, 16), (524288, 16384, 128, 16, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.add]
        triton_poi_fused_add_18.run(buf124, buf123, 524288, grid=grid(524288), stream=stream0)
        buf125 = reinterpret_tensor(buf123, (4096, 128), (128, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (4096, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 128), (1, 128), 0), out=buf125)
        del arg74_1
        buf129 = reinterpret_tensor(buf124, (1, 4096, 128), (524288, 128, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf61, buf125, arg75_1, arg76_1, arg77_1, buf129, 4096, 128, grid=grid(4096), stream=stream0)
        del arg76_1
        del arg77_1
        buf130 = reinterpret_tensor(buf117, (4096, 512), (512, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf129, (4096, 128), (128, 1), 0), reinterpret_tensor(arg78_1, (128, 512), (1, 128), 0), out=buf130)
        del arg78_1
        buf131 = reinterpret_tensor(buf130, (1, 4096, 512), (2097152, 512, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf131, arg79_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg79_1
        buf132 = reinterpret_tensor(buf129, (4096, 128), (128, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf131, (4096, 512), (512, 1), 0), reinterpret_tensor(arg80_1, (512, 128), (1, 512), 0), out=buf132)
        del arg80_1
        del buf131
        buf133 = reinterpret_tensor(buf132, (1, 4096, 128), (524288, 128, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_22.run(buf133, buf61, buf125, arg75_1, arg81_1, 524288, grid=grid(524288), stream=stream0)
        del arg75_1
        del arg81_1
        buf134 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf134, 1785856, grid=grid(1785856), stream=stream0)
        buf136 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf136, 1785856, grid=grid(1785856), stream=stream0)
        buf65 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf65.copy_(arg31_1)
        del arg31_1
        buf66 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf66, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_16, index_add__4, col_sum_1, getitem_17, index_add__5, row_sum_2, getitem_28, index_add__6, col_sum_2, getitem_29, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_23.run(buf56, buf62, buf61, buf65, buf133, buf63, buf66, buf134, buf136, 2916352, grid=grid(2916352), stream=stream0)
        buf68 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        buf72 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_24.run(buf63, arg33_1, buf66, arg50_1, arg51_1, buf68, buf72, 6976, 128, grid=grid(6976), stream=stream0)
        del arg50_1
        del arg51_1
        buf73 = empty_strided_cuda((6976, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf72, (6976, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf73)
        del arg52_1
        buf74 = reinterpret_tensor(buf66, (109, 1, 64, 64, 4), (16384, 1785856, 256, 4, 1), 0); del buf66  # reuse
        buf148 = reinterpret_tensor(buf63, (109, 64, 64, 4), (16384, 256, 4, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [sub, setitem_2], Original ATen: [aten.mean, aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_mean_25.run(arg29_1, buf74, buf148, 1785856, grid=grid(1785856), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf74, 27904, grid=grid(27904), stream=stream0)
        buf76 = empty_strided_cuda((109, 1, 64, 64), (4096, 4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf74, buf76, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf76, 6976, grid=grid(6976), stream=stream0)
        buf78 = reinterpret_tensor(buf72, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf73, arg53_1, buf78, 892928, grid=grid(892928), stream=stream0)
        buf79 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf73, arg53_1, buf79, 892928, grid=grid(892928), stream=stream0)
        buf80 = empty_strided_cuda((109, 8, 64, 16), (8192, 1024, 16, 1), torch.float32)
        buf92 = empty_strided_cuda((109, 8, 64, 1, 16, 1), (8192, 1024, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_1], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf73, arg53_1, buf80, buf92, 892928, grid=grid(892928), stream=stream0)
        del arg53_1
        buf81 = empty_strided_cuda((109, 8, 64, 64), (32768, 4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf76, buf74, buf81, 3571712, grid=grid(3571712), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf82 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf78, buf79, buf80, buf81, False)
        del buf78
        buf83 = buf82[0]
        del buf82
        buf87 = empty_strided_cuda((109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf76, buf74, buf87, 1785856, grid=grid(1785856), stream=stream0)
        del buf74
        buf88 = empty_strided_cuda((446464, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf87, (446464, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 16), (1, 4), 0), out=buf88)
        del arg54_1
        del buf87
        buf89 = reinterpret_tensor(buf88, (109, 1, 64, 64, 16), (65536, 1, 1024, 16, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_34.run(buf89, arg55_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg55_1
        buf90 = reinterpret_tensor(buf81, (446464, 8), (8, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf89, (446464, 16), (16, 1), 0), reinterpret_tensor(arg56_1, (16, 8), (1, 16), 0), out=buf90)
        del arg56_1
        buf91 = empty_strided_cuda((109, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf90, arg57_1, buf91, 872, 4096, grid=grid(872, 4096), stream=stream0)
        del arg57_1
        buf93 = reinterpret_tensor(buf80, (872, 64, 16), (1024, 16, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf91, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf92, (872, 64, 16), (1024, 16, 1), 0), out=buf93)
        buf94 = reinterpret_tensor(buf83, (109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), 0); del buf83  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf94, buf93, 892928, grid=grid(892928), stream=stream0)
        buf95 = reinterpret_tensor(buf93, (6976, 128), (128, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf94, (6976, 128), (128, 1), 0), reinterpret_tensor(arg58_1, (128, 128), (1, 128), 0), out=buf95)
        del arg58_1
        buf138 = reinterpret_tensor(buf94, (109, 64, 128), (8192, 128, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf68, buf95, arg59_1, arg60_1, arg61_1, buf138, 6976, 128, grid=grid(6976), stream=stream0)
        del arg60_1
        del arg61_1
        buf139 = reinterpret_tensor(buf91, (6976, 512), (512, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf138, (6976, 128), (128, 1), 0), reinterpret_tensor(arg62_1, (128, 512), (1, 128), 0), out=buf139)
        del arg62_1
        buf140 = reinterpret_tensor(buf139, (109, 64, 512), (32768, 512, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf140, arg63_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg63_1
        buf141 = reinterpret_tensor(buf138, (6976, 128), (128, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf140, (6976, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 128), (1, 512), 0), out=buf141)
        del arg64_1
        buf142 = reinterpret_tensor(buf141, (109, 64, 128), (8192, 128, 1), 0); del buf141  # reuse
        buf146 = reinterpret_tensor(buf92, (109, 64, 128), (8192, 128, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [x_2, h_off_5, x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_39.run(buf142, buf134, arg33_1, buf136, buf68, buf95, arg59_1, arg65_1, arg82_1, arg83_1, buf146, 6976, 128, grid=grid(6976), stream=stream0)
        del arg33_1
        del arg59_1
        del arg65_1
        del arg82_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf146, (6976, 128), (128, 1), 0), reinterpret_tensor(arg84_1, (128, 384), (1, 128), 0), out=buf147)
        del arg84_1
        # Topologically Sorted Source Nodes: [setitem_6], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf148, 27904, grid=grid(27904), stream=stream0)
        buf150 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf148, buf150, 446464, grid=grid(446464), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf150, 6976, grid=grid(6976), stream=stream0)
        buf152 = reinterpret_tensor(buf146, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf146  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf147, arg85_1, buf152, 892928, grid=grid(892928), stream=stream0)
        buf153 = reinterpret_tensor(buf95, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf147, arg85_1, buf153, 892928, grid=grid(892928), stream=stream0)
        buf154 = reinterpret_tensor(buf68, (109, 8, 64, 16), (8192, 1024, 16, 1), 0); del buf68  # reuse
        buf166 = reinterpret_tensor(buf79, (109, 8, 64, 1, 16, 1), (8192, 1024, 16, 16, 1, 1), 0); del buf79  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf147, arg85_1, buf154, buf166, 892928, grid=grid(892928), stream=stream0)
        del arg85_1
        del buf147
        buf155 = reinterpret_tensor(buf140, (109, 8, 64, 64), (32768, 4096, 64, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf150, buf148, buf155, 3571712, grid=grid(3571712), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf156 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf152, buf153, buf154, buf155, False)
        del buf152
        del buf153
        buf157 = buf156[0]
        del buf156
        buf161 = reinterpret_tensor(buf136, (109, 1, 64, 64, 4), (16384, 1, 256, 4, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf150, buf148, buf161, 1785856, grid=grid(1785856), stream=stream0)
        del buf148
        buf162 = reinterpret_tensor(buf89, (446464, 16), (16, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (446464, 4), (4, 1), 0), reinterpret_tensor(arg86_1, (4, 16), (1, 4), 0), out=buf162)
        del arg86_1
        del buf161
        buf163 = reinterpret_tensor(buf162, (109, 1, 64, 64, 16), (65536, 1, 1024, 16, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_34.run(buf163, arg87_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg87_1
        buf164 = reinterpret_tensor(buf155, (446464, 8), (8, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (446464, 16), (16, 1), 0), reinterpret_tensor(arg88_1, (16, 8), (1, 16), 0), out=buf164)
        del arg88_1
        del buf163
        buf165 = reinterpret_tensor(buf90, (109, 8, 64, 64, 1, 1), (32768, 4096, 64, 1, 1, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf164, arg89_1, buf165, 872, 4096, grid=grid(872, 4096), stream=stream0)
        del arg89_1
        del buf164
        buf167 = reinterpret_tensor(buf154, (872, 64, 16), (1024, 16, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf165, (872, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf166, (872, 64, 16), (1024, 16, 1), 0), out=buf167)
        del buf166
        buf168 = reinterpret_tensor(buf157, (109, 1, 64, 8, 16), (8192, 1, 128, 16, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf168, buf167, 892928, grid=grid(892928), stream=stream0)
        buf169 = reinterpret_tensor(buf167, (6976, 128), (128, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (6976, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 128), (1, 128), 0), out=buf169)
        del arg90_1
        buf175 = reinterpret_tensor(buf168, (109, 64, 128), (8192, 128, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf142, buf169, arg91_1, arg92_1, arg93_1, buf175, 6976, 128, grid=grid(6976), stream=stream0)
        del arg92_1
        del arg93_1
        buf173 = reinterpret_tensor(buf61, (4096, 128), (128, 1), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg99_1, reinterpret_tensor(buf133, (4096, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf173)
        del arg98_1
        del arg99_1
        buf174 = reinterpret_tensor(buf125, (32, 128, 128), (16384, 128, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf173, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf173, (32, 128, 128), (16384, 1, 128), 0), out=buf174)
        del buf173
        buf176 = reinterpret_tensor(buf165, (6976, 512), (512, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf175, (6976, 128), (128, 1), 0), reinterpret_tensor(arg94_1, (128, 512), (1, 128), 0), out=buf176)
        del arg94_1
        buf177 = reinterpret_tensor(buf176, (109, 64, 512), (32768, 512, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_38.run(buf177, arg95_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg95_1
        buf178 = reinterpret_tensor(buf175, (6976, 128), (128, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf177, (6976, 512), (512, 1), 0), reinterpret_tensor(arg96_1, (512, 128), (1, 512), 0), out=buf178)
        del arg96_1
        del buf177
        buf179 = reinterpret_tensor(buf178, (109, 64, 128), (8192, 128, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf179, buf142, buf169, arg91_1, arg97_1, 892928, grid=grid(892928), stream=stream0)
        del arg91_1
        del arg97_1
        del buf142
        del buf169
        buf180 = reinterpret_tensor(buf150, (6976, 64), (64, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf179, (6976, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf180)
        del arg100_1
        del arg101_1
        buf181 = empty_strided_cuda((6976, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf179, (6976, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf181)
        del arg102_1
        del arg103_1
        del buf179
        buf182 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf180, (109, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf181, (109, 64, 64), (4096, 1, 64), 0), out=buf182)
        del buf180
        del buf181
        buf183 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg107_1, reinterpret_tensor(buf133, (4096, 128), (128, 1), 0), reinterpret_tensor(arg106_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf183)
        del arg106_1
        del arg107_1
        buf184 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf133, (4096, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf184)
        del arg108_1
        del arg109_1
        buf185 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf133, (4096, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 1), (1, 128), 0), out=buf185)
        del arg104_1
        del buf133
        buf186 = reinterpret_tensor(buf185, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_41.run(buf186, arg105_1, 4096, grid=grid(4096), stream=stream0)
        del arg105_1
        buf187 = empty_strided_cuda((1, 1499136), (1499136, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_42.run(buf174, buf182, buf183, buf184, buf186, buf187, 1499136, grid=grid(1499136), stream=stream0)
        del buf174
        del buf182
        del buf183
        del buf184
    return (buf187, reinterpret_tensor(buf186, (1, 32, 128), (4096, 128, 1), 0), buf62, buf65, buf56, )
