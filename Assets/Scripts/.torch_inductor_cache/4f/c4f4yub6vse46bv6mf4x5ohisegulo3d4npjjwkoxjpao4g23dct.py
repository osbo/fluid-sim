...
#   %index_put_13 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_11, [None, %arg42_1], %view_131, True), kwargs = {})
...
#   %index_put_12 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_10, [None, %arg42_1], %view_131, True), kwargs = {})
...
#   toks_3 => index_3
# Graph fragment:
#   %index_3 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_133, [None, %arg59_1]), kwargs = {})
#   %index_put_15 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_13, [None, %arg61_1], %index_3, True), kwargs = {})
#   %index_put_14 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_12, [None, %arg60_1], %index_3, True), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg51_1, (96, 32), (32, 1))
    ...
    assert_size_stride(arg57_1, (32, 32), (32, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, z, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_20.run(buf25, buf52, arg41_1, arg42_1, arg43_1, arg44_1, buf56, buf58, buf62, 4096, 32, grid=grid(4096), stream=stream0)
        del arg43_1
        del arg44_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf66, (4096, 128), (128, 1), 0), reinterpret_tensor(arg45_1, (128, 128), (1, 128), 0), out=buf67)
        del arg45_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf68, (4096, 128), (128, 1), 0), reinterpret_tensor(arg47_1, (128, 32), (1, 128), 0), out=buf69)
        del arg47_1
        ...
        buf113 = reinterpret_tensor(buf36, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [col_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf113, 131072, grid=grid(131072), stream=stream0)
        buf139 = reinterpret_tensor(buf35, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf35  # reuse
        # Topologically Sorted Source Nodes: [col_highway_2], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf139, 131072, grid=grid(131072), stream=stream0)
        buf142 = empty_strided_cuda((1, 32, 128, 32), (131072, 4096, 32, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9, row_highway_2, index_add__8], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_26.run(buf70, buf25, buf52, arg41_1, arg48_1, arg42_1, buf109, buf113, buf139, buf142, 131072, grid=grid(131072), stream=stream0)
        del arg41_1
        del arg42_1
        del arg48_1
        del buf25
        ...
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_27.run(buf71, buf72, arg49_1, arg50_1, buf73, buf77, 3488, 32, grid=grid(3488), stream=stream0)
        del arg49_1
        del arg50_1
        buf78 = empty_strided_cuda((3488, 96), (96, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf77, (3488, 32), (32, 1), 0), reinterpret_tensor(arg51_1, (32, 96), (1, 32), 0), out=buf78)
        del arg51_1
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf78, arg52_1, buf84, 111616, grid=grid(111616), stream=stream0)
        buf85 = empty_strided_cuda((109, 8, 32, 4), (1024, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf78, arg52_1, buf85, 111616, grid=grid(111616), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf78, arg52_1, buf86, buf98, 111616, grid=grid(111616), stream=stream0)
        del arg52_1
        del buf78
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (3488, 32), (32, 1), 0), reinterpret_tensor(arg57_1, (32, 32), (1, 32), 0), out=buf101)
        del arg57_1
        buf122 = reinterpret_tensor(buf93, (109, 32, 128), (4096, 128, 1), 0); del buf93  # reuse
        buf118 = reinterpret_tensor(buf122, (109, 32, 32), (4096, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_40.run(buf73, buf101, arg58_1, arg62_1, arg63_1, buf118, 3488, 32, grid=grid(3488), stream=stream0)
        del arg62_1
        del arg63_1
        ...
        del buf107
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_41.run(arg60_1, arg59_1, buf73, buf101, arg58_1, arg61_1, buf109, buf113, 729088, grid=grid(729088), stream=stream0)
        buf112 = reinterpret_tensor(buf80, (1, 109, 4096), (446464, 4096, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf109, (1, 32, 4096), (131072, 4096, 1), 0), out=buf112)
        del arg30_1
        buf116 = empty_strided_cuda((1, 109, 4096), (446464, 4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf113, (1, 32, 4096), (131072, 4096, 1), 0), out=buf116)
        del arg31_1
        buf117 = empty_strided_cuda((109, 1, 32), (32, 3488, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_mid_o, g_1], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_42.run(buf73, buf101, arg58_1, buf117, 3488, 32, grid=grid(3488), stream=stream0)
        buf119 = reinterpret_tensor(buf122, (109, 32, 32), (4096, 128, 1), 32)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf112, buf119, 111616, grid=grid(111616), stream=stream0)
        del buf112
        buf120 = reinterpret_tensor(buf122, (109, 32, 32), (4096, 128, 1), 64)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf116, buf120, 111616, grid=grid(111616), stream=stream0)
        buf121 = reinterpret_tensor(buf122, (109, 32, 32), (4096, 128, 1), 96)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf117, buf121, 111616, grid=grid(111616), stream=stream0)
        del buf117
        del buf118
        del buf119
        del buf120
        del buf121
        buf123 = reinterpret_tensor(buf116, (3488, 128), (128, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (3488, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf123)
        del arg64_1
        del buf122
        buf124 = reinterpret_tensor(buf123, (109, 32, 128), (4096, 128, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf124, arg65_1, 446464, grid=grid(446464), stream=stream0)
        del arg65_1
        buf125 = reinterpret_tensor(buf100, (3488, 32), (32, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (3488, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 32), (1, 128), 0), out=buf125)
        del arg66_1
        del buf124
        buf126 = reinterpret_tensor(buf125, (109, 32, 32), (1024, 32, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_46.run(buf126, buf73, buf101, arg58_1, arg67_1, 111616, grid=grid(111616), stream=stream0)
        del arg58_1
        del arg67_1
        buf127 = reinterpret_tensor(buf73, (3488, 32), (32, 1), 0); del buf73  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (3488, 32), (32, 1), 0), reinterpret_tensor(arg72_1, (32, 32), (1, 32), 0), out=buf127)
        del arg72_1
        buf128 = reinterpret_tensor(buf127, (109, 1, 32, 32), (1024, 1, 32, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf128, arg73_1, 111616, grid=grid(111616), stream=stream0)
        del arg73_1
        buf129 = buf101; del buf101  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf128, (3488, 32), (32, 1), 0), reinterpret_tensor(arg74_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf129)
        del arg74_1
        del arg75_1
        buf130 = reinterpret_tensor(buf128, (3488, 32), (32, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (3488, 32), (32, 1), 0), reinterpret_tensor(arg76_1, (32, 32), (1, 32), 0), out=buf130)
        del arg76_1
        ...
        triton_poi_fused_gelu_47.run(buf131, arg77_1, 111616, grid=grid(111616), stream=stream0)
        del arg77_1
        buf132 = reinterpret_tensor(buf98, (3488, 32), (32, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf131, (3488, 32), (32, 1), 0), reinterpret_tensor(arg78_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf132)
        del arg78_1
        del arg79_1
        buf133 = reinterpret_tensor(buf131, (109, 32, 32), (1024, 32, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf129, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf132, (109, 32, 32), (1024, 1, 32), 0), out=buf133)
        del buf129
        del buf132
        buf134 = reinterpret_tensor(buf113, (4096, 32), (32, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf70, (4096, 32), (32, 1), 0), reinterpret_tensor(arg82_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf134)
        del arg82_1
        del arg83_1
        buf135 = reinterpret_tensor(buf109, (4096, 32), (32, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf70, (4096, 32), (32, 1), 0), reinterpret_tensor(arg84_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf135)
        del arg84_1
        del arg85_1
        buf136 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf70, (4096, 32), (32, 1), 0), reinterpret_tensor(arg80_1, (32, 1), (1, 32), 0), out=buf136)
        del arg80_1
        del buf70
        buf137 = reinterpret_tensor(buf136, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_48.run(buf137, arg81_1, 4096, grid=grid(4096), stream=stream0)
        del arg81_1
        buf138 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_49.run(buf108, buf133, buf134, buf135, buf137, buf138, 902144, grid=grid(902144), stream=stream0)
        del buf108
        del buf133
        del buf134
        del buf135
        # Topologically Sorted Source Nodes: [toks_3, index_add__11, index_add__10], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_50.run(arg61_1, arg59_1, buf126, arg60_1, buf139, buf142, 729088, grid=grid(729088), stream=stream0)
        del arg59_1
        del arg60_1
        del arg61_1
        del buf126
    return (buf138, reinterpret_tensor(buf137, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf139, (1, 4096, 32), (131072, 32, 1), 0), reinterpret_tensor(buf142, (1, 4096, 32), (131072, 32, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg51_1 = rand_strided((96, 32), (32, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg57_1 = rand_strided((32, 32), (32, 1), device='cuda:0', dtype=torch.float32)
