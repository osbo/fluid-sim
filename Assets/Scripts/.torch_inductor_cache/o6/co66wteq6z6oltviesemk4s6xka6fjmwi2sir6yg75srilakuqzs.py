...
#   %arg5_1 : Tensor "f32[7424][1]mps:0" = PlaceHolder[target=arg5_1]
#   %mul_3 : Tensor "f32[7424, 1][1, 7424]mps:0" = PlaceHolder[target=mul_3]
...
#   %sub : Tensor "f32[7424, 1][1, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg4_1, %mul_2), kwargs = {})
#   %view : Tensor "f32[7424, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%arg5_1, [-1, 1]), kwargs = {})
#   %mul_3 : Tensor "f32[7424, 1][1, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %view), kwargs = {})
#   %mul_4 : Tensor "f32[7424, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %mul_3), kwargs = {})
...
#   %mul_5 : Tensor "f32[7424, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg1_1, %div_1), kwargs = {})
#   %add_1 : Tensor "f32[7424, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_5, %mul_3), kwargs = {})
...
#   %copy__4 : Tensor "f32[7424, 1][1, 1]mps:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg6_1, %mul_3), kwargs = {})
...
def partition_0(args):
    ...
    assert_size_stride(arg5_1, (7424, ), (1, ))
    assert_size_stride(arg3_1, (7424, 1), (1, 1))
    assert_size_stride(arg6_1, (7424, 1), (1, 1))
    ...
    del arg0_1
    buf2 = empty_strided((7424, 1), (1, 7424), device='mps', dtype=torch.float32)
    buf12 = empty_strided((7424, 1), (1, 7424), device='mps', dtype=torch.float32)
    buf6 = empty_strided((7424, 1), (1, 7424), device='mps', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg5_1 = rand_strided((7424, ), (1, ), device='mps:0', dtype=torch.float32)
    arg6_1 = rand_strided((7424, 1), (1, 1), device='mps:0', dtype=torch.float32)
