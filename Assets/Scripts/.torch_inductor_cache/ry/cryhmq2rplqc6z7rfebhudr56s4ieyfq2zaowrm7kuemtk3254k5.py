...
#   %index_put_12 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_18, [%arg34_1], %index_6, True), kwargs = {})
...
#   %index_put_13 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_19, [%arg34_1], %index_7, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg44_1
        buf59 = reinterpret_tensor(buf54, (1, 512, 128), (65536, 128, 1), 0); del buf54  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf55, arg45_1, arg46_1, arg47_1, buf59, 512, 128, grid=grid(512), stream=stream0)
        del arg46_1
        del arg47_1
        buf60 = empty_strided_cuda((512, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (512, 128), (128, 1), 0), reinterpret_tensor(arg48_1, (128, 512), (1, 128), 0), out=buf60)
        del arg48_1
        buf61 = reinterpret_tensor(buf60, (1, 512, 512), (262144, 512, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf61, arg49_1, 262144, grid=grid(262144), stream=stream0)
        del arg49_1
        buf62 = reinterpret_tensor(buf59, (512, 128), (128, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf61, (512, 512), (512, 1), 0), reinterpret_tensor(arg50_1, (512, 128), (1, 512), 0), out=buf62)
        del arg50_1
        buf63 = reinterpret_tensor(buf62, (1, 512, 128), (65536, 128, 1), 0); del buf62  # reuse
        buf113 = reinterpret_tensor(buf48, (1, 512, 128), (65536, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_23.run(buf63, buf25, buf55, arg45_1, arg51_1, arg68_1, arg69_1, buf113, 512, 128, grid=grid(512), stream=stream0)
        del arg45_1
        del arg51_1
        del arg68_1
        del arg69_1
        buf64 = reinterpret_tensor(buf34, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf64, 196608, grid=grid(196608), stream=stream0)
        ...
        buf93 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf93, 196608, grid=grid(196608), stream=stream0)
        buf95 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf95, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_17, index_add__4, col_sum_1, getitem_18, index_add__5, row_sum, getitem_8, index_add__2, col_sum, getitem_9, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_25.run(arg34_1, arg32_1, buf63, arg33_1, buf25, buf64, buf66, buf93, buf95, 270336, grid=grid(270336), stream=stream0)
        buf75 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_26.run(buf64, arg35_1, buf66, arg52_1, arg53_1, buf75, 1536, 128, grid=grid(1536), stream=stream0)
        del arg52_1
        del arg53_1
        buf71 = empty_strided_cuda((48, 1, 32), (32, 1536, 1), torch.float32)
        buf72 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_27.run(arg31_1, buf71, buf72, 1536, 32, grid=grid(1536), stream=stream0)
        buf73 = buf71; del buf71  # reuse
        # Topologically Sorted Source Nodes: [lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_poi_fused__to_copy_copy_lt_maximum_28.run(buf73, arg31_1, buf72, 1536, grid=grid(1536), stream=stream0)
        buf76 = empty_strided_cuda((1536, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf75, (1536, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf76)
        buf77 = empty_strided_cuda((48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf76, arg55_1, buf77, 196608, grid=grid(196608), stream=stream0)
        buf78 = empty_strided_cuda((48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf76, arg55_1, buf78, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf79 = empty_strided_cuda((384, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf77, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf78, (384, 16, 32), (512, 32, 1), 0), out=buf79)
        buf80 = reinterpret_tensor(buf78, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(arg30_1, buf80, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_32.run(buf80, 6144, grid=grid(6144), stream=stream0)
        buf82 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf80, buf82, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf82, 1536, grid=grid(1536), stream=stream0)
        buf85 = empty_strided_cuda((48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(buf72, buf79, buf82, buf80, buf85, 12288, 32, grid=grid(12288), stream=stream0)
        buf86 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf85, buf86, 12288, 32, grid=grid(12288), stream=stream0)
        buf87 = reinterpret_tensor(buf77, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf82, buf80, buf87, 196608, grid=grid(196608), stream=stream0)
        buf88 = reinterpret_tensor(buf79, (49152, 8), (8, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf87, (49152, 4), (4, 1), 0), reinterpret_tensor(arg56_1, (4, 8), (1, 4), 0), out=buf88)
        del arg56_1
        buf89 = reinterpret_tensor(buf85, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf89, buf86, buf72, buf88, arg57_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg57_1
        buf90 = reinterpret_tensor(buf87, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf76, arg55_1, buf90, 196608, grid=grid(196608), stream=stream0)
        buf91 = reinterpret_tensor(buf80, (384, 32, 16), (512, 16, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf89, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf90, (384, 32, 16), (512, 16, 1), 0), out=buf91)
        del buf90
        buf92 = reinterpret_tensor(buf86, (1536, 8), (8, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf75, (1536, 128), (128, 1), 0), reinterpret_tensor(arg58_1, (128, 8), (1, 128), 0), out=buf92)
        del arg58_1
        del buf75
        buf97 = reinterpret_tensor(buf53, (48, 1, 1, 128), (128, 6144, 6144, 1), 0); del buf53  # reuse
        buf98 = reinterpret_tensor(buf97, (48, 1, 1, 128), (128, 1, 6144, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_40.run(buf98, buf93, arg35_1, buf95, 6144, 32, grid=grid(6144), stream=stream0)
        buf99 = empty_strided_cuda((48, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (48, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf99)
        del arg54_1
        buf100 = reinterpret_tensor(buf95, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [mul_5, x_mid_3, x_out_3], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_41.run(buf91, buf92, arg59_1, buf99, arg55_1, buf100, 196608, grid=grid(196608), stream=stream0)
        del arg55_1
        del arg59_1
        buf101 = reinterpret_tensor(buf91, (1536, 128), (128, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf100, (1536, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 128), (1, 128), 0), out=buf101)
        del arg60_1
        buf102 = reinterpret_tensor(buf101, (48, 32, 128), (4096, 128, 1), 0); del buf101  # reuse
        buf146 = reinterpret_tensor(buf100, (48, 32, 128), (4096, 128, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf102, buf64, arg35_1, buf66, arg61_1, arg62_1, arg63_1, buf146, 1536, 128, grid=grid(1536), stream=stream0)
        del arg61_1
        del arg62_1
        del arg63_1
        buf109 = buf31; del buf31  # reuse
        buf110 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [mask_base_4, sum_3], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_7.run(arg29_1, buf109, buf110, 512, 32, grid=grid(512), stream=stream0)
        ...
        triton_poi_fused__to_copy_copy_lt_maximum_8.run(buf111, arg29_1, buf110, 512, grid=grid(512), stream=stream0)
        del arg29_1
        buf114 = reinterpret_tensor(buf66, (512, 384), (384, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf113, (512, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 384), (1, 128), 0), out=buf114)
        buf115 = reinterpret_tensor(buf25, (16, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf114, arg71_1, buf115, 65536, grid=grid(65536), stream=stream0)
        buf116 = reinterpret_tensor(buf55, (16, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf55  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf114, arg71_1, buf116, 2048, 32, grid=grid(2048, 32), stream=stream0)
        buf117 = reinterpret_tensor(buf47, (128, 32, 32), (1024, 32, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf115, (128, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf116, (128, 16, 32), (512, 32, 1), 0), out=buf117)
        buf118 = reinterpret_tensor(buf116, (1, 16, 32, 32, 4), (65536, 4096, 128, 4, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_11.run(arg28_1, buf118, 65536, grid=grid(65536), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_2, setitem_4], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_12.run(buf118, 2048, grid=grid(2048), stream=stream0)
        buf120 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf118, buf120, 16384, grid=grid(16384), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf120, 512, grid=grid(512), stream=stream0)
        buf123 = reinterpret_tensor(buf46, (1, 16, 32, 32, 8), (131072, 8192, 32, 1, 1024), 0); del buf46  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_15.run(buf110, buf117, buf120, buf118, buf123, 4096, 32, grid=grid(4096), stream=stream0)
        buf124 = reinterpret_tensor(buf50, (1, 16, 32, 1, 8), (4096, 256, 8, 4096, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_per_fused__softmax_16.run(buf123, buf124, 4096, 32, grid=grid(4096), stream=stream0)
        buf125 = reinterpret_tensor(buf115, (1, 16, 32, 32, 4), (65536, 4096, 128, 4, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf120, buf118, buf125, 65536, grid=grid(65536), stream=stream0)
        buf126 = reinterpret_tensor(buf117, (16384, 8), (8, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf125, (16384, 4), (4, 1), 0), reinterpret_tensor(arg72_1, (4, 8), (1, 4), 0), out=buf126)
        del arg72_1
        buf127 = reinterpret_tensor(buf123, (16, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf127, buf124, buf110, buf126, arg73_1, 128, 1024, grid=grid(128, 1024), stream=stream0)
        del arg73_1
        del buf126
        buf128 = reinterpret_tensor(buf125, (16, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf114, arg71_1, buf128, 65536, grid=grid(65536), stream=stream0)
        buf129 = reinterpret_tensor(buf118, (128, 32, 16), (512, 16, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf127, (128, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf128, (128, 32, 16), (512, 16, 1), 0), out=buf129)
        del buf127
        del buf128
        buf130 = reinterpret_tensor(buf124, (512, 8), (8, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf113, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 8), (1, 128), 0), out=buf130)
        del arg74_1
        buf131 = empty_strided_cuda((16, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf52, (16, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 384), (1, 128), 0), out=buf131)
        del arg70_1
        del buf52
        buf132 = reinterpret_tensor(buf113, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [mul_7, x_mid_5, x_out_6], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_21.run(buf129, buf130, arg75_1, buf131, arg71_1, buf132, 65536, grid=grid(65536), stream=stream0)
        del arg71_1
        del arg75_1
        del buf130
        del buf131
        buf133 = reinterpret_tensor(buf129, (512, 128), (128, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf132, (512, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 128), (1, 128), 0), out=buf133)
        del arg76_1
        buf137 = reinterpret_tensor(buf132, (1, 512, 128), (65536, 128, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf63, buf133, arg77_1, arg78_1, arg79_1, buf137, 512, 128, grid=grid(512), stream=stream0)
        del arg78_1
        del arg79_1
        buf138 = reinterpret_tensor(buf61, (512, 512), (512, 1), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf137, (512, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 512), (1, 128), 0), out=buf138)
        del arg80_1
        buf139 = reinterpret_tensor(buf138, (1, 512, 512), (262144, 512, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf139, arg81_1, 262144, grid=grid(262144), stream=stream0)
        del arg81_1
        buf140 = reinterpret_tensor(buf137, (512, 128), (128, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (512, 512), (512, 1), 0), reinterpret_tensor(arg82_1, (512, 128), (1, 512), 0), out=buf140)
        del arg82_1
        del buf139
        buf141 = reinterpret_tensor(buf140, (1, 512, 128), (65536, 128, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf141, buf63, buf133, arg77_1, arg83_1, 65536, grid=grid(65536), stream=stream0)
        del arg77_1
        del arg83_1
        del buf133
        del buf63
        buf142 = reinterpret_tensor(buf114, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf142, 196608, grid=grid(196608), stream=stream0)
        buf144 = buf64; del buf64  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf144, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_33, index_add__6, col_sum_2, getitem_34, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_44.run(arg34_1, arg32_1, buf141, arg33_1, buf142, buf144, 270336, grid=grid(270336), stream=stream0)
        del arg32_1
        del arg33_1
        del arg34_1
        buf147 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf146, (1536, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 512), (1, 128), 0), out=buf147)
        del arg64_1
        buf148 = reinterpret_tensor(buf147, (48, 32, 512), (16384, 512, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf148, arg65_1, 786432, grid=grid(786432), stream=stream0)
        del arg65_1
        buf149 = reinterpret_tensor(buf146, (1536, 128), (128, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf148, (1536, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 128), (1, 512), 0), out=buf149)
        del arg66_1
        buf150 = reinterpret_tensor(buf149, (48, 32, 128), (4096, 128, 1), 0); del buf149  # reuse
        buf158 = reinterpret_tensor(buf93, (48, 32, 128), (4096, 128, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_46.run(buf150, buf142, arg35_1, buf144, buf102, arg67_1, arg84_1, arg85_1, buf158, 1536, 128, grid=grid(1536), stream=stream0)
        del arg35_1
        del arg67_1
        del arg84_1
        del arg85_1
        del buf102
        buf154 = buf73; del buf73  # reuse
        buf155 = buf72; del buf72  # reuse
        # Topologically Sorted Source Nodes: [mask_base_5, sum_4], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_27.run(arg31_1, buf154, buf155, 1536, 32, grid=grid(1536), stream=stream0)
        ...
        triton_poi_fused__to_copy_copy_lt_maximum_28.run(buf156, arg31_1, buf155, 1536, grid=grid(1536), stream=stream0)
        del arg31_1
        del buf156
        buf159 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (1536, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf159)
        buf160 = reinterpret_tensor(buf144, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_29.run(buf159, arg87_1, buf160, 196608, grid=grid(196608), stream=stream0)
        buf161 = reinterpret_tensor(buf142, (48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf159, arg87_1, buf161, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf162 = reinterpret_tensor(buf89, (384, 32, 32), (1024, 32, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf160, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf161, (384, 16, 32), (512, 32, 1), 0), out=buf162)
        buf163 = reinterpret_tensor(buf161, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(arg30_1, buf163, 196608, grid=grid(196608), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_32.run(buf163, 6144, grid=grid(6144), stream=stream0)
        buf165 = buf82; del buf82  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf163, buf165, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf165, 1536, grid=grid(1536), stream=stream0)
        buf168 = reinterpret_tensor(buf88, (48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), 0); del buf88  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_35.run(buf155, buf162, buf165, buf163, buf168, 12288, 32, grid=grid(12288), stream=stream0)
        buf169 = reinterpret_tensor(buf92, (48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_36.run(buf168, buf169, 12288, 32, grid=grid(12288), stream=stream0)
        buf170 = reinterpret_tensor(buf160, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf165, buf163, buf170, 196608, grid=grid(196608), stream=stream0)
        buf171 = reinterpret_tensor(buf162, (49152, 8), (8, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (49152, 4), (4, 1), 0), reinterpret_tensor(arg88_1, (4, 8), (1, 4), 0), out=buf171)
        del arg88_1
        buf172 = reinterpret_tensor(buf168, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf172, buf169, buf155, buf171, arg89_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg89_1
        del buf171
        buf173 = reinterpret_tensor(buf170, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf159, arg87_1, buf173, 196608, grid=grid(196608), stream=stream0)
        del buf159
        buf174 = reinterpret_tensor(buf163, (384, 32, 16), (512, 16, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf172, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf173, (384, 32, 16), (512, 16, 1), 0), out=buf174)
        del buf172
        del buf173
        buf175 = reinterpret_tensor(buf169, (1536, 8), (8, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (1536, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 8), (1, 128), 0), out=buf175)
        del arg90_1
        buf176 = buf99; del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (48, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf176)
        del arg86_1
        del buf98
        buf177 = reinterpret_tensor(buf158, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [mul_9, x_mid_7, x_out_9], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_41.run(buf174, buf175, arg91_1, buf176, arg87_1, buf177, 196608, grid=grid(196608), stream=stream0)
        del arg87_1
        del arg91_1
        del buf175
        del buf176
        buf178 = reinterpret_tensor(buf174, (1536, 128), (128, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf177, (1536, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 128), (1, 128), 0), out=buf178)
        del arg92_1
        buf184 = reinterpret_tensor(buf177, (48, 32, 128), (4096, 128, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_47.run(buf150, buf178, arg93_1, arg94_1, arg95_1, buf184, 1536, 128, grid=grid(1536), stream=stream0)
        del arg94_1
        del arg95_1
        buf182 = reinterpret_tensor(buf110, (512, 32), (32, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf141, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf182)
        del arg100_1
        del arg101_1
        buf183 = reinterpret_tensor(buf120, (16, 32, 32), (1024, 32, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf182, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf182, (16, 32, 32), (1024, 1, 32), 0), out=buf183)
        buf185 = reinterpret_tensor(buf148, (1536, 512), (512, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf184, (1536, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 512), (1, 128), 0), out=buf185)
        del arg96_1
        buf186 = reinterpret_tensor(buf185, (48, 32, 512), (16384, 512, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf186, arg97_1, 786432, grid=grid(786432), stream=stream0)
        del arg97_1
        buf187 = reinterpret_tensor(buf184, (1536, 128), (128, 1), 0); del buf184  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf186, (1536, 512), (512, 1), 0), reinterpret_tensor(arg98_1, (512, 128), (1, 512), 0), out=buf187)
        del arg98_1
        del buf186
        buf188 = reinterpret_tensor(buf187, (48, 32, 128), (4096, 128, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf188, buf150, buf178, arg93_1, arg99_1, 196608, grid=grid(196608), stream=stream0)
        del arg93_1
        del arg99_1
        del buf150
        del buf178
        buf189 = reinterpret_tensor(buf155, (1536, 32), (32, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf188, (1536, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf189)
        del arg102_1
        del arg103_1
        buf190 = reinterpret_tensor(buf165, (1536, 32), (32, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg105_1, reinterpret_tensor(buf188, (1536, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf190)
        del arg104_1
        del arg105_1
        del buf188
        buf191 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf189, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf190, (48, 32, 32), (1024, 1, 32), 0), out=buf191)
        del buf189
        del buf190
        buf192 = buf182; del buf182  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf141, (512, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf192)
        del arg108_1
        del arg109_1
        buf193 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf141, (512, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf193)
        del arg110_1
        del arg111_1
        buf194 = reinterpret_tensor(buf111, (512, 1), (1, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (512, 128), (128, 1), 0), reinterpret_tensor(arg106_1, (128, 1), (1, 128), 0), out=buf194)
        del arg106_1
        del buf141
        buf195 = reinterpret_tensor(buf194, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf194  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_49.run(buf195, arg107_1, 512, grid=grid(512), stream=stream0)
        del arg107_1
        buf196 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_50.run(buf183, buf191, buf192, buf193, buf195, buf196, 98816, grid=grid(98816), stream=stream0)
        del buf183
        del buf191
        del buf192
        del buf193
    return (buf196, reinterpret_tensor(buf195, (1, 16, 32), (512, 32, 1), 0), )
