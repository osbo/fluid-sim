...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg42_1
        buf101 = reinterpret_tensor(buf52, (1, 4128, 128), (528384, 128, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_22.run(buf29, buf53, arg43_1, arg44_1, arg45_1, buf101, 4128, 128, grid=grid(4128), stream=stream0)
        del arg44_1
        del arg45_1
        buf57 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf57.copy_(arg34_1)
        del arg34_1
        buf58 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf58.copy_(arg32_1)
        del arg32_1
        ...
        buf61 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf61.copy_(arg33_1)
        del arg33_1
        buf62 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf62, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum, getitem_12, index_add__2, col_sum, getitem_13, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_24.run(buf57, buf58, buf25, buf61, buf59, buf62, 2916352, grid=grid(2916352), stream=stream0)
        buf64 = empty_strided_cuda((109, 64, 128), (8192, 128, 1), torch.float32)
        buf68 = empty_strided_cuda((1, 109, 65, 128), (906880, 8320, 128, 1), torch.float32)
        buf66 = reinterpret_tensor(buf68, (1, 109, 64, 128), (906880, 8320, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [h_off_base_1, cat_6], Original ATen: [aten.mean, aten.cat]
        triton_poi_fused_cat_mean_25.run(buf59, arg35_1, buf62, buf64, buf66, 892928, grid=grid(892928), stream=stream0)
        del arg35_1
        buf67 = reinterpret_tensor(buf68, (1, 109, 1, 128), (906880, 8320, 128, 1), 8192)  # alias
        # Topologically Sorted Source Nodes: [bn_off], Original ATen: [aten.mean]
        triton_per_fused_mean_26.run(buf64, buf67, 13952, 64, grid=grid(13952), stream=stream0)
        del buf64
        buf69 = empty_strided_cuda((109, 65, 1), (65, 1, 7104), torch.float32)
        buf70 = empty_strided_cuda((109, 65, 1), (65, 1, 7104), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_27.run(buf68, buf69, buf70, 7085, 128, grid=grid(7085), stream=stream0)
        del buf66
        del buf67
        buf72 = empty_strided_cuda((109, 64, 65, 4), (16640, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_28.run(arg30_1, buf72, 1813760, grid=grid(1813760), stream=stream0)
        del arg30_1
        buf73 = empty_strided_cuda((109, 64, 65), (4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.cat]
        triton_poi_fused_cat_29.run(arg31_1, buf73, 453440, grid=grid(453440), stream=stream0)
        del arg31_1
        buf74 = reinterpret_tensor(buf62, (109, 128, 128), (16384, 128, 1), 0); del buf62  # reuse
        buf79 = empty_strided_cuda((109, 2, 65, 128), (16640, 8320, 128, 1), torch.float32)
        buf77 = reinterpret_tensor(buf79, (109, 2, 64, 128), (16640, 8320, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_3, x_2, kv_1], Original ATen: [aten.native_layer_norm, aten.constant_pad_nd, aten.cat]
        triton_poi_fused_cat_constant_pad_nd_native_layer_norm_30.run(buf68, buf69, buf70, arg50_1, arg51_1, buf74, buf77, 1785856, grid=grid(1785856), stream=stream0)
        del arg50_1
        del arg51_1
        buf75 = empty_strided_cuda((13952, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf74, (13952, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf75)
        buf78 = reinterpret_tensor(buf79, (109, 2, 1, 128), (16640, 8320, 128, 1), 8192)  # alias
        # Topologically Sorted Source Nodes: [block_node], Original ATen: [aten.mean]
        triton_per_fused_mean_31.run(buf74, buf78, 27904, 64, grid=grid(27904), stream=stream0)
        del buf77
        del buf78
        buf80 = empty_strided_cuda((14170, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf79, (14170, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf80)
        del arg52_1
        buf81 = reinterpret_tensor(buf74, (109, 2, 8, 64, 16, 1), (16384, 8192, 1024, 16, 1, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf75, arg53_1, buf81, 1785856, grid=grid(1785856), stream=stream0)
        buf82 = empty_strided_cuda((109, 2, 8, 16, 65, 1), (16896, 8448, 1056, 65, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf80, arg53_1, buf82, 27904, 65, grid=grid(27904, 65), stream=stream0)
        buf83 = empty_strided_cuda((1744, 64, 65), (4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf81, (1744, 64, 16), (1024, 16, 1), 0), reinterpret_tensor(buf82, (1744, 16, 65), (1056, 65, 1), 0), out=buf83)
        buf84 = reinterpret_tensor(buf79, (109, 1, 64, 65, 4), (16640, 1813760, 260, 4, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [setitem_2, setitem_3], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_34.run(buf72, buf84, 1813760, grid=grid(1813760), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_2, setitem_3, setitem_4], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_35.run(buf84, 27904, grid=grid(27904), stream=stream0)
        buf86 = empty_strided_cuda((109, 1, 64, 65), (4160, 4160, 65, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_36.run(buf84, buf86, 453440, grid=grid(453440), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_37.run(buf86, 6976, grid=grid(6976), stream=stream0)
        buf89 = empty_strided_cuda((109, 2, 64, 65, 8), (66560, 33280, 65, 1, 4160), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_red_fused__softmax_add_eq_masked_fill_mul_38.run(buf73, buf83, buf86, buf84, buf89, 111616, 65, grid=grid(111616), stream=stream0)
        buf90 = empty_strided_cuda((109, 2, 64, 1, 8), (1024, 512, 8, 111616, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_red_fused__softmax_39.run(buf89, buf90, 111616, 65, grid=grid(111616), stream=stream0)
        buf91 = empty_strided_cuda((109, 1, 64, 65, 4), (16640, 1, 260, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_40.run(buf86, buf84, buf91, 1813760, grid=grid(1813760), stream=stream0)
        del buf84
        buf92 = empty_strided_cuda((453440, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf91, (453440, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 8), (1, 4), 0), out=buf92)
        del arg54_1
        buf93 = reinterpret_tensor(buf89, (109, 2, 8, 64, 65, 1), (66560, 33280, 4160, 65, 1, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_41.run(buf93, buf90, buf73, buf92, arg55_1, 1744, 4160, grid=grid(1744, 4160), stream=stream0)
        del arg55_1
        buf94 = reinterpret_tensor(buf82, (109, 2, 8, 65, 16, 1), (16896, 8448, 1056, 16, 1, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_42.run(buf80, arg53_1, buf94, 1813760, grid=grid(1813760), stream=stream0)
        del arg53_1
        buf95 = reinterpret_tensor(buf81, (1744, 64, 16), (1024, 16, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf93, (1744, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf94, (1744, 65, 16), (1056, 16, 1), 0), out=buf95)
        buf96 = reinterpret_tensor(buf59, (109, 2, 64, 8, 16), (16384, 8192, 128, 16, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_43.run(buf95, buf96, 1785856, grid=grid(1785856), stream=stream0)
        buf97 = reinterpret_tensor(buf95, (13952, 128), (128, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (13952, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 128), (1, 128), 0), out=buf97)
        del arg56_1
        buf106 = empty_strided_cuda((109, 65, 128), (8320, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_3, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_44.run(buf68, buf97, arg57_1, arg58_1, arg59_1, buf106, 7085, 128, grid=grid(7085), stream=stream0)
        del arg58_1
        del arg59_1
        buf102 = empty_strided_cuda((4128, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (4128, 128), (128, 1), 0), reinterpret_tensor(arg46_1, (128, 512), (1, 128), 0), out=buf102)
        del arg46_1
        buf103 = reinterpret_tensor(buf102, (1, 4128, 512), (2113536, 512, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf103, arg47_1, 2113536, grid=grid(2113536), stream=stream0)
        del arg47_1
        buf104 = reinterpret_tensor(buf101, (4128, 128), (128, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (4128, 512), (512, 1), 0), reinterpret_tensor(arg48_1, (512, 128), (1, 512), 0), out=buf104)
        del arg48_1
        buf105 = reinterpret_tensor(buf104, (1, 4128, 128), (528384, 128, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.add]
        triton_poi_fused_add_46.run(buf105, buf29, buf53, arg43_1, arg49_1, 528384, grid=grid(528384), stream=stream0)
        del arg43_1
        del arg49_1
        buf107 = reinterpret_tensor(buf92, (7085, 512), (512, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf106, (7085, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf107)
        del arg60_1
        buf108 = reinterpret_tensor(buf107, (109, 65, 512), (33280, 512, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf108, arg61_1, 3627520, grid=grid(3627520), stream=stream0)
        del arg61_1
        buf109 = reinterpret_tensor(buf106, (7085, 128), (128, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf108, (7085, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf109)
        del arg62_1
        buf110 = reinterpret_tensor(buf109, (109, 65, 128), (8320, 128, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [x_3, x_4], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf110, buf68, buf97, arg57_1, arg63_1, 906880, grid=grid(906880), stream=stream0)
        del arg57_1
        del arg63_1
        buf113 = empty_strided_cuda((1, 141, 128), (18048, 128, 1), torch.float32)
        buf111 = reinterpret_tensor(buf113, (1, 32, 128), (18048, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [V], Original ATen: [aten.cat]
        triton_poi_fused_cat_49.run(buf105, buf111, 4096, grid=grid(4096), stream=stream0)
        buf112 = reinterpret_tensor(buf113, (1, 109, 128), (18048, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [V], Original ATen: [aten.cat]
        triton_poi_fused_cat_50.run(buf110, buf112, 13952, grid=grid(13952), stream=stream0)
        del buf111
        del buf112
        buf114 = empty_strided_cuda((1, 141, 128), (18048, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [msg], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf113, out=buf114)
        buf115 = empty_strided_cuda((141, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (141, 128), (128, 1), 0), reinterpret_tensor(arg65_1, (128, 128), (1, 128), 0), out=buf115)
        del arg65_1
        buf116 = reinterpret_tensor(buf115, (1, 141, 128), (18048, 128, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf116, arg66_1, 18048, grid=grid(18048), stream=stream0)
        del arg66_1
        buf117 = reinterpret_tensor(buf114, (141, 128), (128, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (141, 128), (128, 1), 0), reinterpret_tensor(arg67_1, (128, 128), (1, 128), 0), out=buf117)
        del arg67_1
        buf118 = reinterpret_tensor(buf117, (1, 141, 128), (18048, 128, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [V_1], Original ATen: [aten.add]
        triton_poi_fused_add_52.run(buf118, buf113, arg68_1, 18048, grid=grid(18048), stream=stream0)
        del arg68_1
        buf119 = buf113; del buf113  # reuse
        # Topologically Sorted Source Nodes: [V_1, msg_1], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf118, out=buf119)
        buf120 = reinterpret_tensor(buf116, (141, 128), (128, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (141, 128), (128, 1), 0), reinterpret_tensor(arg69_1, (128, 128), (1, 128), 0), out=buf120)
        del arg69_1
        buf121 = reinterpret_tensor(buf120, (1, 141, 128), (18048, 128, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf121, arg70_1, 18048, grid=grid(18048), stream=stream0)
        del arg70_1
        buf122 = reinterpret_tensor(buf119, (141, 128), (128, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (141, 128), (128, 1), 0), reinterpret_tensor(arg71_1, (128, 128), (1, 128), 0), out=buf122)
        del arg71_1
        buf123 = buf118; del buf118  # reuse
        # Topologically Sorted Source Nodes: [V_2], Original ATen: [aten.add]
        triton_poi_fused_add_53.run(buf123, buf122, arg72_1, 18048, grid=grid(18048), stream=stream0)
        del arg72_1
        buf124 = reinterpret_tensor(buf122, (1, 141, 128), (18048, 128, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [V_2, msg_2], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf123, out=buf124)
        buf125 = reinterpret_tensor(buf121, (141, 128), (128, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (141, 128), (128, 1), 0), reinterpret_tensor(arg73_1, (128, 128), (1, 128), 0), out=buf125)
        del arg73_1
        buf126 = reinterpret_tensor(buf125, (1, 141, 128), (18048, 128, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf126, arg74_1, 18048, grid=grid(18048), stream=stream0)
        del arg74_1
        buf127 = reinterpret_tensor(buf124, (141, 128), (128, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (141, 128), (128, 1), 0), reinterpret_tensor(arg75_1, (128, 128), (1, 128), 0), out=buf127)
        del arg75_1
        buf128 = buf123; del buf123  # reuse
        # Topologically Sorted Source Nodes: [V_3], Original ATen: [aten.add]
        triton_poi_fused_add_53.run(buf128, buf127, arg76_1, 18048, grid=grid(18048), stream=stream0)
        del arg76_1
        buf129 = reinterpret_tensor(buf127, (1, 141, 128), (18048, 128, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [V_3, msg_3], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf128, out=buf129)
        buf130 = reinterpret_tensor(buf126, (141, 128), (128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf129, (141, 128), (128, 1), 0), reinterpret_tensor(arg77_1, (128, 128), (1, 128), 0), out=buf130)
        del arg77_1
        buf131 = reinterpret_tensor(buf130, (1, 141, 128), (18048, 128, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf131, arg78_1, 18048, grid=grid(18048), stream=stream0)
        del arg78_1
        buf132 = reinterpret_tensor(buf129, (141, 128), (128, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf131, (141, 128), (128, 1), 0), reinterpret_tensor(arg79_1, (128, 128), (1, 128), 0), out=buf132)
        del arg79_1
        buf133 = buf128; del buf128  # reuse
        # Topologically Sorted Source Nodes: [V_4], Original ATen: [aten.add]
        triton_poi_fused_add_53.run(buf133, buf132, arg80_1, 18048, grid=grid(18048), stream=stream0)
        del arg80_1
        buf134 = reinterpret_tensor(buf132, (1, 141, 128), (18048, 128, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [V_4, msg_4], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf133, out=buf134)
        buf135 = reinterpret_tensor(buf131, (141, 128), (128, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (141, 128), (128, 1), 0), reinterpret_tensor(arg81_1, (128, 128), (1, 128), 0), out=buf135)
        del arg81_1
        buf136 = reinterpret_tensor(buf135, (1, 141, 128), (18048, 128, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf136, arg82_1, 18048, grid=grid(18048), stream=stream0)
        del arg82_1
        buf137 = reinterpret_tensor(buf134, (141, 128), (128, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (141, 128), (128, 1), 0), reinterpret_tensor(arg83_1, (128, 128), (1, 128), 0), out=buf137)
        del arg83_1
        buf138 = buf133; del buf133  # reuse
        # Topologically Sorted Source Nodes: [V_5], Original ATen: [aten.add]
        triton_poi_fused_add_53.run(buf138, buf137, arg84_1, 18048, grid=grid(18048), stream=stream0)
        del arg84_1
        buf139 = reinterpret_tensor(buf137, (1, 141, 128), (18048, 128, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [V_5, msg_5], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf138, out=buf139)
        buf140 = reinterpret_tensor(buf136, (141, 128), (128, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (141, 128), (128, 1), 0), reinterpret_tensor(arg85_1, (128, 128), (1, 128), 0), out=buf140)
        del arg85_1
        buf141 = reinterpret_tensor(buf140, (1, 141, 128), (18048, 128, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf141, arg86_1, 18048, grid=grid(18048), stream=stream0)
        del arg86_1
        buf142 = reinterpret_tensor(buf139, (141, 128), (128, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (141, 128), (128, 1), 0), reinterpret_tensor(arg87_1, (128, 128), (1, 128), 0), out=buf142)
        del arg87_1
        buf143 = buf138; del buf138  # reuse
        # Topologically Sorted Source Nodes: [V_6], Original ATen: [aten.add]
        triton_poi_fused_add_53.run(buf143, buf142, arg88_1, 18048, grid=grid(18048), stream=stream0)
        del arg88_1
        buf144 = reinterpret_tensor(buf142, (1, 141, 128), (18048, 128, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [V_6, msg_6], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf143, out=buf144)
        buf145 = reinterpret_tensor(buf141, (141, 128), (128, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf144, (141, 128), (128, 1), 0), reinterpret_tensor(arg89_1, (128, 128), (1, 128), 0), out=buf145)
        del arg89_1
        buf146 = reinterpret_tensor(buf145, (1, 141, 128), (18048, 128, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [input_35], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf146, arg90_1, 18048, grid=grid(18048), stream=stream0)
        del arg90_1
        buf147 = reinterpret_tensor(buf144, (141, 128), (128, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf146, (141, 128), (128, 1), 0), reinterpret_tensor(arg91_1, (128, 128), (1, 128), 0), out=buf147)
        del arg91_1
        buf148 = buf143; del buf143  # reuse
        # Topologically Sorted Source Nodes: [V_7], Original ATen: [aten.add]
        triton_poi_fused_add_53.run(buf148, buf147, arg92_1, 18048, grid=grid(18048), stream=stream0)
        del arg92_1
        buf149 = reinterpret_tensor(buf147, (1, 141, 128), (18048, 128, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [V_7, msg_7], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf148, out=buf149)
        buf150 = reinterpret_tensor(buf146, (141, 128), (128, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf149, (141, 128), (128, 1), 0), reinterpret_tensor(arg93_1, (128, 128), (1, 128), 0), out=buf150)
        del arg93_1
        buf151 = reinterpret_tensor(buf150, (1, 141, 128), (18048, 128, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [input_38], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf151, arg94_1, 18048, grid=grid(18048), stream=stream0)
        del arg94_1
        buf152 = reinterpret_tensor(buf149, (141, 128), (128, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf151, (141, 128), (128, 1), 0), reinterpret_tensor(arg95_1, (128, 128), (1, 128), 0), out=buf152)
        del arg95_1
        buf153 = buf148; del buf148  # reuse
        # Topologically Sorted Source Nodes: [V_8], Original ATen: [aten.add]
        triton_poi_fused_add_53.run(buf153, buf152, arg96_1, 18048, grid=grid(18048), stream=stream0)
        del arg96_1
        buf154 = reinterpret_tensor(buf152, (1, 141, 128), (18048, 128, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [V_8, msg_8], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf153, out=buf154)
        buf155 = reinterpret_tensor(buf151, (141, 128), (128, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf154, (141, 128), (128, 1), 0), reinterpret_tensor(arg97_1, (128, 128), (1, 128), 0), out=buf155)
        del arg97_1
        buf156 = reinterpret_tensor(buf155, (1, 141, 128), (18048, 128, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [input_41], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf156, arg98_1, 18048, grid=grid(18048), stream=stream0)
        del arg98_1
        buf157 = reinterpret_tensor(buf154, (141, 128), (128, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (141, 128), (128, 1), 0), reinterpret_tensor(arg99_1, (128, 128), (1, 128), 0), out=buf157)
        del arg99_1
        buf158 = buf153; del buf153  # reuse
        # Topologically Sorted Source Nodes: [V_9], Original ATen: [aten.add]
        triton_poi_fused_add_53.run(buf158, buf157, arg100_1, 18048, grid=grid(18048), stream=stream0)
        del arg100_1
        buf159 = reinterpret_tensor(buf157, (1, 141, 128), (18048, 128, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [V_9, msg_9], Original ATen: [aten.add, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg64_1, (1, 141, 141), (0, 141, 1), 0), buf158, out=buf159)
        del arg64_1
        buf160 = reinterpret_tensor(buf156, (141, 128), (128, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (141, 128), (128, 1), 0), reinterpret_tensor(arg101_1, (128, 128), (1, 128), 0), out=buf160)
        del arg101_1
        buf161 = reinterpret_tensor(buf160, (1, 141, 128), (18048, 128, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_51.run(buf161, arg102_1, 18048, grid=grid(18048), stream=stream0)
        del arg102_1
        buf162 = reinterpret_tensor(buf159, (141, 128), (128, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (141, 128), (128, 1), 0), reinterpret_tensor(arg103_1, (128, 128), (1, 128), 0), out=buf162)
        del arg103_1
        buf166 = buf161; del buf161  # reuse
        # Topologically Sorted Source Nodes: [V_10, V_11], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_54.run(buf158, buf162, arg104_1, arg105_1, arg106_1, buf166, 141, 128, grid=grid(141), stream=stream0)
        del arg104_1
        del arg105_1
        del arg106_1
        del buf158
        del buf162
        buf170 = reinterpret_tensor(buf53, (1, 4128, 128), (528384, 128, 1), 0); del buf53  # reuse
        # Topologically Sorted Source Nodes: [layer_norm_6], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_55.run(buf166, buf105, arg107_1, arg108_1, buf170, 4128, 128, grid=grid(4128), stream=stream0)
        del arg107_1
        del arg108_1
        buf171 = buf35; del buf35  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (4128, 128), (128, 1), 0), reinterpret_tensor(arg109_1, (128, 384), (1, 128), 0), out=buf171)
        buf172 = buf34; del buf34  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf170, (4128, 128), (128, 1), 0), reinterpret_tensor(arg109_1, (128, 384), (1, 128), 0), out=buf172)
        del arg109_1
        buf173 = reinterpret_tensor(buf50, (32, 8, 129, 16, 1, 1), (16640, 2080, 16, 1, 1, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf171, arg110_1, buf173, 528384, grid=grid(528384), stream=stream0)
        del buf171
        buf174 = reinterpret_tensor(buf36, (32, 8, 16, 1, 129, 1), (16640, 2080, 129, 129, 1, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf172, arg110_1, buf174, 4096, 129, grid=grid(4096, 129), stream=stream0)
        buf175 = reinterpret_tensor(buf48, (256, 129, 129), (16641, 129, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf173, (256, 129, 16), (2080, 16, 1), 0), reinterpret_tensor(buf174, (256, 16, 129), (2080, 129, 1), 0), out=buf175)
        del buf173
        buf176 = buf46; del buf46  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_4], Original ATen: [aten.cat]
        triton_poi_fused_cat_11.run(arg28_1, buf176, 2130048, grid=grid(2130048), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_4, setitem_8], Original ATen: [aten.cat, aten.lift_fresh, aten.index_put]
        triton_poi_fused_cat_index_put_lift_fresh_12.run(buf176, 16384, grid=grid(16384), stream=stream0)
        buf178 = buf41; del buf41  # reuse
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf176, buf178, 532512, grid=grid(532512), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf178, 4096, grid=grid(4096), stream=stream0)
        buf181 = reinterpret_tensor(buf49, (1, 32, 129, 129, 8), (4268032, 133376, 129, 1, 16672), 0); del buf49  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_15.run(arg29_1, buf175, buf178, buf176, buf181, 33024, 129, grid=grid(33024), stream=stream0)
        buf182 = buf45; del buf45  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_red_fused__softmax_16.run(buf181, buf182, 33024, 129, grid=grid(33024), stream=stream0)
        buf183 = buf39; del buf39  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf178, buf176, buf183, 2130048, grid=grid(2130048), stream=stream0)
        del buf176
        del buf178
        buf184 = buf47; del buf47  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_18.run(buf183, buf184, 2130048, grid=grid(2130048), stream=stream0)
        del buf183
        buf185 = reinterpret_tensor(buf175, (532512, 8), (8, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf184, reinterpret_tensor(arg111_1, (4, 8), (1, 4), 0), out=buf185)
        del arg111_1
        del buf184
        buf186 = reinterpret_tensor(buf181, (32, 8, 129, 129, 1, 1), (133376, 16672, 129, 1, 1, 1), 0); del buf181  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf186, buf182, arg29_1, buf185, arg112_1, 256, 16641, grid=grid(256, 16641), stream=stream0)
        del arg112_1
        del arg29_1
        del buf182
        del buf185
        buf187 = reinterpret_tensor(buf174, (32, 8, 129, 1, 16, 1), (16640, 2080, 16, 16, 1, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_20.run(buf172, arg110_1, buf187, 528384, grid=grid(528384), stream=stream0)
        del arg110_1
        del buf172
        buf188 = reinterpret_tensor(buf170, (256, 129, 16), (2064, 16, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf186, (256, 129, 129), (16672, 129, 1), 0), reinterpret_tensor(buf187, (256, 129, 16), (2080, 16, 1), 0), out=buf188)
        del buf186
        del buf187
        buf189 = reinterpret_tensor(buf29, (1, 32, 129, 8, 16), (528384, 16512, 128, 16, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [x_out_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_21.run(buf188, buf189, 528384, grid=grid(528384), stream=stream0)
        buf190 = reinterpret_tensor(buf188, (4128, 128), (128, 1), 0); del buf188  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf189, (4128, 128), (128, 1), 0), reinterpret_tensor(arg113_1, (128, 128), (1, 128), 0), out=buf190)
        del arg113_1
        buf224 = reinterpret_tensor(buf189, (1, 4128, 128), (528384, 128, 1), 0); del buf189  # reuse
        # Topologically Sorted Source Nodes: [x_5, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_56.run(buf166, buf105, buf190, arg114_1, arg115_1, arg116_1, buf224, 4128, 128, grid=grid(4128), stream=stream0)
        del arg115_1
        del arg116_1
        buf194 = buf70; del buf70  # reuse
        buf195 = buf69; del buf69  # reuse
        # Topologically Sorted Source Nodes: [layer_norm_8], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_57.run(buf166, buf110, buf194, buf195, 7085, 128, grid=grid(7085), stream=stream0)
        buf197 = reinterpret_tensor(buf97, (109, 128, 128), (16384, 128, 1), 0); del buf97  # reuse
        buf202 = reinterpret_tensor(buf91, (109, 2, 65, 128), (16640, 8320, 128, 1), 0); del buf91  # reuse
        buf200 = reinterpret_tensor(buf202, (109, 2, 64, 128), (16640, 8320, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_8, x_7, kv_3], Original ATen: [aten.native_layer_norm, aten.constant_pad_nd, aten.cat]
        triton_poi_fused_cat_constant_pad_nd_native_layer_norm_58.run(buf166, buf110, buf194, buf195, arg121_1, arg122_1, buf197, buf200, 1785856, grid=grid(1785856), stream=stream0)
        del arg121_1
        del arg122_1
        del buf194
        del buf195
        buf198 = buf75; del buf75  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf197, (13952, 128), (128, 1), 0), reinterpret_tensor(arg123_1, (128, 384), (1, 128), 0), out=buf198)
        buf201 = reinterpret_tensor(buf202, (109, 2, 1, 128), (16640, 8320, 128, 1), 8192)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_per_fused_mean_31.run(buf197, buf201, 27904, 64, grid=grid(27904), stream=stream0)
        del buf200
        del buf201
        buf203 = buf80; del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf202, (14170, 128), (128, 1), 0), reinterpret_tensor(arg123_1, (128, 384), (1, 128), 0), out=buf203)
        del arg123_1
        buf204 = reinterpret_tensor(buf197, (109, 2, 8, 64, 16, 1), (16384, 8192, 1024, 16, 1, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf198, arg124_1, buf204, 1785856, grid=grid(1785856), stream=stream0)
        del buf198
        buf205 = reinterpret_tensor(buf94, (109, 2, 8, 16, 65, 1), (16896, 8448, 1056, 65, 1, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf203, arg124_1, buf205, 27904, 65, grid=grid(27904, 65), stream=stream0)
        buf206 = reinterpret_tensor(buf93, (1744, 64, 65), (4160, 65, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf204, (1744, 64, 16), (1024, 16, 1), 0), reinterpret_tensor(buf205, (1744, 16, 65), (1056, 65, 1), 0), out=buf206)
        buf207 = reinterpret_tensor(buf202, (109, 1, 64, 65, 4), (16640, 1813760, 260, 4, 1), 0); del buf202  # reuse
        # Topologically Sorted Source Nodes: [setitem_10, setitem_11], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_34.run(buf72, buf207, 1813760, grid=grid(1813760), stream=stream0)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_35.run(buf207, 27904, grid=grid(27904), stream=stream0)
        buf209 = buf86; del buf86  # reuse
        # Topologically Sorted Source Nodes: [setitem_13], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_36.run(buf207, buf209, 453440, grid=grid(453440), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_13], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_37.run(buf209, 6976, grid=grid(6976), stream=stream0)
        buf212 = reinterpret_tensor(buf83, (109, 2, 64, 65, 8), (66560, 33280, 65, 1, 4160), 0); del buf83  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_38.run(buf73, buf206, buf209, buf207, buf212, 111616, 65, grid=grid(111616), stream=stream0)
        del buf206
        buf213 = buf90; del buf90  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_red_fused__softmax_39.run(buf212, buf213, 111616, 65, grid=grid(111616), stream=stream0)
        buf214 = reinterpret_tensor(buf72, (109, 1, 64, 65, 4), (16640, 1, 260, 4, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_40.run(buf209, buf207, buf214, 1813760, grid=grid(1813760), stream=stream0)
        del buf207
        del buf209
        buf215 = reinterpret_tensor(buf108, (453440, 8), (8, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf214, (453440, 4), (4, 1), 0), reinterpret_tensor(arg125_1, (4, 8), (1, 4), 0), out=buf215)
        del arg125_1
        del buf214
        buf216 = reinterpret_tensor(buf212, (109, 2, 8, 64, 65, 1), (66560, 33280, 4160, 65, 1, 1), 0); del buf212  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_41.run(buf216, buf213, buf73, buf215, arg126_1, 1744, 4160, grid=grid(1744, 4160), stream=stream0)
        del arg126_1
        del buf213
        del buf73
        buf217 = reinterpret_tensor(buf205, (109, 2, 8, 65, 16, 1), (16896, 8448, 1056, 16, 1, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_42.run(buf203, arg124_1, buf217, 1813760, grid=grid(1813760), stream=stream0)
        del arg124_1
        del buf203
        buf218 = reinterpret_tensor(buf204, (1744, 64, 16), (1024, 16, 1), 0); del buf204  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf216, (1744, 64, 65), (4160, 65, 1), 0), reinterpret_tensor(buf217, (1744, 65, 16), (1056, 16, 1), 0), out=buf218)
        del buf216
        del buf217
        buf219 = buf96; del buf96  # reuse
        # Topologically Sorted Source Nodes: [x_out_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_43.run(buf218, buf219, 1785856, grid=grid(1785856), stream=stream0)
        buf220 = reinterpret_tensor(buf218, (13952, 128), (128, 1), 0); del buf218  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf219, (13952, 128), (128, 1), 0), reinterpret_tensor(arg127_1, (128, 128), (1, 128), 0), out=buf220)
        del arg127_1
        del buf219
        buf232 = reinterpret_tensor(buf68, (109, 65, 128), (8320, 128, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [x_8, layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_59.run(buf166, buf110, buf220, arg128_1, arg129_1, arg130_1, buf232, 7085, 128, grid=grid(7085), stream=stream0)
        del arg129_1
        del arg130_1
        buf225 = reinterpret_tensor(buf103, (4128, 512), (512, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf224, (4128, 128), (128, 1), 0), reinterpret_tensor(arg117_1, (128, 512), (1, 128), 0), out=buf225)
        del arg117_1
        buf226 = reinterpret_tensor(buf225, (1, 4128, 512), (2113536, 512, 1), 0); del buf225  # reuse
        # Topologically Sorted Source Nodes: [input_47], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_45.run(buf226, arg118_1, 2113536, grid=grid(2113536), stream=stream0)
        del arg118_1
        buf227 = reinterpret_tensor(buf224, (4128, 128), (128, 1), 0); del buf224  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf226, (4128, 512), (512, 1), 0), reinterpret_tensor(arg119_1, (512, 128), (1, 512), 0), out=buf227)
        del arg119_1
        del buf226
        buf228 = reinterpret_tensor(buf25, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [h_diag], Original ATen: [aten.clone]
        triton_poi_fused_clone_60.run(buf166, buf105, buf190, arg114_1, buf227, arg120_1, buf228, 524288, grid=grid(524288), stream=stream0)
        del arg114_1
        del arg120_1
        del buf105
        del buf190
        del buf227
        buf229 = reinterpret_tensor(buf24, (4096, 128), (128, 1), 0); del buf24  # reuse
        buf244 = buf12; del buf12  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        triton_poi_fused_addmm_61.run(buf228, buf229, buf244, 524288, grid=grid(524288), stream=stream0)
        buf230 = empty_strided_cuda((4096, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg136_1, buf229, reinterpret_tensor(arg135_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf230)
        del arg135_1
        del arg136_1
        buf231 = reinterpret_tensor(buf229, (32, 128, 128), (16384, 128, 1), 0); del buf229  # reuse
        # Topologically Sorted Source Nodes: [out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf230, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf230, (32, 128, 128), (16384, 1, 128), 0), out=buf231)
        del buf230
        buf233 = reinterpret_tensor(buf215, (7085, 512), (512, 1), 0); del buf215  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf232, (7085, 128), (128, 1), 0), reinterpret_tensor(arg131_1, (128, 512), (1, 128), 0), out=buf233)
        del arg131_1
        buf234 = reinterpret_tensor(buf233, (109, 65, 512), (33280, 512, 1), 0); del buf233  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf234, arg132_1, 3627520, grid=grid(3627520), stream=stream0)
        del arg132_1
        buf235 = reinterpret_tensor(buf232, (7085, 128), (128, 1), 0); del buf232  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf234, (7085, 512), (512, 1), 0), reinterpret_tensor(arg133_1, (512, 128), (1, 512), 0), out=buf235)
        del arg133_1
        del buf234
        buf236 = reinterpret_tensor(buf235, (109, 65, 128), (8320, 128, 1), 0); del buf235  # reuse
        # Topologically Sorted Source Nodes: [x_8, x_9], Original ATen: [aten.add]
        triton_poi_fused_add_62.run(buf236, buf166, buf110, buf220, arg128_1, arg134_1, 906880, grid=grid(906880), stream=stream0)
        del arg128_1
        del arg134_1
        del buf110
        del buf166
        del buf220
        buf237 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf236, (109, 64, 128), (8320, 128, 1), 0), reinterpret_tensor(arg137_1, (109, 128, 64), (0, 1, 128), 0), out=buf237)
        del arg137_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf236, (109, 64, 128), (8320, 128, 1), 0), reinterpret_tensor(arg139_1, (109, 128, 64), (0, 1, 128), 0), out=buf238)
        del arg139_1
        del buf236
        buf239 = reinterpret_tensor(buf237, (109, 1, 64, 64), (4096, 1, 64, 1), 0); del buf237  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.add]
        triton_poi_fused_add_63.run(buf239, arg138_1, 446464, grid=grid(446464), stream=stream0)
        del arg138_1
        buf240 = reinterpret_tensor(buf238, (109, 1, 64, 64), (4096, 1, 64, 1), 0); del buf238  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.add]
        triton_poi_fused_add_63.run(buf240, arg140_1, 446464, grid=grid(446464), stream=stream0)
        del arg140_1
        buf241 = empty_strided_cuda((109, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf239, (109, 64, 64), (4096, 64, 1), 0), reinterpret_tensor(buf240, (109, 64, 64), (4096, 1, 64), 0), out=buf241)
        del buf239
        del buf240
        buf242 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg144_1, reinterpret_tensor(buf228, (4096, 128), (128, 1), 0), reinterpret_tensor(arg143_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf242)
        del arg143_1
        del arg144_1
        buf243 = empty_strided_cuda((4096, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg146_1, reinterpret_tensor(buf228, (4096, 128), (128, 1), 0), reinterpret_tensor(arg145_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf243)
        del arg145_1
        del arg146_1
        del buf228
        buf245 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf244, reinterpret_tensor(arg141_1, (128, 1), (1, 128), 0), out=buf245)
        del arg141_1
        del buf244
        buf246 = reinterpret_tensor(buf245, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf245  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_64.run(buf246, arg142_1, 4096, grid=grid(4096), stream=stream0)
        del arg142_1
        buf247 = empty_strided_cuda((1, 1499136), (1499136, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_65.run(buf231, buf241, buf242, buf243, buf246, buf247, 1499136, grid=grid(1499136), stream=stream0)
        del buf231
        del buf241
        del buf242
        del buf243
    return (buf247, reinterpret_tensor(buf246, (1, 32, 128), (4096, 128, 1), 0), buf58, buf61, buf57, )
