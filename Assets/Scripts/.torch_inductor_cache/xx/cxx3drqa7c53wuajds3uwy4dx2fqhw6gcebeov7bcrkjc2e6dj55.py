...
# Source node to ATen node mapping:
#   kv => cat_3
#   layer_norm_1 => add_10, add_9, mul_13, mul_14, rsqrt_1, sub_1, var_mean_1
# Graph fragment:
...
#   %add_10 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_14, %arg35_1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3q/c3qqrfxaoy6za5lwhgfaj6s7vj5jaqwvzlqztusbrj2cqhe5kr6x.py
# Topologically Sorted Source Nodes: [layer_norm_2, kv_1], Original ATen: [aten.native_layer_norm, aten.cat]
# Source node to ATen node mapping:
#   kv_1 => cat_4
#   layer_norm_2 => add_14, add_15, mul_16, mul_17, rsqrt_2, sub_3, var_mean_2
# Graph fragment:
...
#   %rsqrt_2 : [num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_14,), kwargs = {})
...
#   %add_15 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_17, %arg43_1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ki/ckismtpfytltq5ud6crxv4fd4uhcbpsykjir4u27lzb3azfuqx3g.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fv/cfvolpssj3s2ehjlk3p6icofijer25wnasn4rcxygkt2lcpcilf2.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7u/c7usl7d6ln2ci5cmdedxuplweljyohevj7x4fdvk2hv22oox4hbm.py
# Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum_2 => clone_1
# Graph fragment:
#   %clone_1 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_26,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/g4/cg4vmxif4n5ypb26yx3ycwkkjahm43hjyyuutu76kaelpxhxi67o.py
# Topologically Sorted Source Nodes: [setitem, setitem_1, setitem_8, setitem_9], Original ATen: [aten.lift_fresh, aten.fill]
# Source node to ATen node mapping:
...
#   %select_scatter_default_8 : [num_users=4] = call_function[target=torch.ops.aten.select_scatter.default](args = (%expand_6, %copy_4, 3, 128), kwargs = {})
...
triton_poi_fused_fill_lift_fresh_12 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/2r/c2rws2ubni7opl3sbmsfu25t5eh2zswov3cqz6yuv7k2d6lhwrqq.py
...
triton_poi_fused_fill_index_put_lift_fresh_13 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sc/cscfyckflfjqzcosb2df5voddo54e2dobiblowrj7mai56joyamn.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xi/cxinfkirwkxgt2fzatymdgymcxhugxfs2l5yt5erd6qlwspz55vz.py
# Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_3 => full_default_5, index_put_3
# Graph fragment:
#   %full_default_5 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 1.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_3 : [num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_15, [None, None, %iota, %iota], %full_default_5), kwargs = {})
triton_poi_fused_index_put_lift_fresh_15 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/y5/cy5jwvjap67rrnw6qi2wtm2c7vtknszgyu5ulfx2o7dhwccnmxkq.py
...
#   %add_11 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_15, %slice_48), kwargs = {})
#   %where : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%eq, %full_default_6, %add_11), kwargs = {})
...
triton_red_fused__softmax_add_eq_masked_fill_mul_16 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kz/ckzoabc6zvphy2uvs362vkf4vyvv44cyphkbi6wncx7p4aga224h.py
...
triton_red_fused__softmax_17 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/2k/c2k7gw73auefvevq3uxekzk2ohy5lfuyibztcdadbb4m4acjcduf.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wf/cwfpqyt4tvuryuqv7weukk3apexgv2jeeq24zrulkaihsknx4ewu.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hi/chizyhicqfe6d3wuebj3oerxgqw73gif52v24zfpzcu7vvo42vgy.py
# Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out => clone_5
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vi/cvi644z5ll6uaw6fepl6wkilrkglpt76llv4oiyclzotmfzczsyj.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ih/cihnnfrablrqces7plttt4ujftcht4kni7b55bhizsa2w74gxtjm.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/22/c22ywkgkq3sxtg6vzbr7gseee5clsuwovfd5uxbixsmmueq2jkdf.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/js/cjs2zfbxctsbsu6rx23egx7mifywb5n77m2yocbirtsus7utoeih.py
# Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   einsum_4 => clone_8
# Graph fragment:
#   %clone_8 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_40,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ox/coxah5ztikkyhscasdknkuf2vrj4qoyojjspwkaf2galegi5nqml.py
# Topologically Sorted Source Nodes: [setitem_4, setitem_5, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
# Source node to ATen node mapping:
...
#   %select_scatter_default_4 : [num_users=4] = call_function[target=torch.ops.aten.select_scatter.default](args = (%view_7, %copy_2, 3, 128), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ab/cabc7nc3xco7mhsxlriszpod5yaxbotmvplcegngdnm37lwtzob2.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/c3/cc3fd5euiibh5qp4nngwxmaktxhfriylkfcwh2wiku37t2djy7rd.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/nr/cnrn6e64iolmzoq2krlexqlwdchwryc5aesvw3htr66yeoovhj5k.py
# Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_7 => full_default_11, index_put_5
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/jg/cjgc4zo5hvfqm35ogecyrwx7ngs2ks3bq2js34k6ka2jm53xeg5q.py
...
# Source node to ATen node mapping:
#   attn_probs_1 => amax_1, exp_1, sub_4
#   eq_2 => eq_2
#   scores_3 => mul_18
#   scores_4 => add_16
...
#   %add_16 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_18, %slice_95), kwargs = {})
#   %where_2 : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%eq_2, %full_default_12, %add_16), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fa/cfazlnryvtp7o2weyxupemmtbcoeg4t2qmpp7rv2hlf4qq2lkfni.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ug/cug5xbvzxidqge3qbqszfwuaoen7egjlmwpc57sovuvncfj63zyc.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/oi/coiusfvnzbvpllu7mhzsb3adw4jzxdecybrap6flzcdjoztlp2ar.py
# Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_4 => clone_11
# Graph fragment:
#   %clone_11 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_45,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4c/c4cn7mquovmeugiz5xdu25d3ji57bdeqx23okj2owpceg23a3fx3.py
# Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
# Source node to ATen node mapping:
#   x_out_4 => clone_12
# Graph fragment:
#   %clone_12 : [num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_46,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/54/c54377ltd6jmzxkn6q27tqdjjnlhpm3nsrnl37ik2ve7nghczull.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/al/calm5qltnv2qzrivpaowomrykmfu5rj57mshptignuk6imn63oi2.py
# Topologically Sorted Source Nodes: [z_off_pre], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   z_off_pre => mean_2
# Graph fragment:
#   %mean_2 : [num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%view_64, [2]), kwargs = {})
triton_red_fused_mean_35 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_red_fused_mean_35', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 1, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/44/c44eenrlxsag6conj7jt6wqqis4tle4ku2mpa5c3b5xketecymxz.py
# Topologically Sorted Source Nodes: [W_cross], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   W_cross => add_7
# Graph fragment:
#   %add_7 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg32_1, %arg33_1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ae/cae4emjshfn3p3yjla3sgspuxnk5wcdlytu4x6qrsjw2emdjtzlo.py
# Topologically Sorted Source Nodes: [x, mul_5, h_diag, layer_norm_3, kv_2], Original ATen: [aten.add, aten.mul, aten.native_layer_norm, aten.cat]
# Source node to ATen node mapping:
#   h_diag => add_20
#   kv_2 => cat_5
#   layer_norm_3 => add_21, add_22, mul_21, mul_22, rsqrt_3, sub_5, var_mean_3
#   mul_5 => mul_20
#   x => add_13
# Graph fragment:
#   %add_13 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_5, %view_40), kwargs = {})
#   %mul_20 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg51_1, %view_75), kwargs = {})
#   %add_20 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_13, %mul_20), kwargs = {})
#   %var_mean_3 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%add_20, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_5 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_20, %getitem_7), kwargs = {})
...
#   %mul_22 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_21, %arg52_1), kwargs = {})
#   %add_22 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_22, %arg53_1), kwargs = {})
#   %cat_5 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_76, %mean_4], 2), kwargs = {})
triton_per_fused_add_cat_mul_native_layer_norm_37 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ss/cssm5yqi3ogebkfqymikd2m66q2xciv5vx2grjseg75jao7xxjtl.py
# Topologically Sorted Source Nodes: [z_diag], Original ATen: [aten.mean]
# Source node to ATen node mapping:
#   z_diag => mean_3
# Graph fragment:
#   %mean_3 : [num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%view_65, [2]), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/cz/cczkb4ete3rizfivsok6ezrb67rsn6g3buptlm3jyismfwkxbqup.py
# Topologically Sorted Source Nodes: [x_1, mul_4, h_off_1, layer_norm_4, kv_3], Original ATen: [aten.add, aten.mul, aten.native_layer_norm, aten.cat]
# Source node to ATen node mapping:
#   h_off_1 => add_19
#   kv_3 => cat_6
#   layer_norm_4 => add_26, add_27, mul_24, mul_25, rsqrt_4, sub_7, var_mean_4
#   mul_4 => mul_19
#   x_1 => add_18
# Graph fragment:
#   %add_18 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_17, %view_63), kwargs = {})
#   %mul_19 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg50_1, %view_70), kwargs = {})
#   %add_19 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_18, %mul_19), kwargs = {})
...
#   %mul_25 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_24, %arg60_1), kwargs = {})
#   %add_27 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_25, %arg61_1), kwargs = {})
#   %cat_6 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_99, %mean_5], 2), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/oi/coilspvofz2zvmatxa7tmjfih4jb3bog4pqjukkljz22elaneotg.py
# Topologically Sorted Source Nodes: [x_3], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   x_3 => add_30
# Graph fragment:
#   %add_30 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_19, %view_121), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/l6/cl65pirwskcijjq23bae4bmeinoyssi43tvpvidwfqoamswipura.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/oh/coh7ijsrjzj6hycdvvt4oidjrsrq72zeessonrtvcp5rkzl3anoj.py
...
def call(args):
    ...
    assert_size_stride(arg32_1, (48, 16), (16, 1))
    assert_size_stride(arg33_1, (48, 16), (16, 1))
    ...
    assert_size_stride(arg72_1, (128, 512), (512, 1))
    assert_size_stride(arg73_1, (128, ), (1, ))
    assert_size_stride(arg74_1, (1, 512), (512, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf40 = empty_strided_cuda((1, 16, 129, 512), (1056768, 66048, 512, 1), torch.float32)
        buf38 = reinterpret_tensor(buf40, (1, 16, 128, 512), (1056768, 66048, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_1, kv], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_7.run(buf26, arg34_1, arg35_1, buf35, buf38, 2048, 512, grid=grid(2048), stream=stream0)
        del arg34_1
        del arg35_1
        buf30 = empty_strided_cuda((1, 48, 65536), (3145728, 65536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_p], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg32_1, (1, 48, 16), (768, 16, 1), 0), reinterpret_tensor(buf26, (1, 16, 65536), (1048576, 65536, 1), 0), out=buf30)
        buf31 = empty_strided_cuda((1, 48, 65536), (3145728, 65536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_p], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg33_1, (1, 48, 16), (768, 16, 1), 0), reinterpret_tensor(buf26, (1, 16, 65536), (1048576, 65536, 1), 0), out=buf31)
        buf59 = empty_strided_cuda((48, 128, 512), (65536, 512, 1), torch.float32)
        buf64 = empty_strided_cuda((48, 1, 129, 512), (66048, 1, 512, 1), torch.float32)
        buf62 = reinterpret_tensor(buf64, (48, 1, 128, 512), (66048, 1, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_2, kv_1], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_8.run(buf30, buf31, arg42_1, arg43_1, buf59, buf62, 6144, 512, grid=grid(6144), stream=stream0)
        del arg42_1
        del arg43_1
        buf36 = empty_strided_cuda((2048, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf35, (2048, 512), (512, 1), 0), reinterpret_tensor(arg36_1, (512, 1536), (1, 512), 0), out=buf36)
        buf39 = reinterpret_tensor(buf40, (1, 16, 1, 512), (1056768, 66048, 512, 1), 65536)  # alias
        # Topologically Sorted Source Nodes: [block_node], Original ATen: [aten.mean]
        triton_red_fused_mean_9.run(buf35, buf39, 8192, 128, grid=grid(8192), stream=stream0)
        del buf38
        del buf39
        buf41 = empty_strided_cuda((2064, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf40, (2064, 512), (512, 1), 0), reinterpret_tensor(arg36_1, (512, 1536), (1, 512), 0), out=buf41)
        del arg36_1
        buf42 = reinterpret_tensor(buf35, (16, 8, 128, 64, 1, 1), (65536, 8192, 64, 1, 1, 1), 0); del buf35  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf36, arg37_1, buf42, 1048576, grid=grid(1048576), stream=stream0)
        buf43 = reinterpret_tensor(buf40, (16, 8, 64, 1, 129, 1), (66048, 8256, 129, 129, 1, 1), 0); del buf40  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_11.run(buf41, arg37_1, buf43, 8192, 129, grid=grid(8192, 129), stream=stream0)
        buf44 = empty_strided_cuda((128, 128, 129), (16512, 129, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf42, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf43, (128, 64, 129), (8256, 129, 1), 0), out=buf44)
        buf45 = reinterpret_tensor(buf43, (1, 16, 128, 129, 4), (1056768, 66048, 516, 4, 1), 0); del buf43  # reuse
        buf108 = empty_strided_cuda((1, 16, 128, 129, 4), (1056768, 66048, 516, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem, setitem_1, setitem_8, setitem_9], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_12.run(arg28_1, buf45, buf108, 1056768, grid=grid(1056768), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem, setitem_1, setitem_2], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_13.run(buf45, 8192, grid=grid(8192), stream=stream0)
        buf47 = empty_strided_cuda((1, 16, 128, 129), (264192, 16512, 129, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf45, buf47, 264192, grid=grid(264192), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_15.run(buf47, 2048, grid=grid(2048), stream=stream0)
        buf50 = empty_strided_cuda((1, 16, 128, 129, 8), (2113536, 132096, 129, 1, 16512), torch.float32)
        # Topologically Sorted Source Nodes: [eq, scores_2, scores, scores_1, attn_probs], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_red_fused__softmax_add_eq_masked_fill_mul_16.run(arg29_1, buf44, buf47, buf45, buf50, 16384, 129, grid=grid(16384), stream=stream0)
        buf51 = empty_strided_cuda((1, 16, 128, 1, 8), (16384, 1024, 8, 16384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs], Original ATen: [aten._softmax]
        triton_red_fused__softmax_17.run(buf50, buf51, 16384, 129, grid=grid(16384), stream=stream0)
        buf52 = empty_strided_cuda((1, 16, 128, 129, 4), (1056768, 66048, 516, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_18.run(buf47, buf45, buf52, 1056768, grid=grid(1056768), stream=stream0)
        del buf45
        buf53 = reinterpret_tensor(buf44, (264192, 8), (8, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf52, (264192, 4), (4, 1), 0), reinterpret_tensor(arg38_1, (4, 8), (1, 4), 0), out=buf53)
        del arg38_1
        buf54 = reinterpret_tensor(buf50, (16, 8, 128, 129, 1, 1), (132096, 16512, 129, 1, 1, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf54, buf51, arg29_1, buf53, arg39_1, 128, 16512, grid=grid(128, 16512), stream=stream0)
        del arg39_1
        buf55 = reinterpret_tensor(buf52, (16, 8, 129, 1, 64, 1), (66048, 8256, 64, 64, 1, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.clone]
        triton_poi_fused_clone_20.run(buf41, arg37_1, buf55, 1056768, grid=grid(1056768), stream=stream0)
        del arg37_1
        buf56 = reinterpret_tensor(buf42, (128, 128, 64), (8192, 64, 1), 0); del buf42  # reuse
        # Topologically Sorted Source Nodes: [x_out], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf54, (128, 128, 129), (16512, 129, 1), 0), reinterpret_tensor(buf55, (128, 129, 64), (8256, 64, 1), 0), out=buf56)
        buf57 = reinterpret_tensor(buf13, (1, 16, 128, 8, 64), (1048576, 65536, 512, 64, 1), 0); del buf13  # reuse
        # Topologically Sorted Source Nodes: [x_out_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_21.run(buf56, buf57, 1048576, grid=grid(1048576), stream=stream0)
        buf58 = reinterpret_tensor(buf56, (2048, 512), (512, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (2048, 512), (512, 1), 0), reinterpret_tensor(arg40_1, (512, 512), (1, 512), 0), out=buf58)
        del arg40_1
        buf60 = empty_strided_cuda((6144, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (6144, 512), (512, 1), 0), reinterpret_tensor(arg44_1, (512, 1536), (1, 512), 0), out=buf60)
        buf63 = reinterpret_tensor(buf64, (48, 1, 1, 512), (66048, 1, 512, 1), 65536)  # alias
        # Topologically Sorted Source Nodes: [block_node_1], Original ATen: [aten.mean]
        triton_red_fused_mean_22.run(buf59, buf63, 24576, 128, grid=grid(24576), stream=stream0)
        del buf62
        del buf63
        buf65 = empty_strided_cuda((6192, 1536), (1536, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf64, (6192, 512), (512, 1), 0), reinterpret_tensor(arg44_1, (512, 1536), (1, 512), 0), out=buf65)
        del arg44_1
        buf66 = reinterpret_tensor(buf59, (48, 8, 128, 64, 1, 1), (65536, 8192, 64, 1, 1, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_23.run(buf60, arg45_1, buf66, 3145728, grid=grid(3145728), stream=stream0)
        buf67 = reinterpret_tensor(buf64, (48, 8, 64, 1, 129, 1), (66048, 8256, 129, 129, 1, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_24.run(buf65, arg45_1, buf67, 24576, 129, grid=grid(24576, 129), stream=stream0)
        buf68 = empty_strided_cuda((384, 128, 129), (16512, 129, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf66, (384, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf67, (384, 64, 129), (8256, 129, 1), 0), out=buf68)
        buf69 = reinterpret_tensor(buf67, (48, 1, 128, 129, 4), (66048, 3170304, 516, 4, 1), 0); del buf67  # reuse
        buf135 = reinterpret_tensor(buf41, (48, 1, 128, 129, 4), (66048, 3170304, 516, 4, 1), 0); del buf41  # reuse
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5, setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_25.run(arg30_1, buf69, buf135, 3170304, grid=grid(3170304), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5, setitem_6], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_26.run(buf69, 24576, grid=grid(24576), stream=stream0)
        buf71 = empty_strided_cuda((48, 1, 128, 129), (16512, 16512, 129, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf69, buf71, 792576, grid=grid(792576), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf71, 6144, grid=grid(6144), stream=stream0)
        buf74 = empty_strided_cuda((48, 1, 128, 129, 8), (132096, 6340608, 129, 1, 16512), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_red_fused__softmax_add_eq_masked_fill_mul_29.run(arg31_1, buf68, buf71, buf69, buf74, 49152, 129, grid=grid(49152), stream=stream0)
        buf75 = empty_strided_cuda((48, 1, 128, 1, 8), (1024, 49152, 8, 49152, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_red_fused__softmax_30.run(buf74, buf75, 49152, 129, grid=grid(49152), stream=stream0)
        buf76 = empty_strided_cuda((48, 1, 128, 129, 4), (66048, 1, 516, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_31.run(buf71, buf69, buf76, 3170304, grid=grid(3170304), stream=stream0)
        buf77 = reinterpret_tensor(buf68, (792576, 8), (8, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (792576, 4), (4, 1), 0), reinterpret_tensor(arg46_1, (4, 8), (1, 4), 0), out=buf77)
        del arg46_1
        buf78 = reinterpret_tensor(buf74, (48, 8, 128, 129, 1, 1), (132096, 16512, 129, 1, 1, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf78, buf75, arg31_1, buf77, arg47_1, 384, 16512, grid=grid(384, 16512), stream=stream0)
        del arg47_1
        buf79 = reinterpret_tensor(buf76, (48, 8, 129, 1, 64, 1), (66048, 8256, 64, 64, 1, 1), 0); del buf76  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf65, arg45_1, buf79, 3170304, grid=grid(3170304), stream=stream0)
        del arg45_1
        buf80 = reinterpret_tensor(buf66, (384, 128, 64), (8192, 64, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf78, (384, 128, 129), (16512, 129, 1), 0), reinterpret_tensor(buf79, (384, 129, 64), (8256, 64, 1), 0), out=buf80)
        buf81 = reinterpret_tensor(buf36, (48, 1, 128, 8, 64), (65536, 1, 512, 64, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf80, buf81, 3145728, grid=grid(3145728), stream=stream0)
        buf82 = reinterpret_tensor(buf80, (6144, 512), (512, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf81, (6144, 512), (512, 1), 0), reinterpret_tensor(arg48_1, (512, 512), (1, 512), 0), out=buf82)
        del arg48_1
        buf83 = empty_strided_cuda((1, 48, 512), (24576, 512, 1), torch.float32)
        buf85 = buf83; del buf83  # reuse
        # Topologically Sorted Source Nodes: [z_off_pre], Original ATen: [aten.mean]
        triton_red_fused_mean_35.run(buf85, buf30, buf31, buf82, arg49_1, 24576, 128, grid=grid(24576), stream=stream0)
        buf84 = empty_strided_cuda((48, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [W_cross], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(arg32_1, arg33_1, buf84, 768, grid=grid(768), stream=stream0)
        del arg32_1
        del arg33_1
        buf86 = empty_strided_cuda((1, 16, 512), (8192, 512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [delta_diag], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf84, (1, 16, 48), (0, 1, 16), 0), reinterpret_tensor(buf85, (1, 48, 512), (0, 512, 1), 0), out=buf86)
        buf87 = reinterpret_tensor(buf57, (1, 2048, 512), (1048576, 512, 1), 0); del buf57  # reuse
        buf98 = empty_strided_cuda((1, 2048, 512), (1048576, 512, 1), torch.float32)
        buf103 = reinterpret_tensor(buf55, (1, 16, 129, 512), (1056768, 66048, 512, 1), 0); del buf55  # reuse
        buf101 = reinterpret_tensor(buf103, (1, 16, 128, 512), (1056768, 66048, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x, mul_5, h_diag, layer_norm_3, kv_2], Original ATen: [aten.add, aten.mul, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_mul_native_layer_norm_37.run(buf26, buf58, arg41_1, arg51_1, buf86, arg52_1, arg53_1, buf87, buf98, buf101, 2048, 512, grid=grid(2048), stream=stream0)
        del arg51_1
        del arg52_1
        del arg53_1
        ...
        # Topologically Sorted Source Nodes: [z_diag], Original ATen: [aten.mean]
        triton_red_fused_mean_38.run(buf92, buf26, buf58, arg41_1, 8192, 128, grid=grid(8192), stream=stream0)
        del arg41_1
        del buf26
        buf93 = buf85; del buf85  # reuse
        # Topologically Sorted Source Nodes: [delta_off], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf84, (1, 48, 16), (768, 16, 1), 0), reinterpret_tensor(buf92, (1, 16, 512), (0, 512, 1), 0), out=buf93)
        del buf84
        del buf92
        buf94 = reinterpret_tensor(buf82, (48, 128, 512), (65536, 512, 1), 0); del buf82  # reuse
        buf125 = reinterpret_tensor(buf81, (48, 128, 512), (65536, 512, 1), 0); del buf81  # reuse
        buf130 = reinterpret_tensor(buf79, (48, 1, 129, 512), (66048, 1, 512, 1), 0); del buf79  # reuse
        buf128 = reinterpret_tensor(buf130, (48, 1, 128, 512), (66048, 1, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_1, mul_4, h_off_1, layer_norm_4, kv_3], Original ATen: [aten.add, aten.mul, aten.native_layer_norm, aten.cat]
        triton_per_fused_add_cat_mul_native_layer_norm_39.run(buf94, buf30, buf31, arg49_1, arg50_1, buf93, arg60_1, arg61_1, buf125, buf128, 6144, 512, grid=grid(6144), stream=stream0)
        del arg49_1
        del arg50_1
        del arg60_1
        del arg61_1
        del buf30
        del buf93
        buf99 = reinterpret_tensor(buf31, (2048, 1536), (1536, 1), 0); del buf31  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (2048, 512), (512, 1), 0), reinterpret_tensor(arg54_1, (512, 1536), (1, 512), 0), out=buf99)
        buf102 = reinterpret_tensor(buf103, (1, 16, 1, 512), (1056768, 66048, 512, 1), 65536)  # alias
        # Topologically Sorted Source Nodes: [block_node_2], Original ATen: [aten.mean]
        triton_red_fused_mean_9.run(buf98, buf102, 8192, 128, grid=grid(8192), stream=stream0)
        del buf101
        del buf102
        buf104 = reinterpret_tensor(buf69, (2064, 1536), (1536, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (2064, 512), (512, 1), 0), reinterpret_tensor(arg54_1, (512, 1536), (1, 512), 0), out=buf104)
        del arg54_1
        buf105 = reinterpret_tensor(buf98, (16, 8, 128, 64, 1, 1), (65536, 8192, 64, 1, 1, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [einsum_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf99, arg55_1, buf105, 1048576, grid=grid(1048576), stream=stream0)
        buf106 = reinterpret_tensor(buf103, (16, 8, 64, 1, 129, 1), (66048, 8256, 129, 129, 1, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [einsum_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_11.run(buf104, arg55_1, buf106, 8192, 129, grid=grid(8192, 129), stream=stream0)
        buf107 = reinterpret_tensor(buf54, (128, 128, 129), (16512, 129, 1), 0); del buf54  # reuse
        # Topologically Sorted Source Nodes: [einsum_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf105, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf106, (128, 64, 129), (8256, 129, 1), 0), out=buf107)
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_13.run(buf108, 8192, grid=grid(8192), stream=stream0)
        buf110 = buf47; del buf47  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf108, buf110, 264192, grid=grid(264192), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_15.run(buf110, 2048, grid=grid(2048), stream=stream0)
        buf113 = reinterpret_tensor(buf53, (1, 16, 128, 129, 8), (2113536, 132096, 129, 1, 16512), 0); del buf53  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_16.run(arg29_1, buf107, buf110, buf108, buf113, 16384, 129, grid=grid(16384), stream=stream0)
        buf114 = buf51; del buf51  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_2], Original ATen: [aten._softmax]
        triton_red_fused__softmax_17.run(buf113, buf114, 16384, 129, grid=grid(16384), stream=stream0)
        buf115 = reinterpret_tensor(buf106, (1, 16, 128, 129, 4), (1056768, 66048, 516, 4, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_18.run(buf110, buf108, buf115, 1056768, grid=grid(1056768), stream=stream0)
        del buf108
        del buf110
        buf116 = reinterpret_tensor(buf107, (264192, 8), (8, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (264192, 4), (4, 1), 0), reinterpret_tensor(arg56_1, (4, 8), (1, 4), 0), out=buf116)
        del arg56_1
        buf117 = reinterpret_tensor(buf113, (16, 8, 128, 129, 1, 1), (132096, 16512, 129, 1, 1, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf117, buf114, arg29_1, buf116, arg57_1, 128, 16512, grid=grid(128, 16512), stream=stream0)
        del arg29_1
        del arg57_1
        del buf114
        del buf116
        buf118 = reinterpret_tensor(buf115, (16, 8, 129, 1, 64, 1), (66048, 8256, 64, 64, 1, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_20.run(buf104, arg55_1, buf118, 1056768, grid=grid(1056768), stream=stream0)
        del arg55_1
        del buf104
        buf119 = reinterpret_tensor(buf105, (128, 128, 64), (8192, 64, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf117, (128, 128, 129), (16512, 129, 1), 0), reinterpret_tensor(buf118, (128, 129, 64), (8256, 64, 1), 0), out=buf119)
        del buf117
        del buf118
        buf120 = reinterpret_tensor(buf58, (1, 16, 128, 8, 64), (1048576, 65536, 512, 64, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_21.run(buf119, buf120, 1048576, grid=grid(1048576), stream=stream0)
        buf121 = reinterpret_tensor(buf119, (2048, 512), (512, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (2048, 512), (512, 1), 0), reinterpret_tensor(arg58_1, (512, 512), (1, 512), 0), out=buf121)
        del arg58_1
        del buf120
        buf122 = reinterpret_tensor(buf121, (1, 2048, 512), (1048576, 512, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [x_2], Original ATen: [aten.add]
        triton_poi_fused_add_5.run(buf122, buf87, arg59_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg59_1
        del buf87
        buf123 = empty_strided_cuda((2048, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf122, (2048, 512), (512, 1), 0), reinterpret_tensor(arg68_1, (512, 128), (1, 512), 0), alpha=1, beta=1, out=buf123)
        del arg68_1
        del arg69_1
        buf124 = empty_strided_cuda((16, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf123, (16, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf123, (16, 128, 128), (16384, 1, 128), 0), out=buf124)
        buf126 = buf60; del buf60  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf125, (6144, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 1536), (1, 512), 0), out=buf126)
        buf129 = reinterpret_tensor(buf130, (48, 1, 1, 512), (66048, 1, 512, 1), 65536)  # alias
        # Topologically Sorted Source Nodes: [block_node_3], Original ATen: [aten.mean]
        triton_red_fused_mean_22.run(buf125, buf129, 24576, 128, grid=grid(24576), stream=stream0)
        del buf128
        del buf129
        buf131 = buf65; del buf65  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf130, (6192, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 1536), (1, 512), 0), out=buf131)
        del arg62_1
        buf132 = reinterpret_tensor(buf125, (48, 8, 128, 64, 1, 1), (65536, 8192, 64, 1, 1, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [einsum_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_23.run(buf126, arg63_1, buf132, 3145728, grid=grid(3145728), stream=stream0)
        del buf126
        buf133 = reinterpret_tensor(buf130, (48, 8, 64, 1, 129, 1), (66048, 8256, 129, 129, 1, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [einsum_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_24.run(buf131, arg63_1, buf133, 24576, 129, grid=grid(24576, 129), stream=stream0)
        buf134 = reinterpret_tensor(buf78, (384, 128, 129), (16512, 129, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [einsum_10], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf132, (384, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf133, (384, 64, 129), (8256, 129, 1), 0), out=buf134)
        ...
        triton_poi_fused_fill_index_put_lift_fresh_26.run(buf135, 24576, grid=grid(24576), stream=stream0)
        buf137 = buf71; del buf71  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf135, buf137, 792576, grid=grid(792576), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_28.run(buf137, 6144, grid=grid(6144), stream=stream0)
        buf140 = reinterpret_tensor(buf77, (48, 1, 128, 129, 8), (132096, 6340608, 129, 1, 16512), 0); del buf77  # reuse
        ...
        triton_red_fused__softmax_add_eq_masked_fill_mul_29.run(arg31_1, buf134, buf137, buf135, buf140, 49152, 129, grid=grid(49152), stream=stream0)
        buf141 = buf75; del buf75  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_red_fused__softmax_30.run(buf140, buf141, 49152, 129, grid=grid(49152), stream=stream0)
        buf142 = reinterpret_tensor(buf133, (48, 1, 128, 129, 4), (66048, 1, 516, 4, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_31.run(buf137, buf135, buf142, 3170304, grid=grid(3170304), stream=stream0)
        del buf135
        del buf137
        buf143 = reinterpret_tensor(buf134, (792576, 8), (8, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (792576, 4), (4, 1), 0), reinterpret_tensor(arg64_1, (4, 8), (1, 4), 0), out=buf143)
        del arg64_1
        buf144 = reinterpret_tensor(buf140, (48, 8, 128, 129, 1, 1), (132096, 16512, 129, 1, 1, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(buf144, buf141, arg31_1, buf143, arg65_1, 384, 16512, grid=grid(384, 16512), stream=stream0)
        del arg31_1
        del arg65_1
        del buf141
        del buf143
        buf145 = reinterpret_tensor(buf142, (48, 8, 129, 1, 64, 1), (66048, 8256, 64, 64, 1, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf131, arg63_1, buf145, 3170304, grid=grid(3170304), stream=stream0)
        del arg63_1
        del buf131
        buf146 = reinterpret_tensor(buf132, (384, 128, 64), (8192, 64, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf144, (384, 128, 129), (16512, 129, 1), 0), reinterpret_tensor(buf145, (384, 129, 64), (8256, 64, 1), 0), out=buf146)
        del buf144
        del buf145
        buf147 = reinterpret_tensor(buf99, (48, 1, 128, 8, 64), (65536, 1, 512, 64, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf146, buf147, 3145728, grid=grid(3145728), stream=stream0)
        buf148 = reinterpret_tensor(buf146, (6144, 512), (512, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf147, (6144, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 512), (1, 512), 0), out=buf148)
        del arg66_1
        del buf147
        buf149 = reinterpret_tensor(buf148, (48, 128, 512), (65536, 512, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [x_3], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf149, buf94, arg67_1, 3145728, grid=grid(3145728), stream=stream0)
        del arg67_1
        del buf94
        buf150 = empty_strided_cuda((6144, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf149, (6144, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 128), (1, 512), 0), alpha=1, beta=1, out=buf150)
        del arg70_1
        del arg71_1
        buf151 = empty_strided_cuda((6144, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg73_1, reinterpret_tensor(buf149, (6144, 512), (512, 1), 0), reinterpret_tensor(arg72_1, (512, 128), (1, 512), 0), alpha=1, beta=1, out=buf151)
        del arg72_1
        del arg73_1
        del buf149
        buf152 = empty_strided_cuda((48, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf150, (48, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf151, (48, 128, 128), (16384, 1, 128), 0), out=buf152)
        del buf150
        del buf151
        buf153 = buf123; del buf123  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg77_1, reinterpret_tensor(buf122, (2048, 512), (512, 1), 0), reinterpret_tensor(arg76_1, (512, 128), (1, 512), 0), alpha=1, beta=1, out=buf153)
        del arg76_1
        del arg77_1
        buf154 = empty_strided_cuda((2048, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf122, (2048, 512), (512, 1), 0), reinterpret_tensor(arg78_1, (512, 128), (1, 512), 0), alpha=1, beta=1, out=buf154)
        del arg78_1
        del arg79_1
        buf155 = empty_strided_cuda((2048, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (2048, 512), (512, 1), 0), reinterpret_tensor(arg74_1, (512, 1), (1, 512), 0), out=buf155)
        del arg74_1
        del buf122
        buf156 = reinterpret_tensor(buf155, (1, 16, 128, 1), (2048, 128, 1, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_41.run(buf156, arg75_1, 2048, grid=grid(2048), stream=stream0)
        del arg75_1
        buf157 = empty_strided_cuda((1, 1574912), (1574912, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_42.run(buf124, buf152, buf153, buf154, buf156, buf157, 1574912, grid=grid(1574912), stream=stream0)
        del buf124
        del buf152
        del buf153
        del buf154
    return (buf157, reinterpret_tensor(buf156, (1, 16, 128), (2048, 128, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg32_1 = rand_strided((48, 16), (16, 1), device='cuda:0', dtype=torch.float32)
    arg33_1 = rand_strided((48, 16), (16, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg72_1 = rand_strided((128, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    arg73_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg74_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.float32)
