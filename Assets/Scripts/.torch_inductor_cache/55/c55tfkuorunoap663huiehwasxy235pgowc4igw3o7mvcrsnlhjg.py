...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg124_1
        buf319 = reinterpret_tensor(buf270, (234, 32, 1024), (32768, 1024, 1), 0); del buf270  # reuse
        buf315 = reinterpret_tensor(buf319, (234, 32, 256), (32768, 1024, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf271, buf298, arg125_1, arg126_1, arg127_1, buf315, 7488, 256, grid=grid(7488), stream=stream0)
        del arg126_1
        del arg127_1
        buf302 = buf230; del buf230  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf268, (8192, 256), (256, 1), 0), reinterpret_tensor(arg132_1, (256, 256), (1, 256), 0), out=buf302)
        del arg132_1
        buf303 = reinterpret_tensor(buf302, (1, 64, 128, 256), (2097152, 32768, 256, 1), 0); del buf302  # reuse
        ...
        del arg133_1
        buf304 = reinterpret_tensor(buf211, (8192, 128), (128, 1), 0); del buf211  # reuse
        # Topologically Sorted Source Nodes: [input_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg135_1, reinterpret_tensor(buf303, (8192, 256), (256, 1), 0), reinterpret_tensor(arg134_1, (256, 128), (1, 256), 0), alpha=1, beta=1, out=buf304)
        del arg134_1
        del arg135_1
        del buf303
        buf305 = empty_strided_cuda((64, 128, 128), (16384, 128, 1), torch.float32)
        ...
        triton_poi_fused_index_add_index_select_43.run(arg60_1, arg59_1, buf271, buf298, arg125_1, arg61_1, buf306, buf310, 14745600, grid=grid(14745600), stream=stream0)
        buf309 = buf269; del buf269  # reuse
        # Topologically Sorted Source Nodes: [row_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf306, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf309)
        del arg30_1
        del buf306
        buf313 = buf239; del buf239  # reuse
        # Topologically Sorted Source Nodes: [col_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf310, (1, 64, 32768), (2097152, 32768, 1), 0), out=buf313)
        del arg31_1
        del buf310
        buf314 = buf244; del buf244  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, g_5], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf271, buf298, arg125_1, buf314, 59904, 32, grid=grid(59904), stream=stream0)
        buf316 = reinterpret_tensor(buf319, (234, 32, 256), (32768, 1024, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf309, buf316, 1916928, grid=grid(1916928), stream=stream0)
        del buf309
        buf317 = reinterpret_tensor(buf319, (234, 32, 256), (32768, 1024, 1), 512)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf313, buf317, 1916928, grid=grid(1916928), stream=stream0)
        buf318 = reinterpret_tensor(buf319, (234, 32, 256), (32768, 1024, 1), 768)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf314, buf318, 1916928, grid=grid(1916928), stream=stream0)
        del buf314
        del buf315
        del buf316
        del buf317
        del buf318
        buf320 = reinterpret_tensor(buf313, (7488, 1024), (1024, 1), 0); del buf313  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf319, (7488, 1024), (1024, 1), 0), reinterpret_tensor(arg128_1, (1024, 1024), (1, 1024), 0), out=buf320)
        del arg128_1
        del buf319
        buf321 = reinterpret_tensor(buf320, (234, 32, 1024), (32768, 1024, 1), 0); del buf320  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf321, arg129_1, 7667712, grid=grid(7667712), stream=stream0)
        del arg129_1
        buf322 = reinterpret_tensor(buf297, (7488, 256), (256, 1), 0); del buf297  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf321, (7488, 1024), (1024, 1), 0), reinterpret_tensor(arg130_1, (1024, 256), (1, 1024), 0), out=buf322)
        del arg130_1
        del buf321
        buf323 = reinterpret_tensor(buf322, (234, 32, 256), (8192, 256, 1), 0); del buf322  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf323, buf271, buf298, arg125_1, arg131_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg125_1
        del arg131_1
        del buf271
        buf324 = buf298; del buf298  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf323, (7488, 256), (256, 1), 0), reinterpret_tensor(arg136_1, (256, 256), (1, 256), 0), out=buf324)
        del arg136_1
        buf325 = reinterpret_tensor(buf324, (234, 1, 32, 256), (8192, 1, 256, 1), 0); del buf324  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_52.run(buf325, arg137_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg137_1
        ...
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf325, (7488, 256), (256, 1), 0), reinterpret_tensor(arg138_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf326)
        del arg138_1
        del arg139_1
        buf327 = reinterpret_tensor(buf325, (7488, 256), (256, 1), 0); del buf325  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf323, (7488, 256), (256, 1), 0), reinterpret_tensor(arg140_1, (256, 256), (1, 256), 0), out=buf327)
        del arg140_1
        ...
        triton_poi_fused_gelu_52.run(buf328, arg141_1, 1916928, grid=grid(1916928), stream=stream0)
        del arg141_1
        buf329 = empty_strided_cuda((7488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg143_1, reinterpret_tensor(buf328, (7488, 256), (256, 1), 0), reinterpret_tensor(arg142_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf329)
        del arg142_1
        del arg143_1
        del buf328
        ...
        extern_kernels.addmm(arg147_1, reinterpret_tensor(buf268, (8192, 256), (256, 1), 0), reinterpret_tensor(arg146_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf331)
        del arg146_1
        del arg147_1
        buf332 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg149_1, reinterpret_tensor(buf268, (8192, 256), (256, 1), 0), reinterpret_tensor(arg148_1, (256, 32), (1, 256), 0), alpha=1, beta=1, out=buf332)
        del arg148_1
        del arg149_1
        buf333 = empty_strided_cuda((8192, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf268, (8192, 256), (256, 1), 0), reinterpret_tensor(arg144_1, (256, 1), (1, 256), 0), out=buf333)
        del arg144_1
        del buf268
        ...
        triton_poi_fused_index_add_index_select_49.run(arg61_1, arg59_1, buf323, arg60_1, buf336, buf339, 14745600, grid=grid(14745600), stream=stream0)
        del arg59_1
        del arg60_1
        del arg61_1
        del buf323
    return (buf335, reinterpret_tensor(buf334, (1, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf336, (1, 8192, 256), (2097152, 256, 1), 0), reinterpret_tensor(buf339, (1, 8192, 256), (2097152, 256, 1), 0), )
