...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg46_1
        buf64 = reinterpret_tensor(buf59, (1, 4096, 128), (524288, 128, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf60, arg47_1, arg48_1, arg49_1, buf64, 4096, 128, grid=grid(4096), stream=stream0)
        del arg48_1
        del arg49_1
        buf65 = reinterpret_tensor(buf35, (4096, 512), (512, 1), 0); del buf35  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf64, (4096, 128), (128, 1), 0), reinterpret_tensor(arg50_1, (128, 512), (1, 128), 0), out=buf65)
        del arg50_1
        buf66 = reinterpret_tensor(buf65, (1, 4096, 512), (2097152, 512, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf66, arg51_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg51_1
        buf67 = reinterpret_tensor(buf64, (4096, 128), (128, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf66, (4096, 512), (512, 1), 0), reinterpret_tensor(arg52_1, (512, 128), (1, 512), 0), out=buf67)
        del arg52_1
        buf68 = reinterpret_tensor(buf67, (1, 4096, 128), (524288, 128, 1), 0); del buf67  # reuse
        buf118 = buf29; del buf29  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_22.run(buf68, buf25, buf60, arg47_1, arg53_1, arg72_1, arg73_1, buf118, 4096, 128, grid=grid(4096), stream=stream0)
        del arg47_1
        del arg53_1
        del arg72_1
        del arg73_1
        buf69 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf69, 1785856, grid=grid(1785856), stream=stream0)
        buf102 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf102, 1785856, grid=grid(1785856), stream=stream0)
        buf104 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf104, 1785856, grid=grid(1785856), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_17, index_add__4, col_sum_1, getitem_18, index_add__5, row_sum, getitem_8, index_add__2, col_sum, getitem_9, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_24.run(arg34_1, arg32_1, buf68, arg33_1, buf25, buf69, buf71, buf102, buf104, 2916352, grid=grid(2916352), stream=stream0)
        buf106 = empty_strided_cuda((109, 1, 1, 128), (128, 13952, 13952, 1), torch.float32)
        buf76 = empty_strided_cuda((109, 128, 128), (16384, 128, 1), torch.float32)
        buf107 = reinterpret_tensor(buf106, (109, 1, 1, 128), (128, 1, 13952, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [layer_norm_3, off_prep_block], Original ATen: [aten.native_layer_norm, aten.mean]
        triton_red_fused_mean_native_layer_norm_25.run(buf107, buf69, arg35_1, buf71, buf102, buf104, arg54_1, arg55_1, buf76, 13952, 128, grid=grid(13952), stream=stream0)
        del arg54_1
        del arg55_1
        buf77 = empty_strided_cuda((13952, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (13952, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf77)
        buf79 = buf104; del buf104  # reuse
        # Topologically Sorted Source Nodes: [mask_base_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf79, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2, lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.clone, aten.sum, aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_27.run(buf79, 13952, 128, grid=grid(13952), stream=stream0)
        buf81 = empty_strided_cuda((109, 1, 128, 128, 4), (65536, 7143424, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(arg30_1, buf81, 7143424, grid=grid(7143424), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_29.run(buf81, 55808, grid=grid(55808), stream=stream0)
        buf83 = buf102; del buf102  # reuse
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf81, buf83, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf83, 13952, grid=grid(13952), stream=stream0)
        buf85 = empty_strided_cuda((109, 8, 128, 16), (16384, 2048, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_32.run(buf77, arg57_1, buf85, 1785856, grid=grid(1785856), stream=stream0)
        buf86 = empty_strided_cuda((109, 8, 128, 16), (16384, 2048, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf77, arg57_1, buf86, 1785856, grid=grid(1785856), stream=stream0)
        buf87 = empty_strided_cuda((109, 8, 128, 16), (16384, 2048, 16, 1), torch.float32)
        buf99 = empty_strided_cuda((109, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf77, arg57_1, buf87, buf99, 1785856, grid=grid(1785856), stream=stream0)
        buf94 = empty_strided_cuda((109, 1, 128, 128, 4), (65536, 1, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_35.run(buf83, buf81, buf94, 7143424, grid=grid(7143424), stream=stream0)
        buf95 = empty_strided_cuda((1785856, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf94, (1785856, 4), (4, 1), 0), reinterpret_tensor(arg58_1, (4, 16), (1, 4), 0), out=buf95)
        del arg58_1
        buf96 = reinterpret_tensor(buf95, (109, 1, 128, 128, 16), (262144, 1, 2048, 16, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf96, arg59_1, 28573696, grid=grid(28573696), stream=stream0)
        del arg59_1
        buf97 = empty_strided_cuda((1785856, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (1785856, 16), (16, 1), 0), reinterpret_tensor(arg60_1, (16, 8), (1, 16), 0), out=buf97)
        del arg60_1
        buf88 = empty_strided_cuda((109, 8, 128, 128), (131072, 16384, 128, 1), torch.float32)
        buf98 = empty_strided_cuda((109, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_37.run(buf79, buf83, buf81, buf97, arg61_1, buf88, buf98, 872, 16384, grid=grid(872, 16384), stream=stream0)
        del arg61_1
        del buf79
        del buf83
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        ...
        buf90 = buf89[0]
        del buf89
        buf100 = reinterpret_tensor(buf87, (872, 128, 16), (2048, 16, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf98, (872, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf99, (872, 128, 16), (2048, 16, 1), 0), out=buf100)
        buf101 = empty_strided_cuda((13952, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (13952, 128), (128, 1), 0), reinterpret_tensor(arg62_1, (128, 8), (1, 128), 0), out=buf101)
        del arg62_1
        buf108 = empty_strided_cuda((109, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf107, (109, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf108)
        del arg56_1
        buf109 = reinterpret_tensor(buf90, (109, 1, 128, 8, 16), (16384, 1, 128, 16, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2, mul_3, x_mid_3], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_38.run(buf109, buf100, buf101, arg63_1, buf108, arg57_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg57_1
        del arg63_1
        buf110 = reinterpret_tensor(buf100, (13952, 128), (128, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf109, (13952, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf110)
        del arg64_1
        buf111 = reinterpret_tensor(buf110, (109, 128, 128), (16384, 128, 1), 0); del buf110  # reuse
        buf160 = reinterpret_tensor(buf109, (109, 128, 128), (16384, 128, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_39.run(buf111, buf69, arg35_1, buf71, arg65_1, arg66_1, arg67_1, buf160, 13952, 128, grid=grid(13952), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        ...
        buf120 = empty_strided_cuda((1, 32, 128), (4096, 128, 1), torch.float32)
        ...
        triton_per_fused_clone_sum_7.run(arg29_1, buf120, buf121, 4096, 128, grid=grid(4096), stream=stream0)
        ...
        triton_poi_fused__to_copy_copy_lt_maximum_8.run(buf122, arg29_1, buf121, 4096, grid=grid(4096), stream=stream0)
        del arg29_1
        del buf122
        buf124 = reinterpret_tensor(buf66, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(arg28_1, buf124, 2097152, grid=grid(2097152), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_2, setitem_4], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_10.run(buf124, 16384, grid=grid(16384), stream=stream0)
        buf126 = reinterpret_tensor(buf60, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(buf124, buf126, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf126, 4096, grid=grid(4096), stream=stream0)
        buf128 = reinterpret_tensor(buf53, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf53  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_13.run(buf119, arg75_1, buf128, 524288, grid=grid(524288), stream=stream0)
        buf129 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_14.run(buf119, arg75_1, buf129, 524288, grid=grid(524288), stream=stream0)
        buf130 = buf39; del buf39  # reuse
        buf142 = reinterpret_tensor(buf37, (32, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf37  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_15.run(buf119, arg75_1, buf130, buf142, 524288, grid=grid(524288), stream=stream0)
        del buf119
        buf137 = buf48; del buf48  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf126, buf124, buf137, 2097152, grid=grid(2097152), stream=stream0)
        buf138 = reinterpret_tensor(buf50, (524288, 16), (16, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf137, (524288, 4), (4, 1), 0), reinterpret_tensor(arg76_1, (4, 16), (1, 4), 0), out=buf138)
        del arg76_1
        del buf137
        buf139 = reinterpret_tensor(buf138, (1, 32, 128, 128, 16), (8388608, 262144, 2048, 16, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_17.run(buf139, arg77_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg77_1
        buf140 = reinterpret_tensor(buf52, (524288, 8), (8, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (524288, 16), (16, 1), 0), reinterpret_tensor(arg78_1, (16, 8), (1, 16), 0), out=buf140)
        del arg78_1
        del buf139
        buf131 = buf42; del buf42  # reuse
        buf141 = reinterpret_tensor(buf51, (32, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4, einsum_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_18.run(buf121, buf126, buf124, buf140, arg79_1, buf131, buf141, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg79_1
        del buf121
        del buf126
        del buf140
        ...
        buf133 = buf132[0]
        del buf132
        buf143 = reinterpret_tensor(buf130, (256, 128, 16), (2048, 16, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf141, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf142, (256, 128, 16), (2048, 16, 1), 0), out=buf143)
        del buf141
        del buf142
        buf144 = buf55; del buf55  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf118, (4096, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 8), (1, 128), 0), out=buf144)
        del arg80_1
        buf145 = buf58; del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (32, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf145)
        del arg74_1
        buf146 = reinterpret_tensor(buf133, (1, 32, 128, 8, 16), (524288, 16384, 128, 16, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4, mul_4, x_mid_5], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_20.run(buf146, buf143, buf144, arg81_1, buf145, arg75_1, 524288, grid=grid(524288), stream=stream0)
        del arg75_1
        del arg81_1
        del buf144
        del buf145
        buf147 = reinterpret_tensor(buf143, (4096, 128), (128, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf146, (4096, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 128), (1, 128), 0), out=buf147)
        del arg82_1
        buf151 = reinterpret_tensor(buf146, (1, 4096, 128), (524288, 128, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf68, buf147, arg83_1, arg84_1, arg85_1, buf151, 4096, 128, grid=grid(4096), stream=stream0)
        del arg84_1
        del arg85_1
        buf152 = reinterpret_tensor(buf124, (4096, 512), (512, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf151, (4096, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 512), (1, 128), 0), out=buf152)
        del arg86_1
        buf153 = reinterpret_tensor(buf152, (1, 4096, 512), (2097152, 512, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf153, arg87_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg87_1
        buf154 = reinterpret_tensor(buf151, (4096, 128), (128, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (4096, 512), (512, 1), 0), reinterpret_tensor(arg88_1, (512, 128), (1, 512), 0), out=buf154)
        del arg88_1
        del buf153
        buf155 = reinterpret_tensor(buf154, (1, 4096, 128), (524288, 128, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf155, buf68, buf147, arg83_1, arg89_1, 524288, grid=grid(524288), stream=stream0)
        del arg83_1
        del arg89_1
        buf156 = buf71; del buf71  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf156, 1785856, grid=grid(1785856), stream=stream0)
        buf158 = buf69; del buf69  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf158, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_33, index_add__6, col_sum_2, getitem_34, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_41.run(arg34_1, arg32_1, buf155, arg33_1, buf156, buf158, 2916352, grid=grid(2916352), stream=stream0)
        del arg32_1
        del arg33_1
        del arg34_1
        buf161 = reinterpret_tensor(buf81, (13952, 512), (512, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf160, (13952, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 512), (1, 128), 0), out=buf161)
        del arg68_1
        buf162 = reinterpret_tensor(buf161, (109, 128, 512), (65536, 512, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf162, arg69_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg69_1
        buf163 = reinterpret_tensor(buf160, (13952, 128), (128, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf162, (13952, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 128), (1, 512), 0), out=buf163)
        del arg70_1
        buf164 = reinterpret_tensor(buf163, (109, 128, 128), (16384, 128, 1), 0); del buf163  # reuse
        buf168 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_43.run(buf164, buf156, arg35_1, buf158, buf111, arg71_1, arg90_1, arg91_1, buf168, 13952, 128, grid=grid(13952), stream=stream0)
        del arg35_1
        del arg71_1
        del arg90_1
        del arg91_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (13952, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf169)
        buf171 = buf158; del buf158  # reuse
        # Topologically Sorted Source Nodes: [mask_base_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf171, 1785856, grid=grid(1785856), stream=stream0)
        ...
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_27.run(buf171, 13952, 128, grid=grid(13952), stream=stream0)
        buf173 = reinterpret_tensor(buf162, (109, 1, 128, 128, 4), (65536, 7143424, 512, 4, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(arg30_1, buf173, 7143424, grid=grid(7143424), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_29.run(buf173, 55808, grid=grid(55808), stream=stream0)
        buf175 = buf156; del buf156  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf173, buf175, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf175, 13952, grid=grid(13952), stream=stream0)
        buf177 = reinterpret_tensor(buf111, (109, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf111  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_32.run(buf169, arg93_1, buf177, 1785856, grid=grid(1785856), stream=stream0)
        buf178 = reinterpret_tensor(buf99, (109, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf169, arg93_1, buf178, 1785856, grid=grid(1785856), stream=stream0)
        buf179 = buf86; del buf86  # reuse
        buf191 = reinterpret_tensor(buf85, (109, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf85  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf169, arg93_1, buf179, buf191, 1785856, grid=grid(1785856), stream=stream0)
        del buf169
        buf186 = buf94; del buf94  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_35.run(buf175, buf173, buf186, 7143424, grid=grid(7143424), stream=stream0)
        buf187 = reinterpret_tensor(buf96, (1785856, 16), (16, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf186, (1785856, 4), (4, 1), 0), reinterpret_tensor(arg94_1, (4, 16), (1, 4), 0), out=buf187)
        del arg94_1
        del buf186
        buf188 = reinterpret_tensor(buf187, (109, 1, 128, 128, 16), (262144, 1, 2048, 16, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf188, arg95_1, 28573696, grid=grid(28573696), stream=stream0)
        del arg95_1
        buf189 = reinterpret_tensor(buf98, (1785856, 8), (8, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf188, (1785856, 16), (16, 1), 0), reinterpret_tensor(arg96_1, (16, 8), (1, 16), 0), out=buf189)
        del arg96_1
        del buf188
        buf180 = buf88; del buf88  # reuse
        buf190 = reinterpret_tensor(buf97, (109, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6, einsum_3], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_37.run(buf171, buf175, buf173, buf189, arg97_1, buf180, buf190, 872, 16384, grid=grid(872, 16384), stream=stream0)
        del arg97_1
        del buf171
        del buf175
        del buf189
        ...
        buf182 = buf181[0]
        del buf181
        buf192 = reinterpret_tensor(buf179, (872, 128, 16), (2048, 16, 1), 0); del buf179  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf190, (872, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf191, (872, 128, 16), (2048, 16, 1), 0), out=buf192)
        del buf190
        del buf191
        buf193 = buf101; del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (13952, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 8), (1, 128), 0), out=buf193)
        del arg98_1
        del buf168
        buf194 = buf108; del buf108  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf107, (109, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf194)
        del arg92_1
        del buf107
        buf195 = reinterpret_tensor(buf182, (109, 1, 128, 8, 16), (16384, 1, 128, 16, 1), 0); del buf182  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6, mul_5, x_mid_7], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_38.run(buf195, buf192, buf193, arg99_1, buf194, arg93_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg93_1
        del arg99_1
        del buf193
        del buf194
        buf196 = reinterpret_tensor(buf192, (13952, 128), (128, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf195, (13952, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 128), (1, 128), 0), out=buf196)
        del arg100_1
        buf202 = reinterpret_tensor(buf195, (109, 128, 128), (16384, 128, 1), 0); del buf195  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_44.run(buf164, buf196, arg101_1, arg102_1, arg103_1, buf202, 13952, 128, grid=grid(13952), stream=stream0)
        del arg102_1
        del arg103_1
        buf200 = reinterpret_tensor(buf68, (4096, 128), (128, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf155, (4096, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf200)
        del arg108_1
        del arg109_1
        buf201 = reinterpret_tensor(buf147, (32, 128, 128), (16384, 128, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf200, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf200, (32, 128, 128), (16384, 1, 128), 0), out=buf201)
        buf203 = reinterpret_tensor(buf173, (13952, 512), (512, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf202, (13952, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 512), (1, 128), 0), out=buf203)
        del arg104_1
        buf204 = reinterpret_tensor(buf203, (109, 128, 512), (65536, 512, 1), 0); del buf203  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf204, arg105_1, 7143424, grid=grid(7143424), stream=stream0)
        del arg105_1
        buf205 = reinterpret_tensor(buf202, (13952, 128), (128, 1), 0); del buf202  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf204, (13952, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 128), (1, 512), 0), out=buf205)
        del arg106_1
        del buf204
        buf206 = reinterpret_tensor(buf205, (109, 128, 128), (16384, 128, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_45.run(buf206, buf164, buf196, arg101_1, arg107_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg101_1
        del arg107_1
        buf207 = buf196; del buf196  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf206, (13952, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf207)
        del arg110_1
        del arg111_1
        buf208 = reinterpret_tensor(buf164, (13952, 128), (128, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg113_1, reinterpret_tensor(buf206, (13952, 128), (128, 1), 0), reinterpret_tensor(arg112_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf208)
        del arg112_1
        del arg113_1
        buf209 = buf206; del buf206  # reuse
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf207, (109, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf208, (109, 128, 128), (16384, 1, 128), 0), out=buf209)
        del buf207
        del buf208
        buf210 = buf200; del buf200  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf155, (4096, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf210)
        del arg116_1
        del arg117_1
        buf211 = reinterpret_tensor(buf118, (4096, 128), (128, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf155, (4096, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf211)
        del arg118_1
        del arg119_1
        buf212 = reinterpret_tensor(buf57, (4096, 1), (1, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf155, (4096, 128), (128, 1), 0), reinterpret_tensor(arg114_1, (128, 1), (1, 128), 0), out=buf212)
        del arg114_1
        del buf155
        buf213 = reinterpret_tensor(buf212, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf212  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_46.run(buf213, arg115_1, 4096, grid=grid(4096), stream=stream0)
        del arg115_1
        buf214 = empty_strided_cuda((1, 3362816), (3362816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_47.run(buf201, buf209, buf210, buf211, buf213, buf214, 3362816, grid=grid(3362816), stream=stream0)
        del buf201
        del buf209
        del buf210
        del buf211
    return (buf214, reinterpret_tensor(buf213, (1, 32, 128), (4096, 128, 1), 0), )
