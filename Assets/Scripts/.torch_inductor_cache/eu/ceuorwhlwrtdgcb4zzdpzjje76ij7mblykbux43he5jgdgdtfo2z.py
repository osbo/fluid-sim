...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_27.run(buf71, buf26, buf53, arg41_1, arg51_1, arg68_1, arg69_1, buf110, 8192, 128, grid=grid(8192), stream=stream0)
        del arg41_1
        del arg51_1
        del arg68_1
        del arg69_1
        ...
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_29.run(buf73, buf74, arg52_1, arg53_1, buf75, buf79, 15584, 128, grid=grid(15584), stream=stream0)
        del arg52_1
        del arg53_1
        buf80 = empty_strided_cuda((15584, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf79, (15584, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf80)
        del arg54_1
        buf82 = reinterpret_tensor(buf79, (487, 1, 32, 32, 4), (4096, 1994752, 128, 4, 1), 0); del buf79  # reuse
        buf186 = empty_strided_cuda((487, 1, 32, 32, 4), (4096, 1994752, 128, 4, 1), torch.float32)
        buf287 = empty_strided_cuda((487, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [sub, setitem_2, setitem_6], Original ATen: [aten.mean, aten.lift_fresh, aten.index_put]
        triton_per_fused_index_put_lift_fresh_mean_30.run(arg29_1, buf82, buf186, buf287, 1994752, 16, grid=grid(1994752), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf80, arg55_1, buf86, 1994752, grid=grid(1994752), stream=stream0)
        buf87 = empty_strided_cuda((487, 8, 32, 16), (4096, 512, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf80, arg55_1, buf87, 1994752, grid=grid(1994752), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_36.run(buf80, arg55_1, buf88, buf100, 1994752, grid=grid(1994752), stream=stream0)
        del arg55_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf95, (498688, 4), (4, 1), 0), reinterpret_tensor(arg56_1, (4, 16), (1, 4), 0), out=buf96)
        del arg56_1
        buf97 = reinterpret_tensor(buf96, (487, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf97, arg57_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg57_1
        buf98 = reinterpret_tensor(buf89, (498688, 8), (8, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (498688, 16), (16, 1), 0), reinterpret_tensor(arg58_1, (16, 8), (1, 16), 0), out=buf98)
        del arg58_1
        buf99 = empty_strided_cuda((487, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf98, arg59_1, buf99, 3896, 1024, grid=grid(3896, 1024), stream=stream0)
        del arg59_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf102, (15584, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 128), (1, 128), 0), out=buf103)
        del arg60_1
        buf157 = reinterpret_tensor(buf97, (487, 32, 512), (16384, 512, 1), 0); del buf97  # reuse
        buf153 = reinterpret_tensor(buf157, (487, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf75, buf103, arg61_1, arg62_1, arg63_1, buf153, 15584, 128, grid=grid(15584), stream=stream0)
        del arg62_1
        del arg63_1
        ...
        buf146 = empty_strided_cuda((1, 128, 128, 128), (2097152, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf146, 2097152, grid=grid(2097152), stream=stream0)
        buf163 = empty_strided_cuda((1, 128, 128, 128), (2097152, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_highway_2], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf163, 2097152, grid=grid(2097152), stream=stream0)
        buf172 = reinterpret_tensor(buf125, (1, 8192, 512), (4194304, 512, 1), 0); del buf125  # reuse
        buf168 = reinterpret_tensor(buf172, (1, 8192, 128), (4194304, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_d_1, z_4, row_highway_2, index_add__8, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_43.run(buf71, buf133, arg77_1, arg42_1, arg78_1, arg79_1, buf137, buf163, buf168, buf139, buf146, 8192, 128, grid=grid(8192), stream=stream0)
        del arg78_1
        del arg79_1
        buf141 = empty_strided_cuda((1090, ), (1, ), torch.int64)
        buf141.copy_(arg43_1)
        del arg43_1
        buf142 = empty_strided_cuda((1090, ), (1, ), torch.int64)
        buf142.copy_(arg45_1)
        del arg45_1
        buf148 = empty_strided_cuda((1090, ), (1, ), torch.int64)
        buf148.copy_(arg44_1)
        del arg44_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_44.run(buf141, buf142, buf75, buf103, arg61_1, buf148, buf139, buf146, 17858560, grid=grid(17858560), stream=stream0)
        ...
        triton_poi_fused_constant_pad_nd_28.run(buf139, buf144, 2097152, grid=grid(2097152), stream=stream0)
        buf145 = buf73; del buf73  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf144, (1, 128, 16384), (0, 16384, 1), 0), out=buf145)
        buf150 = buf144; del buf144  # reuse
        # Topologically Sorted Source Nodes: [col_k_2], Original ATen: [aten.constant_pad_nd]
        triton_poi_fused_constant_pad_nd_28.run(buf146, buf150, 2097152, grid=grid(2097152), stream=stream0)
        buf151 = empty_strided_cuda((1, 487, 16384), (7979008, 16384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf150, (1, 128, 16384), (0, 16384, 1), 0), out=buf151)
        buf152 = empty_strided_cuda((487, 1, 128), (128, 62336, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_mid_o, g_1], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_45.run(buf75, buf103, arg61_1, buf152, 62336, 32, grid=grid(62336), stream=stream0)
        buf154 = reinterpret_tensor(buf157, (487, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf145, buf154, 1994752, grid=grid(1994752), stream=stream0)
        buf155 = reinterpret_tensor(buf157, (487, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf151, buf155, 1994752, grid=grid(1994752), stream=stream0)
        buf156 = reinterpret_tensor(buf157, (487, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_47.run(buf152, buf156, 1994752, grid=grid(1994752), stream=stream0)
        del buf153
        del buf154
        del buf155
        del buf156
        buf158 = reinterpret_tensor(buf151, (15584, 512), (512, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf157, (15584, 512), (512, 1), 0), reinterpret_tensor(arg64_1, (512, 512), (1, 512), 0), out=buf158)
        del arg64_1
        buf159 = reinterpret_tensor(buf158, (487, 32, 512), (16384, 512, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_48.run(buf159, arg65_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg65_1
        buf160 = reinterpret_tensor(buf102, (15584, 128), (128, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (15584, 512), (512, 1), 0), reinterpret_tensor(arg66_1, (512, 128), (1, 512), 0), out=buf160)
        del arg66_1
        buf161 = reinterpret_tensor(buf160, (487, 32, 128), (4096, 128, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_49.run(buf161, buf75, buf103, arg61_1, arg67_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg61_1
        del arg67_1
        # Topologically Sorted Source Nodes: [toks_3, index_add__10, index_add__11], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_50.run(buf141, buf142, buf161, buf148, buf137, buf163, 17858560, grid=grid(17858560), stream=stream0)
        buf166 = buf61; del buf61  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, g_2], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_22.run(buf71, buf133, arg77_1, buf166, 8192, 128, grid=grid(8192), stream=stream0)
        buf167 = buf62; del buf62  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, g_2], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_23.run(buf166, buf167, 128, 64, grid=grid(128), stream=stream0)
        buf169 = reinterpret_tensor(buf172, (1, 8192, 128), (4194304, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_5], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf137, buf169, 1048576, grid=grid(1048576), stream=stream0)
        buf170 = reinterpret_tensor(buf172, (1, 8192, 128), (4194304, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_5], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf163, buf170, 1048576, grid=grid(1048576), stream=stream0)
        buf171 = reinterpret_tensor(buf172, (1, 8192, 128), (4194304, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_5], Original ATen: [aten.cat]
        triton_poi_fused_cat_25.run(buf167, buf171, 1048576, grid=grid(1048576), stream=stream0)
        del buf168
        del buf169
        del buf170
        del buf171
        buf173 = reinterpret_tensor(buf112, (8192, 512), (512, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (8192, 512), (512, 1), 0), reinterpret_tensor(arg80_1, (512, 512), (1, 512), 0), out=buf173)
        del arg80_1
        buf174 = reinterpret_tensor(buf173, (1, 8192, 512), (4194304, 512, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_26.run(buf174, arg81_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg81_1
        buf175 = reinterpret_tensor(buf132, (8192, 128), (128, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf174, (8192, 512), (512, 1), 0), reinterpret_tensor(arg82_1, (512, 128), (1, 512), 0), out=buf175)
        del arg82_1
        buf176 = reinterpret_tensor(buf175, (1, 8192, 128), (1048576, 128, 1), 0); del buf175  # reuse
        buf214 = reinterpret_tensor(buf130, (1, 8192, 128), (1048576, 128, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, h_diag_2, layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_27.run(buf176, buf71, buf133, arg77_1, arg83_1, arg100_1, arg101_1, buf214, 8192, 128, grid=grid(8192), stream=stream0)
        del arg100_1
        del arg101_1
        del arg77_1
        del arg83_1
        ...
        triton_poi_fused_constant_pad_nd_28.run(buf176, buf177, 2097152, grid=grid(2097152), stream=stream0)
        buf178 = reinterpret_tensor(buf159, (1, 487, 16384), (7979008, 16384, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [row_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf177, (1, 128, 16384), (0, 16384, 1), 0), out=buf178)
        buf179 = reinterpret_tensor(buf157, (1, 487, 16384), (7979008, 16384, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [col_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf177, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf179)
        buf180 = buf161; del buf161  # reuse
        buf184 = buf75; del buf75  # reuse
        # Topologically Sorted Source Nodes: [h_off_5, off_in, layer_norm_7], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_51.run(buf180, buf178, buf179, arg84_1, arg85_1, buf184, 15584, 128, grid=grid(15584), stream=stream0)
        del arg84_1
        del arg85_1
        buf185 = buf80; del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf184, (15584, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf185)
        del arg86_1
        # Topologically Sorted Source Nodes: [setitem_6], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf186, 62336, grid=grid(62336), stream=stream0)
        buf188 = buf84; del buf84  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf186, buf188, 498688, grid=grid(498688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf188, 15584, grid=grid(15584), stream=stream0)
        buf190 = reinterpret_tensor(buf184, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf184  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf185, arg87_1, buf190, 1994752, grid=grid(1994752), stream=stream0)
        buf191 = reinterpret_tensor(buf103, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf185, arg87_1, buf191, 1994752, grid=grid(1994752), stream=stream0)
        buf192 = reinterpret_tensor(buf100, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf100  # reuse
        buf204 = reinterpret_tensor(buf82, (487, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf82  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_36.run(buf185, arg87_1, buf192, buf204, 1994752, grid=grid(1994752), stream=stream0)
        del arg87_1
        buf193 = reinterpret_tensor(buf99, (487, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_37.run(buf188, buf186, buf193, 3989504, grid=grid(3989504), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf195 = buf194[0]
        del buf194
        buf199 = reinterpret_tensor(buf192, (487, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_38.run(buf188, buf186, buf199, 1994752, grid=grid(1994752), stream=stream0)
        buf200 = reinterpret_tensor(buf179, (498688, 16), (16, 1), 0); del buf179  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf199, (498688, 4), (4, 1), 0), reinterpret_tensor(arg88_1, (4, 16), (1, 4), 0), out=buf200)
        del arg88_1
        buf201 = reinterpret_tensor(buf200, (487, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf200  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf201, arg89_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg89_1
        buf202 = reinterpret_tensor(buf193, (498688, 8), (8, 1), 0); del buf193  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf201, (498688, 16), (16, 1), 0), reinterpret_tensor(arg90_1, (16, 8), (1, 16), 0), out=buf202)
        del arg90_1
        buf203 = reinterpret_tensor(buf98, (487, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [einsum_11], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf202, arg91_1, buf203, 3896, 1024, grid=grid(3896, 1024), stream=stream0)
        del arg91_1
        buf205 = reinterpret_tensor(buf199, (3896, 32, 16), (512, 16, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [einsum_11], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf203, (3896, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf204, (3896, 32, 16), (512, 16, 1), 0), out=buf205)
        buf206 = reinterpret_tensor(buf195, (487, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf195  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_41.run(buf206, buf205, 1994752, grid=grid(1994752), stream=stream0)
        buf207 = reinterpret_tensor(buf205, (15584, 128), (128, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf206, (15584, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 128), (1, 128), 0), out=buf207)
        del arg92_1
        buf258 = reinterpret_tensor(buf201, (487, 32, 512), (16384, 512, 1), 0); del buf201  # reuse
        buf254 = reinterpret_tensor(buf258, (487, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_1, z_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf180, buf207, arg93_1, arg94_1, arg95_1, buf254, 15584, 128, grid=grid(15584), stream=stream0)
        del arg94_1
        del arg95_1
        buf215 = buf111; del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf214, (8192, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 384), (1, 128), 0), out=buf215)
        del arg102_1
        buf216 = reinterpret_tensor(buf174, (1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_8.run(arg28_1, buf216, 4194304, grid=grid(4194304), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_9.run(buf216, 32768, grid=grid(32768), stream=stream0)
        buf218 = reinterpret_tensor(buf214, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf214  # reuse
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_10.run(buf216, buf218, 1048576, grid=grid(1048576), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(buf218, 8192, grid=grid(8192), stream=stream0)
        buf220 = reinterpret_tensor(buf71, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf71  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf215, arg103_1, buf220, 1048576, grid=grid(1048576), stream=stream0)
        buf221 = reinterpret_tensor(buf133, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf215, arg103_1, buf221, 1048576, grid=grid(1048576), stream=stream0)
        buf222 = buf118; del buf118  # reuse
        buf234 = reinterpret_tensor(buf117, (64, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf117  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf215, arg103_1, buf222, buf234, 1048576, grid=grid(1048576), stream=stream0)
        del arg103_1
        del buf215
        buf223 = reinterpret_tensor(buf129, (64, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_15.run(buf218, buf216, buf223, 8388608, grid=grid(8388608), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf225 = buf224[0]
        del buf224
        buf229 = reinterpret_tensor(buf172, (1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf218, buf216, buf229, 4194304, grid=grid(4194304), stream=stream0)
        buf230 = reinterpret_tensor(buf127, (1048576, 16), (16, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf229, (1048576, 4), (4, 1), 0), reinterpret_tensor(arg104_1, (4, 16), (1, 4), 0), out=buf230)
        del arg104_1
        buf231 = reinterpret_tensor(buf230, (1, 64, 128, 128, 16), (16777216, 262144, 2048, 16, 1), 0); del buf230  # reuse
        # Topologically Sorted Source Nodes: [input_35], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_17.run(buf231, arg105_1, 16777216, grid=grid(16777216), stream=stream0)
        del arg105_1
        buf232 = reinterpret_tensor(buf223, (1048576, 8), (8, 1), 0); del buf223  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf231, (1048576, 16), (16, 1), 0), reinterpret_tensor(arg106_1, (16, 8), (1, 16), 0), out=buf232)
        del arg106_1
        del buf231
        buf233 = reinterpret_tensor(buf128, (64, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [einsum_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf232, arg107_1, buf233, 512, 16384, grid=grid(512, 16384), stream=stream0)
        del arg107_1
        del buf232
        buf235 = reinterpret_tensor(buf218, (512, 128, 16), (2048, 16, 1), 0); del buf218  # reuse
        # Topologically Sorted Source Nodes: [einsum_14], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf233, (512, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf234, (512, 128, 16), (2048, 16, 1), 0), out=buf235)
        del buf233
        del buf234
        buf236 = reinterpret_tensor(buf225, (1, 64, 128, 8, 16), (1048576, 16384, 128, 16, 1), 0); del buf225  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.add]
        triton_poi_fused_add_19.run(buf236, buf235, 1048576, grid=grid(1048576), stream=stream0)
        buf237 = reinterpret_tensor(buf235, (8192, 128), (128, 1), 0); del buf235  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf236, (8192, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), out=buf237)
        del arg108_1
        buf241 = buf177; del buf177  # reuse
        # Topologically Sorted Source Nodes: [row_highway_4], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf241, 2097152, grid=grid(2097152), stream=stream0)
        ...
        triton_poi_fused_new_zeros_20.run(buf248, 2097152, grid=grid(2097152), stream=stream0)
        buf264 = buf146; del buf146  # reuse
        # Topologically Sorted Source Nodes: [col_highway_4], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf264, 2097152, grid=grid(2097152), stream=stream0)
        buf273 = reinterpret_tensor(buf229, (1, 8192, 512), (4194304, 512, 1), 0); del buf229  # reuse
        buf269 = reinterpret_tensor(buf273, (1, 8192, 128), (4194304, 512, 1), 0)  # alias
        ...
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_43.run(buf176, buf237, arg109_1, arg42_1, arg110_1, arg111_1, buf241, buf264, buf269, buf243, buf248, 8192, 128, grid=grid(8192), stream=stream0)
        del arg110_1
        del arg111_1
        # Topologically Sorted Source Nodes: [toks_5, index_add__14, index_add__15], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_44.run(buf141, buf142, buf180, buf207, arg93_1, buf148, buf243, buf248, 17858560, grid=grid(17858560), stream=stream0)
        buf246 = buf139; del buf139  # reuse
        # Topologically Sorted Source Nodes: [row_k_5], Original ATen: [aten.constant_pad_nd]
        triton_poi_fused_constant_pad_nd_28.run(buf243, buf246, 2097152, grid=grid(2097152), stream=stream0)
        buf247 = buf178; del buf178  # reuse
        # Topologically Sorted Source Nodes: [row_t_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf246, (1, 128, 16384), (0, 16384, 1), 0), out=buf247)
        buf251 = buf246; del buf246  # reuse
        # Topologically Sorted Source Nodes: [col_k_5], Original ATen: [aten.constant_pad_nd]
        triton_poi_fused_constant_pad_nd_28.run(buf248, buf251, 2097152, grid=grid(2097152), stream=stream0)
        buf252 = buf145; del buf145  # reuse
        # Topologically Sorted Source Nodes: [col_t_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf251, (1, 128, 16384), (0, 16384, 1), 0), out=buf252)
        buf253 = buf152; del buf152  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, g_3], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_45.run(buf180, buf207, arg93_1, buf253, 62336, 32, grid=grid(62336), stream=stream0)
        buf255 = reinterpret_tensor(buf258, (487, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf247, buf255, 1994752, grid=grid(1994752), stream=stream0)
        buf256 = reinterpret_tensor(buf258, (487, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf252, buf256, 1994752, grid=grid(1994752), stream=stream0)
        buf257 = reinterpret_tensor(buf258, (487, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_47.run(buf253, buf257, 1994752, grid=grid(1994752), stream=stream0)
        del buf254
        del buf255
        del buf256
        del buf257
        buf259 = reinterpret_tensor(buf252, (15584, 512), (512, 1), 0); del buf252  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf258, (15584, 512), (512, 1), 0), reinterpret_tensor(arg96_1, (512, 512), (1, 512), 0), out=buf259)
        del arg96_1
        buf260 = reinterpret_tensor(buf259, (487, 32, 512), (16384, 512, 1), 0); del buf259  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_48.run(buf260, arg97_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg97_1
        buf261 = reinterpret_tensor(buf206, (15584, 128), (128, 1), 0); del buf206  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf260, (15584, 512), (512, 1), 0), reinterpret_tensor(arg98_1, (512, 128), (1, 512), 0), out=buf261)
        del arg98_1
        buf262 = reinterpret_tensor(buf261, (487, 32, 128), (4096, 128, 1), 0); del buf261  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, off_stream_1], Original ATen: [aten.add]
        triton_poi_fused_add_49.run(buf262, buf180, buf207, arg93_1, arg99_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg93_1
        del arg99_1
        # Topologically Sorted Source Nodes: [toks_7, index_add__18, index_add__19], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_50.run(buf141, buf142, buf262, buf148, buf241, buf264, 17858560, grid=grid(17858560), stream=stream0)
        buf267 = buf166; del buf166  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, g_4], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_22.run(buf176, buf237, arg109_1, buf267, 8192, 128, grid=grid(8192), stream=stream0)
        buf268 = buf167; del buf167  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, g_4], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_23.run(buf267, buf268, 128, 64, grid=grid(128), stream=stream0)
        buf270 = reinterpret_tensor(buf273, (1, 8192, 128), (4194304, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf241, buf270, 1048576, grid=grid(1048576), stream=stream0)
        buf271 = reinterpret_tensor(buf273, (1, 8192, 128), (4194304, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf264, buf271, 1048576, grid=grid(1048576), stream=stream0)
        buf272 = reinterpret_tensor(buf273, (1, 8192, 128), (4194304, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_25.run(buf268, buf272, 1048576, grid=grid(1048576), stream=stream0)
        del buf268
        del buf269
        del buf270
        del buf271
        del buf272
        buf274 = reinterpret_tensor(buf216, (8192, 512), (512, 1), 0); del buf216  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf273, (8192, 512), (512, 1), 0), reinterpret_tensor(arg112_1, (512, 512), (1, 512), 0), out=buf274)
        del arg112_1
        del buf273
        buf275 = reinterpret_tensor(buf274, (1, 8192, 512), (4194304, 512, 1), 0); del buf274  # reuse
        # Topologically Sorted Source Nodes: [input_38], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_26.run(buf275, arg113_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg113_1
        buf276 = reinterpret_tensor(buf236, (8192, 128), (128, 1), 0); del buf236  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf275, (8192, 512), (512, 1), 0), reinterpret_tensor(arg114_1, (512, 128), (1, 512), 0), out=buf276)
        del arg114_1
        del buf275
        buf316 = buf264; del buf264  # reuse
        # Topologically Sorted Source Nodes: [row_highway_5], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf316, 2097152, grid=grid(2097152), stream=stream0)
        buf321 = buf241; del buf241  # reuse
        # Topologically Sorted Source Nodes: [col_highway_5], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf321, 2097152, grid=grid(2097152), stream=stream0)
        ...
        triton_poi_fused_new_zeros_20.run(buf351, 2097152, grid=grid(2097152), stream=stream0)
        buf277 = reinterpret_tensor(buf276, (1, 8192, 128), (1048576, 128, 1), 0); del buf276  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, h_diag_3, row_highway_5, index_add__20, col_highway_5, index_add__21, col_highway_6, index_add__25, row_highway_6, index_add__24], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_52.run(buf277, buf176, buf237, arg109_1, arg115_1, arg42_1, buf316, buf321, buf348, buf351, 1048576, grid=grid(1048576), stream=stream0)
        del arg109_1
        del arg115_1
        buf278 = buf243; del buf243  # reuse
        # Topologically Sorted Source Nodes: [h_k_7], Original ATen: [aten.constant_pad_nd]
        triton_poi_fused_constant_pad_nd_28.run(buf277, buf278, 2097152, grid=grid(2097152), stream=stream0)
        buf279 = reinterpret_tensor(buf260, (1, 487, 16384), (7979008, 16384, 1), 0); del buf260  # reuse
        # Topologically Sorted Source Nodes: [row_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf278, (1, 128, 16384), (0, 16384, 1), 0), out=buf279)
        buf280 = reinterpret_tensor(buf258, (1, 487, 16384), (7979008, 16384, 1), 0); del buf258  # reuse
        # Topologically Sorted Source Nodes: [col_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf278, (1, 128, 16384), (2097152, 16384, 1), 0), out=buf280)
        buf281 = buf262; del buf262  # reuse
        buf285 = reinterpret_tensor(buf207, (487, 32, 128), (4096, 128, 1), 0); del buf207  # reuse
        # Topologically Sorted Source Nodes: [h_off_7, off_in_1, layer_norm_11], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_51.run(buf281, buf279, buf280, arg116_1, arg117_1, buf285, 15584, 128, grid=grid(15584), stream=stream0)
        del arg116_1
        del arg117_1
        buf286 = buf185; del buf185  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf285, (15584, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 384), (1, 128), 0), out=buf286)
        del arg118_1
        # Topologically Sorted Source Nodes: [setitem_10], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf287, 62336, grid=grid(62336), stream=stream0)
        buf289 = buf188; del buf188  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf287, buf289, 498688, grid=grid(498688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf289, 15584, grid=grid(15584), stream=stream0)
        buf291 = reinterpret_tensor(buf285, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf285  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf286, arg119_1, buf291, 1994752, grid=grid(1994752), stream=stream0)
        buf292 = reinterpret_tensor(buf180, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf286, arg119_1, buf292, 1994752, grid=grid(1994752), stream=stream0)
        buf293 = reinterpret_tensor(buf204, (487, 8, 32, 16), (4096, 512, 16, 1), 0); del buf204  # reuse
        buf305 = reinterpret_tensor(buf186, (487, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf186  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_36.run(buf286, arg119_1, buf293, buf305, 1994752, grid=grid(1994752), stream=stream0)
        del arg119_1
        del buf286
        buf294 = reinterpret_tensor(buf203, (487, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf203  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_37.run(buf289, buf287, buf294, 3989504, grid=grid(3989504), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf296 = buf295[0]
        del buf295
        buf300 = reinterpret_tensor(buf293, (487, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf293  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_38.run(buf289, buf287, buf300, 1994752, grid=grid(1994752), stream=stream0)
        del buf287
        buf301 = reinterpret_tensor(buf280, (498688, 16), (16, 1), 0); del buf280  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf300, (498688, 4), (4, 1), 0), reinterpret_tensor(arg120_1, (4, 16), (1, 4), 0), out=buf301)
        del arg120_1
        buf302 = reinterpret_tensor(buf301, (487, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf301  # reuse
        # Topologically Sorted Source Nodes: [input_41], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf302, arg121_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg121_1
        buf303 = reinterpret_tensor(buf294, (498688, 8), (8, 1), 0); del buf294  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf302, (498688, 16), (16, 1), 0), reinterpret_tensor(arg122_1, (16, 8), (1, 16), 0), out=buf303)
        del arg122_1
        buf304 = reinterpret_tensor(buf202, (487, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf202  # reuse
        # Topologically Sorted Source Nodes: [einsum_17], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf303, arg123_1, buf304, 3896, 1024, grid=grid(3896, 1024), stream=stream0)
        del arg123_1
        del buf303
        buf306 = reinterpret_tensor(buf300, (3896, 32, 16), (512, 16, 1), 0); del buf300  # reuse
        # Topologically Sorted Source Nodes: [einsum_17], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf304, (3896, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf305, (3896, 32, 16), (512, 16, 1), 0), out=buf306)
        del buf304
        del buf305
        buf307 = reinterpret_tensor(buf296, (487, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf296  # reuse
        # Topologically Sorted Source Nodes: [x_mid_5], Original ATen: [aten.add]
        triton_poi_fused_add_41.run(buf307, buf306, 1994752, grid=grid(1994752), stream=stream0)
        buf308 = reinterpret_tensor(buf306, (15584, 128), (128, 1), 0); del buf306  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf307, (15584, 128), (128, 1), 0), reinterpret_tensor(arg124_1, (128, 128), (1, 128), 0), out=buf308)
        del arg124_1
        buf331 = reinterpret_tensor(buf302, (487, 32, 512), (16384, 512, 1), 0); del buf302  # reuse
        buf327 = reinterpret_tensor(buf331, (487, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf281, buf308, arg125_1, arg126_1, arg127_1, buf327, 15584, 128, grid=grid(15584), stream=stream0)
        del arg126_1
        del arg127_1
        buf312 = buf237; del buf237  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf277, (8192, 128), (128, 1), 0), reinterpret_tensor(arg132_1, (128, 128), (1, 128), 0), out=buf312)
        del arg132_1
        buf313 = reinterpret_tensor(buf312, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf312  # reuse
        # Topologically Sorted Source Nodes: [input_47], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_2.run(buf313, arg133_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg133_1
        buf314 = reinterpret_tensor(buf176, (8192, 128), (128, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [input_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg135_1, reinterpret_tensor(buf313, (8192, 128), (128, 1), 0), reinterpret_tensor(arg134_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf314)
        del arg134_1
        del arg135_1
        buf315 = reinterpret_tensor(buf313, (64, 128, 128), (16384, 128, 1), 0); del buf313  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf314, (64, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf314, (64, 128, 128), (16384, 1, 128), 0), out=buf315)
        del buf314
        # Topologically Sorted Source Nodes: [toks_9, index_add__22, index_add__23], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_44.run(buf141, buf142, buf281, buf308, arg125_1, buf148, buf316, buf321, 17858560, grid=grid(17858560), stream=stream0)
        buf319 = buf278; del buf278  # reuse
        # Topologically Sorted Source Nodes: [row_k_8], Original ATen: [aten.constant_pad_nd]
        triton_poi_fused_constant_pad_nd_28.run(buf316, buf319, 2097152, grid=grid(2097152), stream=stream0)
        del buf316
        buf320 = buf279; del buf279  # reuse
        # Topologically Sorted Source Nodes: [row_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf319, (1, 128, 16384), (0, 16384, 1), 0), out=buf320)
        del arg30_1
        buf324 = buf319; del buf319  # reuse
        # Topologically Sorted Source Nodes: [col_k_8], Original ATen: [aten.constant_pad_nd]
        triton_poi_fused_constant_pad_nd_28.run(buf321, buf324, 2097152, grid=grid(2097152), stream=stream0)
        del buf321
        buf325 = buf247; del buf247  # reuse
        # Topologically Sorted Source Nodes: [col_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 487, 128), (62336, 128, 1), 0), reinterpret_tensor(buf324, (1, 128, 16384), (0, 16384, 1), 0), out=buf325)
        del arg31_1
        del buf324
        buf326 = buf253; del buf253  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, g_5], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_45.run(buf281, buf308, arg125_1, buf326, 62336, 32, grid=grid(62336), stream=stream0)
        buf328 = reinterpret_tensor(buf331, (487, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf320, buf328, 1994752, grid=grid(1994752), stream=stream0)
        del buf320
        buf329 = reinterpret_tensor(buf331, (487, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf325, buf329, 1994752, grid=grid(1994752), stream=stream0)
        buf330 = reinterpret_tensor(buf331, (487, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_47.run(buf326, buf330, 1994752, grid=grid(1994752), stream=stream0)
        del buf326
        del buf327
        del buf328
        del buf329
        del buf330
        buf332 = reinterpret_tensor(buf325, (15584, 512), (512, 1), 0); del buf325  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf331, (15584, 512), (512, 1), 0), reinterpret_tensor(arg128_1, (512, 512), (1, 512), 0), out=buf332)
        del arg128_1
        del buf331
        buf333 = reinterpret_tensor(buf332, (487, 32, 512), (16384, 512, 1), 0); del buf332  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_48.run(buf333, arg129_1, 7979008, grid=grid(7979008), stream=stream0)
        del arg129_1
        buf334 = reinterpret_tensor(buf307, (15584, 128), (128, 1), 0); del buf307  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf333, (15584, 512), (512, 1), 0), reinterpret_tensor(arg130_1, (512, 128), (1, 512), 0), out=buf334)
        del arg130_1
        del buf333
        buf335 = reinterpret_tensor(buf334, (487, 32, 128), (4096, 128, 1), 0); del buf334  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_49.run(buf335, buf281, buf308, arg125_1, arg131_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg125_1
        del arg131_1
        del buf281
        buf336 = buf308; del buf308  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf335, (15584, 128), (128, 1), 0), reinterpret_tensor(arg136_1, (128, 128), (1, 128), 0), out=buf336)
        del arg136_1
        buf337 = reinterpret_tensor(buf336, (487, 1, 32, 128), (4096, 1, 128, 1), 0); del buf336  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_53.run(buf337, arg137_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg137_1
        buf338 = reinterpret_tensor(buf289, (15584, 32), (32, 1), 0); del buf289  # reuse
        # Topologically Sorted Source Nodes: [input_51], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf337, (15584, 128), (128, 1), 0), reinterpret_tensor(arg138_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf338)
        del arg138_1
        del arg139_1
        buf339 = reinterpret_tensor(buf337, (15584, 128), (128, 1), 0); del buf337  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf335, (15584, 128), (128, 1), 0), reinterpret_tensor(arg140_1, (128, 128), (1, 128), 0), out=buf339)
        del arg140_1
        buf340 = reinterpret_tensor(buf339, (487, 1, 32, 128), (4096, 1, 128, 1), 0); del buf339  # reuse
        # Topologically Sorted Source Nodes: [input_53], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_53.run(buf340, arg141_1, 1994752, grid=grid(1994752), stream=stream0)
        del arg141_1
        buf341 = empty_strided_cuda((15584, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg143_1, reinterpret_tensor(buf340, (15584, 128), (128, 1), 0), reinterpret_tensor(arg142_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf341)
        del arg142_1
        del arg143_1
        del buf340
        buf342 = empty_strided_cuda((487, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf338, (487, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf341, (487, 32, 32), (1024, 1, 32), 0), out=buf342)
        del buf338
        del buf341
        buf343 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg147_1, reinterpret_tensor(buf277, (8192, 128), (128, 1), 0), reinterpret_tensor(arg146_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf343)
        del arg146_1
        del arg147_1
        buf344 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg149_1, reinterpret_tensor(buf277, (8192, 128), (128, 1), 0), reinterpret_tensor(arg148_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf344)
        del arg148_1
        del arg149_1
        buf345 = reinterpret_tensor(buf267, (8192, 1), (1, 1), 0); del buf267  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf277, (8192, 128), (128, 1), 0), reinterpret_tensor(arg144_1, (128, 1), (1, 128), 0), out=buf345)
        del arg144_1
        del buf277
        buf346 = reinterpret_tensor(buf345, (1, 64, 128, 1), (8192, 128, 1, 1), 0); del buf345  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_54.run(buf346, arg145_1, 8192, grid=grid(8192), stream=stream0)
        del arg145_1
        buf347 = empty_strided_cuda((1, 2079744), (2079744, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_55.run(buf315, buf342, buf343, buf344, buf346, buf347, 2079744, grid=grid(2079744), stream=stream0)
        del buf315
        del buf342
        del buf343
        del buf344
        # Topologically Sorted Source Nodes: [toks_11, index_add__27, index_add__26], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_50.run(buf148, buf142, buf335, buf141, buf348, buf351, 17858560, grid=grid(17858560), stream=stream0)
        del buf335
    return (buf347, reinterpret_tensor(buf346, (1, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf348, (1, 8192, 128), (2097152, 128, 1), 0), reinterpret_tensor(buf351, (1, 8192, 128), (2097152, 128, 1), 0), reinterpret_tensor(arg42_1, (64, ), (1, ), 0), buf141, buf148, buf142, )
