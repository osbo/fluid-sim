...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3r/c3rzppfpafmpmmmwyb3pdo6fsu2vy5jzngl2ljr5ukz2o4r6ml2k.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp6 = tl.load(in_ptr0 + (28598 + x1), xmask, eviction_policy='evict_last')
...
def call(args):
    ...
    assert_size_stride(arg6_1, (2, 28598), (28598, 1))
    assert_size_stride(arg7_1, (28598, ), (1, ))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf5, arg7_1, buf6, 3660544, grid=grid(3660544), stream=stream0)
        del buf4
        del buf6
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf14, arg7_1, buf15, 3660544, grid=grid(3660544), stream=stream0)
        del arg6_1
        del arg7_1
        del buf13
        del buf15
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg6_1 = rand_strided((2, 28598), (28598, 1), device='cuda:0', dtype=torch.int64)
    arg7_1 = rand_strided((28598, ), (1, ), device='cuda:0', dtype=torch.float32)
