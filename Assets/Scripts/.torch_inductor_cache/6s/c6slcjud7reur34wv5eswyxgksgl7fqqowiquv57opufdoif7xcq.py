...
# Graph fragment:
#   %full_default_8 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([48, 1, 32, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_4 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_32, [%arg32_1]), kwargs = {})
...
#   %index_5 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_32, [%arg33_1]), kwargs = {})
...
#   %index_6 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_71, [%arg32_1]), kwargs = {})
...
#   %index_7 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_71, [%arg33_1]), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg46_1
        buf61 = reinterpret_tensor(buf56, (1, 512, 128), (65536, 128, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf57, arg47_1, arg48_1, arg49_1, buf61, 512, 128, grid=grid(512), stream=stream0)
        del arg48_1
        del arg49_1
        buf62 = reinterpret_tensor(buf47, (512, 512), (512, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf61, (512, 128), (128, 1), 0), reinterpret_tensor(arg50_1, (128, 512), (1, 128), 0), out=buf62)
        del arg50_1
        buf63 = reinterpret_tensor(buf62, (1, 512, 512), (262144, 512, 1), 0); del buf62  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_23.run(buf63, arg51_1, 262144, grid=grid(262144), stream=stream0)
        del arg51_1
        buf64 = reinterpret_tensor(buf61, (512, 128), (128, 1), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf63, (512, 512), (512, 1), 0), reinterpret_tensor(arg52_1, (512, 128), (1, 512), 0), out=buf64)
        del arg52_1
        buf65 = reinterpret_tensor(buf64, (1, 512, 128), (65536, 128, 1), 0); del buf64  # reuse
        buf116 = reinterpret_tensor(buf50, (1, 512, 128), (65536, 128, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_24.run(buf65, buf25, buf57, arg47_1, arg53_1, arg72_1, arg73_1, buf116, 512, 128, grid=grid(512), stream=stream0)
        del arg47_1
        del arg53_1
        del arg72_1
        del arg73_1
        ...
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_25.run(buf66, 196608, grid=grid(196608), stream=stream0)
        buf68 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        ...
        triton_poi_fused_zeros_25.run(buf96, 196608, grid=grid(196608), stream=stream0)
        ...
        triton_poi_fused_zeros_25.run(buf98, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_17, index_add__4, col_sum_1, getitem_18, index_add__5, row_sum, getitem_8, index_add__2, col_sum, getitem_9, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_26.run(arg34_1, arg32_1, buf65, arg33_1, buf25, buf66, buf68, buf96, buf98, 270336, grid=grid(270336), stream=stream0)
        buf76 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_27.run(buf66, arg35_1, buf68, arg54_1, arg55_1, buf76, 1536, 128, grid=grid(1536), stream=stream0)
        del arg54_1
        del arg55_1
        buf74 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mask_base_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(buf74, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2, lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.clone, aten.sum, aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_29.run(buf74, 1536, 32, grid=grid(1536), stream=stream0)
        buf77 = empty_strided_cuda((1536, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (1536, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf77)
        buf78 = empty_strided_cuda((48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf77, arg57_1, buf78, 196608, grid=grid(196608), stream=stream0)
        buf79 = empty_strided_cuda((48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(buf77, arg57_1, buf79, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf80 = empty_strided_cuda((384, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf78, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf79, (384, 16, 32), (512, 32, 1), 0), out=buf80)
        buf81 = reinterpret_tensor(buf79, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(arg30_1, buf81, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_33.run(buf81, 6144, grid=grid(6144), stream=stream0)
        buf83 = empty_strided_cuda((48, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf81, buf83, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_35.run(buf83, 1536, grid=grid(1536), stream=stream0)
        buf86 = empty_strided_cuda((48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_36.run(buf74, buf80, buf83, buf81, buf86, 12288, 32, grid=grid(12288), stream=stream0)
        buf87 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_37.run(buf86, buf87, 12288, 32, grid=grid(12288), stream=stream0)
        buf88 = reinterpret_tensor(buf78, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_38.run(buf83, buf81, buf88, 196608, grid=grid(196608), stream=stream0)
        buf89 = empty_strided_cuda((49152, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf88, (49152, 4), (4, 1), 0), reinterpret_tensor(arg58_1, (4, 16), (1, 4), 0), out=buf89)
        del arg58_1
        buf90 = reinterpret_tensor(buf89, (48, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf90, arg59_1, 786432, grid=grid(786432), stream=stream0)
        del arg59_1
        buf91 = reinterpret_tensor(buf80, (49152, 8), (8, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf90, (49152, 16), (16, 1), 0), reinterpret_tensor(arg60_1, (16, 8), (1, 16), 0), out=buf91)
        del arg60_1
        buf92 = reinterpret_tensor(buf86, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf92, buf87, buf74, buf91, arg61_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg61_1
        buf93 = reinterpret_tensor(buf88, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_41.run(buf77, arg57_1, buf93, 196608, grid=grid(196608), stream=stream0)
        buf94 = reinterpret_tensor(buf81, (384, 32, 16), (512, 16, 1), 0); del buf81  # reuse
        ...
        del buf93
        buf95 = reinterpret_tensor(buf87, (1536, 8), (8, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (1536, 128), (128, 1), 0), reinterpret_tensor(arg62_1, (128, 8), (1, 128), 0), out=buf95)
        del arg62_1
        del buf76
        buf100 = reinterpret_tensor(buf55, (48, 1, 1, 128), (128, 6144, 6144, 1), 0); del buf55  # reuse
        buf101 = reinterpret_tensor(buf100, (48, 1, 1, 128), (128, 1, 6144, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_42.run(buf101, buf96, arg35_1, buf98, 6144, 32, grid=grid(6144), stream=stream0)
        buf102 = empty_strided_cuda((48, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (48, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf102)
        del arg56_1
        buf103 = reinterpret_tensor(buf98, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [mul_5, x_mid_3, x_out_3], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_43.run(buf94, buf95, arg63_1, buf102, arg57_1, buf103, 196608, grid=grid(196608), stream=stream0)
        del arg57_1
        del arg63_1
        buf104 = reinterpret_tensor(buf94, (1536, 128), (128, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (1536, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf104)
        del arg64_1
        buf105 = reinterpret_tensor(buf104, (48, 32, 128), (4096, 128, 1), 0); del buf104  # reuse
        buf151 = reinterpret_tensor(buf103, (48, 32, 128), (4096, 128, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_44.run(buf105, buf66, arg35_1, buf68, arg65_1, arg66_1, arg67_1, buf151, 1536, 128, grid=grid(1536), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        ...
        del arg29_1
        buf117 = reinterpret_tensor(buf68, (512, 384), (384, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf117)
        ...
        triton_poi_fused_clone_9.run(buf117, arg75_1, buf118, 65536, grid=grid(65536), stream=stream0)
        buf119 = reinterpret_tensor(buf57, (16, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf117, arg75_1, buf119, 2048, 32, grid=grid(2048, 32), stream=stream0)
        buf120 = reinterpret_tensor(buf49, (128, 32, 32), (1024, 32, 1), 0); del buf49  # reuse
        ...
        buf126 = reinterpret_tensor(buf48, (1, 16, 32, 32, 8), (131072, 8192, 32, 1, 1024), 0); del buf48  # reuse
        ...
        buf127 = reinterpret_tensor(buf52, (1, 16, 32, 1, 8), (4096, 256, 8, 4096, 1), 0); del buf52  # reuse
        ...
        buf129 = reinterpret_tensor(buf63, (16384, 16), (16, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (16384, 4), (4, 1), 0), reinterpret_tensor(arg76_1, (4, 16), (1, 4), 0), out=buf129)
        del arg76_1
        buf130 = reinterpret_tensor(buf129, (1, 16, 32, 32, 16), (262144, 16384, 512, 16, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_18.run(buf130, arg77_1, 262144, grid=grid(262144), stream=stream0)
        del arg77_1
        buf131 = reinterpret_tensor(buf120, (16384, 8), (8, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf130, (16384, 16), (16, 1), 0), reinterpret_tensor(arg78_1, (16, 8), (1, 16), 0), out=buf131)
        del arg78_1
        buf132 = reinterpret_tensor(buf126, (16, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf132, buf127, buf113, buf131, arg79_1, 128, 1024, grid=grid(128, 1024), stream=stream0)
        del arg79_1
        del buf131
        buf133 = reinterpret_tensor(buf128, (16, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_20.run(buf117, arg75_1, buf133, 65536, grid=grid(65536), stream=stream0)
        buf134 = reinterpret_tensor(buf121, (128, 32, 16), (512, 16, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf132, (128, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf133, (128, 32, 16), (512, 16, 1), 0), out=buf134)
        del buf132
        del buf133
        buf135 = reinterpret_tensor(buf127, (512, 8), (8, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (512, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 8), (1, 128), 0), out=buf135)
        del arg80_1
        buf136 = empty_strided_cuda((16, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf54, (16, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf136)
        del arg74_1
        del buf54
        buf137 = reinterpret_tensor(buf116, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [mul_7, x_mid_5, x_out_6], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_22.run(buf134, buf135, arg81_1, buf136, arg75_1, buf137, 65536, grid=grid(65536), stream=stream0)
        del arg75_1
        del arg81_1
        del buf135
        del buf136
        buf138 = reinterpret_tensor(buf134, (512, 128), (128, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf137, (512, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 128), (1, 128), 0), out=buf138)
        del arg82_1
        buf142 = reinterpret_tensor(buf137, (1, 512, 128), (65536, 128, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf65, buf138, arg83_1, arg84_1, arg85_1, buf142, 512, 128, grid=grid(512), stream=stream0)
        del arg84_1
        del arg85_1
        buf143 = reinterpret_tensor(buf130, (512, 512), (512, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (512, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 512), (1, 128), 0), out=buf143)
        del arg86_1
        buf144 = reinterpret_tensor(buf143, (1, 512, 512), (262144, 512, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_23.run(buf144, arg87_1, 262144, grid=grid(262144), stream=stream0)
        del arg87_1
        buf145 = reinterpret_tensor(buf142, (512, 128), (128, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf144, (512, 512), (512, 1), 0), reinterpret_tensor(arg88_1, (512, 128), (1, 512), 0), out=buf145)
        del arg88_1
        del buf144
        buf146 = reinterpret_tensor(buf145, (1, 512, 128), (65536, 128, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_45.run(buf146, buf65, buf138, arg83_1, arg89_1, 65536, grid=grid(65536), stream=stream0)
        del arg83_1
        del arg89_1
        del buf138
        del buf65
        buf147 = reinterpret_tensor(buf117, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_25.run(buf147, 196608, grid=grid(196608), stream=stream0)
        buf149 = buf66; del buf66  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_25.run(buf149, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_33, index_add__6, col_sum_2, getitem_34, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_46.run(arg34_1, arg32_1, buf146, arg33_1, buf147, buf149, 270336, grid=grid(270336), stream=stream0)
        del arg32_1
        del arg33_1
        del arg34_1
        buf152 = reinterpret_tensor(buf90, (1536, 512), (512, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf151, (1536, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 512), (1, 128), 0), out=buf152)
        del arg68_1
        buf153 = reinterpret_tensor(buf152, (48, 32, 512), (16384, 512, 1), 0); del buf152  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf153, arg69_1, 786432, grid=grid(786432), stream=stream0)
        del arg69_1
        buf154 = reinterpret_tensor(buf151, (1536, 128), (128, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (1536, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 128), (1, 512), 0), out=buf154)
        del arg70_1
        buf155 = reinterpret_tensor(buf154, (48, 32, 128), (4096, 128, 1), 0); del buf154  # reuse
        buf162 = reinterpret_tensor(buf96, (48, 32, 128), (4096, 128, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_48.run(buf155, buf147, arg35_1, buf149, buf105, arg71_1, arg90_1, arg91_1, buf162, 1536, 128, grid=grid(1536), stream=stream0)
        del arg35_1
        del arg71_1
        del arg90_1
        del arg91_1
        ...
        triton_poi_fused_clone_28.run(buf160, 49152, grid=grid(49152), stream=stream0)
        ...
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_29.run(buf160, 1536, 32, grid=grid(1536), stream=stream0)
        buf163 = buf77; del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf162, (1536, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf163)
        buf164 = reinterpret_tensor(buf149, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_30.run(buf163, arg93_1, buf164, 196608, grid=grid(196608), stream=stream0)
        buf165 = reinterpret_tensor(buf147, (48, 8, 16, 1, 32, 1), (4096, 512, 32, 32, 1, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_31.run(buf163, arg93_1, buf165, 6144, 32, grid=grid(6144, 32), stream=stream0)
        buf166 = reinterpret_tensor(buf92, (384, 32, 32), (1024, 32, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf164, (384, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf165, (384, 16, 32), (512, 32, 1), 0), out=buf166)
        buf167 = reinterpret_tensor(buf165, (48, 1, 32, 32, 4), (4096, 196608, 128, 4, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_32.run(arg30_1, buf167, 196608, grid=grid(196608), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_33.run(buf167, 6144, grid=grid(6144), stream=stream0)
        buf169 = buf83; del buf83  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_34.run(buf167, buf169, 49152, grid=grid(49152), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_35.run(buf169, 1536, grid=grid(1536), stream=stream0)
        buf172 = reinterpret_tensor(buf91, (48, 1, 32, 32, 8), (8192, 393216, 32, 1, 1024), 0); del buf91  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_36.run(buf160, buf166, buf169, buf167, buf172, 12288, 32, grid=grid(12288), stream=stream0)
        buf173 = reinterpret_tensor(buf95, (48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_37.run(buf172, buf173, 12288, 32, grid=grid(12288), stream=stream0)
        buf174 = reinterpret_tensor(buf164, (48, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_38.run(buf169, buf167, buf174, 196608, grid=grid(196608), stream=stream0)
        buf175 = reinterpret_tensor(buf153, (49152, 16), (16, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf174, (49152, 4), (4, 1), 0), reinterpret_tensor(arg94_1, (4, 16), (1, 4), 0), out=buf175)
        del arg94_1
        buf176 = reinterpret_tensor(buf175, (48, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_39.run(buf176, arg95_1, 786432, grid=grid(786432), stream=stream0)
        del arg95_1
        buf177 = reinterpret_tensor(buf166, (49152, 8), (8, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf176, (49152, 16), (16, 1), 0), reinterpret_tensor(arg96_1, (16, 8), (1, 16), 0), out=buf177)
        del arg96_1
        buf178 = reinterpret_tensor(buf172, (48, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf178, buf173, buf160, buf177, arg97_1, 384, 1024, grid=grid(384, 1024), stream=stream0)
        del arg97_1
        del buf177
        buf179 = reinterpret_tensor(buf174, (48, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_41.run(buf163, arg93_1, buf179, 196608, grid=grid(196608), stream=stream0)
        del buf163
        buf180 = reinterpret_tensor(buf167, (384, 32, 16), (512, 16, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf178, (384, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf179, (384, 32, 16), (512, 16, 1), 0), out=buf180)
        del buf178
        del buf179
        buf181 = reinterpret_tensor(buf173, (1536, 8), (8, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf162, (1536, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 8), (1, 128), 0), out=buf181)
        del arg98_1
        buf182 = buf102; del buf102  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (48, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf182)
        del arg92_1
        del buf101
        buf183 = reinterpret_tensor(buf162, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf162  # reuse
        # Topologically Sorted Source Nodes: [mul_9, x_mid_7, x_out_9], Original ATen: [aten.mul, aten.add, aten.clone]
        triton_poi_fused_add_clone_mul_43.run(buf180, buf181, arg99_1, buf182, arg93_1, buf183, 196608, grid=grid(196608), stream=stream0)
        del arg93_1
        del arg99_1
        del buf181
        del buf182
        buf184 = reinterpret_tensor(buf180, (1536, 128), (128, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf183, (1536, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 128), (1, 128), 0), out=buf184)
        del arg100_1
        buf190 = reinterpret_tensor(buf183, (48, 32, 128), (4096, 128, 1), 0); del buf183  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_49.run(buf155, buf184, arg101_1, arg102_1, arg103_1, buf190, 1536, 128, grid=grid(1536), stream=stream0)
        del arg102_1
        del arg103_1
        buf188 = reinterpret_tensor(buf113, (512, 32), (32, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf146, (512, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf188)
        del arg108_1
        del arg109_1
        buf189 = reinterpret_tensor(buf123, (16, 32, 32), (1024, 32, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf188, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf188, (16, 32, 32), (1024, 1, 32), 0), out=buf189)
        buf191 = reinterpret_tensor(buf176, (1536, 512), (512, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf190, (1536, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 512), (1, 128), 0), out=buf191)
        del arg104_1
        buf192 = reinterpret_tensor(buf191, (48, 32, 512), (16384, 512, 1), 0); del buf191  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf192, arg105_1, 786432, grid=grid(786432), stream=stream0)
        del arg105_1
        buf193 = reinterpret_tensor(buf190, (1536, 128), (128, 1), 0); del buf190  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf192, (1536, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 128), (1, 512), 0), out=buf193)
        del arg106_1
        del buf192
        buf194 = reinterpret_tensor(buf193, (48, 32, 128), (4096, 128, 1), 0); del buf193  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_50.run(buf194, buf155, buf184, arg101_1, arg107_1, 196608, grid=grid(196608), stream=stream0)
        del arg101_1
        del arg107_1
        del buf155
        del buf184
        buf195 = reinterpret_tensor(buf160, (1536, 32), (32, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf194, (1536, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf195)
        del arg110_1
        del arg111_1
        buf196 = reinterpret_tensor(buf169, (1536, 32), (32, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg113_1, reinterpret_tensor(buf194, (1536, 128), (128, 1), 0), reinterpret_tensor(arg112_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf196)
        del arg112_1
        del arg113_1
        del buf194
        buf197 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf195, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf196, (48, 32, 32), (1024, 1, 32), 0), out=buf197)
        del buf195
        del buf196
        buf198 = buf188; del buf188  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf146, (512, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf198)
        del arg116_1
        del arg117_1
        buf199 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf146, (512, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf199)
        del arg118_1
        del arg119_1
        buf200 = reinterpret_tensor(buf114, (512, 1), (1, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf146, (512, 128), (128, 1), 0), reinterpret_tensor(arg114_1, (128, 1), (1, 128), 0), out=buf200)
        del arg114_1
        del buf146
        buf201 = reinterpret_tensor(buf200, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf200  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_51.run(buf201, arg115_1, 512, grid=grid(512), stream=stream0)
        del arg115_1
        buf202 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_52.run(buf189, buf197, buf198, buf199, buf201, buf202, 98816, grid=grid(98816), stream=stream0)
        del buf189
        del buf197
        del buf198
        del buf199
    return (buf202, reinterpret_tensor(buf201, (1, 16, 32), (512, 32, 1), 0), )
