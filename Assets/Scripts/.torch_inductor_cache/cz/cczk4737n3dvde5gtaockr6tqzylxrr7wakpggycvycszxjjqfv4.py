...
#   %full_default_40 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 64, 128, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_41 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 64, 128, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_43 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 64, 128, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_42 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 64, 128, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
def call(args):
    ...
    assert_size_stride(arg134_1, (384, 128), (128, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, z, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_21.run(buf26, buf53, arg41_1, arg42_1, arg46_1, arg47_1, buf57, buf59, buf63, 8192, 128, grid=grid(8192), stream=stream0)
        del arg46_1
        del arg47_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (8192, 512), (512, 1), 0), reinterpret_tensor(arg48_1, (512, 512), (1, 512), 0), out=buf68)
        del arg48_1
        buf69 = reinterpret_tensor(buf68, (1, 8192, 512), (4194304, 512, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_26.run(buf69, arg49_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg49_1
        buf70 = reinterpret_tensor(buf59, (8192, 128), (128, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf69, (8192, 512), (512, 1), 0), reinterpret_tensor(arg50_1, (512, 128), (1, 512), 0), out=buf70)
        del arg50_1
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_27.run(buf71, buf26, buf53, arg41_1, arg51_1, arg68_1, arg69_1, buf109, 8192, 128, grid=grid(8192), stream=stream0)
        del arg41_1
        del arg51_1
        del arg68_1
        del arg69_1
        ...
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_28.run(buf72, buf73, arg52_1, arg53_1, buf74, buf78, 7488, 128, grid=grid(7488), stream=stream0)
        del arg52_1
        del arg53_1
        buf79 = empty_strided_cuda((7488, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (7488, 128), (128, 1), 0), reinterpret_tensor(arg54_1, (128, 384), (1, 128), 0), out=buf79)
        del arg54_1
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf79, arg55_1, buf85, 958464, grid=grid(958464), stream=stream0)
        buf86 = empty_strided_cuda((234, 8, 32, 16), (4096, 512, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf79, arg55_1, buf86, 958464, grid=grid(958464), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf79, arg55_1, buf87, buf99, 958464, grid=grid(958464), stream=stream0)
        del arg55_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (7488, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 128), (1, 128), 0), out=buf102)
        del arg60_1
        buf154 = reinterpret_tensor(buf96, (234, 32, 512), (16384, 512, 1), 0); del buf96  # reuse
        buf150 = reinterpret_tensor(buf154, (234, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf74, buf102, arg61_1, arg62_1, arg63_1, buf150, 7488, 128, grid=grid(7488), stream=stream0)
        del arg62_1
        del arg63_1
        ...
        buf144 = reinterpret_tensor(buf117, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf117  # reuse
        ...
        buf160 = reinterpret_tensor(buf116, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf116  # reuse
        ...
        buf169 = reinterpret_tensor(buf124, (1, 8192, 512), (4194304, 512, 1), 0); del buf124  # reuse
        buf165 = reinterpret_tensor(buf169, (1, 8192, 128), (4194304, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_d_1, z_4, row_highway_2, index_add__8, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_42.run(buf71, buf132, arg77_1, arg42_1, arg78_1, arg79_1, buf136, buf160, buf165, buf138, buf144, 8192, 128, grid=grid(8192), stream=stream0)
        del arg78_1
        del arg79_1
        ...
        del arg44_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_43.run(buf140, buf141, buf74, buf102, arg61_1, buf146, buf138, buf144, 7372800, grid=grid(7372800), stream=stream0)
        buf143 = buf72; del buf72  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf138, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf143)
        ...
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf144, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf148)
        buf149 = empty_strided_cuda((234, 1, 128), (128, 29952, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_mid_o, g_1], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf74, buf102, arg61_1, buf149, 29952, 32, grid=grid(29952), stream=stream0)
        buf151 = reinterpret_tensor(buf154, (234, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf143, buf151, 958464, grid=grid(958464), stream=stream0)
        buf152 = reinterpret_tensor(buf154, (234, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf148, buf152, 958464, grid=grid(958464), stream=stream0)
        buf153 = reinterpret_tensor(buf154, (234, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf149, buf153, 958464, grid=grid(958464), stream=stream0)
        del buf150
        del buf151
        del buf152
        del buf153
        ...
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf156, arg65_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg65_1
        buf157 = reinterpret_tensor(buf101, (7488, 128), (128, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf158, buf74, buf102, arg61_1, arg67_1, 958464, grid=grid(958464), stream=stream0)
        del arg61_1
        del arg67_1
        # Topologically Sorted Source Nodes: [toks_3, index_add__10, index_add__11], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_49.run(buf140, buf141, buf158, buf146, buf136, buf160, 7372800, grid=grid(7372800), stream=stream0)
        buf163 = buf61; del buf61  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, g_2], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_22.run(buf71, buf132, arg77_1, buf163, 8192, 128, grid=grid(8192), stream=stream0)
        ...
        triton_poi_fused_cat_24.run(buf136, buf166, 1048576, grid=grid(1048576), stream=stream0)
        ...
        del buf167
        del buf168
        buf170 = reinterpret_tensor(buf111, (8192, 512), (512, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg81_1
        buf172 = reinterpret_tensor(buf160, (8192, 128), (128, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        buf210 = reinterpret_tensor(buf136, (1, 8192, 128), (1048576, 128, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, h_diag_2, layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_27.run(buf173, buf71, buf132, arg77_1, arg83_1, arg100_1, arg101_1, buf210, 8192, 128, grid=grid(8192), stream=stream0)
        del arg100_1
        del arg101_1
        del arg77_1
        del arg83_1
        buf174 = reinterpret_tensor(buf156, (1, 234, 16384), (3833856, 16384, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [row_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf173, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf174)
        buf175 = reinterpret_tensor(buf154, (1, 234, 16384), (3833856, 16384, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [col_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf173, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf175)
        buf176 = buf158; del buf158  # reuse
        buf180 = buf74; del buf74  # reuse
        # Topologically Sorted Source Nodes: [h_off_5, off_in, layer_norm_7], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_50.run(buf176, buf174, buf175, arg84_1, arg85_1, buf180, 7488, 128, grid=grid(7488), stream=stream0)
        del arg84_1
        del arg85_1
        buf181 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf180, (7488, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 384), (1, 128), 0), out=buf181)
        del arg86_1
        ...
        buf186 = reinterpret_tensor(buf180, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf180  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf181, arg87_1, buf186, 958464, grid=grid(958464), stream=stream0)
        buf187 = reinterpret_tensor(buf102, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf181, arg87_1, buf187, 958464, grid=grid(958464), stream=stream0)
        buf188 = reinterpret_tensor(buf99, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf99  # reuse
        buf200 = reinterpret_tensor(buf81, (234, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf81  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf181, arg87_1, buf188, buf200, 958464, grid=grid(958464), stream=stream0)
        del arg87_1
        buf189 = reinterpret_tensor(buf98, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf191 = buf190[0]
        del buf190
        buf195 = reinterpret_tensor(buf188, (234, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf188  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf184, buf182, buf195, 958464, grid=grid(958464), stream=stream0)
        buf196 = reinterpret_tensor(buf175, (239616, 16), (16, 1), 0); del buf175  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg90_1
        buf199 = reinterpret_tensor(buf97, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf97  # reuse
        ...
        del arg91_1
        buf201 = reinterpret_tensor(buf195, (1872, 32, 16), (512, 16, 1), 0); del buf195  # reuse
        # Topologically Sorted Source Nodes: [einsum_11], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf199, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf200, (1872, 32, 16), (512, 16, 1), 0), out=buf201)
        buf202 = reinterpret_tensor(buf191, (234, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf191  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf202, buf201, 958464, grid=grid(958464), stream=stream0)
        buf203 = reinterpret_tensor(buf201, (7488, 128), (128, 1), 0); del buf201  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf202, (7488, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 128), (1, 128), 0), out=buf203)
        del arg92_1
        buf252 = reinterpret_tensor(buf197, (234, 32, 512), (16384, 512, 1), 0); del buf197  # reuse
        buf248 = reinterpret_tensor(buf252, (234, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_1, z_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf176, buf203, arg93_1, arg94_1, arg95_1, buf248, 7488, 128, grid=grid(7488), stream=stream0)
        del arg94_1
        del arg95_1
        buf211 = buf110; del buf110  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf210, (8192, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 384), (1, 128), 0), out=buf211)
        del arg102_1
        buf212 = reinterpret_tensor(buf171, (1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), 0); del buf171  # reuse
        ...
        buf214 = reinterpret_tensor(buf210, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf210  # reuse
        ...
        buf216 = reinterpret_tensor(buf71, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf71  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf211, arg103_1, buf216, 1048576, grid=grid(1048576), stream=stream0)
        buf217 = reinterpret_tensor(buf132, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf211, arg103_1, buf217, 1048576, grid=grid(1048576), stream=stream0)
        buf218 = reinterpret_tensor(buf144, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf144  # reuse
        buf230 = reinterpret_tensor(buf138, (64, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf138  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf211, arg103_1, buf218, buf230, 1048576, grid=grid(1048576), stream=stream0)
        del arg103_1
        buf219 = reinterpret_tensor(buf128, (64, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf221 = buf220[0]
        del buf220
        buf225 = reinterpret_tensor(buf169, (1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg106_1
        buf229 = reinterpret_tensor(buf127, (64, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf127  # reuse
        ...
        del arg107_1
        buf231 = reinterpret_tensor(buf214, (512, 128, 16), (2048, 16, 1), 0); del buf214  # reuse
        # Topologically Sorted Source Nodes: [einsum_14], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf229, (512, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf230, (512, 128, 16), (2048, 16, 1), 0), out=buf231)
        buf232 = reinterpret_tensor(buf221, (1, 64, 128, 8, 16), (1048576, 16384, 128, 16, 1), 0); del buf221  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.add]
        triton_poi_fused_add_19.run(buf232, buf231, 1048576, grid=grid(1048576), stream=stream0)
        buf233 = reinterpret_tensor(buf231, (8192, 128), (128, 1), 0); del buf231  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf232, (8192, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), out=buf233)
        del arg108_1
        buf237 = reinterpret_tensor(buf232, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf232  # reuse
        # Topologically Sorted Source Nodes: [row_highway_4], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf237, 1048576, grid=grid(1048576), stream=stream0)
        buf239 = reinterpret_tensor(buf230, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf230  # reuse
        # Topologically Sorted Source Nodes: [row_highway_3], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf239, 1048576, grid=grid(1048576), stream=stream0)
        buf243 = reinterpret_tensor(buf218, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf218  # reuse
        ...
        buf258 = reinterpret_tensor(buf217, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf217  # reuse
        # Topologically Sorted Source Nodes: [col_highway_4], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf258, 1048576, grid=grid(1048576), stream=stream0)
        buf267 = reinterpret_tensor(buf225, (1, 8192, 512), (4194304, 512, 1), 0); del buf225  # reuse
        buf263 = reinterpret_tensor(buf267, (1, 8192, 128), (4194304, 512, 1), 0)  # alias
        ...
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_42.run(buf173, buf233, arg109_1, arg42_1, arg110_1, arg111_1, buf237, buf258, buf263, buf239, buf243, 8192, 128, grid=grid(8192), stream=stream0)
        del arg110_1
        del arg111_1
        # Topologically Sorted Source Nodes: [toks_5, index_add__14, index_add__15], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_43.run(buf140, buf141, buf176, buf203, arg93_1, buf146, buf239, buf243, 7372800, grid=grid(7372800), stream=stream0)
        buf242 = buf174; del buf174  # reuse
        # Topologically Sorted Source Nodes: [row_t_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf239, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf242)
        buf246 = buf143; del buf143  # reuse
        # Topologically Sorted Source Nodes: [col_t_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf243, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf246)
        buf247 = buf149; del buf149  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, g_3], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf176, buf203, arg93_1, buf247, 29952, 32, grid=grid(29952), stream=stream0)
        buf249 = reinterpret_tensor(buf252, (234, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf242, buf249, 958464, grid=grid(958464), stream=stream0)
        buf250 = reinterpret_tensor(buf252, (234, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf246, buf250, 958464, grid=grid(958464), stream=stream0)
        buf251 = reinterpret_tensor(buf252, (234, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_7], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf247, buf251, 958464, grid=grid(958464), stream=stream0)
        del buf248
        del buf249
        del buf250
        del buf251
        buf253 = reinterpret_tensor(buf246, (7488, 512), (512, 1), 0); del buf246  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf252, (7488, 512), (512, 1), 0), reinterpret_tensor(arg96_1, (512, 512), (1, 512), 0), out=buf253)
        del arg96_1
        buf254 = reinterpret_tensor(buf253, (234, 32, 512), (16384, 512, 1), 0); del buf253  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf254, arg97_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg97_1
        buf255 = reinterpret_tensor(buf202, (7488, 128), (128, 1), 0); del buf202  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf254, (7488, 512), (512, 1), 0), reinterpret_tensor(arg98_1, (512, 128), (1, 512), 0), out=buf255)
        del arg98_1
        buf256 = reinterpret_tensor(buf255, (234, 32, 128), (4096, 128, 1), 0); del buf255  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, off_stream_1], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf256, buf176, buf203, arg93_1, arg99_1, 958464, grid=grid(958464), stream=stream0)
        del arg93_1
        del arg99_1
        # Topologically Sorted Source Nodes: [toks_7, index_add__18, index_add__19], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_49.run(buf140, buf141, buf256, buf146, buf237, buf258, 7372800, grid=grid(7372800), stream=stream0)
        buf261 = buf163; del buf163  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, g_4], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_22.run(buf173, buf233, arg109_1, buf261, 8192, 128, grid=grid(8192), stream=stream0)
        buf262 = buf164; del buf164  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, g_4], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_23.run(buf261, buf262, 128, 64, grid=grid(128), stream=stream0)
        buf264 = reinterpret_tensor(buf267, (1, 8192, 128), (4194304, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf237, buf264, 1048576, grid=grid(1048576), stream=stream0)
        buf265 = reinterpret_tensor(buf267, (1, 8192, 128), (4194304, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf258, buf265, 1048576, grid=grid(1048576), stream=stream0)
        buf266 = reinterpret_tensor(buf267, (1, 8192, 128), (4194304, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_9], Original ATen: [aten.cat]
        triton_poi_fused_cat_25.run(buf262, buf266, 1048576, grid=grid(1048576), stream=stream0)
        del buf263
        del buf264
        del buf265
        del buf266
        buf268 = reinterpret_tensor(buf212, (8192, 512), (512, 1), 0); del buf212  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf267, (8192, 512), (512, 1), 0), reinterpret_tensor(arg112_1, (512, 512), (1, 512), 0), out=buf268)
        del arg112_1
        buf269 = reinterpret_tensor(buf268, (1, 8192, 512), (4194304, 512, 1), 0); del buf268  # reuse
        # Topologically Sorted Source Nodes: [input_38], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_26.run(buf269, arg113_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg113_1
        buf270 = reinterpret_tensor(buf258, (8192, 128), (128, 1), 0); del buf258  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf269, (8192, 512), (512, 1), 0), reinterpret_tensor(arg114_1, (512, 128), (1, 512), 0), out=buf270)
        del arg114_1
        buf271 = reinterpret_tensor(buf270, (1, 8192, 128), (1048576, 128, 1), 0); del buf270  # reuse
        buf308 = reinterpret_tensor(buf237, (1, 8192, 128), (1048576, 128, 1), 0); del buf237  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, h_diag_3, layer_norm_13], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_27.run(buf271, buf173, buf233, arg109_1, arg115_1, arg132_1, arg133_1, buf308, 8192, 128, grid=grid(8192), stream=stream0)
        del arg109_1
        del arg115_1
        del arg132_1
        del arg133_1
        buf272 = reinterpret_tensor(buf254, (1, 234, 16384), (3833856, 16384, 1), 0); del buf254  # reuse
        # Topologically Sorted Source Nodes: [row_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf271, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf272)
        buf273 = reinterpret_tensor(buf252, (1, 234, 16384), (3833856, 16384, 1), 0); del buf252  # reuse
        # Topologically Sorted Source Nodes: [col_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf271, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf273)
        buf274 = buf256; del buf256  # reuse
        buf278 = reinterpret_tensor(buf203, (234, 32, 128), (4096, 128, 1), 0); del buf203  # reuse
        # Topologically Sorted Source Nodes: [h_off_7, off_in_1, layer_norm_11], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_50.run(buf274, buf272, buf273, arg116_1, arg117_1, buf278, 7488, 128, grid=grid(7488), stream=stream0)
        del arg116_1
        del arg117_1
        buf279 = buf181; del buf181  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf278, (7488, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 384), (1, 128), 0), out=buf279)
        del arg118_1
        ...
        buf284 = reinterpret_tensor(buf278, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf278  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf279, arg119_1, buf284, 958464, grid=grid(958464), stream=stream0)
        buf285 = reinterpret_tensor(buf176, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf279, arg119_1, buf285, 958464, grid=grid(958464), stream=stream0)
        buf286 = reinterpret_tensor(buf200, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf200  # reuse
        buf298 = reinterpret_tensor(buf182, (234, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf182  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf279, arg119_1, buf286, buf298, 958464, grid=grid(958464), stream=stream0)
        del arg119_1
        buf287 = reinterpret_tensor(buf199, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf289 = buf288[0]
        del buf288
        buf293 = reinterpret_tensor(buf286, (234, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf286  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf282, buf280, buf293, 958464, grid=grid(958464), stream=stream0)
        buf294 = reinterpret_tensor(buf273, (239616, 16), (16, 1), 0); del buf273  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg122_1
        buf297 = reinterpret_tensor(buf198, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf198  # reuse
        ...
        del arg123_1
        buf299 = reinterpret_tensor(buf293, (1872, 32, 16), (512, 16, 1), 0); del buf293  # reuse
        # Topologically Sorted Source Nodes: [einsum_17], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf297, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf298, (1872, 32, 16), (512, 16, 1), 0), out=buf299)
        buf300 = reinterpret_tensor(buf289, (234, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf289  # reuse
        # Topologically Sorted Source Nodes: [x_mid_5], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf300, buf299, 958464, grid=grid(958464), stream=stream0)
        buf301 = reinterpret_tensor(buf299, (7488, 128), (128, 1), 0); del buf299  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf300, (7488, 128), (128, 1), 0), reinterpret_tensor(arg124_1, (128, 128), (1, 128), 0), out=buf301)
        del arg124_1
        buf350 = reinterpret_tensor(buf295, (234, 32, 512), (16384, 512, 1), 0); del buf295  # reuse
        buf346 = reinterpret_tensor(buf350, (234, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf274, buf301, arg125_1, arg126_1, arg127_1, buf346, 7488, 128, grid=grid(7488), stream=stream0)
        del arg126_1
        del arg127_1
        buf309 = buf211; del buf211  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf308, (8192, 128), (128, 1), 0), reinterpret_tensor(arg134_1, (128, 384), (1, 128), 0), out=buf309)
        del arg134_1
        buf310 = reinterpret_tensor(buf269, (1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), 0); del buf269  # reuse
        ...
        buf312 = reinterpret_tensor(buf308, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf308  # reuse
        ...
        buf314 = reinterpret_tensor(buf233, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf233  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf309, arg135_1, buf314, 1048576, grid=grid(1048576), stream=stream0)
        buf315 = reinterpret_tensor(buf173, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [q_f_6, k_f_6, v_f_6, logit_bias_6, x_soft_12], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf309, arg135_1, buf315, 1048576, grid=grid(1048576), stream=stream0)
        buf316 = reinterpret_tensor(buf243, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf243  # reuse
        buf328 = reinterpret_tensor(buf239, (64, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf239  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf309, arg135_1, buf316, buf328, 1048576, grid=grid(1048576), stream=stream0)
        del arg135_1
        buf317 = reinterpret_tensor(buf229, (64, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf229  # reuse
        # Topologically Sorted Source Nodes: [q_f_6, k_f_6, v_f_6, logit_bias_6, x_soft_12], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf319 = buf318[0]
        del buf318
        buf323 = reinterpret_tensor(buf267, (1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), 0); del buf267  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg138_1
        buf327 = reinterpret_tensor(buf228, (64, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf228  # reuse
        ...
        del arg139_1
        buf329 = reinterpret_tensor(buf312, (512, 128, 16), (2048, 16, 1), 0); del buf312  # reuse
        # Topologically Sorted Source Nodes: [einsum_20], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf327, (512, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf328, (512, 128, 16), (2048, 16, 1), 0), out=buf329)
        buf330 = reinterpret_tensor(buf319, (1, 64, 128, 8, 16), (1048576, 16384, 128, 16, 1), 0); del buf319  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6], Original ATen: [aten.add]
        triton_poi_fused_add_19.run(buf330, buf329, 1048576, grid=grid(1048576), stream=stream0)
        buf331 = reinterpret_tensor(buf329, (8192, 128), (128, 1), 0); del buf329  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf330, (8192, 128), (128, 1), 0), reinterpret_tensor(arg140_1, (128, 128), (1, 128), 0), out=buf331)
        del arg140_1
        buf335 = reinterpret_tensor(buf330, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf330  # reuse
        # Topologically Sorted Source Nodes: [row_highway_6], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf335, 1048576, grid=grid(1048576), stream=stream0)
        buf337 = reinterpret_tensor(buf328, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf328  # reuse
        # Topologically Sorted Source Nodes: [row_highway_5], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf337, 1048576, grid=grid(1048576), stream=stream0)
        buf341 = reinterpret_tensor(buf316, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf316  # reuse
        # Topologically Sorted Source Nodes: [col_highway_5], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf341, 1048576, grid=grid(1048576), stream=stream0)
        buf356 = reinterpret_tensor(buf315, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf315  # reuse
        # Topologically Sorted Source Nodes: [col_highway_6], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf356, 1048576, grid=grid(1048576), stream=stream0)
        buf365 = reinterpret_tensor(buf323, (1, 8192, 512), (4194304, 512, 1), 0); del buf323  # reuse
        buf361 = reinterpret_tensor(buf365, (1, 8192, 128), (4194304, 512, 1), 0)  # alias
        ...
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_42.run(buf271, buf331, arg141_1, arg42_1, arg142_1, arg143_1, buf335, buf356, buf361, buf337, buf341, 8192, 128, grid=grid(8192), stream=stream0)
        del arg142_1
        del arg143_1
        # Topologically Sorted Source Nodes: [toks_9, index_add__22, index_add__23], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_43.run(buf140, buf141, buf274, buf301, arg125_1, buf146, buf337, buf341, 7372800, grid=grid(7372800), stream=stream0)
        buf340 = buf272; del buf272  # reuse
        # Topologically Sorted Source Nodes: [row_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf337, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf340)
        buf344 = buf242; del buf242  # reuse
        # Topologically Sorted Source Nodes: [col_t_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf341, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf344)
        buf345 = buf247; del buf247  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, g_5], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf274, buf301, arg125_1, buf345, 29952, 32, grid=grid(29952), stream=stream0)
        buf347 = reinterpret_tensor(buf350, (234, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf340, buf347, 958464, grid=grid(958464), stream=stream0)
        buf348 = reinterpret_tensor(buf350, (234, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf344, buf348, 958464, grid=grid(958464), stream=stream0)
        buf349 = reinterpret_tensor(buf350, (234, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_11], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf345, buf349, 958464, grid=grid(958464), stream=stream0)
        del buf346
        del buf347
        del buf348
        del buf349
        buf351 = reinterpret_tensor(buf344, (7488, 512), (512, 1), 0); del buf344  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf350, (7488, 512), (512, 1), 0), reinterpret_tensor(arg128_1, (512, 512), (1, 512), 0), out=buf351)
        del arg128_1
        buf352 = reinterpret_tensor(buf351, (234, 32, 512), (16384, 512, 1), 0); del buf351  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf352, arg129_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg129_1
        buf353 = reinterpret_tensor(buf300, (7488, 128), (128, 1), 0); del buf300  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf352, (7488, 512), (512, 1), 0), reinterpret_tensor(arg130_1, (512, 128), (1, 512), 0), out=buf353)
        del arg130_1
        buf354 = reinterpret_tensor(buf353, (234, 32, 128), (4096, 128, 1), 0); del buf353  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf354, buf274, buf301, arg125_1, arg131_1, 958464, grid=grid(958464), stream=stream0)
        del arg125_1
        del arg131_1
        # Topologically Sorted Source Nodes: [toks_11, index_add__26, index_add__27], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_49.run(buf140, buf141, buf354, buf146, buf335, buf356, 7372800, grid=grid(7372800), stream=stream0)
        buf359 = buf261; del buf261  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_3, g_6], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_22.run(buf271, buf331, arg141_1, buf359, 8192, 128, grid=grid(8192), stream=stream0)
        buf360 = buf262; del buf262  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_3, g_6], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_23.run(buf359, buf360, 128, 64, grid=grid(128), stream=stream0)
        buf362 = reinterpret_tensor(buf365, (1, 8192, 128), (4194304, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_13], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf335, buf362, 1048576, grid=grid(1048576), stream=stream0)
        buf363 = reinterpret_tensor(buf365, (1, 8192, 128), (4194304, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_13], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf356, buf363, 1048576, grid=grid(1048576), stream=stream0)
        buf364 = reinterpret_tensor(buf365, (1, 8192, 128), (4194304, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_13], Original ATen: [aten.cat]
        triton_poi_fused_cat_25.run(buf360, buf364, 1048576, grid=grid(1048576), stream=stream0)
        del buf361
        del buf362
        del buf363
        del buf364
        buf366 = reinterpret_tensor(buf310, (8192, 512), (512, 1), 0); del buf310  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf365, (8192, 512), (512, 1), 0), reinterpret_tensor(arg144_1, (512, 512), (1, 512), 0), out=buf366)
        del arg144_1
        buf367 = reinterpret_tensor(buf366, (1, 8192, 512), (4194304, 512, 1), 0); del buf366  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_26.run(buf367, arg145_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg145_1
        buf368 = reinterpret_tensor(buf356, (8192, 128), (128, 1), 0); del buf356  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf367, (8192, 512), (512, 1), 0), reinterpret_tensor(arg146_1, (512, 128), (1, 512), 0), out=buf368)
        del arg146_1
        buf369 = reinterpret_tensor(buf368, (1, 8192, 128), (1048576, 128, 1), 0); del buf368  # reuse
        buf406 = reinterpret_tensor(buf335, (1, 8192, 128), (1048576, 128, 1), 0); del buf335  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_3, h_diag_4, layer_norm_17], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_27.run(buf369, buf271, buf331, arg141_1, arg147_1, arg164_1, arg165_1, buf406, 8192, 128, grid=grid(8192), stream=stream0)
        del arg141_1
        del arg147_1
        del arg164_1
        del arg165_1
        buf370 = reinterpret_tensor(buf352, (1, 234, 16384), (3833856, 16384, 1), 0); del buf352  # reuse
        # Topologically Sorted Source Nodes: [row_p_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf369, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf370)
        buf371 = reinterpret_tensor(buf350, (1, 234, 16384), (3833856, 16384, 1), 0); del buf350  # reuse
        # Topologically Sorted Source Nodes: [col_p_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf369, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf371)
        buf372 = buf354; del buf354  # reuse
        buf376 = reinterpret_tensor(buf301, (234, 32, 128), (4096, 128, 1), 0); del buf301  # reuse
        # Topologically Sorted Source Nodes: [h_off_9, off_in_2, layer_norm_15], Original ATen: [aten.mean, aten.add, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_50.run(buf372, buf370, buf371, arg148_1, arg149_1, buf376, 7488, 128, grid=grid(7488), stream=stream0)
        del arg148_1
        del arg149_1
        buf377 = buf279; del buf279  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf376, (7488, 128), (128, 1), 0), reinterpret_tensor(arg150_1, (128, 384), (1, 128), 0), out=buf377)
        del arg150_1
        ...
        buf382 = reinterpret_tensor(buf376, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf376  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf377, arg151_1, buf382, 958464, grid=grid(958464), stream=stream0)
        buf383 = reinterpret_tensor(buf274, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf274  # reuse
        # Topologically Sorted Source Nodes: [q_f_7, k_f_7, v_f_7, logit_bias_7, x_soft_14], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf377, arg151_1, buf383, 958464, grid=grid(958464), stream=stream0)
        buf384 = reinterpret_tensor(buf298, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf298  # reuse
        buf396 = reinterpret_tensor(buf280, (234, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf280  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf377, arg151_1, buf384, buf396, 958464, grid=grid(958464), stream=stream0)
        del arg151_1
        buf385 = reinterpret_tensor(buf297, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf297  # reuse
        # Topologically Sorted Source Nodes: [q_f_7, k_f_7, v_f_7, logit_bias_7, x_soft_14], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf387 = buf386[0]
        del buf386
        buf391 = reinterpret_tensor(buf384, (234, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf384  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf380, buf378, buf391, 958464, grid=grid(958464), stream=stream0)
        buf392 = reinterpret_tensor(buf371, (239616, 16), (16, 1), 0); del buf371  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg154_1
        buf395 = reinterpret_tensor(buf296, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf296  # reuse
        ...
        del arg155_1
        buf397 = reinterpret_tensor(buf391, (1872, 32, 16), (512, 16, 1), 0); del buf391  # reuse
        # Topologically Sorted Source Nodes: [einsum_23], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf395, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf396, (1872, 32, 16), (512, 16, 1), 0), out=buf397)
        buf398 = reinterpret_tensor(buf387, (234, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf387  # reuse
        # Topologically Sorted Source Nodes: [x_mid_7], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf398, buf397, 958464, grid=grid(958464), stream=stream0)
        buf399 = reinterpret_tensor(buf397, (7488, 128), (128, 1), 0); del buf397  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf398, (7488, 128), (128, 1), 0), reinterpret_tensor(arg156_1, (128, 128), (1, 128), 0), out=buf399)
        del arg156_1
        buf448 = reinterpret_tensor(buf393, (234, 32, 512), (16384, 512, 1), 0); del buf393  # reuse
        buf444 = reinterpret_tensor(buf448, (234, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_3, z_14], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf372, buf399, arg157_1, arg158_1, arg159_1, buf444, 7488, 128, grid=grid(7488), stream=stream0)
        del arg158_1
        del arg159_1
        buf407 = buf309; del buf309  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf406, (8192, 128), (128, 1), 0), reinterpret_tensor(arg166_1, (128, 384), (1, 128), 0), out=buf407)
        del arg166_1
        buf408 = reinterpret_tensor(buf367, (1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), 0); del buf367  # reuse
        ...
        buf410 = reinterpret_tensor(buf406, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf406  # reuse
        ...
        buf412 = reinterpret_tensor(buf331, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf331  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf407, arg167_1, buf412, 1048576, grid=grid(1048576), stream=stream0)
        buf413 = reinterpret_tensor(buf271, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf271  # reuse
        # Topologically Sorted Source Nodes: [q_f_8, k_f_8, v_f_8, logit_bias_8, x_soft_16], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf407, arg167_1, buf413, 1048576, grid=grid(1048576), stream=stream0)
        buf414 = reinterpret_tensor(buf341, (64, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf341  # reuse
        buf426 = reinterpret_tensor(buf337, (64, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf337  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf407, arg167_1, buf414, buf426, 1048576, grid=grid(1048576), stream=stream0)
        del arg167_1
        del buf407
        buf415 = reinterpret_tensor(buf327, (64, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf327  # reuse
        # Topologically Sorted Source Nodes: [q_f_8, k_f_8, v_f_8, logit_bias_8, x_soft_16], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf417 = buf416[0]
        del buf416
        buf421 = reinterpret_tensor(buf365, (1, 64, 128, 128, 4), (4194304, 65536, 512, 4, 1), 0); del buf365  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg170_1
        del buf423
        buf425 = reinterpret_tensor(buf326, (64, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf326  # reuse
        ...
        del arg171_1
        del buf424
        buf427 = reinterpret_tensor(buf410, (512, 128, 16), (2048, 16, 1), 0); del buf410  # reuse
        # Topologically Sorted Source Nodes: [einsum_26], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf425, (512, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf426, (512, 128, 16), (2048, 16, 1), 0), out=buf427)
        del buf425
        buf428 = reinterpret_tensor(buf417, (1, 64, 128, 8, 16), (1048576, 16384, 128, 16, 1), 0); del buf417  # reuse
        # Topologically Sorted Source Nodes: [x_mid_8], Original ATen: [aten.add]
        triton_poi_fused_add_19.run(buf428, buf427, 1048576, grid=grid(1048576), stream=stream0)
        buf429 = reinterpret_tensor(buf427, (8192, 128), (128, 1), 0); del buf427  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf428, (8192, 128), (128, 1), 0), reinterpret_tensor(arg172_1, (128, 128), (1, 128), 0), out=buf429)
        del arg172_1
        buf433 = reinterpret_tensor(buf428, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf428  # reuse
        # Topologically Sorted Source Nodes: [row_highway_8], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf433, 1048576, grid=grid(1048576), stream=stream0)
        buf435 = reinterpret_tensor(buf426, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf426  # reuse
        # Topologically Sorted Source Nodes: [row_highway_7], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf435, 1048576, grid=grid(1048576), stream=stream0)
        buf439 = reinterpret_tensor(buf414, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf414  # reuse
        # Topologically Sorted Source Nodes: [col_highway_7], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf439, 1048576, grid=grid(1048576), stream=stream0)
        buf454 = reinterpret_tensor(buf413, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf413  # reuse
        # Topologically Sorted Source Nodes: [col_highway_8], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf454, 1048576, grid=grid(1048576), stream=stream0)
        buf463 = reinterpret_tensor(buf421, (1, 8192, 512), (4194304, 512, 1), 0); del buf421  # reuse
        buf459 = reinterpret_tensor(buf463, (1, 8192, 128), (4194304, 512, 1), 0)  # alias
        ...
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_42.run(buf369, buf429, arg173_1, arg42_1, arg174_1, arg175_1, buf433, buf454, buf459, buf435, buf439, 8192, 128, grid=grid(8192), stream=stream0)
        del arg174_1
        del arg175_1
        # Topologically Sorted Source Nodes: [toks_13, index_add__30, index_add__31], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_43.run(buf140, buf141, buf372, buf399, arg157_1, buf146, buf435, buf439, 7372800, grid=grid(7372800), stream=stream0)
        buf438 = buf370; del buf370  # reuse
        # Topologically Sorted Source Nodes: [row_t_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf435, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf438)
        buf442 = buf340; del buf340  # reuse
        # Topologically Sorted Source Nodes: [col_t_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf439, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf442)
        buf443 = buf345; del buf345  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_3, g_7], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf372, buf399, arg157_1, buf443, 29952, 32, grid=grid(29952), stream=stream0)
        buf445 = reinterpret_tensor(buf448, (234, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_15], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf438, buf445, 958464, grid=grid(958464), stream=stream0)
        buf446 = reinterpret_tensor(buf448, (234, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_15], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf442, buf446, 958464, grid=grid(958464), stream=stream0)
        buf447 = reinterpret_tensor(buf448, (234, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_15], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf443, buf447, 958464, grid=grid(958464), stream=stream0)
        del buf444
        del buf445
        del buf446
        del buf447
        buf449 = reinterpret_tensor(buf442, (7488, 512), (512, 1), 0); del buf442  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf448, (7488, 512), (512, 1), 0), reinterpret_tensor(arg160_1, (512, 512), (1, 512), 0), out=buf449)
        del arg160_1
        buf450 = reinterpret_tensor(buf449, (234, 32, 512), (16384, 512, 1), 0); del buf449  # reuse
        # Topologically Sorted Source Nodes: [input_56], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf450, arg161_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg161_1
        buf451 = reinterpret_tensor(buf398, (7488, 128), (128, 1), 0); del buf398  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf450, (7488, 512), (512, 1), 0), reinterpret_tensor(arg162_1, (512, 128), (1, 512), 0), out=buf451)
        del arg162_1
        buf452 = reinterpret_tensor(buf451, (234, 32, 128), (4096, 128, 1), 0); del buf451  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_3, off_stream_3], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf452, buf372, buf399, arg157_1, arg163_1, 958464, grid=grid(958464), stream=stream0)
        del arg157_1
        del arg163_1
        # Topologically Sorted Source Nodes: [toks_15, index_add__34, index_add__35], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_49.run(buf140, buf141, buf452, buf146, buf433, buf454, 7372800, grid=grid(7372800), stream=stream0)
        buf457 = buf359; del buf359  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_4, g_8], Original ATen: [aten.add, aten.mean]
        triton_red_fused_add_mean_22.run(buf369, buf429, arg173_1, buf457, 8192, 128, grid=grid(8192), stream=stream0)
        buf458 = buf360; del buf360  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_4, g_8], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_23.run(buf457, buf458, 128, 64, grid=grid(128), stream=stream0)
        buf460 = reinterpret_tensor(buf463, (1, 8192, 128), (4194304, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_17], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf433, buf460, 1048576, grid=grid(1048576), stream=stream0)
        buf461 = reinterpret_tensor(buf463, (1, 8192, 128), (4194304, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_17], Original ATen: [aten.cat]
        triton_poi_fused_cat_24.run(buf454, buf461, 1048576, grid=grid(1048576), stream=stream0)
        buf462 = reinterpret_tensor(buf463, (1, 8192, 128), (4194304, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_17], Original ATen: [aten.cat]
        triton_poi_fused_cat_25.run(buf458, buf462, 1048576, grid=grid(1048576), stream=stream0)
        del buf458
        del buf459
        del buf460
        del buf461
        del buf462
        buf464 = reinterpret_tensor(buf408, (8192, 512), (512, 1), 0); del buf408  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf463, (8192, 512), (512, 1), 0), reinterpret_tensor(arg176_1, (512, 512), (1, 512), 0), out=buf464)
        del arg176_1
        del buf463
        buf465 = reinterpret_tensor(buf464, (1, 8192, 512), (4194304, 512, 1), 0); del buf464  # reuse
        # Topologically Sorted Source Nodes: [input_62], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_26.run(buf465, arg177_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg177_1
        buf466 = reinterpret_tensor(buf454, (8192, 128), (128, 1), 0); del buf454  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf465, (8192, 512), (512, 1), 0), reinterpret_tensor(arg178_1, (512, 128), (1, 512), 0), out=buf466)
        del arg178_1
        del buf465
        buf505 = buf433; del buf433  # reuse
        # Topologically Sorted Source Nodes: [row_highway_9], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf505, 1048576, grid=grid(1048576), stream=stream0)
        buf509 = buf439; del buf439  # reuse
        # Topologically Sorted Source Nodes: [col_highway_9], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf509, 1048576, grid=grid(1048576), stream=stream0)
        buf535 = buf435; del buf435  # reuse
        # Topologically Sorted Source Nodes: [col_highway_10], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf535, 1048576, grid=grid(1048576), stream=stream0)
        buf538 = reinterpret_tensor(buf412, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf412  # reuse
        # Topologically Sorted Source Nodes: [row_highway_10], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf538, 1048576, grid=grid(1048576), stream=stream0)
        buf467 = reinterpret_tensor(buf466, (1, 8192, 128), (1048576, 128, 1), 0); del buf466  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_4, h_diag_5, row_highway_9, index_add__36, col_highway_9, index_add__37, col_highway_10, index_add__41, row_highway_10, index_add__40], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_51.run(buf467, buf369, buf429, arg173_1, arg179_1, arg42_1, buf505, buf509, buf535, buf538, 1048576, grid=grid(1048576), stream=stream0)
        del arg173_1
        del arg179_1
        buf468 = reinterpret_tensor(buf450, (1, 234, 16384), (3833856, 16384, 1), 0); del buf450  # reuse
        # Topologically Sorted Source Nodes: [row_p_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf467, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf468)
        buf469 = reinterpret_tensor(buf448, (1, 234, 16384), (3833856, 16384, 1), 0); del buf448  # reuse
        # Topologically Sorted Source Nodes: [col_p_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf467, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf469)
        buf470 = buf452; del buf452  # reuse
        buf474 = reinterpret_tensor(buf399, (234, 32, 128), (4096, 128, 1), 0); del buf399  # reuse
        ...
        triton_per_fused_add_mean_native_layer_norm_50.run(buf470, buf468, buf469, arg180_1, arg181_1, buf474, 7488, 128, grid=grid(7488), stream=stream0)
        del arg180_1
        del arg181_1
        buf475 = buf377; del buf377  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf474, (7488, 128), (128, 1), 0), reinterpret_tensor(arg182_1, (128, 384), (1, 128), 0), out=buf475)
        del arg182_1
        ...
        buf480 = reinterpret_tensor(buf474, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf474  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_33.run(buf475, arg183_1, buf480, 958464, grid=grid(958464), stream=stream0)
        buf481 = reinterpret_tensor(buf372, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf372  # reuse
        # Topologically Sorted Source Nodes: [q_f_9, k_f_9, v_f_9, logit_bias_9, x_soft_18], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_34.run(buf475, arg183_1, buf481, 958464, grid=grid(958464), stream=stream0)
        buf482 = reinterpret_tensor(buf396, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf396  # reuse
        buf494 = reinterpret_tensor(buf378, (234, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf378  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_35.run(buf475, arg183_1, buf482, buf494, 958464, grid=grid(958464), stream=stream0)
        del arg183_1
        del buf475
        buf483 = reinterpret_tensor(buf395, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf395  # reuse
        # Topologically Sorted Source Nodes: [q_f_9, k_f_9, v_f_9, logit_bias_9, x_soft_18], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf485 = buf484[0]
        del buf484
        buf489 = reinterpret_tensor(buf482, (234, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf482  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf478, buf476, buf489, 958464, grid=grid(958464), stream=stream0)
        del buf476
        buf490 = reinterpret_tensor(buf469, (239616, 16), (16, 1), 0); del buf469  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg186_1
        buf493 = reinterpret_tensor(buf394, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf394  # reuse
        ...
        del arg187_1
        del buf492
        buf495 = reinterpret_tensor(buf489, (1872, 32, 16), (512, 16, 1), 0); del buf489  # reuse
        # Topologically Sorted Source Nodes: [einsum_29], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf493, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf494, (1872, 32, 16), (512, 16, 1), 0), out=buf495)
        del buf493
        del buf494
        buf496 = reinterpret_tensor(buf485, (234, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf485  # reuse
        # Topologically Sorted Source Nodes: [x_mid_9], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf496, buf495, 958464, grid=grid(958464), stream=stream0)
        buf497 = reinterpret_tensor(buf495, (7488, 128), (128, 1), 0); del buf495  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf496, (7488, 128), (128, 1), 0), reinterpret_tensor(arg188_1, (128, 128), (1, 128), 0), out=buf497)
        del arg188_1
        buf518 = reinterpret_tensor(buf491, (234, 32, 512), (16384, 512, 1), 0); del buf491  # reuse
        buf514 = reinterpret_tensor(buf518, (234, 32, 128), (16384, 512, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o_4, z_18], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf470, buf497, arg189_1, arg190_1, arg191_1, buf514, 7488, 128, grid=grid(7488), stream=stream0)
        del arg190_1
        del arg191_1
        buf501 = buf429; del buf429  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf467, (8192, 128), (128, 1), 0), reinterpret_tensor(arg196_1, (128, 128), (1, 128), 0), out=buf501)
        del arg196_1
        buf502 = reinterpret_tensor(buf501, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf501  # reuse
        # Topologically Sorted Source Nodes: [input_71], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_2.run(buf502, arg197_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg197_1
        buf503 = reinterpret_tensor(buf369, (8192, 128), (128, 1), 0); del buf369  # reuse
        # Topologically Sorted Source Nodes: [input_72], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg199_1, reinterpret_tensor(buf502, (8192, 128), (128, 1), 0), reinterpret_tensor(arg198_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf503)
        del arg198_1
        del arg199_1
        buf504 = reinterpret_tensor(buf502, (64, 128, 128), (16384, 128, 1), 0); del buf502  # reuse
        ...
        triton_poi_fused_index_add_index_select_43.run(buf140, buf141, buf470, buf497, arg189_1, buf146, buf505, buf509, 7372800, grid=grid(7372800), stream=stream0)
        buf508 = buf468; del buf468  # reuse
        # Topologically Sorted Source Nodes: [row_t_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf505, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf508)
        del arg30_1
        del buf505
        buf512 = buf438; del buf438  # reuse
        # Topologically Sorted Source Nodes: [col_t_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf509, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf512)
        del arg31_1
        del buf509
        buf513 = buf443; del buf443  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_4, g_9], Original ATen: [aten.add, aten.mean]
        triton_per_fused_add_mean_44.run(buf470, buf497, arg189_1, buf513, 29952, 32, grid=grid(29952), stream=stream0)
        buf515 = reinterpret_tensor(buf518, (234, 32, 128), (16384, 512, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_19], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf508, buf515, 958464, grid=grid(958464), stream=stream0)
        del buf508
        buf516 = reinterpret_tensor(buf518, (234, 32, 128), (16384, 512, 1), 256)  # alias
        # Topologically Sorted Source Nodes: [z_19], Original ATen: [aten.cat]
        triton_poi_fused_cat_45.run(buf512, buf516, 958464, grid=grid(958464), stream=stream0)
        buf517 = reinterpret_tensor(buf518, (234, 32, 128), (16384, 512, 1), 384)  # alias
        # Topologically Sorted Source Nodes: [z_19], Original ATen: [aten.cat]
        triton_poi_fused_cat_46.run(buf513, buf517, 958464, grid=grid(958464), stream=stream0)
        del buf513
        del buf514
        del buf515
        del buf516
        del buf517
        buf519 = reinterpret_tensor(buf512, (7488, 512), (512, 1), 0); del buf512  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf518, (7488, 512), (512, 1), 0), reinterpret_tensor(arg192_1, (512, 512), (1, 512), 0), out=buf519)
        del arg192_1
        del buf518
        buf520 = reinterpret_tensor(buf519, (234, 32, 512), (16384, 512, 1), 0); del buf519  # reuse
        # Topologically Sorted Source Nodes: [input_68], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_47.run(buf520, arg193_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg193_1
        buf521 = reinterpret_tensor(buf496, (7488, 128), (128, 1), 0); del buf496  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf520, (7488, 512), (512, 1), 0), reinterpret_tensor(arg194_1, (512, 128), (1, 512), 0), out=buf521)
        del arg194_1
        del buf520
        buf522 = reinterpret_tensor(buf521, (234, 32, 128), (4096, 128, 1), 0); del buf521  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_4, off_stream_4], Original ATen: [aten.add]
        triton_poi_fused_add_48.run(buf522, buf470, buf497, arg189_1, arg195_1, 958464, grid=grid(958464), stream=stream0)
        del arg189_1
        del arg195_1
        del buf470
        buf523 = buf497; del buf497  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf522, (7488, 128), (128, 1), 0), reinterpret_tensor(arg200_1, (128, 128), (1, 128), 0), out=buf523)
        del arg200_1
        buf524 = reinterpret_tensor(buf523, (234, 1, 32, 128), (4096, 1, 128, 1), 0); del buf523  # reuse
        # Topologically Sorted Source Nodes: [input_74], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_52.run(buf524, arg201_1, 958464, grid=grid(958464), stream=stream0)
        del arg201_1
        ...
        extern_kernels.addmm(arg203_1, reinterpret_tensor(buf524, (7488, 128), (128, 1), 0), reinterpret_tensor(arg202_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf525)
        del arg202_1
        del arg203_1
        buf526 = reinterpret_tensor(buf524, (7488, 128), (128, 1), 0); del buf524  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf522, (7488, 128), (128, 1), 0), reinterpret_tensor(arg204_1, (128, 128), (1, 128), 0), out=buf526)
        del arg204_1
        buf527 = reinterpret_tensor(buf526, (234, 1, 32, 128), (4096, 1, 128, 1), 0); del buf526  # reuse
        # Topologically Sorted Source Nodes: [input_77], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_52.run(buf527, arg205_1, 958464, grid=grid(958464), stream=stream0)
        del arg205_1
        buf528 = empty_strided_cuda((7488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_78], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg207_1, reinterpret_tensor(buf527, (7488, 128), (128, 1), 0), reinterpret_tensor(arg206_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf528)
        del arg206_1
        del arg207_1
        del buf527
        ...
        extern_kernels.addmm(arg211_1, reinterpret_tensor(buf467, (8192, 128), (128, 1), 0), reinterpret_tensor(arg210_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf530)
        del arg210_1
        del arg211_1
        buf531 = empty_strided_cuda((8192, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg213_1, reinterpret_tensor(buf467, (8192, 128), (128, 1), 0), reinterpret_tensor(arg212_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf531)
        del arg212_1
        del arg213_1
        buf532 = reinterpret_tensor(buf457, (8192, 1), (1, 1), 0); del buf457  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf467, (8192, 128), (128, 1), 0), reinterpret_tensor(arg208_1, (128, 1), (1, 128), 0), out=buf532)
        del arg208_1
        del buf467
        ...
        triton_poi_fused_index_add_index_select_49.run(buf146, buf141, buf522, buf140, buf535, buf538, 7372800, grid=grid(7372800), stream=stream0)
        del buf522
    return (buf534, reinterpret_tensor(buf533, (1, 64, 128), (8192, 128, 1), 0), reinterpret_tensor(buf535, (1, 8192, 128), (1048576, 128, 1), 0), reinterpret_tensor(buf538, (1, 8192, 128), (1048576, 128, 1), 0), arg42_1, buf140, buf146, buf141, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg134_1 = rand_strided((384, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg146_1 = rand_strided((128, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg150_1 = rand_strided((384, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg156_1 = rand_strided((128, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg160_1 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    arg161_1 = rand_strided((512, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg162_1 = rand_strided((128, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg166_1 = rand_strided((384, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg172_1 = rand_strided((128, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg176_1 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    arg177_1 = rand_strided((512, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg178_1 = rand_strided((128, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg182_1 = rand_strided((384, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg188_1 = rand_strided((128, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg192_1 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    arg193_1 = rand_strided((512, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg194_1 = rand_strided((128, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    arg195_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg196_1 = rand_strided((128, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg200_1 = rand_strided((128, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg201_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg202_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg203_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg204_1 = rand_strided((128, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg205_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg206_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg207_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg208_1 = rand_strided((1, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg209_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg210_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg211_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg212_1 = rand_strided((32, 128), (128, 1), device='cuda:0', dtype=torch.float32)
