...
# Graph fragment:
#   %arg6_1 : Tensor "f32[1, 1153664][1153664, 1]mps:0" = PlaceHolder[target=arg6_1]
#   %arg7_1 : Tensor "f32[1, 234, 1, 1][234, 1, 1, 1]mps:0" = PlaceHolder[target=arg7_1]
#   %slice_2 : Tensor "f32[1, 239616][1153664, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%arg6_1, 1, 606208, 845824), kwargs = {})
#   %view_16 : Tensor "f32[1, 234, 32, 32][1153664, 1024, 32, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%slice_2, [1, 234, 32, 32]), kwargs = {})
...
#   %sub : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=6] = call_function[target=torch.ops.aten.sub.Tensor](args = (%arg4_1, %mul_2), kwargs = {})
#   return %sum_1,%sub
...
#   %bmm_2 : Tensor "f32[37, 32, 1][32, 1, 1]mps:0" = PlaceHolder[target=bmm_2]
...
#   %full_default_1 : Tensor "f32[234, 32][32, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([234, 32], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: mps:0, pin_memory: False})
#   %view_30 : Tensor "f32[1, 37, 32, 1][1184, 32, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm_2, [1, 37, 32, 1]), kwargs = {})
#   %select_1 : Tensor "f32[37, 32, 1][32, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%view_30, 0, 0), kwargs = {})
#   %view_32 : Tensor "f32[37, 32][32, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%select_1, [37, 32]), kwargs = {})
#   %slice_scatter_default : Tensor "f32[64, 32][32, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_1, %view_32, 0, 0, 37), kwargs = {})
...
#   %bmm_1 : Tensor "f32[37, 32, 1][32, 1, 1]mps:0" = PlaceHolder[target=bmm_1]
...
#   %view_24 : Tensor "f32[1, 37, 32, 1][1184, 32, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm_1, [1, 37, 32, 1]), kwargs = {})
#   %select : Tensor "f32[37, 32, 1][32, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%view_24, 0, 0), kwargs = {})
#   %view_31 : Tensor "f32[37, 32][32, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%select, [37, 32]), kwargs = {})
#   %slice_scatter_default_1 : Tensor "f32[64, 32][32, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full, %view_31, 0, 0, 37), kwargs = {})
...
#   y_r_final => view_41
# Graph fragment:
#   %bmm : Tensor "f32[37, 128, 1][128, 1, 1]mps:0" = PlaceHolder[target=bmm]
#   %bmm_5 : Tensor "f32[37, 128, 1][128, 1, 1]mps:0" = PlaceHolder[target=bmm_5]
#   %bmm_6 : Tensor "f32[37, 128, 1][128, 1, 1]mps:0" = PlaceHolder[target=bmm_6]
#   %sub : Tensor "f32[4736, 1][1, 1]mps:0" = PlaceHolder[target=sub]
#   %arg6_1 : Tensor "f32[1, 1153664][1153664, 1]mps:0" = PlaceHolder[target=arg6_1]
#   %arg23_1 : Tensor "f32[1, 4736][4736, 1]mps:0" = PlaceHolder[target=arg23_1]
#   %copy__3 : Tensor "f32[4736, 1][1, 1]mps:0" = PlaceHolder[target=copy__3]
#   %add_3 : Tensor "f32[1, 4736, 1][4736, 1, 4736]mps:0" = PlaceHolder[target=add_3]
#   %copy__2 : Tensor "f32[4736, 1][1, 1]mps:0" = PlaceHolder[target=copy__2]
#   %copy_ : Tensor "f32[4736, 1][1, 1]mps:0" = PlaceHolder[target=copy_]
#   %copy__1 : Tensor "f32[1][1]mps:0" = PlaceHolder[target=copy__1]
#   %sum_1 : Tensor "f32[][]mps:0" = PlaceHolder[target=sum_1]
#   %sum_2 : Tensor "f32[][]mps:0" = PlaceHolder[target=sum_2]
#   %add_4 : Tensor "f32[4736, 1][1, 4736]mps:0" = PlaceHolder[target=add_4]
#   %mm : Tensor "f32[4736, 1][1, 1]mps:0" = PlaceHolder[target=mm]
...
#   %view_10 : Tensor "f32[1, 37, 128, 1][4736, 128, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm, [1, 37, 128, 1]), kwargs = {})
#   %view_12 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_10, [1, 4736, 1]), kwargs = {})
#   %view_41 : Tensor "f32[1, 37, 128, 1][4736, 128, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm_5, [1, 37, 128, 1]), kwargs = {})
#   %view_46 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_41, [1, 4736, 1]), kwargs = {})
#   %view_45 : Tensor "f32[1, 37, 128, 1][4736, 128, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm_6, [1, 37, 128, 1]), kwargs = {})
#   %view_47 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_45, [1, 4736, 1]), kwargs = {})
#   %add_1 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_46, %view_47), kwargs = {})
#   %add_2 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_12, %add_1), kwargs = {})
#   %view_51 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%sub, [1, 4736, 1]), kwargs = {})
#   %mul_5 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_51, 1), kwargs = {})
#   %slice_15 : Tensor "f32[1, 4736][1153664, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%arg6_1, 1, 1148928, 9223372036854775807), kwargs = {})
#   %mul_4 : Tensor "f32[1, 4736][4736, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%slice_15, %arg23_1), kwargs = {})
#   %unsqueeze : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_4, -1), kwargs = {})
#   %mul_6 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_5, %unsqueeze), kwargs = {})
#   %add_3 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_2, %mul_6), kwargs = {})
#   %view_52 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.reshape.default](args = (%add_3, [4736, 1]), kwargs = {})
#   %mul_7 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %view_52), kwargs = {})
...
#   %mul_8 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg1_1, %div_1), kwargs = {})
#   %add_4 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_8, %view_52), kwargs = {})
#   %copy_ : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg1_1, %add_4), kwargs = {})
...
#   %copy__4 : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg5_1, %view_52), kwargs = {})
...
mps_lib_8 = compile_mps_shader('''
    ...
    kernel void generated_kernel(
        ...
        for(auto r0_0_cnt = 0; r0_0_cnt < 5; ++r0_0_cnt) {
            ...
            auto tmp8 = in_ptr4[1148928 + r0_0];
...
def partition_0(args):
    ...
    assert_size_stride(arg6_1, (1, 1153664), (1153664, 1))
    ...
    assert_size_stride(arg23_1, (1, 4736), (4736, 1))
    assert_size_stride(arg3_1, (4736, 1), (1, 1))
    assert_size_stride(arg5_1, (4736, 1), (1, 1))
    ...
    buf2 = empty_strided((4736, 1), (1, 1), device='mps', dtype=torch.float32)
    mps_lib_2.generated_kernel(buf1, buf2, arg1_1, buf0, arg4_1, arg2_1, threads=[1, 1024], group_size=[1, 1024])
    buf3 = empty_strided((37, 128, 1), (128, 1, 1), device='mps', dtype=torch.float32)
    ...
    extern_kernels.bmm(reinterpret_tensor(arg6_1, (37, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf2, (37, 128, 1), (128, 1, 0), 0), out=buf3)
    buf5 = empty_strided((37, 32, 1), (32, 1, 1), device='mps', dtype=torch.float32)
    ...
    extern_kernels.bmm(reinterpret_tensor(arg6_1, (37, 32, 128), (4096, 1, 32), 997376), reinterpret_tensor(buf2, (37, 128, 1), (128, 1, 1), 0), out=buf5)
    ...
    del arg16_1
    del buf6
    buf13 = empty_strided((37, 32, 1), (32, 1, 1), device='mps', dtype=torch.float32)
    ...
    extern_kernels.bmm(reinterpret_tensor(arg6_1, (37, 32, 128), (4096, 1, 32), 845824), reinterpret_tensor(buf2, (37, 128, 1), (128, 1, 1), 0), out=buf13)
    ...
    del buf4
    buf12 = empty_strided((37, 128, 1), (128, 1, 1), device='mps', dtype=torch.float32)
    # Topologically Sorted Source Nodes: [getitem_2, node_U, y_r_final], Original ATen: [aten.slice, aten.view, aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(arg6_1, (37, 128, 32), (4096, 32, 1), 845824), reinterpret_tensor(buf10, (37, 32, 1), (32, 1, 1), 0), out=buf12)
    ...
    del arg20_1
    del buf5
    buf20 = empty_strided((37, 128, 1), (128, 1, 1), device='mps', dtype=torch.float32)
    # Topologically Sorted Source Nodes: [getitem_3, node_V, y_c_final], Original ATen: [aten.slice, aten.view, aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(arg6_1, (37, 128, 32), (4096, 32, 1), 997376), reinterpret_tensor(buf18, (37, 32, 1), (32, 1, 1), 0), out=buf20)
    buf21 = empty_strided((1, 4736, 1), (4736, 1, 4736), device='mps', dtype=torch.float32)
    buf25 = empty_strided((4736, 1), (1, 4736), device='mps', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg5_1 = rand_strided((4736, 1), (1, 1), device='mps:0', dtype=torch.float32)
    arg6_1 = rand_strided((1, 1153664), (1153664, 1), device='mps:0', dtype=torch.float32)
    ...
    arg23_1 = rand_strided((1, 4736), (4736, 1), device='mps:0', dtype=torch.float32)
