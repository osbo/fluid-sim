...
#   unsqueeze => unsqueeze
# Graph fragment:
#   %arg0_1 : Tensor "f32[1, 4736, 9][43695, 9, 1]mps:0" = PlaceHolder[target=arg0_1]
#   %arg1_1 : Tensor "f32[1, 12][12, 1]mps:0" = PlaceHolder[target=arg1_1]
#   %slice_1 : Tensor "f32[1, 4736, 6][43695, 9, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%arg0_1, 2, 3, 9223372036854775807), kwargs = {})
...
#   %expand : Tensor "f32[1, 4736, 12][12, 0, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze, [-1, 4736, -1]), kwargs = {})
#   %cat : Tensor "f32[1, 4736, 18][85248, 18, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%slice_1, %expand], -1), kwargs = {})
#   return %cat
...
# Graph fragment:
#   %mm_default_22 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=mm_default_22]
#   %arg3_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg3_1]
#   %add_tensor_20 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_22, %arg3_1), kwargs = {})
#   %view_1 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_20, [1, 4736, 64]), kwargs = {})
#   %mul : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_1, 0.5), kwargs = {})
#   %mul_1 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_1, 0.7071067811865476), kwargs = {})
#   %erf : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_1,), kwargs = {})
#   %add : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf, 1), kwargs = {})
#   %mul_2 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul, %add), kwargs = {})
#   return %mul_2
...
#   aggr => full_default
# Graph fragment:
#   %full_default : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([4736, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: mps:0, pin_memory: False})
#   return %index_put
...
# Graph fragment:
#   %arg6_1 : Tensor "i64[2, 32026][32026, 1]mps:0" = PlaceHolder[target=arg6_1]
#   %addmm_2 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=addmm_2]
#   %arg7_1 : Tensor "f32[32026][1]mps:0" = PlaceHolder[target=arg7_1]
#   %index_put : Tensor "f32[4736, 64][128, 1]mps:0" = PlaceHolder[target=index_put]
#   %full_default : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([4736, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: mps:0, pin_memory: False})
#   %select : Tensor "i64[32026][1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg6_1, 0, 0), kwargs = {})
#   %select_1 : Tensor "i64[32026][1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg6_1, 0, 1), kwargs = {})
#   %index : Tensor "f32[32026, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%addmm_2, [%select_1]), kwargs = {})
#   %unsqueeze_1 : Tensor "f32[32026, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%arg7_1, -1), kwargs = {})
#   %mul_3 : Tensor "f32[32026, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%index, %unsqueeze_1), kwargs = {})
#   %index_put : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default, [%select], %mul_3, True), kwargs = {})
#   return %buf7
mps_lib_3 = compile_mps_shader('''
    ...
    kernel void generated_kernel(
        ...
        if ((tmp5 < 0) && (tmp5 > 4736)) return;
        auto tmp8 = tmp7 + tmp2;
        auto tmp9 = tmp7 < 0;
        auto tmp10 = tmp9 ? tmp8 : tmp7;
        if ((tmp10 < 0) && (tmp10 > 4736)) return;
...
# Graph fragment:
#   %mm_default_21 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=mm_default_21]
#   %arg13_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg13_1]
#   %add_tensor_19 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_21, %arg13_1), kwargs = {})
#   %mul_4 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_19, 0.5), kwargs = {})
#   %mul_5 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_tensor_19, 0.7071067811865476), kwargs = {})
#   %erf_1 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_5,), kwargs = {})
#   %add_1 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf_1, 1), kwargs = {})
#   %mul_6 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_4, %add_1), kwargs = {})
#   return %mul_6
...
#   x_flat => squeeze
# Graph fragment:
#   %addmm_1 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=addmm_1]
#   %mm_default_20 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=mm_default_20]
#   %arg15_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg15_1]
#   %view_3 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%addmm_1, [1, 4736, 64]), kwargs = {})
#   %squeeze : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.squeeze.dim](args = (%view_3, 0), kwargs = {})
#   %add_tensor_18 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_20, %arg15_1), kwargs = {})
#   %add_2 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%squeeze, %add_tensor_18), kwargs = {})
#   return %add_2
...
# Graph fragment:
#   %full_default_1 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([4736, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: mps:0, pin_memory: False})
#   return %index_put_1
...
#   x_flat_1 => squeeze_1
# Graph fragment:
#   %add_2 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=add_2]
#   %mm_default_18 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=mm_default_18]
#   %arg23_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg23_1]
#   %getitem_1 : Tensor "f32[1, 4736, 1][4736, 1, 4736]mps:0" = PlaceHolder[target=getitem_1]
#   %buf22 : Tensor "f32[1, 4736, 1][4736, 1, 4736]mps:0" = PlaceHolder[target=buf22]
...
#   %add_tensor_18 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_20, %arg15_1), kwargs = {})
#   %add_2 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%squeeze, %add_tensor_18), kwargs = {})
#   %unsqueeze_2 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%add_2, 0), kwargs = {})
#   %squeeze_1 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.squeeze.dim](args = (%unsqueeze_2, 0), kwargs = {})
#   %add_tensor_16 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_18, %arg23_1), kwargs = {})
#   %add_4 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%squeeze_1, %add_tensor_16), kwargs = {})
#   %unsqueeze_4 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%add_4, 0), kwargs = {})
...
#   %sub : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%unsqueeze_4, %getitem_1), kwargs = {})
#   %add_5 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem, 1e-05), kwargs = {})
#   %rsqrt : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_5,), kwargs = {})
#   %mul_11 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %rsqrt), kwargs = {})
#   %mul_12 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_11, %arg24_1), kwargs = {})
#   %add_6 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_12, %arg25_1), kwargs = {})
...
# Graph fragment:
#   %addmm_10 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=addmm_10]
#   %getitem_3 : Tensor "f32[1, 4736, 1][4736, 1, 4736]mps:0" = PlaceHolder[target=getitem_3]
#   %buf27 : Tensor "f32[1, 4736, 1][4736, 1, 4736]mps:0" = PlaceHolder[target=buf27]
#   %arg32_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg32_1]
#   %arg33_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg33_1]
#   %view_5 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.reshape.default](args = (%addmm_10, [1, 4736, 64]), kwargs = {})
...
#   %sub_1 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_5, %getitem_3), kwargs = {})
#   %add_8 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_2, 1e-05), kwargs = {})
#   %rsqrt_1 : Tensor "f32[1, 4736, 1][4736, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_8,), kwargs = {})
#   %mul_13 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_1, %rsqrt_1), kwargs = {})
#   %mul_14 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_13, %arg32_1), kwargs = {})
#   %add_9 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_14, %arg33_1), kwargs = {})
...
# Graph fragment:
#   %mm_default_17 : Tensor "f32[4736, 192][192, 1]mps:0" = PlaceHolder[target=mm_default_17]
#   %arg35_1 : Tensor "f32[192][1]mps:0" = PlaceHolder[target=arg35_1]
#   %add_tensor_15 : Tensor "f32[4736, 192][192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_17, %arg35_1), kwargs = {})
#   %view_24 : Tensor "f32[1, 37, 128, 192][909312, 24576, 192, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_15, [1, 37, 128, 192]), kwargs = {})
#   %slice_2 : Tensor "f32[1, 37, 128, 64][909312, 24576, 192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_24, 3, 0, 64), kwargs = {})
#   %view_25 : Tensor "f32[1, 37, 128, 8, 8][909312, 24576, 192, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%slice_2, [1, 37, 128, 8, 8]), kwargs = {})
#   %view_28 : Tensor "f32[37, 128, 8, 8][24576, 192, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_25, [37, 128, 8, 8]), kwargs = {})
#   %permute_22 : Tensor "f32[37, 8, 128, 8][24576, 8, 192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_28, [0, 2, 1, 3]), kwargs = {})
#   %clone_1 : Tensor "f32[37, 8, 128, 8][8192, 1024, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_22,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_1
...
#   %add_tensor_15 : Tensor "f32[4736, 192][192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_17, %arg35_1), kwargs = {})
#   %view_24 : Tensor "f32[1, 37, 128, 192][909312, 24576, 192, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_15, [1, 37, 128, 192]), kwargs = {})
#   %slice_3 : Tensor "f32[1, 37, 128, 64][909312, 24576, 192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_24, 3, 64, 128), kwargs = {})
#   %view_26 : Tensor "f32[1, 37, 128, 8, 8][909312, 24576, 192, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%slice_3, [1, 37, 128, 8, 8]), kwargs = {})
#   %view_29 : Tensor "f32[37, 128, 8, 8][24576, 192, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_26, [37, 128, 8, 8]), kwargs = {})
#   %permute_23 : Tensor "f32[37, 8, 128, 8][24576, 8, 192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_29, [0, 2, 1, 3]), kwargs = {})
#   %clone_2 : Tensor "f32[37, 8, 128, 8][8192, 1024, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_23,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_2
...
#   %add_tensor_15 : Tensor "f32[4736, 192][192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_17, %arg35_1), kwargs = {})
#   %view_24 : Tensor "f32[1, 37, 128, 192][909312, 24576, 192, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_15, [1, 37, 128, 192]), kwargs = {})
#   %slice_4 : Tensor "f32[1, 37, 128, 64][909312, 24576, 192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_24, 3, 128, 192), kwargs = {})
#   %view_27 : Tensor "f32[1, 37, 128, 8, 8][909312, 24576, 192, 8, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%slice_4, [1, 37, 128, 8, 8]), kwargs = {})
#   %view_30 : Tensor "f32[37, 128, 8, 8][24576, 192, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_27, [37, 128, 8, 8]), kwargs = {})
#   %permute_24 : Tensor "f32[37, 8, 128, 8][24576, 8, 192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_30, [0, 2, 1, 3]), kwargs = {})
#   %clone_3 : Tensor "f32[37, 8, 128, 8][8192, 1024, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_24,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_3
...
# Graph fragment:
#   %arg31_1 : Tensor "f32[37, 128, 128, 4][65536, 512, 4, 1]mps:0" = PlaceHolder[target=arg31_1]
#   %unsqueeze_17 : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%arg31_1, 0), kwargs = {})
#   %expand_3 : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze_17, [1, -1, -1, -1, -1]), kwargs = {})
...
#   %index_put_2 : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.index_put.default](args = (%expand_3, [None, None, %iota, %iota], %full_default_2), kwargs = {})
#   return %index_put_2
...
#   unsqueeze_9 => unsqueeze_17
# Graph fragment:
#   %index_put_2 : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0" = PlaceHolder[target=index_put_2]
#   %unsqueeze_17 : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%arg31_1, 0), kwargs = {})
#   %expand_3 : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze_17, [1, -1, -1, -1, -1]), kwargs = {})
#   %iota : Tensor "i64[128][1]mps:0"[num_users=2] = call_function[target=torch.ops.prims.iota.default](args = (128,), kwargs = {start: 0, step: 1, dtype: torch.int64, device: mps:0, requires_grad: False})
#   %full_default_2 : Tensor "f32[][]mps:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: mps:0, pin_memory: False})
...
# Graph fragment:
#   %buf32 : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0" = PlaceHolder[target=buf32]
#   %iota : Tensor "i64[128][1]mps:0"[num_users=2] = call_function[target=torch.ops.prims.iota.default](args = (128,), kwargs = {start: 0, step: 1, dtype: torch.int64, device: mps:0, requires_grad: False})
#   %select_5 : Tensor "f32[1, 37, 128, 128][2424832, 65536, 512, 4]mps:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%index_put_2, 4, 3), kwargs = {})
...
#   %index_put_3 : Tensor "f32[1, 37, 128, 128][606208, 16384, 128, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_5, [None, None, %iota, %iota], %full_default_3), kwargs = {})
#   return %index_put_3
...
#   setitem_1 => full_default_3, index_put_3, select_5
# Graph fragment:
#   %index_put_3 : Tensor "f32[1, 37, 128, 128][606208, 16384, 128, 1]mps:0" = PlaceHolder[target=index_put_3]
#   %iota : Tensor "i64[128][1]mps:0"[num_users=2] = call_function[target=torch.ops.prims.iota.default](args = (128,), kwargs = {start: 0, step: 1, dtype: torch.int64, device: mps:0, requires_grad: False})
#   %select_5 : Tensor "f32[1, 37, 128, 128][2424832, 65536, 512, 4]mps:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%index_put_2, 4, 3), kwargs = {})
#   %full_default_3 : Tensor "f32[][]mps:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 1.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: mps:0, pin_memory: False})
#   %index_put_3 : Tensor "f32[1, 37, 128, 128][606208, 16384, 128, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%select_5, [None, None, %iota, %iota], %full_default_3), kwargs = {})
...
# Graph fragment:
#   %buf34 : Tensor "f32[1, 37, 128, 128][606208, 16384, 128, 1]mps:0" = PlaceHolder[target=buf34]
#   %buf32 : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0" = PlaceHolder[target=buf32]
#   %select_scatter_default : Tensor "f32[1, 37, 128, 128, 4][2424832, 65536, 512, 4, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.select_scatter.default](args = (%index_put_2, %index_put_3, 4, 3), kwargs = {})
#   %select_8 : Tensor "f32[1, 37, 128, 128][2424832, 65536, 512, 4]mps:0"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%select_scatter_default, 4, 3), kwargs = {})
#   %view_32 : Tensor "f32[37, 1, 128, 128][65536, 65536, 512, 4]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%select_8, [37, 1, 128, 128]), kwargs = {})
#   %expand_5 : Tensor "f32[37, 8, 128, 128][65536, 0, 512, 4]mps:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%view_32, [37, 8, 128, 128]), kwargs = {})
#   %clone_4 : Tensor "f32[37, 8, 128, 128][131072, 16384, 128, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%expand_5,), kwargs = {})
#   return %clone_4
...
#   %slice_4 : Tensor "f32[1, 37, 128, 64][909312, 24576, 192, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_24, 3, 128, 192), kwargs = {})
#   %view_27 : Tensor "f32[1, 37, 128, 8, 8][909312, 24576, 192, 8, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%slice_4, [1, 37, 128, 8, 8]), kwargs = {})
#   %unsqueeze_19 : Tensor "f32[1, 37, 128, 8, 8, 1][909312, 24576, 192, 8, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%view_27, 5), kwargs = {})
#   %permute_29 : Tensor "f32[1, 37, 1, 8, 8, 128][909312, 24576, 1, 8, 1, 192]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%unsqueeze_19, [0, 1, 5, 3, 4, 2]), kwargs = {})
#   %permute_31 : Tensor "f32[37, 8, 128, 1, 8, 1][24576, 8, 192, 909312, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%permute_29, [1, 3, 5, 0, 4, 2]), kwargs = {})
#   %clone_6 : Tensor "f32[37, 8, 128, 1, 8, 1][8192, 1024, 8, 8, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_31,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_6
...
# Graph fragment:
#   %mm_default_16 : Tensor "f32[606208, 16][16, 1]mps:0" = PlaceHolder[target=mm_default_16]
#   %arg37_1 : Tensor "f32[16][1]mps:0" = PlaceHolder[target=arg37_1]
#   %add_tensor_14 : Tensor "f32[606208, 16][16, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_16, %arg37_1), kwargs = {})
#   %view_35 : Tensor "f32[1, 37, 128, 128, 16][9699328, 262144, 2048, 16, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_14, [1, 37, 128, 128, 16]), kwargs = {})
#   %mul_15 : Tensor "f32[1, 37, 128, 128, 16][9699328, 262144, 2048, 16, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_35, 0.5), kwargs = {})
#   %mul_16 : Tensor "f32[1, 37, 128, 128, 16][9699328, 262144, 2048, 16, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_35, 0.7071067811865476), kwargs = {})
#   %erf_3 : Tensor "f32[1, 37, 128, 128, 16][9699328, 262144, 2048, 16, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_16,), kwargs = {})
#   %add_10 : Tensor "f32[1, 37, 128, 128, 16][9699328, 262144, 2048, 16, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf_3, 1), kwargs = {})
#   %mul_17 : Tensor "f32[1, 37, 128, 128, 16][9699328, 262144, 2048, 16, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %add_10), kwargs = {})
#   return %mul_17
...
# Graph fragment:
#   %mm_default_15 : Tensor "f32[606208, 8][8, 1]mps:0" = PlaceHolder[target=mm_default_15]
#   %arg39_1 : Tensor "f32[8][1]mps:0" = PlaceHolder[target=arg39_1]
#   %add_tensor_13 : Tensor "f32[606208, 8][8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_15, %arg39_1), kwargs = {})
#   %view_37 : Tensor "f32[1, 37, 128, 128, 8][4849664, 131072, 1024, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_13, [1, 37, 128, 128, 8]), kwargs = {})
#   %unsqueeze_18 : Tensor "f32[1, 37, 128, 128, 8, 1][4849664, 131072, 1024, 8, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%view_37, 5), kwargs = {})
#   %permute_28 : Tensor "f32[1, 37, 128, 8, 1, 128][4849664, 131072, 1024, 1, 1, 8]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%unsqueeze_18, [0, 1, 2, 4, 5, 3]), kwargs = {})
#   %permute_30 : Tensor "f32[37, 8, 128, 128, 1, 1][131072, 1, 1024, 8, 4849664, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%permute_28, [1, 3, 2, 5, 0, 4]), kwargs = {})
#   %clone_5 : Tensor "f32[37, 8, 128, 128, 1, 1][131072, 16384, 128, 1, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_30,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_5
...
#   x_soft_1 => view_38
# Graph fragment:
#   %getitem_4 : Tensor "f32[37, 8, 128, 8][8192, 1024, 8, 1]mps:0" = PlaceHolder[target=getitem_4]
#   %bmm_2 : Tensor "f32[296, 128, 8][1024, 8, 1]mps:0" = PlaceHolder[target=bmm_2]
#   %permute_27 : Tensor "f32[37, 128, 8, 8][8192, 8, 1024, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_4, [0, 2, 1, 3]), kwargs = {})
#   %view_38 : Tensor "f32[1, 37, 128, 8, 8][303104, 8192, 8, 1024, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_27, [1, 37, 128, 8, 8]), kwargs = {})
#   %view_41 : Tensor "f32[37, 8, 128, 1, 1, 8][8192, 1024, 8, 8, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm_2, [37, 8, 128, 1, 1, 8]), kwargs = {})
#   %permute_32 : Tensor "f32[1, 37, 128, 8, 8, 1][8, 8192, 8, 1024, 1, 8]mps:0"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_41, [4, 0, 2, 1, 5, 3]), kwargs = {})
#   %view_42 : Tensor "f32[1, 37, 128, 8, 8][8, 8192, 8, 1024, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_32, [1, 37, 128, 8, 8]), kwargs = {})
#   %add_11 : Tensor "f32[1, 37, 128, 8, 8][303104, 8192, 8, 1024, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_38, %view_42), kwargs = {})
#   %clone_7 : Tensor "f32[1, 37, 128, 8, 8][303104, 8192, 64, 8, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%add_11,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_7
...
# Graph fragment:
#   %mm_default_13 : Tensor "f32[4736, 256][256, 1]mps:0" = PlaceHolder[target=mm_default_13]
#   %arg45_1 : Tensor "f32[256][1]mps:0" = PlaceHolder[target=arg45_1]
#   %add_tensor_11 : Tensor "f32[4736, 256][256, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_13, %arg45_1), kwargs = {})
#   %view_48 : Tensor "f32[1, 4736, 256][1212416, 256, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_11, [1, 4736, 256]), kwargs = {})
#   %mul_20 : Tensor "f32[1, 4736, 256][1212416, 256, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_48, 0.5), kwargs = {})
#   %mul_21 : Tensor "f32[1, 4736, 256][1212416, 256, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_48, 0.7071067811865476), kwargs = {})
#   %erf_4 : Tensor "f32[1, 4736, 256][1212416, 256, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_21,), kwargs = {})
#   %add_15 : Tensor "f32[1, 4736, 256][1212416, 256, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf_4, 1), kwargs = {})
#   %mul_22 : Tensor "f32[1, 4736, 256][1212416, 256, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_20, %add_15), kwargs = {})
#   return %mul_22
...
# Graph fragment:
#   %addmm_10 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=addmm_10]
#   %mm_default_14 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=mm_default_14]
#   %arg41_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg41_1]
#   %mm_default_12 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=mm_default_12]
#   %arg47_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg47_1]
#   %view_5 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.reshape.default](args = (%addmm_10, [1, 4736, 64]), kwargs = {})
#   %add_tensor_12 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_14, %arg41_1), kwargs = {})
#   %view_45 : Tensor "f32[1, 37, 128, 64][303104, 8192, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_12, [1, 37, 128, 64]), kwargs = {})
#   %view_46 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_45, [1, 4736, 64]), kwargs = {})
#   %add_12 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_5, %view_46), kwargs = {})
#   %add_tensor_10 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_12, %arg47_1), kwargs = {})
#   %view_50 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_10, [1, 4736, 64]), kwargs = {})
#   %add_16 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0"[num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_12, %view_50), kwargs = {})
#   return %add_16
...
# Graph fragment:
#   %add_16 : Tensor "f32[1, 4736, 64][303104, 64, 1]mps:0" = PlaceHolder[target=add_16]
#   %view_51 : Tensor "f32[1, 37, 128, 64][303104, 8192, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_16, [1, 37, 128, 64]), kwargs = {})
#   %constant_pad_nd_1 : Tensor "f32[1, 64, 128, 64][524288, 8192, 64, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view_51, [0, 0, 0, 0, 0, 27], 0.0), kwargs = {})
...
#   sigmoid => sigmoid
# Graph fragment:
#   %mm_default_2 : Tensor "f32[4736, 1][1, 1]mps:0" = PlaceHolder[target=mm_default_2]
#   %arg77_1 : Tensor "f32[1][1]mps:0" = PlaceHolder[target=arg77_1]
#   %add_tensor : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_2, %arg77_1), kwargs = {})
#   %view_116 : Tensor "f32[1, 37, 128, 1][4736, 128, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor, [1, 37, 128, 1]), kwargs = {})
#   %sigmoid : Tensor "f32[1, 37, 128, 1][4736, 128, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_116,), kwargs = {})
#   return %sigmoid
...
# Topologically Sorted Source Nodes: [input_22, input_23], Original ATen: [aten.addmm, aten.view, aten.gelu]
# Source node to ATen node mapping:
#   input_22 => add_tensor_5, view_93
#   input_23 => add_27, erf_7, mul_33, mul_34, mul_35
# Graph fragment:
#   %mm_default_7 : Tensor "f32[4736, 64][64, 1]mps:0" = PlaceHolder[target=mm_default_7]
#   %arg65_1 : Tensor "f32[64][1]mps:0" = PlaceHolder[target=arg65_1]
#   %add_tensor_5 : Tensor "f32[4736, 64][64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_7, %arg65_1), kwargs = {})
#   %view_93 : Tensor "f32[1, 37, 128, 64][303104, 8192, 64, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor_5, [1, 37, 128, 64]), kwargs = {})
#   %mul_33 : Tensor "f32[1, 37, 128, 64][303104, 8192, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_93, 0.5), kwargs = {})
#   %mul_34 : Tensor "f32[1, 37, 128, 64][303104, 8192, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_93, 0.7071067811865476), kwargs = {})
#   %erf_7 : Tensor "f32[1, 37, 128, 64][303104, 8192, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_34,), kwargs = {})
#   %add_27 : Tensor "f32[1, 37, 128, 64][303104, 8192, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf_7, 1), kwargs = {})
#   %mul_35 : Tensor "f32[1, 37, 128, 64][303104, 8192, 64, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_33, %add_27), kwargs = {})
#   return %mul_35
...
#   sigmoid => sigmoid
# Graph fragment:
#   %bmm_6 : Tensor "f32[37, 128, 128][16384, 128, 1]mps:0" = PlaceHolder[target=bmm_6]
#   %bmm_7 : Tensor "f32[234, 32, 32][1024, 32, 1]mps:0" = PlaceHolder[target=bmm_7]
#   %addmm_30 : Tensor "f32[4736, 32][32, 1]mps:0" = PlaceHolder[target=addmm_30]
#   %addmm_31 : Tensor "f32[4736, 32][32, 1]mps:0" = PlaceHolder[target=addmm_31]
#   %sigmoid : Tensor "f32[1, 37, 128, 1][4736, 128, 1, 1]mps:0" = PlaceHolder[target=sigmoid]
#   %view_98 : Tensor "f32[1, 37, 128, 128][606208, 16384, 128, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%bmm_6, [1, 37, 128, 128]), kwargs = {})
#   %view_122 : Tensor "f32[1, 606208][606208, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_98, [1, -1]), kwargs = {})
...
#   %view_119 : Tensor "f32[1, 4736, 32][151552, 32, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%addmm_30, [1, 4736, 32]), kwargs = {})
#   %view_124 : Tensor "f32[1, 151552][151552, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_119, [1, -1]), kwargs = {})
#   %view_121 : Tensor "f32[1, 4736, 32][151552, 32, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%addmm_31, [1, 4736, 32]), kwargs = {})
#   %view_125 : Tensor "f32[1, 151552][151552, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%view_121, [1, -1]), kwargs = {})
#   %cat_3 : Tensor "f32[1, 1148928][1148928, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_122, %view_123, %view_124, %view_125], 1), kwargs = {})
#   %add_tensor : Tensor "f32[4736, 1][1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mm_default_2, %arg77_1), kwargs = {})
#   %view_116 : Tensor "f32[1, 37, 128, 1][4736, 128, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_tensor, [1, 37, 128, 1]), kwargs = {})
#   %sigmoid : Tensor "f32[1, 37, 128, 1][4736, 128, 1, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_116,), kwargs = {})
#   %squeeze_2 : Tensor "f32[1, 37, 128][4736, 128, 1]mps:0"[num_users=2] = call_function[target=torch.ops.aten.squeeze.dim](args = (%sigmoid, -1), kwargs = {})
#   %view_117 : Tensor "f32[1, 4736][4736, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%squeeze_2, [1, 4736]), kwargs = {})
#   %cat_4 : Tensor "f32[1, 1153664][1153664, 1]mps:0"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_3, %view_117], 1), kwargs = {})
#   return %cat_4
mps_lib_35 = compile_mps_shader('''
    ...
    kernel void generated_kernel(
        ...
        auto tmp16 = in_ptr1[(-606208) + (x0)];
        auto tmp23 = in_ptr2[(-845824) + (x0)];
        auto tmp27 = in_ptr3[(-997376) + (x0)];
        auto tmp36 = in_ptr4[(-1148928) + x0];
        auto tmp0 = x0;
        auto tmp1 = static_cast<long>(tmp0);
        auto tmp2 = 0;
        auto tmp3 = tmp1 >= tmp2;
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(arg31_1, (37, 128, 128, 4), (65536, 512, 4, 1))
        ...
        buf0 = empty_strided((1, 4736, 18), (85248, 18, 1), device='mps', dtype=torch.float32)
        mps_lib_0.generated_kernel(buf0, arg0_1, arg1_1, threads=[85248])
        del arg0_1
        del arg1_1
        buf1 = empty_strided((4736, 64), (64, 1), device='mps', dtype=torch.float32)
        ...
        extern_kernels.mm(reinterpret_tensor(buf0, (4736, 18), (18, 1), 0), reinterpret_tensor(arg2_1, (18, 64), (1, 18), 0), out=buf1)
        del arg2_1
        del buf0
        buf2 = empty_strided((1, 4736, 64), (303104, 64, 1), device='mps', dtype=torch.float32)
        mps_lib_1.generated_kernel(buf2, buf1, arg3_1, threads=[303104])
        del arg3_1
        buf3 = buf1; del buf1  # reuse
        # Topologically Sorted Source Nodes: [input_1, input_2, input_3], Original ATen: [aten.addmm, aten.view, aten.gelu, aten.t]
        extern_kernels.addmm(arg5_1, reinterpret_tensor(buf2, (4736, 64), (64, 1), 0), reinterpret_tensor(arg4_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf3)
        del arg4_1
        del arg5_1
        buf8 = empty_strided((4736, 128), (128, 1), device='mps', dtype=torch.float32)
        buf4 = reinterpret_tensor(buf8, (4736, 64), (128, 1), 0)  # alias
        ...
        del arg10_1
        del arg11_1
        buf6 = reinterpret_tensor(buf8, (4736, 64), (128, 1), 64)  # alias
        mps_lib_2.generated_kernel(buf6, threads=[303104])
        buf5 = reinterpret_tensor(buf2, (4736, 64), (64, 1), 0); del buf2  # reuse
        ...
        del arg8_1
        del arg9_1
        mps_lib_3.generated_kernel(buf6, arg6_1, buf5, arg7_1, threads=[2049664])
        del buf4
        del buf6
        ...
        del arg12_1
        buf10 = empty_strided((4736, 64), (64, 1), device='mps', dtype=torch.float32)
        mps_lib_4.generated_kernel(buf10, buf9, arg13_1, threads=[303104])
        del arg13_1
        ...
        mps_lib_5.generated_kernel(buf12, buf3, buf11, arg15_1, threads=[303104])
        del arg15_1
        buf17 = buf8; del buf8  # reuse
        buf13 = reinterpret_tensor(buf17, (4736, 64), (128, 1), 0)  # alias
        ...
        del arg18_1
        del arg19_1
        buf15 = reinterpret_tensor(buf17, (4736, 64), (128, 1), 64)  # alias
        mps_lib_6.generated_kernel(buf15, threads=[303104])
        ...
        del arg16_1
        del arg17_1
        mps_lib_3.generated_kernel(buf15, arg6_1, buf14, arg7_1, threads=[2049664])
        del arg6_1
        del arg7_1
        del buf13
        del buf15
        ...
        mps_lib_4.generated_kernel(buf19, buf18, arg21_1, threads=[303104])
        del arg21_1
        ...
        del arg22_1
        buf24 = reinterpret_tensor(buf19, (1, 4736, 64), (303104, 64, 1), 0); del buf19  # reuse
        mps_lib_7.generated_kernel(buf24, buf12, buf20, arg23_1, arg24_1, arg25_1, threads=[4736, 64], group_size=[1, 64])
        del arg23_1
        del arg24_1
        del arg25_1
        ...
        extern_kernels.addmm(arg27_1, reinterpret_tensor(buf24, (4736, 64), (64, 1), 0), reinterpret_tensor(arg26_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf25)
        del arg26_1
        del arg27_1
        buf29 = buf24; del buf24  # reuse
        mps_lib_8.generated_kernel(buf29, buf25, arg32_1, arg33_1, threads=[4736, 64], group_size=[1, 64])
        del arg32_1
        del arg33_1
        buf30 = empty_strided((4736, 192), (192, 1), device='mps', dtype=torch.float32)
        ...
        extern_kernels.mm(reinterpret_tensor(buf29, (4736, 64), (64, 1), 0), reinterpret_tensor(arg34_1, (64, 192), (1, 64), 0), out=buf30)
        del arg34_1
        buf35 = reinterpret_tensor(buf29, (37, 8, 128, 8), (8192, 8, 64, 1), 0); del buf29  # reuse
        mps_lib_9.generated_kernel(buf35, buf30, arg35_1, threads=[303104])
        buf36 = reinterpret_tensor(buf12, (37, 8, 128, 8), (8192, 8, 64, 1), 0); del buf12  # reuse
        mps_lib_10.generated_kernel(buf36, buf30, arg35_1, threads=[303104])
        buf37 = empty_strided((37, 8, 128, 8), (8192, 8, 64, 1), device='mps', dtype=torch.float32)
        mps_lib_11.generated_kernel(buf37, buf30, arg35_1, threads=[303104])
        buf31 = empty_strided((1, 37, 128, 128, 4), (2424832, 65536, 512, 4, 1), device='mps', dtype=torch.float32)
        mps_lib_12.generated_kernel(buf31, arg31_1, threads=[2424832])
        del arg31_1
        mps_lib_13.generated_kernel(buf31, threads=[18944])
        buf33 = reinterpret_tensor(buf17, (1, 37, 128, 128), (606208, 16384, 128, 1), 0); del buf17  # reuse
        mps_lib_14.generated_kernel(buf33, buf31, threads=[606208])
        mps_lib_15.generated_kernel(buf33, threads=[4736])
        buf38 = empty_strided((37, 8, 128, 128), (131072, 16384, 128, 1), device='mps', dtype=torch.float32)
        mps_lib_16.generated_kernel(buf38, buf33, buf31, threads=[4849664])
        ...
        del buf38
        buf40 = buf39[0]
        assert_size_stride(buf40, (37, 8, 128, 8), (8192, 1024, 8, 1), 'torch.ops.aten._scaled_dot_product_attention_math_for_mps.default')
        assert_alignment(buf40, 16, 'torch.ops.aten._scaled_dot_product_attention_math_for_mps.default')
        del buf39
        buf47 = reinterpret_tensor(buf37, (37, 8, 128, 1, 8, 1), (8192, 1024, 8, 8, 1, 1), 0); del buf37  # reuse
        mps_lib_17.generated_kernel(buf47, buf30, arg35_1, threads=[303104])
        del arg35_1
        del buf30
        buf42 = empty_strided((1, 37, 128, 128, 4), (2424832, 65536, 512, 4, 1), device='mps', dtype=torch.float32)
        mps_lib_18.generated_kernel(buf42, buf33, buf31, threads=[2424832])
        del buf31
        del buf33
        buf43 = empty_strided((606208, 16), (16, 1), device='mps', dtype=torch.float32)
        # Topologically Sorted Source Nodes: [input_10], Original ATen: [aten.view, aten.t, aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf42, (606208, 4), (4, 1), 0), reinterpret_tensor(arg36_1, (4, 16), (1, 4), 0), out=buf43)
        del arg36_1
        del buf42
        buf44 = empty_strided((1, 37, 128, 128, 16), (9699328, 262144, 2048, 16, 1), device='mps', dtype=torch.float32)
        mps_lib_19.generated_kernel(buf44, buf43, arg37_1, threads=[9699328])
        del arg37_1
        del buf43
        buf45 = empty_strided((606208, 8), (8, 1), device='mps', dtype=torch.float32)
        # Topologically Sorted Source Nodes: [input_10, input_11, input_12], Original ATen: [aten.addmm, aten.view, aten.gelu, aten.t]
        extern_kernels.mm(reinterpret_tensor(buf44, (606208, 16), (16, 1), 0), reinterpret_tensor(arg38_1, (16, 8), (1, 16), 0), out=buf45)
        del arg38_1
        del buf44
        buf46 = empty_strided((37, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), device='mps', dtype=torch.float32)
        mps_lib_20.generated_kernel(buf46, buf45, arg39_1, threads=[296, 16384])
        del arg39_1
        del buf45
        buf48 = empty_strided((296, 128, 8), (1024, 8, 1), device='mps', dtype=torch.float32)
        ...
        extern_kernels.bmm(reinterpret_tensor(buf46, (296, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf47, (296, 128, 8), (1024, 8, 1), 0), out=buf48)
        del buf46
        buf49 = reinterpret_tensor(buf47, (1, 37, 128, 8, 8), (303104, 8192, 64, 8, 1), 0); del buf47  # reuse
        mps_lib_21.generated_kernel(buf49, buf40, buf48, threads=[303104])
        buf50 = reinterpret_tensor(buf48, (4736, 64), (64, 1), 0); del buf48  # reuse
        ...
        extern_kernels.mm(reinterpret_tensor(buf49, (4736, 64), (64, 1), 0), reinterpret_tensor(arg40_1, (64, 64), (1, 64), 0), out=buf50)
        del arg40_1
        buf54 = reinterpret_tensor(buf49, (1, 4736, 64), (303104, 64, 1), 0); del buf49  # reuse
        mps_lib_7.generated_kernel(buf54, buf25, buf50, arg41_1, arg42_1, arg43_1, threads=[4736, 64], group_size=[1, 64])
        del arg42_1
        del arg43_1
        buf55 = empty_strided((4736, 256), (256, 1), device='mps', dtype=torch.float32)
        ...
        extern_kernels.mm(reinterpret_tensor(buf54, (4736, 64), (64, 1), 0), reinterpret_tensor(arg44_1, (64, 256), (1, 64), 0), out=buf55)
        del arg44_1
        buf56 = empty_strided((1, 4736, 256), (1212416, 256, 1), device='mps', dtype=torch.float32)
        mps_lib_22.generated_kernel(buf56, buf55, arg45_1, threads=[1212416])
        del arg45_1
        del buf55
        buf57 = reinterpret_tensor(buf54, (4736, 64), (64, 1), 0); del buf54  # reuse
        # Topologically Sorted Source Nodes: [input_13, input_14, input_15], Original ATen: [aten.addmm, aten.view, aten.gelu, aten.t]
        extern_kernels.mm(reinterpret_tensor(buf56, (4736, 256), (256, 1), 0), reinterpret_tensor(arg46_1, (256, 64), (1, 256), 0), out=buf57)
        del arg46_1
        del buf56
        buf58 = reinterpret_tensor(buf40, (1, 4736, 64), (303104, 64, 1), 0); del buf40  # reuse
        mps_lib_23.generated_kernel(buf58, buf25, buf50, arg41_1, buf57, arg47_1, threads=[303104])
        del arg41_1
        del arg47_1
        del buf25
        del buf50
        ...
        del buf77
        buf110 = empty_strided((4736, 1), (1, 1), device='mps', dtype=torch.float32)
        # Topologically Sorted Source Nodes: [h_leaves_2, linear_29], Original ATen: [aten.view, aten.t, aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf58, (4736, 64), (64, 1), 0), reinterpret_tensor(arg76_1, (64, 1), (1, 64), 0), out=buf110)
        del arg76_1
        buf111 = empty_strided((1, 37, 128, 1), (4736, 128, 1, 1), device='mps', dtype=torch.float32)
        mps_lib_30.generated_kernel(buf111, buf110, arg77_1, threads=[4736])
        del arg77_1
        del buf110
        buf108 = empty_strided((4736, 32), (32, 1), device='mps', dtype=torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.view, aten.t, aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf58, (4736, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf108)
        del arg78_1
        del arg79_1
        buf109 = empty_strided((4736, 32), (32, 1), device='mps', dtype=torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.view, aten.t, aten.addmm]
        extern_kernels.addmm(arg81_1, reinterpret_tensor(buf58, (4736, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf109)
        del arg80_1
        del arg81_1
        buf92 = buf57; del buf57  # reuse
        # Topologically Sorted Source Nodes: [h_leaves, input_22], Original ATen: [aten.view, aten.t, aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf58, (4736, 64), (64, 1), 0), reinterpret_tensor(arg64_1, (64, 64), (1, 64), 0), out=buf92)
        del arg64_1
        buf93 = reinterpret_tensor(buf58, (1, 37, 128, 64), (303104, 8192, 64, 1), 0); del buf58  # reuse
        mps_lib_31.generated_kernel(buf93, buf92, arg65_1, threads=[303104])
        del arg65_1
        del buf92
        buf85 = reinterpret_tensor(buf75, (234, 8, 32, 1, 8, 1), (2048, 256, 8, 8, 1, 1), 0); del buf75  # reuse
        mps_lib_32.generated_kernel(buf85, buf67, arg51_1, threads=[479232])
        del arg51_1
        del buf67
        ...
        mps_lib_33.generated_kernel(buf84, buf83, arg55_1, threads=[1872, 1024])
        del arg55_1
        ...
        mps_lib_34.generated_kernel(buf87, buf78, buf86, threads=[479232])
        ...
        mps_lib_31.generated_kernel(buf102, buf101, arg69_1, threads=[479232])
        del arg69_1
        del buf101
        ...
        mps_lib_31.generated_kernel(buf105, buf104, arg73_1, threads=[479232])
        del arg73_1
        del buf104
        ...
        del buf103
        del buf106
        buf94 = empty_strided((4736, 128), (128, 1), device='mps', dtype=torch.float32)
        # Topologically Sorted Source Nodes: [input_22, input_23, input_24], Original ATen: [aten.addmm, aten.view, aten.gelu, aten.t]
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf93, (4736, 64), (64, 1), 0), reinterpret_tensor(arg66_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf94)
        del arg66_1
        del arg67_1
        del buf93
        buf95 = empty_strided((37, 128, 128), (16384, 128, 1), device='mps', dtype=torch.float32)
        # Topologically Sorted Source Nodes: [input_24, out_2, transpose_8], Original ATen: [aten.view, aten.transpose, aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf94, (37, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf94, (37, 128, 128), (16384, 1, 128), 0), out=buf95)
        del buf94
        buf112 = empty_strided((1, 1153664), (1153664, 1), device='mps', dtype=torch.float32)
        mps_lib_35.generated_kernel(buf112, buf95, buf107, buf108, buf109, buf111, threads=[1153664])
        return (buf112, reinterpret_tensor(buf111, (1, 37, 128), (4736, 128, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1, 4736, 9), (43695, 9, 1), device='mps:0', dtype=torch.float32)
    ...
    arg6_1 = rand_strided((2, 32026), (32026, 1), device='mps:0', dtype=torch.int64)
    arg7_1 = rand_strided((32026, ), (1, ), device='mps:0', dtype=torch.float32)
    ...
    arg31_1 = rand_strided((37, 128, 128, 4), (65536, 512, 4, 1), device='mps:0', dtype=torch.float32)
