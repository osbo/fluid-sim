...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/by/cby7p72bmbcacguoljuz2f77urrqh5cdou7txlvscorcknjijfjz.py
# Topologically Sorted Source Nodes: [h_k_3], Original ATen: [aten.constant_pad_nd]
# Source node to ATen node mapping:
#   h_k_3 => constant_pad_nd_1
# Graph fragment:
#   %constant_pad_nd_1 : [num_users=2] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view_51, [0, 0, 0, 0, 0, 32], 0.0), kwargs = {})
triton_poi_fused_constant_pad_nd_21 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_constant_pad_nd_21', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 1, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/un/cun6sxic2ds6jazyljnvwejuwgvq6mo46tcb5ib2xajfdwh76zh2.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7l/c7lnnwdfvsnsapn5ohm4q74gijvvngptolnwymmmhakqn47hf5aq.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3j/c3jyju3agw4c2qsrwttlvsj2p66o63y2i7u7zdu4rtu5vil52yed.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/wc/cwc7y72v34lgv66dmgag6npkvilyak3goikz3lvc2ypo6ezew3wr.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.full([1], 0, tl.int64)
    tmp2 = tmp0 >= tmp1
    tmp3 = tl.full([1], 1026048, tl.int64)
    tmp4 = tmp0 < tmp3
    ...
    tmp9 = tmp0 >= tmp5
    tmp10 = tl.full([1], 763904, tl.int64)
    tmp11 = tmp0 < tmp10
    tmp12 = tmp9 & tmp11
    tmp13 = tmp12 & tmp4
    tmp14 = tl.load(in_ptr1 + ((-524288) + x0), tmp13, eviction_policy='evict_last', other=0.0)
    tmp15 = tmp0 >= tmp10
    tmp16 = tl.full([1], 894976, tl.int64)
    tmp17 = tmp0 < tmp16
    tmp18 = tmp15 & tmp17
    tmp19 = tmp18 & tmp4
    tmp20 = tl.load(in_ptr2 + ((-763904) + x0), tmp19, eviction_policy='evict_last', other=0.0)
    tmp21 = tmp0 >= tmp16
    tmp22 = tmp21 & tmp4
    tmp23 = tl.load(in_ptr3 + ((-894976) + x0), tmp22, eviction_policy='evict_last', other=0.0)
    ...
    tmp29 = tmp0 >= tmp3
    tmp30 = tl.full([1], 1030144, tl.int64)
    tmp31 = tmp0 < tmp30
    tmp32 = tl.load(in_ptr4 + ((-1026048) + x0), tmp29, eviction_policy='evict_last', other=0.0)
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_20.run(buf60, buf25, buf52, arg41_1, arg47_1, arg64_1, arg65_1, buf99, 4096, 128, grid=grid(4096), stream=stream0)
        del arg41_1
        del arg47_1
        del arg64_1
        del arg65_1
        buf61 = reinterpret_tensor(buf17, (1, 64, 128, 128), (1048576, 16384, 128, 1), 0); del buf17  # reuse
        # Topologically Sorted Source Nodes: [h_k_3], Original ATen: [aten.constant_pad_nd]
        triton_poi_fused_constant_pad_nd_21.run(buf60, buf61, 1048576, grid=grid(1048576), stream=stream0)
        ...
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf61, (1, 64, 16384), (0, 16384, 1), 0), out=buf62)
        ...
        buf144 = empty_strided_cuda((234, 1, 32, 32, 4), (4096, 958464, 128, 4, 1), torch.float32)
        buf217 = empty_strided_cuda((234, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [sub, setitem_2, setitem_6], Original ATen: [aten.mean, aten.lift_fresh, aten.index_put]
        triton_per_fused_index_put_lift_fresh_mean_23.run(arg29_1, buf71, buf144, buf217, 958464, 16, grid=grid(958464), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        del arg56_1
        buf134 = reinterpret_tensor(buf91, (234, 32, 128), (4096, 128, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, z_1], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf64, buf92, arg57_1, arg58_1, arg59_1, buf134, 7488, 128, grid=grid(7488), stream=stream0)
        del arg58_1
        del arg59_1
        buf100 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (4096, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf100)
        del arg66_1
        ...
        buf103 = reinterpret_tensor(buf99, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf99  # reuse
        ...
        buf105 = reinterpret_tensor(buf52, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf52  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_11.run(buf100, arg67_1, buf105, 524288, grid=grid(524288), stream=stream0)
        buf106 = reinterpret_tensor(buf25, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf100, arg67_1, buf106, 524288, grid=grid(524288), stream=stream0)
        buf107 = buf37; del buf37  # reuse
        buf119 = reinterpret_tensor(buf36, (32, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf36  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf100, arg67_1, buf107, buf119, 524288, grid=grid(524288), stream=stream0)
        del arg67_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (524288, 4), (4, 1), 0), reinterpret_tensor(arg68_1, (4, 16), (1, 4), 0), out=buf115)
        del arg68_1
        ...
        triton_poi_fused_gelu_16.run(buf116, arg69_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg69_1
        buf117 = reinterpret_tensor(buf108, (524288, 8), (8, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (524288, 16), (16, 1), 0), reinterpret_tensor(arg70_1, (16, 8), (1, 16), 0), out=buf117)
        del arg70_1
        ...
        triton_poi_fused_clone_17.run(buf117, arg71_1, buf118, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg71_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (4096, 128), (128, 1), 0), reinterpret_tensor(arg72_1, (128, 128), (1, 128), 0), out=buf122)
        del arg72_1
        ...
        triton_per_fused_native_layer_norm_5.run(buf60, buf122, arg73_1, arg74_1, arg75_1, buf126, 4096, 128, grid=grid(4096), stream=stream0)
        del arg74_1
        del arg75_1
        buf127 = reinterpret_tensor(buf114, (4096, 512), (512, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf126, (4096, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 512), (1, 128), 0), out=buf127)
        del arg76_1
        ...
        triton_poi_fused_gelu_19.run(buf128, arg77_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg77_1
        buf129 = reinterpret_tensor(buf126, (4096, 128), (128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (4096, 512), (512, 1), 0), reinterpret_tensor(arg78_1, (512, 128), (1, 512), 0), out=buf129)
        del arg78_1
        buf130 = reinterpret_tensor(buf129, (1, 4096, 128), (524288, 128, 1), 0); del buf129  # reuse
        buf172 = reinterpret_tensor(buf119, (1, 4096, 128), (524288, 128, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_1, h_diag_2, layer_norm_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_20.run(buf130, buf60, buf122, arg73_1, arg79_1, arg96_1, arg97_1, buf172, 4096, 128, grid=grid(4096), stream=stream0)
        del arg73_1
        del arg79_1
        del arg96_1
        del arg97_1
        ...
        triton_poi_fused_constant_pad_nd_21.run(buf130, buf131, 1048576, grid=grid(1048576), stream=stream0)
        buf132 = reinterpret_tensor(buf86, (1, 234, 16384), (3833856, 16384, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [row_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf131, (1, 64, 16384), (0, 16384, 1), 0), out=buf132)
        buf133 = buf62; del buf62  # reuse
        # Topologically Sorted Source Nodes: [col_p_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf131, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf133)
        buf135 = empty_strided_cuda((7488, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (7488, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf135)
        del arg60_1
        buf136 = reinterpret_tensor(buf135, (234, 32, 512), (16384, 512, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf136, arg61_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg61_1
        buf137 = reinterpret_tensor(buf134, (7488, 128), (128, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (7488, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf137)
        del arg62_1
        buf138 = reinterpret_tensor(buf137, (234, 32, 128), (4096, 128, 1), 0); del buf137  # reuse
        buf142 = reinterpret_tensor(buf89, (234, 32, 128), (4096, 128, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, h_off_5, off_stream, off_in, layer_norm_7], Original ATen: [aten.add, aten.mean, aten.native_layer_norm]
        triton_per_fused_add_mean_native_layer_norm_37.run(buf138, buf132, buf133, buf64, buf92, arg57_1, arg63_1, arg80_1, arg81_1, buf142, 7488, 128, grid=grid(7488), stream=stream0)
        del arg57_1
        del arg63_1
        del arg80_1
        del arg81_1
        buf143 = buf69; del buf69  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (7488, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 384), (1, 128), 0), out=buf143)
        del arg82_1
        # Topologically Sorted Source Nodes: [setitem_6], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_24.run(buf144, 29952, grid=grid(29952), stream=stream0)
        buf146 = buf73; del buf73  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_25.run(buf144, buf146, 239616, grid=grid(239616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf146, 7488, grid=grid(7488), stream=stream0)
        buf148 = reinterpret_tensor(buf142, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf142  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_27.run(buf143, arg83_1, buf148, 958464, grid=grid(958464), stream=stream0)
        buf149 = reinterpret_tensor(buf92, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_28.run(buf143, arg83_1, buf149, 958464, grid=grid(958464), stream=stream0)
        buf150 = reinterpret_tensor(buf64, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf64  # reuse
        buf162 = reinterpret_tensor(buf71, (234, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf71  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf143, arg83_1, buf150, buf162, 958464, grid=grid(958464), stream=stream0)
        del arg83_1
        buf151 = reinterpret_tensor(buf88, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf146, buf144, buf151, 1916928, grid=grid(1916928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf152 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf148, buf149, buf150, buf151, False)
        del buf148
        del buf149
        buf153 = buf152[0]
        del buf152
        buf157 = reinterpret_tensor(buf150, (234, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_31.run(buf146, buf144, buf157, 958464, grid=grid(958464), stream=stream0)
        buf158 = reinterpret_tensor(buf133, (239616, 16), (16, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf157, (239616, 4), (4, 1), 0), reinterpret_tensor(arg84_1, (4, 16), (1, 4), 0), out=buf158)
        del arg84_1
        buf159 = reinterpret_tensor(buf158, (234, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_32.run(buf159, arg85_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg85_1
        buf160 = reinterpret_tensor(buf151, (239616, 8), (8, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (239616, 16), (16, 1), 0), reinterpret_tensor(arg86_1, (16, 8), (1, 16), 0), out=buf160)
        del arg86_1
        buf161 = reinterpret_tensor(buf87, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [einsum_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf160, arg87_1, buf161, 1872, 1024, grid=grid(1872, 1024), stream=stream0)
        del arg87_1
        buf163 = reinterpret_tensor(buf157, (1872, 32, 16), (512, 16, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [einsum_9], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf161, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf162, (1872, 32, 16), (512, 16, 1), 0), out=buf163)
        buf164 = reinterpret_tensor(buf153, (234, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [x_mid_3], Original ATen: [aten.add]
        triton_poi_fused_add_34.run(buf164, buf163, 958464, grid=grid(958464), stream=stream0)
        buf165 = reinterpret_tensor(buf163, (7488, 128), (128, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf164, (7488, 128), (128, 1), 0), reinterpret_tensor(arg88_1, (128, 128), (1, 128), 0), out=buf165)
        del arg88_1
        buf207 = reinterpret_tensor(buf164, (234, 32, 128), (4096, 128, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_1, z_3], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf138, buf165, arg89_1, arg90_1, arg91_1, buf207, 7488, 128, grid=grid(7488), stream=stream0)
        del arg90_1
        del arg91_1
        buf173 = buf100; del buf100  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (4096, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 384), (1, 128), 0), out=buf173)
        del arg98_1
        buf174 = reinterpret_tensor(buf128, (1, 32, 128, 128, 4), (2097152, 65536, 512, 4, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_38.run(arg28_1, buf174, 2097152, grid=grid(2097152), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_8.run(buf174, 16384, grid=grid(16384), stream=stream0)
        buf176 = reinterpret_tensor(buf172, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_9.run(buf174, buf176, 524288, grid=grid(524288), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_10.run(buf176, 4096, grid=grid(4096), stream=stream0)
        buf178 = reinterpret_tensor(buf60, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf60  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_11.run(buf173, arg99_1, buf178, 524288, grid=grid(524288), stream=stream0)
        buf179 = reinterpret_tensor(buf122, (32, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_12.run(buf173, arg99_1, buf179, 524288, grid=grid(524288), stream=stream0)
        buf180 = buf107; del buf107  # reuse
        buf192 = reinterpret_tensor(buf106, (32, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf106  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_13.run(buf173, arg99_1, buf180, buf192, 524288, grid=grid(524288), stream=stream0)
        del arg99_1
        del buf173
        buf181 = reinterpret_tensor(buf118, (32, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf176, buf174, buf181, 4194304, grid=grid(4194304), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_4, k_f_4, v_f_4, logit_bias_4, x_soft_8], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf182 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf178, buf179, buf180, buf181, False)
        del buf178
        del buf179
        del buf180
        buf183 = buf182[0]
        del buf182
        buf187 = buf101; del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf176, buf174, buf187, 2097152, grid=grid(2097152), stream=stream0)
        del buf174
        buf188 = reinterpret_tensor(buf116, (524288, 16), (16, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf187, (524288, 4), (4, 1), 0), reinterpret_tensor(arg100_1, (4, 16), (1, 4), 0), out=buf188)
        del arg100_1
        buf189 = reinterpret_tensor(buf188, (1, 32, 128, 128, 16), (8388608, 262144, 2048, 16, 1), 0); del buf188  # reuse
        # Topologically Sorted Source Nodes: [input_35], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_16.run(buf189, arg101_1, 8388608, grid=grid(8388608), stream=stream0)
        del arg101_1
        buf190 = reinterpret_tensor(buf181, (524288, 8), (8, 1), 0); del buf181  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf189, (524288, 16), (16, 1), 0), reinterpret_tensor(arg102_1, (16, 8), (1, 16), 0), out=buf190)
        del arg102_1
        del buf189
        buf191 = reinterpret_tensor(buf117, (32, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [einsum_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf190, arg103_1, buf191, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg103_1
        del buf190
        buf193 = reinterpret_tensor(buf176, (256, 128, 16), (2048, 16, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [einsum_10], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf191, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf192, (256, 128, 16), (2048, 16, 1), 0), out=buf193)
        del buf191
        del buf192
        buf194 = reinterpret_tensor(buf183, (1, 32, 128, 8, 16), (524288, 16384, 128, 16, 1), 0); del buf183  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4], Original ATen: [aten.add]
        triton_poi_fused_add_18.run(buf194, buf193, 524288, grid=grid(524288), stream=stream0)
        buf195 = reinterpret_tensor(buf193, (4096, 128), (128, 1), 0); del buf193  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf194, (4096, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 128), (1, 128), 0), out=buf195)
        del arg104_1
        buf199 = reinterpret_tensor(buf194, (1, 4096, 128), (524288, 128, 1), 0); del buf194  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, z_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf130, buf195, arg105_1, arg106_1, arg107_1, buf199, 4096, 128, grid=grid(4096), stream=stream0)
        del arg106_1
        del arg107_1
        buf200 = reinterpret_tensor(buf187, (4096, 512), (512, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf199, (4096, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 512), (1, 128), 0), out=buf200)
        del arg108_1
        buf201 = reinterpret_tensor(buf200, (1, 4096, 512), (2097152, 512, 1), 0); del buf200  # reuse
        # Topologically Sorted Source Nodes: [input_38], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf201, arg109_1, 2097152, grid=grid(2097152), stream=stream0)
        del arg109_1
        buf202 = reinterpret_tensor(buf199, (4096, 128), (128, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf201, (4096, 512), (512, 1), 0), reinterpret_tensor(arg110_1, (512, 128), (1, 512), 0), out=buf202)
        del arg110_1
        del buf201
        buf203 = reinterpret_tensor(buf202, (1, 4096, 128), (524288, 128, 1), 0); del buf202  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d_2, h_diag_3], Original ATen: [aten.add]
        triton_poi_fused_add_39.run(buf203, buf130, buf195, arg105_1, arg111_1, 524288, grid=grid(524288), stream=stream0)
        del arg105_1
        del arg111_1
        buf204 = buf131; del buf131  # reuse
        # Topologically Sorted Source Nodes: [h_k_7], Original ATen: [aten.constant_pad_nd]
        triton_poi_fused_constant_pad_nd_21.run(buf203, buf204, 1048576, grid=grid(1048576), stream=stream0)
        buf205 = reinterpret_tensor(buf159, (1, 234, 16384), (3833856, 16384, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [row_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf204, (1, 64, 16384), (0, 16384, 1), 0), out=buf205)
        del arg30_1
        buf206 = buf132; del buf132  # reuse
        # Topologically Sorted Source Nodes: [col_p_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 234, 64), (14976, 64, 1), 0), reinterpret_tensor(buf204, (1, 64, 16384), (1048576, 16384, 1), 0), out=buf206)
        del arg31_1
        del buf204
        buf208 = reinterpret_tensor(buf136, (7488, 512), (512, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf207, (7488, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 512), (1, 128), 0), out=buf208)
        del arg92_1
        buf209 = reinterpret_tensor(buf208, (234, 32, 512), (16384, 512, 1), 0); del buf208  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf209, arg93_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg93_1
        buf210 = reinterpret_tensor(buf207, (7488, 128), (128, 1), 0); del buf207  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf209, (7488, 512), (512, 1), 0), reinterpret_tensor(arg94_1, (512, 128), (1, 512), 0), out=buf210)
        del arg94_1
        del buf209
        buf211 = reinterpret_tensor(buf210, (234, 32, 128), (4096, 128, 1), 0); del buf210  # reuse
        buf215 = reinterpret_tensor(buf162, (234, 32, 128), (4096, 128, 1), 0); del buf162  # reuse
        ...
        triton_per_fused_add_mean_native_layer_norm_37.run(buf211, buf205, buf206, buf138, buf165, arg89_1, arg95_1, arg112_1, arg113_1, buf215, 7488, 128, grid=grid(7488), stream=stream0)
        del arg112_1
        del arg113_1
        del arg89_1
        del arg95_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf215, (7488, 128), (128, 1), 0), reinterpret_tensor(arg114_1, (128, 384), (1, 128), 0), out=buf216)
        del arg114_1
        # Topologically Sorted Source Nodes: [setitem_10], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_24.run(buf217, 29952, grid=grid(29952), stream=stream0)
        buf219 = buf146; del buf146  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_25.run(buf217, buf219, 239616, grid=grid(239616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf219, 7488, grid=grid(7488), stream=stream0)
        buf221 = reinterpret_tensor(buf215, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf215  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_27.run(buf216, arg115_1, buf221, 958464, grid=grid(958464), stream=stream0)
        buf222 = reinterpret_tensor(buf165, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_28.run(buf216, arg115_1, buf222, 958464, grid=grid(958464), stream=stream0)
        buf223 = reinterpret_tensor(buf138, (234, 8, 32, 16), (4096, 512, 16, 1), 0); del buf138  # reuse
        buf235 = reinterpret_tensor(buf144, (234, 8, 32, 1, 16, 1), (4096, 512, 16, 16, 1, 1), 0); del buf144  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf216, arg115_1, buf223, buf235, 958464, grid=grid(958464), stream=stream0)
        del arg115_1
        del buf216
        buf224 = reinterpret_tensor(buf161, (234, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf219, buf217, buf224, 1916928, grid=grid(1916928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_5, k_f_5, v_f_5, logit_bias_5, x_soft_10], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf225 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf221, buf222, buf223, buf224, False)
        del buf221
        del buf222
        buf226 = buf225[0]
        del buf225
        buf230 = reinterpret_tensor(buf223, (234, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf223  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_31.run(buf219, buf217, buf230, 958464, grid=grid(958464), stream=stream0)
        del buf217
        buf231 = reinterpret_tensor(buf206, (239616, 16), (16, 1), 0); del buf206  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf230, (239616, 4), (4, 1), 0), reinterpret_tensor(arg116_1, (4, 16), (1, 4), 0), out=buf231)
        del arg116_1
        buf232 = reinterpret_tensor(buf231, (234, 1, 32, 32, 16), (16384, 1, 512, 16, 1), 0); del buf231  # reuse
        # Topologically Sorted Source Nodes: [input_41], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_32.run(buf232, arg117_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg117_1
        buf233 = reinterpret_tensor(buf224, (239616, 8), (8, 1), 0); del buf224  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf232, (239616, 16), (16, 1), 0), reinterpret_tensor(arg118_1, (16, 8), (1, 16), 0), out=buf233)
        del arg118_1
        buf234 = reinterpret_tensor(buf160, (234, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf160  # reuse
        # Topologically Sorted Source Nodes: [einsum_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf233, arg119_1, buf234, 1872, 1024, grid=grid(1872, 1024), stream=stream0)
        del arg119_1
        del buf233
        buf236 = reinterpret_tensor(buf230, (1872, 32, 16), (512, 16, 1), 0); del buf230  # reuse
        # Topologically Sorted Source Nodes: [einsum_13], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf234, (1872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf235, (1872, 32, 16), (512, 16, 1), 0), out=buf236)
        del buf234
        del buf235
        buf237 = reinterpret_tensor(buf226, (234, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf226  # reuse
        # Topologically Sorted Source Nodes: [x_mid_5], Original ATen: [aten.add]
        triton_poi_fused_add_34.run(buf237, buf236, 958464, grid=grid(958464), stream=stream0)
        buf238 = reinterpret_tensor(buf236, (7488, 128), (128, 1), 0); del buf236  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf237, (7488, 128), (128, 1), 0), reinterpret_tensor(arg120_1, (128, 128), (1, 128), 0), out=buf238)
        del arg120_1
        buf246 = reinterpret_tensor(buf237, (234, 32, 128), (4096, 128, 1), 0); del buf237  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, z_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf211, buf238, arg121_1, arg122_1, arg123_1, buf246, 7488, 128, grid=grid(7488), stream=stream0)
        del arg122_1
        del arg123_1
        buf242 = buf195; del buf195  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf203, (4096, 128), (128, 1), 0), reinterpret_tensor(arg128_1, (128, 128), (1, 128), 0), out=buf242)
        del arg128_1
        buf243 = reinterpret_tensor(buf242, (1, 32, 128, 128), (524288, 16384, 128, 1), 0); del buf242  # reuse
        # Topologically Sorted Source Nodes: [input_47], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf243, arg129_1, 524288, grid=grid(524288), stream=stream0)
        del arg129_1
        buf244 = reinterpret_tensor(buf130, (4096, 128), (128, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [input_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg131_1, reinterpret_tensor(buf243, (4096, 128), (128, 1), 0), reinterpret_tensor(arg130_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf244)
        del arg130_1
        del arg131_1
        buf245 = reinterpret_tensor(buf243, (32, 128, 128), (16384, 128, 1), 0); del buf243  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf244, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf244, (32, 128, 128), (16384, 1, 128), 0), out=buf245)
        del buf244
        buf247 = reinterpret_tensor(buf232, (7488, 512), (512, 1), 0); del buf232  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf246, (7488, 128), (128, 1), 0), reinterpret_tensor(arg124_1, (128, 512), (1, 128), 0), out=buf247)
        del arg124_1
        buf248 = reinterpret_tensor(buf247, (234, 32, 512), (16384, 512, 1), 0); del buf247  # reuse
        # Topologically Sorted Source Nodes: [input_44], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf248, arg125_1, 3833856, grid=grid(3833856), stream=stream0)
        del arg125_1
        buf249 = reinterpret_tensor(buf246, (7488, 128), (128, 1), 0); del buf246  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf248, (7488, 512), (512, 1), 0), reinterpret_tensor(arg126_1, (512, 128), (1, 512), 0), out=buf249)
        del arg126_1
        del buf248
        buf250 = reinterpret_tensor(buf249, (234, 32, 128), (4096, 128, 1), 0); del buf249  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o_2, off_stream_2], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf250, buf211, buf238, arg121_1, arg127_1, 958464, grid=grid(958464), stream=stream0)
        del arg121_1
        del arg127_1
        del buf211
        buf251 = buf238; del buf238  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf250, (7488, 128), (128, 1), 0), reinterpret_tensor(arg132_1, (128, 128), (1, 128), 0), out=buf251)
        del arg132_1
        buf252 = reinterpret_tensor(buf251, (234, 1, 32, 128), (4096, 1, 128, 1), 0); del buf251  # reuse
        # Topologically Sorted Source Nodes: [input_50], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf252, arg133_1, 958464, grid=grid(958464), stream=stream0)
        del arg133_1
        buf253 = reinterpret_tensor(buf219, (7488, 32), (32, 1), 0); del buf219  # reuse
        # Topologically Sorted Source Nodes: [input_51], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg135_1, reinterpret_tensor(buf252, (7488, 128), (128, 1), 0), reinterpret_tensor(arg134_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf253)
        del arg134_1
        del arg135_1
        buf254 = reinterpret_tensor(buf252, (7488, 128), (128, 1), 0); del buf252  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf250, (7488, 128), (128, 1), 0), reinterpret_tensor(arg136_1, (128, 128), (1, 128), 0), out=buf254)
        del arg136_1
        del buf250
        buf255 = reinterpret_tensor(buf254, (234, 1, 32, 128), (4096, 1, 128, 1), 0); del buf254  # reuse
        # Topologically Sorted Source Nodes: [input_53], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf255, arg137_1, 958464, grid=grid(958464), stream=stream0)
        del arg137_1
        buf256 = empty_strided_cuda((7488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_54], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf255, (7488, 128), (128, 1), 0), reinterpret_tensor(arg138_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf256)
        del arg138_1
        del arg139_1
        del buf255
        buf257 = empty_strided_cuda((234, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf253, (234, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf256, (234, 32, 32), (1024, 1, 32), 0), out=buf257)
        del buf253
        del buf256
        buf258 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg143_1, reinterpret_tensor(buf203, (4096, 128), (128, 1), 0), reinterpret_tensor(arg142_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf258)
        del arg142_1
        del arg143_1
        buf259 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg145_1, reinterpret_tensor(buf203, (4096, 128), (128, 1), 0), reinterpret_tensor(arg144_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf259)
        del arg144_1
        del arg145_1
        buf260 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf203, (4096, 128), (128, 1), 0), reinterpret_tensor(arg140_1, (128, 1), (1, 128), 0), out=buf260)
        del arg140_1
        del buf203
        buf261 = reinterpret_tensor(buf260, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf260  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_42.run(buf261, arg141_1, 4096, grid=grid(4096), stream=stream0)
        del arg141_1
        buf262 = empty_strided_cuda((1, 1030144), (1030144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf245, buf257, buf258, buf259, buf261, buf262, 1030144, grid=grid(1030144), stream=stream0)
        del buf245
        del buf257
        del buf258
        del buf259
    return (buf262, reinterpret_tensor(buf261, (1, 32, 128), (4096, 128, 1), 0), )
