...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.add]
        triton_poi_fused_add_23.run(buf60, buf29, buf52, arg39_1, arg45_1, 67584, grid=grid(67584), stream=stream0)
        del arg39_1
        del arg45_1
        ...
        # Topologically Sorted Source Nodes: [row_sum, getitem_14, index_add__2, col_sum, getitem_15, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_25.run(arg48_1, arg46_1, buf60, arg47_1, buf61, buf63, 270336, grid=grid(270336), stream=stream0)
        buf68 = reinterpret_tensor(buf34, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf34  # reuse
        ...
        # Topologically Sorted Source Nodes: [mean_1, cat_4], Original ATen: [aten.mean, aten.cat]
        triton_per_fused_cat_mean_26.run(buf61, arg49_1, buf63, buf67, buf66, 6144, 32, grid=grid(6144), stream=stream0)
        buf72 = empty_strided_cuda((48, 33, 128), (4224, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_work_1], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_27.run(buf68, arg50_1, arg51_1, buf72, 1584, 128, grid=grid(1584), stream=stream0)
        del arg50_1
        del arg51_1
        del buf66
        del buf67
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_28.run(buf73, arg53_1, buf74, 221184, grid=grid(221184), stream=stream0)
        buf75 = empty_strided_cuda((384, 16, 36), (576, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_29.run(buf73, arg53_1, buf75, 221184, grid=grid(221184), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(arg30_1, buf77, 209088, grid=grid(209088), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf77, 6336, grid=grid(6336), stream=stream0)
        buf79 = empty_strided_cuda((48, 1, 33, 33), (1120, 53760, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf77, buf79, 52272, grid=grid(52272), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf79, 1584, grid=grid(1584), stream=stream0)
        buf82 = empty_strided_cuda((48, 1, 33, 33, 8), (8960, 430080, 33, 1, 1120), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_34.run(arg31_1, buf76, buf79, buf77, buf82, 12672, 33, grid=grid(12672), stream=stream0)
        buf83 = empty_strided_cuda((48, 1, 33, 1, 8), (264, 12672, 8, 12672, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_35.run(buf82, buf83, 12672, 33, grid=grid(12672), stream=stream0)
        buf84 = empty_strided_cuda((48, 1, 33, 33, 4), (4384, 4, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf79, buf77, buf84, 209088, grid=grid(209088), stream=stream0)
        buf85 = empty_strided_cuda((52272, 4), (4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf84, buf85, 209088, grid=grid(209088), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf87, buf83, arg31_1, buf86, arg55_1, 384, 1089, grid=grid(384, 1089), stream=stream0)
        del arg55_1
        buf88 = reinterpret_tensor(buf72, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf73, arg53_1, buf88, 202752, grid=grid(202752), stream=stream0)
        del arg53_1
        ...
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf89, buf90, 202752, grid=grid(202752), stream=stream0)
        ...
        del arg56_1
        buf95 = reinterpret_tensor(buf90, (48, 33, 128), (4224, 128, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf68, buf91, arg57_1, arg58_1, arg59_1, buf95, 1584, 128, grid=grid(1584), stream=stream0)
        del arg58_1
        del arg59_1
        buf96 = empty_strided_cuda((1584, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf95, (1584, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf96)
        del arg60_1
        buf97 = reinterpret_tensor(buf96, (48, 33, 512), (16896, 512, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf97, arg61_1, 811008, grid=grid(811008), stream=stream0)
        del arg61_1
        buf98 = reinterpret_tensor(buf95, (1584, 128), (128, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (1584, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf98)
        del arg62_1
        buf99 = reinterpret_tensor(buf98, (48, 33, 128), (4224, 128, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf99, buf68, buf91, arg57_1, arg63_1, 202752, grid=grid(202752), stream=stream0)
        del arg57_1
        del arg63_1
        buf103 = empty_strided_cuda((1, 64, 128), (8192, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [ex, x_work_2], Original ATen: [aten.cat, aten.native_layer_norm]
        triton_per_fused_cat_native_layer_norm_44.run(buf60, buf99, arg66_1, arg67_1, buf103, 64, 128, grid=grid(64), stream=stream0)
        del arg66_1
        del arg67_1
        buf104 = empty_strided_cuda((64, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [qkv_2], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf103, (64, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 384), (1, 128), 0), alpha=1, beta=1, out=buf104)
        del arg68_1
        del arg69_1
        buf105 = empty_strided_cuda((8, 64, 64), (4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf104, (8, 64, 16), (16, 384, 1), 0), reinterpret_tensor(buf104, (8, 16, 64), (16, 1, 384), 128), out=buf105)
        buf106 = empty_strided_cuda((1, 1, 64, 64, 4), (16384, 16384, 256, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_45.run(arg65_1, buf106, 16384, grid=grid(16384), stream=stream0)
        del arg65_1
        # Topologically Sorted Source Nodes: [setitem_4], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_46.run(buf106, 256, grid=grid(256), stream=stream0)
        buf108 = empty_strided_cuda((1, 1, 64, 64), (4096, 4096, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_47.run(buf106, buf108, 4096, grid=grid(4096), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_48.run(buf108, 64, grid=grid(64), stream=stream0)
        buf111 = empty_strided_cuda((1, 1, 64, 64, 8), (32768, 32768, 64, 1, 4096), torch.float32)
        buf112 = empty_strided_cuda((1, 1, 64, 1, 8), (512, 512, 1, 512, 64), torch.float32)
        # Topologically Sorted Source Nodes: [eq_4, scores_8, scores_6, scores_7, attn_probs_2], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_49.run(arg64_1, buf105, buf108, buf106, buf111, buf112, 512, 64, grid=grid(512), stream=stream0)
        buf113 = empty_strided_cuda((1, 1, 64, 64, 4), (16384, 1, 256, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_50.run(buf108, buf106, buf113, 16384, grid=grid(16384), stream=stream0)
        del buf108
        buf114 = reinterpret_tensor(buf105, (4096, 8), (8, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf113, (4096, 4), (4, 1), 0), reinterpret_tensor(arg70_1, (4, 8), (1, 4), 0), out=buf114)
        del arg70_1
        buf115 = reinterpret_tensor(buf114, (1, 1, 64, 64, 8), (32768, 1, 512, 8, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_2, eq_5, linear_edge_weights_5, combined_weights_2], Original ATen: [aten._softmax, aten.eq, aten.masked_fill, aten.add]
        triton_poi_fused__softmax_add_eq_masked_fill_51.run(buf115, buf111, buf112, arg64_1, arg71_1, 4096, 8, grid=grid(4096, 8), stream=stream0)
        del arg64_1
        del arg71_1
        del buf111
        buf116 = reinterpret_tensor(buf103, (8, 64, 16), (1024, 16, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf115, (8, 64, 64), (1, 512, 8), 0), reinterpret_tensor(buf104, (8, 64, 16), (16, 384, 1), 256), out=buf116)
        del buf104
        buf117 = empty_strided_cuda((1, 1, 64, 8, 16), (8192, 1, 128, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_52.run(buf116, buf117, 8192, grid=grid(8192), stream=stream0)
        buf118 = reinterpret_tensor(buf116, (64, 128), (128, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf117, (64, 128), (128, 1), 0), reinterpret_tensor(arg72_1, (128, 128), (1, 128), 0), out=buf118)
        del arg72_1
        buf122 = reinterpret_tensor(buf117, (1, 64, 128), (8192, 128, 1), 0); del buf117  # reuse
        buf123 = buf122; del buf122  # reuse
        # Topologically Sorted Source Nodes: [ex, x_4, layer_norm_6], Original ATen: [aten.cat, aten.add, aten.native_layer_norm]
        triton_per_fused_add_cat_native_layer_norm_53.run(buf123, buf60, buf99, buf118, arg73_1, arg74_1, arg75_1, 64, 128, grid=grid(64), stream=stream0)
        del arg74_1
        del arg75_1
        buf124 = reinterpret_tensor(buf115, (64, 512), (512, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf123, (64, 128), (128, 1), 0), reinterpret_tensor(arg76_1, (128, 512), (1, 128), 0), out=buf124)
        del arg76_1
        buf125 = reinterpret_tensor(buf124, (1, 64, 512), (32768, 512, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_54.run(buf125, arg77_1, 32768, grid=grid(32768), stream=stream0)
        del arg77_1
        buf126 = reinterpret_tensor(buf123, (64, 128), (128, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf125, (64, 512), (512, 1), 0), reinterpret_tensor(arg78_1, (512, 128), (1, 512), 0), out=buf126)
        del arg78_1
        del buf125
        buf127 = reinterpret_tensor(buf126, (1, 64, 128), (8192, 128, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [ex, x_4, x_5], Original ATen: [aten.cat, aten.add]
        triton_poi_fused_add_cat_55.run(buf127, buf60, buf99, buf118, arg73_1, arg79_1, 8192, grid=grid(8192), stream=stream0)
        del arg73_1
        del arg79_1
        del buf118
        buf131 = reinterpret_tensor(buf52, (1, 528, 128), (67584, 128, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [x_work_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_56.run(buf127, buf60, arg80_1, arg81_1, buf131, 528, 128, grid=grid(528), stream=stream0)
        del arg80_1
        del arg81_1
        buf132 = reinterpret_tensor(buf91, (528, 384), (384, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf131, (528, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 384), (1, 128), 0), out=buf132)
        del arg82_1
        buf133 = reinterpret_tensor(buf131, (16, 8, 33, 16, 1, 1), (4224, 528, 16, 1, 1, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf132, arg83_1, buf133, 67584, grid=grid(67584), stream=stream0)
        buf134 = reinterpret_tensor(buf29, (16, 8, 16, 1, 33, 1), (4224, 528, 33, 33, 1, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(buf132, arg83_1, buf134, 2048, 33, grid=grid(2048, 33), stream=stream0)
        buf135 = reinterpret_tensor(buf47, (128, 33, 33), (1089, 33, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf133, (128, 33, 16), (528, 16, 1), 0), reinterpret_tensor(buf134, (128, 16, 33), (528, 33, 1), 0), out=buf135)
        buf136 = buf45; del buf45  # reuse
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(arg28_1, buf136, 69696, grid=grid(69696), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf136, 2112, grid=grid(2112), stream=stream0)
        buf138 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf136, buf138, 17424, grid=grid(17424), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_9], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_14.run(buf138, 528, grid=grid(528), stream=stream0)
        buf141 = reinterpret_tensor(buf48, (1, 16, 33, 33, 8), (143360, 8960, 33, 1, 1120), 0); del buf48  # reuse
        buf142 = buf44; del buf44  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_15.run(arg29_1, buf135, buf138, buf136, buf141, buf142, 4224, 33, grid=grid(4224), stream=stream0)
        buf143 = buf38; del buf38  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf138, buf136, buf143, 69696, grid=grid(69696), stream=stream0)
        del buf136
        del buf138
        buf144 = buf46; del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_17.run(buf143, buf144, 69696, grid=grid(69696), stream=stream0)
        del buf143
        buf145 = reinterpret_tensor(buf135, (17424, 8), (8, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf144, reinterpret_tensor(arg84_1, (4, 8), (1, 4), 0), out=buf145)
        del arg84_1
        del buf144
        buf146 = reinterpret_tensor(buf141, (16, 8, 33, 33, 1, 1), (8960, 1120, 33, 1, 1, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf146, buf142, arg29_1, buf145, arg85_1, 128, 1089, grid=grid(128, 1089), stream=stream0)
        del arg29_1
        del arg85_1
        del buf142
        del buf145
        buf147 = reinterpret_tensor(buf134, (16, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_19.run(buf132, arg83_1, buf147, 67584, grid=grid(67584), stream=stream0)
        del arg83_1
        buf148 = reinterpret_tensor(buf133, (128, 33, 16), (528, 16, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf146, (128, 33, 33), (1120, 33, 1), 0), reinterpret_tensor(buf147, (128, 33, 16), (528, 16, 1), 0), out=buf148)
        del buf146
        buf149 = reinterpret_tensor(buf147, (1, 16, 33, 8, 16), (67584, 4224, 128, 16, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_20.run(buf148, buf149, 67584, grid=grid(67584), stream=stream0)
        buf150 = reinterpret_tensor(buf148, (528, 128), (128, 1), 0); del buf148  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf149, (528, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 128), (1, 128), 0), out=buf150)
        del arg86_1
        buf154 = reinterpret_tensor(buf149, (1, 528, 128), (67584, 128, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_57.run(buf127, buf60, buf150, arg87_1, arg88_1, arg89_1, buf154, 528, 128, grid=grid(528), stream=stream0)
        del arg88_1
        del arg89_1
        buf155 = reinterpret_tensor(buf58, (528, 512), (512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf154, (528, 128), (128, 1), 0), reinterpret_tensor(arg90_1, (128, 512), (1, 128), 0), out=buf155)
        del arg90_1
        buf156 = reinterpret_tensor(buf155, (1, 528, 512), (270336, 512, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf156, arg91_1, 270336, grid=grid(270336), stream=stream0)
        del arg91_1
        buf157 = reinterpret_tensor(buf154, (528, 128), (128, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (528, 512), (512, 1), 0), reinterpret_tensor(arg92_1, (512, 128), (1, 512), 0), out=buf157)
        del arg92_1
        del buf156
        buf158 = reinterpret_tensor(buf157, (1, 528, 128), (67584, 128, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_58.run(buf158, buf127, buf60, buf150, arg87_1, arg93_1, 67584, grid=grid(67584), stream=stream0)
        del arg87_1
        del arg93_1
        del buf150
        del buf60
        buf159 = buf63; del buf63  # reuse
        # Topologically Sorted Source Nodes: [row_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf159, 196608, grid=grid(196608), stream=stream0)
        buf161 = buf61; del buf61  # reuse
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_24.run(buf161, 196608, grid=grid(196608), stream=stream0)
        ...
        triton_poi_fused_index_index_add_zeros_25.run(arg48_1, arg46_1, buf158, arg47_1, buf159, buf161, 270336, grid=grid(270336), stream=stream0)
        del arg46_1
        del arg47_1
        del arg48_1
        buf163 = empty_strided_cuda((48, 1, 1, 128), (128, 6144, 6144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [mean_2], Original ATen: [aten.mean]
        triton_per_fused_mean_59.run(buf159, arg49_1, buf161, buf163, 6144, 32, grid=grid(6144), stream=stream0)
        buf164 = reinterpret_tensor(buf132, (48, 33, 128), (4224, 128, 1), 0); del buf132  # reuse
        buf168 = reinterpret_tensor(buf68, (48, 33, 128), (4224, 128, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [off_in, x_work_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_60.run(buf159, arg49_1, buf161, buf163, buf127, buf99, arg94_1, arg95_1, buf164, buf168, 1584, 128, grid=grid(1584), stream=stream0)
        del arg49_1
        del arg94_1
        del arg95_1
        del buf127
        ...
        del buf161
        del buf163
        buf169 = buf73; del buf73  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf168, (1584, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 384), (1, 128), 0), out=buf169)
        del arg96_1
        buf170 = reinterpret_tensor(buf75, (384, 36, 16), (576, 16, 1), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_28.run(buf169, arg97_1, buf170, 221184, grid=grid(221184), stream=stream0)
        buf171 = reinterpret_tensor(buf74, (384, 16, 36), (576, 36, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_29.run(buf169, arg97_1, buf171, 221184, grid=grid(221184), stream=stream0)
        buf172 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(buf170, buf171, out=buf172)
        del buf170
        del buf171
        buf173 = reinterpret_tensor(buf84, (48, 1, 33, 33, 4), (4384, 210432, 132, 4, 1), 0); del buf84  # reuse
        # Topologically Sorted Source Nodes: [setitem_10], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(arg30_1, buf173, 209088, grid=grid(209088), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [setitem_10], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf173, 6336, grid=grid(6336), stream=stream0)
        buf175 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_32.run(buf173, buf175, 52272, grid=grid(52272), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_33.run(buf175, 1584, grid=grid(1584), stream=stream0)
        buf178 = reinterpret_tensor(buf87, (48, 1, 33, 33, 8), (8960, 430080, 33, 1, 1120), 0); del buf87  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_34.run(arg31_1, buf172, buf175, buf173, buf178, 12672, 33, grid=grid(12672), stream=stream0)
        del buf172
        buf179 = buf83; del buf83  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_4], Original ATen: [aten._softmax]
        triton_per_fused__softmax_35.run(buf178, buf179, 12672, 33, grid=grid(12672), stream=stream0)
        buf180 = reinterpret_tensor(buf77, (48, 1, 33, 33, 4), (4384, 4, 132, 4, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_36.run(buf175, buf173, buf180, 209088, grid=grid(209088), stream=stream0)
        del buf173
        del buf175
        buf181 = buf85; del buf85  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_37.run(buf180, buf181, 209088, grid=grid(209088), stream=stream0)
        del buf180
        buf182 = buf86; del buf86  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf181, reinterpret_tensor(arg98_1, (4, 8), (1, 4), 0), out=buf182)
        del arg98_1
        del buf181
        buf183 = reinterpret_tensor(buf178, (48, 8, 33, 33, 1, 1), (8960, 1120, 33, 1, 1, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [x_out_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_38.run(buf183, buf179, arg31_1, buf182, arg99_1, 384, 1089, grid=grid(384, 1089), stream=stream0)
        del arg31_1
        del arg99_1
        del buf179
        del buf182
        buf184 = reinterpret_tensor(buf168, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf168  # reuse
        # Topologically Sorted Source Nodes: [x_out_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_39.run(buf169, arg97_1, buf184, 202752, grid=grid(202752), stream=stream0)
        del arg97_1
        del buf169
        buf185 = reinterpret_tensor(buf99, (384, 33, 16), (528, 16, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [x_out_16], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf183, (384, 33, 33), (1120, 33, 1), 0), reinterpret_tensor(buf184, (384, 33, 16), (528, 16, 1), 0), out=buf185)
        del buf183
        buf186 = reinterpret_tensor(buf184, (48, 1, 33, 8, 16), (4224, 1, 128, 16, 1), 0); del buf184  # reuse
        # Topologically Sorted Source Nodes: [x_out_17], Original ATen: [aten.clone]
        triton_poi_fused_clone_40.run(buf185, buf186, 202752, grid=grid(202752), stream=stream0)
        buf187 = reinterpret_tensor(buf185, (1584, 128), (128, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf186, (1584, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 128), (1, 128), 0), out=buf187)
        del arg100_1
        buf194 = reinterpret_tensor(buf186, (48, 33, 128), (4224, 128, 1), 0); del buf186  # reuse
        # Topologically Sorted Source Nodes: [x_8, layer_norm_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_41.run(buf164, buf187, arg101_1, arg102_1, arg103_1, buf194, 1584, 128, grid=grid(1584), stream=stream0)
        del arg102_1
        del arg103_1
        buf191 = reinterpret_tensor(buf113, (16, 32, 32), (1024, 32, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf158, (16, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg108_1, (16, 128, 32), (0, 1, 128), 0), out=buf191)
        del arg108_1
        buf192 = reinterpret_tensor(buf191, (1, 16, 32, 32), (16384, 1024, 32, 1), 0); del buf191  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.add]
        triton_poi_fused_add_61.run(buf192, arg109_1, 16384, grid=grid(16384), stream=stream0)
        del arg109_1
        buf193 = reinterpret_tensor(buf106, (16, 32, 32), (1024, 32, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf192, (16, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf192, (16, 32, 32), (1024, 1, 32), 0), out=buf193)
        buf195 = reinterpret_tensor(buf97, (1584, 512), (512, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf194, (1584, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 512), (1, 128), 0), out=buf195)
        del arg104_1
        buf196 = reinterpret_tensor(buf195, (48, 33, 512), (16896, 512, 1), 0); del buf195  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf196, arg105_1, 811008, grid=grid(811008), stream=stream0)
        del arg105_1
        buf197 = reinterpret_tensor(buf194, (1584, 128), (128, 1), 0); del buf194  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf196, (1584, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 128), (1, 512), 0), out=buf197)
        del arg106_1
        del buf196
        buf198 = reinterpret_tensor(buf197, (48, 33, 128), (4224, 128, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [x_8, x_9], Original ATen: [aten.add]
        triton_poi_fused_add_43.run(buf198, buf164, buf187, arg101_1, arg107_1, 202752, grid=grid(202752), stream=stream0)
        del arg101_1
        del arg107_1
        del buf164
        del buf187
        buf199 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf198, (48, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg110_1, (48, 128, 32), (0, 1, 128), 0), out=buf199)
        del arg110_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf198, (48, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg112_1, (48, 128, 32), (0, 1, 128), 0), out=buf200)
        del arg112_1
        del buf198
        buf201 = reinterpret_tensor(buf199, (48, 1, 32, 32), (1024, 1, 32, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.add]
        triton_poi_fused_add_62.run(buf201, arg111_1, 49152, grid=grid(49152), stream=stream0)
        del arg111_1
        buf202 = reinterpret_tensor(buf200, (48, 1, 32, 32), (1024, 1, 32, 1), 0); del buf200  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.add]
        triton_poi_fused_add_62.run(buf202, arg113_1, 49152, grid=grid(49152), stream=stream0)
        del arg113_1
        buf203 = empty_strided_cuda((48, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf201, (48, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf202, (48, 32, 32), (1024, 1, 32), 0), out=buf203)
        del buf201
        del buf202
        buf204 = reinterpret_tensor(buf25, (1, 16, 32, 128), (65536, 4096, 128, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [h_phys_flat], Original ATen: [aten.clone]
        triton_poi_fused_clone_63.run(buf158, buf204, 65536, grid=grid(65536), stream=stream0)
        buf205 = reinterpret_tensor(buf192, (512, 32), (32, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf204, (512, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf205)
        del arg116_1
        del arg117_1
        buf206 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf204, (512, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf206)
        del arg118_1
        del arg119_1
        del buf204
        buf207 = reinterpret_tensor(buf112, (16, 32, 1), (32, 1, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [linear_39], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf158, (16, 32, 128), (4224, 128, 1), 0), reinterpret_tensor(arg114_1, (16, 128, 1), (0, 1, 0), 0), out=buf207)
        del arg114_1
        del buf158
        buf208 = reinterpret_tensor(buf207, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf207  # reuse
        # Topologically Sorted Source Nodes: [linear_39, sigmoid], Original ATen: [aten.add, aten.sigmoid]
        triton_poi_fused_add_sigmoid_64.run(buf208, arg115_1, 512, grid=grid(512), stream=stream0)
        del arg115_1
        buf209 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_65.run(buf193, buf203, buf205, buf206, buf208, buf209, 98816, grid=grid(98816), stream=stream0)
        del buf193
        del buf203
        del buf205
        del buf206
    return (buf209, reinterpret_tensor(buf208, (1, 16, 32), (512, 32, 1), 0), )
