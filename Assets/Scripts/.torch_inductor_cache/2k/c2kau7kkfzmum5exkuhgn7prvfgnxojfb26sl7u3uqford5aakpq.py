...
# Graph fragment:
#   %full_default_10 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([48, 1, 32, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_4 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_30, [%device_put]), kwargs = {})
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_10, [%device_put_2], %index_4, True), kwargs = {})
...
#   %index_5 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_30, [%device_put_1]), kwargs = {})
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_11, [%device_put_2], %index_5, True), kwargs = {})
...
#   %index_6 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_65, [%device_put]), kwargs = {})
#   %index_put_12 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_24, [%device_put_2], %index_6, True), kwargs = {})
...
#   %index_7 : [num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%permute_65, [%device_put_1]), kwargs = {})
#   %index_put_13 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_25, [%device_put_2], %index_7, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_native_layer_norm_5.run(buf25, buf52, arg43_1, arg44_1, arg45_1, buf57, 512, 128, grid=grid(512), stream=stream0)
        del arg44_1
        del arg45_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (512, 128), (128, 1), 0), reinterpret_tensor(arg46_1, (128, 512), (1, 128), 0), out=buf58)
        del arg46_1
        buf59 = reinterpret_tensor(buf58, (1, 512, 512), (262144, 512, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [input_11], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf59, arg47_1, 262144, grid=grid(262144), stream=stream0)
        del arg47_1
        buf60 = reinterpret_tensor(buf57, (512, 128), (128, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (512, 512), (512, 1), 0), reinterpret_tensor(arg48_1, (512, 128), (1, 512), 0), out=buf60)
        del arg48_1
        buf61 = reinterpret_tensor(buf60, (1, 512, 128), (65536, 128, 1), 0); del buf60  # reuse
        buf106 = empty_strided_cuda((1, 512, 128), (65536, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_20.run(buf61, buf25, buf52, arg43_1, arg49_1, arg64_1, arg65_1, buf106, 512, 128, grid=grid(512), stream=stream0)
        del arg43_1
        del arg49_1
        del arg64_1
        del arg65_1
        ...
        buf73 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf73, 196608, grid=grid(196608), stream=stream0)
        buf75 = empty_strided_cuda((48, 1, 32, 128), (4096, 4096, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf75, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_15, index_add__4, col_sum_1, getitem_16, index_add__5, row_sum, getitem_8, index_add__2, col_sum, getitem_9, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_22.run(buf56, buf62, buf61, buf65, buf25, buf63, buf66, buf73, buf75, 270336, grid=grid(270336), stream=stream0)
        buf71 = empty_strided_cuda((48, 32, 128), (4096, 128, 1), torch.float32)
        buf80 = reinterpret_tensor(buf35, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf35  # reuse
        buf78 = reinterpret_tensor(buf80, (48, 1, 32, 128), (4224, 1, 128, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [layer_norm_3, kv_1], Original ATen: [aten.native_layer_norm, aten.cat]
        triton_per_fused_cat_native_layer_norm_23.run(buf63, arg35_1, buf66, arg50_1, arg51_1, buf71, buf78, 1536, 128, grid=grid(1536), stream=stream0)
        del arg50_1
        del arg51_1
        ...
        buf79 = reinterpret_tensor(buf80, (48, 1, 1, 128), (4224, 1, 128, 1), 4096)  # alias
        # Topologically Sorted Source Nodes: [off_prep_block], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf73, arg35_1, buf75, buf79, 6144, 32, grid=grid(6144), stream=stream0)
        del buf78
        buf81 = empty_strided_cuda((1584, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf80, (1584, 128), (128, 1), 0), reinterpret_tensor(arg52_1, (128, 384), (1, 128), 0), out=buf81)
        del arg52_1
        buf82 = reinterpret_tensor(buf75, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf72, arg53_1, buf82, 196608, grid=grid(196608), stream=stream0)
        buf83 = empty_strided_cuda((384, 16, 36), (576, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_26.run(buf81, arg53_1, buf83, 221184, grid=grid(221184), stream=stream0)
        buf84 = empty_strided_cuda((384, 32, 36), (1152, 36, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(reinterpret_tensor(buf82, (384, 32, 16), (512, 16, 1), 0), buf83, out=buf84)
        buf85 = empty_strided_cuda((48, 1, 32, 33, 4), (4224, 202752, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_27.run(arg30_1, buf85, 202752, grid=grid(202752), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_4, setitem_5, setitem_6], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf85, 6144, grid=grid(6144), stream=stream0)
        buf87 = empty_strided_cuda((48, 1, 32, 33), (1056, 1056, 33, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf85, buf87, 50688, grid=grid(50688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf87, 1536, grid=grid(1536), stream=stream0)
        buf90 = empty_strided_cuda((48, 1, 32, 33, 8), (8448, 405504, 33, 1, 1056), torch.float32)
        # Topologically Sorted Source Nodes: [eq_2, scores_5, scores_3, scores_4, attn_probs_1], Original ATen: [aten.eq, aten.masked_fill, aten.mul, aten.add, aten._softmax]
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg31_1, buf84, buf87, buf85, buf90, 12288, 33, grid=grid(12288), stream=stream0)
        buf91 = empty_strided_cuda((48, 1, 32, 1, 8), (256, 12288, 8, 12288, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_probs_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_32.run(buf90, buf91, 12288, 33, grid=grid(12288), stream=stream0)
        buf92 = empty_strided_cuda((48, 1, 32, 33, 4), (4224, 1, 132, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf87, buf85, buf92, 202752, grid=grid(202752), stream=stream0)
        del buf85
        buf93 = empty_strided_cuda((50688, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf92, (50688, 4), (4, 1), 0), reinterpret_tensor(arg54_1, (4, 8), (1, 4), 0), out=buf93)
        del arg54_1
        buf94 = reinterpret_tensor(buf90, (48, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf94, buf91, arg31_1, buf93, arg55_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg55_1
        buf95 = reinterpret_tensor(buf92, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf81, arg53_1, buf95, 202752, grid=grid(202752), stream=stream0)
        del arg53_1
        buf96 = reinterpret_tensor(buf82, (384, 32, 16), (512, 16, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [x_out_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf94, (384, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf95, (384, 33, 16), (528, 16, 1), 0), out=buf96)
        buf97 = reinterpret_tensor(buf73, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf73  # reuse
        # Topologically Sorted Source Nodes: [x_out_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf96, buf97, 196608, grid=grid(196608), stream=stream0)
        buf98 = reinterpret_tensor(buf96, (1536, 128), (128, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (1536, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 128), (1, 128), 0), out=buf98)
        del arg56_1
        buf99 = reinterpret_tensor(buf98, (48, 32, 128), (4096, 128, 1), 0); del buf98  # reuse
        buf139 = reinterpret_tensor(buf97, (48, 32, 128), (4096, 128, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf99, buf63, arg35_1, buf66, arg57_1, arg58_1, arg59_1, buf139, 1536, 128, grid=grid(1536), stream=stream0)
        del arg57_1
        del arg58_1
        del arg59_1
        buf107 = reinterpret_tensor(buf66, (512, 384), (384, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf106, (512, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf107)
        buf108 = reinterpret_tensor(buf49, (1, 16, 33, 128), (67584, 4224, 128, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [kv_2], Original ATen: [aten.cat]
        triton_poi_fused_cat_38.run(buf106, buf33, buf108, 67584, grid=grid(67584), stream=stream0)
        del buf33
        buf109 = reinterpret_tensor(buf95, (528, 384), (384, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf108, (528, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 384), (1, 128), 0), out=buf109)
        del arg66_1
        buf110 = reinterpret_tensor(buf106, (16, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf107, arg67_1, buf110, 65536, grid=grid(65536), stream=stream0)
        buf111 = reinterpret_tensor(buf108, (16, 8, 16, 1, 33, 1), (4224, 528, 33, 33, 1, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(buf109, arg67_1, buf111, 2048, 33, grid=grid(2048, 33), stream=stream0)
        buf112 = reinterpret_tensor(buf48, (128, 32, 33), (1056, 33, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [einsum_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf110, (128, 32, 16), (512, 16, 1), 0), reinterpret_tensor(buf111, (128, 16, 33), (528, 33, 1), 0), out=buf112)
        buf113 = reinterpret_tensor(buf111, (1, 16, 32, 33, 4), (67584, 4224, 132, 4, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_10.run(arg28_1, buf113, 67584, grid=grid(67584), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [setitem_8, setitem_9, setitem_10], Original ATen: [aten.lift_fresh, aten.fill, aten.index_put]
        triton_poi_fused_fill_index_put_lift_fresh_11.run(buf113, 2048, grid=grid(2048), stream=stream0)
        buf115 = buf41; del buf41  # reuse
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf113, buf115, 16896, grid=grid(16896), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_11], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_13.run(buf115, 512, grid=grid(512), stream=stream0)
        buf118 = reinterpret_tensor(buf47, (1, 16, 32, 33, 8), (135168, 8448, 33, 1, 1056), 0); del buf47  # reuse
        buf119 = buf45; del buf45  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_14.run(arg29_1, buf112, buf115, buf113, buf118, buf119, 4096, 33, grid=grid(4096), stream=stream0)
        buf120 = reinterpret_tensor(buf34, (1, 16, 32, 33, 4), (67584, 4224, 132, 4, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_15.run(buf115, buf113, buf120, 67584, grid=grid(67584), stream=stream0)
        del buf113
        del buf115
        buf121 = reinterpret_tensor(buf112, (16896, 8), (8, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (16896, 4), (4, 1), 0), reinterpret_tensor(arg68_1, (4, 8), (1, 4), 0), out=buf121)
        del arg68_1
        buf122 = reinterpret_tensor(buf118, (16, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_16.run(buf122, buf119, arg29_1, buf121, arg69_1, 128, 1056, grid=grid(128, 1056), stream=stream0)
        del arg29_1
        del arg69_1
        del buf119
        del buf121
        buf123 = reinterpret_tensor(buf120, (16, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf109, arg67_1, buf123, 67584, grid=grid(67584), stream=stream0)
        del arg67_1
        buf124 = reinterpret_tensor(buf110, (128, 32, 16), (512, 16, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [x_out_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf122, (128, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf123, (128, 33, 16), (528, 16, 1), 0), out=buf124)
        del buf122
        del buf123
        buf125 = reinterpret_tensor(buf25, (1, 16, 32, 8, 16), (65536, 4096, 128, 16, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [x_out_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_18.run(buf124, buf125, 65536, grid=grid(65536), stream=stream0)
        buf126 = reinterpret_tensor(buf124, (512, 128), (128, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf125, (512, 128), (128, 1), 0), reinterpret_tensor(arg70_1, (128, 128), (1, 128), 0), out=buf126)
        del arg70_1
        buf130 = reinterpret_tensor(buf125, (1, 512, 128), (65536, 128, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf61, buf126, arg71_1, arg72_1, arg73_1, buf130, 512, 128, grid=grid(512), stream=stream0)
        del arg72_1
        del arg73_1
        buf131 = reinterpret_tensor(buf59, (512, 512), (512, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf130, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 512), (1, 128), 0), out=buf131)
        del arg74_1
        buf132 = reinterpret_tensor(buf131, (1, 512, 512), (262144, 512, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_19.run(buf132, arg75_1, 262144, grid=grid(262144), stream=stream0)
        del arg75_1
        buf133 = reinterpret_tensor(buf130, (512, 128), (128, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf132, (512, 512), (512, 1), 0), reinterpret_tensor(arg76_1, (512, 128), (1, 512), 0), out=buf133)
        del arg76_1
        del buf132
        buf134 = reinterpret_tensor(buf133, (1, 512, 128), (65536, 128, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_39.run(buf134, buf61, buf126, arg71_1, arg77_1, 65536, grid=grid(65536), stream=stream0)
        del arg71_1
        del arg77_1
        del buf126
        del buf61
        buf135 = reinterpret_tensor(buf107, (48, 1, 32, 128), (4096, 4096, 128, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf135, 196608, grid=grid(196608), stream=stream0)
        buf137 = buf63; del buf63  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_21.run(buf137, 196608, grid=grid(196608), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_27, index_add__6, col_sum_2, getitem_28, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_40.run(buf56, buf62, buf134, buf65, buf135, buf137, 270336, grid=grid(270336), stream=stream0)
        buf140 = empty_strided_cuda((1536, 512), (512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf139, (1536, 128), (128, 1), 0), reinterpret_tensor(arg60_1, (128, 512), (1, 128), 0), out=buf140)
        del arg60_1
        buf141 = reinterpret_tensor(buf140, (48, 32, 512), (16384, 512, 1), 0); del buf140  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf141, arg61_1, 786432, grid=grid(786432), stream=stream0)
        del arg61_1
        buf142 = reinterpret_tensor(buf139, (1536, 128), (128, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf141, (1536, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 128), (1, 512), 0), out=buf142)
        del arg62_1
        buf143 = reinterpret_tensor(buf142, (48, 32, 128), (4096, 128, 1), 0); del buf142  # reuse
        buf147 = buf71; del buf71  # reuse
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_42.run(buf143, buf135, arg35_1, buf137, buf99, arg63_1, arg78_1, arg79_1, buf147, 1536, 128, grid=grid(1536), stream=stream0)
        del arg35_1
        del arg63_1
        del arg78_1
        del arg79_1
        del buf135
        del buf137
        buf148 = buf72; del buf72  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf147, (1536, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf148)
        buf149 = reinterpret_tensor(buf109, (48, 1, 33, 128), (4224, 1, 128, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [kv_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf147, buf79, buf149, 202752, grid=grid(202752), stream=stream0)
        del buf79
        buf150 = buf81; del buf81  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf149, (1584, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 384), (1, 128), 0), out=buf150)
        del arg80_1
        buf151 = reinterpret_tensor(buf147, (48, 8, 32, 16, 1, 1), (4096, 512, 16, 1, 1, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [einsum_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_25.run(buf148, arg81_1, buf151, 196608, grid=grid(196608), stream=stream0)
        del buf148
        buf152 = buf83; del buf83  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_26.run(buf150, arg81_1, buf152, 221184, grid=grid(221184), stream=stream0)
        buf153 = buf84; del buf84  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.bmm(reinterpret_tensor(buf151, (384, 32, 16), (512, 16, 1), 0), buf152, out=buf153)
        del buf152
        buf154 = reinterpret_tensor(buf149, (48, 1, 32, 33, 4), (4224, 202752, 132, 4, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [setitem_12, setitem_13], Original ATen: [aten.lift_fresh, aten.fill]
        triton_poi_fused_fill_lift_fresh_27.run(arg30_1, buf154, 202752, grid=grid(202752), stream=stream0)
        del arg30_1
        ...
        triton_poi_fused_fill_index_put_lift_fresh_28.run(buf154, 6144, grid=grid(6144), stream=stream0)
        buf156 = buf87; del buf87  # reuse
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_29.run(buf154, buf156, 50688, grid=grid(50688), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_15], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf156, 1536, grid=grid(1536), stream=stream0)
        buf159 = reinterpret_tensor(buf94, (48, 1, 32, 33, 8), (8448, 405504, 33, 1, 1056), 0); del buf94  # reuse
        ...
        triton_per_fused__softmax_add_eq_masked_fill_mul_31.run(arg31_1, buf153, buf156, buf154, buf159, 12288, 33, grid=grid(12288), stream=stream0)
        del buf153
        buf160 = buf91; del buf91  # reuse
        # Topologically Sorted Source Nodes: [attn_probs_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_32.run(buf159, buf160, 12288, 33, grid=grid(12288), stream=stream0)
        buf161 = reinterpret_tensor(buf80, (48, 1, 32, 33, 4), (4224, 1, 132, 4, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_33.run(buf156, buf154, buf161, 202752, grid=grid(202752), stream=stream0)
        del buf154
        del buf156
        buf162 = buf93; del buf93  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf161, (50688, 4), (4, 1), 0), reinterpret_tensor(arg82_1, (4, 8), (1, 4), 0), out=buf162)
        del arg82_1
        buf163 = reinterpret_tensor(buf159, (48, 8, 32, 33, 1, 1), (8448, 1056, 33, 1, 1, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf163, buf160, arg31_1, buf162, arg83_1, 384, 1056, grid=grid(384, 1056), stream=stream0)
        del arg31_1
        del arg83_1
        del buf160
        del buf162
        buf164 = reinterpret_tensor(buf161, (48, 8, 33, 1, 16, 1), (4224, 528, 16, 16, 1, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf150, arg81_1, buf164, 202752, grid=grid(202752), stream=stream0)
        del arg81_1
        del buf150
        buf165 = reinterpret_tensor(buf151, (384, 32, 16), (512, 16, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [x_out_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf163, (384, 32, 33), (1056, 33, 1), 0), reinterpret_tensor(buf164, (384, 33, 16), (528, 16, 1), 0), out=buf165)
        del buf163
        del buf164
        buf166 = reinterpret_tensor(buf99, (48, 1, 32, 8, 16), (4096, 1, 128, 16, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [x_out_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_36.run(buf165, buf166, 196608, grid=grid(196608), stream=stream0)
        buf167 = reinterpret_tensor(buf165, (1536, 128), (128, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf166, (1536, 128), (128, 1), 0), reinterpret_tensor(arg84_1, (128, 128), (1, 128), 0), out=buf167)
        del arg84_1
        buf173 = reinterpret_tensor(buf166, (48, 32, 128), (4096, 128, 1), 0); del buf166  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_44.run(buf143, buf167, arg85_1, arg86_1, arg87_1, buf173, 1536, 128, grid=grid(1536), stream=stream0)
        del arg86_1
        del arg87_1
        buf171 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg93_1, reinterpret_tensor(buf134, (512, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf171)
        del arg92_1
        del arg93_1
        ...
        buf174 = reinterpret_tensor(buf141, (1536, 512), (512, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf173, (1536, 128), (128, 1), 0), reinterpret_tensor(arg88_1, (128, 512), (1, 128), 0), out=buf174)
        del arg88_1
        buf175 = reinterpret_tensor(buf174, (48, 32, 512), (16384, 512, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf175, arg89_1, 786432, grid=grid(786432), stream=stream0)
        del arg89_1
        buf176 = reinterpret_tensor(buf173, (1536, 128), (128, 1), 0); del buf173  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf175, (1536, 512), (512, 1), 0), reinterpret_tensor(arg90_1, (512, 128), (1, 512), 0), out=buf176)
        del arg90_1
        del buf175
        buf177 = reinterpret_tensor(buf176, (48, 32, 128), (4096, 128, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_45.run(buf177, buf143, buf167, arg85_1, arg91_1, 196608, grid=grid(196608), stream=stream0)
        del arg85_1
        del arg91_1
        del buf143
        del buf167
        ...
        extern_kernels.addmm(arg95_1, reinterpret_tensor(buf177, (1536, 128), (128, 1), 0), reinterpret_tensor(arg94_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf178)
        del arg94_1
        del arg95_1
        buf179 = empty_strided_cuda((1536, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg97_1, reinterpret_tensor(buf177, (1536, 128), (128, 1), 0), reinterpret_tensor(arg96_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf179)
        del arg96_1
        del arg97_1
        del buf177
        ...
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf134, (512, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf181)
        del arg100_1
        del arg101_1
        buf182 = empty_strided_cuda((512, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf134, (512, 128), (128, 1), 0), reinterpret_tensor(arg102_1, (128, 32), (1, 128), 0), alpha=1, beta=1, out=buf182)
        del arg102_1
        del arg103_1
        buf183 = empty_strided_cuda((512, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf134, (512, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 1), (1, 128), 0), out=buf183)
        del arg98_1
        del buf134
        buf184 = reinterpret_tensor(buf183, (1, 16, 32, 1), (512, 32, 1, 1), 0); del buf183  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_46.run(buf184, arg99_1, 512, grid=grid(512), stream=stream0)
        del arg99_1
        buf185 = empty_strided_cuda((1, 98816), (98816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_47.run(buf172, buf180, buf181, buf182, buf184, buf185, 98816, grid=grid(98816), stream=stream0)
        del buf172
        del buf180
        del buf181
        del buf182
    return (buf185, reinterpret_tensor(buf184, (1, 16, 32), (512, 32, 1), 0), buf62, buf65, buf56, )
