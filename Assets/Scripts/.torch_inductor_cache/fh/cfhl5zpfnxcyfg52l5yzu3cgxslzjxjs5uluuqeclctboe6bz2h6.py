...
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_6, [None, %arg64_1], %index_2, True), kwargs = {})
...
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_7, [None, %arg65_1], %index_2, True), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg56_1
        buf95 = reinterpret_tensor(buf90, (109, 32, 64), (2048, 64, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_34.run(buf63, buf91, arg57_1, arg58_1, arg59_1, buf95, 3488, 64, grid=grid(3488), stream=stream0)
        del arg58_1
        del arg59_1
        buf96 = reinterpret_tensor(buf87, (3488, 256), (256, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf95, (3488, 64), (64, 1), 0), reinterpret_tensor(arg60_1, (64, 256), (1, 64), 0), out=buf96)
        del arg60_1
        buf97 = reinterpret_tensor(buf96, (109, 32, 256), (8192, 256, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_35.run(buf97, arg61_1, 892928, grid=grid(892928), stream=stream0)
        del arg61_1
        buf98 = reinterpret_tensor(buf95, (3488, 64), (64, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (3488, 256), (256, 1), 0), reinterpret_tensor(arg62_1, (256, 64), (1, 256), 0), out=buf98)
        del arg62_1
        del buf97
        buf99 = reinterpret_tensor(buf98, (109, 32, 64), (2048, 64, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf99, buf63, buf91, arg57_1, arg63_1, 223232, grid=grid(223232), stream=stream0)
        del arg57_1
        del arg63_1
        del buf63
        del buf91
        buf100 = empty_strided_cuda((1, 109, 64), (6976, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [off_summary], Original ATen: [aten.mean]
        triton_per_fused_mean_37.run(buf99, buf100, 6976, 32, grid=grid(6976), stream=stream0)
        buf101 = empty_strided_cuda((1, 32, 64), (2048, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_highway], Original ATen: [aten.zeros_like]
        triton_poi_fused_zeros_like_38.run(buf101, 2048, grid=grid(2048), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [row_highway, off_summary, off_gathered, index_add__2, col_highway, index_add__3], Original ATen: [aten.zeros_like, aten.mean, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_mean_zeros_like_39.run(arg64_1, arg66_1, buf100, arg65_1, buf101, buf103, 11392, grid=grid(11392), stream=stream0)
        del arg64_1
        del arg65_1
        del arg66_1
        buf105 = empty_strided_cuda((1, 32, 1, 64), (2048, 64, 2048, 1), torch.float32)
        buf110 = empty_strided_cuda((1, 32, 64), (2048, 64, 1), torch.float32)
        buf115 = empty_strided_cuda((1, 32, 64), (2048, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_highway_1, col_highway_1, mul_4], Original ATen: [aten.mul]
        triton_poi_fused_mul_40.run(arg69_1, buf101, arg67_1, buf103, arg68_1, buf105, buf110, buf115, 2048, grid=grid(2048), stream=stream0)
        del arg67_1
        del arg68_1
        del buf101
        del buf103
        buf106 = reinterpret_tensor(buf52, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [mul_4, h_d_out], Original ATen: [aten.mul, aten.add]
        triton_poi_fused_add_mul_41.run(buf60, buf105, buf106, 262144, grid=grid(262144), stream=stream0)
        del buf105
        buf107 = buf25; del buf25  # reuse
        buf125 = reinterpret_tensor(buf49, (4096, 64), (64, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        triton_poi_fused_addmm_42.run(buf106, buf107, buf125, 262144, grid=grid(262144), stream=stream0)
        buf108 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, buf107, reinterpret_tensor(arg70_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf108)
        del arg70_1
        del arg71_1
        del buf107
        ...
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf110, (1, 32, 64), (0, 64, 1), 0), out=buf111)
        buf112 = buf110; del buf110  # reuse
        buf113 = buf112; del buf112  # reuse
        # Topologically Sorted Source Nodes: [diag_summary], Original ATen: [aten.mean]
        triton_red_fused_mean_43.run(buf113, buf60, 2048, 128, grid=grid(2048), stream=stream0)
        del buf60
        ...
        del arg30_1
        buf116 = empty_strided_cuda((1, 109, 64), (6976, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf115, (1, 32, 64), (0, 64, 1), 0), out=buf116)
        del buf115
        ...
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), buf113, out=buf117)
        del arg31_1
        del buf113
        buf118 = reinterpret_tensor(buf111, (1, 109, 1, 64), (6976, 64, 6976, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [mul_5], Original ATen: [aten.mul]
        triton_poi_fused_mul_44.run(buf118, arg69_1, buf114, buf116, buf117, 6976, grid=grid(6976), stream=stream0)
        del arg69_1
        del buf114
        del buf116
        del buf117
        buf119 = reinterpret_tensor(buf99, (1, 109, 32, 64), (223232, 2048, 64, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [mul_5, h_o_out], Original ATen: [aten.mul, aten.add]
        triton_poi_fused_add_mul_45.run(buf119, buf118, 223232, grid=grid(223232), stream=stream0)
        del buf118
        buf120 = reinterpret_tensor(buf72, (3488, 32), (32, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg73_1, reinterpret_tensor(buf119, (3488, 64), (64, 1), 0), reinterpret_tensor(arg72_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf120)
        del arg72_1
        del arg73_1
        buf121 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf119, (3488, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf121)
        del arg74_1
        del arg75_1
        del buf119
        buf122 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf120, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf121, (109, 32, 32), (1024, 1, 32), 0), out=buf122)
        del buf120
        del buf121
        buf123 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf106, (4096, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf123)
        del arg78_1
        del arg79_1
        buf124 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg81_1, reinterpret_tensor(buf106, (4096, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf124)
        del arg80_1
        del arg81_1
        del buf106
        buf126 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf125, reinterpret_tensor(arg76_1, (64, 1), (1, 64), 0), out=buf126)
        del arg76_1
        del buf125
        buf127 = reinterpret_tensor(buf126, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_46.run(buf127, arg77_1, 4096, grid=grid(4096), stream=stream0)
        del arg77_1
        buf128 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_47.run(buf109, buf122, buf123, buf124, buf127, buf128, 902144, grid=grid(902144), stream=stream0)
        del buf109
        del buf122
        del buf123
        del buf124
    return (buf128, reinterpret_tensor(buf127, (1, 32, 128), (4096, 128, 1), 0), )
