...
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_6, [None, %slice_58], %view_91, True), kwargs = {})
#   %full_default_7 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_7, [None, %slice_58], %view_91, True), kwargs = {})
...
#   toks_1 => index_2
# Graph fragment:
#   %index_2 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_93, [None, %device_put_2]), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg46_1
        del buf58
        buf105 = reinterpret_tensor(buf49, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [col_highway], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf105, 262144, grid=grid(262144), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [x, x_1, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_21.run(buf60, buf25, buf52, arg41_1, arg47_1, arg64_1, buf95, buf105, 262144, grid=grid(262144), stream=stream0)
        del arg41_1
        del arg47_1
        del buf25
        ...
        del arg56_1
        buf98 = reinterpret_tensor(buf90, (109, 32, 64), (2048, 64, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf63, buf91, arg57_1, arg58_1, arg59_1, buf98, 3488, 64, grid=grid(3488), stream=stream0)
        del arg58_1
        del arg59_1
        buf97 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf97.copy_(arg65_1)
        del arg65_1
        buf99 = reinterpret_tensor(buf87, (3488, 256), (256, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf100, arg61_1, 892928, grid=grid(892928), stream=stream0)
        del arg61_1
        ...
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_37.run(buf102, buf63, buf91, arg57_1, arg63_1, 223232, grid=grid(223232), stream=stream0)
        del arg57_1
        del arg63_1
        del buf63
        del buf91
        buf103 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf103.copy_(arg67_1)
        del arg67_1
        buf107 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf107.copy_(arg66_1)
        del arg66_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__4, index_add__5], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_38.run(buf97, buf103, buf102, buf107, buf95, buf105, 1458176, grid=grid(1458176), stream=stream0)
        buf109 = reinterpret_tensor(buf30, (1, 32, 128, 192), (786432, 24576, 192, 1), 0); del buf30  # reuse
        # Topologically Sorted Source Nodes: [cat_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf60, buf95, buf105, buf109, 786432, grid=grid(786432), stream=stream0)
        buf110 = buf52; del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf109, (4096, 192), (192, 1), 0), reinterpret_tensor(arg68_1, (192, 64), (1, 192), 0), out=buf110)
        del arg68_1
        del buf109
        buf111 = reinterpret_tensor(buf110, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf111, arg69_1, 262144, grid=grid(262144), stream=stream0)
        del arg69_1
        buf112 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf111, (4096, 64), (64, 1), 0), reinterpret_tensor(arg70_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf112)
        del arg70_1
        del arg71_1
        del buf111
        buf113 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf112, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf112, (32, 128, 128), (16384, 1, 128), 0), out=buf113)
        del buf112
        buf114 = reinterpret_tensor(buf100, (1, 109, 8192), (892928, 8192, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf95, (1, 32, 8192), (262144, 8192, 1), 0), out=buf114)
        del arg30_1
        buf115 = reinterpret_tensor(buf86, (1, 109, 8192), (892928, 8192, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf105, (1, 32, 8192), (262144, 8192, 1), 0), out=buf115)
        del arg31_1
        buf116 = reinterpret_tensor(buf68, (109, 1, 32, 192), (6144, 6144, 192, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [h_cat], Original ATen: [aten.cat]
        triton_poi_fused_cat_40.run(buf102, buf114, buf115, buf116, 669696, grid=grid(669696), stream=stream0)
        del buf114
        del buf115
        buf117 = reinterpret_tensor(buf102, (3488, 64), (64, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (3488, 192), (192, 1), 0), reinterpret_tensor(arg72_1, (192, 64), (1, 192), 0), out=buf117)
        del arg72_1
        buf118 = reinterpret_tensor(buf117, (109, 1, 32, 64), (2048, 1, 64, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf118, arg73_1, 223232, grid=grid(223232), stream=stream0)
        del arg73_1
        buf119 = reinterpret_tensor(buf72, (3488, 32), (32, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf118, (3488, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf119)
        del arg74_1
        del arg75_1
        buf120 = reinterpret_tensor(buf118, (3488, 64), (64, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (3488, 192), (192, 1), 0), reinterpret_tensor(arg76_1, (192, 64), (1, 192), 0), out=buf120)
        del arg76_1
        del buf116
        buf121 = reinterpret_tensor(buf120, (109, 1, 32, 64), (2048, 1, 64, 1), 0); del buf120  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf121, arg77_1, 223232, grid=grid(223232), stream=stream0)
        del arg77_1
        buf122 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf121, (3488, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf122)
        del arg78_1
        del arg79_1
        del buf121
        buf123 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf119, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf122, (109, 32, 32), (1024, 1, 32), 0), out=buf123)
        del buf119
        del buf122
        buf124 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg82_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf124)
        del arg82_1
        del arg83_1
        buf125 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg84_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf125)
        del arg84_1
        del arg85_1
        buf126 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 1), (1, 64), 0), out=buf126)
        del arg80_1
        del buf60
        buf127 = reinterpret_tensor(buf126, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_42.run(buf127, arg81_1, 4096, grid=grid(4096), stream=stream0)
        del arg81_1
        buf128 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf113, buf123, buf124, buf125, buf127, buf128, 902144, grid=grid(902144), stream=stream0)
        del buf113
        del buf123
        del buf124
        del buf125
    return (buf128, reinterpret_tensor(buf127, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf105, (1, 4096, 64), (262144, 64, 1), 0), reinterpret_tensor(buf95, (1, 4096, 64), (262144, 64, 1), 0), arg64_1, buf97, buf107, buf103, )
