...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg68_1
        buf109 = reinterpret_tensor(buf103, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf103  # reuse
        ...
        buf110 = reinterpret_tensor(buf52, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf111 = reinterpret_tensor(buf25, (32, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf25  # reuse
        buf123 = reinterpret_tensor(buf36, (32, 8, 128, 1, 8, 1), (8192, 1024, 8, 8, 1, 1), 0); del buf36  # reuse
        ...
        buf112 = reinterpret_tensor(buf48, (32, 8, 128, 128), (131072, 16384, 128, 1), 0); del buf48  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_14.run(buf107, buf105, buf112, 4194304, grid=grid(4194304), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, logit_bias_2, x_soft_4], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        del arg71_1
        buf121 = reinterpret_tensor(buf112, (524288, 8), (8, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (524288, 16), (16, 1), 0), reinterpret_tensor(arg72_1, (16, 8), (1, 16), 0), out=buf121)
        del arg72_1
        del buf120
        buf122 = reinterpret_tensor(buf47, (32, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_17.run(buf121, arg73_1, buf122, 256, 16384, grid=grid(256, 16384), stream=stream0)
        del arg73_1
        del buf121
        buf124 = reinterpret_tensor(buf111, (256, 128, 8), (1024, 8, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf122, (256, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf123, (256, 128, 8), (1024, 8, 1), 0), out=buf124)
        del buf122
        del buf123
        buf125 = reinterpret_tensor(buf114, (1, 32, 128, 8, 8), (262144, 8192, 64, 8, 1), 0); del buf114  # reuse
        ...
        buf79 = reinterpret_tensor(buf72, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf80 = empty_strided_cuda((109, 8, 32, 8), (2048, 256, 8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf81 = empty_strided_cuda((109, 8, 32, 8), (2048, 256, 8, 1), torch.float32)
        buf93 = empty_strided_cuda((109, 8, 32, 1, 8, 1), (2048, 256, 8, 8, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_1], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        del arg53_1
        buf82 = reinterpret_tensor(buf66, (109, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf77, buf75, buf82, 892928, grid=grid(892928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf83 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf79, buf80, buf81, buf82, False)
        del buf79
        buf84 = buf83[0]
        del buf83
        buf88 = empty_strided_cuda((109, 1, 32, 32, 4), (4096, 1, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg55_1
        buf91 = reinterpret_tensor(buf82, (111616, 8), (8, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf90, (111616, 16), (16, 1), 0), reinterpret_tensor(arg56_1, (16, 8), (1, 16), 0), out=buf91)
        del arg56_1
        buf92 = reinterpret_tensor(buf63, (109, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf91, arg57_1, buf92, 872, 1024, grid=grid(872, 1024), stream=stream0)
        del arg57_1
        del buf91
        buf94 = reinterpret_tensor(buf81, (872, 32, 8), (256, 8, 1), 0); del buf81  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf92, (872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf93, (872, 32, 8), (256, 8, 1), 0), out=buf94)
        buf95 = reinterpret_tensor(buf84, (109, 1, 32, 8, 8), (2048, 1, 64, 8, 1), 0); del buf84  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        ...
        del arg60_1
        del arg61_1
        buf141 = reinterpret_tensor(buf92, (3488, 256), (256, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        buf154 = reinterpret_tensor(buf148, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf148  # reuse
        ...
        buf155 = reinterpret_tensor(buf96, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf156 = reinterpret_tensor(buf68, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf68  # reuse
        buf168 = reinterpret_tensor(buf143, (109, 8, 32, 1, 8, 1), (2048, 256, 8, 8, 1, 1), 0); del buf143  # reuse
        ...
        del arg85_1
        del buf149
        buf157 = reinterpret_tensor(buf137, (109, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_32.run(buf152, buf150, buf157, 892928, grid=grid(892928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, logit_bias_3, x_soft_6], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        del arg87_1
        buf166 = reinterpret_tensor(buf157, (111616, 8), (8, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (111616, 16), (16, 1), 0), reinterpret_tensor(arg88_1, (16, 8), (1, 16), 0), out=buf166)
        del arg88_1
        del buf165
        buf167 = reinterpret_tensor(buf135, (109, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), 0); del buf135  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf166, arg89_1, buf167, 872, 1024, grid=grid(872, 1024), stream=stream0)
        del arg89_1
        del buf166
        buf169 = reinterpret_tensor(buf156, (872, 32, 8), (256, 8, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf167, (872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf168, (872, 32, 8), (256, 8, 1), 0), out=buf169)
        del buf168
        buf170 = reinterpret_tensor(buf159, (109, 1, 32, 8, 8), (2048, 1, 64, 8, 1), 0); del buf159  # reuse
        ...
        del buf175
        buf178 = reinterpret_tensor(buf167, (3488, 256), (256, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
