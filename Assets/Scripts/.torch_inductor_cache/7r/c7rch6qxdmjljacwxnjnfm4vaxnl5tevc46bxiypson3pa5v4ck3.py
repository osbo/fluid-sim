...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg46_1
        buf65 = reinterpret_tensor(buf59, (1, 512, 128), (65536, 128, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [x, layer_norm_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf25, buf60, arg47_1, arg48_1, arg49_1, buf65, 512, 128, grid=grid(512), stream=stream0)
        del arg48_1
        del arg49_1
        buf64 = empty_strided_cuda((6, ), (1, ), torch.int64)
        buf64.copy_(arg34_1)
        del arg34_1
        buf66 = reinterpret_tensor(buf35, (512, 512), (512, 1), 0); del buf35  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf65, (512, 128), (128, 1), 0), reinterpret_tensor(arg50_1, (128, 512), (1, 128), 0), out=buf66)
        del arg50_1
        buf67 = reinterpret_tensor(buf66, (1, 512, 512), (262144, 512, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf67, arg51_1, 262144, grid=grid(262144), stream=stream0)
        del arg51_1
        buf68 = reinterpret_tensor(buf65, (512, 128), (128, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (512, 512), (512, 1), 0), reinterpret_tensor(arg52_1, (512, 128), (1, 512), 0), out=buf68)
        del arg52_1
        buf69 = reinterpret_tensor(buf68, (1, 512, 128), (65536, 128, 1), 0); del buf68  # reuse
        buf121 = buf29; del buf29  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, layer_norm_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_22.run(buf69, buf25, buf60, arg47_1, arg53_1, arg72_1, arg73_1, buf121, 512, 128, grid=grid(512), stream=stream0)
        del arg47_1
        del arg53_1
        del arg72_1
        del arg73_1
        buf70 = empty_strided_cuda((6, ), (1, ), torch.int64)
        buf70.copy_(arg32_1)
        del arg32_1
        ...
        buf105 = empty_strided_cuda((6, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf105, 98304, grid=grid(98304), stream=stream0)
        buf107 = empty_strided_cuda((6, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf107, 98304, grid=grid(98304), stream=stream0)
        buf73 = empty_strided_cuda((6, ), (1, ), torch.int64)
        buf73.copy_(arg33_1)
        del arg33_1
        buf74 = empty_strided_cuda((6, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_sum_1], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf74, 98304, grid=grid(98304), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_17, index_add__4, col_sum_1, getitem_18, index_add__5, row_sum, getitem_8, index_add__2, col_sum, getitem_9, index_add__3], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_24.run(buf64, buf70, buf69, buf73, buf25, buf71, buf74, buf105, buf107, 98304, grid=grid(98304), stream=stream0)
        buf109 = empty_strided_cuda((6, 1, 1, 128), (128, 768, 768, 1), torch.float32)
        buf79 = empty_strided_cuda((6, 128, 128), (16384, 128, 1), torch.float32)
        buf110 = reinterpret_tensor(buf109, (6, 1, 1, 128), (128, 1, 768, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [layer_norm_3, off_prep_block], Original ATen: [aten.native_layer_norm, aten.mean]
        triton_red_fused_mean_native_layer_norm_25.run(buf110, buf71, arg35_1, buf74, buf105, buf107, arg54_1, arg55_1, buf79, 768, 128, grid=grid(768), stream=stream0)
        del arg54_1
        del arg55_1
        buf80 = empty_strided_cuda((768, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf79, (768, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf80)
        buf82 = buf107; del buf107  # reuse
        # Topologically Sorted Source Nodes: [mask_base_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf82, 98304, grid=grid(98304), stream=stream0)
        # Topologically Sorted Source Nodes: [mask_base_2, sum_2, lt_1, _need_diag_1, maximum_1, copy__1], Original ATen: [aten.clone, aten.sum, aten.lt, aten._to_copy, aten.maximum, aten.copy]
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_27.run(buf82, 768, 128, grid=grid(768), stream=stream0)
        buf84 = empty_strided_cuda((6, 1, 128, 128, 4), (65536, 393216, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [bias_physics_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(arg30_1, buf84, 393216, grid=grid(393216), stream=stream0)
        # Topologically Sorted Source Nodes: [bias_physics_1, setitem_2], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_29.run(buf84, 3072, grid=grid(3072), stream=stream0)
        buf86 = buf105; del buf105  # reuse
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf84, buf86, 98304, grid=grid(98304), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf86, 768, grid=grid(768), stream=stream0)
        buf88 = empty_strided_cuda((6, 8, 128, 16), (16384, 2048, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_32.run(buf80, arg57_1, buf88, 98304, grid=grid(98304), stream=stream0)
        buf89 = empty_strided_cuda((6, 8, 128, 16), (16384, 2048, 16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf80, arg57_1, buf89, 98304, grid=grid(98304), stream=stream0)
        buf90 = empty_strided_cuda((6, 8, 128, 16), (16384, 2048, 16, 1), torch.float32)
        buf102 = empty_strided_cuda((6, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf80, arg57_1, buf90, buf102, 98304, grid=grid(98304), stream=stream0)
        buf97 = empty_strided_cuda((6, 1, 128, 128, 4), (65536, 1, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_35.run(buf86, buf84, buf97, 393216, grid=grid(393216), stream=stream0)
        buf98 = empty_strided_cuda((98304, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (98304, 4), (4, 1), 0), reinterpret_tensor(arg58_1, (4, 16), (1, 4), 0), out=buf98)
        del arg58_1
        buf99 = reinterpret_tensor(buf98, (6, 1, 128, 128, 16), (262144, 1, 2048, 16, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf99, arg59_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg59_1
        buf100 = empty_strided_cuda((98304, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (98304, 16), (16, 1), 0), reinterpret_tensor(arg60_1, (16, 8), (1, 16), 0), out=buf100)
        del arg60_1
        buf91 = empty_strided_cuda((6, 8, 128, 128), (131072, 16384, 128, 1), torch.float32)
        buf101 = empty_strided_cuda((6, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2, einsum_1], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_37.run(buf82, buf86, buf84, buf100, arg61_1, buf91, buf101, 48, 16384, grid=grid(48, 16384), stream=stream0)
        del arg61_1
        del buf82
        del buf86
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, eq_3, logit_bias_3, logit_bias_2, x_soft_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        ...
        buf93 = buf92[0]
        del buf92
        buf103 = reinterpret_tensor(buf90, (48, 128, 16), (2048, 16, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf101, (48, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf102, (48, 128, 16), (2048, 16, 1), 0), out=buf103)
        buf104 = empty_strided_cuda((768, 8), (8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf79, (768, 128), (128, 1), 0), reinterpret_tensor(arg62_1, (128, 8), (1, 128), 0), out=buf104)
        del arg62_1
        buf111 = empty_strided_cuda((6, 384), (384, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf110, (6, 128), (128, 1), 0), reinterpret_tensor(arg56_1, (128, 384), (1, 128), 0), out=buf111)
        del arg56_1
        buf112 = reinterpret_tensor(buf93, (6, 1, 128, 8, 16), (16384, 1, 128, 16, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [x_mid_2, mul_3, x_mid_3], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_38.run(buf112, buf103, buf104, arg63_1, buf111, arg57_1, 98304, grid=grid(98304), stream=stream0)
        del arg57_1
        del arg63_1
        buf113 = reinterpret_tensor(buf103, (768, 128), (128, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (768, 128), (128, 1), 0), reinterpret_tensor(arg64_1, (128, 128), (1, 128), 0), out=buf113)
        del arg64_1
        buf114 = reinterpret_tensor(buf113, (6, 128, 128), (16384, 128, 1), 0); del buf113  # reuse
        buf163 = reinterpret_tensor(buf112, (6, 128, 128), (16384, 128, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_39.run(buf114, buf71, arg35_1, buf74, arg65_1, arg66_1, arg67_1, buf163, 768, 128, grid=grid(768), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        buf122 = buf30; del buf30  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (512, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf122)
        buf123 = empty_strided_cuda((1, 4, 128), (512, 128, 1), torch.float32)
        buf124 = reinterpret_tensor(buf25, (1, 4, 128, 128), (65536, 16384, 128, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [mask_base_4, sum_3], Original ATen: [aten.clone, aten.sum]
        triton_per_fused_clone_sum_7.run(arg29_1, buf123, buf124, 512, 128, grid=grid(512), stream=stream0)
        ...
        triton_poi_fused__to_copy_copy_lt_maximum_8.run(buf125, arg29_1, buf124, 512, grid=grid(512), stream=stream0)
        del arg29_1
        del buf125
        buf127 = reinterpret_tensor(buf67, (1, 4, 128, 128, 4), (262144, 65536, 512, 4, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_9.run(arg28_1, buf127, 262144, grid=grid(262144), stream=stream0)
        del arg28_1
        # Topologically Sorted Source Nodes: [bias_physics_2, setitem_4], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_10.run(buf127, 2048, grid=grid(2048), stream=stream0)
        buf129 = reinterpret_tensor(buf60, (1, 4, 128, 128), (65536, 16384, 128, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_11.run(buf127, buf129, 65536, grid=grid(65536), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_5], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_12.run(buf129, 512, grid=grid(512), stream=stream0)
        buf131 = reinterpret_tensor(buf53, (4, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf53  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_13.run(buf122, arg75_1, buf131, 65536, grid=grid(65536), stream=stream0)
        buf132 = buf40; del buf40  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_14.run(buf122, arg75_1, buf132, 65536, grid=grid(65536), stream=stream0)
        buf133 = buf39; del buf39  # reuse
        buf145 = reinterpret_tensor(buf37, (4, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf37  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_15.run(buf122, arg75_1, buf133, buf145, 65536, grid=grid(65536), stream=stream0)
        del buf122
        buf140 = buf48; del buf48  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_16.run(buf129, buf127, buf140, 262144, grid=grid(262144), stream=stream0)
        buf141 = reinterpret_tensor(buf50, (65536, 16), (16, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf140, (65536, 4), (4, 1), 0), reinterpret_tensor(arg76_1, (4, 16), (1, 4), 0), out=buf141)
        del arg76_1
        del buf140
        buf142 = reinterpret_tensor(buf141, (1, 4, 128, 128, 16), (1048576, 262144, 2048, 16, 1), 0); del buf141  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_17.run(buf142, arg77_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg77_1
        buf143 = reinterpret_tensor(buf52, (65536, 8), (8, 1), 0); del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (65536, 16), (16, 1), 0), reinterpret_tensor(arg78_1, (16, 8), (1, 16), 0), out=buf143)
        del arg78_1
        del buf142
        buf134 = buf42; del buf42  # reuse
        buf144 = reinterpret_tensor(buf51, (4, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [q_f_2, k_f_2, v_f_2, eq_5, logit_bias_5, logit_bias_4, x_soft_4, einsum_2], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_18.run(buf124, buf129, buf127, buf143, arg79_1, buf134, buf144, 32, 16384, grid=grid(32, 16384), stream=stream0)
        del arg79_1
        del buf124
        del buf129
        del buf143
        ...
        buf136 = buf135[0]
        del buf135
        buf146 = reinterpret_tensor(buf133, (32, 128, 16), (2048, 16, 1), 0); del buf133  # reuse
        # Topologically Sorted Source Nodes: [einsum_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf144, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf145, (32, 128, 16), (2048, 16, 1), 0), out=buf146)
        del buf144
        del buf145
        buf147 = buf55; del buf55  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (512, 128), (128, 1), 0), reinterpret_tensor(arg80_1, (128, 8), (1, 128), 0), out=buf147)
        del arg80_1
        buf148 = buf58; del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (4, 128), (128, 1), 0), reinterpret_tensor(arg74_1, (128, 384), (1, 128), 0), out=buf148)
        del arg74_1
        buf149 = reinterpret_tensor(buf136, (1, 4, 128, 8, 16), (65536, 16384, 128, 16, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [x_mid_4, mul_4, x_mid_5], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_20.run(buf149, buf146, buf147, arg81_1, buf148, arg75_1, 65536, grid=grid(65536), stream=stream0)
        del arg75_1
        del arg81_1
        del buf147
        del buf148
        buf150 = reinterpret_tensor(buf146, (512, 128), (128, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf149, (512, 128), (128, 1), 0), reinterpret_tensor(arg82_1, (128, 128), (1, 128), 0), out=buf150)
        del arg82_1
        buf154 = reinterpret_tensor(buf149, (1, 512, 128), (65536, 128, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [x_4, layer_norm_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_native_layer_norm_5.run(buf69, buf150, arg83_1, arg84_1, arg85_1, buf154, 512, 128, grid=grid(512), stream=stream0)
        del arg84_1
        del arg85_1
        buf155 = reinterpret_tensor(buf127, (512, 512), (512, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf154, (512, 128), (128, 1), 0), reinterpret_tensor(arg86_1, (128, 512), (1, 128), 0), out=buf155)
        del arg86_1
        buf156 = reinterpret_tensor(buf155, (1, 512, 512), (262144, 512, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_21.run(buf156, arg87_1, 262144, grid=grid(262144), stream=stream0)
        del arg87_1
        buf157 = reinterpret_tensor(buf154, (512, 128), (128, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (512, 512), (512, 1), 0), reinterpret_tensor(arg88_1, (512, 128), (1, 512), 0), out=buf157)
        del arg88_1
        del buf156
        buf158 = reinterpret_tensor(buf157, (1, 512, 128), (65536, 128, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [x_4, x_5], Original ATen: [aten.add]
        triton_poi_fused_add_40.run(buf158, buf69, buf150, arg83_1, arg89_1, 65536, grid=grid(65536), stream=stream0)
        del arg83_1
        del arg89_1
        buf159 = buf74; del buf74  # reuse
        # Topologically Sorted Source Nodes: [row_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf159, 98304, grid=grid(98304), stream=stream0)
        buf161 = buf71; del buf71  # reuse
        # Topologically Sorted Source Nodes: [col_sum_2], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_23.run(buf161, 98304, grid=grid(98304), stream=stream0)
        # Topologically Sorted Source Nodes: [row_sum_2, getitem_33, index_add__6, col_sum_2, getitem_34, index_add__7], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_41.run(buf64, buf70, buf158, buf73, buf159, buf161, 98304, grid=grid(98304), stream=stream0)
        buf164 = reinterpret_tensor(buf84, (768, 512), (512, 1), 0); del buf84  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf163, (768, 128), (128, 1), 0), reinterpret_tensor(arg68_1, (128, 512), (1, 128), 0), out=buf164)
        del arg68_1
        buf165 = reinterpret_tensor(buf164, (6, 128, 512), (65536, 512, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf165, arg69_1, 393216, grid=grid(393216), stream=stream0)
        del arg69_1
        buf166 = reinterpret_tensor(buf163, (768, 128), (128, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (768, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 128), (1, 512), 0), out=buf166)
        del arg70_1
        buf167 = reinterpret_tensor(buf166, (6, 128, 128), (16384, 128, 1), 0); del buf166  # reuse
        buf171 = buf79; del buf79  # reuse
        # Topologically Sorted Source Nodes: [x_3, off_in, layer_norm_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_43.run(buf167, buf159, arg35_1, buf161, buf114, arg71_1, arg90_1, arg91_1, buf171, 768, 128, grid=grid(768), stream=stream0)
        del arg35_1
        del arg71_1
        del arg90_1
        del arg91_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (768, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf172)
        buf174 = buf161; del buf161  # reuse
        # Topologically Sorted Source Nodes: [mask_base_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_26.run(buf174, 98304, grid=grid(98304), stream=stream0)
        ...
        triton_per_fused__to_copy_clone_copy_lt_maximum_sum_27.run(buf174, 768, 128, grid=grid(768), stream=stream0)
        buf176 = reinterpret_tensor(buf165, (6, 1, 128, 128, 4), (65536, 393216, 512, 4, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [bias_physics_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_28.run(arg30_1, buf176, 393216, grid=grid(393216), stream=stream0)
        del arg30_1
        # Topologically Sorted Source Nodes: [bias_physics_3, setitem_6], Original ATen: [aten.clone, aten.lift_fresh, aten.index_put]
        triton_poi_fused_clone_index_put_lift_fresh_29.run(buf176, 3072, grid=grid(3072), stream=stream0)
        buf178 = buf159; del buf159  # reuse
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_30.run(buf176, buf178, 98304, grid=grid(98304), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_7], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_31.run(buf178, 768, grid=grid(768), stream=stream0)
        buf180 = reinterpret_tensor(buf114, (6, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf114  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_32.run(buf172, arg93_1, buf180, 98304, grid=grid(98304), stream=stream0)
        buf181 = reinterpret_tensor(buf102, (6, 8, 128, 16), (16384, 2048, 16, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_33.run(buf172, arg93_1, buf181, 98304, grid=grid(98304), stream=stream0)
        buf182 = buf89; del buf89  # reuse
        buf194 = reinterpret_tensor(buf88, (6, 8, 128, 1, 16, 1), (16384, 2048, 16, 16, 1, 1), 0); del buf88  # reuse
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_34.run(buf172, arg93_1, buf182, buf194, 98304, grid=grid(98304), stream=stream0)
        del buf172
        buf189 = buf97; del buf97  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_35.run(buf178, buf176, buf189, 393216, grid=grid(393216), stream=stream0)
        buf190 = reinterpret_tensor(buf99, (98304, 16), (16, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf189, (98304, 4), (4, 1), 0), reinterpret_tensor(arg94_1, (4, 16), (1, 4), 0), out=buf190)
        del arg94_1
        del buf189
        buf191 = reinterpret_tensor(buf190, (6, 1, 128, 128, 16), (262144, 1, 2048, 16, 1), 0); del buf190  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf191, arg95_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg95_1
        buf192 = reinterpret_tensor(buf101, (98304, 8), (8, 1), 0); del buf101  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf191, (98304, 16), (16, 1), 0), reinterpret_tensor(arg96_1, (16, 8), (1, 16), 0), out=buf192)
        del arg96_1
        del buf191
        buf183 = buf91; del buf91  # reuse
        buf193 = reinterpret_tensor(buf100, (6, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [q_f_3, k_f_3, v_f_3, eq_7, logit_bias_7, logit_bias_6, x_soft_6, einsum_3], Original ATen: [aten.clone, aten.eq, aten.masked_fill, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_eq_masked_fill_37.run(buf174, buf178, buf176, buf192, arg97_1, buf183, buf193, 48, 16384, grid=grid(48, 16384), stream=stream0)
        del arg97_1
        del buf174
        del buf178
        del buf192
        ...
        buf185 = buf184[0]
        del buf184
        buf195 = reinterpret_tensor(buf182, (48, 128, 16), (2048, 16, 1), 0); del buf182  # reuse
        # Topologically Sorted Source Nodes: [einsum_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf193, (48, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf194, (48, 128, 16), (2048, 16, 1), 0), out=buf195)
        del buf193
        del buf194
        buf196 = buf104; del buf104  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (768, 128), (128, 1), 0), reinterpret_tensor(arg98_1, (128, 8), (1, 128), 0), out=buf196)
        del arg98_1
        del buf171
        buf197 = buf111; del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf110, (6, 128), (128, 1), 0), reinterpret_tensor(arg92_1, (128, 384), (1, 128), 0), out=buf197)
        del arg92_1
        del buf110
        buf198 = reinterpret_tensor(buf185, (6, 1, 128, 8, 16), (16384, 1, 128, 16, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [x_mid_6, mul_5, x_mid_7], Original ATen: [aten.add, aten.mul]
        triton_poi_fused_add_mul_38.run(buf198, buf195, buf196, arg99_1, buf197, arg93_1, 98304, grid=grid(98304), stream=stream0)
        del arg93_1
        del arg99_1
        del buf196
        del buf197
        buf199 = reinterpret_tensor(buf195, (768, 128), (128, 1), 0); del buf195  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf198, (768, 128), (128, 1), 0), reinterpret_tensor(arg100_1, (128, 128), (1, 128), 0), out=buf199)
        del arg100_1
        buf205 = reinterpret_tensor(buf198, (6, 128, 128), (16384, 128, 1), 0); del buf198  # reuse
        # Topologically Sorted Source Nodes: [x_6, layer_norm_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_44.run(buf167, buf199, arg101_1, arg102_1, arg103_1, buf205, 768, 128, grid=grid(768), stream=stream0)
        del arg102_1
        del arg103_1
        buf203 = reinterpret_tensor(buf69, (512, 128), (128, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg109_1, reinterpret_tensor(buf158, (512, 128), (128, 1), 0), reinterpret_tensor(arg108_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf203)
        del arg108_1
        del arg109_1
        buf204 = reinterpret_tensor(buf150, (4, 128, 128), (16384, 128, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf203, (4, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf203, (4, 128, 128), (16384, 1, 128), 0), out=buf204)
        buf206 = reinterpret_tensor(buf176, (768, 512), (512, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf205, (768, 128), (128, 1), 0), reinterpret_tensor(arg104_1, (128, 512), (1, 128), 0), out=buf206)
        del arg104_1
        buf207 = reinterpret_tensor(buf206, (6, 128, 512), (65536, 512, 1), 0); del buf206  # reuse
        # Topologically Sorted Source Nodes: [input_32], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf207, arg105_1, 393216, grid=grid(393216), stream=stream0)
        del arg105_1
        buf208 = reinterpret_tensor(buf205, (768, 128), (128, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf207, (768, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 128), (1, 512), 0), out=buf208)
        del arg106_1
        del buf207
        buf209 = reinterpret_tensor(buf208, (6, 128, 128), (16384, 128, 1), 0); del buf208  # reuse
        # Topologically Sorted Source Nodes: [x_6, x_7], Original ATen: [aten.add]
        triton_poi_fused_add_45.run(buf209, buf167, buf199, arg101_1, arg107_1, 98304, grid=grid(98304), stream=stream0)
        del arg101_1
        del arg107_1
        buf210 = buf199; del buf199  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg111_1, reinterpret_tensor(buf209, (768, 128), (128, 1), 0), reinterpret_tensor(arg110_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf210)
        del arg110_1
        del arg111_1
        buf211 = reinterpret_tensor(buf167, (768, 128), (128, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg113_1, reinterpret_tensor(buf209, (768, 128), (128, 1), 0), reinterpret_tensor(arg112_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf211)
        del arg112_1
        del arg113_1
        buf212 = buf209; del buf209  # reuse
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf210, (6, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf211, (6, 128, 128), (16384, 1, 128), 0), out=buf212)
        del buf210
        del buf211
        buf213 = buf203; del buf203  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg117_1, reinterpret_tensor(buf158, (512, 128), (128, 1), 0), reinterpret_tensor(arg116_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf213)
        del arg116_1
        del arg117_1
        buf214 = reinterpret_tensor(buf121, (512, 128), (128, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg119_1, reinterpret_tensor(buf158, (512, 128), (128, 1), 0), reinterpret_tensor(arg118_1, (128, 128), (1, 128), 0), alpha=1, beta=1, out=buf214)
        del arg118_1
        del arg119_1
        buf215 = reinterpret_tensor(buf57, (512, 1), (1, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (512, 128), (128, 1), 0), reinterpret_tensor(arg114_1, (128, 1), (1, 128), 0), out=buf215)
        del arg114_1
        del buf158
        buf216 = reinterpret_tensor(buf215, (1, 4, 128, 1), (512, 128, 1, 1), 0); del buf215  # reuse
        # Topologically Sorted Source Nodes: [sigmoid_4], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_46.run(buf216, arg115_1, 512, grid=grid(512), stream=stream0)
        del arg115_1
        buf217 = empty_strided_cuda((1, 295424), (295424, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_47.run(buf204, buf212, buf213, buf214, buf216, buf217, 295424, grid=grid(295424), stream=stream0)
        del buf204
        del buf212
        del buf213
        del buf214
    return (buf217, reinterpret_tensor(buf216, (1, 4, 128), (512, 128, 1), 0), buf70, buf73, buf64, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg32_1 = rand_strided((6, ), (1, ), device='cpu', dtype=torch.int64)
    arg33_1 = rand_strided((6, ), (1, ), device='cpu', dtype=torch.int64)
    arg34_1 = rand_strided((6, ), (1, ), device='cpu', dtype=torch.int64)
