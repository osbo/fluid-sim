...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp4 = tmp0 < tmp3
    tmp5 = tl.load(in_ptr0 + ((512*(x1 // 2)) + x0), tmp4, eviction_policy='evict_last', other=0.0)
    ...
    tmp12 = tmp0 < tmp11
    tmp13 = tl.load(in_ptr2 + ((512*x1) + ((-512) + x0)), tmp10, eviction_policy='evict_last', other=0.0)
    tmp14 = tl.load(in_ptr3 + ((512*x1) + ((-512) + x0)), tmp10, eviction_policy='evict_last', other=0.0)
    tmp15 = tl.load(in_ptr4 + ((-512) + x0), tmp10, eviction_policy='evict_last', other=0.0)
    tmp16 = tmp14 + tmp15
    tmp17 = tmp13 + tmp16
