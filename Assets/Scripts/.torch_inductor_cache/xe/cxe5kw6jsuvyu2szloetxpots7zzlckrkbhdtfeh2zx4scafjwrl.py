...
#   %add_16 : [num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_12, %view_41), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fm/cfmvpeanxbmh6efahgzxuhjag4nhx5eqw3wusehxwmzgulasztrk.py
# Topologically Sorted Source Nodes: [row_sum_1, getitem_16, index_add__4, col_sum_1, getitem_17, index_add__5], Original ATen: [aten.zeros, aten.index, aten.index_add]
# Source node to ATen node mapping:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/5i/c5ittzhh4omarvro4q3taqlq7ou3zevehqntwbh3elitjfazyno2.py
...
#   %index_put_8 : [num_users=2] = call_function[target=torch.ops.aten.index_put_.default](args = (%view_7, [None, None, %iota_1, %iota_1], %full_default_6), kwargs = {})
...
#   sigmoid => sigmoid
# Graph fragment:
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_94,), kwargs = {})
...
#   packed_1 => cat_4
# Graph fragment:
#   %cat_4 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_3, %view_95], 1), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg72_1, (1, 64), (64, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.add]
        triton_poi_fused_add_20.run(buf60, buf25, buf52, arg43_1, arg49_1, 262144, grid=grid(262144), stream=stream0)
        del arg43_1
        del arg49_1
        del buf25
        del buf52
        ...
        # Topologically Sorted Source Nodes: [row_sum_1, getitem_16, index_add__4, col_sum_1, getitem_17, index_add__5], Original ATen: [aten.zeros, aten.index, aten.index_add]
        triton_poi_fused_index_index_add_zeros_22.run(arg32_1, arg30_1, buf60, arg31_1, buf61, buf63, 1458176, grid=grid(1458176), stream=stream0)
        del arg30_1
        del arg31_1
        del arg32_1
        ...
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_23.run(buf61, arg33_1, buf63, arg50_1, arg51_1, buf65, buf69, 3488, 64, grid=grid(3488), stream=stream0)
        del arg33_1
        del arg50_1
        del arg51_1
        ...
        del arg52_1
        buf71 = empty_strided_cuda((109, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        buf72 = buf71; del buf71  # reuse
        # Topologically Sorted Source Nodes: [sub], Original ATen: [aten.mean]
        triton_per_fused_mean_24.run(buf72, arg29_1, 446464, 16, grid=grid(446464), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_25.run(buf72, 13952, grid=grid(13952), stream=stream0)
        buf74 = empty_strided_cuda((109, 1, 32, 32), (1024, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf72, buf74, 111616, grid=grid(111616), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_27.run(buf74, 3488, grid=grid(3488), stream=stream0)
        buf76 = reinterpret_tensor(buf69, (109, 8, 32, 8), (2048, 256, 8, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_28.run(buf70, arg53_1, buf76, 223232, grid=grid(223232), stream=stream0)
        buf77 = empty_strided_cuda((109, 8, 32, 8), (2048, 256, 8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf70, arg53_1, buf77, 223232, grid=grid(223232), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_1], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf70, arg53_1, buf78, buf90, 223232, grid=grid(223232), stream=stream0)
        del arg53_1
        del buf70
        buf79 = reinterpret_tensor(buf63, (109, 8, 32, 32), (8192, 1024, 32, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf74, buf72, buf79, 892928, grid=grid(892928), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_32.run(buf74, buf72, buf85, 446464, grid=grid(446464), stream=stream0)
        del buf72
        ...
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_33.run(buf87, arg55_1, 1785856, grid=grid(1785856), stream=stream0)
        del arg55_1
        ...
        # Topologically Sorted Source Nodes: [einsum_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_34.run(buf88, arg57_1, buf89, 872, 1024, grid=grid(872, 1024), stream=stream0)
        del arg57_1
        del buf88
        ...
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        triton_poi_fused_add_35.run(buf92, buf91, 223232, grid=grid(223232), stream=stream0)
        ...
        del arg58_1
        buf99 = reinterpret_tensor(buf92, (109, 32, 64), (2048, 64, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_36.run(buf65, buf93, arg59_1, arg60_1, arg61_1, buf99, 3488, 64, grid=grid(3488), stream=stream0)
        del arg60_1
        del arg61_1
        buf97 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg66_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf97)
        del arg66_1
        del arg67_1
        buf98 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf97, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf97, (32, 128, 128), (16384, 1, 128), 0), out=buf98)
        del buf97
        buf100 = reinterpret_tensor(buf89, (3488, 256), (256, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (3488, 64), (64, 1), 0), reinterpret_tensor(arg62_1, (64, 256), (1, 64), 0), out=buf100)
        del arg62_1
        buf101 = reinterpret_tensor(buf100, (109, 32, 256), (8192, 256, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf101, arg63_1, 892928, grid=grid(892928), stream=stream0)
        del arg63_1
        buf102 = reinterpret_tensor(buf99, (3488, 64), (64, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (3488, 256), (256, 1), 0), reinterpret_tensor(arg64_1, (256, 64), (1, 256), 0), out=buf102)
        del arg64_1
        del buf101
        buf103 = reinterpret_tensor(buf102, (109, 32, 64), (2048, 64, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_38.run(buf103, buf65, buf93, arg59_1, arg65_1, 223232, grid=grid(223232), stream=stream0)
        del arg59_1
        del arg65_1
        del buf65
        del buf93
        buf104 = reinterpret_tensor(buf74, (3488, 32), (32, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf103, (3488, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf104)
        del arg68_1
        del arg69_1
        buf105 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf103, (3488, 64), (64, 1), 0), reinterpret_tensor(arg70_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf105)
        del arg70_1
        del arg71_1
        del buf103
        buf106 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf104, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf105, (109, 32, 32), (1024, 1, 32), 0), out=buf106)
        del buf104
        del buf105
        buf107 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf107)
        del arg74_1
        del arg75_1
        buf108 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg77_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg76_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf108)
        del arg76_1
        del arg77_1
        buf109 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg72_1, (64, 1), (1, 64), 0), out=buf109)
        del arg72_1
        del buf60
        buf110 = reinterpret_tensor(buf109, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_39.run(buf110, arg73_1, 4096, grid=grid(4096), stream=stream0)
        del arg73_1
        buf111 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_40.run(buf98, buf106, buf107, buf108, buf110, buf111, 902144, grid=grid(902144), stream=stream0)
        del buf106
        del buf107
        del buf108
        del buf98
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg72_1 = rand_strided((1, 64), (64, 1), device='cuda:0', dtype=torch.float32)
