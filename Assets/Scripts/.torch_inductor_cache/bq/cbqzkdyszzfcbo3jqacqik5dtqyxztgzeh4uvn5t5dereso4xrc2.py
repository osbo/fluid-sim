...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/2u/c2usdywjspnd3eis42kdnxt66vqeocsblw7g3mpgamw5iaiq3hxw.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/lo/clo4tzzkkre7ks6proltld4yury64l5wwlymjzhn7jxrqgsy2ody.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ve/cvegc6hddlv7344ks66lsjxqs4k553brbua6sinartwkhsetwcfc.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3c/c3cblsdp4uas6vvl5alq2iikmv5ng2j4nqk45537eqp5lcomnj26.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [aggr, getitem_4, messages, index_add_], Original ATen: [aten.zeros_like, aten.index, aten.mul, aten.index_add]
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf5, arg7_1, buf6, 1294336, grid=grid(1294336), stream=stream0)
        del buf4
        del buf6
        ...
        triton_poi_fused_index_index_add_mul_zeros_like_3.run(arg6_1, buf14, arg7_1, buf15, 1294336, grid=grid(1294336), stream=stream0)
        del arg6_1
        del arg7_1
        del buf13
        del buf15
        ...
        del arg56_1
        buf99 = reinterpret_tensor(buf90, (109, 32, 64), (2048, 64, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, z_1], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_34.run(buf63, buf91, arg57_1, arg58_1, arg59_1, buf99, 3488, 64, grid=grid(3488), stream=stream0)
        del arg58_1
        del arg59_1
        buf95 = buf52; del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg64_1, (64, 64), (1, 64), 0), out=buf95)
        del arg64_1
        buf96 = reinterpret_tensor(buf95, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf96, arg65_1, 262144, grid=grid(262144), stream=stream0)
        del arg65_1
        ...
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf96, (4096, 64), (64, 1), 0), reinterpret_tensor(arg66_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf97)
        del arg66_1
        del arg67_1
        del buf96
        ...
        del buf97
        buf100 = reinterpret_tensor(buf87, (3488, 256), (256, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (3488, 64), (64, 1), 0), reinterpret_tensor(arg60_1, (64, 256), (1, 64), 0), out=buf100)
        del arg60_1
        buf101 = reinterpret_tensor(buf100, (109, 32, 256), (8192, 256, 1), 0); del buf100  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_35.run(buf101, arg61_1, 892928, grid=grid(892928), stream=stream0)
        del arg61_1
        buf102 = reinterpret_tensor(buf99, (3488, 64), (64, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf101, (3488, 256), (256, 1), 0), reinterpret_tensor(arg62_1, (256, 64), (1, 256), 0), out=buf102)
        del arg62_1
        del buf101
        buf103 = reinterpret_tensor(buf102, (109, 32, 64), (2048, 64, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf103, buf63, buf91, arg57_1, arg63_1, 223232, grid=grid(223232), stream=stream0)
        del arg57_1
        del arg63_1
        del buf63
        buf104 = buf91; del buf91  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (3488, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 64), (1, 64), 0), out=buf104)
        del arg68_1
        buf105 = reinterpret_tensor(buf104, (109, 1, 32, 64), (2048, 1, 64, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf105, arg69_1, 223232, grid=grid(223232), stream=stream0)
        del arg69_1
        buf106 = reinterpret_tensor(buf72, (3488, 32), (32, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf105, (3488, 64), (64, 1), 0), reinterpret_tensor(arg70_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf106)
        del arg70_1
        del arg71_1
        buf107 = reinterpret_tensor(buf105, (3488, 64), (64, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (3488, 64), (64, 1), 0), reinterpret_tensor(arg72_1, (64, 64), (1, 64), 0), out=buf107)
        del arg72_1
        del buf103
        buf108 = reinterpret_tensor(buf107, (109, 1, 32, 64), (2048, 1, 64, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_37.run(buf108, arg73_1, 223232, grid=grid(223232), stream=stream0)
        del arg73_1
        buf109 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf108, (3488, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf109)
        del arg74_1
        del arg75_1
        del buf108
        ...
        extern_kernels.bmm(reinterpret_tensor(buf106, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf109, (109, 32, 32), (1024, 1, 32), 0), out=buf110)
        del buf106
        del buf109
        ...
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_38.run(buf114, arg77_1, 4096, grid=grid(4096), stream=stream0)
        del arg77_1
        buf115 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf98, buf110, buf111, buf112, buf114, buf115, 902144, grid=grid(902144), stream=stream0)
        del buf110
        del buf111
        del buf112
        del buf98
    return (buf115, reinterpret_tensor(buf114, (1, 32, 128), (4096, 128, 1), 0), )
