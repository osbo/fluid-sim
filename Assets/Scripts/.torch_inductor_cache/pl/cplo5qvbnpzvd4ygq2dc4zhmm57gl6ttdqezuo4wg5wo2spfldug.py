...
#   x_1 => add_16
# Graph fragment:
#   %add_12 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_5, %view_44), kwargs = {})
...
# Graph fragment:
#   %mean_4 : [num_users=3] = call_function[target=torch.ops.aten.mean.dim](args = (%view_59, [2]), kwargs = {})
...
# Graph fragment:
#   %mul_25 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_73, 0.5), kwargs = {})
#   %mul_26 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_73, 0.7071067811865476), kwargs = {})
...
#   x_mid_1 => add_21
# Graph fragment:
#   %add_21 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_76, %view_80), kwargs = {})
...
#   x_2 => add_22
# Graph fragment:
#   %add_22 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mean_4, %view_84), kwargs = {})
...
# Graph fragment:
#   %mul_30 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_86, 0.5), kwargs = {})
#   %mul_31 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_86, 0.7071067811865476), kwargs = {})
...
# Graph fragment:
#   %add_22 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mean_4, %view_84), kwargs = {})
#   %add_26 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_22, %view_88), kwargs = {})
...
#   sigmoid => sigmoid
# Graph fragment:
#   %sigmoid : [num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_108,), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/fi/cfibwgrhjpoa5wlkpegnhbz2kfv3x3yv777m677la3e274maeqme.py
# Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   packed_1 => cat_4
# Graph fragment:
#   %cat_4 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_3, %view_109], 1), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg58_1
        del arg59_1
        buf95 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [u_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg65_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg64_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf95)
        del arg64_1
        del arg65_1
        buf96 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf95, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf95, (32, 128, 128), (16384, 1, 128), 0), out=buf96)
        del buf95
        ...
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_35.run(buf99, arg61_1, 892928, grid=grid(892928), stream=stream0)
        del arg61_1
        ...
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf101, buf63, buf91, arg57_1, arg63_1, 223232, grid=grid(223232), stream=stream0)
        del arg57_1
        del arg63_1
        del buf63
        del buf91
        buf102 = reinterpret_tensor(buf72, (3488, 32), (32, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [u_leaf_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf101, (3488, 64), (64, 1), 0), reinterpret_tensor(arg66_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf102)
        del arg66_1
        del arg67_1
        buf103 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [v_leaf], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg69_1, reinterpret_tensor(buf101, (3488, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf103)
        del arg68_1
        del arg69_1
        del buf101
        buf104 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf102, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf103, (109, 32, 32), (1024, 1, 32), 0), out=buf104)
        del buf102
        del buf103
        buf105 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg73_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg72_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf105)
        del arg72_1
        del arg73_1
        buf106 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf106)
        del arg74_1
        del arg75_1
        buf107 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg70_1, (64, 1), (1, 64), 0), out=buf107)
        del arg70_1
        del buf60
        buf108 = reinterpret_tensor(buf107, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_37.run(buf108, arg71_1, 4096, grid=grid(4096), stream=stream0)
        del arg71_1
        buf109 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_38.run(buf96, buf104, buf105, buf106, buf108, buf109, 902144, grid=grid(902144), stream=stream0)
        del buf104
        del buf105
        del buf106
        del buf96
    return (buf109, reinterpret_tensor(buf108, (1, 32, 128), (4096, 128, 1), 0), )
