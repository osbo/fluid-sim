...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/i7/ci7fjrsh4l6cn7nwkjezxruggfny5sc3rlwdjalnmalzmhknrq5r.py
...
#   %full_default_11 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
#   %full_default_10 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/x2/cx2qquzoewgd74c7l2advvcnpzxbpqr23ikdu7sz3gaw4mscnizr.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/um/cumw7lcve3ffghi4cw4lu53ys2y7httf34vtsblmy5kaoul54gz2.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/tw/ctwdvpv7fp77abwngkczxkmhpom4olwf5z3hrczabjzzxannhklz.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gf/cgfzrndaefuqhdc3hzfp67ujvff4kvntbeknjr3zqncr6lkz34os.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sr/csrfcyn4alfipq2n5geeyey7qj2bwfiiygmdbju7rtq42uxqz7n7.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/kv/ckv3qzov2pq4bsxw6om77p3oga35jz3pcahb7frho6d4ap5rkntd.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_new_zeros_19.run(buf106, 262144, grid=grid(262144), stream=stream0)
        buf112 = reinterpret_tensor(buf36, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [col_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf112, 262144, grid=grid(262144), stream=stream0)
        buf137 = reinterpret_tensor(buf35, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf35  # reuse
        ...
        buf140 = empty_strided_cuda((1, 32, 128, 64), (262144, 8192, 64, 1), torch.float32)
        ...
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9, row_highway_2, index_add__8], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_23.run(buf67, buf25, buf52, arg41_1, arg51_1, arg42_1, buf106, buf112, buf137, buf140, 262144, grid=grid(262144), stream=stream0)
        del arg41_1
        del arg51_1
        del buf25
        ...
        del arg54_1
        buf76 = empty_strided_cuda((109, 32, 32, 4), (4096, 128, 4, 1), torch.float32)
        ...
        del arg60_1
        buf120 = reinterpret_tensor(buf75, (109, 32, 192), (6144, 192, 1), 0); del buf75  # reuse
        buf117 = reinterpret_tensor(buf120, (109, 32, 64), (6144, 192, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf70, buf98, arg61_1, arg62_1, arg63_1, buf117, 3488, 64, grid=grid(3488), stream=stream0)
        del arg62_1
        del arg63_1
        buf102 = buf52; del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (4096, 64), (64, 1), 0), reinterpret_tensor(arg68_1, (64, 64), (1, 64), 0), out=buf102)
        del arg68_1
        buf103 = reinterpret_tensor(buf102, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf103, arg69_1, 262144, grid=grid(262144), stream=stream0)
        del arg69_1
        buf104 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf103, (4096, 64), (64, 1), 0), reinterpret_tensor(arg70_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf104)
        del arg70_1
        del arg71_1
        del buf103
        ...
        del arg44_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_38.run(buf108, buf109, buf70, buf98, arg61_1, buf114, buf106, buf112, 1458176, grid=grid(1458176), stream=stream0)
        buf111 = reinterpret_tensor(buf94, (1, 109, 8192), (892928, 8192, 1), 0); del buf94  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf106, (1, 32, 8192), (262144, 8192, 1), 0), out=buf111)
        del arg30_1
        del buf106
        buf116 = reinterpret_tensor(buf93, (1, 109, 8192), (892928, 8192, 1), 0); del buf93  # reuse
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf112, (1, 32, 8192), (262144, 8192, 1), 0), out=buf116)
        del arg31_1
        del buf112
        buf118 = reinterpret_tensor(buf120, (109, 32, 64), (6144, 192, 1), 64)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf111, buf118, 223232, grid=grid(223232), stream=stream0)
        del buf111
        buf119 = reinterpret_tensor(buf120, (109, 32, 64), (6144, 192, 1), 128)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf116, buf119, 223232, grid=grid(223232), stream=stream0)
        del buf117
        del buf118
        del buf119
        buf121 = reinterpret_tensor(buf116, (3488, 256), (256, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (3488, 192), (192, 1), 0), reinterpret_tensor(arg64_1, (192, 256), (1, 192), 0), out=buf121)
        del arg64_1
        del buf120
        buf122 = reinterpret_tensor(buf121, (109, 32, 256), (8192, 256, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_40.run(buf122, arg65_1, 892928, grid=grid(892928), stream=stream0)
        del arg65_1
        buf123 = reinterpret_tensor(buf97, (3488, 64), (64, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (3488, 256), (256, 1), 0), reinterpret_tensor(arg66_1, (256, 64), (1, 256), 0), out=buf123)
        del arg66_1
        del buf122
        buf124 = reinterpret_tensor(buf123, (109, 32, 64), (2048, 64, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_41.run(buf124, buf70, buf98, arg61_1, arg67_1, 223232, grid=grid(223232), stream=stream0)
        del arg61_1
        del arg67_1
        del buf70
        buf125 = buf98; del buf98  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (3488, 64), (64, 1), 0), reinterpret_tensor(arg72_1, (64, 64), (1, 64), 0), out=buf125)
        del arg72_1
        buf126 = reinterpret_tensor(buf125, (109, 1, 32, 64), (2048, 1, 64, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf126, arg73_1, 223232, grid=grid(223232), stream=stream0)
        del arg73_1
        buf127 = reinterpret_tensor(buf79, (3488, 32), (32, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf126, (3488, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf127)
        del arg74_1
        del arg75_1
        buf128 = reinterpret_tensor(buf126, (3488, 64), (64, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (3488, 64), (64, 1), 0), reinterpret_tensor(arg76_1, (64, 64), (1, 64), 0), out=buf128)
        del arg76_1
        buf129 = reinterpret_tensor(buf128, (109, 1, 32, 64), (2048, 1, 64, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf129, arg77_1, 223232, grid=grid(223232), stream=stream0)
        del arg77_1
        buf130 = empty_strided_cuda((3488, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf129, (3488, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf130)
        del arg78_1
        del arg79_1
        del buf129
        buf131 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        ...
        del buf127
        del buf130
        buf132 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf67, (4096, 64), (64, 1), 0), reinterpret_tensor(arg82_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf132)
        del arg82_1
        del arg83_1
        buf133 = empty_strided_cuda((4096, 32), (32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf67, (4096, 64), (64, 1), 0), reinterpret_tensor(arg84_1, (64, 32), (1, 64), 0), alpha=1, beta=1, out=buf133)
        del arg84_1
        del arg85_1
        buf134 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (4096, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 1), (1, 64), 0), out=buf134)
        del arg80_1
        del buf67
        ...
        del buf133
        # Topologically Sorted Source Nodes: [toks_3, index_add__11, index_add__10], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_45.run(buf114, buf109, buf124, buf108, buf137, buf140, 1458176, grid=grid(1458176), stream=stream0)
        del buf124
    return (buf136, reinterpret_tensor(buf135, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf137, (1, 4096, 64), (262144, 64, 1), 0), reinterpret_tensor(buf140, (1, 4096, 64), (262144, 64, 1), 0), arg42_1, buf108, buf114, buf109, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg68_1 = rand_strided((64, 64), (64, 1), device='cuda:0', dtype=torch.float32)
