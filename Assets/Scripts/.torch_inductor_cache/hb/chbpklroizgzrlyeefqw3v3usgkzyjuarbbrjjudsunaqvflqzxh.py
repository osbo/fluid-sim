...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/pl/cplsjtpknpak67yjyt6g75g55vqtta26cxwngjjkkch7igg2jfix.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, out_ptr3, out_ptr4, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tl.store(out_ptr4 + (r1 + (96*x0)), tmp34, None)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vp/cvptkaw2izgktszy2phsoh75bsorc7m35ndl4wdfkixkddyaw3lr.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/g4/cg4tayaqu72mqmsodtvjixks57l236prrcjzfzojamappvlruzaw.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/we/cwejlxorsii7glcx75nk5ojrpeyn2tjhxjke5v3w5ltgm2dtygtk.py
...
triton_poi_fused_add_index_add_new_zeros_23 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_index_add_new_zeros_23', 'mutated_arg_names': ['in_out_ptr0', 'out_ptr0', 'out_ptr1', 'out_ptr2', 'out_ptr3'], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/re/crej3r5k2x4tuhu7xq7rdlpl34r7sjjbcw3ucppcm3tjtcxlhrzr.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ew/cewyrl252hbop76q2mejtmgqrnyrxsbwayanahzsszvtxkykiywj.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/f6/cf67e2f7oswmna3al2x3pocgdqaetfcgl66sjkfk73u4h3ifxaiz.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7b/c7bkqj2csz3h35ax6iim6sazjhxoacsvwrhiroagjrz3dy3fryzz.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f_1 => clone_9
#   logit_bias_1 => clone_11
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sw/cswr7yptho57ndjcbseei3yvjvjxb4s4hjhwnhf3kpbj6vbugnp5.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/ar/car42boka6lvzo6yeohqn3q3d32wpmez7tzqsqqaqqup72w5guko.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4v/c4v5ntvobgz7gjvjuslj462p73izj7dpnljiepgnb3igtbe5yfye.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp29 = tmp27 * tmp28
    tmp31 = tmp29 + tmp30
    tl.store(out_ptr2 + (r1 + (96*x0)), tmp31, xmask)
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/3u/c3uil3refr3iuhfqtxzwwvsbyqf3cq5abeo7z6gzpdwbxnowngfy.py
...
triton_poi_fused_index_add_index_select_38 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_add_index_select_38', 'mutated_arg_names': ['out_ptr0', 'out_ptr1'], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/25/c25faoahrqiiu3g7bm5ymxwfbq6nh5xjkgdpewbo2zubwcupgcpk.py
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_39', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp7 = 4.0
    tmp8 = tmp6 / tmp7
    tl.store(out_ptr0 + (x0 + (96*x1)), tmp8, xmask)
''', device_str='cuda')
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gt/cgt6tzetbqzdbyjrroxr254bxrr5mpba6sug5eraperaruofvktw.py
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_41', 'mutated_arg_names': ['in_out_ptr0'], 'no_x_dim': False, 'num_load': 5, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/yu/cyukekkhyers6x7k2dwwjjjjzh3csgwepgfldgk2rxlruumpngft.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/mr/cmr2dtfzmk7hkdinckehyyheid4rmdfjimguh3dzf7dduo3lhri4.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/uo/cuozzx5s7hfxwqhox4asitgnucczimdtl5hwsgoak7xpqru2jtcf.py
...
triton_poi_fused_index_add_index_select_45 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_add_index_select_45', 'mutated_arg_names': ['out_ptr0', 'out_ptr1'], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
def call(args):
    ...
    assert_size_stride(arg48_1, (128, 96), (96, 1))
    ...
    assert_size_stride(arg64_1, (128, 96), (96, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf63 = reinterpret_tensor(buf30, (1, 4096, 96), (393216, 96, 1), 0); del buf30  # reuse
        buf60 = reinterpret_tensor(buf63, (1, 4096, 32), (393216, 96, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_d, z, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.native_layer_norm, aten.new_zeros, aten.index_add]
        triton_per_fused_add_index_add_native_layer_norm_new_zeros_20.run(buf25, buf52, arg41_1, arg42_1, arg46_1, arg47_1, buf56, buf58, buf60, 4096, 32, grid=grid(4096), stream=stream0)
        del arg46_1
        del arg47_1
        buf61 = reinterpret_tensor(buf63, (1, 4096, 32), (393216, 96, 1), 32)  # alias
        # Topologically Sorted Source Nodes: [z_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_21.run(buf56, buf61, 131072, grid=grid(131072), stream=stream0)
        buf62 = reinterpret_tensor(buf63, (1, 4096, 32), (393216, 96, 1), 64)  # alias
        # Topologically Sorted Source Nodes: [z_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_21.run(buf58, buf62, 131072, grid=grid(131072), stream=stream0)
        del buf60
        del buf61
        del buf62
        buf64 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf63, (4096, 96), (96, 1), 0), reinterpret_tensor(arg48_1, (96, 128), (1, 96), 0), out=buf64)
        del arg48_1
        del buf63
        buf65 = reinterpret_tensor(buf64, (1, 4096, 128), (524288, 128, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [input_14], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_22.run(buf65, arg49_1, 524288, grid=grid(524288), stream=stream0)
        del arg49_1
        buf66 = reinterpret_tensor(buf58, (4096, 32), (32, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf65, (4096, 128), (128, 1), 0), reinterpret_tensor(arg50_1, (128, 32), (1, 128), 0), out=buf66)
        del arg50_1
        buf106 = buf56; del buf56  # reuse
        # Topologically Sorted Source Nodes: [row_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf106, 131072, grid=grid(131072), stream=stream0)
        buf112 = reinterpret_tensor(buf36, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [col_highway_1], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf112, 131072, grid=grid(131072), stream=stream0)
        buf137 = reinterpret_tensor(buf35, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf35  # reuse
        ...
        buf140 = empty_strided_cuda((1, 32, 128, 32), (131072, 4096, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_highway_2], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_19.run(buf140, 131072, grid=grid(131072), stream=stream0)
        buf67 = reinterpret_tensor(buf66, (1, 4096, 32), (131072, 32, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [x_mid_d, h_diag_1, row_highway_1, index_add__4, col_highway_1, index_add__5, col_highway_2, index_add__9, row_highway_2, index_add__8], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_23.run(buf67, buf25, buf52, arg41_1, arg51_1, arg42_1, buf106, buf112, buf137, buf140, 131072, grid=grid(131072), stream=stream0)
        del arg41_1
        del arg51_1
        del buf25
        buf68 = empty_strided_cuda((1, 109, 4096), (446464, 4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [row_p_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf67, (1, 32, 4096), (131072, 4096, 1), 0), out=buf68)
        buf69 = empty_strided_cuda((1, 109, 4096), (446464, 4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [col_p_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf67, (1, 32, 4096), (131072, 4096, 1), 0), out=buf69)
        buf70 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        buf74 = empty_strided_cuda((109, 32, 32), (1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [h_off_3, layer_norm_3], Original ATen: [aten.mean, aten.native_layer_norm]
        triton_per_fused_mean_native_layer_norm_24.run(buf68, buf69, arg52_1, arg53_1, buf70, buf74, 3488, 32, grid=grid(3488), stream=stream0)
        del arg52_1
        del arg53_1
        buf75 = empty_strided_cuda((3488, 96), (96, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf74, (3488, 32), (32, 1), 0), reinterpret_tensor(arg54_1, (32, 96), (1, 32), 0), out=buf75)
        del arg54_1
        buf76 = reinterpret_tensor(buf69, (109, 32, 32, 4), (4096, 128, 4, 1), 0); del buf69  # reuse
        buf77 = buf76; del buf76  # reuse
        # Topologically Sorted Source Nodes: [sub], Original ATen: [aten.mean]
        triton_per_fused_mean_25.run(buf77, arg29_1, 446464, 16, grid=grid(446464), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf77, 13952, grid=grid(13952), stream=stream0)
        buf79 = reinterpret_tensor(buf74, (109, 1, 32, 32), (1024, 1024, 32, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        ...
        buf81 = empty_strided_cuda((109, 8, 32, 4), (1024, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf75, arg55_1, buf81, 111616, grid=grid(111616), stream=stream0)
        buf82 = empty_strided_cuda((109, 8, 32, 4), (1024, 128, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf75, arg55_1, buf82, 111616, grid=grid(111616), stream=stream0)
        buf83 = empty_strided_cuda((109, 8, 32, 4), (1024, 128, 4, 1), torch.float32)
        buf95 = empty_strided_cuda((109, 8, 32, 1, 4, 1), (1024, 128, 4, 4, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_31.run(buf75, arg55_1, buf83, buf95, 111616, grid=grid(111616), stream=stream0)
        del arg55_1
        buf84 = empty_strided_cuda((109, 8, 32, 32), (8192, 1024, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        ...
        buf86 = buf85[0]
        del buf85
        buf90 = reinterpret_tensor(buf68, (109, 1, 32, 32, 4), (4096, 1, 128, 4, 1), 0); del buf68  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        del arg58_1
        del buf92
        buf94 = empty_strided_cuda((109, 8, 32, 32, 1, 1), (8192, 1024, 32, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_35.run(buf93, arg59_1, buf94, 872, 1024, grid=grid(872, 1024), stream=stream0)
        del arg59_1
        del buf93
        buf96 = reinterpret_tensor(buf79, (872, 32, 4), (128, 4, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf94, (872, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf95, (872, 32, 4), (128, 4, 1), 0), out=buf96)
        del buf94
        buf97 = reinterpret_tensor(buf86, (109, 1, 32, 8, 4), (1024, 1, 32, 4, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        triton_poi_fused_add_36.run(buf97, buf96, 111616, grid=grid(111616), stream=stream0)
        buf98 = reinterpret_tensor(buf96, (3488, 32), (32, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (3488, 32), (32, 1), 0), reinterpret_tensor(arg60_1, (32, 32), (1, 32), 0), out=buf98)
        del arg60_1
        buf120 = reinterpret_tensor(buf75, (109, 32, 96), (3072, 96, 1), 0); del buf75  # reuse
        buf117 = reinterpret_tensor(buf120, (109, 32, 32), (3072, 96, 1), 0)  # alias
        # Topologically Sorted Source Nodes: [x_mid_o, z_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_37.run(buf70, buf98, arg61_1, arg62_1, arg63_1, buf117, 3488, 32, grid=grid(3488), stream=stream0)
        del arg62_1
        del arg63_1
        buf102 = buf52; del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (4096, 32), (32, 1), 0), reinterpret_tensor(arg68_1, (32, 32), (1, 32), 0), out=buf102)
        del arg68_1
        buf103 = reinterpret_tensor(buf102, (1, 32, 128, 32), (131072, 4096, 32, 1), 0); del buf102  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf103, arg69_1, 131072, grid=grid(131072), stream=stream0)
        del arg69_1
        buf104 = reinterpret_tensor(buf65, (4096, 128), (128, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf103, (4096, 32), (32, 1), 0), reinterpret_tensor(arg70_1, (32, 128), (1, 32), 0), alpha=1, beta=1, out=buf104)
        del arg70_1
        del arg71_1
        del buf103
        buf105 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf104, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf104, (32, 128, 128), (16384, 1, 128), 0), out=buf105)
        del buf104
        buf108 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf108.copy_(arg43_1)
        del arg43_1
        buf109 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf109.copy_(arg45_1)
        del arg45_1
        buf114 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf114.copy_(arg44_1)
        del arg44_1
        # Topologically Sorted Source Nodes: [toks_1, index_add__6, index_add__7], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_38.run(buf108, buf109, buf70, buf98, arg61_1, buf114, buf106, buf112, 729088, grid=grid(729088), stream=stream0)
        buf111 = reinterpret_tensor(buf90, (1, 109, 4096), (446464, 4096, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf106, (1, 32, 4096), (131072, 4096, 1), 0), out=buf111)
        del arg30_1
        buf116 = reinterpret_tensor(buf77, (1, 109, 4096), (446464, 4096, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf112, (1, 32, 4096), (131072, 4096, 1), 0), out=buf116)
        del arg31_1
        buf118 = reinterpret_tensor(buf120, (109, 32, 32), (3072, 96, 1), 32)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf111, buf118, 111616, grid=grid(111616), stream=stream0)
        del buf111
        buf119 = reinterpret_tensor(buf120, (109, 32, 32), (3072, 96, 1), 64)  # alias
        # Topologically Sorted Source Nodes: [z_3], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf116, buf119, 111616, grid=grid(111616), stream=stream0)
        del buf117
        del buf118
        del buf119
        buf121 = reinterpret_tensor(buf116, (3488, 128), (128, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf120, (3488, 96), (96, 1), 0), reinterpret_tensor(arg64_1, (96, 128), (1, 96), 0), out=buf121)
        del arg64_1
        del buf120
        buf122 = reinterpret_tensor(buf121, (109, 32, 128), (4096, 128, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_40.run(buf122, arg65_1, 446464, grid=grid(446464), stream=stream0)
        del arg65_1
        buf123 = reinterpret_tensor(buf97, (3488, 32), (32, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf122, (3488, 128), (128, 1), 0), reinterpret_tensor(arg66_1, (128, 32), (1, 128), 0), out=buf123)
        del arg66_1
        del buf122
        buf124 = reinterpret_tensor(buf123, (109, 32, 32), (1024, 32, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [x_mid_o, off_stream], Original ATen: [aten.add]
        triton_poi_fused_add_41.run(buf124, buf70, buf98, arg61_1, arg67_1, 111616, grid=grid(111616), stream=stream0)
        del arg61_1
        del arg67_1
        buf125 = buf98; del buf98  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (3488, 32), (32, 1), 0), reinterpret_tensor(arg72_1, (32, 32), (1, 32), 0), out=buf125)
        del arg72_1
        buf126 = reinterpret_tensor(buf125, (109, 1, 32, 32), (1024, 1, 32, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf126, arg73_1, 111616, grid=grid(111616), stream=stream0)
        del arg73_1
        buf127 = reinterpret_tensor(buf70, (3488, 32), (32, 1), 0); del buf70  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf126, (3488, 32), (32, 1), 0), reinterpret_tensor(arg74_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf127)
        del arg74_1
        del arg75_1
        buf128 = reinterpret_tensor(buf126, (3488, 32), (32, 1), 0); del buf126  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (3488, 32), (32, 1), 0), reinterpret_tensor(arg76_1, (32, 32), (1, 32), 0), out=buf128)
        del arg76_1
        buf129 = reinterpret_tensor(buf128, (109, 1, 32, 32), (1024, 1, 32, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_42.run(buf129, arg77_1, 111616, grid=grid(111616), stream=stream0)
        del arg77_1
        buf130 = reinterpret_tensor(buf95, (3488, 32), (32, 1), 0); del buf95  # reuse
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf129, (3488, 32), (32, 1), 0), reinterpret_tensor(arg78_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf130)
        del arg78_1
        del arg79_1
        buf131 = reinterpret_tensor(buf129, (109, 32, 32), (1024, 32, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf127, (109, 32, 32), (1024, 32, 1), 0), reinterpret_tensor(buf130, (109, 32, 32), (1024, 1, 32), 0), out=buf131)
        del buf127
        del buf130
        buf132 = reinterpret_tensor(buf112, (4096, 32), (32, 1), 0); del buf112  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf67, (4096, 32), (32, 1), 0), reinterpret_tensor(arg82_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf132)
        del arg82_1
        del arg83_1
        buf133 = reinterpret_tensor(buf106, (4096, 32), (32, 1), 0); del buf106  # reuse
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf67, (4096, 32), (32, 1), 0), reinterpret_tensor(arg84_1, (32, 32), (1, 32), 0), alpha=1, beta=1, out=buf133)
        del arg84_1
        del arg85_1
        buf134 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (4096, 32), (32, 1), 0), reinterpret_tensor(arg80_1, (32, 1), (1, 32), 0), out=buf134)
        del arg80_1
        del buf67
        buf135 = reinterpret_tensor(buf134, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf134  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_43.run(buf135, arg81_1, 4096, grid=grid(4096), stream=stream0)
        del arg81_1
        buf136 = empty_strided_cuda((1, 902144), (902144, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_44.run(buf105, buf131, buf132, buf133, buf135, buf136, 902144, grid=grid(902144), stream=stream0)
        del buf105
        del buf131
        del buf132
        del buf133
        # Topologically Sorted Source Nodes: [toks_3, index_add__11, index_add__10], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_45.run(buf114, buf109, buf124, buf108, buf137, buf140, 729088, grid=grid(729088), stream=stream0)
        del buf124
    return (buf136, reinterpret_tensor(buf135, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf137, (1, 4096, 32), (131072, 32, 1), 0), reinterpret_tensor(buf140, (1, 4096, 32), (131072, 32, 1), 0), arg42_1, buf108, buf114, buf109, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg48_1 = rand_strided((128, 96), (96, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg64_1 = rand_strided((128, 96), (96, 1), device='cuda:0', dtype=torch.float32)
