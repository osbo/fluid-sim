...
# Graph fragment:
#   %var_mean_1 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_8, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_1 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_8, %getitem_3), kwargs = {})
...
# Graph fragment:
#   %mul_15 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_33, 0.5), kwargs = {})
#   %mul_16 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_33, 0.7071067811865476), kwargs = {})
...
# Graph fragment:
#   %mul_20 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_46, 0.5), kwargs = {})
#   %mul_21 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_46, 0.7071067811865476), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/6k/c6kokpwosl2ho2mm5lhfzrohnsjlvct24th3uyudcuozaykaoggq.py
# Topologically Sorted Source Nodes: [col_highway], Original ATen: [aten.new_zeros]
# Source node to ATen node mapping:
#   col_highway => full_default_7
# Graph fragment:
#   %full_default_7 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/eo/ceoku7jpq2h5qknf25y4vzlx5s5gbx5rkr4b35zfmmhlnc3msqln.py
# Topologically Sorted Source Nodes: [x, x_1, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
# Source node to ATen node mapping:
#   col_highway => full_default_7
...
#   x_1 => add_16
# Graph fragment:
#   %add_12 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_8, %view_44), kwargs = {})
#   %add_16 : [num_users=6] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_12, %view_48), kwargs = {})
#   %full_default_6 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_6 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_6, [None, %slice_56], %view_88, True), kwargs = {})
#   %full_default_7 : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 128, 64], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put_7 : [num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_7, [None, %slice_56], %view_88, True), kwargs = {})
triton_poi_fused_add_index_add_new_zeros_21 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_index_add_new_zeros_21', 'mutated_arg_names': ['in_out_ptr0', 'out_ptr0', 'out_ptr1'], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7k/c7k5dn3yqjc2ipcyrslew3n6ninoayjkxr57vtxbyyzebp2vfflw.py
...
# Graph fragment:
#   %var_mean_3 : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%view_58, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_3 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_58, %getitem_11), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_native_layer_norm_22', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 4, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/xw/cxwg2cjjehk7shifgo67aszrzo6jmj36zygveguzgyff5we6ijvw.py
...
#   %index_put_4 : [num_users=2] = call_function[target=torch.ops.aten.index_put.default](args = (%view_6, [None, None, %iota_1, %iota_1], %full_default_4), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/up/cuppdzgmdvazx5zfjzvm2g4sbfybpd6kpcjhcqsrqy5xfujbpmey.py
# Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_2 => full_default_4, index_put_4
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/w6/cw6ftefwhz2jyjprxx2h5cgavnhojjggl3poipp6l5nn7r6vpj6v.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/33/c336j5oqt4w73mq5cbn4oujg7yf2bu7vh3b57pqtgs2qu4toinrt.py
# Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
# Source node to ATen node mapping:
#   setitem_3 => full_default_5, index_put_5
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/qm/cqmgt35nbccez6wdwae5dmkqbk2lemnholc6s4a7rlublmbgp3ub.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/so/csoa4usdarmratpntaaxri4aka7zronm4qbkmowklmtvdu75sx6k.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f_1 => clone_9
#   logit_bias_1 => clone_11
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/bk/cbkizhywv5sh4jcy6cjxjh4lc5zuswlsuvnepxoh5llqrvx5cx4e.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/mb/cmbzk3skozt6tr4kdybvypepu33e5kinkjk5pjtpjr6kuq7l5wo7.py
# Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
# Source node to ATen node mapping:
#   k_f_1 => clone_9
#   logit_bias_1 => clone_11
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/vb/cvbktxb6i5f4m7fztmzexjameialbseu4yazsp4oylabouonrpq6.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/rv/crvwsp3dpf32numun6y3aze3ijv5rdvs2adevjkfgdg5pq5yfw4k.py
# Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_17 => add_20, erf_5, mul_25, mul_26, mul_27
# Graph fragment:
#   %mul_25 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_72, 0.5), kwargs = {})
#   %mul_26 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_72, 0.7071067811865476), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/hx/chxqf4inh2lirqfhp2slvrrmmuvexx5fsxu6zwvqnwfstydpjp5i.py
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/uy/cuy3752wzbhhdjvjz735s5xqxoqvmx5lliw6efoietfs6iegnrrr.py
# Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
# Source node to ATen node mapping:
#   x_mid_1 => add_21
# Graph fragment:
#   %add_21 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_75, %view_79), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/62/c62lvnnqmhdnt3sepztknmwk4c3h3yd6nc5wy4uc7da47nulaj65.py
...
#   x_2 => add_22
# Graph fragment:
#   %add_22 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_58, %view_83), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_35', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 6, 'num_reduction': 4, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/tw/ctwkvbtaj3tdbcm3vlsowta3nqksq2mxsmlai564ljajl6toptic.py
# Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_20 => add_25, erf_6, mul_30, mul_31, mul_32
# Graph fragment:
#   %mul_30 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_85, 0.5), kwargs = {})
#   %mul_31 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_85, 0.7071067811865476), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/2z/c2z3bojs5e6slq4vnj54z4uxk66hv7sktwdvxxvel2o6qs3gf5xk.py
...
# Graph fragment:
#   %add_22 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_58, %view_83), kwargs = {})
#   %add_26 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_22, %view_87), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/7z/c7zmavwgichg7fuamf2f6d7bceq36i76b77s7lrq4viliaf23mhy.py
# Topologically Sorted Source Nodes: [toks, index_add__4, index_add__5], Original ATen: [aten.index_select, aten.index_add]
# Source node to ATen node mapping:
#   index_add__4 => index_put_8
#   index_add__5 => index_put_9
#   toks => index_2
# Graph fragment:
#   %index_2 : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_89, [None, %device_put_2]), kwargs = {})
#   %index_put_8 : [num_users=3] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_6, [None, %device_put], %index_2, True), kwargs = {})
#   %index_put_9 : [num_users=3] = call_function[target=torch.ops.aten.index_put_.default](args = (%index_put_7, [None, %device_put_1], %index_2, True), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_index_add_index_select_38', 'mutated_arg_names': ['out_ptr0', 'out_ptr1'], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, out_ptr0, out_ptr1, xnumel, XBLOCK : tl.constexpr):
    ...
    tl.atomic_add(out_ptr1 + (x0 + (8192*tmp16)), tmp12, None, sem='relaxed')
''', device_str='cuda')


# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/sz/cszpevhvr4p73v6gytto2xsashlr7q3qiyljfghysemfsvnvrcr7.py
# Topologically Sorted Source Nodes: [h_in], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   h_in => cat_3
# Graph fragment:
#   %cat_3 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%view_94, %view_96, %view_98], -1), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=89, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, multi_processor_count=142), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4), equal_to_1=())]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_cat_39', 'mutated_arg_names': [], 'no_x_dim': False, 'num_load': 3, 'num_reduction': 0, 'backend_hash': 'EE1FF1A692BB318A52D1FC9AAB9D4731B4C6A59706D9DFCBED88CECB030EA339', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_ptr0, in_ptr1, in_ptr2, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp8 = tmp0 < tmp7
    tmp9 = tmp6 & tmp8
    tmp10 = tl.load(in_ptr1 + ((64*x1) + ((-64) + x0)), tmp9, eviction_policy='evict_last', other=0.0)
    tmp11 = tmp0 >= tmp7
    tmp12 = tl.full([1], 192, tl.int64)
    tmp13 = tmp0 < tmp12
    tmp14 = tl.load(in_ptr2 + ((64*x1) + ((-128) + x0)), tmp11, eviction_policy='evict_last', other=0.0)
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/gf/cgfnayewaorxharlivwpjz3gsaqqxhitoaz4y6whb6wmqpzu5h54.py
# Topologically Sorted Source Nodes: [h_in_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   h_in_1 => cat_4
# Graph fragment:
#   %cat_4 : [num_users=2] = call_function[target=torch.ops.aten.cat.default](args = ([%view_126, %view_127, %view_128], -1), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/jo/cjozzs5a7k42tkh23s5oqtrzpmwbwf6gfybdunlw2bevwkowxzfh.py
# Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
# Source node to ATen node mapping:
#   input_26 => add_28, erf_8, mul_36, mul_37, mul_38
# Graph fragment:
#   %mul_36 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_130, 0.5), kwargs = {})
#   %mul_37 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_130, 0.7071067811865476), kwargs = {})
...
# kernel path: /orcd/home/002/osbo/ondemand/fluid-sim/Assets/Scripts/.torch_inductor_cache/4i/c4ix675wnykxqcl7x7urzdjktu6b2q6frbjhn2mtlqk4pehncztq.py
# Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
# Source node to ATen node mapping:
#   packed_1 => cat_6
# Graph fragment:
#   %cat_6 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%cat_5, %view_144], 1), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg67_1, (178, ), (1, ))
    assert_size_stride(arg68_1, (64, 192), (192, 1))
    assert_size_stride(arg69_1, (64, ), (1, ))
    assert_size_stride(arg70_1, (128, 64), (64, 1))
    assert_size_stride(arg71_1, (128, ), (1, ))
    assert_size_stride(arg72_1, (64, 192), (192, 1))
    assert_size_stride(arg73_1, (64, ), (1, ))
    assert_size_stride(arg74_1, (128, 64), (64, 1))
    assert_size_stride(arg75_1, (128, ), (1, ))
    assert_size_stride(arg76_1, (64, 192), (192, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del arg46_1
        del buf58
        buf103 = reinterpret_tensor(buf49, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [col_highway], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf103, 262144, grid=grid(262144), stream=stream0)
        buf93 = reinterpret_tensor(buf36, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [row_highway], Original ATen: [aten.new_zeros]
        triton_poi_fused_new_zeros_20.run(buf93, 262144, grid=grid(262144), stream=stream0)
        buf60 = reinterpret_tensor(buf59, (1, 4096, 64), (262144, 64, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [x, x_1, row_highway, index_add__2, col_highway, index_add__3], Original ATen: [aten.add, aten.new_zeros, aten.index_add]
        triton_poi_fused_add_index_add_new_zeros_21.run(buf60, buf25, buf52, arg41_1, arg47_1, arg64_1, buf93, buf103, 262144, grid=grid(262144), stream=stream0)
        del arg41_1
        del arg47_1
        del buf25
        ...
        buf66 = empty_strided_cuda((109, 128, 64), (8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [layer_norm_3], Original ATen: [aten.native_layer_norm]
        triton_per_fused_native_layer_norm_22.run(buf61, buf62, arg48_1, arg49_1, buf66, 13952, 64, grid=grid(13952), stream=stream0)
        del arg48_1
        del arg49_1
        buf67 = empty_strided_cuda((13952, 192), (192, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf66, (13952, 64), (64, 1), 0), reinterpret_tensor(arg50_1, (64, 192), (1, 64), 0), out=buf67)
        del arg50_1
        buf68 = empty_strided_cuda((109, 1, 128, 128, 4), (65536, 7143424, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_23.run(arg29_1, buf68, 7143424, grid=grid(7143424), stream=stream0)
        del arg29_1
        # Topologically Sorted Source Nodes: [setitem_2], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_24.run(buf68, 55808, grid=grid(55808), stream=stream0)
        buf70 = empty_strided_cuda((109, 1, 128, 128), (16384, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_25.run(buf68, buf70, 1785856, grid=grid(1785856), stream=stream0)
        # Topologically Sorted Source Nodes: [setitem_3], Original ATen: [aten.lift_fresh, aten.index_put]
        triton_poi_fused_index_put_lift_fresh_26.run(buf70, 13952, grid=grid(13952), stream=stream0)
        buf72 = reinterpret_tensor(buf66, (109, 8, 128, 8), (8192, 1024, 8, 1), 0); del buf66  # reuse
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_27.run(buf67, arg51_1, buf72, 892928, grid=grid(892928), stream=stream0)
        buf73 = empty_strided_cuda((109, 8, 128, 8), (8192, 1024, 8, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_28.run(buf67, arg51_1, buf73, 892928, grid=grid(892928), stream=stream0)
        buf74 = empty_strided_cuda((109, 8, 128, 8), (8192, 1024, 8, 1), torch.float32)
        buf86 = empty_strided_cuda((109, 8, 128, 1, 8, 1), (8192, 1024, 8, 8, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2, einsum_5], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_29.run(buf67, arg51_1, buf74, buf86, 892928, grid=grid(892928), stream=stream0)
        del arg51_1
        buf75 = empty_strided_cuda((109, 8, 128, 128), (131072, 16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_clone_30.run(buf70, buf68, buf75, 14286848, grid=grid(14286848), stream=stream0)
        # Topologically Sorted Source Nodes: [q_f_1, k_f_1, v_f_1, logit_bias_1, x_soft_2], Original ATen: [aten.clone, aten._scaled_dot_product_efficient_attention]
        buf76 = torch.ops.aten._scaled_dot_product_efficient_attention.default(buf72, buf73, buf74, buf75, False)
        del buf72
        del buf73
        buf77 = buf76[0]
        del buf76
        buf81 = empty_strided_cuda((109, 1, 128, 128, 4), (65536, 1, 512, 4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_31.run(buf70, buf68, buf81, 7143424, grid=grid(7143424), stream=stream0)
        del buf68
        buf82 = empty_strided_cuda((1785856, 16), (16, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf81, (1785856, 4), (4, 1), 0), reinterpret_tensor(arg52_1, (4, 16), (1, 4), 0), out=buf82)
        del arg52_1
        del buf81
        buf83 = reinterpret_tensor(buf82, (109, 1, 128, 128, 16), (262144, 1, 2048, 16, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [input_17], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_32.run(buf83, arg53_1, 28573696, grid=grid(28573696), stream=stream0)
        del arg53_1
        buf84 = reinterpret_tensor(buf75, (1785856, 8), (8, 1), 0); del buf75  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf83, (1785856, 16), (16, 1), 0), reinterpret_tensor(arg54_1, (16, 8), (1, 16), 0), out=buf84)
        del arg54_1
        del buf83
        buf85 = empty_strided_cuda((109, 8, 128, 128, 1, 1), (131072, 16384, 128, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_33.run(buf84, arg55_1, buf85, 872, 16384, grid=grid(872, 16384), stream=stream0)
        del arg55_1
        del buf84
        buf87 = reinterpret_tensor(buf74, (872, 128, 8), (1024, 8, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [einsum_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf85, (872, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf86, (872, 128, 8), (1024, 8, 1), 0), out=buf87)
        del buf85
        del buf86
        buf88 = reinterpret_tensor(buf77, (109, 1, 128, 8, 8), (8192, 1, 64, 8, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [x_mid_1], Original ATen: [aten.add]
        triton_poi_fused_add_34.run(buf88, buf87, 892928, grid=grid(892928), stream=stream0)
        buf89 = reinterpret_tensor(buf87, (13952, 64), (64, 1), 0); del buf87  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf88, (13952, 64), (64, 1), 0), reinterpret_tensor(arg56_1, (64, 64), (1, 64), 0), out=buf89)
        del arg56_1
        buf96 = reinterpret_tensor(buf88, (109, 128, 64), (8192, 64, 1), 0); del buf88  # reuse
        # Topologically Sorted Source Nodes: [x_2, layer_norm_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_35.run(buf61, buf62, buf89, arg57_1, arg58_1, arg59_1, buf96, 13952, 64, grid=grid(13952), stream=stream0)
        del arg58_1
        del arg59_1
        buf95 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf95.copy_(arg65_1)
        del arg65_1
        buf97 = empty_strided_cuda((13952, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (13952, 64), (64, 1), 0), reinterpret_tensor(arg60_1, (64, 256), (1, 64), 0), out=buf97)
        del arg60_1
        buf98 = reinterpret_tensor(buf97, (109, 128, 256), (32768, 256, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [input_20], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_36.run(buf98, arg61_1, 3571712, grid=grid(3571712), stream=stream0)
        del arg61_1
        buf99 = reinterpret_tensor(buf96, (13952, 64), (64, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (13952, 256), (256, 1), 0), reinterpret_tensor(arg62_1, (256, 64), (1, 256), 0), out=buf99)
        del arg62_1
        del buf98
        buf100 = reinterpret_tensor(buf99, (109, 128, 64), (8192, 64, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [x_2, x_3], Original ATen: [aten.add]
        triton_poi_fused_add_37.run(buf100, buf61, buf62, buf89, arg57_1, arg63_1, 892928, grid=grid(892928), stream=stream0)
        del arg57_1
        del arg63_1
        del buf61
        buf101 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf101.copy_(arg67_1)
        del arg67_1
        buf105 = empty_strided_cuda((178, ), (1, ), torch.int64)
        buf105.copy_(arg66_1)
        del arg66_1
        # Topologically Sorted Source Nodes: [toks, index_add__4, index_add__5], Original ATen: [aten.index_select, aten.index_add]
        triton_poi_fused_index_add_index_select_38.run(buf95, buf101, buf100, buf105, buf93, buf103, 1458176, grid=grid(1458176), stream=stream0)
        buf107 = reinterpret_tensor(buf30, (1, 32, 128, 192), (786432, 24576, 192, 1), 0); del buf30  # reuse
        # Topologically Sorted Source Nodes: [h_in], Original ATen: [aten.cat]
        triton_poi_fused_cat_39.run(buf60, buf93, buf103, buf107, 786432, grid=grid(786432), stream=stream0)
        buf108 = buf52; del buf52  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf107, (4096, 192), (192, 1), 0), reinterpret_tensor(arg68_1, (192, 64), (1, 192), 0), out=buf108)
        del arg68_1
        del buf107
        buf109 = reinterpret_tensor(buf108, (1, 32, 128, 64), (262144, 8192, 64, 1), 0); del buf108  # reuse
        # Topologically Sorted Source Nodes: [input_23], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_1.run(buf109, arg69_1, 262144, grid=grid(262144), stream=stream0)
        del arg69_1
        buf110 = reinterpret_tensor(buf33, (4096, 128), (128, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [input_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg71_1, reinterpret_tensor(buf109, (4096, 64), (64, 1), 0), reinterpret_tensor(arg70_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf110)
        del arg70_1
        del arg71_1
        del buf109
        buf111 = empty_strided_cuda((32, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf110, (32, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf110, (32, 128, 128), (16384, 1, 128), 0), out=buf111)
        buf112 = reinterpret_tensor(buf89, (1, 109, 8192), (892928, 8192, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [row_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg30_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf93, (1, 32, 8192), (262144, 8192, 1), 0), out=buf112)
        del arg30_1
        buf113 = buf62; del buf62  # reuse
        # Topologically Sorted Source Nodes: [col_t], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(arg31_1, (1, 109, 32), (3488, 32, 1), 0), reinterpret_tensor(buf103, (1, 32, 8192), (262144, 8192, 1), 0), out=buf113)
        del arg31_1
        buf114 = reinterpret_tensor(buf67, (109, 1, 128, 192), (24576, 1, 192, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [h_in_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_40.run(buf100, buf112, buf113, buf114, 2678784, grid=grid(2678784), stream=stream0)
        del buf100
        del buf112
        buf115 = reinterpret_tensor(buf113, (13952, 64), (64, 1), 0); del buf113  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (13952, 192), (192, 1), 0), reinterpret_tensor(arg72_1, (192, 64), (1, 192), 0), out=buf115)
        del arg72_1
        buf116 = reinterpret_tensor(buf115, (109, 1, 128, 64), (8192, 1, 64, 1), 0); del buf115  # reuse
        # Topologically Sorted Source Nodes: [input_26], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf116, arg73_1, 892928, grid=grid(892928), stream=stream0)
        del arg73_1
        buf117 = reinterpret_tensor(buf70, (13952, 128), (128, 1), 0); del buf70  # reuse
        # Topologically Sorted Source Nodes: [input_27], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg75_1, reinterpret_tensor(buf116, (13952, 64), (64, 1), 0), reinterpret_tensor(arg74_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf117)
        del arg74_1
        del arg75_1
        buf118 = reinterpret_tensor(buf116, (13952, 64), (64, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (13952, 192), (192, 1), 0), reinterpret_tensor(arg76_1, (192, 64), (1, 192), 0), out=buf118)
        del arg76_1
        del buf114
        buf119 = reinterpret_tensor(buf118, (109, 1, 128, 64), (8192, 1, 64, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [input_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_41.run(buf119, arg77_1, 892928, grid=grid(892928), stream=stream0)
        del arg77_1
        buf120 = empty_strided_cuda((13952, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [input_30], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf119, (13952, 64), (64, 1), 0), reinterpret_tensor(arg78_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf120)
        del arg78_1
        del arg79_1
        del buf119
        buf121 = empty_strided_cuda((109, 128, 128), (16384, 128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [out_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf117, (109, 128, 128), (16384, 128, 1), 0), reinterpret_tensor(buf120, (109, 128, 128), (16384, 1, 128), 0), out=buf121)
        del buf117
        del buf120
        buf122 = buf110; del buf110  # reuse
        # Topologically Sorted Source Nodes: [node_U], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg83_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg82_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf122)
        del arg82_1
        del arg83_1
        buf123 = empty_strided_cuda((4096, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [node_V], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg85_1, reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg84_1, (64, 128), (1, 64), 0), alpha=1, beta=1, out=buf123)
        del arg84_1
        del arg85_1
        buf124 = empty_strided_cuda((4096, 1), (1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf60, (4096, 64), (64, 1), 0), reinterpret_tensor(arg80_1, (64, 1), (1, 64), 0), out=buf124)
        del arg80_1
        del buf60
        buf125 = reinterpret_tensor(buf124, (1, 32, 128, 1), (4096, 128, 1, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [sigmoid], Original ATen: [aten.sigmoid]
        triton_poi_fused_sigmoid_42.run(buf125, arg81_1, 4096, grid=grid(4096), stream=stream0)
        del arg81_1
        buf126 = empty_strided_cuda((1, 3362816), (3362816, 1), torch.float32)
        # Topologically Sorted Source Nodes: [packed_1], Original ATen: [aten.cat]
        triton_poi_fused_cat_43.run(buf111, buf121, buf122, buf123, buf125, buf126, 3362816, grid=grid(3362816), stream=stream0)
        del buf111
        del buf121
        del buf122
        del buf123
    return (buf126, reinterpret_tensor(buf125, (1, 32, 128), (4096, 128, 1), 0), reinterpret_tensor(buf103, (1, 4096, 64), (262144, 64, 1), 0), reinterpret_tensor(buf93, (1, 4096, 64), (262144, 64, 1), 0), arg64_1, buf95, buf105, buf101, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg64_1 = rand_strided((32, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg65_1 = rand_strided((178, ), (1, ), device='cpu', dtype=torch.int64)
    arg66_1 = rand_strided((178, ), (1, ), device='cpu', dtype=torch.int64)
    arg67_1 = rand_strided((178, ), (1, ), device='cpu', dtype=torch.int64)
    arg68_1 = rand_strided((64, 192), (192, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg72_1 = rand_strided((64, 192), (192, 1), device='cuda:0', dtype=torch.float32)
    arg73_1 = rand_strided((64, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg74_1 = rand_strided((128, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    arg75_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg76_1 = rand_strided((64, 192), (192, 1), device='cuda:0', dtype=torch.float32)
