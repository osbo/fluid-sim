...
#   - task summary CSV:
#       Assets/Scripts/results/lsp_generalization_train_task_<task>.csv
#
# Merge summaries:
#   python3 - <<'PY'
...
#SBATCH --mem=32G
#SBATCH -t 6:00:00
#SBATCH -o /home/osbo/ondemand/fluid-sim/Assets/Scripts/slurm_logs/lsp_train_gen4096_%j.out
#SBATCH -e /home/osbo/ondemand/fluid-sim/Assets/Scripts/slurm_logs/lsp_train_gen4096_%j.err
...
for TASK_ID in "${TASK_IDS[@]}"; do
  ...
  SRC_TRAIN_DIR="${FLUID_SIM_ROOT}/Assets/Scripts/data/generalization_4096/${TRAIN_SPLIT}/train"
  GEN_TRAIN_DIR="${FLUID_SIM_ROOT}/Assets/Scripts/results/lsp_generalization_generated_train/${TRAIN_SPLIT}"
