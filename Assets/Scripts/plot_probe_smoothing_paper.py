...
def main() -> None:
    ...
    results_dir = scripts_dir / "results" / "probe_smoothing_8192"
    ...
    p.add_argument(
        "--default-profile-csv",
        type=Path,
        default=scripts_dir / "weights" / "v2_8192_d128_L3_hw_smooth_default_training_profile.csv",
    )
    p.add_argument(
        "--zero-profile-csv",
        type=Path,
        default=scripts_dir / "weights" / "v2_8192_d128_L3_hw_smooth_zero_training_profile.csv",
    )
    p.add_argument(
        "--out-png",
        type=Path,
